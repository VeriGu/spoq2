...
Section Bottom_Spec.
  ...
  Definition measurement_start_spec (v: Ptr) (st: RData) : (option RData) :=
    (Some st).
...
#[global] Hint Unfold measurement_start_spec: spec.
...
#[global] Hint Unfold iasm_267_spec: spec.

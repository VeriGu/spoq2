...
Section Bottom.
 ...
 (* TODO *)
  ...
  Definition iasm_11_spec (st: RData) : option RData :=
    Some st.
  ...
  Definition iasm_14_spec (v: Z) (st: RData) : option RData :=
    Some st.
  ...
  Parameter iasm_267_ret : Z.
  Definition iasm_267_spec (st: RData) : option (Z * RData) :=
    Some (iasm_267_ret, st).

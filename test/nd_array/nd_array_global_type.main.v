...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "nd_array_global_type".
Definition PROJ_BASE: string := "nd_array_global_type".
Definition PROJ_BC_PATH: string := "nd_array_global_type.bc".

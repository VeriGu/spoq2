...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "fold_shift_past_64_bits".
Definition PROJ_BASE: string := "fold_shift_past_64_bits".
Definition PROJ_BC_PATH: string := "fold_shift_past_64_bits.bc".

...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "fold_mul_exceeds_64_bits".
Definition PROJ_BASE: string := "fold_mul_exceeds_64_bits".
Definition PROJ_BC_PATH: string := "fold_mul_exceeds_64_bits.bc".
...
(* The true value exceeds 64 bits; the folded one does not. *)
Hint Postcondition vuln_spec (_ret_0 >? (18446744073709551615)).

...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "int_trunc_divisor_zero".
Definition PROJ_BASE: string := "int_trunc_divisor_zero".
Definition PROJ_BC_PATH: string := "int_trunc_divisor_zero.bc".
...
(* The two fields PNG001 multiplies: a png_uint_32 and a png_byte. *)
Parameter width_spec : (RData-> (option ((int32) * RData))).
Parameter channels_spec : (RData-> (option ((int8) * RData))).

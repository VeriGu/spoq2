...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "int_sext_i8_negative".
Definition PROJ_BASE: string := "int_sext_i8_negative".
Definition PROJ_BC_PATH: string := "int_sext_i8_negative.bc".
...
(* An i8 result; the case that matters is the bit pattern 0xFF. *)

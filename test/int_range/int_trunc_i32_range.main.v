...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "int_trunc_i32_range".
Definition PROJ_BASE: string := "int_trunc_i32_range".
Definition PROJ_BC_PATH: string := "int_trunc_i32_range.bc".
...
(* An i64 result, truncated to i32 and read back: 0..2^32-1. *)

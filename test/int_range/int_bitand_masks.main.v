...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "int_bitand_masks".
Definition PROJ_BASE: string := "int_bitand_masks".
Definition PROJ_BC_PATH: string := "int_bitand_masks.bc".
...
(* An i32 result, masked to its low eight bits. *)
Parameter pick32_spec : (RData-> (option ((Z) * RData))).

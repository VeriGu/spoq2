...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "int_trunc_wraps_to_zero".
Definition PROJ_BASE: string := "int_trunc_wraps_to_zero".
Definition PROJ_BC_PATH: string := "int_trunc_wraps_to_zero.bc".
...
(* An i64 result; the case that matters is the one equal to 2^32. *)
Parameter pick64_spec : (RData-> (option ((int64) * RData))).

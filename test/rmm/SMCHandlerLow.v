...
Definition smc_realm_create_spec_low (v_rd_addr: Z) (v_realm_params_addr: Z) (st: RData) : (option (Z * RData)) :=
  when st_0 == ((new_frame "smc_realm_create" st));
  (* when v_g_rd, st_1 == ((alloc_stack "smc_realm_create" 8 8 st_0)); *)
  (* when v_g_rtt_base, st_2 == ((alloc_stack "smc_realm_create" 8 8 st_1)); *)
  (* when v_p, st_3 == ((alloc_stack "smc_realm_create" 4096 8 st_2)); *)
  let v_g_rd := (mkPtr "stack_g0" 0) in
  let v_g_rtt_base := (mkPtr "stack_g1" 0) in
  let v_p := (mkPtr "stack_realm_params" 0) in
  let st_3 := st_0 in
  when v_call, st_4 == ((get_realm_params_spec v_p v_realm_params_addr st_3));
  if v_call
  then (
    when v_call1, st_5 == ((validate_realm_params_spec v_p st_4));
    if v_call1
    then (
      when v_1, st_6 == ((load_RData 8 (ptr_offset v_p 2056) st_5));
      when v_2, st_7 == ((load_RData 4 (ptr_offset v_p 2072) st_6));
      when v_call5, st_8 == ((addr_is_contained_spec v_1 ((v_2 << (12)) + (v_1)) v_rd_addr st_7));
      if v_call5
      then (
        when v_3, st_9 == ((load_RData 2 (ptr_offset (ptr_offset v_p 2048) 0) st_8));
        when st_10 == ((vmid_free_spec v_3 st_9));
        when st_14 == ((free_stack "smc_realm_create" st_0 st_10));
        (Some (1, st_14)))
      else (
        when v_4, st_9 == ((load_RData 8 (ptr_offset v_p 2056) st_8));
        when v_5, st_10 == ((load_RData 4 (ptr_offset v_p 2072) st_9));
        when v_call11, st_11 == ((find_lock_rd_granules_spec v_rd_addr v_g_rd v_4 v_5 v_g_rtt_base st_10));
        if v_call11
        then (
          when v_7_tmp, st_12 == ((load_RData 8 v_g_rd st_11));
          rely (int_is_granule v_7_tmp);
          when v_call16, st_13 == ((granule_map_spec (int_to_ptr v_7_tmp) 2 st_12));
          when st_14 == ((set_rd_state_spec v_call16 0 st_13));
          when st_15 == ((set_rd_rec_count_spec v_call16 0 st_14));
          when v_9, st_16 == ((load_RData 8 (ptr_offset v_p 2056) st_15));
          when v_call18, st_17 == ((find_granule_spec v_9 st_16));
          when st_18 == ((store_RData 8 (ptr_offset v_call16 32) (ptr_to_int v_call18) st_17));
          when v_call19, st_19 == ((requested_ipa_bits_spec v_p st_18));
          when st_20 == ((store_RData 4 (ptr_offset v_call16 16) v_call19 st_19));
          when v_11, st_21 == ((load_RData 8 (ptr_offset v_p 2064) st_20));
          when st_22 == ((store_RData 4 (ptr_offset v_call16 20) v_11 st_21));
          when v_13, st_23 == ((load_RData 4 (ptr_offset v_p 2072) st_22));
          when st_24 == ((store_RData 4 (ptr_offset v_call16 24) v_13 st_23));
          when v_call27, st_25 == ((memcpy_spec (ptr_offset v_call16 386) (ptr_offset v_p 1024) 64 st_24));
          when v_15, st_26 == ((load_RData 2 (ptr_offset (ptr_offset v_p 2048) 0) st_25));
          when st_27 == ((store_RData 4 (ptr_offset v_call16 40) v_15 st_26));
          when st_28 == ((store_RData 4 (ptr_offset v_call16 48) 16 st_27));
          when v_18, st_29 == ((load_RData 8 (ptr_offset v_p 0) st_28));
          when st_30 == ((store_RData 1 (ptr_offset v_call16 64) ((v_18 & (512)) >> (9)) st_29));
          if ((v_18 & (512)) =? (0))
          then (
            when v_call44, st_32 == ((memcpy_spec (ptr_offset v_call16 386) (ptr_offset v_p 1024) 64 st_30));
            when v_25, st_33 == ((load_RData 1 (ptr_offset v_p 256) st_32));
            when st_34 == ((store_RData 4 (ptr_offset v_call16 52) v_25 st_33));
            when v_27, st_35 == ((load_RData 1 (ptr_offset v_p 256) st_34));
            if (v_27 =? (1))
            then (
              when st_36 == ((store_RData 4 (ptr_offset v_call16 52) 1 st_35));
              when v_28, st_38 == ((load_RData 8 (ptr_offset v_p 0) st_36));
              when st_39 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_38));
              when st_40 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_39));
              when st_41 == ((realm_params_measure_spec v_call16 v_p st_40));
              when st_42 == ((buffer_unmap_spec v_call16 st_41));
              when v_36_tmp, st_43 == ((load_RData 8 v_g_rd st_42));
              rely (int_is_granule v_36_tmp);
              when st_44 == ((granule_unlock_transition_spec (int_to_ptr v_36_tmp) 2 st_43));
              when v_37_tmp, st_45 == ((load_RData 8 v_g_rtt_base st_44));
              when v_38, st_46 == ((load_RData 4 (ptr_offset v_p 2072) st_45));
              if ((0 - (v_38)) <? (0))
              then (
                rely (int_is_granule v_37_tmp);
                rely (((smc_realm_create_loop335_rank (int_to_ptr v_37_tmp) 0 (ptr_offset v_p 2072)) >= (0)));
                match (
                  (smc_realm_create_loop335
                    (z_to_nat (smc_realm_create_loop335_rank (int_to_ptr v_37_tmp) 0 (ptr_offset v_p 2072)))
                    false
                    (int_to_ptr v_37_tmp)
                    0
                    (ptr_offset v_p 2072)
                ...
                | (Some (__break__, v_39, v_indvars_iv_0, v_rtt_num_start_0, st_47)) =>
                  when st_53 == ((free_stack "smc_realm_create" st_0 st_47));
                  (Some (0, st_53))
                | None => None
                end)
              else (
                when st_52 == ((free_stack "smc_realm_create" st_0 st_46));
                (Some (0, st_52))))
            else (
              if (v_27 =? (0))
              then (
                when st_36 == ((store_RData 4 (ptr_offset v_call16 52) 0 st_35));
                when v_28, st_39 == ((load_RData 8 (ptr_offset v_p 0) st_36));
                when st_40 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_39));
                when st_41 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_40));
                when st_42 == ((realm_params_measure_spec v_call16 v_p st_41));
                when st_43 == ((buffer_unmap_spec v_call16 st_42));
                when v_36_tmp, st_44 == ((load_RData 8 v_g_rd st_43));
                rely (int_is_granule v_36_tmp);
                when st_45 == ((granule_unlock_transition_spec (int_to_ptr v_36_tmp) 2 st_44));
                when v_37_tmp, st_46 == ((load_RData 8 v_g_rtt_base st_45));
                when v_38, st_47 == ((load_RData 4 (ptr_offset v_p 2072) st_46));
                if ((0 - (v_38)) <? (0))
                then (
                  rely (int_is_granule v_37_tmp);
                  rely (((smc_realm_create_loop335_rank (int_to_ptr v_37_tmp) 0 (ptr_offset v_p 2072)) >= (0)));
                  ...
                  | (Some (__break__, v_39, v_indvars_iv_0, v_rtt_num_start_0, st_48)) =>
                    when st_54 == ((free_stack "smc_realm_create" st_0 st_48));
                    (Some (0, st_54))
                  | None => None
                  end)
                else (
                ...
                when v_28, st_38 == ((load_RData 8 (ptr_offset v_p 0) st_35));
                when st_39 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_38));
                when st_40 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_39));
                when st_41 == ((realm_params_measure_spec v_call16 v_p st_40));
                when st_42 == ((buffer_unmap_spec v_call16 st_41));
            ...
            when v_22, st_31 == ((load_RData 8 (ptr_offset v_p 0) st_30));
            when st_32 == ((store_RData 1 (ptr_offset v_call16 65) ((v_22 >> (10)) & (15)) st_31));
            when v_call44, st_34 == ((memcpy_spec (ptr_offset v_call16 386) (ptr_offset v_p 1024) 64 st_32));
            when v_25, st_35 == ((load_RData 1 (ptr_offset v_p 256) st_34));
            when st_36 == ((store_RData 4 (ptr_offset v_call16 52) v_25 st_35));
            when v_27, st_37 == ((load_RData 1 (ptr_offset v_p 256) st_36));
            if (v_27 =? (1))
            then (
              when st_38 == ((store_RData 4 (ptr_offset v_call16 52) 1 st_37));
              when v_28, st_40 == ((load_RData 8 (ptr_offset v_p 0) st_38));
              when st_41 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_40));
              when st_42 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_41));
              when st_43 == ((realm_params_measure_spec v_call16 v_p st_42));
              when st_44 == ((buffer_unmap_spec v_call16 st_43));
              when v_36_tmp, st_45 == ((load_RData 8 v_g_rd st_44));
              rely (int_is_granule v_36_tmp);
              when st_46 == ((granule_unlock_transition_spec (int_to_ptr v_36_tmp) 2 st_45));
              when v_37_tmp, st_47 == ((load_RData 8 v_g_rtt_base st_46));
              when v_38, st_48 == ((load_RData 4 (ptr_offset v_p 2072) st_47));
              if ((0 - (v_38)) <? (0))
              then (
                rely (int_is_granule v_37_tmp);
                rely (((smc_realm_create_loop335_rank (int_to_ptr v_37_tmp) 0 (ptr_offset v_p 2072)) >= (0)));
                ...
                | (Some (__break__, v_39, v_indvars_iv_0, v_rtt_num_start_0, st_49)) =>
                  when st_55 == ((free_stack "smc_realm_create" st_0 st_49));
                  (Some (0, st_55))
                | None => None
                end)
              else (
              ...
              if (v_27 =? (0))
              then (
                when st_38 == ((store_RData 4 (ptr_offset v_call16 52) 0 st_37));
                when v_28, st_41 == ((load_RData 8 (ptr_offset v_p 0) st_38));
                when st_42 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_41));
                when st_43 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_42));
                when st_44 == ((realm_params_measure_spec v_call16 v_p st_43));
                when st_45 == ((buffer_unmap_spec v_call16 st_44));
                when v_36_tmp, st_46 == ((load_RData 8 v_g_rd st_45));
                rely (int_is_granule v_36_tmp);
                when st_47 == ((granule_unlock_transition_spec (int_to_ptr v_36_tmp) 2 st_46));
                when v_37_tmp, st_48 == ((load_RData 8 v_g_rtt_base st_47));
                when v_38, st_49 == ((load_RData 4 (ptr_offset v_p 2072) st_48));
                if ((0 - (v_38)) <? (0))
                then (
                  rely (int_is_granule v_37_tmp);
                  rely (((smc_realm_create_loop335_rank (int_to_ptr v_37_tmp) 0 (ptr_offset v_p 2072)) >= (0)));
                  ...
                  | (Some (__break__, v_39, v_indvars_iv_0, v_rtt_num_start_0, st_50)) =>
                    when st_56 == ((free_stack "smc_realm_create" st_0 st_50));
                    (Some (0, st_56))
                  | None => None
                  end)
                else (
                ...
                when v_28, st_40 == ((load_RData 8 (ptr_offset v_p 0) st_37));
                when st_41 == ((store_RData 1 (ptr_offset v_call16 56) ((v_28 >> (22)) & (1)) st_40));
                when st_42 == ((store_RData 4 (ptr_offset v_call16 60) ((v_28 >> (23)) & (31)) st_41));
                when st_43 == ((realm_params_measure_spec v_call16 v_p st_42));
                when st_44 == ((buffer_unmap_spec v_call16 st_43));
          ...
          when v_6, st_12 == ((load_RData 2 (ptr_offset (ptr_offset v_p 2048) 0) st_11));
          when st_13 == ((vmid_free_spec v_6 st_12));
          when st_18 == ((free_stack "smc_realm_create" st_0 st_13));
          (Some (1, st_18)))))
    else (
      when st_8 == ((free_stack "smc_realm_create" st_0 st_5));
      (Some (1, st_8))))
  else (
    when st_6 == ((free_stack "smc_realm_create" st_0 st_4));
    (Some (1, st_6))).

Fixpoint smc_rec_create_loop222_low (_N_: nat) (__return__: bool) (__retval__: Z) (__break__: bool) (v_indvars_iv: Z) (v_rec_aux_granules: Ptr) (v_rec_params: Ptr) (v_wide_trip_count: Z) (st: RData) : (option (bool * Z * bool * Z * Ptr * Ptr * Z * RData)) :=
  match (_N_) with
  | O => (Some (__return__, __retval__, __break__, v_indvars_iv, v_rec_aux_granules, v_rec_params, v_wide_trip_count, st))
  | (S _N__0) =>
      match ((smc_rec_create_loop222_low _N__0 __return__ __retval__ __break__ v_indvars_iv v_rec_aux_granules v_rec_params v_wide_trip_count st)) with
      | (Some (__return___0, __retval___0, __break___0, v_indvars_iv_0, v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_0)) =>
          ...
          then (Some (__return___0, __retval___0, true, v_indvars_iv_0, v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_0))
              ...
              then (Some (true, __retval___0, false, v_indvars_iv_0, v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_0))
                  ...
                  when v_3, st_1 == ((load_RData 8 (ptr_offset v_rec_params_0 (0 + ((2048 + ((0 + ((8 + (((8 * (v_indvars_iv_0)) + (0))))))))))) st_0));
                  when v_call11, st_2 == ((find_lock_granule_spec v_3 1 st_1));
                  if (ptr_eqb v_call11 (mkPtr "null" 0))
                  then (
                      when st_3 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules_0 0) v_indvars_iv_0 false st_2));
                      (Some (true, 1, false, v_indvars_iv_0, v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_3)))
                  else (
                      when st_4 == ((granule_unlock_transition_spec v_call11 4 st_2));
                      when st_5 == ((store_RData 8 (ptr_offset v_rec_aux_granules_0 (0 + (((8 * (v_indvars_iv_0)) + (0))))) (ptr_to_int v_call11) st_4));
                      if (((v_indvars_iv_0 + (1)) - (v_wide_trip_count_0)) <>? (0))
                      then (Some (false, __retval___0, false, (v_indvars_iv_0 + (1)), v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_5))
                      else (Some (false, __retval___0, true, v_indvars_iv_0, v_rec_aux_granules_0, v_rec_params_0, v_wide_trip_count_0, st_5)))))
      | None => None
      end
  end.

Definition smc_rec_create_spec_low (v_rec_addr: Z) (v_rd_addr: Z) (v_rec_params_addr: Z) (st: RData) : (option (Z * RData)) :=
    when st_0 == ((new_frame "smc_rec_create" st));
    (* when v_g_rd, st_1 == ((alloc_stack "smc_rec_create" 8 8 st_0)); *)
    (* when v_g_rec, st_2 == ((alloc_stack "smc_rec_create" 8 8 st_1)); *)
    (* when v_rec_aux_granules, st_3 == ((alloc_stack "smc_rec_create" 128 8 st_2)); *)
    (* when v_rec_params, st_4 == ((alloc_stack "smc_rec_create" 4096 8 st_3)); *)
    let v_g_rd := (mkPtr "stack_g1" 0) in
    let v_g_rec := (mkPtr "stack_g0" 0) in
    let v_rec_aux_granules := (mkPtr "stack_rec_aux_granules" 0) in
    let v_rec_params := (mkPtr "stack_rec_params" 0) in
    let st_4 := st_0 in
    when v_call, st_5 == ((find_granule_spec v_rec_params_addr st_4));
    if (ptr_eqb v_call (mkPtr "null" 0))
    then (
      when st_7 == ((free_stack "smc_rec_create" st_0 st_5));
      (Some (1, st_7)))
    else (
      when v_0, st_6 == ((load_RData 4 (ptr_offset v_call 4) st_5));
      if (v_0 =? (0))
      then (
        when v_call2, st_7 == ((ns_buffer_read_spec 0 v_call 0 4096 v_rec_params st_6));
        if v_call2
        then (
          when v_5, st_8 == ((load_RData 8 (ptr_offset v_rec_params 2048) st_7));
          if (v_5 >? (16))
          then (
            when st_10 == ((free_stack "smc_rec_create" st_0 st_8));
            (Some (1, st_10)))
          else (
              rely (((smc_rec_create_loop222_rank 0 v_rec_aux_granules v_rec_params v_5) >= (0)));
              match (
                match (
                  match (
                    match (
                      (smc_rec_create_loop222
                        (z_to_nat (smc_rec_create_loop222_rank 0 v_rec_aux_granules v_rec_params v_5))
                        false
                        0
                        false
                        0
                  ...
                  | (Some (return___2, retval___2, st_10)) => (Some (return___2, retval___2, v_5, v_5, st_10))
                  | None => None
                  end
                ) with
              ...
              | (Some (__return__, __retval__, v_2, v_conv, st_9)) =>
                if __return__
                then (
                  when st_10 == ((free_stack "smc_rec_create" st_0 st_9));
                  (Some (__retval__, st_10)))
                else (
                  when v_call18, st_10 == ((find_lock_two_granules_spec v_rec_addr 1 v_g_rec v_rd_addr 2 v_g_rd st_9));
                  if v_call18
                  then (
                    when v_5_tmp, st_11 == ((load_RData 8 v_g_rec st_10));
                    rely (int_is_granule v_5_tmp);
                    when v_call21, st_12 == ((granule_map_spec (int_to_ptr v_5_tmp) 3 st_11));
                    when v_7_tmp, st_13 == ((load_RData 8 v_g_rd st_12));
                    rely (int_is_granule v_7_tmp);
                    when v_call22, st_14 == ((granule_map_spec (int_to_ptr v_7_tmp) 2 st_13));
                    when v_call23, st_15 == ((get_rd_state_locked_spec v_call22 st_14));
                    if (v_call23 =? (0))
                    then (
                      when v_call28, st_16 == ((get_rd_rec_count_locked_spec v_call22 st_15));
                      when v_9, st_17 == ((load_RData 8 (ptr_offset v_rec_params 256) st_16));
                      when v_call29, st_18 == ((mpidr_is_valid_spec v_9 st_17));
                      if v_call29
                      then (
                        when v_10, st_19 == ((load_RData 8 (ptr_offset v_rec_params 256) st_18));
                        when v_call32, st_20 == ((mpidr_to_rec_idx_spec v_10 st_19));
                        if ((v_call28 - (v_call32)) =? (0))
                        then (
                          when v_12, st_21 == ((load_RData 4 (ptr_offset v_call22 48) st_20));
                          if ((v_12 - (v_conv)) =? (0))
                          then (
                            when v_13_tmp, st_22 == ((load_RData 8 v_g_rec st_21));
                            when st_23 == ((store_RData 8 v_call21 v_13_tmp st_22));
                            when st_24 == ((store_RData 8 (ptr_offset v_call21 8) v_call28 st_23));
                            when st_25 == ((init_rec_regs_spec v_call21 v_rec_params v_call22 st_24));
                            when st_26 == ((gic_cpu_state_init_spec (ptr_offset v_call21 584) st_25));
                            when v_call47, st_27 == ((memcpy_spec (ptr_offset v_call21 968) v_rec_aux_granules ((v_2 << (3)) & (34359738360)) st_26));
                            when st_28 == ((store_RData 4 (ptr_offset v_call21 964) v_conv st_27));
                            when v_call49, st_29 == ((realm_ipa_bits_spec v_call22 st_28));
                            when st_30 == ((store_RData 8 (ptr_offset v_call21 880) v_call49 st_29));
                            when v_call50, st_31 == ((realm_rtt_starting_level_spec v_call22 st_30));
                            when st_32 == ((store_RData 4 (ptr_offset v_call21 888) v_call50 st_31));
                            when v_20_tmp, st_33 == ((load_RData 8 (ptr_offset v_call22 32) st_32));
                            when st_34 == ((store_RData 8 (ptr_offset v_call21 896) v_20_tmp st_33));
                            when v_22_tmp, st_35 == ((load_RData 8 v_g_rd st_34));
                            when st_36 == ((store_RData 8 (ptr_offset v_call21 904) v_22_tmp st_35));
                            when v_25, st_37 == ((load_RData 1 (ptr_offset v_call22 64) st_36));
                            when st_38 == ((store_RData 1 (ptr_offset v_call21 920) (v_25 & (1)) st_37));
                            when v_29, st_39 == ((load_RData 1 (ptr_offset v_call22 65) st_38));
                            when st_40 == ((store_RData 1 (ptr_offset v_call21 921) v_29 st_39));
                            when v_32, st_41 == ((load_RData 1 (ptr_offset v_call22 56) st_40));
                            when st_42 == ((store_RData 1 (ptr_offset v_call21 912) (v_32 & (1)) st_41));
                            when v_36, st_43 == ((load_RData 4 (ptr_offset v_call22 60) st_42));
                            when st_44 == ((store_RData 4 (ptr_offset v_call21 916) v_36 st_43));
                            when st_45 == ((rec_params_measure_spec v_call22 v_rec_params st_44));
                            when v_38_tmp, st_46 == ((load_RData 8 v_g_rd st_45));
                            rely (int_is_granule v_38_tmp);
                            when st_47 == ((atomic_granule_get_spec (int_to_ptr v_38_tmp) st_46));
                            when v_39, st_48 == ((load_RData 8 (ptr_offset v_rec_params 0) st_47));
                            when st_49 == ((store_RData 1 (ptr_offset v_call21 16) (v_39 & (1)) st_48));
                            when st_50 == ((store_RData 1 (ptr_offset v_call21 3240) 0 st_49));
                            when st_51 == ((store_RData 4 (ptr_offset v_call21 2168) 0 st_50));
                            when st_52 == ((set_rd_rec_count_spec v_call22 (v_call28 + (1)) st_51));
                            when st_54 == ((buffer_unmap_spec v_call22 st_52));
                            when st_55 == ((buffer_unmap_spec v_call21 st_54));
                            when v_44_tmp, st_56 == ((load_RData 8 v_g_rd st_55));
                            rely (int_is_granule v_44_tmp);
                            when st_57 == ((granule_unlock_spec (int_to_ptr v_44_tmp) st_56));
                            when v_45_tmp, st_58 == ((load_RData 8 v_g_rec st_57));
                            rely (int_is_granule v_45_tmp);
                            when st_59 == ((granule_unlock_transition_spec (int_to_ptr v_45_tmp) 3 st_58));
                            when st_60 == ((free_stack "smc_rec_create" st_0 st_59));
                            (Some (0, st_60)))
                          else (
                            when st_22 == ((buffer_unmap_spec v_call22 st_21));
                            when st_23 == ((buffer_unmap_spec v_call21 st_22));
                            when v_44_tmp, st_24 == ((load_RData 8 v_g_rd st_23));
                            rely (int_is_granule v_44_tmp);
                            when st_25 == ((granule_unlock_spec (int_to_ptr v_44_tmp) st_24));
                            when v_45_tmp, st_26 == ((load_RData 8 v_g_rec st_25));
                            rely (int_is_granule v_45_tmp);
                            when st_27 == ((granule_unlock_transition_spec (int_to_ptr v_45_tmp) 1 st_26));
                            when st_28 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules 0) v_conv false st_27));
                            when st_30 == ((free_stack "smc_rec_create" st_0 st_28));
                            (Some (1, st_30))))
                        else (
                          when st_22 == ((buffer_unmap_spec v_call22 st_20));
                          when st_23 == ((buffer_unmap_spec v_call21 st_22));
                          when v_44_tmp, st_24 == ((load_RData 8 v_g_rd st_23));
                          rely (int_is_granule v_44_tmp);
                          when st_25 == ((granule_unlock_spec (int_to_ptr v_44_tmp) st_24));
                          ...
                          when st_27 == ((granule_unlock_transition_spec (int_to_ptr v_45_tmp) 1 st_26));
                          when st_28 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules 0) v_conv false st_27));
                          when st_29 == ((free_stack "smc_rec_create" st_0 st_28));
                          (Some (1, st_29))))
                      else (
                        when st_19 == ((buffer_unmap_spec v_call22 st_18));
                        when st_20 == ((buffer_unmap_spec v_call21 st_19));
                        when v_44_tmp, st_21 == ((load_RData 8 v_g_rd st_20));
                        rely (int_is_granule v_44_tmp);
                        when st_22 == ((granule_unlock_spec (int_to_ptr v_44_tmp) st_21));
                        when v_45_tmp, st_23 == ((load_RData 8 v_g_rec st_22));
                        rely (int_is_granule v_45_tmp);
                        when st_24 == ((granule_unlock_transition_spec (int_to_ptr v_45_tmp) 1 st_23));
                        when st_25 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules 0) v_conv false st_24));
                        when st_27 == ((free_stack "smc_rec_create" st_0 st_25));
                        (Some (1, st_27))))
                    else (
                      when st_16 == ((buffer_unmap_spec v_call22 st_15));
                      when st_17 == ((buffer_unmap_spec v_call21 st_16));
                      when v_44_tmp, st_18 == ((load_RData 8 v_g_rd st_17));
                      rely (int_is_granule v_44_tmp);
                      when st_19 == ((granule_unlock_spec (int_to_ptr v_44_tmp) st_18));
                      when v_45_tmp, st_20 == ((load_RData 8 v_g_rec st_19));
                      rely (int_is_granule v_45_tmp);
                      when st_21 == ((granule_unlock_transition_spec (int_to_ptr v_45_tmp) 1 st_20));
                      when st_22 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules 0) v_conv false st_21));
                      when st_24 == ((free_stack "smc_rec_create" st_0 st_22));
                      (Some (2, st_24))))
                  else (
                    when st_11 == ((free_rec_aux_granules_spec (ptr_offset v_rec_aux_granules 0) v_conv false st_10));
                    when st_13 == ((free_stack "smc_rec_create" st_0 st_11));
                    (Some (1, st_13))))
              | None => None
              end))
        else (
          when st_9 == ((free_stack "smc_rec_create" st_0 st_7));
          (Some (1, st_9))))
      else (
        when st_8 == ((free_stack "smc_rec_create" st_0 st_6));
        (Some (1, st_8)))).
...
Definition smc_rtt_fold_spec_low (v_rtt_addr: Z) (v_rd_addr: Z) (v_map_addr: Z) (v_ulevel: Z) (st: RData) : (option (Z * RData)) :=
  ...
  let v_wi := (mkPtr "stack_wi" 0) in
  let v_s2_ctx := (mkPtr "stack_s2_ctx" 0) in
  let v_ripas := (mkPtr "stack_ripas" 0) in
  let st_3 := st_0 in
...
Definition smc_rtt_create_6_low
  ...
  (st_26: RData) :
  option (Z * RData) :=
  anno (v_wi.(pbase) = "stack_wi");
  anno (v_wi.(poffset) = 0);
  anno (v_call16.(pbase) = "slot_delegated");
  anno (v_call14.(pbase) = "slot_rtt");
  anno (v_g_tbl.(pbase) = "stack_g0");
  anno (v_g_tbl.(poffset) = 0);
...
Definition smc_rtt_create_5_low
  ...
  anno (v_15_tmp < STACK_VIRT /\ v_15_tmp >= GRANULES_BASE);
...
Definition smc_rtt_create_4_low
  ...
  anno (v_16_tmp < STACK_VIRT /\ v_16_tmp >= GRANULES_BASE);
...
Definition smc_rtt_create_3_low
  ...
  anno (v_g_tbl.(pbase) = "stack_g0");
  anno (v_g_tbl.(poffset) = 0);
  anno (v_s2_ctx.(pbase) = "stack_s2_ctx");
  anno (v_s2_ctx.(poffset) = 0);
  ...
  anno (v_18_tmp < STACK_VIRT /\ v_18_tmp >= GRANULES_BASE);
  ...
  anno (v_23_tmp > 0);
  anno (v_23_tmp < STACK_VIRT);
  anno (v_23_tmp >= GRANULES_BASE);
  anno (v_23_tmp < MAX_ERR);
...
Definition smc_rtt_create_2_low
  ...
  anno (v_20_tmp < STACK_VIRT /\ v_20_tmp >= GRANULES_BASE);
...
Definition smc_rtt_create_spec_low (v_rtt_addr: Z) (v_rd_addr: Z) (v_map_addr: Z) (v_ulevel: Z) (st: RData) : (option (Z * RData)) :=
  ...
  then (
    ...
    anno (v_0_tmp < STACK_VIRT /\ v_0_tmp >= GRANULES_BASE);
    ...
    then (
      ...
      then (
        ...
        anno (v_9_tmp < STACK_VIRT /\ v_9_tmp >= GRANULES_BASE);
        ...
        anno (v_12_tmp < STACK_VIRT /\ v_12_tmp >= GRANULES_BASE);
  ...
  Definition smc_rtt_read_entry_spec (v_rd_addr: Z) (v_map_addr: Z) (v_ulevel: Z) (v_ret: Ptr) (st: RData) : (option RData) :=
    when st_0 == ((new_frame "smc_rtt_read_entry" st));
    rely (((v_ret.(poffset)) = (0)));
    rely (((v_ret.(pbase)) = ("stack_smc_result")));
    (* when v_wi, st_1 == ((alloc_stack "smc_rtt_read_entry" 24 8 st_0)); *)
    let v_wi := (mkPtr "stack_wi" 0) in
    when v_call, st_2 == ((find_lock_granule_spec v_rd_addr 2 st_1));
    if (ptr_eqb v_call (mkPtr "null" 0))
    then (
      when st_3 == ((store_RData 8 (ptr_offset v_ret 0) 1 st_2));
      (* when st_5 == ((free_stack "smc_rtt_read_entry" st_0 st_3)); *)
      (Some st_5))
    else (
      when v_call1, st_3 == ((granule_map_spec v_call 2 st_2));
      when v_call2, st_4 == ((validate_rtt_entry_cmds_spec v_map_addr v_ulevel v_call1 st_3));
      if v_call2
      then (
        when v_2_tmp, st_5 == ((load_RData 8 (ptr_offset v_call1 32) st_4));
        when v_call7, st_6 == ((realm_rtt_starting_level_spec v_call1 st_5));
        when v_call8, st_7 == ((realm_ipa_bits_spec v_call1 st_6));
        when st_8 == ((buffer_unmap_spec v_call1 st_7));
        when st_9 == ((granule_lock_spec (int_to_ptr v_2_tmp) 6 st_8));
        when st_10 == ((granule_unlock_spec v_call st_9));
        when st_11 == ((rtt_walk_lock_unlock_spec (int_to_ptr v_2_tmp) v_call7 v_call8 v_map_addr v_ulevel v_wi st_10));
        when v_3_tmp, st_12 == ((load_RData 8 (ptr_offset v_wi 0) st_11));
        when v_call9, st_13 == ((granule_map_spec (int_to_ptr v_3_tmp) 22 st_12));
        when v_5, st_14 == ((load_RData 8 (ptr_offset v_wi 8) st_13));
        when v_call11, st_15 == ((__tte_read_spec (ptr_offset v_call9 (8 * (v_5))) st_14));
        when v_6, st_16 == ((load_RData 8 (ptr_offset v_wi 16) st_15));
        when st_17 == ((store_RData 8 (ptr_offset v_ret 8) v_6 st_16));
        when st_18 == ((store_RData 8 (ptr_offset v_ret 24) 0 st_17));
        when st_19 == ((store_RData 8 (ptr_offset v_ret 32) 0 st_18));
        when v_call18, st_20 == ((s2tte_is_unassigned_spec v_call11 st_19));
        if v_call18
        then (
          when v_call20, st_21 == ((s2tte_get_ripas_spec v_call11 st_20));
          when st_22 == ((store_RData 8 (ptr_offset v_ret 16) 0 st_21));
          when st_23 == ((store_RData 8 (ptr_offset v_ret 32) v_call20 st_22));
          when st_25 == ((buffer_unmap_spec v_call9 st_23));
          when v_15_tmp, st_26 == ((load_RData 8 (ptr_offset v_wi 0) st_25));
          when st_27 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_26));
          when st_28 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_27));
          (* when st_31 == ((free_stack "smc_rtt_read_entry" st_0 st_28)); *)
          (Some st_31))
        else (
          when v_call25, st_21 == ((s2tte_is_destroyed_spec v_call11 st_20));
          if v_call25
          then (
            when st_22 == ((store_RData 8 (ptr_offset v_ret 16) 1 st_21));
            when st_25 == ((buffer_unmap_spec v_call9 st_22));
            when v_15_tmp, st_26 == ((load_RData 8 (ptr_offset v_wi 0) st_25));
            when st_27 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_26));
            rely (((0 <= (0)) /\ ((0 < (5)))));
            when st_28 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_27));
            ...
            when v_7, st_22 == ((load_RData 8 (ptr_offset v_wi 16) st_21));
            when v_call31, st_23 == ((s2tte_is_assigned_spec v_call11 v_7 st_22));
            if v_call31
            then (
              when st_24 == ((store_RData 8 (ptr_offset v_ret 16) 2 st_23));
              when v_8, st_25 == ((load_RData 8 (ptr_offset v_wi 16) st_24));
              when v_call36, st_26 == ((s2tte_pa_spec v_call11 v_8 st_25));
              when st_27 == ((store_RData 8 (ptr_offset v_ret 24) v_call36 st_26));
              when st_28 == ((store_RData 8 (ptr_offset v_ret 32) 0 st_27));
              when st_32 == ((buffer_unmap_spec v_call9 st_28));
              when v_15_tmp, st_33 == ((load_RData 8 (ptr_offset v_wi 0) st_32));
              when st_34 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_33));
              when st_35 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_34));
              (* when st_38 == ((free_stack "smc_rtt_read_entry" st_0 st_35)); *)
              (Some st_38))
            else (
              when v_9, st_24 == ((load_RData 8 (ptr_offset v_wi 16) st_23));
              when v_call43, st_25 == ((s2tte_is_valid_spec v_call11 v_9 st_24));
              if v_call43
              then (
                when st_26 == ((store_RData 8 (ptr_offset v_ret 16) 2 st_25));
                when v_10, st_27 == ((load_RData 8 (ptr_offset v_wi 16) st_26));
                when v_call48, st_28 == ((s2tte_pa_spec v_call11 v_10 st_27));
                when st_29 == ((store_RData 8 (ptr_offset v_ret 24) v_call48 st_28));
                when st_30 == ((store_RData 8 (ptr_offset v_ret 32) 1 st_29));
                when st_35 == ((buffer_unmap_spec v_call9 st_30));
                when v_15_tmp, st_36 == ((load_RData 8 (ptr_offset v_wi 0) st_35));
                when st_37 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_36));
                when st_38 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_37));
                (* when st_41 == ((free_stack "smc_rtt_read_entry" st_0 st_38)); *)
                (Some st_41))
              else (
                when v_11, st_26 == ((load_RData 8 (ptr_offset v_wi 16) st_25));
                when v_call55, st_27 == ((s2tte_is_valid_ns_spec v_call11 v_11 st_26));
                if v_call55
                then (
                  when st_28 == ((store_RData 8 (ptr_offset v_ret 16) 4 st_27));
                  when v_12, st_29 == ((load_RData 8 (ptr_offset v_wi 16) st_28));
                  when v_call60, st_30 == ((host_ns_s2tte_spec v_call11 v_12 st_29));
                  when st_31 == ((store_RData 8 (ptr_offset v_ret 24) v_call60 st_30));
                  when st_37 == ((buffer_unmap_spec v_call9 st_31));
                  when v_15_tmp, st_38 == ((load_RData 8 (ptr_offset v_wi 0) st_37));
                  when st_39 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_38));
                  when st_40 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_39));
                  (* when st_43 == ((free_stack "smc_rtt_read_entry" st_0 st_40)); *)
                  (Some st_43))
                else (
                  when v_13, st_28 == ((load_RData 8 (ptr_offset v_wi 16) st_27));
                  when v_call65, st_29 == ((s2tte_is_table_spec v_call11 v_13 st_28));
                  if v_call65
                  then (
                    when st_30 == ((store_RData 8 (ptr_offset v_ret 16) 3 st_29));
                    when v_14, st_31 == ((load_RData 8 (ptr_offset v_wi 16) st_30));
                    when v_call70, st_32 == ((s2tte_pa_table_spec v_call11 v_14 st_31));
                    when st_33 == ((store_RData 8 (ptr_offset v_ret 24) v_call70 st_32));
                    when st_40 == ((buffer_unmap_spec v_call9 st_33));
                    when v_15_tmp, st_41 == ((load_RData 8 (ptr_offset v_wi 0) st_40));
                    when st_42 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_41));
                    when st_43 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_42));
                    (* when st_46 == ((free_stack "smc_rtt_read_entry" st_0 st_43)); *)
                    (Some st_46))
                  else (
                    when st_36 == ((buffer_unmap_spec v_call9 st_29));
                    when v_15_tmp, st_37 == ((load_RData 8 (ptr_offset v_wi 0) st_36));
                    when st_38 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_37));
                    when st_39 == ((store_RData 8 (ptr_offset v_ret 0) 0 st_38));
                    (* when st_42 == ((free_stack "smc_rtt_read_entry" st_0 st_39)); *)
                    (Some st_42))))))))
      else (
        when st_5 == ((buffer_unmap_spec v_call1 st_4));
        when st_6 == ((granule_unlock_spec v_call st_5));
        when st_7 == ((store_RData 8 (ptr_offset v_ret 0) 1 st_6));
        (* when st_10 == ((free_stack "smc_rtt_read_entry" st_0 st_7)); *)
        (Some st_10))).

  Definition smc_rec_enter_spec_low (v_rec_addr: Z) (v_rec_run_addr: Z) (st: RData) : (option (Z * RData)) :=
    (* when st_0 == ((new_frame "smc_rec_enter" st)); *)
    (* when v_rec_run, st_1 == ((alloc_stack "smc_rec_enter" 4096 8 st_0)); *)
    let st_2 := st_0 in
    let v_rec_run := (mkPtr "stack_rmi_rec_run" 0) in
    when v_call, st_2 == ((memset_spec (ptr_offset v_rec_run 2048) 0 2048 st_1));
    when v_call1, st_3 == ((find_granule_spec v_rec_run_addr st_2));
    if (ptr_eqb v_call1 (mkPtr "null" 0))
    then (
      when st_5 == ((free_stack "smc_rec_enter" st_0 st_3));
      (Some (1, st_5)))
    else (
      when v_1, st_4 == ((load_RData 4 (ptr_offset v_call1 4) st_3));
      if (v_1 =? (0))
      then (
        when v_call3, st_5 == ((find_lock_unused_granule_spec v_rec_addr 3 st_4));
        when v_call4, st_6 == ((ptr_is_err_spec v_call3 st_5));
        if v_call4
        then (
          when v_call6, st_7 == ((ptr_status_spec v_call3 st_6));
          when st_9 == ((free_stack "smc_rec_enter" st_0 st_7));
          (Some (v_call6, st_9)))
        else (
          when st_7 == ((atomic_granule_get_spec v_call3 st_6));
          when st_8 == ((granule_unlock_spec v_call3 st_7));
          when v_call9, st_9 == ((ns_buffer_read_spec 0 v_call1 0 2048 v_rec_run st_8));
          if v_call9
          then (
            when v_call12, st_10 == ((granule_map_spec v_call3 3 st_9));
            when v_6_tmp, st_11 == ((load_RData 8 (ptr_offset v_call12 904) st_10));
            when v_call13, st_12 == ((granule_map_spec (int_to_ptr v_6_tmp) 2 st_11));
            when v_call14, st_13 == ((get_rd_state_unlocked_spec v_call13 st_12));
            when st_14 == ((buffer_unmap_spec v_call13 st_13));
            if (v_call14 =? (2))
            then (
              when v_call18, st_15 == ((pack_return_code_spec 2 1 st_14));
              when st_17 == ((buffer_unmap_spec v_call12 st_15));
              if (v_call18 =? (0))
              then (
                when v_call70, st_18 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_17));
                if v_call70
                then (
                  when st_21 == ((atomic_granule_put_release_spec v_call3 st_18));
                  when st_19 == ((free_stack "smc_rec_enter" st_0 st_21));
                  (Some (0, st_19)))
                else (
                  when st_21 == ((atomic_granule_put_release_spec v_call3 st_18));
                  when st_19 == ((free_stack "smc_rec_enter" st_0 st_21));
                ...
                when st_19 == ((atomic_granule_put_release_spec v_call3 st_17));
                when st_18 == ((free_stack "smc_rec_enter" st_0 st_19));
                (Some (v_call18, st_18))))
            else (
              if (v_call14 =? (0))
              then (
                when v_call15, st_15 == ((pack_return_code_spec 2 0 st_14));
                when st_18 == ((buffer_unmap_spec v_call12 st_15));
                if (v_call15 =? (0))
                then (
                  when v_call70, st_19 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_18));
                  if v_call70
                  then (
                    when st_22 == ((atomic_granule_put_release_spec v_call3 st_19));
                    when st_17 == ((free_stack "smc_rec_enter" st_0 st_22));
                    (Some (0, st_17)))
                  else (
                    when st_22 == ((atomic_granule_put_release_spec v_call3 st_19));
                    when st_17 == ((free_stack "smc_rec_enter" st_0 st_22));
                  ...
                  when st_20 == ((atomic_granule_put_release_spec v_call3 st_18));
                  when st_17 == ((free_stack "smc_rec_enter" st_0 st_20));
                  (Some (v_call15, st_17))))
              else (
                when v_9, st_15 == ((load_RData 1 (ptr_offset v_call12 16) st_14));
                if ((v_9 & (1)) =? (0))
                then (
                  when st_19 == ((buffer_unmap_spec v_call12 st_15));
                  when st_21 == ((atomic_granule_put_release_spec v_call3 st_19));
                  when st_17 == ((free_stack "smc_rec_enter" st_0 st_21));
                  (Some (3, st_17)))
                else (
                  when v_11, st_16 == ((load_RData 1 (ptr_offset v_call12 960) st_15));
                  if ((v_11 & (1)) =? (0))
                  then (
                    when st_17 == ((gic_copy_state_from_ns_spec (ptr_offset v_call12 584) (ptr_offset v_rec_run 0) st_16));
                    when v_call28, st_18 == ((gic_validate_state_spec (ptr_offset v_call12 584) st_17));
                    if v_call28
                    then (
                      when v_call32, st_19 == ((complete_mmio_emulation_spec v_call12 (ptr_offset v_rec_run 0) st_18));
                      if v_call32
                      then (
                        when v_call36, st_20 == ((complete_sea_insertion_spec v_call12 (ptr_offset v_rec_run 0) st_19));
                        if v_call36
                        then (
                          when st_21 == ((complete_set_ripas_spec v_call12 st_20));
                          when st_22 == ((complete_sysreg_emulation_spec v_call12 (ptr_offset v_rec_run 0) st_21));
                          when v_call40, st_23 == ((complete_host_call_spec v_call12 v_rec_run st_22));
                          if v_call40
                          then (
                            when st_24 == ((reset_last_run_info_spec v_call12 st_23));
                            when v_15, st_25 == ((load_RData 8 (ptr_offset v_call12 832) st_24));
                            when st_26 == ((store_RData 8 (ptr_offset v_call12 808) v_15 st_25));
                            when v_17, st_27 == ((load_RData 8 (ptr_offset v_rec_run 0) st_26));
                            if ((v_17 & (4)) =? (0))
                            then (
                              when v_18, st_29 == ((load_RData 8 (ptr_offset v_rec_run 0) st_27));
                              if ((v_18 & (8)) =? (0))
                              then (
                                when st_31 == ((rec_run_loop_spec v_call12 (ptr_offset v_rec_run 2048) st_29));
                                when st_32 == ((gic_copy_state_to_ns_spec (ptr_offset v_call12 584) (ptr_offset v_rec_run 2048) st_31));
                                when st_41 == ((buffer_unmap_spec v_call12 st_32));
                                when v_call70, st_42 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_41));
                                if v_call70
                                then (
                                  when st_45 == ((atomic_granule_put_release_spec v_call3 st_42));
                                  when st_30 == ((free_stack "smc_rec_enter" st_0 st_45));
                                  (Some (0, st_30)))
                                else (
                                  when st_45 == ((atomic_granule_put_release_spec v_call3 st_42));
                                  when st_30 == ((free_stack "smc_rec_enter" st_0 st_45));
                                ...
                                when v_19, st_30 == ((load_RData 8 (ptr_offset v_call12 808) st_29));
                                when st_31 == ((store_RData 8 (ptr_offset v_call12 808) (v_19 |' (16384)) st_30));
                                when st_33 == ((rec_run_loop_spec v_call12 (ptr_offset v_rec_run 2048) st_31));
                                when st_34 == ((gic_copy_state_to_ns_spec (ptr_offset v_call12 584) (ptr_offset v_rec_run 2048) st_33));
                                when st_43 == ((buffer_unmap_spec v_call12 st_34));
                                when v_call70, st_44 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_43));
                                if v_call70
                                then (
                                  when st_47 == ((atomic_granule_put_release_spec v_call3 st_44));
                                  when st_32 == ((free_stack "smc_rec_enter" st_0 st_47));
                                  (Some (0, st_32)))
                                else (
                                  when st_47 == ((atomic_granule_put_release_spec v_call3 st_44));
                                  when st_32 == ((free_stack "smc_rec_enter" st_0 st_47));
                              ...
                              when st_28 == ((store_RData 8 (ptr_offset v_call12 808) (v_15 |' (8192)) st_27));
                              when v_18, st_30 == ((load_RData 8 (ptr_offset v_rec_run 0) st_28));
                              if ((v_18 & (8)) =? (0))
                              then (
                                when st_32 == ((rec_run_loop_spec v_call12 (ptr_offset v_rec_run 2048) st_30));
                                when st_33 == ((gic_copy_state_to_ns_spec (ptr_offset v_call12 584) (ptr_offset v_rec_run 2048) st_32));
                                when st_42 == ((buffer_unmap_spec v_call12 st_33));
                                when v_call70, st_43 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_42));
                                if v_call70
                                then (
                                  when st_46 == ((atomic_granule_put_release_spec v_call3 st_43));
                                  when st_31 == ((free_stack "smc_rec_enter" st_0 st_46));
                                  (Some (0, st_31)))
                                else (
                                  when st_46 == ((atomic_granule_put_release_spec v_call3 st_43));
                                  when st_31 == ((free_stack "smc_rec_enter" st_0 st_46));
                                ...
                                when v_19, st_31 == ((load_RData 8 (ptr_offset v_call12 808) st_30));
                                when st_32 == ((store_RData 8 (ptr_offset v_call12 808) (v_19 |' (16384)) st_31));
                                when st_34 == ((rec_run_loop_spec v_call12 (ptr_offset v_rec_run 2048) st_32));
                                when st_35 == ((gic_copy_state_to_ns_spec (ptr_offset v_call12 584) (ptr_offset v_rec_run 2048) st_34));
                                when st_44 == ((buffer_unmap_spec v_call12 st_35));
                                when v_call70, st_45 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_44));
                                if v_call70
                                then (
                                  when st_48 == ((atomic_granule_put_release_spec v_call3 st_45));
                                  when st_33 == ((free_stack "smc_rec_enter" st_0 st_48));
                                  (Some (0, st_33)))
                                else (
                                  when st_48 == ((atomic_granule_put_release_spec v_call3 st_45));
                                  when st_33 == ((free_stack "smc_rec_enter" st_0 st_48));
                            ...
                            when st_32 == ((buffer_unmap_spec v_call12 st_23));
                            when v_call70, st_33 == ((ns_buffer_write_spec 0 v_call1 2048 2048 (ptr_offset v_rec_run 2048) st_32));
                            if v_call70
                            then (
                              when st_36 == ((atomic_granule_put_release_spec v_call3 st_33));
                              when st_25 == ((free_stack "smc_rec_enter" st_0 st_36));
                              (Some (0, st_25)))
                            else (
                              when st_36 == ((atomic_granule_put_release_spec v_call3 st_33));
                              when st_25 == ((free_stack "smc_rec_enter" st_0 st_36));
                          ...
                          when st_28 == ((buffer_unmap_spec v_call12 st_20));
                          when st_30 == ((atomic_granule_put_release_spec v_call3 st_28));
                          when st_22 == ((free_stack "smc_rec_enter" st_0 st_30));
                          (Some (3, st_22))))
                      else (
                        when st_26 == ((buffer_unmap_spec v_call12 st_19));
                        when st_28 == ((atomic_granule_put_release_spec v_call3 st_26));
                        when st_21 == ((free_stack "smc_rec_enter" st_0 st_28));
                        (Some (3, st_21))))
                    else (
                      when st_24 == ((buffer_unmap_spec v_call12 st_18));
                      when st_26 == ((atomic_granule_put_release_spec v_call3 st_24));
                      when st_20 == ((free_stack "smc_rec_enter" st_0 st_26));
                      (Some (3, st_20))))
                  else (
                    when st_21 == ((buffer_unmap_spec v_call12 st_16));
                    when st_23 == ((atomic_granule_put_release_spec v_call3 st_21));
                    when st_18 == ((free_stack "smc_rec_enter" st_0 st_23));
                    (Some (3, st_18)))))))
          else (
            when st_10 == ((atomic_granule_put_release_spec v_call3 st_9));
            when st_12 == ((free_stack "smc_rec_enter" st_0 st_10));
            (Some (1, st_12)))))
      else (
        when st_6 == ((free_stack "smc_rec_enter" st_0 st_4));
        (Some (1, st_6)))).

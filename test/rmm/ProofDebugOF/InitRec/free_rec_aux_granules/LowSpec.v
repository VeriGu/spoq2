    ...
    | (S _N__0) =>
      ...
      | (Some (__break___0, v_indvars_iv_0, v_rec_aux_0, v_scrub_0, v_wide_trip_count_0, st_0)) =>
        ...
        then (Some (true, v_indvars_iv_0, v_rec_aux_0, v_scrub_0, v_wide_trip_count_0, st_0))
          ...
          when v_0_tmp, st_1 == ((load_RData 8 (ptr_offset v_rec_aux_0 (8 * (v_indvars_iv_0))) st_0));
          ...
          then (
            ...
            match (
              ...
              then (Some (false, true, (v_indvars_iv_0 + (1)), st_5))
              else (Some (true, false, v_indvars_iv_0, st_5))
            ) with
            | (Some (break___1, __continue__, v_indvars_iv_1, st_6)) =>
              if break___1
              then (Some (true, v_indvars_iv_1, v_rec_aux_0, true, v_wide_trip_count_0, st_6))
              else (Some (false, v_indvars_iv_1, v_rec_aux_0, true, v_wide_trip_count_0, st_6))
            | None => None
            end)
          else (
            ...
            match (
              if (((v_indvars_iv_0 + (1)) - (v_wide_trip_count_0)) <>? (0))
              then (Some (false, true, (v_indvars_iv_0 + (1)), st_4))
              else (Some (true, false, v_indvars_iv_0, st_4))
            ) with
            | (Some (break___1, __continue__, v_indvars_iv_1, st_5)) =>
              if break___1
              then (Some (true, v_indvars_iv_1, v_rec_aux_0, false, v_wide_trip_count_0, st_5))
              else (Some (false, v_indvars_iv_1, v_rec_aux_0, false, v_wide_trip_count_0, st_5))
            | None => None
            end))
      | None => None
      end

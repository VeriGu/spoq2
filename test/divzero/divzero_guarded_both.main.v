...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "divzero_guarded_both".
Definition PROJ_BASE: string := "divzero_guarded_both".
Definition PROJ_BC_PATH: string := "divzero_guarded_both.bc".

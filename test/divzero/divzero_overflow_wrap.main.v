...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "divzero_overflow_wrap".
Definition PROJ_BASE: string := "divzero_overflow_wrap".
Definition PROJ_BC_PATH: string := "divzero_overflow_wrap.bc".
...
Parameter len_spec : (RData-> (option ((int32) * RData))).
Parameter rps_spec : (RData-> (option ((int32) * RData))).

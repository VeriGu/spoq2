...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "divzero_added_by_patch".
Definition PROJ_BASE: string := "divzero_added_by_patch".
Definition PROJ_BC_PATH: string := "divzero_added_by_patch.bc".

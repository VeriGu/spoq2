...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "divzero_only_on_one_path".
Definition PROJ_BASE: string := "divzero_only_on_one_path".
Definition PROJ_BC_PATH: string := "divzero_only_on_one_path.bc".
...
Parameter flag_spec : (RData-> (option ((int32) * RData))).

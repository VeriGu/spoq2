...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "align_cache_wrong_patch".
Definition PROJ_BASE: string := "align_cache_wrong_patch".
Definition PROJ_BC_PATH: string := "align_cache_wrong_patch.bc".

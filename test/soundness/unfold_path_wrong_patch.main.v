...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "unfold_path_wrong_patch".
Definition PROJ_BASE: string := "unfold_path_wrong_patch".
Definition PROJ_BC_PATH: string := "unfold_path_wrong_patch.bc".

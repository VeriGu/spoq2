...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "cache_forward_wrong_patch".
Definition PROJ_BASE: string := "cache_forward_wrong_patch".
Definition PROJ_BC_PATH: string := "cache_forward_wrong_patch.bc".

...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "loop_invariant_false".
Definition PROJ_BASE: string := "loop_invariant_false".
Definition PROJ_BC_PATH: string := "loop_invariant_false.bc".
...
Loop_inv vuln_loop_0 (arg_dummy0 = 0 /\ arg_dummy0 = 1).

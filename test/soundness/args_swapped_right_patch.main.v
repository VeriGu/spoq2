...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "args_swapped_right_patch".
Definition PROJ_BASE: string := "args_swapped_right_patch".
Definition PROJ_BC_PATH: string := "args_swapped_right_patch.bc".

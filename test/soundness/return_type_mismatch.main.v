...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "return_type_mismatch".
Definition PROJ_BASE: string := "return_type_mismatch".
Definition PROJ_BC_PATH: string := "return_type_mismatch.bc".

...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "args_extra_param_wrong_patch".
Definition PROJ_BASE: string := "args_extra_param_wrong_patch".
Definition PROJ_BC_PATH: string := "args_extra_param_wrong_patch.bc".

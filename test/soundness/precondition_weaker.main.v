...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "precondition_weaker".
Definition PROJ_BASE: string := "precondition_weaker".
Definition PROJ_BC_PATH: string := "precondition_weaker.bc".

...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "loop_invariant_inductive".
Definition PROJ_BASE: string := "loop_invariant_inductive".
Definition PROJ_BC_PATH: string := "loop_invariant_inductive.bc".
...
Loop_inv vuln_loop_0 (st = st_old).

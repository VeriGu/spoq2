...
Section ValidateAddr_validate_map_addr_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque addr_is_level_aligned_spec.
  Local Opaque rd_is_locked.
  Local Opaque realm_ipa_size_spec.
    Lemma f_validate_map_addr_correct:
      forall v_map_addr v_level v_rd st st' res
        ...
        exec_func RealmInfo_layer code "validate_map_addr"
...
End ValidateAddr_validate_map_addr_CodeProof.

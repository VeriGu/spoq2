...
Require Import SMCHandler.smc_rec_destroy.LowSpec.
Require Import Zwf.
...
Section SMCHandler_smc_rec_destroy_CodeProof.
  ...
  Local Opaque free_rec_aux_granules_spec.
  ...
  Local Opaque ptr_status_spec.
    Lemma f_smc_rec_destroy_correct:
      forall v_rec_addr st st' res
             (Hspec: smc_rec_destroy_spec_low v_rec_addr st = Some (res, st')),
        exec_func InitRec_layer code "smc_rec_destroy"
                  [VInt v_rec_addr]
                  st st' (Some (VInt res)).
    Proof.
...
End SMCHandler_smc_rec_destroy_CodeProof.

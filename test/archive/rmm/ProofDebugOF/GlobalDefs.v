...
Section GlobalDefs.
  ...
  Definition store_s_smc_result (sz: Z) (ofs: Z) (v: Z) (st: s_smc_result) : (option s_smc_result) :=
    ...
    then (
      let idx := ((ofs - (0)) / (8)) in
      (Some (st.[e_x] :< ((st.(e_x)) # idx == v))))
    else None.

  Definition load_u_anon_12 (sz: Z) (ofs: Z) (st: u_anon_12) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_union_anon_12_0)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (505))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_12_1)) @ idx)))
      else None).

  Definition store_u_anon_12 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_12) : (option u_anon_12) :=
    if (ofs =? (0))
    then (Some (st.[e_union_anon_12_0] :< v))
    else (
      if ((ofs >=? (1)) && ((ofs <? (505))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_12_1] :< ((st.(e_union_anon_12_1)) # idx == v))))
      else None).
  ...
  Definition load_u_anon_1 (sz: Z) (ofs: Z) (st: u_anon_1) : (option Z) :=
    ...
    then (
      let idx := ((ofs - (0)) / (8)) in
      (Some ((st.(e_union_anon_1_0)) @ idx)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (9))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_1_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_1 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_1) : (option u_anon_1) :=
    ...
    then (
      let idx := ((ofs - (0)) / (8)) in
      (Some (st.[e_union_anon_1_0] :< ((st.(e_union_anon_1_0)) # idx == v))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (9))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_1_1] :< ((st.(e_union_anon_1_1)) # idx == v))))
      else None).
  ...
  Definition load_u_anon_1_15 (sz: Z) (ofs: Z) (st: u_anon_1_15) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_anon_14 sz elem_ofs (st.(e_union_anon_1_15_0))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (1145))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_1_15_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_1_15 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_1_15) : (option u_anon_1_15) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_1_15_0] :< ret)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (1145))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_1_15_1] :< ((st.(e_union_anon_1_15_1)) # idx == v))))
      else None).
  ...
  Definition load_s_rmi_rec_entry (sz: Z) (ofs: Z) (st: s_rmi_rec_entry) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_u_anon_12 sz elem_ofs (st.(e_rmi_rec_entry_0))))
    else (
      if ((ofs >=? (512)) && ((ofs <? (768))))
      then (
        let elem_ofs := (ofs - (512)) in
        (load_u_anon_1 sz elem_ofs (st.(e_rmi_rec_entry_1))))
      else (
        if ((ofs >=? (768)) && ((ofs <? (2048))))
        then (
          let elem_ofs := (ofs - (768)) in
          (load_u_anon_1_15 sz elem_ofs (st.(e_rmi_rec_entry_2))))
        else None)).
  ...
  Definition load_u_anon_7_148 (sz: Z) (ofs: Z) (st: u_anon_7_148) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_rmi_rec_entry sz elem_ofs (st.(e_union_anon_7_148_0))))
    else None.
  ...
  Definition store_u_anon_7_148 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_7_148) : (option u_anon_7_148) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_7_148_0] :< ret)))
    else None.
  ...
  Definition load_u_anon_0 (sz: Z) (ofs: Z) (st: u_anon_0) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_anon_8 sz elem_ofs (st.(e_union_anon_0_0))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_0_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_0 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_0) : (option u_anon_0) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_0_0] :< ret)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_0_1] :< ((st.(e_union_anon_0_1)) # idx == v))))
      else None).
  ...
  Definition load_u_anon_2 (sz: Z) (ofs: Z) (st: u_anon_2) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_anon_3 sz elem_ofs (st.(e_union_anon_2_0))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (105))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_2_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_2 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_2) : (option u_anon_2) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_2_0] :< ret)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (105))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_2_1] :< ((st.(e_union_anon_2_1)) # idx == v))))
      else None).

  Definition load_s_anon_5 (sz: Z) (ofs: Z) (st: s_anon_5) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_cntp_ctl)))
    else (
      if (ofs =? (8))
      then (Some (st.(e_cntp_cval)))
      else (
        if (ofs =? (16))
        then (Some (st.(e_cntv_ctl)))
        else (
          if (ofs =? (24))
          then (Some (st.(e_cntv_cval)))
          else None))).

  Definition store_s_anon_5 (sz: Z) (ofs: Z) (v: Z) (st: s_anon_5) : (option s_anon_5) :=
    if (ofs =? (0))
    then (Some (st.[e_cntp_ctl] :< v))
    else (
      if (ofs =? (8))
      then (Some (st.[e_cntp_cval] :< v))
      else (
        if (ofs =? (16))
        then (Some (st.[e_cntv_ctl] :< v))
        else (
          if (ofs =? (24))
          then (Some (st.[e_cntv_cval] :< v))
          else None))).
  ...
  Definition load_u_anon_4 (sz: Z) (ofs: Z) (st: u_anon_4) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_anon_5 sz elem_ofs (st.(e_union_anon_4_0))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (225))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_4_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_4 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_4) : (option u_anon_4) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_4_0] :< ret)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (225))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_4_1] :< ((st.(e_union_anon_4_1)) # idx == v))))
      else None).

  Definition load_s_anon_7 (sz: Z) (ofs: Z) (st: s_anon_7) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_ripas_base)))
    else (
      if (ofs =? (8))
      then (Some (st.(e_ripas_size)))
      else (
        if (ofs =? (16))
        then (Some (st.(e_ripas_value)))
        else None)).

  Definition store_s_anon_7 (sz: Z) (ofs: Z) (v: Z) (st: s_anon_7) : (option s_anon_7) :=
    if (ofs =? (0))
    then (Some (st.[e_ripas_base] :< v))
    else (
      if (ofs =? (8))
      then (Some (st.[e_ripas_size] :< v))
      else (
        if (ofs =? (16))
        then (Some (st.[e_ripas_value] :< v))
        else None)).
  ...
  Definition load_u_anon_6_9 (sz: Z) (ofs: Z) (st: u_anon_6_9) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_anon_7 sz elem_ofs (st.(e_union_anon_6_9_0))))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_6_9_1)) @ idx)))
      else None).
  ...
  Definition store_u_anon_6_9 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_6_9) : (option u_anon_6_9) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_6_9_0] :< ret)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_6_9_1] :< ((st.(e_union_anon_6_9_1)) # idx == v))))
      else None).

  Definition load_u_anon_8 (sz: Z) (ofs: Z) (st: u_anon_8) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_union_anon_8_0)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (253))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_8_1)) @ idx)))
      else None).

  Definition store_u_anon_8 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_8) : (option u_anon_8) :=
    if (ofs =? (0))
    then (Some (st.[e_union_anon_8_0] :< v))
    else (
      if ((ofs >=? (1)) && ((ofs <? (253))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_8_1] :< ((st.(e_union_anon_8_1)) # idx == v))))
      else None).

  Definition load_u_anon_9 (sz: Z) (ofs: Z) (st: u_anon_9) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_union_anon_9_0)))
    else None.

  Definition store_u_anon_9 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_9) : (option u_anon_9) :=
    if (ofs =? (0))
    then (Some (st.[e_union_anon_9_0] :< v))
    else None.

  Definition load_u_anon_11 (sz: Z) (ofs: Z) (st: u_anon_11) : (option Z) :=
    if (ofs =? (0))
    then (Some (st.(e_union_anon_11_0)))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some ((st.(e_union_anon_11_1)) @ idx)))
      else None).

  Definition store_u_anon_11 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_11) : (option u_anon_11) :=
    if (ofs =? (0))
    then (Some (st.[e_union_anon_11_0] :< v))
    else (
      if ((ofs >=? (1)) && ((ofs <? (233))))
      then (
        let idx := ((ofs - (1)) / (1)) in
        (Some (st.[e_union_anon_11_1] :< ((st.(e_union_anon_11_1)) # idx == v))))
      else None).
  ...
  Definition load_s_rmi_rec_exit (sz: Z) (ofs: Z) (st: s_rmi_rec_exit) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_u_anon_7 sz elem_ofs (st.(e_rmi_rec_exit_0))))
    else (
      if ((ofs >=? (256)) && ((ofs <? (512))))
      then (
        let elem_ofs := (ofs - (256)) in
        (load_u_anon_0 sz elem_ofs (st.(e_rmi_rec_exit_1))))
      else (
        if ((ofs >=? (512)) && ((ofs <? (768))))
        then (
          let elem_ofs := (ofs - (512)) in
          (load_u_anon_1 sz elem_ofs (st.(e_rmi_rec_exit_2))))
        else (
          if ((ofs >=? (768)) && ((ofs <? (1024))))
          then (
            let elem_ofs := (ofs - (768)) in
            (load_u_anon_2 sz elem_ofs (st.(e_rmi_rec_exit_3))))
          else (
            if ((ofs >=? (1024)) && ((ofs <? (1280))))
            then (
              let elem_ofs := (ofs - (1024)) in
              (load_u_anon_4 sz elem_ofs (st.(e_rmi_rec_exit_4))))
            else (
              if ((ofs >=? (1280)) && ((ofs <? (1536))))
              then (
                let elem_ofs := (ofs - (1280)) in
                (load_u_anon_6_9 sz elem_ofs (st.(e_rmi_rec_exit_5))))
              else (
                if ((ofs >=? (1536)) && ((ofs <? (1792))))
                then (
                  let elem_ofs := (ofs - (1536)) in
                  (load_u_anon_8 sz elem_ofs (st.(e_rmi_rec_exit_6))))
                else (
                  if ((ofs >=? (1792)) && ((ofs <? (1800))))
                  then (
                    let elem_ofs := (ofs - (1792)) in
                    (load_u_anon_9 sz elem_ofs (st.(e_rmi_rec_exit_7))))
                  else (
                    if ((ofs >=? (1800)) && ((ofs <? (1808))))
                    then (
                      let elem_ofs := (ofs - (1800)) in
                      (load_u_anon_9 sz elem_ofs (st.(e_rmi_rec_exit_8))))
                    else (
                      if ((ofs >=? (1808)) && ((ofs <? (2048))))
                      then (
                        let elem_ofs := (ofs - (1808)) in
                        (load_u_anon_11 sz elem_ofs (st.(e_rmi_rec_exit_9))))
                      else None))))))))).
  ...
  Definition load_u_anon_12_150 (sz: Z) (ofs: Z) (st: u_anon_12_150) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_s_rmi_rec_exit sz elem_ofs (st.(e_union_anon_12_150_0))))
    else None.
  ...
  Definition store_u_anon_12_150 (sz: Z) (ofs: Z) (v: Z) (st: u_anon_12_150) : (option u_anon_12_150) :=
    ...
    then (
      ...
      (Some (st.[e_union_anon_12_150_0] :< ret)))
    else None.
  ...
  Definition load_s_rmi_rec_run (sz: Z) (ofs: Z) (st: s_rmi_rec_run) : (option Z) :=
    ...
    then (
      let elem_ofs := (ofs - (0)) in
      (load_u_anon_7_148 sz elem_ofs (st.(e_rmi_rec_run_0))))
    else (
      if ((ofs >=? (2048)) && ((ofs <? (4096))))
      then (
        let elem_ofs := (ofs - (2048)) in
        (load_u_anon_12_150 sz elem_ofs (st.(e_rmi_rec_run_1))))
      else None).
  ...
  Definition store_s_rmi_rec_run (sz: Z) (ofs: Z) (v: Z) (st: s_rmi_rec_run) : (option s_rmi_rec_run) :=
    ...
    then (
      ...
      (Some (st.[e_rmi_rec_run_0] :< ret)))
    else (
      if ((ofs >=? (2048)) && ((ofs <? (4096))))
      then (
        let elem_ofs := (ofs - (2048)) in
        when ret == ((store_u_anon_12_150 sz elem_ofs v (st.(e_rmi_rec_run_1))));
        (Some (st.[e_rmi_rec_run_1] :< ret)))
      else None).

  Definition load_s_granule (sz: Z) (ofs: Z) (sg: s_granule) : (option Z) :=
    if (ofs =? (4))
    then (Some (sg.(e_state)))
    else (
      if (ofs =? (8))
      then (Some (sg.(e_refcount)))
      else None).
                                  ...
                                  then (
                                    ...
                                    then (
                                      ...
                                      then (
                                        ...
                                        if ((p.(pbase)) =s ("stack_rec_aux_granules"))
                                        then (
                                          let idx := ((p.(poffset)) / (8)) in
                        ...
                        then (
                          ...
                          then (
                            ...
                            then (
                              ...
                              (Some (st.[stack].[stack_rec_aux_granules] :< new_ptr)))
                            else (
                              if ((p.(pbase)) =s ("stack_gs"))
                              then (
                                let idx := ((p.(poffset)) / (40)) in
  ...
  Fixpoint walk_rtt_level (n: nat) (sh: Shared) (lvl: Z) (rd: Z) (gfn: Z) (pte: Z) : nat -> (Shared -> (Z -> Z -> Z -> Z -> (Z * Z)))))) :=
    ...
    | O => (lvl, pte)
    | (S n') =>
      let (lvl', pte') := (walk_rtt_level n' sh lvl rd gfn pte) in
      let rtt_idx' := (pte_to_gidx pte') in
      if ((((sh.(granules)) @ rtt_idx').(e_state)) =? (GRANULE_STATE_RTT))
      then (
  ...
  Definition rd_rtt (sh: Shared) (rd: Z) : Z :=
    (((((sh.(granule_data)) @ rd).(g_rd)).(e_rd_s2_ctx)).(e_rls2ctx_g_rtt)).

  Definition walk_star (sh: Shared) (rd: Z) (gfn: Z) (rtt_idx: Z) : Prop :=
    (exists (lvl: Z) (pte: Z) (N: nat), (((walk_rtt_level N sh 0 rd gfn (gidx_to_table_pte (rd_rtt sh rd))) = ((lvl, pte))) /\ ((rtt_idx = ((pte_to_gidx pte)))))).

  Definition walk_rtt (sh: Shared) (rd: Z) (gfn: Z) : (option Z) :=
    let rtt_pte := (gidx_to_table_pte (rd_rtt sh rd)) in
    let (lvl', pte') := (walk_rtt_level (z_to_nat 4) sh 0 rd gfn rtt_pte) in
    if (PTE_IS_VALID pte')
    then (
  ...
  Definition pte_table_equiv (pte: Z) (table: (ZMap.t Z)) : Prop :=
    (((PTE_IS_TABLE pte) = (false)) /\
      ((forall (idx: Z), if ((pte_to_gidx pte) =? (0))
      then ((pte_to_gidx (table @ idx)) = (0))
      else (((PTE_PERM pte) = ((PTE_PERM (table @ idx)))) /\ (((pte_to_gidx (table @ idx)) = (((pte_to_gidx pte) + (idx))))))))).
...
#[global] Hint Unfold load_u_anon_12: spec.
#[global] Hint Unfold store_u_anon_12: spec.
#[global] Hint Unfold load_u_anon_1: spec.
#[global] Hint Unfold store_u_anon_1: spec.
#[global] Hint Unfold load_u_anon_1_15: spec.
#[global] Hint Unfold load_s_anon_14: spec.
#[global] Hint Unfold store_s_anon_14: spec.
#[global] Hint Unfold store_u_anon_1_15: spec.
#[global] Hint Unfold load_s_rmi_rec_entry: spec.
#[global] Hint Unfold store_s_rmi_rec_entry: spec.
#[global] Hint Unfold load_u_anon_7_148: spec.
#[global] Hint Unfold store_u_anon_7_148: spec.
#[global] Hint Unfold load_u_anon_7: spec.
#[global] Hint Unfold store_u_anon_7: spec.
#[global] Hint Unfold load_s_anon_8: spec.
#[global] Hint Unfold store_s_anon_8: spec.
...
#[global] Hint Unfold load_u_anon_2: spec.
#[global] Hint Unfold store_u_anon_2: spec.
#[global] Hint Unfold load_s_anon_5: spec.
#[global] Hint Unfold store_s_anon_5: spec.
#[global] Hint Unfold load_u_anon_4: spec.
#[global] Hint Unfold store_u_anon_4: spec.
#[global] Hint Unfold load_s_anon_7: spec.
#[global] Hint Unfold store_s_anon_7: spec.
#[global] Hint Unfold load_u_anon_6_9: spec.
#[global] Hint Unfold store_u_anon_6_9: spec.
#[global] Hint Unfold load_u_anon_8: spec.
#[global] Hint Unfold store_u_anon_8: spec.
#[global] Hint Unfold load_u_anon_9: spec.
#[global] Hint Unfold store_u_anon_9: spec.
#[global] Hint Unfold load_u_anon_11: spec.
#[global] Hint Unfold store_u_anon_11: spec.
#[global] Hint Unfold load_s_rmi_rec_exit: spec.
#[global] Hint Unfold store_s_rmi_rec_exit: spec.
#[global] Hint Unfold load_u_anon_12_150: spec.
#[global] Hint Unfold store_u_anon_12_150: spec.
#[global] Hint Unfold load_s_rmi_rec_run: spec.
#[global] Hint Unfold store_s_rmi_rec_run: spec.
...
#[global] Hint Unfold rtt_num_start: spec.
Opaque query_oracle.
...
#[global] Hint Unfold walk_one_step: spec.
#[global] Hint Unfold walk_rtt_level: spec.
#[global] Hint Unfold rd_rtt: spec.
#[global] Hint Unfold walk_star: spec.
Opaque walk_rtt.
#[global] Hint Unfold pte_table_equiv: spec.

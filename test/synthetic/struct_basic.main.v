...
Definition load_s_Point (sz: Z) (ofs:Z)  (st_s_Point: s_Point) : option Z := 
...
Definition store_s_Point (sz: Z) (ofs:Z) (v:Z)  (st: s_Point) : option s_Point := 
...
Definition POINT_BASE : Z := 67108864.
...
Parameter llvm_memcpy_p0_p0_i64_spec : (Ptr-> (Ptr-> (Z-> (Z-> (RData-> (option RData)))))).

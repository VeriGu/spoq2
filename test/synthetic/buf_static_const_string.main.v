...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "buf_static_const_string".
Definition PROJ_BASE: string := "buf_static_const_string".
Definition PROJ_BC_PATH: string := "buf_static_const_string.bc".
...
Parameter g_string: (ZMap.t int64).
Record GLOBALS :=
  mkGLOBALS {
    __spoq_dummy_field: Z    }.

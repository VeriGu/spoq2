...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_argmem_stack_frame".
Definition PROJ_BASE: string := "attr_argmem_stack_frame".
Definition PROJ_BC_PATH: string := "attr_argmem_stack_frame.bc".
...
Definition MAX_GLOBAL : intSizeT := 67108864.
...
Parameter ext_argmem_stack_frame_spec : (Ptr-> (RData-> (option ((int32) * RData)))).

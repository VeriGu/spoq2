...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_readonly".
Definition PROJ_BASE: string := "attr_readonly".
Definition PROJ_BC_PATH: string := "attr_readonly.bc".
...
Parameter ext_pure_spec : (RData -> (option ((int32) * RData))).

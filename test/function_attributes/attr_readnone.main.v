...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_readnone".
Definition PROJ_BASE: string := "attr_readnone".
Definition PROJ_BC_PATH: string := "attr_readnone.bc".
...
Parameter ext_const_spec : (RData -> (option ((int32) * RData))).

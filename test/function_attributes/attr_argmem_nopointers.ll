; ModuleID = '/home/rjs2247/workspace/spoq3/test/function_attributes/src/attr_argmem_nopointers.c'
source_filename = "/home/rjs2247/workspace/spoq3/test/function_attributes/src/attr_argmem_nopointers.c"
...
entry:
  ...
  %call = call i32 @ext_argmem_np(i32 noundef 1)
  %0 = load i32, ptr @g, align 4, !tbaa !9
  ret i32 %0
}

declare i32 @ext_argmem_np(i32 noundef) #1

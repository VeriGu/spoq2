; ModuleID = 'src/attr_argmem_stack_frame.c'
source_filename = "src/attr_argmem_stack_frame.c"
...
define dso_local i32 @vuln() #0 {
  ...
  %3 = call i32 @ext_argmem_stack_frame(ptr noundef %2)
  store i32 7, ptr %2, align 4
  %4 = call i32 @ext_argmem_stack_frame(ptr noundef %1)
  %5 = load i32, ptr %2, align 4
  ret i32 %5
}

declare i32 @ext_argmem_stack_frame(ptr noundef) #1

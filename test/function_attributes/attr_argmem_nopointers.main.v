...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_argmem_nopointers".
Definition PROJ_BASE: string := "attr_argmem_nopointers".
Definition PROJ_BC_PATH: string := "attr_argmem_nopointers.bc".
...
Parameter ext_argmem_np_spec : (int32 -> (RData -> (option ((int32) * RData)))).

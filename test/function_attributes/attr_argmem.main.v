...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_argmem".
Definition PROJ_BASE: string := "attr_argmem".
Definition PROJ_BC_PATH: string := "attr_argmem.bc".
...
Parameter ext_argmem_spec : (Ptr -> (RData -> (option ((int32) * RData)))).

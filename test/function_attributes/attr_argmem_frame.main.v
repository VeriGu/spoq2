...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "attr_argmem_frame".
Definition PROJ_BASE: string := "attr_argmem_frame".
Definition PROJ_BC_PATH: string := "attr_argmem_frame.bc".


Hint StackVar vuln v_local stack_type_1.
Hint StackVar patch v_local stack_type_1.
...
Parameter ext_argmem_frame_spec : (Ptr -> (RData -> (option ((int32) * RData)))).

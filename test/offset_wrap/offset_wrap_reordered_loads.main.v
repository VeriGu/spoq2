...
(* SPOQ STOP *)
Definition PROJ_NAME: string := "offset_wrap_reordered_loads".
Definition PROJ_BASE: string := "offset_wrap_reordered_loads".
Definition PROJ_BC_PATH: string := "offset_wrap_reordered_loads.bc".

Definition PROJ_NAME: string := "rmm_container_default_config_with_14_layer".
Definition PROJ_BASE: string := "./coq/proof_default_config_with_14_layer".
...
Section Bottom.
  ...
  Definition LAYER_NEW_FRAME : string := "new_frame".  Definition LAYER_CODE : string := "./rmm-opt.linked.ir2json.json".
...
Section Layer9.
  ...
  Definition LAYER_PRIMS: list string :=
    "rsi_rtt_set_ripas" ::
    "rsi_rtt_unmap_non_secure" ::
    "rsi_rtt_create" ::
    "rsi_data_destroy" ::
    "rsi_rtt_destroy" ::
    "rsi_data_map_extra" ::
    "rsi_data_create_s1" ::
    "rsi_data_create_unknown_s1" ::
    "rsi_data_read" ::

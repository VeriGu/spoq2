...
(declare-fun lock.0 () Ptr)
(declare-fun query_oracle.0_call (RData) Option_RData)
(declare-fun CPU_ID.0 () Int)
(assert
 (forall ((gidx.66623 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.66623)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.66623)) 1)))
 (=> $x62 $x59))))
 )
(assert
 (let (($x92390 (forall ((gidx.71677 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x53 (granule_data ?x17)))
 (let ((?x93 (select ?x53 gidx.71677)))
 (let (($x95 (= (g_norm ?x93) zero_granule_data)))
 (let (($x98 (= (e_state_s_granule (select (g_granules (globals ?x17)) gidx.71677)) 1)))
 (or (not $x98) $x95)))))))))))
 ))
 (let (($x27378 (forall ((gidx.71666 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71666)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71666)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x27378) $x92390))))
(assert
 (let ((?x134838 (pbase lock.0)))
 (= ?x134838 "granules")))
(assert
 (forall ((gidx.1901513 Int) )(let ((?x460 (query_oracle.0_call st.0)))
 (let ((?x376 (value_RData ?x460)))
 (let ((?x86295 (share ?x376)))
 (let ((?x9000 (granule_data ?x86295)))
 (let ((?x976 (select ?x9000 gidx.1901513)))
 (let (($x978 (= (g_norm ?x976) zero_granule_data)))
 (let (($x965 (= (e_state_s_granule (select (g_granules (globals ?x86295)) gidx.1901513)) 1)))
 (=> $x965 $x978)))))))))
 )
(assert
 (let ((?x9963 (poffset lock.0)))
 (let ((?x850 (div ?x9963 16)))
 (let ((?x460 (query_oracle.0_call st.0)))
 (let ((?x376 (value_RData ?x460)))
 (let ((?x86295 (share ?x376)))
 (let ((?x86251 (globals ?x86295)))
 (let ((?x63399 (g_granules ?x86251)))
 (let ((?x23104 (select ?x63399 ?x850)))
 (let ((?x31454 (e_lock ?x23104)))
 (let ((?x571 (e_val ?x31454)))
 (= ?x571 None_Z))))))))))))
(assert
 (let ((?x9963 (poffset lock.0)))
 (let ((?x850 (div ?x9963 16)))
 ...
 (let ((?x63399 (g_granules ?x86251)))
 (let ((?x23104 (select ?x63399 ?x850)))
 (let ((?x971 (e_state_s_granule ?x23104)))
 (let ((?x28580 (* (- 1) ?x971)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x963 (select ?x43 ?x850)))
 (let ((?x961 (e_state_s_granule ?x963)))
 (let ((?x23277 (+ ?x961 ?x28580)))
 (= ?x23277 0))))))))))))))))))
(assert
 (let (($x968 (forall ((gidx.1901550 Int) )(let ((?x460 (query_oracle.0_call st.0)))
 (let ((?x376 (value_RData ?x460)))
 (let ((?x86295 (share ?x376)))
 (let ((?x9000 (granule_data ?x86295)))
 (let ((?x976 (select ?x9000 gidx.1901550)))
 (let (($x978 (= (g_norm ?x976) zero_granule_data)))
 (let ((?x9963 (poffset lock.0)))
 (let ((?x850 (div ?x9963 16)))
 (let ((?x86251 (globals ?x86295)))
 (let ((?x63399 (g_granules ?x86251)))
 (let ((?x23104 (select ?x63399 ?x850)))
 (let ((?x23339 (e_ref ?x23104)))
 (let ((?x971 (e_state_s_granule ?x23104)))
 (let ((?x28633 (Some_Z CPU_ID.0)))
 (let ((?x31085 (mks_spinlock_t ?x28633)))
 (let ((?x22724 (mks_granule ?x31085 ?x971 ?x23339)))
 (let ((?x23484 (store ?x63399 ?x850 ?x22724)))
 (=> (= (e_state_s_granule (select ?x23484 gidx.1901550)) 1) $x978)))))))))))))))))))
 ))
 (not $x968)))
(check-sat)

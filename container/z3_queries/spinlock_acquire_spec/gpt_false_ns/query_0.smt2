...
(assert
 ...
 (or (not $x759) $x722))))
(assert
 (let ((?x25061 (pbase lock.0)))
 (= ?x25061 "granules")))
(assert
 (forall ((gidx.317148 Int) )(let ((?x157016 (query_oracle.0_call st.0)))
 (let ((?x164661 (value_RData ?x157016)))
 (let ((?x313223 (share ?x164661)))
 (let ((?x143694 (globals ?x313223)))
 (let ((?x142485 (g_granules ?x143694)))
 (let ((?x19935 (select ?x142485 gidx.317148)))
 (let ((?x19577 (e_state_s_granule ?x19935)))
 (let (($x10352 (= ?x19577 6)))
 (let (($x2386 (= ?x19577 0)))
 (let (($x160999 (or $x2386 $x10352)))
 (let ((?x40097 (gpt ?x313223)))
 (let (($x159115 (select ?x40097 gidx.317148)))
 (let (($x19253 (not $x159115)))
 (=> $x19253 $x160999)))))))))))))))
 )
(assert
 (let ((?x9963 (poffset lock.0)))
 (let ((?x141906 (div ?x9963 16)))
 (let ((?x157016 (query_oracle.0_call st.0)))
 (let ((?x164661 (value_RData ?x157016)))
 (let ((?x313223 (share ?x164661)))
 (let ((?x143694 (globals ?x313223)))
 (let ((?x142485 (g_granules ?x143694)))
 (let ((?x132349 (select ?x142485 ?x141906)))
 (let ((?x158043 (e_lock ?x132349)))
 (let ((?x137467 (e_val ?x158043)))
 (= ?x137467 None_Z))))))))))))
(assert
 (let ((?x9963 (poffset lock.0)))
 (let ((?x141906 (div ?x9963 16)))
 ...
 (let ((?x142485 (g_granules ?x143694)))
 (let ((?x132349 (select ?x142485 ?x141906)))
 (let ((?x2626 (e_state_s_granule ?x132349)))
 (let ((?x2721 (* (- 1) ?x2626)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x2663 (select ?x21 ?x141906)))
 (let ((?x2471 (e_state_s_granule ?x2663)))
 (let ((?x2723 (+ ?x2471 ?x2721)))
 (= ?x2723 0))))))))))))))))))
(assert
 (let (($x2694 (forall ((gidx.317203 Int) )(let ((?x9963 (poffset lock.0)))
 (let ((?x141906 (div ?x9963 16)))
 (let ((?x157016 (query_oracle.0_call st.0)))
 (let ((?x164661 (value_RData ?x157016)))
 (let ((?x313223 (share ?x164661)))
 ...
 (let ((?x142485 (g_granules ?x143694)))
 (let ((?x132349 (select ?x142485 ?x141906)))
 (let ((?x2543 (e_ref ?x132349)))
 (let ((?x2626 (e_state_s_granule ?x132349)))
 (let ((?x2659 (Some_Z CPU_ID.0)))
 (let ((?x2730 (mks_spinlock_t ?x2659)))
 (let ((?x2568 (mks_granule ?x2730 ?x2626 ?x2543)))
 (let ((?x2660 (store ?x142485 ?x141906 ?x2568)))
 (let ((?x2760 (e_state_s_granule (select ?x2660 gidx.317203))))
 (let ((?x40097 (gpt ?x313223)))
 (let (($x159115 (select ?x40097 gidx.317203)))
 (let (($x19253 (not $x159115)))
 (=> $x19253 (or (= ?x2760 0) (= ?x2760 6))))))))))))))))))))))
 ))
 (not $x2694)))
(check-sat)

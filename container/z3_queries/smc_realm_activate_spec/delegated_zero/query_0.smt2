...
(declare-fun |\|smc_realm_activate_spec'.0\|_call| (Int RData) Option_Tuple_Z_RData)
...
(assert
 (let (($x8754 (forall ((gidx.71710 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 ...
 (let (($x7943 (forall ((gidx.71699 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71699)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71699)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x7943) $x8754))))
(assert
 (forall ((gidx.1049263 Int) )(let ((?x8214 (|\|smc_realm_activate_spec'.0\|_call| v_0.0 st.0)))
 (let ((?x8403 (value_Tuple_Z_RData ?x8214)))
 (let ((?x8479 (elem_1 ?x8403)))
 (let ((?x8589 (share ?x8479)))
 (let ((?x8147 (granule_data ?x8589)))
 (let ((?x7856 (select ?x8147 gidx.1049263)))
 (let (($x8636 (= (g_norm ?x7856) zero_granule_data)))
 (let (($x8497 (= (e_state_s_granule (select (g_granules (globals ?x8589)) gidx.1049263)) 1)))
 (=> $x8497 $x8636))))))))))
 )
(assert
 (let (($x7773 (forall ((gidx.1049301 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.1049301)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.1049301)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x7773)))
(check-sat)

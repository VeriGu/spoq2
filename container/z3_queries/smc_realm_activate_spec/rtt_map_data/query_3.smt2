...
(assert
 ...
 (not $x8592)))))))))))))
(assert
 (let (($x9456 (forall ((rtt_gidx.1101946 Int) (ipa_gidx.1101946 Int) (data_gidx.1101946 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x297 (share ?x738)))
 (let ((?x8542 (granule_data ?x297)))
 (let ((?x8989 (g_granule_state (select ?x8542 (rtt_walk_abs.0_call ?x738 rtt_gidx.1101946 ipa_gidx.1101946)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1101946)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x297)) rtt_gidx.1101946)) 5) $x142) (or (= ?x8989 4) (= ?x8989 6))))))))))
 ))
 (not $x9456)))
(check-sat)

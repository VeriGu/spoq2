...
(assert
 ...
 (not $x929)))))))))))))))))))))
(assert
 (let (($x1088 (forall ((gidx.2610654 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x46857 (share ?x617)))
 (let ((?x8851 (granule_data ?x46857)))
 (let ((?x871 (select ?x8851 gidx.2610654)))
 (let (($x1091 (= (g_norm ?x871) zero_granule_data)))
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let ((?x114456 (div ?x44933 16)))
 ...
 (let ((?x20440 (e_ref ?x59378)))
 (let ((?x45219 (e_state_s_granule ?x59378)))
 (let ((?x26588 (mks_spinlock_t None_Z)))
 (let ((?x969 (mks_granule ?x26588 ?x45219 ?x20440)))
 (let ((?x45209 (store ?x705 ?x114456 ?x969)))
 (=> (= (e_state_s_granule (select ?x45209 gidx.2610654)) 1) $x1091)))))))))))))))))))
 ))
 (not $x1088)))
(check-sat)

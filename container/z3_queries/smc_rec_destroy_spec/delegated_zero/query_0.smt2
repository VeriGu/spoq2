...
(assert
 (forall ((gidx.66614 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.66614)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.66614)) 1)))
 (=> $x62 $x59))))
 )
(assert
 (let (($x864 (forall ((gidx.71668 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x53 (granule_data ?x17)))
 (let ((?x93 (select ?x53 gidx.71668)))
 (let (($x95 (= (g_norm ?x93) zero_granule_data)))
 (let (($x98 (= (e_state_s_granule (select (g_granules (globals ?x17)) gidx.71668)) 1)))
 (or (not $x98) $x95)))))))))))
 ))
 (let (($x1219 (forall ((gidx.71657 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71657)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71657)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x1219) $x864))))
(assert
 (forall ((gidx.2609888 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x46857 (share ?x617)))
 (let ((?x8851 (granule_data ?x46857)))
 (let ((?x871 (select ?x8851 gidx.2609888)))
 (let (($x1091 (= (g_norm ?x871) zero_granule_data)))
 (let (($x51263 (= (e_state_s_granule (select (g_granules (globals ?x46857)) gidx.2609888)) 1)))
 (=> $x51263 $x1091)))))))))
 )
(assert
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let ((?x114456 (div ?x44933 16)))
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x46857 (share ?x617)))
 (let ((?x85785 (globals ?x46857)))
 (let ((?x705 (g_granules ?x85785)))
 (let ((?x59378 (select ?x705 ?x114456)))
 (let ((?x164877 (e_lock ?x59378)))
 (let ((?x45041 (e_val ?x164877)))
 (= ?x45041 None_Z)))))))))))))
(assert
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 ...
 (let ((?x705 (g_granules ?x85785)))
 (let ((?x59378 (select ?x705 ?x114456)))
 (let ((?x45219 (e_state_s_granule ?x59378)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x157158 (select ?x43 ?x114456)))
 (let ((?x129916 (e_state_s_granule ?x157158)))
 (let ((?x44914 (+ ?x129916 (* (- 1) ?x45219))))
 (= ?x44914 0))))))))))))))))))
(assert
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let ((?x1008 (div ?x44933 4096)))
 (let ((?x114456 (div ?x44933 16)))
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x46857 (share ?x617)))
 ...
 (let ((?x705 (g_granules ?x85785)))
 (let ((?x59378 (select ?x705 ?x114456)))
 (let ((?x20440 (e_ref ?x59378)))
 (let ((?x45219 (e_state_s_granule ?x59378)))
 (let ((?x37442 (Some_Z CPU_ID.0)))
 (let ((?x59408 (mks_spinlock_t ?x37442)))
 (let ((?x85792 (mks_granule ?x59408 ?x45219 ?x20440)))
 (let ((?x822 (store ?x705 ?x114456 ?x85792)))
 (let ((?x141856 (select ?x822 ?x1008)))
 (let ((?x998 (e_state_s_granule ?x141856)))
 (= ?x998 3))))))))))))))))))))
(assert
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let (($x85800 (halt ?x617)))
 (let ((?x70347 (stack ?x617)))
 (let ((?x46857 (share ?x617)))
 (let ((?x85785 (globals ?x46857)))
 (let ((?x15942 (g_realm_attest_private_key ?x85785)))
 (let ((?x23831 (g_get_realm_identity_identity ?x85785)))
 (let ((?x64544 (g_rmm_platform_token ?x85785)))
 (let ((?x44942 (g_platform_token_buf ?x85785)))
 (let ((?x62455 (g_rmm_attest_public_key_hash_len ?x85785)))
 (let ((?x62452 (g_rmm_attest_public_key_hash ?x85785)))
 (let ((?x78073 (g_rmm_attest_public_key_len ?x85785)))
 (let ((?x23830 (g_rmm_attest_public_key ?x85785)))
 (let ((?x62469 (g_rmm_attest_signing_key ?x85785)))
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let ((?x114456 (div ?x44933 16)))
 (let ((?x705 (g_granules ?x85785)))
 ...
 (let ((?x85792 (mks_granule ?x59408 ?x45219 ?x20440)))
 (let ((?x822 (store ?x705 ?x114456 ?x85792)))
 (let ((?x290 (g_mbedtls_mem_buf ?x85785)))
 (let ((?x29737 (g_tt_l1_upper ?x85785)))
 (let ((?x54769 (g_tt_l2_mem1_3 ?x85785)))
 (let ((?x91898 (g_tt_l2_mem1_2 ?x85785)))
 (let ((?x31506 (g_tt_l2_mem1_1 ?x85785)))
 (let ((?x85827 (g_tt_l2_mem1_0 ?x85785)))
 (let ((?x64760 (g_tt_l2_mem0_1 ?x85785)))
 (let ((?x62435 (g_tt_l2_mem0_0 ?x85785)))
 (let ((?x54722 (g_tt_l3_buffer ?x85785)))
 (let ((?x23794 (g_rmm_trap_list ?x85785)))
 (let ((?x70346 (g_status_handler ?x85785)))
 (let ((?x31500 (g_default_gicstate ?x85785)))
 (let ((?x85828 (g_pri_res0_mask ?x85785)))
 (let ((?x683 (g_max_vintid ?x85785)))
 (let ((?x54734 (g_nr_aprs ?x85785)))
 (let ((?x54725 (g_nr_lrs ?x85785)))
 (let ((?x54752 (g_vmids ?x85785)))
 (let ((?x23798 (g_vmid_lock ?x85785)))
 (let ((?x15979 (g_vmid_count ?x85785)))
 (let ((?x59411 (g_debug_exits ?x85785)))
 (let ((?x85790 (g_heap ?x85785)))
 (let ((?x886 (mkGLOBALS ?x85790 ?x59411 ?x15979 ?x23798 ?x54752 ?x54725 ?x54734 ?x683 ?x85828 ?x31500 ?x70346 ?x23794 ?x54722 ?x62435 ?x64760 ?x85827 ?x31506 ?x91898 ?x54769 ?x29737 ?x290 ?x822 ?x62469 ?x23830 ?x78073 ?x62452 ?x62455 ?x44942 ?x64544 ?x23831 ?x15942)))
 (let ((?x8851 (granule_data ?x46857)))
 (let ((?x31505 (gpt ?x46857)))
 (let ((?x888 (mkShared ?x31505 ?x8851 ?x886)))
 (let ((?x439 (priv ?x617)))
 (let ((?x91840 (repl ?x617)))
 (let ((?x91893 (oracle ?x617)))
 (let ((?x62450 (log ?x617)))
 (let ((?x891 (mkRData ?x62450 ?x91893 ?x91840 ?x439 ?x888 ?x70347 $x85800)))
 (let ((?x1116 (mkPtr "granules" ?x44933)))
 (let ((?x1064 (g_refcount_para.0_call ?x1116 ?x891)))
 (= ?x1064 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let (($x85801 (>= ?x44933 0)))
 (let ((?x19534 (mod ?x44933 4096)))
 (let (($x1384 (= ?x19534 0)))
 (and $x1384 $x85801)))))))
(assert
 (let ((?x487 (query_oracle.0_call st.0)))
 ...
 (let ((?x62450 (log ?x617)))
 (let ((?x891 (mkRData ?x62450 ?x91893 ?x91840 ?x439 ?x888 ?x70347 $x85800)))
 (let ((?x18542 (mkPtr "granule_data" ?x44933)))
 (let ((?x555 (rec_to_rd_para.0_call ?x18542 ?x891)))
 (let ((?x67564 (poffset ?x555)))
 (let (($x1034 (>= ?x67564 0)))
 (let ((?x946 (mod ?x67564 4096)))
 (let (($x75302 (= ?x946 0)))
 (let ((?x149596 (pbase ?x555)))
 (let (($x911 (= ?x149596 "granules")))
 (and $x911 $x75302 $x1034))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x1092 (forall ((gidx.2610505 Int) )(let ((?x43676 (test_PA.0_call v_0.0)))
 (let ((?x44933 (meta_granule_offset ?x43676)))
 (let ((?x1008 (div ?x44933 4096)))
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x46857 (share ?x617)))
 (let ((?x8851 (granule_data ?x46857)))
 (let ((?x944 (select ?x8851 ?x1008)))
 (let ((?x21315 (g_rec ?x944)))
 (let ((?x141779 (g_rd ?x944)))
 (let ((?x974 (g_granule_state ?x944)))
 (let ((?x943 (gd_g_idx ?x944)))
 (let ((?x149503 (mkr_granule_data ?x943 ?x974 zero_granule_data ?x141779 ?x21315)))
 (let ((?x45243 (store ?x8851 ?x1008 ?x149503)))
 (let (($x85800 (halt ?x617)))
 (let ((?x70347 (stack ?x617)))
 (let ((?x85785 (globals ?x46857)))
 (let ((?x15942 (g_realm_attest_private_key ?x85785)))
 ...
 (let ((?x555 (rec_to_rd_para.0_call ?x18542 ?x891)))
 (let ((?x67564 (poffset ?x555)))
 (let ((?x27915 (div ?x67564 4096)))
 (let ((?x141856 (select ?x822 ?x1008)))
 (let ((?x87203 (e_ref ?x141856)))
 (let ((?x122193 (e_lock ?x141856)))
 (let ((?x44337 (mks_granule ?x122193 1 ?x87203)))
 (let ((?x51293 (store ?x822 ?x1008 ?x44337)))
 (let ((?x44282 (select ?x51293 ?x27915)))
 (let ((?x26931 (e_ref ?x44282)))
 (let ((?x27520 (e_u_anon_3_0 ?x26931)))
 (let ((?x67566 (+ (- 1) ?x27520)))
 (let ((?x27653 (mku_anon_3 ?x67566)))
 (let ((?x44993 (mks_granule (e_lock ?x44282) (e_state_s_granule ?x44282) ?x27653)))
 (let ((?x836 (store ?x51293 ?x27915 ?x44993)))
 (=> (= (e_state_s_granule (select ?x836 gidx.2610505)) 1) (= (g_norm (select ?x45243 gidx.2610505)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1092)))
(check-sat)

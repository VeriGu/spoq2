...
(assert
 ...
 (not $x1986)))))))))
(assert
 (let (($x2226 (forall ((rtt_gidx.2532289 Int) (ipa_gidx.2532289 Int) (data_gidx.2532289 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x1812 (g_granule_state (select ?x9037 (rtt_walk_abs.0_call ?x738 rtt_gidx.2532289 ipa_gidx.2532289)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.2532289)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x492)) rtt_gidx.2532289)) 5) $x142) (or (= ?x1812 4) (= ?x1812 6))))))))))
 ))
 (not $x2226)))
(check-sat)

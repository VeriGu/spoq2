...
(assert
 ...
 (not $x1941)))))))))))))
(assert
 (let (($x1487 (forall ((rtt_gidx.2532359 Int) (ipa_gidx.2532359 Int) (data_gidx.2532359 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x1812 (g_granule_state (select ?x9037 (rtt_walk_abs.0_call ?x738 rtt_gidx.2532359 ipa_gidx.2532359)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.2532359)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x492)) rtt_gidx.2532359)) 5) $x142) (or (= ?x1812 4) (= ?x1812 6))))))))))
 ))
 (not $x1487)))
(check-sat)

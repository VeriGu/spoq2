...
(assert
 (let (($x1464 (forall ((rtt_gidx.61424 Int) (ipa_gidx.61424 Int) )(let ((?x13 (share st.0)))
 (let ((?x53 (log st.0)))
 ...
 (let (($x1344 (forall ((rtt_gidx.61388 Int) (ipa_gidx.61388 Int) )(let ((?x160 (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.61388))))
 (let (($x161 (= ?x160 5)))
 (let (($x162 (not $x161)))
 (let (($x153 (not (rtt_is_root.0_call rtt_gidx.61388))))
 ...
 (or (not $x1344) $x1464))))
(assert
 (forall ((v_0.61835 Int) )(let ((?x50731 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.61835))) 4096)))
 (let ((?x13 (share st.0)))
 (let ((?x50 (gpt ?x13)))
 (select ?x50 ?x50731)))))
 )
(assert
 ...
 (let ((?x54 (oracle st.0)))
 (let ((?x53 (log st.0)))
 (let ((?x1391 (mkRData ?x53 ?x54 ?x55 ?x56 (mkShared ?x50 (store (granule_data ?x13) i.51405 d.51405) ?x15) ?x57 $x58)))
 (let ((?x1583 (rtt_walk_abs.0_call ?x1391 rtt_gidx.51405 ipa_gidx.51405)))
 (let ((?x1484 (rtt_walk_abs.0_call st.0 rtt_gidx.51405 ipa_gidx.51405)))
 (let (($x1278 (= (+ ?x1484 (* (- 1) ?x1583)) 0)))
 (let ((?x160 (e_state_s_granule (select (g_granules ?x15) i.51405))))
 (let (($x161 (= ?x160 5)))
 (let (($x162 (not $x161)))
 (let (($x1480 (and $x162 (not (= ?x160 4)))))
 (=> $x1480 $x1278)))))))))))))))))))
 )
(assert
 ...
 (let ((?x1485 (store ?x17 i.50497 d.50497)))
 ...
 (let ((?x19 (g_heap ?x15)))
 (let ((?x1817 (mkGLOBALS ?x19 ?x20 ?x21 ?x22 ?x23 ?x24 ?x25 ?x26 ?x27 ?x28 ?x29 ?x30 ?x31 ?x32 ?x33 ?x34 ?x35 ?x36 ?x37 ?x38 ?x39 ?x1485 ?x40 ?x41 ?x42 ?x43 ?x44 ?x45 ?x46 ?x47 ?x48)))
 (let ((?x51 (granule_data ?x13)))
 (let ((?x50 (gpt ?x13)))
 (let ((?x56 (priv st.0)))
 (let ((?x55 (repl st.0)))
 (let ((?x54 (oracle st.0)))
 (let ((?x53 (log st.0)))
 (let ((?x1313 (rtt_walk_abs.0_call (mkRData ?x53 ?x54 ?x55 ?x56 (mkShared ?x50 ?x51 ?x1817) ?x57 $x58) rtt_gidx.50497 ipa_gidx.50497)))
 (let ((?x1484 (rtt_walk_abs.0_call st.0 rtt_gidx.50497 ipa_gidx.50497)))
 (let ((?x160 (e_state_s_granule (select ?x17 i.50497))))
 (let (($x161 (= ?x160 5)))
 (let (($x162 (not $x161)))
 (let (($x1480 (and $x162 (not (= ?x160 4)))))
 (=> $x1480 (= (+ ?x1484 (* (- 1) ?x1313)) 0))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.2531610 Int) (ipa_gidx.2531610 Int) (data_gidx.2531610 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x1812 (g_granule_state (select ?x9037 (rtt_walk_abs.0_call ?x738 rtt_gidx.2531610 ipa_gidx.2531610)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.2531610)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x492)) rtt_gidx.2531610)) 5) $x142) (or (= ?x1812 4) (= ?x1812 6))))))))))
 )
(assert
 (forall ((v_0.2531645 Int) )(let ((?x50731 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2531645))) 4096)))
 (let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x47113 (gpt ?x492)))
 (select ?x47113 ?x50731)))))))
 )
(assert
 (let (($x1818 (forall ((rtt_gidx.2531937 Int) (ipa_gidx.2531937 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x85873 (log ?x738)))
 (let ((?x1802 (|(oracle (value_RData (query_oracle.0_call st.0)))_call| ?x85873)))
 (let ((?x1688 (|(repl (value_RData (query_oracle.0_call st.0)))_call| ?x1802 ?x492)))
 (let ((?x1360 (value_Shared ?x1688)))
 (let ((?x1530 (globals ?x1360)))
 (let ((?x1637 (g_granules ?x1530)))
 (let (($x1621 (not (= (e_state_s_granule (select ?x1637 rtt_gidx.2531937)) 5))))
 (let (($x54855 (halt ?x738)))
 (let ((?x70447 (stack ?x738)))
 (let ((?x29827 (priv ?x738)))
 (let ((?x8270 (repl ?x738)))
 (let ((?x85874 (oracle ?x738)))
 (let ((?x1734 (List_Event_concat ?x1802 ?x85873)))
 (let ((?x1556 (mkRData ?x1734 ?x85874 ?x8270 ?x29827 ?x1360 ?x70447 $x54855)))
 (let ((?x1788 (rtt_walk_abs.0_call ?x1556 rtt_gidx.2531937 ipa_gidx.2531937)))
 (let ((?x1626 (granule_data ?x1360)))
 (let ((?x1753 (g_granule_state (select ?x1626 ?x1788))))
 (let (($x46009 (= ?x1753 4)))
 (let (($x1751 (= ?x1753 6)))
 (let (($x153 (not (rtt_is_root.0_call rtt_gidx.2531937))))
 (or $x153 $x1751 $x46009 $x1621)))))))))))))))))))))))))
 ))
 (let (($x1680 (forall ((rtt_gidx.2531901 Int) (ipa_gidx.2531901 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x1837 (rtt_walk_abs.0_call ?x738 rtt_gidx.2531901 ipa_gidx.2531901)))
 (let ((?x492 (share ?x738)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x1052 (g_granule_state (select ?x9037 ?x1837))))
 (let (($x1675 (= ?x1052 6)))
 (let (($x153 (not (rtt_is_root.0_call rtt_gidx.2531901))))
 (let (($x1568 (= ?x1052 4)))
 (let (($x1879 (not (= (e_state_s_granule (select (g_granules (globals ?x492)) rtt_gidx.2531901)) 5))))
 (or $x1879 $x1568 $x153 $x1675))))))))))))
 ))
 (or (not $x1680) $x1818))))
(assert
 (forall ((rtt_gidx.2532042 Int) (ipa_gidx.2532042 Int) (i.2532042 Int) (d.2532042 r_granule_data) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let (($x54855 (halt ?x738)))
 (let ((?x70447 (stack ?x738)))
 (let ((?x492 (share ?x738)))
 (let ((?x548 (globals ?x492)))
 (let ((?x47113 (gpt ?x492)))
 (let ((?x29827 (priv ?x738)))
 (let ((?x8270 (repl ?x738)))
 (let ((?x85874 (oracle ?x738)))
 (let ((?x85873 (log ?x738)))
 (let ((?x1656 (mkRData ?x85873 ?x85874 ?x8270 ?x29827 (mkShared ?x47113 (store (granule_data ?x492) i.2532042 d.2532042) ?x548) ?x70447 $x54855)))
 (let ((?x1700 (rtt_walk_abs.0_call ?x1656 rtt_gidx.2532042 ipa_gidx.2532042)))
 (let ((?x1742 (rtt_walk_abs.0_call ?x738 rtt_gidx.2532042 ipa_gidx.2532042)))
 (let (($x1879 (not (= (e_state_s_granule (select (g_granules ?x548) i.2532042)) 5))))
 (let (($x1633 (and $x1879 (not (= (e_state_s_granule (select (g_granules ?x548) i.2532042)) 4)))))
 (=> $x1633 (= (+ ?x1742 (* (- 1) ?x1700)) 0)))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.2532149 Int) (ipa_gidx.2532149 Int) (i.2532149 Int) (d.2532149 s_granule) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let (($x54855 (halt ?x738)))
 (let ((?x70447 (stack ?x738)))
 (let ((?x492 (share ?x738)))
 (let ((?x548 (globals ?x492)))
 (let ((?x31547 (g_realm_attest_private_key ?x548)))
 (let ((?x54850 (g_get_realm_identity_identity ?x548)))
 (let ((?x31559 (g_rmm_platform_token ?x548)))
 (let ((?x66365 (g_platform_token_buf ?x548)))
 (let ((?x66945 (g_rmm_attest_public_key_hash_len ?x548)))
 (let ((?x66375 (g_rmm_attest_public_key_hash ?x548)))
 (let ((?x47048 (g_rmm_attest_public_key_len ?x548)))
 (let ((?x47077 (g_rmm_attest_public_key ?x548)))
 (let ((?x47075 (g_rmm_attest_signing_key ?x548)))
 (let ((?x54824 (g_mbedtls_mem_buf ?x548)))
 (let ((?x54833 (g_tt_l1_upper ?x548)))
 (let ((?x54831 (g_tt_l2_mem1_3 ?x548)))
 (let ((?x54830 (g_tt_l2_mem1_2 ?x548)))
 (let ((?x62540 (g_tt_l2_mem1_1 ?x548)))
 (let ((?x62543 (g_tt_l2_mem1_0 ?x548)))
 (let ((?x62534 (g_tt_l2_mem0_1 ?x548)))
 (let ((?x70435 (g_tt_l2_mem0_0 ?x548)))
 (let ((?x85891 (g_tt_l3_buffer ?x548)))
 (let ((?x27677 (g_rmm_trap_list ?x548)))
 (let ((?x78162 (g_status_handler ?x548)))
 (let ((?x54823 (g_default_gicstate ?x548)))
 (let ((?x70432 (g_pri_res0_mask ?x548)))
 (let ((?x70434 (g_max_vintid ?x548)))
 (let ((?x62531 (g_nr_aprs ?x548)))
 (let ((?x62535 (g_nr_lrs ?x548)))
 (let ((?x70474 (g_vmids ?x548)))
 (let ((?x39445 (g_vmid_lock ?x548)))
 (let ((?x31536 (g_vmid_count ?x548)))
 (let ((?x54826 (g_debug_exits ?x548)))
 (let ((?x39448 (g_heap ?x548)))
 (let ((?x1840 (mkGLOBALS ?x39448 ?x54826 ?x31536 ?x39445 ?x70474 ?x62535 ?x62531 ?x70434 ?x70432 ?x54823 ?x78162 ?x27677 ?x85891 ?x70435 ?x62534 ?x62543 ?x62540 ?x54830 ?x54831 ?x54833 ?x54824 (store (g_granules ?x548) i.2532149 d.2532149) ?x47075 ?x47077 ?x47048 ?x66375 ?x66945 ?x66365 ?x31559 ?x54850 ?x31547)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x47113 (gpt ?x492)))
 (let ((?x29827 (priv ?x738)))
 (let ((?x8270 (repl ?x738)))
 (let ((?x85874 (oracle ?x738)))
 (let ((?x85873 (log ?x738)))
 (let ((?x1789 (rtt_walk_abs.0_call (mkRData ?x85873 ?x85874 ?x8270 ?x29827 (mkShared ?x47113 ?x9037 ?x1840) ?x70447 $x54855) rtt_gidx.2532149 ipa_gidx.2532149)))
 (let ((?x1742 (rtt_walk_abs.0_call ?x738 rtt_gidx.2532149 ipa_gidx.2532149)))
 (let (($x1879 (not (= (e_state_s_granule (select (g_granules ?x548) i.2532149)) 5))))
 (let (($x1633 (and $x1879 (not (= (e_state_s_granule (select (g_granules ?x548) i.2532149)) 4)))))
 (=> $x1633 (= (+ ?x1742 (* (- 1) ?x1789)) 0))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x13 (share st.0)))
 (let ((?x15 (globals ?x13)))
 ...
 (let ((?x492 (share ?x738)))
 (let ((?x548 (globals ?x492)))
 (let ((?x740 (g_granules ?x548)))
 (= ?x740 ?x17))))))))))
(assert
 (let ((?x1799 (test_PA.0_call v_0.2531645)))
 (let ((?x1895 (meta_granule_offset ?x1799)))
 (let ((?x1796 (div ?x1895 4096)))
 (let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x548 (globals ?x492)))
 (let ((?x740 (g_granules ?x548)))
 (let ((?x1804 (select ?x740 ?x1796)))
 (let ((?x1945 (e_lock ?x1804)))
 (let ((?x1798 (e_val ?x1945)))
 (= ?x1798 None_Z)))))))))))))
(assert
 (let ((?x1799 (test_PA.0_call v_0.2531645)))
 (let ((?x1895 (meta_granule_offset ?x1799)))
 ...
 (let ((?x740 (g_granules ?x548)))
 (let ((?x1804 (select ?x740 ?x1796)))
 (let ((?x2066 (e_state_s_granule ?x1804)))
 (= ?x2066 3))))))))))))
(assert
 (let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x1799 (test_PA.0_call v_0.2531645)))
 (let ((?x1895 (meta_granule_offset ?x1799)))
 (let ((?x1343 (mkPtr "granules" ?x1895)))
 (let ((?x1727 (g_refcount_para.0_call ?x1343 ?x738)))
 (= ?x1727 0))))))))
(assert
 (let ((?x1799 (test_PA.0_call v_0.2531645)))
 (let ((?x1895 (meta_granule_offset ?x1799)))
 (let (($x1913 (>= ?x1895 0)))
 (let ((?x172756 (mod ?x1895 4096)))
 (let (($x1950 (= ?x172756 0)))
 (and $x1950 $x1913)))))))
(assert
 (let ((?x627 (query_oracle.0_call st.0)))
 ...
 (let ((?x1799 (test_PA.0_call v_0.2531645)))
 (let ((?x1895 (meta_granule_offset ?x1799)))
 (let ((?x19337 (mkPtr "granule_data" ?x1895)))
 (let ((?x1923 (rec_to_rd_para.0_call ?x19337 ?x738)))
 (let ((?x1714 (poffset ?x1923)))
 (let (($x157259 (>= ?x1714 0)))
 (let ((?x1863 (mod ?x1714 4096)))
 (let (($x87366 (= ?x1863 0)))
 (let ((?x1853 (pbase ?x1923)))
 (let (($x1898 (= ?x1853 "granules")))
 (and $x1898 $x87366 $x157259))))))))))))))
(assert
 (let (($x1915 (forall ((rtt_gidx.2532219 Int) (ipa_gidx.2532219 Int) (data_gidx.2532219 Int) )(let ((?x627 (query_oracle.0_call st.0)))
 (let ((?x738 (value_RData ?x627)))
 (let ((?x492 (share ?x738)))
 (let ((?x9037 (granule_data ?x492)))
 (let ((?x1812 (g_granule_state (select ?x9037 (rtt_walk_abs.0_call ?x738 rtt_gidx.2532219 ipa_gidx.2532219)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.2532219)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x492)) rtt_gidx.2532219)) 5) $x142) (or (= ?x1812 4) (= ?x1812 6))))))))))
 ))
 (not $x1915)))
(check-sat)

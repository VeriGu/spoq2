...
(assert
 ...
 (= ?x25061 "granules")))
(assert
 (let (($x2651 (forall ((gidx.317480 Int) )(let ((?x9963 (poffset lock.0)))
 (let ((?x141906 (div ?x9963 16)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x2663 (select ?x21 ?x141906)))
 (let ((?x2610 (e_ref ?x2663)))
 (let ((?x2471 (e_state_s_granule ?x2663)))
 (let ((?x10208 (mks_spinlock_t None_Z)))
 (let ((?x4026 (mks_granule ?x10208 ?x2471 ?x2610)))
 (let ((?x2561 (store ?x21 ?x141906 ?x4026)))
 (let ((?x2360 (e_state_s_granule (select ?x2561 gidx.317480))))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.317480)))
 (let (($x65 (not $x64)))
 (=> $x65 (or (= ?x2360 0) (= ?x2360 6)))))))))))))))))))
 ))
 (not $x2651)))
(check-sat)

...
(assert
 (let (($x962 (forall ((gidx.71677 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 ...
 (let (($x1116 (forall ((gidx.71666 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71666)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71666)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x1116) $x962))))
(assert
 (let ((?x21763 (pbase lock.0)))
 (= ?x21763 "granules")))
(assert
 (let (($x852 (forall ((gidx.2228606 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.2228606)) zero_granule_data)))
 (let ((?x9539 (poffset lock.0)))
 (let ((?x1226 (div ?x9539 16)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1340 (select ?x43 ?x1226)))
 (let ((?x1557 (e_ref ?x1340)))
 (let ((?x1396 (e_state_s_granule ?x1340)))
 (let ((?x54849 (mks_spinlock_t None_Z)))
 (let ((?x1432 (mks_granule ?x54849 ?x1396 ?x1557)))
 (let ((?x1572 (store ?x43 ?x1226 ?x1432)))
 (=> (= (e_state_s_granule (select ?x1572 gidx.2228606)) 1) $x59))))))))))))))
 ))
 (not $x852)))
(check-sat)

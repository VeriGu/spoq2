...
(assert
 (forall ((gidx.239975 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x703 (elem_0 ?x2418)))
 (let ((?x881 (e_2 ?x703)))
 (let ((?x59366 (granule_unlock_spec.0_call ?x881 ?x785)))
 (let ((?x24382 (value_RData ?x59366)))
 (let ((?x70414 (share ?x24382)))
 (let ((?x884 (granule_data ?x70414)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x70414)) gidx.239975)) 1) (= (g_norm (select ?x884 gidx.239975)) zero_granule_data))))))))))))))))))
 )
(assert
 (forall ((v.239985 Int) )(let ((?x603 (make_return_code_para.0_call v.239985)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.239998 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239998)) (* (- 1) v.239998)) 0))
 )
(assert
 (let (($x16666 (forall ((gidx.240036 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x70414 (share ?x24382)))
 (let ((?x884 (granule_data ?x70414)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x70414)) gidx.240036)) 1) (= (g_norm (select ?x884 gidx.240036)) zero_granule_data))))))))))))))))))
 ))
 (not $x16666)))
(check-sat)

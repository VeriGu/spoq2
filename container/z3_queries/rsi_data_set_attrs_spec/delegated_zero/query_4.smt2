...
(assert
 (let (($x998 (forall ((gidx.239938 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x20847 (share ?x785)))
 (let ((?x778 (granule_data ?x20847)))
 (let (($x784 (= (e_state_s_granule (select (g_granules (globals ?x20847)) gidx.239938)) 1)))
 (=> $x784 (= (g_norm (select ?x778 gidx.239938)) zero_granule_data)))))))))))))))
 ))
 (not $x998)))
(check-sat)

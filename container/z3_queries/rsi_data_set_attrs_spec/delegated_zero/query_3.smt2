...
(declare-fun abs_attr_to_mem_attr.0_call (Int) Int)
(declare-fun v_2.0 () Int)
(declare-fun abs_attr_to_ripas.0_call (Int) Int)
(declare-fun abs_attr_to_desc_type.0_call (Int) Int)
(declare-fun abs_tte_read.0_call (Ptr RData) abs_PTE_t)
(assert
 (let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x695 (div ?x622 4096)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 (let ((?x8561 (share ?x722)))
 (let ((?x623 (globals ?x8561)))
 (let ((?x643 (g_granules ?x623)))
 (let ((?x710 (select ?x643 ?x695)))
 (let ((?x709 (e_state_s_granule ?x710)))
 (= ?x709 5)))))))))))))
(assert
 (let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let (($x788 (>= ?x622 0)))
 (let ((?x1740 (mod ?x622 4096)))
 (let (($x727 (= ?x1740 0)))
 (and $x727 $x788)))))))
(assert
 (let ((?x639 (test_PA.0_call v_0.0)))
 ...
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 (let ((?x17488 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x773 (rtt_walk_lock_unlock_spec_abs.0_call ?x17488 ?x604 0 64 v_1.0 3 ?x722)))
 (let ((?x2418 (value_Tuple_abs_ret_rtt_RData ?x773)))
 (let ((?x703 (elem_0 ?x2418)))
 (let ((?x802 (e_3 ?x703)))
 (let ((?x801 (* 8 ?x802)))
 (let ((?x881 (e_2 ?x703)))
 (let ((?x931 (poffset ?x881)))
 (let ((?x800 (+ ?x931 ?x801)))
 (let ((?x824 (div ?x800 4096)))
 (let ((?x785 (elem_1 ?x2418)))
 (let ((?x20847 (share ?x785)))
 (let ((?x774 (globals ?x20847)))
 (let ((?x816 (g_granules ?x774)))
 (let ((?x937 (select ?x816 ?x824)))
 (let ((?x827 (e_state_s_granule ?x937)))
 (= ?x827 5)))))))))))))))))))))))
(assert
 (let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 ...
 (= ?x33217 3))))))))))))
(assert
 (forall ((gidx.37655 Int) )(let (($x651 (= (g_norm (select (granule_data (share st.0)) gidx.37655)) zero_granule_data)))
 (let (($x666 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.37655)) 1)))
 (=> $x666 $x651))))
 )
(assert
 (forall ((v.38307 Int) )(let ((?x603 (make_return_code_para.0_call v.38307)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.38183 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38183)) (* (- 1) v.38183)) 0))
 )
(assert
 (forall ((gidx.239646 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 (let ((?x8561 (share ?x722)))
 (let ((?x688 (granule_data ?x8561)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8561)) gidx.239646)) 1) (= (g_norm (select ?x688 gidx.239646)) zero_granule_data))))))))))
 )
(assert
 (forall ((v.239656 Int) )(let ((?x603 (make_return_code_para.0_call v.239656)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.239669 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239669)) (* (- 1) v.239669)) 0))
 )
(assert
 (forall ((gidx.239743 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x785 (elem_1 ?x2418)))
 (let ((?x20847 (share ?x785)))
 (let ((?x778 (granule_data ?x20847)))
 (let (($x784 (= (e_state_s_granule (select (g_granules (globals ?x20847)) gidx.239743)) 1)))
 (=> $x784 (= (g_norm (select ?x778 gidx.239743)) zero_granule_data)))))))))))))))
 )
(assert
 (forall ((v.239753 Int) )(let ((?x603 (make_return_code_para.0_call v.239753)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.239766 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239766)) (* (- 1) v.239766)) 0))
 )
(assert
 (forall ((gidx.239840 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x824 (div ?x800 4096)))
 (let ((?x778 (granule_data ?x20847)))
 (let ((?x952 (select ?x778 ?x824)))
 (let ((?x954 (abs_attr_to_mem_attr.0_call v_2.0)))
 (let ((?x24318 (abs_attr_to_ripas.0_call v_2.0)))
 (let ((?x16763 (abs_attr_to_desc_type.0_call v_2.0)))
 (let ((?x24303 (mkPtr "granule_data" ?x800)))
 (let ((?x804 (abs_tte_read.0_call ?x24303 ?x785)))
 (let ((?x24306 (meta_PA ?x804)))
 (let ((?x882 (mkabs_PTE_t ?x24306 ?x16763 ?x24318 ?x954)))
 (let ((?x16739 (test_PTE_Z.0_call ?x882)))
 (let ((?x902 (mod ?x800 4096)))
 (let ((?x960 (g_norm ?x952)))
 (let ((?x24302 (store ?x960 ?x902 ?x16739)))
 (let ((?x24280 (mkr_granule_data (gd_g_idx ?x952) (g_granule_state ?x952) ?x24302 (g_rd ?x952) (g_rec ?x952))))
 (let ((?x24312 (store ?x778 ?x824 ?x24280)))
 (let ((?x24308 (mkRData (log ?x785) (oracle ?x785) (repl ?x785) (priv ?x785) (mkShared (gpt ?x20847) ?x24312 ?x774) (stack ?x785) (halt ?x785))))
 (let ((?x24301 (granule_unlock_spec.0_call ?x881 ?x24308)))
 (let ((?x16768 (value_RData ?x24301)))
 (let ((?x77236 (share ?x16768)))
 (let ((?x24313 (granule_data ?x77236)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x77236)) gidx.239840)) 1) (= (g_norm (select ?x24313 gidx.239840)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v.239850 Int) )(let ((?x603 (make_return_code_para.0_call v.239850)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.239863 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239863)) (* (- 1) v.239863)) 0))
 )
(assert
 (let (($x953 (forall ((gidx.239901 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x77236 (share ?x16768)))
 (let ((?x24313 (granule_data ?x77236)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x77236)) gidx.239901)) 1) (= (g_norm (select ?x24313 gidx.239901)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x953)))
(check-sat)

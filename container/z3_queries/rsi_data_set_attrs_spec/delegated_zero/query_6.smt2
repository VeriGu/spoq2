...
(assert
 (let (($x946 (forall ((gidx.240073 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 (let ((?x8561 (share ?x722)))
 (let ((?x688 (granule_data ?x8561)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8561)) gidx.240073)) 1) (= (g_norm (select ?x688 gidx.240073)) zero_granule_data))))))))))
 ))
 (not $x946)))
(check-sat)

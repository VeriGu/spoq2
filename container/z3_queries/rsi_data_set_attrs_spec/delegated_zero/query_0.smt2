...
(assert
 (let (($x702 (forall ((gidx.239609 Int) )(let (($x651 (= (g_norm (select (granule_data (share st.0)) gidx.239609)) zero_granule_data)))
 (let (($x666 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.239609)) 1)))
 (=> $x666 $x651))))
 ))
 (not $x702)))
(check-sat)

...
(assert
 (forall ((gidx.240110 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 (let ((?x52919 (spinlock_release_spec.0_call ?x604 ?x722)))
 (let ((?x16661 (value_RData ?x52919)))
 (let ((?x21490 (share ?x16661)))
 (let ((?x903 (granule_data ?x21490)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x21490)) gidx.240110)) 1) (= (g_norm (select ?x903 gidx.240110)) zero_granule_data))))))))))))
 )
(assert
 (forall ((v.240120 Int) )(let ((?x603 (make_return_code_para.0_call v.240120)))
 (let ((?x585 (pack_struct_return_code_para.0_call ?x603)))
 (and (distinct ?x585 0) true))))
 )
(assert
 (forall ((v.240133 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.240133)) (* (- 1) v.240133)) 0))
 )
(assert
 (let (($x16813 (forall ((gidx.240171 Int) )(let ((?x639 (test_PA.0_call v_0.0)))
 (let ((?x622 (meta_granule_offset ?x639)))
 (let ((?x604 (mkPtr "granules" ?x622)))
 (let ((?x624 (spinlock_acquire_spec.0_call ?x604 st.0)))
 (let ((?x722 (value_RData ?x624)))
 ...
 (let ((?x21490 (share ?x16661)))
 (let ((?x903 (granule_data ?x21490)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x21490)) gidx.240171)) 1) (= (g_norm (select ?x903 gidx.240171)) zero_granule_data))))))))))))
 ))
 (not $x16813)))
(check-sat)

...
(assert
 ...
 (let (($x609 (=> (and (and (distinct ?x698 (- 1)) true) (rtt_is_root.0_call rtt_gidx.37462)) (or (= ?x692 4) (= ?x692 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x23)) rtt_gidx.37462)) 5) (and (distinct ?x698 (- 1)) true) (rtt_is_root.0_call rtt_gidx.37462)) (or (= ?x692 4) (= ?x692 6)))))))))
 )
(assert
...
(assert
 (let (($x752 (forall ((rtt_gidx.240559 Int) (ipa_gidx.240559 Int) (data_gidx.240559 Int) )(let ((?x698 (rtt_walk_abs.0_call st.0 rtt_gidx.240559 ipa_gidx.240559)))
 (let ((?x23 (share st.0)))
 (let ((?x25 (granule_data ?x23)))
 (let ((?x692 (g_granule_state (select ?x25 ?x698))))
 (let (($x609 (=> (and (and (distinct ?x698 (- 1)) true) (rtt_is_root.0_call rtt_gidx.240559)) (or (= ?x692 4) (= ?x692 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x23)) rtt_gidx.240559)) 5) (and (distinct ?x698 (- 1)) true) (rtt_is_root.0_call rtt_gidx.240559)) (or (= ?x692 4) (= ?x692 6)))))))))
 ))
 (not $x752)))
(check-sat)

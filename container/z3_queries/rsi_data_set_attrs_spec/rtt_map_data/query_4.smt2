...
(assert
 (let (($x1339 (forall ((rtt_gidx.241416 Int) (ipa_gidx.241416 Int) (data_gidx.241416 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1020 (value_Tuple_abs_ret_rtt_RData ?x1010)))
 (let ((?x991 (elem_1 ?x1020)))
 (let ((?x987 (rtt_walk_abs.0_call ?x991 rtt_gidx.241416 ipa_gidx.241416)))
 (let ((?x994 (share ?x991)))
 (let ((?x1015 (granule_data ?x994)))
 (let ((?x1022 (g_granule_state (select ?x1015 ?x987))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241416)))
 (let (($x1035 (=> (and (and (distinct ?x987 (- 1)) true) $x644) (or (= ?x1022 4) (= ?x1022 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x994)) rtt_gidx.241416)) 5) (and (distinct ?x987 (- 1)) true) $x644) (or (= ?x1022 4) (= ?x1022 6)))))))))))))))))))
 ))
 (not $x1339)))
(check-sat)

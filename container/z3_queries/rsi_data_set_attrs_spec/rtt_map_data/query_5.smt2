...
(assert
 (forall ((rtt_gidx.241495 Int) (ipa_gidx.241495 Int) (data_gidx.241495 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1106 (rtt_walk_abs.0_call ?x924 rtt_gidx.241495 ipa_gidx.241495)))
 (let ((?x1228 (share ?x924)))
 (let ((?x16757 (granule_data ?x1228)))
 (let ((?x1093 (g_granule_state (select ?x16757 ?x1106))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241495)))
 (let (($x24484 (=> (and (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x1228)) rtt_gidx.241495)) 5) (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))))))))))))))))))))
 )
(assert
 (forall ((v.241505 Int) )(let ((?x706 (make_return_code_para.0_call v.241505)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((v.241518 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.241518)) (* (- 1) v.241518)) 0))
 )
(assert
 (forall ((rtt_gidx.241596 Int) (ipa_gidx.241596 Int) (i.241596 Int) (d.241596 r_granule_data) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x901 (log ?x924)))
 (let ((?x1196 (mkRData ?x901 ?x1123 ?x16734 ?x24453 (mkShared ?x1045 (store (granule_data ?x1228) i.241596 d.241596) ?x1189) ?x24486 $x24458)))
 (let ((?x1109 (+ (rtt_walk_abs.0_call ?x924 rtt_gidx.241596 ipa_gidx.241596) (* (- 1) (rtt_walk_abs.0_call ?x1196 rtt_gidx.241596 ipa_gidx.241596)))))
 (let (($x1242 (and (not (= (e_state_s_granule (select (g_granules ?x1189) i.241596)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1189) i.241596)) 4)))))
 (=> $x1242 (= ?x1109 0))))))))))))))))))))))))))))
 )
(assert
 (let (($x1359 (forall ((rtt_gidx.241676 Int) (ipa_gidx.241676 Int) (data_gidx.241676 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1128 (granule_unlock_spec.0_call ?x1098 ?x991)))
 (let ((?x924 (value_RData ?x1128)))
 (let ((?x1106 (rtt_walk_abs.0_call ?x924 rtt_gidx.241676 ipa_gidx.241676)))
 (let ((?x1228 (share ?x924)))
 (let ((?x16757 (granule_data ?x1228)))
 (let ((?x1093 (g_granule_state (select ?x16757 ?x1106))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241676)))
 (let (($x24484 (=> (and (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x1228)) rtt_gidx.241676)) 5) (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))))))))))))))))))))
 ))
 (not $x1359)))
(check-sat)

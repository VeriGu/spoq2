...
(assert
 (let (($x8950 (forall ((rtt_gidx.241755 Int) (ipa_gidx.241755 Int) (data_gidx.241755 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x910 (rtt_walk_abs.0_call ?x746 rtt_gidx.241755 ipa_gidx.241755)))
 (let ((?x818 (share ?x746)))
 (let ((?x760 (granule_data ?x818)))
 (let ((?x767 (g_granule_state (select ?x760 ?x910))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241755)))
 (let (($x822 (=> (and (and (distinct ?x910 (- 1)) true) $x644) (or (= ?x767 4) (= ?x767 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x818)) rtt_gidx.241755)) 5) (and (distinct ?x910 (- 1)) true) $x644) (or (= ?x767 4) (= ?x767 6)))))))))))))))
 ))
 (not $x8950)))
(check-sat)

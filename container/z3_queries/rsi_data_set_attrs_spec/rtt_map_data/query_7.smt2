...
(assert
 (forall ((rtt_gidx.241834 Int) (ipa_gidx.241834 Int) (data_gidx.241834 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x51503 (spinlock_release_spec.0_call ?x719 ?x746)))
 (let ((?x32504 (value_RData ?x51503)))
 (let ((?x1285 (rtt_walk_abs.0_call ?x32504 rtt_gidx.241834 ipa_gidx.241834)))
 (let ((?x16889 (share ?x32504)))
 (let ((?x1548 (granule_data ?x16889)))
 (let ((?x16886 (g_granule_state (select ?x1548 ?x1285))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241834)))
 (let (($x16828 (=> (and (and (distinct ?x1285 (- 1)) true) $x644) (or (= ?x16886 4) (= ?x16886 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x16889)) rtt_gidx.241834)) 5) (and (distinct ?x1285 (- 1)) true) $x644) (or (= ?x16886 4) (= ?x16886 6)))))))))))))))))
 )
(assert
 (forall ((v.241844 Int) )(let ((?x706 (make_return_code_para.0_call v.241844)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((v.241857 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.241857)) (* (- 1) v.241857)) 0))
 )
(assert
 (forall ((rtt_gidx.241935 Int) (ipa_gidx.241935 Int) (i.241935 Int) (d.241935 r_granule_data) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x51503 (spinlock_release_spec.0_call ?x719 ?x746)))
 (let ((?x32504 (value_RData ?x51503)))
 (let (($x24632 (halt ?x32504)))
 (let ((?x24468 (stack ?x32504)))
 (let ((?x16889 (share ?x32504)))
 (let ((?x24658 (globals ?x16889)))
 (let ((?x1323 (gpt ?x16889)))
 (let ((?x1314 (priv ?x32504)))
 (let ((?x1268 (repl ?x32504)))
 (let ((?x1353 (oracle ?x32504)))
 (let ((?x1297 (log ?x32504)))
 (let ((?x1402 (mkRData ?x1297 ?x1353 ?x1268 ?x1314 (mkShared ?x1323 (store (granule_data ?x16889) i.241935 d.241935) ?x24658) ?x24468 $x24632)))
 (let ((?x1397 (+ (rtt_walk_abs.0_call ?x32504 rtt_gidx.241935 ipa_gidx.241935) (* (- 1) (rtt_walk_abs.0_call ?x1402 rtt_gidx.241935 ipa_gidx.241935)))))
 (let (($x765 (and (not (= (e_state_s_granule (select (g_granules ?x24658) i.241935)) 5)) (not (= (e_state_s_granule (select (g_granules ?x24658) i.241935)) 4)))))
 (=> $x765 (= ?x1397 0))))))))))))))))))))))
 )
(assert
 (let (($x24739 (forall ((rtt_gidx.242015 Int) (ipa_gidx.242015 Int) (data_gidx.242015 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x51503 (spinlock_release_spec.0_call ?x719 ?x746)))
 (let ((?x32504 (value_RData ?x51503)))
 (let ((?x1285 (rtt_walk_abs.0_call ?x32504 rtt_gidx.242015 ipa_gidx.242015)))
 (let ((?x16889 (share ?x32504)))
 (let ((?x1548 (granule_data ?x16889)))
 (let ((?x16886 (g_granule_state (select ?x1548 ?x1285))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.242015)))
 (let (($x16828 (=> (and (and (distinct ?x1285 (- 1)) true) $x644) (or (= ?x16886 4) (= ?x16886 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x16889)) rtt_gidx.242015)) 5) (and (distinct ?x1285 (- 1)) true) $x644) (or (= ?x16886 4) (= ?x16886 6)))))))))))))))))
 ))
 (not $x24739)))
(check-sat)

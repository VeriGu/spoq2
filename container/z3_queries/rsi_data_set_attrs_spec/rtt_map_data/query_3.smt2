...
(assert
 (let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x904 (div ?x742 4096)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x818 (share ?x746)))
 (let ((?x772 (globals ?x818)))
 (let ((?x785 (g_granules ?x772)))
 (let ((?x858 (select ?x785 ?x904)))
 (let ((?x857 (e_state_s_granule ?x858)))
 (= ?x857 5)))))))))))))
(assert
 (let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let (($x1030 (>= ?x742 0)))
 (let ((?x1754 (mod ?x742 4096)))
 (let (($x973 (= ?x1754 0)))
 (and $x973 $x1030)))))))
(assert
 (let ((?x727 (test_PA.0_call v_0.0)))
 ...
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x16715 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1010 (rtt_walk_lock_unlock_spec_abs.0_call ?x16715 ?x719 0 64 v_1.0 3 ?x746)))
 (let ((?x1020 (value_Tuple_abs_ret_rtt_RData ?x1010)))
 (let ((?x950 (elem_0 ?x1020)))
 (let ((?x1082 (e_3 ?x950)))
 (let ((?x1083 (* 8 ?x1082)))
 (let ((?x1098 (e_2 ?x950)))
 (let ((?x1099 (poffset ?x1098)))
 (let ((?x1084 (+ ?x1099 ?x1083)))
 (let ((?x1085 (div ?x1084 4096)))
 (let ((?x991 (elem_1 ?x1020)))
 (let ((?x994 (share ?x991)))
 (let ((?x990 (globals ?x994)))
 (let ((?x993 (g_granules ?x990)))
 (let ((?x1086 (select ?x993 ?x1085)))
 (let ((?x1087 (e_state_s_granule ?x1086)))
 (= ?x1087 5)))))))))))))))))))))))
(assert
 (let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 ...
 (= ?x32472 3))))))))))))
(assert
 (forall ((rtt_gidx.37462 Int) (ipa_gidx.37462 Int) (data_gidx.37462 Int) )(let ((?x698 (rtt_walk_abs.0_call st.0 rtt_gidx.37462 ipa_gidx.37462)))
 (let ((?x23 (share st.0)))
 (let ((?x25 (granule_data ?x23)))
 (let ((?x692 (g_granule_state (select ?x25 ?x698))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.37462)))
 (let (($x609 (=> (and (and (distinct ?x698 (- 1)) true) $x644) (or (= ?x692 4) (= ?x692 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x23)) rtt_gidx.37462)) 5) (and (distinct ?x698 (- 1)) true) $x644) (or (= ?x692 4) (= ?x692 6))))))))))
 )
(assert
 (forall ((v.39072 Int) )(let ((?x706 (make_return_code_para.0_call v.39072)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((rtt_gidx.38948 Int) (ipa_gidx.38948 Int) (i.38948 Int) (d.38948 r_granule_data) )(let (($x35 (halt st.0)))
 (let ((?x34 (stack st.0)))
 (let ((?x23 (share st.0)))
 (let ((?x28 (globals ?x23)))
 (let ((?x27 (gpt ?x23)))
 ...
 (let ((?x31 (oracle st.0)))
 (let ((?x30 (log st.0)))
 (let ((?x801 (mkRData ?x30 ?x31 ?x32 ?x33 (mkShared ?x27 (store (granule_data ?x23) i.38948 d.38948) ?x28) ?x34 $x35)))
 (let ((?x776 (rtt_walk_abs.0_call ?x801 rtt_gidx.38948 ipa_gidx.38948)))
 (let (($x731 (= (+ (rtt_walk_abs.0_call st.0 rtt_gidx.38948 ipa_gidx.38948) (* (- 1) ?x776)) 0)))
 (let ((?x704 (e_state_s_granule (select (g_granules ?x28) i.38948))))
 (let (($x2445 (= ?x704 5)))
 (let (($x714 (not $x2445)))
 (=> (and $x714 (not (= ?x704 4))) $x731)))))))))))))))))
 )
(assert
 (forall ((v.38040 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38040)) (* (- 1) v.38040)) 0))
 )
(assert
 (forall ((rtt_gidx.240638 Int) (ipa_gidx.240638 Int) (data_gidx.240638 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 (let ((?x910 (rtt_walk_abs.0_call ?x746 rtt_gidx.240638 ipa_gidx.240638)))
 (let ((?x818 (share ?x746)))
 (let ((?x760 (granule_data ?x818)))
 (let ((?x767 (g_granule_state (select ?x760 ?x910))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.240638)))
 (let (($x822 (=> (and (and (distinct ?x910 (- 1)) true) $x644) (or (= ?x767 4) (= ?x767 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x818)) rtt_gidx.240638)) 5) (and (distinct ?x910 (- 1)) true) $x644) (or (= ?x767 4) (= ?x767 6)))))))))))))))
 )
(assert
 (forall ((v.240648 Int) )(let ((?x706 (make_return_code_para.0_call v.240648)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((v.240661 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.240661)) (* (- 1) v.240661)) 0))
 )
(assert
 (forall ((rtt_gidx.240739 Int) (ipa_gidx.240739 Int) (i.240739 Int) (d.240739 r_granule_data) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x852 (priv ?x746)))
 (let ((?x961 (repl ?x746)))
 (let ((?x849 (oracle ?x746)))
 (let ((?x805 (log ?x746)))
 (let ((?x959 (mkRData ?x805 ?x849 ?x961 ?x852 (mkShared ?x853 (store (granule_data ?x818) i.240739 d.240739) ?x772) ?x947 $x948)))
 (let ((?x966 (+ (rtt_walk_abs.0_call ?x746 rtt_gidx.240739 ipa_gidx.240739) (* (- 1) (rtt_walk_abs.0_call ?x959 rtt_gidx.240739 ipa_gidx.240739)))))
 (let (($x929 (and (not (= (e_state_s_granule (select (g_granules ?x772) i.240739)) 5)) (not (= (e_state_s_granule (select (g_granules ?x772) i.240739)) 4)))))
 (=> $x929 (= ?x966 0))))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.240897 Int) (ipa_gidx.240897 Int) (data_gidx.240897 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1020 (value_Tuple_abs_ret_rtt_RData ?x1010)))
 (let ((?x991 (elem_1 ?x1020)))
 (let ((?x987 (rtt_walk_abs.0_call ?x991 rtt_gidx.240897 ipa_gidx.240897)))
 (let ((?x994 (share ?x991)))
 (let ((?x1015 (granule_data ?x994)))
 (let ((?x1022 (g_granule_state (select ?x1015 ?x987))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.240897)))
 (let (($x1035 (=> (and (and (distinct ?x987 (- 1)) true) $x644) (or (= ?x1022 4) (= ?x1022 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x994)) rtt_gidx.240897)) 5) (and (distinct ?x987 (- 1)) true) $x644) (or (= ?x1022 4) (= ?x1022 6)))))))))))))))))))
 )
(assert
 (forall ((v.240907 Int) )(let ((?x706 (make_return_code_para.0_call v.240907)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((v.240920 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.240920)) (* (- 1) v.240920)) 0))
 )
(assert
 (forall ((rtt_gidx.240998 Int) (ipa_gidx.240998 Int) (i.240998 Int) (d.240998 r_granule_data) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1025 (priv ?x991)))
 (let ((?x946 (repl ?x991)))
 (let ((?x1027 (oracle ?x991)))
 (let ((?x1052 (log ?x991)))
 (let ((?x1064 (mkRData ?x1052 ?x1027 ?x946 ?x1025 (mkShared ?x1048 (store (granule_data ?x994) i.240998 d.240998) ?x990) ?x923 $x951)))
 (let ((?x1068 (+ (rtt_walk_abs.0_call ?x991 rtt_gidx.240998 ipa_gidx.240998) (* (- 1) (rtt_walk_abs.0_call ?x1064 rtt_gidx.240998 ipa_gidx.240998)))))
 (let (($x1076 (and (not (= (e_state_s_granule (select (g_granules ?x990) i.240998)) 5)) (not (= (e_state_s_granule (select (g_granules ?x990) i.240998)) 4)))))
 (=> $x1076 (= ?x1068 0))))))))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.241156 Int) (ipa_gidx.241156 Int) (data_gidx.241156 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x950 (elem_0 ?x1020)))
 (let ((?x1098 (e_2 ?x950)))
 (let ((?x1128 (granule_unlock_spec.0_call ?x1098 ?x991)))
 (let ((?x924 (value_RData ?x1128)))
 (let ((?x1106 (rtt_walk_abs.0_call ?x924 rtt_gidx.241156 ipa_gidx.241156)))
 (let ((?x1228 (share ?x924)))
 (let ((?x16757 (granule_data ?x1228)))
 (let ((?x1093 (g_granule_state (select ?x16757 ?x1106))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241156)))
 (let (($x24484 (=> (and (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x1228)) rtt_gidx.241156)) 5) (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))))))))))))))))))))
 )
(assert
 (forall ((v.241166 Int) )(let ((?x706 (make_return_code_para.0_call v.241166)))
 (let ((?x688 (pack_struct_return_code_para.0_call ?x706)))
 (and (distinct ?x688 0) true))))
 )
(assert
 (forall ((v.241179 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.241179)) (* (- 1) v.241179)) 0))
 )
(assert
 (forall ((rtt_gidx.241257 Int) (ipa_gidx.241257 Int) (i.241257 Int) (d.241257 r_granule_data) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1128 (granule_unlock_spec.0_call ?x1098 ?x991)))
 (let ((?x924 (value_RData ?x1128)))
 (let (($x24458 (halt ?x924)))
 (let ((?x24486 (stack ?x924)))
 (let ((?x1228 (share ?x924)))
 (let ((?x1189 (globals ?x1228)))
 (let ((?x1045 (gpt ?x1228)))
 (let ((?x24453 (priv ?x924)))
 (let ((?x16734 (repl ?x924)))
 (let ((?x1123 (oracle ?x924)))
 (let ((?x901 (log ?x924)))
 (let ((?x1196 (mkRData ?x901 ?x1123 ?x16734 ?x24453 (mkShared ?x1045 (store (granule_data ?x1228) i.241257 d.241257) ?x1189) ?x24486 $x24458)))
 (let ((?x1109 (+ (rtt_walk_abs.0_call ?x924 rtt_gidx.241257 ipa_gidx.241257) (* (- 1) (rtt_walk_abs.0_call ?x1196 rtt_gidx.241257 ipa_gidx.241257)))))
 (let (($x1242 (and (not (= (e_state_s_granule (select (g_granules ?x1189) i.241257)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1189) i.241257)) 4)))))
 (=> $x1242 (= ?x1109 0))))))))))))))))))))))))))))
 )
(assert
 (let (($x24519 (forall ((rtt_gidx.241337 Int) (ipa_gidx.241337 Int) (data_gidx.241337 Int) )(let ((?x727 (test_PA.0_call v_0.0)))
 (let ((?x742 (meta_granule_offset ?x727)))
 (let ((?x719 (mkPtr "granules" ?x742)))
 (let ((?x758 (spinlock_acquire_spec.0_call ?x719 st.0)))
 (let ((?x746 (value_RData ?x758)))
 ...
 (let ((?x1128 (granule_unlock_spec.0_call ?x1098 ?x991)))
 (let ((?x924 (value_RData ?x1128)))
 (let ((?x1106 (rtt_walk_abs.0_call ?x924 rtt_gidx.241337 ipa_gidx.241337)))
 (let ((?x1228 (share ?x924)))
 (let ((?x16757 (granule_data ?x1228)))
 (let ((?x1093 (g_granule_state (select ?x16757 ?x1106))))
 (let (($x644 (rtt_is_root.0_call rtt_gidx.241337)))
 (let (($x24484 (=> (and (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x1228)) rtt_gidx.241337)) 5) (and (distinct ?x1106 (- 1)) true) $x644) (or (= ?x1093 4) (= ?x1093 6)))))))))))))))))))))))
 ))
 (not $x24519)))
(check-sat)

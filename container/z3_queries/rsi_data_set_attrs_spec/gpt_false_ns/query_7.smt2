...
(assert
 (forall ((gidx.240255 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 (let ((?x51215 (spinlock_release_spec.0_call ?x704 ?x2425)))
 (let ((?x22370 (value_RData ?x51215)))
 (let ((?x27180 (share ?x22370)))
 (let ((?x24559 (globals ?x27180)))
 (let ((?x24490 (g_granules ?x24559)))
 (let ((?x959 (e_state_s_granule (select ?x24490 gidx.240255))))
 (=> (not (select (gpt ?x27180) gidx.240255)) (or (= ?x959 0) (= ?x959 6)))))))))))))))
 )
(assert
 (forall ((v.240265 Int) )(let ((?x605 (make_return_code_para.0_call v.240265)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.240278 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.240278)) (* (- 1) v.240278)) 0))
 )
(assert
 (let (($x975 (forall ((gidx.240334 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x24559 (globals ?x27180)))
 (let ((?x24490 (g_granules ?x24559)))
 (let ((?x959 (e_state_s_granule (select ?x24490 gidx.240334))))
 (=> (not (select (gpt ?x27180) gidx.240334)) (or (= ?x959 0) (= ?x959 6)))))))))))))))
 ))
 (not $x975)))
(check-sat)

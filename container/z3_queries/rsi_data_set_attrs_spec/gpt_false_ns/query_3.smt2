...
(assert
 (let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x732 (div ?x624 4096)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 (let ((?x8550 (share ?x2425)))
 (let ((?x680 (globals ?x8550)))
 (let ((?x658 (g_granules ?x680)))
 (let ((?x2418 (select ?x658 ?x732)))
 (let ((?x661 (e_state_s_granule ?x2418)))
 (= ?x661 5)))))))))))))
(assert
 (let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let (($x2434 (>= ?x624 0)))
 (let ((?x1740 (mod ?x624 4096)))
 (let (($x721 (= ?x1740 0)))
 (and $x721 $x2434)))))))
(assert
 (let ((?x622 (test_PA.0_call v_0.0)))
 ...
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 (let ((?x16539 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x708 (rtt_walk_lock_unlock_spec_abs.0_call ?x16539 ?x704 0 64 v_1.0 3 ?x2425)))
 (let ((?x767 (value_Tuple_abs_ret_rtt_RData ?x708)))
 (let ((?x788 (elem_0 ?x767)))
 (let ((?x824 (e_3 ?x788)))
 (let ((?x937 (* 8 ?x824)))
 (let ((?x802 (e_2 ?x788)))
 (let ((?x801 (poffset ?x802)))
 (let ((?x827 (+ ?x801 ?x937)))
 (let ((?x923 (div ?x827 4096)))
 (let ((?x785 (elem_1 ?x767)))
 (let ((?x23675 (share ?x785)))
 (let ((?x772 (globals ?x23675)))
 (let ((?x809 (g_granules ?x772)))
 (let ((?x924 (select ?x809 ?x923)))
 (let ((?x821 (e_state_s_granule ?x924)))
 (= ?x821 5)))))))))))))))))))))))
(assert
 (let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 ...
 (= ?x32349 3))))))))))))
(assert
 (forall ((gidx.37441 Int) )(let ((?x610 (share st.0)))
 (let ((?x1118 (globals ?x610)))
 (let ((?x1142 (g_granules ?x1118)))
 (let ((?x674 (select ?x1142 gidx.37441)))
 (let ((?x651 (e_state_s_granule ?x674)))
 (let (($x672 (= ?x651 6)))
 (let (($x678 (= ?x651 0)))
 (=> (not (select (gpt ?x610) gidx.37441)) (or $x678 $x672))))))))))
 )
(assert
 (forall ((v.38093 Int) )(let ((?x605 (make_return_code_para.0_call v.38093)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.37969 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.37969)) (* (- 1) v.37969)) 0))
 )
(assert
 (forall ((gidx.239611 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x680 (globals ?x8550)))
 (let ((?x658 (g_granules ?x680)))
 (let ((?x715 (e_state_s_granule (select ?x658 gidx.239611))))
 (=> (not (select (gpt ?x8550) gidx.239611)) (or (= ?x715 0) (= ?x715 6)))))))))))))
 )
(assert
 (forall ((v.239621 Int) )(let ((?x605 (make_return_code_para.0_call v.239621)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.239634 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239634)) (* (- 1) v.239634)) 0))
 )
(assert
 (forall ((gidx.239744 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x772 (globals ?x23675)))
 (let ((?x809 (g_granules ?x772)))
 (let ((?x806 (e_state_s_granule (select ?x809 gidx.239744))))
 (=> (not (select (gpt ?x23675) gidx.239744)) (or (= ?x806 0) (= ?x806 6)))))))))))))))))
 )
(assert
 (forall ((v.239754 Int) )(let ((?x605 (make_return_code_para.0_call v.239754)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.239767 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239767)) (* (- 1) v.239767)) 0))
 )
(assert
 (forall ((gidx.239877 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x788 (elem_0 ?x767)))
 (let ((?x802 (e_2 ?x788)))
 (let ((?x979 (granule_unlock_spec.0_call ?x802 ?x785)))
 (let ((?x960 (value_RData ?x979)))
 (let ((?x70713 (share ?x960)))
 (let ((?x24401 (globals ?x70713)))
 (let ((?x21597 (g_granules ?x24401)))
 (let ((?x831 (e_state_s_granule (select ?x21597 gidx.239877))))
 (=> (not (select (gpt ?x70713) gidx.239877)) (or (= ?x831 0) (= ?x831 6)))))))))))))))))))))
 )
(assert
 (forall ((v.239887 Int) )(let ((?x605 (make_return_code_para.0_call v.239887)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.239900 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.239900)) (* (- 1) v.239900)) 0))
 )
(assert
 (let (($x24392 (forall ((gidx.239956 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x24401 (globals ?x70713)))
 (let ((?x21597 (g_granules ?x24401)))
 (let ((?x831 (e_state_s_granule (select ?x21597 gidx.239956))))
 (=> (not (select (gpt ?x70713) gidx.239956)) (or (= ?x831 0) (= ?x831 6)))))))))))))))))))))
 ))
 (not $x24392)))
(check-sat)

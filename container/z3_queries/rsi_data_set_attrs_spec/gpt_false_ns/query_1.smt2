...
(assert
 (let (($x811 (forall ((gidx.239689 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x680 (globals ?x8550)))
 (let ((?x658 (g_granules ?x680)))
 (let ((?x715 (e_state_s_granule (select ?x658 gidx.239689))))
 (=> (not (select (gpt ?x8550) gidx.239689)) (or (= ?x715 0) (= ?x715 6)))))))))))))
 ))
 (not $x811)))
(check-sat)

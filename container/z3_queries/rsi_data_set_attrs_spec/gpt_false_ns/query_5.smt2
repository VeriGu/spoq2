...
(assert
 (forall ((gidx.240066 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x831 (e_state_s_granule (select ?x21597 gidx.240066))))
 (=> (not (select (gpt ?x70713) gidx.240066)) (or (= ?x831 0) (= ?x831 6)))))))))))))))))))))
 )
(assert
 (forall ((v.240076 Int) )(let ((?x605 (make_return_code_para.0_call v.240076)))
 (let ((?x675 (pack_struct_return_code_para.0_call ?x605)))
 (and (distinct ?x675 0) true))))
 )
(assert
 (forall ((v.240089 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.240089)) (* (- 1) v.240089)) 0))
 )
(assert
 (let (($x24511 (forall ((gidx.240145 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x24401 (globals ?x70713)))
 (let ((?x21597 (g_granules ?x24401)))
 (let ((?x831 (e_state_s_granule (select ?x21597 gidx.240145))))
 (=> (not (select (gpt ?x70713) gidx.240145)) (or (= ?x831 0) (= ?x831 6)))))))))))))))))))))
 ))
 (not $x24511)))
(check-sat)

...
(assert
 (let (($x22168 (forall ((gidx.240011 Int) )(let ((?x622 (test_PA.0_call v_0.0)))
 (let ((?x624 (meta_granule_offset ?x622)))
 (let ((?x704 (mkPtr "granules" ?x624)))
 (let ((?x722 (spinlock_acquire_spec.0_call ?x704 st.0)))
 (let ((?x2425 (value_RData ?x722)))
 ...
 (let ((?x772 (globals ?x23675)))
 (let ((?x809 (g_granules ?x772)))
 (let ((?x806 (e_state_s_granule (select ?x809 gidx.240011))))
 (=> (not (select (gpt ?x23675) gidx.240011)) (or (= ?x806 0) (= ?x806 6)))))))))))))))))
 ))
 (not $x22168)))
(check-sat)

...
(assert
 ...
 (= ?x19740 0))))))))))))))))))))))))))
(assert
 (let (($x1840 (forall ((rtt_gidx.318861 Int) (ipa_gidx.318861 Int) (data_gidx.318861 Int) )(let ((?x1051 (query_oracle.0_call st.0)))
 (let ((?x955 (value_RData ?x1051)))
 (let ((?x1524 (+ (- 1) v_3.0)))
 (let ((?x1463 (test_PA.0_call v_1.0)))
 (let ((?x1464 (meta_granule_offset ?x1463)))
 ...
 (let ((?x1566 (share ?x1412)))
 (let ((?x1586 (granule_data ?x1566)))
 (let ((?x1615 (g_granule_state (select ?x1586 (rtt_walk_abs.0_call ?x1412 rtt_gidx.318861 ipa_gidx.318861)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.318861)))
 (let (($x1624 (= (e_state_s_granule (select (g_granules (globals ?x1566)) rtt_gidx.318861)) 5)))
 (=> (and $x1624 $x102) (or (= ?x1615 4) (= ?x1615 6)))))))))))))))))))
 ))
 (not $x1840)))
(check-sat)

...
(assert
 ...
 (not $x4695)))))))))))))))))))
(assert
 (let (($x2946 (forall ((rtt_gidx.320927 Int) (ipa_gidx.320927 Int) (data_gidx.320927 Int) )(let ((?x1051 (query_oracle.0_call st.0)))
 (let ((?x955 (value_RData ?x1051)))
 (let ((?x1524 (+ (- 1) v_3.0)))
 (let ((?x1463 (test_PA.0_call v_1.0)))
 (let ((?x1464 (meta_granule_offset ?x1463)))
 ...
 (let ((?x2050 (share ?x2071)))
 (let ((?x2122 (granule_data ?x2050)))
 (let ((?x2106 (g_granule_state (select ?x2122 (rtt_walk_abs.0_call ?x2071 rtt_gidx.320927 ipa_gidx.320927)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.320927)))
 (let (($x2111 (= (e_state_s_granule (select (g_granules (globals ?x2050)) rtt_gidx.320927)) 5)))
 (=> (and $x2111 $x102) (or (= ?x2106 4) (= ?x2106 6)))))))))))))))))))))
 ))
 (not $x2946)))
(check-sat)

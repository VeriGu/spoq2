...
(assert
 (let (($x2372 (forall ((rtt_gidx.319841 Int) (ipa_gidx.319841 Int) (data_gidx.319841 Int) )(let ((?x1051 (query_oracle.0_call st.0)))
 (let ((?x955 (value_RData ?x1051)))
 (let ((?x1524 (+ (- 1) v_3.0)))
 (let ((?x1463 (test_PA.0_call v_1.0)))
 (let ((?x1464 (meta_granule_offset ?x1463)))
 ...
 (let ((?x2554 (g_granule_state (select ?x20298 (rtt_walk_abs.0_call ?x20291 rtt_gidx.319841 ipa_gidx.319841)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.319841)))
 (let (($x2111 (= (e_state_s_granule (select (g_granules ?x2054) rtt_gidx.319841)) 5)))
 (=> (and $x2111 $x102) (or (= ?x2554 4) (= ?x2554 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2372)))
(check-sat)

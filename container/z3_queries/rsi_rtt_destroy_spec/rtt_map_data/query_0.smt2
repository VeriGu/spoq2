...
(assert
 ...
 (let ((?x9 (share st.0)))
 (let ((?x11 (globals ?x9)))
 (let ((?x885 (store (g_norm (select (granule_data ?x9) (div offset.94374 4096))) (mod offset.94374 4096) (test_PTE_Z.0_call empty_pte.94374))))
...
(assert
 ...
 (or (not $x1084) $x1091))))
(assert
 (let (($x1769 (forall ((rtt_gidx.316901 Int) (ipa_gidx.316901 Int) (data_gidx.316901 Int) )(let ((?x9 (share st.0)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x98 (g_granule_state (select ?x36 (rtt_walk_abs.0_call st.0 rtt_gidx.316901 ipa_gidx.316901)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.316901)))
 (let (($x106 (= (e_state_s_granule (select (g_granules (globals ?x9)) rtt_gidx.316901)) 5)))
 (=> (and $x106 $x102) (or (= ?x98 4) (= ?x98 6)))))))))
 ))
 (not $x1769)))
(check-sat)

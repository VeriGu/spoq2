...
(assert
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x59788)) gidx.2347022)) 1) (= (g_norm (select ?x27344 gidx.2347022)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x39617 (query_oracle.0_call st.0)))
 (let ((?x39619 (value_RData ?x39617)))
...
(assert
 ...
 (let ((?x597 (poffset ?x24683)))
 (let (($x27813 (>= ?x597 0)))
 (let ((?x18196 (mod ?x597 4096)))
 (let (($x27161 (= ?x18196 0)))
 (let ((?x27568 (pbase ?x24683)))
 (let (($x27614 (= ?x27568 "granules")))
 (and $x27614 $x27161 $x27813)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x20390 (forall ((gidx.2347621 Int) )(let ((?x23915 (test_PA.0_call v_0.0)))
 (let ((?x55599 (meta_granule_offset ?x23915)))
 (let ((?x59997 (div ?x55599 4096)))
 (let ((?x39617 (query_oracle.0_call st.0)))
 (let ((?x39619 (value_RData ?x39617)))
 ...
 (let ((?x59788 (share ?x19374)))
 (let ((?x27344 (granule_data ?x59788)))
 (let ((?x27737 (select ?x27344 ?x922)))
 (let ((?x60389 (mkabs_PA_t (- 1))))
 (let ((?x60477 (mkabs_PTE_t ?x60389 0 1 0)))
 (let ((?x60475 (test_PTE_Z.0_call ?x60477)))
 (let ((?x18938 (mod ?x16009 4096)))
 (let ((?x18060 (g_norm ?x27737)))
 (let ((?x27506 (store ?x18060 ?x18938 ?x60475)))
 (let ((?x19324 (mkr_granule_data (gd_g_idx ?x27737) (g_granule_state ?x27737) ?x27506 (g_rd ?x27737) (g_rec ?x27737))))
 (let ((?x18629 (store ?x27344 ?x922 ?x19324)))
 (let ((?x19530 (select ?x18629 ?x59997)))
 (let ((?x19282 (mkr_granule_data (gd_g_idx ?x19530) (g_granule_state ?x19530) zero_granule_data (g_rd ?x19530) (g_rec ?x19530))))
 (let ((?x27656 (store ?x18629 ?x59997 ?x19282)))
 (let ((?x31288 (div ?x597 4096)))
 (let ((?x63619 (div ?x55599 16)))
 (let ((?x18358 (globals ?x59788)))
 (let ((?x26864 (g_granules ?x18358)))
 (let ((?x18186 (select ?x26864 ?x63619)))
 ...
 (let ((?x27415 (mks_granule ?x16065 ?x27171 (e_ref ?x18186))))
 (let ((?x18856 (store ?x26864 ?x63619 ?x27415)))
 (let ((?x27595 (select ?x18856 ?x31288)))
 (let ((?x27604 (e_ref ?x27595)))
 (let ((?x80064 (e_u_anon_3_0 ?x27604)))
 (let ((?x19263 (+ (- 1) ?x80064)))
 (let ((?x60450 (mku_anon_3 ?x19263)))
 (let ((?x27467 (mks_granule (e_lock ?x27595) (e_state_s_granule ?x27595) ?x60450)))
 (let ((?x26809 (store ?x18856 ?x31288 ?x27467)))
 (let ((?x27330 (select ?x26809 ?x59997)))
 (let ((?x27100 (mks_granule (e_lock ?x27330) 1 (e_ref ?x27330))))
 (let ((?x27254 (store ?x26809 ?x59997 ?x27100)))
 (=> (= (e_state_s_granule (select ?x27254 gidx.2347621)) 1) (= (g_norm (select ?x27656 gidx.2347621)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x20390)))
(check-sat)

...
(assert
 ...
 (not $x27017)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x15856 (forall ((gidx.2611810 Int) )(let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 (let ((?x86308 (stack ?x588)))
 (let ((?x24349 (share ?x588)))
 ...
 (let ((?x18801 (globals ?x18931)))
 (let ((?x26512 (g_granules ?x18801)))
 (let ((?x1036 (e_state_s_granule (select ?x26512 gidx.2611810))))
 (=> (not (select (gpt ?x18931) gidx.2611810)) (or (= ?x1036 0) (= ?x1036 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x15856)))
(check-sat)

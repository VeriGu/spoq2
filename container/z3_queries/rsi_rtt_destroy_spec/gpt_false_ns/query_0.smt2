...
(assert
 (forall ((gidx.60498 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.60498)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.60498)) (or $x62 $x61))))))))))
 )
(assert
 (let (($x19349 (forall ((gidx.67788 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x87 (gpt ?x17)))
 (let (($x102 (select ?x87 gidx.67788)))
 (let ((?x52 (globals ?x17)))
 (let ((?x53 (g_granules ?x52)))
 (let ((?x96 (select ?x53 gidx.67788)))
 (let ((?x98 (e_state_s_granule ?x96)))
 (let (($x100 (= ?x98 0)))
 (let (($x99 (= ?x98 6)))
 (or $x99 $x100 $x102)))))))))))))))
 ))
 (let (($x18890 (forall ((gidx.67771 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.67771)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.67771)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x62 (= ?x60 0)))
 (let (($x61 (= ?x60 6)))
 (or $x61 $x62 $x64)))))))))))
 ))
 (or (not $x18890) $x19349))))
(assert
 (forall ((gidx.2610924 Int) )(let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let ((?x24349 (share ?x588)))
 (let ((?x86251 (globals ?x24349)))
 (let ((?x62907 (g_granules ?x86251)))
 (let ((?x1005 (select ?x62907 gidx.2610924)))
 (let ((?x1006 (e_state_s_granule ?x1005)))
 (let (($x1007 (= ?x1006 6)))
 (let (($x1008 (= ?x1006 0)))
 (let ((?x86297 (gpt ?x24349)))
 (let (($x599 (select ?x86297 gidx.2610924)))
 (let (($x1010 (not $x599)))
 (=> $x1010 (or $x1008 $x1007)))))))))))))))
 )
(assert
 (let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 (let ((?x55384 (div ?x711 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let ((?x24349 (share ?x588)))
 (let ((?x86251 (globals ?x24349)))
 (let ((?x62907 (g_granules ?x86251)))
 (let ((?x22102 (select ?x62907 ?x55384)))
 (let ((?x92413 (e_lock ?x22102)))
 (let ((?x37213 (e_val ?x92413)))
 (= ?x37213 None_Z)))))))))))))
(assert
 (let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 ...
 (let ((?x62907 (g_granules ?x86251)))
 (let ((?x22102 (select ?x62907 ?x55384)))
 (let ((?x63510 (e_state_s_granule ?x22102)))
 (let ((?x35434 (* (- 1) ?x63510)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x92393 (select ?x21 ?x55384)))
 (let ((?x55382 (e_state_s_granule ?x92393)))
 (let ((?x26948 (+ ?x55382 ?x35434)))
 (= ?x26948 0)))))))))))))))))))
(assert
 (let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 (let ((?x26017 (div ?x711 4096)))
 (let ((?x55384 (div ?x711 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let ((?x24349 (share ?x588)))
 ...
 (let ((?x62907 (g_granules ?x86251)))
 (let ((?x22102 (select ?x62907 ?x55384)))
 (let ((?x22096 (e_ref ?x22102)))
 (let ((?x63510 (e_state_s_granule ?x22102)))
 (let ((?x17076 (Some_Z CPU_ID.0)))
 (let ((?x23844 (mks_spinlock_t ?x17076)))
 (let ((?x29011 (mks_granule ?x23844 ?x63510 ?x22096)))
 (let ((?x21877 (store ?x62907 ?x55384 ?x29011)))
 (let ((?x6986 (select ?x21877 ?x26017)))
 (let ((?x26931 (e_state_s_granule ?x6986)))
 (= ?x26931 5))))))))))))))))))))
(assert
 (let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 (let (($x26979 (>= ?x711 0)))
 (let ((?x51295 (mod ?x711 4096)))
 (let (($x27155 (= ?x51295 0)))
 (and $x27155 $x26979)))))))
(assert
 (forall ((gidx.2611034 Int) )(let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 (let ((?x86308 (stack ?x588)))
 (let ((?x24349 (share ?x588)))
 (let ((?x86251 (globals ?x24349)))
 (let ((?x47157 (g_realm_attest_private_key ?x86251)))
 (let ((?x24515 (g_get_realm_identity_identity ?x86251)))
 (let ((?x62597 (g_rmm_platform_token ?x86251)))
 (let ((?x31301 (g_platform_token_buf ?x86251)))
 (let ((?x62941 (g_rmm_attest_public_key_hash_len ?x86251)))
 (let ((?x15952 (g_rmm_attest_public_key_hash ?x86251)))
 (let ((?x45280 (g_rmm_attest_public_key_len ?x86251)))
 (let ((?x62913 (g_rmm_attest_public_key ?x86251)))
 (let ((?x62909 (g_rmm_attest_signing_key ?x86251)))
 (let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 (let ((?x55384 (div ?x711 16)))
 (let ((?x62907 (g_granules ?x86251)))
 ...
 (let ((?x29011 (mks_granule ?x23844 ?x63510 ?x22096)))
 (let ((?x21877 (store ?x62907 ?x55384 ?x29011)))
 (let ((?x93982 (g_mbedtls_mem_buf ?x86251)))
 (let ((?x63242 (g_tt_l1_upper ?x86251)))
 (let ((?x31303 (g_tt_l2_mem1_3 ?x86251)))
 (let ((?x47359 (g_tt_l2_mem1_2 ?x86251)))
 (let ((?x55107 (g_tt_l2_mem1_1 ?x86251)))
 (let ((?x23802 (g_tt_l2_mem1_0 ?x86251)))
 (let ((?x78567 (g_tt_l2_mem0_1 ?x86251)))
 (let ((?x8126 (g_tt_l2_mem0_0 ?x86251)))
 (let ((?x92389 (g_tt_l3_buffer ?x86251)))
 (let ((?x86299 (g_rmm_trap_list ?x86251)))
 (let ((?x22065 (g_status_handler ?x86251)))
 (let ((?x86300 (g_default_gicstate ?x86251)))
 (let ((?x92401 (g_pri_res0_mask ?x86251)))
 (let ((?x70843 (g_max_vintid ?x86251)))
 (let ((?x56664 (g_nr_aprs ?x86251)))
 (let ((?x55129 (g_nr_lrs ?x86251)))
 (let ((?x54937 (g_vmids ?x86251)))
 (let ((?x69771 (g_vmid_lock ?x86251)))
 (let ((?x62935 (g_vmid_count ?x86251)))
 (let ((?x55113 (g_debug_exits ?x86251)))
 (let ((?x70824 (g_heap ?x86251)))
 (let ((?x21477 (mkGLOBALS ?x70824 ?x55113 ?x62935 ?x69771 ?x54937 ?x55129 ?x56664 ?x70843 ?x92401 ?x86300 ?x22065 ?x86299 ?x92389 ?x8126 ?x78567 ?x23802 ?x55107 ?x47359 ?x31303 ?x63242 ?x93982 ?x21877 ?x62909 ?x62913 ?x45280 ?x15952 ?x62941 ?x31301 ?x62597 ?x24515 ?x47157)))
 (let ((?x8976 (granule_data ?x24349)))
 (let ((?x86297 (gpt ?x24349)))
 (let ((?x21799 (mkShared ?x86297 ?x8976 ?x21477)))
 (let ((?x16070 (priv ?x588)))
 (let ((?x54939 (repl ?x588)))
 (let ((?x86298 (oracle ?x588)))
 (let ((?x62919 (log ?x588)))
 (let ((?x92392 (mkRData ?x62919 ?x86298 ?x54939 ?x16070 ?x21799 ?x86308 $x26943)))
 (let ((?x6972 (+ (- 1) v_3.0)))
 (let ((?x6905 (mkPtr "granules" ?x711)))
 (let ((?x18220 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x24861 (rtt_walk_lock_unlock_spec_abs.0_call ?x18220 ?x6905 0 64 v_2.0 ?x6972 ?x92392)))
 (let ((?x21834 (value_Tuple_abs_ret_rtt_RData ?x24861)))
 (let ((?x27086 (elem_1 ?x21834)))
 (let ((?x18931 (share ?x27086)))
 (let ((?x18801 (globals ?x18931)))
 (let ((?x26512 (g_granules ?x18801)))
 (let ((?x1036 (e_state_s_granule (select ?x26512 gidx.2611034))))
 (=> (not (select (gpt ?x18931) gidx.2611034)) (or (= ?x1036 0) (= ?x1036 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x26952 (* (- 1) v_3.0)))
 (let ((?x638 (query_oracle.0_call st.0)))
 ...
 (let ((?x24861 (rtt_walk_lock_unlock_spec_abs.0_call ?x18220 ?x6905 0 64 v_2.0 ?x6972 ?x92392)))
 (let ((?x21834 (value_Tuple_abs_ret_rtt_RData ?x24861)))
 (let ((?x35498 (elem_0 ?x21834)))
 (let ((?x86307 (e_1 ?x35498)))
 (= (+ ?x86307 ?x26952) (- 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x21834 (value_Tuple_abs_ret_rtt_RData ?x24861)))
 (let ((?x35498 (elem_0 ?x21834)))
 (let ((?x37030 (e_3 ?x35498)))
 (let (($x28970 (>= ?x37030 0)))
 (let (($x1049 (not (<= 512 ?x37030))))
 (and $x1049 $x28970)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x37030 (e_3 ?x35498)))
 (let ((?x916 (* 8 ?x37030)))
 (let ((?x17139 (e_2 ?x35498)))
 (let ((?x915 (poffset ?x17139)))
 (let ((?x26719 (+ ?x915 ?x916)))
 (let ((?x86303 (mkPtr "granule_data" ?x26719)))
 (let ((?x701 (abs_tte_read.0_call ?x86303 ?x27086)))
 (let ((?x1057 (meta_desc_type ?x701)))
 (let (($x24804 (= ?x1057 3)))
 (let (($x1056 (not (<= 4 v_3.0))))
 (and $x1056 $x24804)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x26472 (* (- 1) ?x24802)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 ...
 (let ((?x86303 (mkPtr "granule_data" ?x26719)))
 (let ((?x701 (abs_tte_read.0_call ?x86303 ?x27086)))
 (let ((?x1059 (meta_PA ?x701)))
 (let ((?x1060 (meta_granule_offset ?x1059)))
 (let ((?x709 (+ ?x1060 ?x26472)))
 (= ?x709 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2611144 Int) )(let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 (let ((?x86308 (stack ?x588)))
 (let ((?x24349 (share ?x588)))
 ...
 (let ((?x21834 (value_Tuple_abs_ret_rtt_RData ?x24861)))
 (let ((?x27086 (elem_1 ?x21834)))
 (let ((?x18324 (query_oracle.0_call ?x27086)))
 (let ((?x19130 (value_RData ?x18324)))
 (let ((?x61672 (share ?x19130)))
 (let ((?x25913 (globals ?x61672)))
 (let ((?x26799 (g_granules ?x25913)))
 (let ((?x1070 (e_state_s_granule (select ?x26799 gidx.2611144))))
 (let (($x1035 (not (select (gpt ?x61672) gidx.2611144))))
 (=> $x1035 (or (= ?x1070 0) (= ?x1070 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x25936 (div ?x24802 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 (let ((?x86308 (stack ?x588)))
 ...
 (let ((?x25913 (globals ?x61672)))
 (let ((?x26799 (g_granules ?x25913)))
 (let ((?x25823 (select ?x26799 ?x25936)))
 (let ((?x18933 (e_lock ?x25823)))
 (let ((?x26783 (e_val ?x18933)))
 (= ?x26783 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 ...
 (let ((?x26799 (g_granules ?x25913)))
 (let ((?x25823 (select ?x26799 ?x25936)))
 (let ((?x26308 (e_state_s_granule ?x25823)))
 (let ((?x18931 (share ?x27086)))
 (let ((?x18801 (globals ?x18931)))
 (let ((?x26512 (g_granules ?x18801)))
 (let ((?x26050 (select ?x26512 ?x25936)))
 (let ((?x25538 (e_state_s_granule ?x26050)))
 (let ((?x26434 (+ ?x25538 (* (- 1) ?x26308))))
 (= ?x26434 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x24734 (div ?x24802 4096)))
 (let ((?x25936 (div ?x24802 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 (let (($x26943 (halt ?x588)))
 ...
 (let ((?x25823 (select ?x26799 ?x25936)))
 (let ((?x26308 (e_state_s_granule ?x25823)))
 (let ((?x25919 (mks_granule ?x23844 ?x26308 (e_ref ?x25823))))
 (let ((?x25178 (store ?x26799 ?x25936 ?x25919)))
 (let ((?x19016 (select ?x25178 ?x24734)))
 (let ((?x18088 (e_state_s_granule ?x19016)))
 (= ?x18088 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let (($x47357 (>= ?x24802 0)))
 (let ((?x75725 (mod ?x24802 4096)))
 (let (($x68001 (= ?x75725 0)))
 (and $x68001 $x47357)))))))
(assert
 (let ((?x638 (query_oracle.0_call st.0)))
 ...
 (let ((?x18324 (query_oracle.0_call ?x27086)))
 (let ((?x19130 (value_RData ?x18324)))
 (let (($x17888 (halt ?x19130)))
 (let ((?x18562 (stack ?x19130)))
 (let ((?x61672 (share ?x19130)))
 (let ((?x25913 (globals ?x61672)))
 (let ((?x18891 (g_realm_attest_private_key ?x25913)))
 (let ((?x26845 (g_get_realm_identity_identity ?x25913)))
 (let ((?x25983 (g_rmm_platform_token ?x25913)))
 (let ((?x25857 (g_platform_token_buf ?x25913)))
 (let ((?x26903 (g_rmm_attest_public_key_hash_len ?x25913)))
 (let ((?x26430 (g_rmm_attest_public_key_hash ?x25913)))
 (let ((?x26814 (g_rmm_attest_public_key_len ?x25913)))
 (let ((?x67099 (g_rmm_attest_public_key ?x25913)))
 (let ((?x19358 (g_rmm_attest_signing_key ?x25913)))
 (let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x25936 (div ?x24802 16)))
 (let ((?x26799 (g_granules ?x25913)))
 ...
 (let ((?x25919 (mks_granule ?x23844 ?x26308 (e_ref ?x25823))))
 (let ((?x25178 (store ?x26799 ?x25936 ?x25919)))
 (let ((?x18697 (g_mbedtls_mem_buf ?x25913)))
 (let ((?x19289 (g_tt_l1_upper ?x25913)))
 (let ((?x26850 (g_tt_l2_mem1_3 ?x25913)))
 (let ((?x25525 (g_tt_l2_mem1_2 ?x25913)))
 (let ((?x26686 (g_tt_l2_mem1_1 ?x25913)))
 (let ((?x26899 (g_tt_l2_mem1_0 ?x25913)))
 (let ((?x25888 (g_tt_l2_mem0_1 ?x25913)))
 (let ((?x18967 (g_tt_l2_mem0_0 ?x25913)))
 (let ((?x19209 (g_tt_l3_buffer ?x25913)))
 (let ((?x26804 (g_rmm_trap_list ?x25913)))
 (let ((?x19014 (g_status_handler ?x25913)))
 (let ((?x26309 (g_default_gicstate ?x25913)))
 (let ((?x36257 (g_pri_res0_mask ?x25913)))
 (let ((?x25989 (g_max_vintid ?x25913)))
 (let ((?x25854 (g_nr_aprs ?x25913)))
 (let ((?x26724 (g_nr_lrs ?x25913)))
 (let ((?x26431 (g_vmids ?x25913)))
 (let ((?x19324 (g_vmid_lock ?x25913)))
 (let ((?x19258 (g_vmid_count ?x25913)))
 (let ((?x18437 (g_debug_exits ?x25913)))
 (let ((?x19348 (g_heap ?x25913)))
 (let ((?x18930 (mkGLOBALS ?x19348 ?x18437 ?x19258 ?x19324 ?x26431 ?x26724 ?x25854 ?x25989 ?x36257 ?x26309 ?x19014 ?x26804 ?x19209 ?x18967 ?x25888 ?x26899 ?x26686 ?x25525 ?x26850 ?x19289 ?x18697 ?x25178 ?x19358 ?x67099 ?x26814 ?x26430 ?x26903 ?x25857 ?x25983 ?x26845 ?x18891)))
 (let ((?x18894 (granule_data ?x61672)))
 (let ((?x18950 (gpt ?x61672)))
 (let ((?x19429 (priv ?x19130)))
 (let ((?x18768 (repl ?x19130)))
 (let ((?x37965 (oracle ?x19130)))
 (let ((?x18320 (log ?x19130)))
 (let ((?x26195 (mkRData ?x18320 ?x37965 ?x18768 ?x19429 (mkShared ?x18950 ?x18894 ?x18930) ?x18562 $x17888)))
 (let ((?x68023 (mkPtr "granules" ?x24802)))
 (let ((?x43867 (g_refcount_para.0_call ?x68023 ?x26195)))
 (= ?x43867 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x915 (poffset ?x17139)))
 (let (($x63831 (>= ?x915 0)))
 (let ((?x1102 (mod ?x915 4096)))
 (let (($x27241 (= ?x1102 0)))
 (let ((?x1100 (pbase ?x17139)))
 (let (($x6689 (= ?x1100 "granules")))
 (and $x6689 $x27241 $x63831)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x58142 (forall ((gidx.2611661 Int) )(let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x24734 (div ?x24802 4096)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x25919 (mks_granule ?x23844 ?x26308 (e_ref ?x25823))))
 (let ((?x25178 (store ?x26799 ?x25936 ?x25919)))
 (let ((?x26260 (select ?x25178 ?x48135)))
 (let ((?x18865 (e_ref ?x26260)))
 (let ((?x180 (e_u_anon_3_0 ?x18865)))
 (let ((?x26163 (+ (- 1) ?x180)))
 (let ((?x25671 (mku_anon_3 ?x26163)))
 (let ((?x19400 (mks_granule (e_lock ?x26260) (e_state_s_granule ?x26260) ?x25671)))
 (let ((?x93980 (store ?x25178 ?x48135 ?x19400)))
 (let ((?x920 (select ?x93980 ?x24734)))
 (let ((?x63616 (mks_granule (e_lock ?x920) 1 (e_ref ?x920))))
 (let ((?x18162 (store ?x93980 ?x24734 ?x63616)))
 (let ((?x19421 (e_state_s_granule (select ?x18162 gidx.2611661))))
 (let (($x1035 (not (select (gpt ?x61672) gidx.2611661))))
 (=> $x1035 (or (= ?x19421 0) (= ?x19421 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x58142)))
(check-sat)

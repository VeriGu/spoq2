...
(assert
 ...
 (not $x16328)))))))))))))))))))))
(assert
 (let (($x19473 (forall ((gidx.2612014 Int) )(let ((?x70823 (test_PA.0_call v_1.0)))
 (let ((?x711 (meta_granule_offset ?x70823)))
 (let ((?x55384 (div ?x711 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x22096 (e_ref ?x22102)))
 (let ((?x63510 (e_state_s_granule ?x22102)))
 (let ((?x23803 (mks_spinlock_t None_Z)))
 (let ((?x26185 (mks_granule ?x23803 ?x63510 ?x22096)))
 (let ((?x26737 (store ?x62907 ?x55384 ?x26185)))
 (let ((?x100069 (e_state_s_granule (select ?x26737 gidx.2612014))))
 (let ((?x86297 (gpt ?x24349)))
 (let (($x599 (select ?x86297 gidx.2612014)))
 (let (($x1010 (not $x599)))
 (=> $x1010 (or (= ?x100069 0) (= ?x100069 6))))))))))))))))))))))
 ))
 (not $x19473)))
(check-sat)

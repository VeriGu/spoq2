...
(assert
 ...
 (not $x26879)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x1103 (forall ((gidx.2611754 Int) )(let ((?x7899 (test_PA.0_call v_0.0)))
 (let ((?x24802 (meta_granule_offset ?x7899)))
 (let ((?x25936 (div ?x24802 16)))
 (let ((?x638 (query_oracle.0_call st.0)))
 (let ((?x588 (value_RData ?x638)))
 ...
 (let ((?x25919 (mks_granule ?x23844 ?x26308 (e_ref ?x25823))))
 (let ((?x25178 (store ?x26799 ?x25936 ?x25919)))
 (let ((?x1073 (e_state_s_granule (select ?x25178 gidx.2611754))))
 (let (($x1035 (not (select (gpt ?x61672) gidx.2611754))))
 (=> $x1035 (or (= ?x1073 0) (= ?x1073 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1103)))
(check-sat)

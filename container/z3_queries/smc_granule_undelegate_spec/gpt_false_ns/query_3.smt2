...
(assert
 ...
 (not $x137)))
(assert
 (let ((?x130 (+ (- 2147483648) v_0.0)))
 (let ((?x1091 (div ?x130 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x1092 (select ?x21 ?x1091)))
 (let ((?x8859 (e_lock ?x1092)))
 (let ((?x573 (e_val ?x8859)))
 (= ?x573 None_Z))))))))))
(assert
 (let ((?x130 (+ (- 2147483648) v_0.0)))
 (let ((?x1091 (div ?x130 4096)))
 ...
 (let ((?x21 (g_granules ?x19)))
 (let ((?x1092 (select ?x21 ?x1091)))
 (let ((?x1068 (e_state_s_granule ?x1092)))
 (let (($x1106 (= ?x1068 1)))
 (not $x1106))))))))))
(assert
 (let (($x1120 (forall ((gidx.189911 Int) )(let ((?x130 (+ (- 2147483648) v_0.0)))
 (let ((?x1091 (div ?x130 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x1092 (select ?x21 ?x1091)))
 (let ((?x1008 (e_ref ?x1092)))
 (let ((?x1068 (e_state_s_granule ?x1092)))
 (let ((?x34744 (mks_spinlock_t None_Z)))
 (let ((?x1084 (mks_granule ?x34744 ?x1068 ?x1008)))
 (let ((?x1097 (store ?x21 ?x1091 ?x1084)))
 (let ((?x1107 (e_state_s_granule (select ?x1097 gidx.189911))))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.189911)))
 (let (($x65 (not $x64)))
 (=> $x65 (or (= ?x1107 0) (= ?x1107 6)))))))))))))))))))
 ))
 (not $x1120)))
(check-sat)

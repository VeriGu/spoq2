...
(assert
 ...
 (= ?x451 0)))
(assert
 (forall ((gidx.189189 Int) )(let (($x35 (halt st.0)))
 (let ((?x34 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x609 (g_realm_attest_private_key ?x19)))
 ...
 (let ((?x446 (+ 18446744004990074880 v_0.0)))
 (let ((?x755 (get_tte_spec.0_call ?x446 ?x754)))
 (let ((?x759 (value_Tuple_Ptr_RData ?x755)))
 (let ((?x757 (elem_1 ?x759)))
 (let ((?x785 (share ?x757)))
 (let ((?x816 (globals ?x785)))
 (let ((?x811 (g_granules ?x816)))
 (let ((?x812 (e_state_s_granule (select ?x811 gidx.189189))))
 (=> (not (select (gpt ?x785) gidx.189189)) (or (= ?x812 0) (= ?x812 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.189299 Int) )(let (($x35 (halt st.0)))
 (let ((?x34 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x609 (g_realm_attest_private_key ?x19)))
 ...
 (let ((?x759 (value_Tuple_Ptr_RData ?x755)))
 (let ((?x757 (elem_1 ?x759)))
 (let ((?x760 (elem_0 ?x759)))
 (let ((?x806 (__tte_read_spec.0_call ?x760 ?x757)))
 (let ((?x823 (value_Tuple_Z_RData ?x806)))
 (let ((?x821 (elem_1 ?x823)))
 (let ((?x800 (share ?x821)))
 (let ((?x804 (globals ?x800)))
 (let ((?x783 (g_granules ?x804)))
 (let ((?x919 (e_state_s_granule (select ?x783 gidx.189299))))
 (=> (not (select (gpt ?x800) gidx.189299)) (or (= ?x919 0) (= ?x919 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x35 (halt st.0)))
 (let ((?x34 (stack st.0)))
...
(assert
 ...
 (let ((?x759 (value_Tuple_Ptr_RData ?x755)))
 (let ((?x760 (elem_0 ?x759)))
 (let ((?x831 (poffset ?x760)))
 (let (($x920 (>= ?x831 0)))
 (let ((?x651 (pbase ?x760)))
 (let (($x906 (= ?x651 "granule_data")))
 (and $x906 $x920)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x941 (forall ((gidx.189399 Int) )(let ((?x522 (^ 2 524300)))
 (let ((?x521 (to_int ?x522)))
 (let ((?x140 (+ (- 551903297536) v_0.0)))
 (let ((?x520 (div ?x140 ?x521)))
 (let ((?x12 (share st.0)))
 ...
 (let ((?x936 (e_state_s_granule (select ?x45564 gidx.189399))))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.189399)))
 (let (($x65 (not $x64)))

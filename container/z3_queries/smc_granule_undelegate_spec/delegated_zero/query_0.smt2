...
(assert
 ...
 (= ?x468 0)))
(assert
 (forall ((gidx.185996 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x444 (+ 18446744004990074880 v_0.0)))
 (let ((?x724 (get_tte_spec.0_call ?x444 ?x723)))
 (let ((?x728 (value_Tuple_Ptr_RData ?x724)))
 (let ((?x726 (elem_1 ?x728)))
 (let ((?x52360 (share ?x726)))
 (let ((?x742 (granule_data ?x52360)))
 (let ((?x767 (select ?x742 gidx.185996)))
 (=> (= (g_granule_state ?x767) 1) (= (g_norm ?x767) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.186064 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x728 (value_Tuple_Ptr_RData ?x724)))
 (let ((?x726 (elem_1 ?x728)))
 (let ((?x729 (elem_0 ?x728)))
 (let ((?x741 (__tte_read_spec.0_call ?x729 ?x726)))
 (let ((?x785 (value_Tuple_Z_RData ?x741)))
 (let ((?x783 (elem_1 ?x785)))
 (let ((?x97430 (share ?x783)))
 (let ((?x798 (granule_data ?x97430)))
 (let ((?x863 (select ?x798 gidx.186064)))
 (=> (= (g_granule_state ?x863) 1) (= (g_norm ?x863) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
...
(assert
 ...
 (let ((?x728 (value_Tuple_Ptr_RData ?x724)))
 (let ((?x729 (elem_0 ?x728)))
 (let ((?x867 (poffset ?x729)))
 (let (($x868 (>= ?x867 0)))
 (let ((?x871 (pbase ?x729)))
 (let (($x864 (= ?x871 "granule_data")))
 (and $x864 $x868)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x926 (forall ((gidx.186195 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x729 (elem_0 ?x728)))
 (let ((?x867 (poffset ?x729)))
 (let ((?x880 (div ?x867 4096)))
 (let ((?x883 (select ?x19 ?x880)))
 (let ((?x893 (g_rec ?x883)))
 (let ((?x881 (g_rd ?x883)))
 (let ((?x726 (elem_1 ?x728)))
 (let ((?x741 (__tte_read_spec.0_call ?x729 ?x726)))
 (let ((?x785 (value_Tuple_Z_RData ?x741)))
 (let ((?x786 (elem_0 ?x785)))
 (let ((?x889 (lor ?x786 32)))
 (let ((?x888 (mod ?x867 4096)))
 (let ((?x885 (g_norm ?x883)))
 (let ((?x890 (store ?x885 ?x888 ?x889)))
 (let ((?x891 (gd_g_idx ?x883)))
 (let ((?x901 (store ?x19 ?x880 (mkr_granule_data ?x891 0 ?x890 ?x881 ?x893))))
 (let ((?x920 (select ?x901 gidx.186195)))
 (=> (= (g_granule_state ?x920) 1) (= (g_norm ?x920) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x926)))
(check-sat)

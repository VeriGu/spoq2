...
(declare-fun lor (Int Int) Int)
(assert
 (forall ((gidx.60129 Int) )(let (($x54 (= (g_norm (select (granule_data (share st.0)) gidx.60129)) zero_granule_data)))
 (let (($x56 (= (g_granule_state (select (granule_data (share st.0)) gidx.60129)) 1)))
 (=> $x56 $x54))))
 )
(assert
 (let (($x540 (forall ((gidx.64998 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x49 (granule_data ?x17)))
 (let ((?x84 (select ?x49 gidx.64998)))
 (let (($x86 (= (g_norm ?x84) zero_granule_data)))
 (or (not (= (g_granule_state ?x84) 1)) $x86))))))))))
 ))
 (let (($x541 (forall ((gidx.64988 Int) )(let (($x54 (= (g_norm (select (granule_data (share st.0)) gidx.64988)) zero_granule_data)))
 (let (($x56 (= (g_granule_state (select (granule_data (share st.0)) gidx.64988)) 1)))
 (or (not $x56) $x54))))
 ))
 (or (not $x541) $x540))))
(assert
 (let ((?x279 (land v_0.0 4095)))
 (let (($x280 (= ?x279 0)))
 (let (($x138 (not (<= 556198264832 v_0.0))))
 (let (($x129 (>= v_0.0 551903297536)))
 (let (($x130 (and $x129 $x138)))
 (let (($x128 (not (<= 4294967296 v_0.0))))
 (let (($x119 (>= v_0.0 2147483648)))
 (let (($x120 (and $x119 $x128)))
 (let (($x123 (or $x120 $x130)))
 (and $x123 $x280)))))))))))
(assert
 (>= v_0.0 551903297536))
(assert
 (let ((?x543 (^ 2 524300)))
 (let ((?x537 (to_int ?x543)))
 (let ((?x132 (+ (- 551903297536) v_0.0)))
 (let ((?x536 (div ?x132 ?x537)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x521 (g_granules ?x523)))
 (let ((?x535 (select ?x521 ?x536)))
 (let ((?x533 (e_lock ?x535)))
 (let ((?x532 (e_val ?x533)))
 (= ?x532 None_Z))))))))))))
(assert
 (let ((?x543 (^ 2 524300)))
 ...
 (let ((?x521 (g_granules ?x523)))
 (let ((?x535 (select ?x521 ?x536)))
 (let ((?x566 (e_state_s_granule ?x535)))
 (= ?x566 1)))))))))))
(assert
 (forall ((gidx.185928 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 (let ((?x596 (g_get_realm_identity_identity ?x523)))
 (let ((?x595 (g_rmm_platform_token ?x523)))
 (let ((?x594 (g_platform_token_buf ?x523)))
 (let ((?x593 (g_rmm_attest_public_key_hash_len ?x523)))
 (let ((?x592 (g_rmm_attest_public_key_hash ?x523)))
 (let ((?x591 (g_rmm_attest_public_key_len ?x523)))
 (let ((?x590 (g_rmm_attest_public_key ?x523)))
 (let ((?x589 (g_rmm_attest_signing_key ?x523)))
 (let ((?x543 (^ 2 524300)))
 (let ((?x537 (to_int ?x543)))
 (let ((?x132 (+ (- 551903297536) v_0.0)))
 (let ((?x536 (div ?x132 ?x537)))
 ...
 (let ((?x558 (e_ref ?x535)))
 (let ((?x566 (e_state_s_granule ?x535)))
 (let ((?x565 (Some_Z CPU_ID.0)))
 (let ((?x561 (mks_spinlock_t ?x565)))
 (let ((?x567 (mks_granule ?x561 ?x566 ?x558)))
 (let ((?x559 (store ?x521 ?x536 ?x567)))
 (let ((?x588 (g_mbedtls_mem_buf ?x523)))
 (let ((?x587 (g_tt_l1_upper ?x523)))
 (let ((?x586 (g_tt_l2_mem1_3 ?x523)))
 (let ((?x585 (g_tt_l2_mem1_2 ?x523)))
 (let ((?x584 (g_tt_l2_mem1_1 ?x523)))
 (let ((?x583 (g_tt_l2_mem1_0 ?x523)))
 (let ((?x582 (g_tt_l2_mem0_1 ?x523)))
 (let ((?x581 (g_tt_l2_mem0_0 ?x523)))
 (let ((?x554 (g_tt_l3_buffer ?x523)))
 (let ((?x580 (g_rmm_trap_list ?x523)))
 (let ((?x579 (g_status_handler ?x523)))
 (let ((?x578 (g_default_gicstate ?x523)))
 (let ((?x577 (g_pri_res0_mask ?x523)))
 (let ((?x576 (g_max_vintid ?x523)))
 (let ((?x575 (g_nr_aprs ?x523)))
 (let ((?x574 (g_nr_lrs ?x523)))
 (let ((?x556 (g_vmids ?x523)))
 (let ((?x557 (g_vmid_lock ?x523)))
 (let ((?x562 (g_vmid_count ?x523)))
 (let ((?x560 (g_debug_exits ?x523)))
 (let ((?x563 (g_heap ?x523)))
 (let ((?x598 (mkGLOBALS ?x563 ?x560 ?x562 ?x557 ?x556 ?x574 ?x575 ?x576 ?x577 ?x578 ?x579 ?x580 ?x554 ?x581 ?x582 ?x583 ?x584 ?x585 ?x586 ?x587 ?x588 ?x559 ?x589 ?x590 ?x591 ?x592 ?x593 ?x594 ?x595 ?x596 ?x597)))
 (let ((?x19 (granule_data ?x12)))
 (let ((?x599 (gpt ?x12)))
 (let ((?x26 (priv st.0)))
 (let ((?x14 (repl st.0)))
 (let ((?x9 (oracle st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x601 (mkRData ?x7 ?x9 ?x14 ?x26 (mkShared ?x599 ?x19 ?x598) ?x27 $x28)))
 (let ((?x603 (monitor_call_state_oracle.0_call 3288334593 v_0.0 0 0 0 0 0 ?x601)))
 (let ((?x607 (value_Tuple_Z_RData ?x603)))
 (let ((?x605 (elem_1 ?x607)))
 (let ((?x9340 (share ?x605)))
 (let ((?x617 (granule_data ?x9340)))
 (let ((?x632 (select ?x617 gidx.185928)))
 (=> (= (g_granule_state ?x632) 1) (= (g_norm ?x632) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x468 (land v_0.0 549755813888)))
 (let (($x448 (= ?x468 0)))
 (not $x448))))
(assert
 (forall ((gidx.186263 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x607 (value_Tuple_Z_RData ?x603)))
 (let ((?x605 (elem_1 ?x607)))
 (let ((?x647 (mks_granule (e_lock (select (g_granules (globals (share ?x605))) ?x536)) 0 (e_ref (select (g_granules (globals (share ?x605))) ?x536)))))
 (let ((?x9340 (share ?x605)))
 (let ((?x644 (globals ?x9340)))
 (let ((?x645 (g_granules ?x644)))
 (let ((?x648 (store ?x645 ?x536 ?x647)))
 (let ((?x714 (mkGLOBALS (g_heap ?x644) (g_debug_exits ?x644) (g_vmid_count ?x644) (g_vmid_lock ?x644) (g_vmids ?x644) (g_nr_lrs ?x644) (g_nr_aprs ?x644) (g_max_vintid ?x644) (g_pri_res0_mask ?x644) (g_default_gicstate ?x644) (g_status_handler ?x644) (g_rmm_trap_list ?x644) (g_tt_l3_buffer ?x644) (g_tt_l2_mem0_0 ?x644) (g_tt_l2_mem0_1 ?x644) (g_tt_l2_mem1_0 ?x644) (g_tt_l2_mem1_1 ?x644) (g_tt_l2_mem1_2 ?x644) (g_tt_l2_mem1_3 ?x644) (g_tt_l1_upper ?x644) (g_mbedtls_mem_buf ?x644) ?x648 (g_rmm_attest_signing_key ?x644) (g_rmm_attest_public_key ?x644) (g_rmm_attest_public_key_len ?x644) (g_rmm_attest_public_key_hash ?x644) (g_rmm_attest_public_key_hash_len ?x644) (g_platform_token_buf ?x644) (g_rmm_platform_token ?x644) (g_get_realm_identity_identity ?x644) (g_realm_attest_private_key ?x644))))
 (let ((?x617 (granule_data ?x9340)))
 (let ((?x723 (mkRData (log ?x605) (oracle ?x605) (repl ?x605) (priv ?x605) (mkShared (gpt ?x9340) ?x617 ?x714) (stack ?x605) (halt ?x605))))
 (let ((?x480 (+ 18446743457381744640 v_0.0)))
 (let ((?x47652 (get_tte_spec.0_call ?x480 ?x723)))
 (let ((?x943 (value_Tuple_Ptr_RData ?x47652)))
 (let ((?x936 (elem_1 ?x943)))
 (let ((?x52525 (share ?x936)))
 (let ((?x980 (granule_data ?x52525)))
 (let ((?x919 (select ?x980 gidx.186263)))
 (=> (= (g_granule_state ?x919) 1) (= (g_norm ?x919) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.186331 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x943 (value_Tuple_Ptr_RData ?x47652)))
 (let ((?x936 (elem_1 ?x943)))
 (let ((?x942 (elem_0 ?x943)))
 (let ((?x934 (__tte_read_spec.0_call ?x942 ?x936)))
 (let ((?x974 (value_Tuple_Z_RData ?x934)))
 (let ((?x970 (elem_1 ?x974)))
 (let ((?x64361 (share ?x970)))
 (let ((?x992 (granule_data ?x64361)))
 (let ((?x1015 (select ?x992 gidx.186331)))
 (=> (= (g_granule_state ?x1015) 1) (= (g_norm ?x1015) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
...
(assert
 ...
 (let ((?x943 (value_Tuple_Ptr_RData ?x47652)))
 (let ((?x942 (elem_0 ?x943)))
 (let ((?x1019 (poffset ?x942)))
 (let (($x1020 (>= ?x1019 0)))
 (let ((?x1023 (pbase ?x942)))
 (let (($x1016 (= ?x1023 "granule_data")))
 (and $x1016 $x1020)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x1059 (forall ((gidx.186462 Int) )(let (($x28 (halt st.0)))
 (let ((?x27 (stack st.0)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x597 (g_realm_attest_private_key ?x523)))
 ...
 (let ((?x942 (elem_0 ?x943)))
 (let ((?x1019 (poffset ?x942)))
 (let ((?x1028 (div ?x1019 4096)))
 (let ((?x1032 (select ?x19 ?x1028)))
 (let ((?x1038 (g_rec ?x1032)))
 (let ((?x1037 (g_rd ?x1032)))
 (let ((?x936 (elem_1 ?x943)))
 (let ((?x934 (__tte_read_spec.0_call ?x942 ?x936)))
 (let ((?x974 (value_Tuple_Z_RData ?x934)))
 (let ((?x928 (elem_0 ?x974)))
 (let ((?x1030 (lor ?x928 32)))
 (let ((?x1029 (mod ?x1019 4096)))
 (let ((?x1036 (g_norm ?x1032)))
 (let ((?x1031 (store ?x1036 ?x1029 ?x1030)))
 (let ((?x1033 (gd_g_idx ?x1032)))
 (let ((?x1043 (store ?x19 ?x1028 (mkr_granule_data ?x1033 0 ?x1031 ?x1037 ?x1038))))
 (let ((?x1053 (select ?x1043 gidx.186462)))
 (=> (= (g_granule_state ?x1053) 1) (= (g_norm ?x1053) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1059)))
(check-sat)

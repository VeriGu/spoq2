...
(assert
 ...
 (not $x129)))
(assert
 (let ((?x122 (+ (- 2147483648) v_0.0)))
 (let ((?x1069 (div ?x122 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x523 (globals ?x12)))
 (let ((?x521 (g_granules ?x523)))
 (let ((?x1091 (select ?x521 ?x1069)))
 (let ((?x9750 (e_lock ?x1091)))
 (let ((?x572 (e_val ?x9750)))
 (= ?x572 None_Z))))))))))
(assert
 (let ((?x122 (+ (- 2147483648) v_0.0)))
 (let ((?x1069 (div ?x122 4096)))
 ...
 (let ((?x521 (g_granules ?x523)))
 (let ((?x1091 (select ?x521 ?x1069)))
 (let ((?x1072 (e_state_s_granule ?x1091)))
 (let (($x1060 (= ?x1072 1)))
 (not $x1060))))))))))
(assert
 (let (($x1100 (forall ((gidx.186612 Int) )(let (($x54 (= (g_norm (select (granule_data (share st.0)) gidx.186612)) zero_granule_data)))
 (let (($x56 (= (g_granule_state (select (granule_data (share st.0)) gidx.186612)) 1)))
 (=> $x56 $x54))))
 ))
 (not $x1100)))
(check-sat)

...
(assert
 ...
 (and $x1317 $x1318)))))))
(assert
 (let (($x1428 (forall ((rtt_gidx.553032 Int) (ipa_gidx.553032 Int) (data_gidx.553032 Int) )(let ((?x427 (query_oracle.0_call st.0)))
 (let ((?x501 (value_RData ?x427)))
 (let ((?x612 (share ?x501)))
 (let ((?x9011 (granule_data ?x612)))
 (let ((?x1153 (g_granule_state (select ?x9011 (rtt_walk_abs.0_call ?x501 rtt_gidx.553032 ipa_gidx.553032)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.553032)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x612)) rtt_gidx.553032)) 5) $x142) (or (= ?x1153 4) (= ?x1153 6))))))))))
 ))
 (not $x1428)))
(check-sat)

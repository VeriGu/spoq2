...
(assert
 ...
 (let ((?x409 (g_granules ?x620)))
 (let ((?x1324 (select ?x409 ?x1287)))
 (let ((?x1328 (e_ref ?x1324)))
 (let ((?x1354 (e_state_s_granule ?x1324)))
 (let ((?x25108 (Some_Z CPU_ID.0)))
 (let ((?x62443 (mks_spinlock_t ?x25108)))
 (let ((?x1423 (mks_granule ?x62443 ?x1354 ?x1328)))
 ...
 (not $x975)))))))))))))))))))))
(assert
 (let (($x1635 (forall ((rtt_gidx.553816 Int) (ipa_gidx.553816 Int) (data_gidx.553816 Int) )(let ((?x427 (query_oracle.0_call st.0)))
 (let ((?x501 (value_RData ?x427)))
 (let (($x46988 (halt ?x501)))
 (let ((?x39265 (stack ?x501)))
 (let ((?x612 (share ?x501)))
 ...
 (let ((?x1328 (e_ref ?x1324)))
 (let ((?x1354 (e_state_s_granule ?x1324)))
 (let ((?x85617 (mks_spinlock_t None_Z)))
 (let ((?x1881 (mks_granule ?x85617 ?x1354 ?x1328)))
 (let ((?x1738 (store ?x409 ?x1287 ?x1881)))
 (let ((?x46937 (g_mbedtls_mem_buf ?x620)))
 (let ((?x46966 (g_tt_l1_upper ?x620)))
 (let ((?x46965 (g_tt_l2_mem1_3 ?x620)))
 (let ((?x54687 (g_tt_l2_mem1_2 ?x620)))
 ...
 (let ((?x54679 (g_debug_exits ?x620)))
 (let ((?x39213 (g_heap ?x620)))
 (let ((?x686 (mkGLOBALS ?x39213 ?x54679 ?x31477 ?x39205 ?x31483 ?x70158 ?x54689 ?x39232 ?x62444 ?x555 ?x70173 ?x62431 ?x62432 ?x62433 ?x54698 ?x54699 ?x54700 ?x54687 ?x46965 ?x46966 ?x46937 ?x1738 ?x39234 ?x39235 ?x39227 ?x31492 ?x54718 ?x31491 ?x31467 ?x47002 ?x85597)))
 (let ((?x9011 (granule_data ?x612)))
 (let ((?x85599 (gpt ?x612)))
 (let ((?x39264 (priv ?x501)))
 (let ((?x39256 (repl ?x501)))
 (let ((?x39255 (oracle ?x501)))
 (let ((?x413 (log ?x501)))
 (let ((?x1834 (mkRData ?x413 ?x39255 ?x39256 ?x39264 (mkShared ?x85599 ?x9011 ?x686) ?x39265 $x46988)))
 (let ((?x1684 (g_granule_state (select ?x9011 (rtt_walk_abs.0_call ?x1834 rtt_gidx.553816 ipa_gidx.553816)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.553816)))
 (=> (and (= (e_state_s_granule (select ?x1738 rtt_gidx.553816)) 5) $x142) (or (= ?x1684 4) (= ?x1684 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1635)))
(check-sat)

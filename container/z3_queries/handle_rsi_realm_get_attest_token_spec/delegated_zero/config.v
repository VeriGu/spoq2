...
(* Hint OnlyTrans rsi_set_ttbr0. *)
Hint OnlyTrans handle_rsi_realm_get_attest_token.
...
Section Layer8.
  ...
  Definition handle_rsi_realm_get_attest_token_spec_low (v_0: Ptr) (v_1: Ptr) (st: RData) : (option RData) :=
    ...
    then (
      ...
      then (
        when v_34, st_8 == (
            (create_realm_token_spec
              (mkPtr "granule_data" ((rec_to_rd_para (mkPtr (v_1.(pbase)) ((v_1.(poffset)) + (944))) (st.[stack].[stack_type_4] :< 0)).(poffset)))
              v_1
              (mkPtr "null" 0)
              (mkPtr "stack_s_q_useful_buf__3" 0)
              (st.[stack].[stack_type_4] :< 0)));
        if (
          (((((((st_8.(share)).(globals)).(g_rmm_platform_token)).(e_len_s_q_useful_buf)) + ((((st_8.(stack)).(stack_s_q_useful_buf__3)).(e_len_s_q_useful_buf)))) -
            ((((((st.(share)).(granule_data)) @ (((v_1.(poffset)) + (40)) / (4096))).(g_norm)) @ (((v_1.(poffset)) + (40)) mod (4096))))) >?
            (0)))
        then (
          (Some (st_8.[stack].[stack_s_attest_result] :<
            ((((st_8.(stack)).(stack_s_attest_result)).[e_return_to_realm] :< 1).[e_smc_result] :<
              ((((st_8.(stack)).(stack_s_attest_result)).(e_smc_result)).[e_x0] :< (pack_struct_return_code_para (make_return_code_para 1)))))))
        else (
          when v_67, st_17 == (
              (memcpy_spec
                (mkPtr "granule_data" ((test_PA ((st_8.(stack)).(stack_type_4))).(meta_granule_offset)))
                (test_Z_Ptr (((st_8.(stack)).(stack_s_q_useful_buf__3)).(e_ptr)))
                (((st_8.(stack)).(stack_s_q_useful_buf__3)).(e_len_s_q_useful_buf))
                st_8));
          when v_72, st_21 == (
              (memcpy_spec
                (mkPtr
                  "granule_data"
                  (((test_PA ((st_8.(stack)).(stack_type_4))).(meta_granule_offset)) + ((1 * ((((st_17.(stack)).(stack_s_q_useful_buf__3)).(e_len_s_q_useful_buf)))))))
                (test_Z_Ptr ((((st_17.(share)).(globals)).(g_rmm_platform_token)).(e_ptr)))
                ((((st_17.(share)).(globals)).(g_rmm_platform_token)).(e_len_s_q_useful_buf))
                st_17));
          when st_23 == ((granule_unlock_spec (test_Z_Ptr ((st_21.(stack)).(stack_type_4))) st_21));
          (Some (st_23.[stack].[stack_s_attest_result] :<
            ((((st_23.(stack)).(stack_s_attest_result)).[e_return_to_realm] :< 1).[e_smc_result] :<
              (((((st_23.(stack)).(stack_s_attest_result)).(e_smc_result)).[e_x0] :< 0).[e_x1] :<
                (((((st_23.(share)).(globals)).(g_rmm_platform_token)).(e_len_s_q_useful_buf)) + ((((st_23.(stack)).(stack_s_q_useful_buf__3)).(e_len_s_q_useful_buf))))))))))
      else (
        (Some ((st.[stack].[stack_s_attest_result] :<
          ((((st.(stack)).(stack_s_attest_result)).[e_return_to_realm] :< 1).[e_smc_result] :<
            ((((st.(stack)).(stack_s_attest_result)).(e_smc_result)).[e_x0] :< (pack_struct_return_code_para (make_return_code_para 1))))).[stack].[stack_type_4] :<
...
Section Layer9.
  ...
  Definition masked_assign_spec_abs (pte: abs_PTE_t) (attr: Z) : (abs_PTE_t) :=
    (mkabs_PTE_t pte.(meta_PA) 
      (abs_attr_to_desc_type attr)
      (abs_attr_to_ripas attr)
      (abs_attr_to_mem_attr attr)).
        ...
        then (
          ...
          then (
            ...
            then (
              ...
              rely (((((test_PA v_0_Zptr).(meta_granule_offset)) mod (4096)) = (0)));
              rely (((st_4.(share).(globals).(g_granules) @ ((((ret_record.(e_2)).(poffset)) + ((8 * ((ret_record.(e_3)))))) / 4096)).(e_state_s_granule) = GRANULE_STATE_RTT));
              when st_14 == (
                  (granule_unlock_spec
                    (ret_record.(e_2))
                    ((st_4.[share].[globals].[g_granules] :<
              ...
              | (Some (__return___0, __retval___0, st_6)) =>
                ...
                then (
                  ...
                  then (
                    ...
                    rely ((((((ret_record.(e_2)).(poffset)) + (8)) mod (4096)) = (8)));
                    rely (((((test_PA v_0_Zptr).(meta_granule_offset)) mod (4096)) = (0)));
                    rely (((st_11.(share).(globals).(g_granules) @ ((((ret_record.(e_2)).(poffset)) + ((8 * ((ret_record.(e_3)))))) / 4096)).(e_state_s_granule) = GRANULE_STATE_RTT));
                    when st_17 == (
                        (granule_unlock_spec
                          (ret_record.(e_2))
                          ((st_11.[share].[globals].[g_granules] :<
            ...
            then (None)
              ...
              | None =>
                ...
                then (
                  ...
                  (* first check parent tte's granule state: *)
                  rely ((((((st1_0.(share)).(globals)).(g_granules)) @ ((((ret_rtt.(e_2)).(poffset)) + ((8 * ((ret_rtt.(e_3)))))) / (4096))).(e_state_s_granule)) = (5));
                  (* then check tte's granule state *)
                  rely (((((((st1_0.(share)).(globals)).(g_granules)) @ ((((test_Z_PTE v_3).(meta_PA)).(meta_granule_offset)) / (4096))).(e_state_s_granule)) = (0)) \/ 
                        ((((((st1_0.(share)).(globals)).(g_granules)) @ ((((test_Z_PTE v_3).(meta_PA)).(meta_granule_offset)) / (4096))).(e_state_s_granule)) = (6)));
                  (Some (
                    0  ,
                    (st1_0.[share].[granule_data] :<
                      (((st1_0.(share)).(granule_data)) #
...
(* Definition rtt_map_data_cond_upd_rtt_tte (st: RData) : Prop :=
  (forall (parent_gidx : Z) (pa : Z) (x : Z) (y: Z) (z : Z), 
    ((rtt_map_data st) -> 
     (* ((st.(share).(globals).(g_granules) @ (parent_gidx / 4096)).(e_state_s_granule) = GRANULE_STATE_RTT) -> *)
     (rtt_map_data ((st.[share].[globals].[g_granules] :<
                    ((((st.(share)).(globals)).(g_granules)) #
                      ((((test_PA pa).(meta_granule_offset))) / (4096)) ==
                      (((((st.(share)).(globals)).(g_granules)) @ ((((test_PA pa).(meta_granule_offset))) / (4096))).[e_state_s_granule] :< 5))).[share].[granule_data] :<
                    (((st.(share)).(granule_data)) #
                      (parent_gidx / (4096)) ==
                      ((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).[g_norm] :<
                        (((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).(g_norm)) #
                          (parent_gidx mod (4096)) == (test_PTE_Z (mkabs_PTE_t (test_PA pa) x y z)))))))
     )). *)

(* Definition rtt_map_data_cond_upd_rtt_attr (st: RData) : Prop :=
  (forall (parent_gidx : Z) (pa : abs_PA_t) (x : Z) (y: Z) (z : Z), 
    ((rtt_map_data st) -> 
     (* ((st.(share).(globals).(g_granules) @ (parent_gidx / 4096)).(e_state_s_granule) = GRANULE_STATE_RTT) -> *)
     (rtt_map_data ((st.[share].[globals].[g_granules] :<
                      ((((st.(share)).(globals)).(g_granules)) #
                        ((((pa).(meta_granule_offset))) / (4096)) ==
                        (((((st.(share)).(globals)).(g_granules)) @ ((((pa).(meta_granule_offset))) / (4096))).[e_state_s_granule] :< 5))).[share].[granule_data] :<
                        (((st.(share)).(granule_data)) #
                          (parent_gidx / (4096)) ==
                          ((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).[g_norm] :<
                            (((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).(g_norm)) #
                              (parent_gidx mod (4096)) == (test_PTE_Z (mkabs_PTE_t (pa) x y z)))))))
     )). *)
...
Definition rtt_map_data_ind_cond_5 (st: RData) : Prop :=
  (forall (offset : Z),
    ((rtt_map_data st) -> 
      ((st.(share).(granule_data) @ (offset)).(g_norm) = zero_granule_data) ->
      (rtt_map_data (st.[share].[globals].[g_granules] :<
      ((st.(share).(globals).(g_granules)) # (offset) ==
        (((((st.(share)).(globals)).(g_granules)) @ offset).[e_state_s_granule] :< 5))))
    )). *)

(* update valid entry *)
(* Definition rtt_map_data_ind_cond_6 (st: RData) : Prop :=
  (forall (parent_gidx : Z) (pte_z : Z), 
    ((rtt_map_data st) -> 
       ((st.(share).(globals).(g_granules) @ (parent_gidx / 4096)).(e_state_s_granule) = GRANULE_STATE_RTT) ->
       (((((((st.(share)).(globals)).(g_granules)) @ ((((test_Z_PTE pte_z).(meta_PA)).(meta_granule_offset)) / (4096))).(e_state_s_granule)) = (GRANULE_STATE_NS)) \/ 
        ((((((st.(share)).(globals)).(g_granules)) @ ((((test_Z_PTE pte_z).(meta_PA)).(meta_granule_offset)) / (4096))).(e_state_s_granule)) = (GRANULE_STATE_ANY))) ->
      (rtt_map_data (st.[share].[granule_data] :<
      (((st.(share)).(granule_data)) #
        (parent_gidx / (4096)) ==
        ((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).[g_norm] :<
          (((((st.(share)).(granule_data)) @ (parent_gidx / (4096))).(g_norm)) #
            (parent_gidx mod (4096)) == pte_z)))))
  )). *)

Definition pte_Z_equiv (st: RData) : Prop :=
  (forall (v : Z), (test_PTE_Z (test_Z_PTE v) - (v) = 0)).

Definition pack_non_zero (st : RData) : Prop :=
  (forall (v : Z), (pack_struct_return_code_para (make_return_code_para v) <> (0))).

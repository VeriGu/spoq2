...
(assert
 ...
 (not $x2269)))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.315602 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x2040 (e_state_s_granule (select ?x149201 gidx.315602))))
 (=> (not (select (gpt ?x33504) gidx.315602)) (or (= ?x2040 0) (= ?x2040 6)))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.315712 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x158047 (e_state_s_granule (select ?x2261 gidx.315712))))
 (=> (not (select (gpt ?x44518) gidx.315712)) (or (= ?x158047 0) (= ?x158047 6)))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x50905 (forall ((gidx.315768 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x126835 (globals ?x44518)))
 (let ((?x2261 (g_granules ?x126835)))
 (let ((?x158047 (e_state_s_granule (select ?x2261 gidx.315768))))
 (=> (not (select (gpt ?x44518) gidx.315768)) (or (= ?x158047 0) (= ?x158047 6)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x50905)))
(check-sat)

...
(assert
 ...
 (not $x1800)))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.313396 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1902 (e_state_s_granule (select ?x2092 gidx.313396))))
 (=> (not (select (gpt ?x2079) gidx.313396)) (or (= ?x1902 0) (= ?x1902 6)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.313506 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x125267 (e_state_s_granule (select ?x2043 gidx.313506))))
 (=> (not (select (gpt ?x35101) gidx.313506)) (or (= ?x125267 0) (= ?x125267 6)))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x150580 (forall ((gidx.313562 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x150576 (globals ?x35101)))
 (let ((?x2043 (g_granules ?x150576)))
 (let ((?x125267 (e_state_s_granule (select ?x2043 gidx.313562))))
 (=> (not (select (gpt ?x35101) gidx.313562)) (or (= ?x125267 0) (= ?x125267 6)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x150580)))
(check-sat)

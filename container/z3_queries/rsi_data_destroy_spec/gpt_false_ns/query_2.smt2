...
(assert
 ...
 (check_rcsm_mask_para.0_call ?x766)))
(assert
 (forall ((gidx.310198 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 ...
 (let ((?x1105 (e_state_s_granule (select ?x810 gidx.310198))))
 (=> (not (select (gpt ?x762) gidx.310198)) (or (= ?x1105 0) (= ?x1105 6)))))))))))))
 )
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
...
(assert
 ...
 (and $x1048 $x1075)))))))
(assert
 (forall ((gidx.310308 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 (let ((?x1101 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1108 (rtt_walk_lock_unlock_spec_abs.0_call ?x1101 ?x749 0 64 v_1.0 3 ?x842)))
 (let ((?x1070 (value_Tuple_abs_ret_rtt_RData ?x1108)))
 (let ((?x1106 (elem_1 ?x1070)))
 (let ((?x1156 (share ?x1106)))
 (let ((?x1155 (globals ?x1156)))
 (let ((?x1159 (g_granules ?x1155)))
 (let ((?x1152 (e_state_s_granule (select ?x1159 gidx.310308))))
 (=> (not (select (gpt ?x1156) gidx.310308)) (or (= ?x1152 0) (= ?x1152 6)))))))))))))))))
 )
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
...
(assert
 ...
 (let ((?x1173 (* 8 ?x1172)))
 (let ((?x1169 (e_2 ?x1092)))
 (let ((?x1170 (poffset ?x1169)))
 (let ((?x1174 (+ ?x1170 ?x1173)))
 (let ((?x1175 (mkPtr "granule_data" ?x1174)))
 (let ((?x1177 (abs_tte_read.0_call ?x1175 ?x1106)))
 (let ((?x1179 (meta_desc_type ?x1177)))
 (let (($x1180 (= ?x1179 3)))
 (not $x1180)))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 ...
 (let ((?x1175 (mkPtr "granule_data" ?x1174)))
 (let ((?x1177 (abs_tte_read.0_call ?x1175 ?x1106)))
 (let ((?x17327 (meta_mem_attr ?x1177)))
 (let (($x17287 (= ?x17327 1)))
 (let ((?x1293 (meta_ripas ?x1177)))
 (let (($x17341 (= ?x1293 0)))
 (let ((?x1179 (meta_desc_type ?x1177)))
 (let (($x94383 (= ?x1179 0)))
 (and $x94383 $x17341 $x17287)))))))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 ...
 (let ((?x1170 (poffset ?x1169)))
 (let (($x1187 (>= ?x1170 0)))
 (let ((?x1184 (mod ?x1170 4096)))
 (let (($x1185 (= ?x1184 0)))
 (let ((?x1182 (pbase ?x1169)))
 (let (($x1183 (= ?x1182 "granules")))
 (and $x1183 $x1185 $x1187))))))))))))))))))
(assert
 (forall ((gidx.311190 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1175 (mkPtr "granule_data" ?x1174)))
 (let ((?x1177 (abs_tte_read.0_call ?x1175 ?x1106)))
 (let ((?x1190 (meta_PA ?x1177)))
 (let ((?x1191 (meta_granule_offset ?x1190)))
 (let ((?x1192 (mkPtr "granules" ?x1191)))
 (let ((?x1193 (spinlock_acquire_spec.0_call ?x1192 ?x1106)))
 (let ((?x1195 (value_RData ?x1193)))
 (let ((?x1262 (share ?x1195)))
 (let ((?x1240 (globals ?x1262)))
 (let ((?x1242 (g_granules ?x1240)))
 (let ((?x1250 (e_state_s_granule (select ?x1242 gidx.311190))))
 (=> (not (select (gpt ?x1262) gidx.311190)) (or (= ?x1250 0) (= ?x1250 6))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 ...
 (let ((?x1240 (globals ?x1262)))
 (let ((?x1242 (g_granules ?x1240)))
 (let ((?x1238 (select ?x1242 ?x1248)))
 (let ((?x1239 (e_state_s_granule ?x1238)))
 (= ?x1239 4))))))))))))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
...
(assert
 ...
 (let ((?x1193 (spinlock_acquire_spec.0_call ?x1192 ?x1106)))
 (let ((?x1195 (value_RData ?x1193)))
 (let ((?x1149 (g_refcount_para.0_call ?x1192 ?x1195)))
 (= ?x1149 0)))))))))))))))))))))))))
(assert
 (forall ((gidx.311300 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1193 (spinlock_acquire_spec.0_call ?x1192 ?x1106)))
 (let ((?x1195 (value_RData ?x1193)))
 (let ((?x1296 (mkPtr "granule_data" ?x1191)))
 (let ((?x1297 (memset_spec.0_call ?x1296 0 4096 ?x1195)))
 (let ((?x1286 (value_Tuple_Ptr_RData ?x1297)))
 (let ((?x1300 (elem_1 ?x1286)))
 (let ((?x1345 (share ?x1300)))
 (let ((?x1340 (globals ?x1345)))
 (let ((?x1307 (g_granules ?x1340)))
 (let ((?x1232 (e_state_s_granule (select ?x1307 gidx.311300))))
 (let (($x1289 (not (select (gpt ?x1345) gidx.311300))))
 (=> $x1289 (or (= ?x1232 0) (= ?x1232 6)))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.311410 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1286 (value_Tuple_Ptr_RData ?x1297)))
 (let ((?x1300 (elem_1 ?x1286)))
 (let ((?x17006 (mks_granule (e_lock (select (g_granules (globals (share ?x1300))) (div ?x1191 4096))) 1 (e_ref (select (g_granules (globals (share ?x1300))) (div ?x1191 4096))))))
 (let ((?x1248 (div ?x1191 4096)))
 (let ((?x1345 (share ?x1300)))
 (let ((?x1340 (globals ?x1345)))
 (let ((?x1307 (g_granules ?x1340)))
 (let ((?x16992 (store ?x1307 ?x1248 ?x17006)))
 (let ((?x24843 (mkGLOBALS (g_heap ?x1340) (g_debug_exits ?x1340) (g_vmid_count ?x1340) (g_vmid_lock ?x1340) (g_vmids ?x1340) (g_nr_lrs ?x1340) (g_nr_aprs ?x1340) (g_max_vintid ?x1340) (g_pri_res0_mask ?x1340) (g_default_gicstate ?x1340) (g_status_handler ?x1340) (g_rmm_trap_list ?x1340) (g_tt_l3_buffer ?x1340) (g_tt_l2_mem0_0 ?x1340) (g_tt_l2_mem0_1 ?x1340) (g_tt_l2_mem1_0 ?x1340) (g_tt_l2_mem1_1 ?x1340) (g_tt_l2_mem1_2 ?x1340) (g_tt_l2_mem1_3 ?x1340) (g_tt_l1_upper ?x1340) (g_mbedtls_mem_buf ?x1340) ?x16992 (g_rmm_attest_signing_key ?x1340) (g_rmm_attest_public_key ?x1340) (g_rmm_attest_public_key_len ?x1340) (g_rmm_attest_public_key_hash ?x1340) (g_rmm_attest_public_key_hash_len ?x1340) (g_platform_token_buf ?x1340) (g_rmm_platform_token ?x1340) (g_get_realm_identity_identity ?x1340) (g_realm_attest_private_key ?x1340))))
 (let ((?x1343 (gpt ?x1345)))
 (let ((?x17089 (mkRData (log ?x1300) (oracle ?x1300) (repl ?x1300) (priv ?x1300) (mkShared ?x1343 (granule_data ?x1345) ?x24843) (stack ?x1300) (halt ?x1300))))
 (let ((?x17091 (granule_unlock_spec.0_call ?x1192 ?x17089)))
 (let ((?x9180 (value_RData ?x17091)))
 (let ((?x102095 (share ?x9180)))
 (let ((?x1404 (globals ?x102095)))
 (let ((?x1420 (g_granules ?x1404)))
 (let ((?x1388 (e_state_s_granule (select ?x1420 gidx.311410))))
 (=> (not (select (gpt ?x102095) gidx.311410)) (or (= ?x1388 0) (= ?x1388 6)))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.311520 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x17091 (granule_unlock_spec.0_call ?x1192 ?x17089)))
 (let ((?x9180 (value_RData ?x17091)))
 (let ((?x1396 (granule_unlock_spec.0_call ?x1169 ?x9180)))
 (let ((?x1465 (value_RData ?x1396)))
 (let ((?x1437 (share ?x1465)))
 (let ((?x1440 (globals ?x1437)))
 (let ((?x1461 (g_granules ?x1440)))
 (let ((?x1317 (e_state_s_granule (select ?x1461 gidx.311520))))
 (=> (not (select (gpt ?x1437) gidx.311520)) (or (= ?x1317 0) (= ?x1317 6)))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x25234 (forall ((gidx.311576 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1440 (globals ?x1437)))
 (let ((?x1461 (g_granules ?x1440)))
 (let ((?x1317 (e_state_s_granule (select ?x1461 gidx.311576))))
 (=> (not (select (gpt ?x1437) gidx.311576)) (or (= ?x1317 0) (= ?x1317 6)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x25234)))
(check-sat)

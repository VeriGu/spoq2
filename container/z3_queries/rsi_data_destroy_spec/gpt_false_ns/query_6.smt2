...
(assert
 ...
 (not $x1120))))))))))))))
(assert
 (forall ((gidx.312294 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x25544 (e_state_s_granule (select ?x25551 gidx.312294))))
 (=> (not (select (gpt ?x25505) gidx.312294)) (or (= ?x25544 0) (= ?x25544 6)))))))))))))))
 )
(assert
 (let (($x25504 (forall ((gidx.312350 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x17575 (globals ?x25505)))
 (let ((?x25551 (g_granules ?x17575)))
 (let ((?x25544 (e_state_s_granule (select ?x25551 gidx.312350))))
 (=> (not (select (gpt ?x25505) gidx.312350)) (or (= ?x25544 0) (= ?x25544 6)))))))))))))))
 ))
 (not $x25504)))
(check-sat)

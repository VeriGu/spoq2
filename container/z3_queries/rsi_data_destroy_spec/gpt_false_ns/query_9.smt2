...
(assert
 ...
 (= ?x1683 5))))))))))))))))))))
(assert
 (forall ((gidx.312680 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1608 (spinlock_acquire_spec.0_call ?x1691 ?x842)))
 (let ((?x1689 (value_RData ?x1608)))
 (let ((?x4538 (granule_unlock_spec.0_call ?x749 ?x1689)))
 (let ((?x1680 (value_RData ?x4538)))
 (let ((?x1667 (share ?x1680)))
 (let ((?x1622 (globals ?x1667)))
 (let ((?x2624 (g_granules ?x1622)))
 (let ((?x405 (e_state_s_granule (select ?x2624 gidx.312680))))
 (=> (not (select (gpt ?x1667) gidx.312680)) (or (= ?x405 0) (= ?x405 6))))))))))))))))))))))
 )
(assert
 (forall ((gidx.312790 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x4527 (rtt_walk_lock_unlock_spec_abs.0_call ?x1101 ?x1609 0 64 v_1.0 3 ?x1680)))
 (let ((?x18464 (value_Tuple_abs_ret_rtt_RData ?x4527)))
 (let ((?x1716 (elem_1 ?x18464)))
 (let ((?x1705 (share ?x1716)))
 (let ((?x4513 (globals ?x1705)))
 (let ((?x4525 (g_granules ?x4513)))
 (let ((?x1725 (e_state_s_granule (select ?x4525 gidx.312790))))
 (=> (not (select (gpt ?x1705) gidx.312790)) (or (= ?x1725 0) (= ?x1725 6))))))))))))))))))))))))))
 )
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
...
(assert
 ...
 (let ((?x1790 (e_2 ?x9421)))
 (let ((?x1750 (poffset ?x1790)))
 (let ((?x1748 (+ ?x1750 ?x1775)))
 (let ((?x1787 (mkPtr "granule_data" ?x1748)))
 (let ((?x1789 (abs_tte_read.0_call ?x1787 ?x1716)))
 (let ((?x18596 (meta_desc_type ?x1789)))
 (let (($x18733 (= ?x18596 3)))
 (not $x18733))))))))))))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 ...
 (let ((?x1787 (mkPtr "granule_data" ?x1748)))
 (let ((?x1789 (abs_tte_read.0_call ?x1787 ?x1716)))
 (let ((?x43942 (meta_mem_attr ?x1789)))
 (let (($x43938 (= ?x43942 1)))
 (let ((?x1760 (meta_ripas ?x1789)))
 (let (($x1753 (= ?x1760 0)))
 (let ((?x18596 (meta_desc_type ?x1789)))
 (let (($x152737 (= ?x18596 0)))
 (and $x152737 $x1753 $x43938))))))))))))))))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 ...
 (let ((?x1777 (mod ?x1750 4096)))
 (let (($x1743 (= ?x1777 0)))
 (let ((?x1782 (pbase ?x1790)))
 (let (($x1728 (= ?x1782 "granules")))
 (and $x1728 $x1743 $x1776)))))))))))))))))))))))))))
(assert
 (forall ((gidx.313672 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1787 (mkPtr "granule_data" ?x1748)))
 (let ((?x1789 (abs_tte_read.0_call ?x1787 ?x1716)))
 (let ((?x1719 (meta_PA ?x1789)))
 (let ((?x1784 (meta_granule_offset ?x1719)))
 (let ((?x1730 (mkPtr "granules" ?x1784)))
 (let ((?x1727 (spinlock_acquire_spec.0_call ?x1730 ?x1716)))
 (let ((?x1792 (value_RData ?x1727)))
 (let ((?x1847 (share ?x1792)))
 (let ((?x1850 (globals ?x1847)))
 (let ((?x1852 (g_granules ?x1850)))
 (let ((?x1768 (e_state_s_granule (select ?x1852 gidx.313672))))
 (=> (not (select (gpt ?x1847) gidx.313672)) (or (= ?x1768 0) (= ?x1768 6)))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 ...
 (let ((?x1850 (globals ?x1847)))
 (let ((?x1852 (g_granules ?x1850)))
 (let ((?x1759 (select ?x1852 ?x1817)))
 (let ((?x1758 (e_state_s_granule ?x1759)))
 (= ?x1758 4)))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
...
(assert
 ...
 (let ((?x1727 (spinlock_acquire_spec.0_call ?x1730 ?x1716)))
 (let ((?x1792 (value_RData ?x1727)))
 (let ((?x1859 (g_refcount_para.0_call ?x1730 ?x1792)))
 (= ?x1859 0))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.313782 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1727 (spinlock_acquire_spec.0_call ?x1730 ?x1716)))
 (let ((?x1792 (value_RData ?x1727)))
 (let ((?x1801 (mkPtr "granule_data" ?x1784)))
 (let ((?x1802 (memset_spec.0_call ?x1801 0 4096 ?x1792)))
 (let ((?x1864 (value_Tuple_Ptr_RData ?x1802)))
 (let ((?x1755 (elem_1 ?x1864)))
 (let ((?x1885 (share ?x1755)))
 (let ((?x1838 (globals ?x1885)))
 (let ((?x179256 (g_granules ?x1838)))
 (let ((?x1840 (e_state_s_granule (select ?x179256 gidx.313782))))
 (let (($x1868 (not (select (gpt ?x1885) gidx.313782))))
 (=> $x1868 (or (= ?x1840 0) (= ?x1840 6))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.313892 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1864 (value_Tuple_Ptr_RData ?x1802)))
 (let ((?x1755 (elem_1 ?x1864)))
 (let ((?x35636 (mks_granule (e_lock (select (g_granules (globals (share ?x1755))) (div ?x1784 4096))) 1 (e_ref (select (g_granules (globals (share ?x1755))) (div ?x1784 4096))))))
 (let ((?x1817 (div ?x1784 4096)))
 (let ((?x1885 (share ?x1755)))
 (let ((?x1838 (globals ?x1885)))
 (let ((?x179256 (g_granules ?x1838)))
 (let ((?x130790 (store ?x179256 ?x1817 ?x35636)))
 (let ((?x1924 (mkGLOBALS (g_heap ?x1838) (g_debug_exits ?x1838) (g_vmid_count ?x1838) (g_vmid_lock ?x1838) (g_vmids ?x1838) (g_nr_lrs ?x1838) (g_nr_aprs ?x1838) (g_max_vintid ?x1838) (g_pri_res0_mask ?x1838) (g_default_gicstate ?x1838) (g_status_handler ?x1838) (g_rmm_trap_list ?x1838) (g_tt_l3_buffer ?x1838) (g_tt_l2_mem0_0 ?x1838) (g_tt_l2_mem0_1 ?x1838) (g_tt_l2_mem1_0 ?x1838) (g_tt_l2_mem1_1 ?x1838) (g_tt_l2_mem1_2 ?x1838) (g_tt_l2_mem1_3 ?x1838) (g_tt_l1_upper ?x1838) (g_mbedtls_mem_buf ?x1838) ?x130790 (g_rmm_attest_signing_key ?x1838) (g_rmm_attest_public_key ?x1838) (g_rmm_attest_public_key_len ?x1838) (g_rmm_attest_public_key_hash ?x1838) (g_rmm_attest_public_key_hash_len ?x1838) (g_platform_token_buf ?x1838) (g_rmm_platform_token ?x1838) (g_get_realm_identity_identity ?x1838) (g_realm_attest_private_key ?x1838))))
 (let ((?x1883 (gpt ?x1885)))
 (let ((?x1917 (mkRData (log ?x1755) (oracle ?x1755) (repl ?x1755) (priv ?x1755) (mkShared ?x1883 (granule_data ?x1885) ?x1924) (stack ?x1755) (halt ?x1755))))
 (let ((?x1925 (granule_unlock_spec.0_call ?x1730 ?x1917)))
 (let ((?x40223 (value_RData ?x1925)))
 (let ((?x129998 (share ?x40223)))
 (let ((?x1948 (globals ?x129998)))
 (let ((?x1976 (g_granules ?x1948)))
 (let ((?x139892 (e_state_s_granule (select ?x1976 gidx.313892))))
 (=> (not (select (gpt ?x129998) gidx.313892)) (or (= ?x139892 0) (= ?x139892 6))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.314002 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1925 (granule_unlock_spec.0_call ?x1730 ?x1917)))
 (let ((?x40223 (value_RData ?x1925)))
 (let ((?x1941 (granule_unlock_spec.0_call ?x1790 ?x40223)))
 (let ((?x1934 (value_RData ?x1941)))
 (let ((?x1982 (share ?x1934)))
 (let ((?x1983 (globals ?x1982)))
 (let ((?x2009 (g_granules ?x1983)))
 (let ((?x1807 (e_state_s_granule (select ?x2009 gidx.314002))))
 (=> (not (select (gpt ?x1982) gidx.314002)) (or (= ?x1807 0) (= ?x1807 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x154859 (forall ((gidx.314058 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1983 (globals ?x1982)))
 (let ((?x2009 (g_granules ?x1983)))
 (let ((?x1807 (e_state_s_granule (select ?x2009 gidx.314058))))
 (=> (not (select (gpt ?x1982) gidx.314058)) (or (= ?x1807 0) (= ?x1807 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x154859)))
(check-sat)

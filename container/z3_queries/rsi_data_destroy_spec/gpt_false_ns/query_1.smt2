...
(assert
 ...
 (not $x1292))))))))))))))))))))))))))
(assert
 (forall ((gidx.310914 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1389 (e_state_s_granule (select ?x25056 gidx.310914))))
 (=> (not (select (gpt ?x17258) gidx.310914)) (or (= ?x1389 0) (= ?x1389 6))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.311024 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x9320 (e_state_s_granule (select ?x1451 gidx.311024))))
 (=> (not (select (gpt ?x25068) gidx.311024)) (or (= ?x9320 0) (= ?x9320 6))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x86212 (forall ((gidx.311080 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x25086 (globals ?x25068)))
 (let ((?x1451 (g_granules ?x25086)))
 (let ((?x9320 (e_state_s_granule (select ?x1451 gidx.311080))))
 (=> (not (select (gpt ?x25068) gidx.311080)) (or (= ?x9320 0) (= ?x9320 6))))))))))))))))))))))))))))))))))
 ))
 (not $x86212)))
(check-sat)

...
(assert
 ...
 (let ((?x1179 (meta_desc_type ?x1177)))
 (let (($x94383 (= ?x1179 0)))
 (let (($x1615 (and $x94383 $x17341 $x17287)))
 (not $x1615))))))))))))))))))))))))))
(assert
 (forall ((gidx.311962 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1092 (elem_0 ?x1070)))
 (let ((?x1169 (e_2 ?x1092)))
 (let ((?x73824 (granule_unlock_spec.0_call ?x1169 ?x1106)))
 (let ((?x1556 (value_RData ?x73824)))
 (let ((?x17476 (share ?x1556)))
 (let ((?x25069 (globals ?x17476)))
 (let ((?x17437 (g_granules ?x25069)))
 (let ((?x1538 (e_state_s_granule (select ?x17437 gidx.311962))))
 (=> (not (select (gpt ?x17476) gidx.311962)) (or (= ?x1538 0) (= ?x1538 6)))))))))))))))))))))
 )
(assert
 (let (($x9434 (forall ((gidx.312018 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x25069 (globals ?x17476)))
 (let ((?x17437 (g_granules ?x25069)))
 (let ((?x1538 (e_state_s_granule (select ?x17437 gidx.312018))))
 (=> (not (select (gpt ?x17476) gidx.312018)) (or (= ?x1538 0) (= ?x1538 6)))))))))))))))))))))
 ))
 (not $x9434)))
(check-sat)

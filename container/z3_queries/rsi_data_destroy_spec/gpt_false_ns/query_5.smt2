...
(assert
 ...
 (not $x1166)))))))))))))
(assert
 (forall ((gidx.312128 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1538 (e_state_s_granule (select ?x17437 gidx.312128))))
 (=> (not (select (gpt ?x17476) gidx.312128)) (or (= ?x1538 0) (= ?x1538 6)))))))))))))))))))))
 )
(assert
 (let (($x25501 (forall ((gidx.312184 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x25069 (globals ?x17476)))
 (let ((?x17437 (g_granules ?x25069)))
 (let ((?x1538 (e_state_s_granule (select ?x17437 gidx.312184))))
 (=> (not (select (gpt ?x17476) gidx.312184)) (or (= ?x1538 0) (= ?x1538 6)))))))))))))))))))))
 ))
 (not $x25501)))
(check-sat)

...
(assert
 ...
 (not $x1749))))))))))))))))))))))
(assert
 (forall ((gidx.314610 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x2216 (e_state_s_granule (select ?x135142 gidx.314610))))
 (=> (not (select (gpt ?x26856) gidx.314610)) (or (= ?x2216 0) (= ?x2216 6))))))))))))))))))))))))))))))
 )
(assert
 (let (($x50769 (forall ((gidx.314666 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x34495 (globals ?x26856)))
 (let ((?x135142 (g_granules ?x34495)))
 (let ((?x2216 (e_state_s_granule (select ?x135142 gidx.314666))))
 (=> (not (select (gpt ?x26856) gidx.314666)) (or (= ?x2216 0) (= ?x2216 6))))))))))))))))))))))))))))))
 ))
 (not $x50769)))
(check-sat)

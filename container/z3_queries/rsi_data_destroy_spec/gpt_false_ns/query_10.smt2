...
(assert
 ...
 (not $x1800)))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.314168 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1727 (spinlock_acquire_spec.0_call ?x1730 ?x1716)))
 (let ((?x1792 (value_RData ?x1727)))
 (let ((?x88326 (granule_unlock_spec.0_call ?x1730 ?x1792)))
 (let ((?x44190 (value_RData ?x88326)))
 (let ((?x2079 (share ?x44190)))
 (let ((?x2099 (globals ?x2079)))
 (let ((?x2092 (g_granules ?x2099)))
 (let ((?x1902 (e_state_s_granule (select ?x2092 gidx.314168))))
 (=> (not (select (gpt ?x2079) gidx.314168)) (or (= ?x1902 0) (= ?x1902 6)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.314278 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x88326 (granule_unlock_spec.0_call ?x1730 ?x1792)))
 (let ((?x44190 (value_RData ?x88326)))
 (let ((?x40166 (granule_unlock_spec.0_call ?x1790 ?x44190)))
 (let ((?x1947 (value_RData ?x40166)))
 (let ((?x35101 (share ?x1947)))
 (let ((?x150576 (globals ?x35101)))
 (let ((?x2043 (g_granules ?x150576)))
 (let ((?x125267 (e_state_s_granule (select ?x2043 gidx.314278))))
 (=> (not (select (gpt ?x35101) gidx.314278)) (or (= ?x125267 0) (= ?x125267 6)))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x144460 (forall ((gidx.314334 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x150576 (globals ?x35101)))
 (let ((?x2043 (g_granules ?x150576)))
 (let ((?x125267 (e_state_s_granule (select ?x2043 gidx.314334))))
 (=> (not (select (gpt ?x35101) gidx.314334)) (or (= ?x125267 0) (= ?x125267 6)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x144460)))
(check-sat)

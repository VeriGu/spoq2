...
(assert
 ...
 (let ((?x2162 (meta_desc_type ?x2033)))
 (let (($x118597 (= ?x2162 0)))
 (let (($x2606 (and $x118597 $x1970 $x33034)))
 (not $x2606)))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.316650 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x153554 (elem_0 ?x44410)))
 (let ((?x50795 (e_2 ?x153554)))
 (let ((?x60993 (granule_unlock_spec.0_call ?x50795 ?x27105)))
 (let ((?x144877 (value_RData ?x60993)))
 (let ((?x154001 (share ?x144877)))
 (let ((?x132783 (globals ?x154001)))
 (let ((?x158072 (g_granules ?x132783)))
 (let ((?x38214 (e_state_s_granule (select ?x158072 gidx.316650))))
 (=> (not (select (gpt ?x154001) gidx.316650)) (or (= ?x38214 0) (= ?x38214 6))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x130013 (forall ((gidx.316706 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x132783 (globals ?x154001)))
 (let ((?x158072 (g_granules ?x132783)))
 (let ((?x38214 (e_state_s_granule (select ?x158072 gidx.316706))))
 (=> (not (select (gpt ?x154001) gidx.316706)) (or (= ?x38214 0) (= ?x38214 6))))))))))))))))))))))))))))))))
 ))
 (not $x130013)))
(check-sat)

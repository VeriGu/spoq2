...
(assert
 ...
 (let (($x44192 (and $x152737 $x1753 $x43938)))
 (not $x44192)))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.314444 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x9421 (elem_0 ?x18464)))
 (let ((?x1790 (e_2 ?x9421)))
 (let ((?x149257 (granule_unlock_spec.0_call ?x1790 ?x1716)))
 (let ((?x153423 (value_RData ?x149257)))
 (let ((?x26856 (share ?x153423)))
 (let ((?x34495 (globals ?x26856)))
 (let ((?x135142 (g_granules ?x34495)))
 (let ((?x2216 (e_state_s_granule (select ?x135142 gidx.314444))))
 (=> (not (select (gpt ?x26856) gidx.314444)) (or (= ?x2216 0) (= ?x2216 6))))))))))))))))))))))))))))))
 )
(assert
 (let (($x153608 (forall ((gidx.314500 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x34495 (globals ?x26856)))
 (let ((?x135142 (g_granules ?x34495)))
 (let ((?x2216 (e_state_s_granule (select ?x135142 gidx.314500))))
 (=> (not (select (gpt ?x26856) gidx.314500)) (or (= ?x2216 0) (= ?x2216 6))))))))))))))))))))))))))))))
 ))
 (not $x153608)))
(check-sat)

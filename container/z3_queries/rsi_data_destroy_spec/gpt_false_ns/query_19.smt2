...
(assert
 ...
 (not $x1586))))))))))))))
(assert
 (forall ((gidx.316982 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 (let ((?x92759 (spinlock_release_spec.0_call ?x749 ?x842)))
 (let ((?x25487 (value_RData ?x92759)))
 (let ((?x25505 (share ?x25487)))
 (let ((?x17575 (globals ?x25505)))
 (let ((?x25551 (g_granules ?x17575)))
 (let ((?x25544 (e_state_s_granule (select ?x25551 gidx.316982))))
 (=> (not (select (gpt ?x25505) gidx.316982)) (or (= ?x25544 0) (= ?x25544 6)))))))))))))))
 )
(assert
 (let (($x142419 (forall ((gidx.317038 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x17575 (globals ?x25505)))
 (let ((?x25551 (g_granules ?x17575)))
 (let ((?x25544 (e_state_s_granule (select ?x25551 gidx.317038))))
 (=> (not (select (gpt ?x25505) gidx.317038)) (or (= ?x25544 0) (= ?x25544 6)))))))))))))))
 ))
 (not $x142419)))
(check-sat)

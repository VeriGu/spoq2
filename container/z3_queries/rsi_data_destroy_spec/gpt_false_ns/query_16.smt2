...
(assert
 ...
 (not $x2269)))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.316374 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x2223 (spinlock_acquire_spec.0_call ?x2133 ?x27105)))
 (let ((?x19142 (value_RData ?x2223)))
 (let ((?x47497 (granule_unlock_spec.0_call ?x2133 ?x19142)))
 (let ((?x2449 (value_RData ?x47497)))
 (let ((?x33504 (share ?x2449)))
 (let ((?x134524 (globals ?x33504)))
 (let ((?x149201 (g_granules ?x134524)))
 (let ((?x2040 (e_state_s_granule (select ?x149201 gidx.316374))))
 (=> (not (select (gpt ?x33504) gidx.316374)) (or (= ?x2040 0) (= ?x2040 6)))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.316484 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x47497 (granule_unlock_spec.0_call ?x2133 ?x19142)))
 (let ((?x2449 (value_RData ?x47497)))
 (let ((?x51510 (granule_unlock_spec.0_call ?x50795 ?x2449)))
 (let ((?x27514 (value_RData ?x51510)))
 (let ((?x44518 (share ?x27514)))
 (let ((?x126835 (globals ?x44518)))
 (let ((?x2261 (g_granules ?x126835)))
 (let ((?x158047 (e_state_s_granule (select ?x2261 gidx.316484))))
 (=> (not (select (gpt ?x44518) gidx.316484)) (or (= ?x158047 0) (= ?x158047 6)))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x131688 (forall ((gidx.316540 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x126835 (globals ?x44518)))
 (let ((?x2261 (g_granules ?x126835)))
 (let ((?x158047 (e_state_s_granule (select ?x2261 gidx.316540))))
 (=> (not (select (gpt ?x44518) gidx.316540)) (or (= ?x158047 0) (= ?x158047 6)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x131688)))
(check-sat)

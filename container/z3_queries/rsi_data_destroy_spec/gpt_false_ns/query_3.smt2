...
(assert
 ...
 (not $x1292))))))))))))))))))))))))))
(assert
 (forall ((gidx.311686 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x1193 (spinlock_acquire_spec.0_call ?x1192 ?x1106)))
 (let ((?x1195 (value_RData ?x1193)))
 (let ((?x66814 (granule_unlock_spec.0_call ?x1192 ?x1195)))
 (let ((?x1578 (value_RData ?x66814)))
 (let ((?x17258 (share ?x1578)))
 (let ((?x25054 (globals ?x17258)))
 (let ((?x25056 (g_granules ?x25054)))
 (let ((?x1389 (e_state_s_granule (select ?x25056 gidx.311686))))
 (=> (not (select (gpt ?x17258) gidx.311686)) (or (= ?x1389 0) (= ?x1389 6))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.311796 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x66814 (granule_unlock_spec.0_call ?x1192 ?x1195)))
 (let ((?x1578 (value_RData ?x66814)))
 (let ((?x1387 (granule_unlock_spec.0_call ?x1169 ?x1578)))
 (let ((?x1457 (value_RData ?x1387)))
 (let ((?x25068 (share ?x1457)))
 (let ((?x25086 (globals ?x25068)))
 (let ((?x1451 (g_granules ?x25086)))
 (let ((?x9320 (e_state_s_granule (select ?x1451 gidx.311796))))
 (=> (not (select (gpt ?x25068) gidx.311796)) (or (= ?x9320 0) (= ?x9320 6))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x9386 (forall ((gidx.311852 Int) )(let ((?x766 (test_PA.0_call v_0.0)))
 (let ((?x718 (meta_granule_offset ?x766)))
 (let ((?x749 (mkPtr "granules" ?x718)))
 (let ((?x870 (spinlock_acquire_spec.0_call ?x749 st.0)))
 (let ((?x842 (value_RData ?x870)))
 ...
 (let ((?x25086 (globals ?x25068)))
 (let ((?x1451 (g_granules ?x25086)))
 (let ((?x9320 (e_state_s_granule (select ?x1451 gidx.311852))))
 (=> (not (select (gpt ?x25068) gidx.311852)) (or (= ?x9320 0) (= ?x9320 6))))))))))))))))))))))))))))))))))
 ))
 (not $x9386)))
(check-sat)

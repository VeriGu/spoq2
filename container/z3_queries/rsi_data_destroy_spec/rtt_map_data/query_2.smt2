...
(assert
 (let (($x27222 (forall ((rtt_gidx.399533 Int) (ipa_gidx.399533 Int) (data_gidx.399533 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 (let ((?x3016 (meta_granule_offset ?x2187)))
 (let ((?x3050 (mkPtr "granules" ?x3016)))
 ...
 (let ((?x27211 (rtt_walk_abs.0_call ?x3922 rtt_gidx.399533 ipa_gidx.399533)))
 (let ((?x19217 (g_granule_state (select ?x3919 ?x27211))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.399533)))
 (let (($x27246 (=> (and (and (distinct ?x27211 (- 1)) true) $x153) (or (= ?x19217 4) (= ?x19217 6)))))
 (let (($x3146 (= (e_state_s_granule (select (g_granules ?x3186) rtt_gidx.399533)) 5)))
 (=> (and $x3146 (and (distinct ?x27211 (- 1)) true) $x153) (or (= ?x19217 4) (= ?x19217 6)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x27222)))
(check-sat)

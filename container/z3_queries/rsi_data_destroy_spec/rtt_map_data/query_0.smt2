...
(assert
 ...
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x1793 (store (g_norm (select (granule_data ?x15) (div offset.125460 4096))) (mod offset.125460 4096) (test_PTE_Z.0_call empty_pte.125460))))
...
(assert
 ...
 (let ((?x2169 (store (g_norm (select (granule_data ?x15) (div parent_gidx.86611 4096))) (mod parent_gidx.86611 4096) ?x2166)))
...
(assert
 (let (($x2211 (forall ((rtt_gidx.393007 Int) (ipa_gidx.393007 Int) (data_gidx.393007 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.393007 ipa_gidx.393007)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.393007)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.393007)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 ))
 (not $x2211)))
(check-sat)

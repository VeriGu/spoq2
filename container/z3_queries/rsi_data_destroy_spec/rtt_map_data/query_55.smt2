...
(assert
 (let (($x20924 (forall ((rtt_gidx.468808 Int) (ipa_gidx.468808 Int) (data_gidx.468808 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 ...
 (let ((?x41354 (rtt_walk_abs.0_call ?x34108 rtt_gidx.468808 ipa_gidx.468808)))
 (let ((?x41362 (g_granule_state (select ?x41514 ?x41354))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.468808)))
 (let (($x48364 (=> (and (and (distinct ?x41354 (- 1)) true) $x153) (or (= ?x41362 4) (= ?x41362 6)))))
 (let (($x7977 (= (e_state_s_granule (select (g_granules ?x7985) rtt_gidx.468808)) 5)))

...
(assert
 (let (($x20597 (forall ((rtt_gidx.403081 Int) (ipa_gidx.403081 Int) (data_gidx.403081 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 (let ((?x3016 (meta_granule_offset ?x2187)))
 (let ((?x3050 (mkPtr "granules" ?x3016)))
 ...
 (let ((?x28527 (rtt_walk_abs.0_call ?x5215 rtt_gidx.403081 ipa_gidx.403081)))
 (let ((?x28512 (g_granule_state (select ?x4932 ?x28527))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.403081)))
 (let (($x20477 (=> (and (and (distinct ?x28527 (- 1)) true) $x153) (or (= ?x28512 4) (= ?x28512 6)))))
 (let (($x3146 (= (e_state_s_granule (select (g_granules ?x3186) rtt_gidx.403081)) 5)))
 (=> (and $x3146 (and (distinct ?x28527 (- 1)) true) $x153) (or (= ?x28512 4) (= ?x28512 6)))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x20597)))
(check-sat)

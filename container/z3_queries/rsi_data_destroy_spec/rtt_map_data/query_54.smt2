...
(assert
 (let (($x21507 (forall ((rtt_gidx.468729 Int) (ipa_gidx.468729 Int) (data_gidx.468729 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 ...
 (let ((?x8893 (query_oracle.0_call ?x39930)))
 (let ((?x8792 (value_RData ?x8893)))
 (let ((?x9194 (rtt_walk_abs.0_call ?x8792 rtt_gidx.468729 ipa_gidx.468729)))
 (let ((?x9070 (share ?x8792)))
 (let ((?x9221 (granule_data ?x9070)))
 (let ((?x9189 (g_granule_state (select ?x9221 ?x9194))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.468729)))
 (let (($x9192 (=> $x153 (or (= ?x9189 4) (= ?x9189 6)))))
 (let (($x9016 (= (e_state_s_granule (select (g_granules (globals ?x9070)) rtt_gidx.468729)) 5)))
 (=> (and $x9016 (and (distinct ?x9194 (- 1)) true) $x153) (or (= ?x9189 4) (= ?x9189 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x21507)))
(check-sat)

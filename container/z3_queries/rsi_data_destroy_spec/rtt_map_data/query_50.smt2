...
(assert
 (let (($x19502 (forall ((rtt_gidx.461918 Int) (ipa_gidx.461918 Int) (data_gidx.461918 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x14511 (query_oracle.0_call ?x7155)))
 ...
 (let ((?x16613 (value_Tuple_abs_ret_rtt_RData ?x17180)))
 (let ((?x16860 (elem_1 ?x16613)))
 (let ((?x17198 (rtt_walk_abs.0_call ?x16860 rtt_gidx.461918 ipa_gidx.461918)))
 (let ((?x16963 (share ?x16860)))
 (let ((?x16398 (granule_data ?x16963)))
 (let ((?x16721 (g_granule_state (select ?x16398 ?x17198))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.461918)))
 (let (($x15973 (=> $x153 (or (= ?x16721 4) (= ?x16721 6)))))
 (let (($x16673 (= (e_state_s_granule (select (g_granules (globals ?x16963)) rtt_gidx.461918)) 5)))
 (=> (and $x16673 (and (distinct ?x17198 (- 1)) true) $x153) (or (= ?x16721 4) (= ?x16721 6)))))))))))))))))))))))))
 ))
 (not $x19502)))
(check-sat)

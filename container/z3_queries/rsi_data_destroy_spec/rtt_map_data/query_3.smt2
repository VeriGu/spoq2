...
(assert
 (let (($x4570 (forall ((rtt_gidx.402922 Int) (ipa_gidx.402922 Int) (data_gidx.402922 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 (let ((?x3016 (meta_granule_offset ?x2187)))
 (let ((?x3050 (mkPtr "granules" ?x3016)))
 ...
 (let ((?x4834 (div ?x4865 4096)))
 (let ((?x4174 (g_granules ?x4180)))
 (let ((?x4914 (select ?x4174 ?x4834)))
 (let ((?x28288 (mks_granule (e_lock ?x4914) 1 (e_ref ?x4914))))
 (let ((?x28260 (store ?x4174 ?x4834 ?x28288)))
 (let ((?x4428 (g_mbedtls_mem_buf ?x4180)))
 (let ((?x4395 (g_tt_l1_upper ?x4180)))
 (let ((?x4452 (g_tt_l2_mem1_3 ?x4180)))
 (let ((?x4440 (g_tt_l2_mem1_2 ?x4180)))
 ...
 (let ((?x4414 (g_debug_exits ?x4180)))
 (let ((?x4445 (g_heap ?x4180)))
 (let ((?x28285 (mkGLOBALS ?x4445 ?x4414 ?x4389 ?x4461 ?x4417 ?x4443 ?x4427 ?x30261 ?x4442 ?x4449 ?x4385 ?x4416 ?x4407 ?x4397 ?x4412 ?x4409 ?x8173 ?x4440 ?x4452 ?x4395 ?x4428 ?x28260 ?x4424 ?x4437 ?x4447 ?x4458 ?x4431 ?x4439 ?x4419 ?x4422 ?x4398)))
 (let ((?x4915 (mkr_granule_data (gd_g_idx (select (granule_data ?x4021) ?x4834)) (g_granule_state (select (granule_data ?x4021) ?x4834)) zero_granule_data (g_rd (select (granule_data ?x4021) ?x4834)) (g_rec (select (granule_data ?x4021) ?x4834)))))
 (let ((?x4134 (granule_data ?x4021)))
 (let ((?x4898 (store ?x4134 ?x4834 ?x4915)))
 (let ((?x4307 (gpt ?x4021)))
 (let ((?x4311 (priv ?x3902)))
 (let ((?x4100 (repl ?x3902)))
 (let ((?x4002 (oracle ?x3902)))
 (let ((?x4105 (log ?x3902)))
 (let ((?x20299 (mkRData ?x4105 ?x4002 ?x4100 ?x4311 (mkShared ?x4307 ?x4898 ?x28285) ?x4331 $x4329)))
 (let ((?x4906 (g_granule_state (select ?x4898 (rtt_walk_abs.0_call ?x20299 rtt_gidx.402922 ipa_gidx.402922)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.402922)))
 (let ((?x35795 (mkRData ?x4105 ?x4002 ?x4100 ?x4311 (mkShared ?x4307 ?x4134 ?x28285) ?x4331 $x4329)))
 (let ((?x20306 (mkRData (log ?x35795) (oracle ?x35795) (repl ?x35795) (priv ?x35795) (mkShared (gpt (share ?x35795)) ?x4898 (globals (share ?x35795))) (stack ?x35795) (halt ?x35795))))
 (let (($x4922 (=> (and (and (distinct (rtt_walk_abs.0_call ?x20306 rtt_gidx.402922 ipa_gidx.402922) (- 1)) true) $x153) (or (= ?x4906 4) (= ?x4906 6)))))
 (=> (and (= (e_state_s_granule (select ?x28260 rtt_gidx.402922)) 5) (and (distinct (rtt_walk_abs.0_call ?x20306 rtt_gidx.402922 ipa_gidx.402922) (- 1)) true) $x153) (or (= ?x4906 4) (= ?x4906 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4570)))
(check-sat)

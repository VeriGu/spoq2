...
(assert
 (let (($x43487 (forall ((rtt_gidx.427177 Int) (ipa_gidx.427177 Int) (data_gidx.427177 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 ...
 (let ((?x4976 (rtt_walk_abs.0_call ?x39930 rtt_gidx.427177 ipa_gidx.427177)))
 (let ((?x36906 (g_granule_state (select ?x39942 ?x4976))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.427177)))
 (let (($x39994 (=> (and (and (distinct ?x4976 (- 1)) true) $x153) (or (= ?x36906 4) (= ?x36906 6)))))
 (let (($x7977 (= (e_state_s_granule (select (g_granules ?x7985) rtt_gidx.427177)) 5)))

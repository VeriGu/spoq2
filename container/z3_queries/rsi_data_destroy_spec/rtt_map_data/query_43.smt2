...
(assert
 (let (($x74881 (forall ((rtt_gidx.454741 Int) (ipa_gidx.454741 Int) (data_gidx.454741 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x14511 (query_oracle.0_call ?x7155)))
 ...
 (let ((?x74855 (rtt_walk_abs.0_call ?x50620 rtt_gidx.454741 ipa_gidx.454741)))
 (let ((?x61300 (g_granule_state (select ?x79179 ?x74855))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.454741)))
 (let (($x520970 (=> (and (and (distinct ?x74855 (- 1)) true) $x153) (or (= ?x61300 4) (= ?x61300 6)))))
 (let (($x16673 (= (e_state_s_granule (select (g_granules ?x17124) rtt_gidx.454741)) 5)))
 (=> (and $x16673 (and (distinct ?x74855 (- 1)) true) $x153) (or (= ?x61300 4) (= ?x61300 6))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x74881)))
(check-sat)

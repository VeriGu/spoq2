...
(assert
 ...
 (let ((?x8842 (meta_desc_type ?x8687)))
 (let (($x9739 (= ?x8842 0)))
 (let (($x6111 (and $x9739 $x9695 $x8891)))
 (not $x6111)))))))))))))))))))))))))))))
(assert
...
(assert
 (let (($x10818 (forall ((rtt_gidx.423755 Int) (ipa_gidx.423755 Int) (data_gidx.423755 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 ...
 (let ((?x7991 (value_Tuple_abs_ret_rtt_RData ?x7963)))
 (let ((?x7899 (elem_1 ?x7991)))
 (let ((?x8107 (rtt_walk_abs.0_call ?x7899 rtt_gidx.423755 ipa_gidx.423755)))
 (let ((?x8138 (share ?x7899)))
 (let ((?x7809 (granule_data ?x8138)))
 (let ((?x7894 (g_granule_state (select ?x7809 ?x8107))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.423755)))
 (let (($x7927 (=> $x153 (or (= ?x7894 4) (= ?x7894 6)))))
 (let (($x7977 (= (e_state_s_granule (select (g_granules (globals ?x8138)) rtt_gidx.423755)) 5)))
 (=> (and $x7977 (and (distinct ?x8107 (- 1)) true) $x153) (or (= ?x7894 4) (= ?x7894 6)))))))))))))))))))))))
 ))
 (not $x10818)))
(check-sat)

...
(assert
 ...
 (not $x2189))))
(assert
 (forall ((rtt_gidx.52088 Int) (ipa_gidx.52088 Int) (data_gidx.52088 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.52088 ipa_gidx.52088)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.52088)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.52088)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 )
(assert
 (let (($x1510 (forall ((rtt_gidx.136672 Int) (ipa_gidx.136672 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.136672))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x541 (|(oracle st.0)_call| ?x83)))
 (let ((?x540 (|(repl st.0)_call| ?x541 ?x15)))
 (let ((?x543 (value_Shared ?x540)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x520 (List_Event_concat ?x541 ?x83)))
 (let ((?x615 (mkRData ?x520 ?x84 ?x85 ?x86 ?x543 ?x87 $x88)))
 (let ((?x686 (rtt_walk_abs.0_call ?x615 rtt_gidx.136672 ipa_gidx.136672)))
 (let (($x687 (= ?x686 (- 1))))
 (let (($x695 (not (= (e_state_s_granule (select (g_granules (globals ?x543)) rtt_gidx.136672)) 5))))
 (let ((?x689 (g_granule_state (select (granule_data ?x543) ?x686))))
 (let (($x691 (= ?x689 4)))
 (let (($x690 (= ?x689 6)))
 (or $x690 $x691 $x695 $x687 $x176)))))))))))))))))))))
 ))
 (let (($x1529 (forall ((rtt_gidx.136625 Int) (ipa_gidx.136625 Int) )(let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.136625 ipa_gidx.136625)))
 (let (($x174 (= ?x169 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.136625))))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.136625)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
 (or $x172 $x173 $x180 $x176 $x174)))))))))))))))
 ))
 (or (not $x1529) $x1510))))
(assert
 (forall ((gidx.87050 Int) )(let (($x1530 (= (g_norm (select (granule_data (share st.0)) gidx.87050)) zero_granule_data)))
 (let (($x1542 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.87050)) 1)))
 (=> $x1542 $x1530))))
 )
(assert
 (forall ((offset.102028 Int) )(let (($x1530 (= (g_norm (select (granule_data (share st.0)) offset.102028)) zero_granule_data)))
 (let (($x1583 (not $x1530)))
 (let (($x1688 (forall ((rtt_gidx.102025 Int) (ipa_gidx.102025 Int) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x79 (g_realm_attest_private_key ?x31)))
 (let ((?x78 (g_get_realm_identity_identity ?x31)))
 (let ((?x77 (g_rmm_platform_token ?x31)))
 (let ((?x76 (g_platform_token_buf ?x31)))
 (let ((?x75 (g_rmm_attest_public_key_hash_len ?x31)))
 (let ((?x74 (g_rmm_attest_public_key_hash ?x31)))
 (let ((?x73 (g_rmm_attest_public_key_len ?x31)))
 (let ((?x72 (g_rmm_attest_public_key ?x31)))
 (let ((?x71 (g_rmm_attest_signing_key ?x31)))
 (let ((?x1714 (mks_granule (e_lock (select (g_granules ?x31) offset.102028)) 4 (e_ref (select (g_granules ?x31) offset.102028)))))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x1684 (store ?x35 offset.102028 ?x1714)))
 (let ((?x70 (g_mbedtls_mem_buf ?x31)))
 (let ((?x69 (g_tt_l1_upper ?x31)))
 (let ((?x68 (g_tt_l2_mem1_3 ?x31)))
 (let ((?x67 (g_tt_l2_mem1_2 ?x31)))
 (let ((?x66 (g_tt_l2_mem1_1 ?x31)))
 (let ((?x65 (g_tt_l2_mem1_0 ?x31)))
 (let ((?x64 (g_tt_l2_mem0_1 ?x31)))
 (let ((?x63 (g_tt_l2_mem0_0 ?x31)))
 (let ((?x62 (g_tt_l3_buffer ?x31)))
 (let ((?x61 (g_rmm_trap_list ?x31)))
 (let ((?x60 (g_status_handler ?x31)))
 (let ((?x59 (g_default_gicstate ?x31)))
 (let ((?x58 (g_pri_res0_mask ?x31)))
 (let ((?x57 (g_max_vintid ?x31)))
 (let ((?x56 (g_nr_aprs ?x31)))
 (let ((?x55 (g_nr_lrs ?x31)))
 (let ((?x54 (g_vmids ?x31)))
 (let ((?x53 (g_vmid_lock ?x31)))
 (let ((?x52 (g_vmid_count ?x31)))
 (let ((?x51 (g_debug_exits ?x31)))
 (let ((?x50 (g_heap ?x31)))
 (let ((?x1614 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x1684 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x1733 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x17 ?x1614) ?x87 $x88) rtt_gidx.102025 ipa_gidx.102025)))
 (let (($x1603 (= ?x1733 (- 1))))
 (let (($x1618 (not (= (e_state_s_granule (select ?x1684 rtt_gidx.102025)) 5))))
 (let ((?x1738 (g_granule_state (select ?x17 ?x1733))))
 (let (($x1740 (= ?x1738 6)))
 (let (($x1592 (= ?x1738 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.102025))))
 (or $x176 $x1592 $x1740 $x1618 $x1603)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1598 (forall ((rtt_gidx.101955 Int) (ipa_gidx.101955 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.101955)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.101955 ipa_gidx.101955)))
 (let (($x174 (= ?x169 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.101955))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
 (or $x172 $x173 $x176 $x174 $x180)))))))))))))))
 ))
 (let (($x1532 (not $x1598)))
 (or $x1532 $x1688 $x1583)))))))
 )
(assert
 (forall ((offset.125460 Int) (empty_pte.125460 abs_PTE_t) )(let (($x1815 (forall ((rtt_gidx.125456 Int) (ipa_gidx.125456 Int) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x1810 (test_PTE_Z.0_call empty_pte.125460)))
 (let ((?x1809 (mod offset.125460 4096)))
 (let ((?x1793 (store (g_norm (select (granule_data ?x15) (div offset.125460 4096))) ?x1809 ?x1810)))
 (let ((?x1795 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) (div offset.125460 4096))) (g_granule_state (select (granule_data ?x15) (div offset.125460 4096))) ?x1793 (g_rd (select (granule_data ?x15) (div offset.125460 4096))) (g_rec (select (granule_data ?x15) (div offset.125460 4096))))))
 (let ((?x1750 (div offset.125460 4096)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x1759 (store ?x17 ?x1750 ?x1795)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x1826 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x1759 ?x31) ?x87 $x88) rtt_gidx.125456 ipa_gidx.125456)))
 (let ((?x1828 (g_granule_state (select ?x1759 ?x1826))))
 (let (($x1829 (= ?x1828 6)))
 (let (($x1814 (= ?x1826 (- 1))))
 (let (($x1817 (= ?x1828 4)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.125456)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.125456))))
 (or $x176 $x180 $x1817 $x1814 $x1829)))))))))))))))))))))))))))))
 ))
 (let (($x1832 (not (= (meta_granule_offset (meta_PA empty_pte.125460)) (- 1)))))
 (let ((?x1835 (e_state_s_granule (select (g_granules (globals (share st.0))) (div offset.125460 4096)))))
 (let (($x1837 (not (= ?x1835 5))))
 (let (($x1693 (forall ((rtt_gidx.125343 Int) (ipa_gidx.125343 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.125343)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.125343))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.125343 ipa_gidx.125343)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
 (or $x172 $x173 $x174 $x176 $x180)))))))))))))))
 ))
 (let (($x1747 (not $x1693)))
 (or $x1747 $x1837 $x1832 $x1815))))))))
 )
(assert
 (forall ((offset.156760 Int) (state.156760 Int) )(let (($x1962 (forall ((rtt_gidx.156758 Int) (ipa_gidx.156758 Int) )(let ((?x1926 (mks_granule (e_lock (select (g_granules (globals (share st.0))) offset.156760)) state.156760 (e_ref (select (g_granules (globals (share st.0))) offset.156760)))))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x1927 (store ?x35 offset.156760 ?x1926)))
 (let (($x1944 (not (= (e_state_s_granule (select ?x1927 rtt_gidx.156758)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.156758))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x79 (g_realm_attest_private_key ?x31)))
 (let ((?x78 (g_get_realm_identity_identity ?x31)))
 ...
 (let ((?x51 (g_debug_exits ?x31)))
 (let ((?x50 (g_heap ?x31)))
 (let ((?x1945 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x1927 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x1951 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) offset.156760)) (g_granule_state (select (granule_data ?x15) offset.156760)) zero_granule_data (g_rd (select (granule_data ?x15) offset.156760)) (g_rec (select (granule_data ?x15) offset.156760)))))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x1952 (store ?x17 offset.156760 ?x1951)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x1955 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x1952 ?x1945) ?x87 $x88) rtt_gidx.156758 ipa_gidx.156758)))
 (let ((?x1957 (g_granule_state (select ?x1952 ?x1955))))
 (let (($x1958 (= ?x1957 4)))
 (let (($x1959 (= ?x1957 6)))
 (let (($x1960 (= ?x1955 (- 1))))
 (or $x1960 $x1959 $x1958 $x176 $x1944)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1931 (forall ((rtt_gidx.156659 Int) (ipa_gidx.156659 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.156659)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.156659))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.156659 ipa_gidx.156659)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
...
(assert
 (forall ((rtt_gidx.87958 Int) (ipa_gidx.87958 Int) (i.87958 Int) (d.87958 r_granule_data) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x81 (gpt ?x15)))
 ...
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2003 (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 (store (granule_data ?x15) i.87958 d.87958) ?x31) ?x87 $x88)))
 (let ((?x2004 (rtt_walk_abs.0_call ?x2003 rtt_gidx.87958 ipa_gidx.87958)))
 (let ((?x2006 (rtt_walk_abs.0_call st.0 rtt_gidx.87958 ipa_gidx.87958)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 i.87958)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (=> (and $x180 (not (= ?x178 4))) (= (+ ?x2006 (* (- 1) ?x2004)) 0))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.86611 Int) (pte_z.86611 Int) (x.86611 Int) (y.86611 Int) (z.86611 Int) )(let (($x2183 (forall ((rtt_gidx.86609 Int) (ipa_gidx.86609 Int) )(let ((?x2136 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.86611))) 4096)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x2151 (select ?x35 ?x2136)))
 (let ((?x2155 (store ?x35 ?x2136 (mks_granule (e_lock ?x2151) 4 (e_ref ?x2151)))))
 (let (($x2159 (not (= (e_state_s_granule (select ?x2155 rtt_gidx.86609)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.86609))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x79 (g_realm_attest_private_key ?x31)))
 (let ((?x78 (g_get_realm_identity_identity ?x31)))
 ...
 (let ((?x51 (g_debug_exits ?x31)))
 (let ((?x50 (g_heap ?x31)))
 (let ((?x2160 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x2155 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x2166 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.86611)) x.86611 y.86611 z.86611))))
 (let ((?x2167 (mod parent_gidx.86611 4096)))
 (let ((?x2169 (store (g_norm (select (granule_data ?x15) (div parent_gidx.86611 4096))) ?x2167 ?x2166)))
 (let ((?x2172 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) (div parent_gidx.86611 4096))) (g_granule_state (select (granule_data ?x15) (div parent_gidx.86611 4096))) ?x2169 (g_rd (select (granule_data ?x15) (div parent_gidx.86611 4096))) (g_rec (select (granule_data ?x15) (div parent_gidx.86611 4096))))))
 (let ((?x2161 (div parent_gidx.86611 4096)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x2173 (store ?x17 ?x2161 ?x2172)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2176 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x2173 ?x2160) ?x87 $x88) rtt_gidx.86609 ipa_gidx.86609)))
 (let ((?x2178 (g_granule_state (select ?x2173 ?x2176))))
 (let (($x2179 (= ?x2178 4)))
 (let (($x2180 (= ?x2178 6)))
 (let (($x2181 (= ?x2176 (- 1))))
 (or $x2181 $x2180 $x2179 $x176 $x2159))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2139 (forall ((rtt_gidx.86413 Int) (ipa_gidx.86413 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.86413)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.86413))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.86413 ipa_gidx.86413)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
...
(assert
 (let (($x6605 (forall ((rtt_gidx.406869 Int) (ipa_gidx.406869 Int) (data_gidx.406869 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.406869 ipa_gidx.406869)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.406869)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.406869)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 ))
 (not $x6605)))
(check-sat)

...
(assert
 (let (($x6125 (forall ((rtt_gidx.406470 Int) (ipa_gidx.406470 Int) (data_gidx.406470 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 (let ((?x3016 (meta_granule_offset ?x2187)))
 (let ((?x3050 (mkPtr "granules" ?x3016)))
 ...
 (let ((?x4834 (div ?x4865 4096)))
 (let ((?x20742 (g_granules ?x20762)))
 (let ((?x6064 (select ?x20742 ?x4834)))
 (let ((?x21539 (mks_granule (e_lock ?x6064) 1 (e_ref ?x6064))))
 (let ((?x21609 (store ?x20742 ?x4834 ?x21539)))
 (let ((?x5530 (g_mbedtls_mem_buf ?x20762)))
 (let ((?x5538 (g_tt_l1_upper ?x20762)))
 (let ((?x5531 (g_tt_l2_mem1_3 ?x20762)))
 (let ((?x5672 (g_tt_l2_mem1_2 ?x20762)))
 ...
 (let ((?x5680 (g_debug_exits ?x20762)))
 (let ((?x5678 (g_heap ?x20762)))
 (let ((?x21540 (mkGLOBALS ?x5678 ?x5680 ?x5525 ?x5579 ?x5552 ?x5560 ?x5687 ?x5695 ?x5679 ?x5681 ?x5655 ?x5683 ?x5523 ?x5528 ?x5658 ?x5581 ?x5674 ?x5672 ?x5531 ?x5538 ?x5530 ?x21609 ?x5566 ?x5692 ?x5248 ?x5644 ?x5673 ?x5670 ?x5589 ?x5671 ?x5682)))
 (let ((?x6005 (mkr_granule_data (gd_g_idx (select (granule_data ?x28851) ?x4834)) (g_granule_state (select (granule_data ?x28851) ?x4834)) zero_granule_data (g_rd (select (granule_data ?x28851) ?x4834)) (g_rec (select (granule_data ?x28851) ?x4834)))))
 (let ((?x5551 (granule_data ?x28851)))
 (let ((?x6067 (store ?x5551 ?x4834 ?x6005)))
 (let ((?x5512 (gpt ?x28851)))
 (let ((?x5590 (priv ?x5333)))
 (let ((?x5086 (repl ?x5333)))
 (let ((?x4969 (oracle ?x5333)))
 (let ((?x4992 (log ?x5333)))
 (let ((?x29841 (mkRData ?x4992 ?x4969 ?x5086 ?x5590 (mkShared ?x5512 ?x6067 ?x21540) ?x5568 $x5132)))
 (let ((?x19297 (g_granule_state (select ?x6067 (rtt_walk_abs.0_call ?x29841 rtt_gidx.406470 ipa_gidx.406470)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.406470)))
 (let ((?x29670 (mkRData ?x4992 ?x4969 ?x5086 ?x5590 (mkShared ?x5512 ?x5551 ?x21540) ?x5568 $x5132)))
 (let ((?x29559 (mkRData (log ?x29670) (oracle ?x29670) (repl ?x29670) (priv ?x29670) (mkShared (gpt (share ?x29670)) ?x6067 (globals (share ?x29670))) (stack ?x29670) (halt ?x29670))))
 (let (($x5254 (=> (and (and (distinct (rtt_walk_abs.0_call ?x29559 rtt_gidx.406470 ipa_gidx.406470) (- 1)) true) $x153) (or (= ?x19297 4) (= ?x19297 6)))))
 (=> (and (= (e_state_s_granule (select ?x21609 rtt_gidx.406470)) 5) (and (distinct (rtt_walk_abs.0_call ?x29559 rtt_gidx.406470 ipa_gidx.406470) (- 1)) true) $x153) (or (= ?x19297 4) (= ?x19297 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6125)))
(check-sat)

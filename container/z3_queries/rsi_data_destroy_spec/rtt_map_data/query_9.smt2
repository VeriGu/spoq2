...
(assert
 (let (($x6573 (forall ((rtt_gidx.406710 Int) (ipa_gidx.406710 Int) (data_gidx.406710 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 (let ((?x3016 (meta_granule_offset ?x2187)))
 (let ((?x3050 (mkPtr "granules" ?x3016)))
 ...
 (let ((?x3058 (value_Tuple_abs_ret_rtt_RData ?x3057)))
 (let ((?x3054 (elem_1 ?x3058)))
 (let ((?x3084 (rtt_walk_abs.0_call ?x3054 rtt_gidx.406710 ipa_gidx.406710)))
 (let ((?x3181 (share ?x3054)))
 (let ((?x3187 (granule_data ?x3181)))
 (let ((?x3090 (g_granule_state (select ?x3187 ?x3084))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.406710)))
 (let (($x3135 (=> $x153 (or (= ?x3090 4) (= ?x3090 6)))))
 (let (($x3146 (= (e_state_s_granule (select (g_granules (globals ?x3181)) rtt_gidx.406710)) 5)))
 (=> (and $x3146 (and (distinct ?x3084 (- 1)) true) $x153) (or (= ?x3090 4) (= ?x3090 6))))))))))))))))))))
 ))
 (not $x6573)))
(check-sat)

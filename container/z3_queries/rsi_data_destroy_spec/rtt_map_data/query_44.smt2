...
(assert
 (let (($x18471 (forall ((rtt_gidx.458130 Int) (ipa_gidx.458130 Int) (data_gidx.458130 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x14511 (query_oracle.0_call ?x7155)))
 ...
 (let ((?x29152 (div ?x14063 4096)))
 (let ((?x16838 (g_granules ?x17325)))
 (let ((?x18533 (select ?x16838 ?x29152)))
 (let ((?x61004 (mks_granule (e_lock ?x18533) 1 (e_ref ?x18533))))
 (let ((?x69228 (store ?x16838 ?x29152 ?x61004)))
 (let ((?x18256 (g_mbedtls_mem_buf ?x17325)))
 (let ((?x18357 (g_tt_l1_upper ?x17325)))
 (let ((?x18117 (g_tt_l2_mem1_3 ?x17325)))
 (let ((?x17682 (g_tt_l2_mem1_2 ?x17325)))
 ...
 (let ((?x18333 (g_debug_exits ?x17325)))
 (let ((?x18017 (g_heap ?x17325)))
 (let ((?x49663 (mkGLOBALS ?x18017 ?x18333 ?x18233 ?x18208 ?x17694 ?x18345 ?x18209 ?x17493 ?x18246 ?x18344 ?x18093 ?x18012 ?x18004 ?x18358 ?x18295 ?x18113 ?x18297 ?x17682 ?x18117 ?x18357 ?x18256 ?x69228 ?x18349 ?x18288 ?x18332 ?x17832 ?x17665 ?x18341 ?x16392 ?x17963 ?x18280)))
 (let ((?x53152 (mkr_granule_data (gd_g_idx (select (granule_data ?x18309) ?x29152)) (g_granule_state (select (granule_data ?x18309) ?x29152)) zero_granule_data (g_rd (select (granule_data ?x18309) ?x29152)) (g_rec (select (granule_data ?x18309) ?x29152)))))
 (let ((?x18339 (granule_data ?x18309)))
 (let ((?x18204 (store ?x18339 ?x29152 ?x53152)))
 (let ((?x18325 (gpt ?x18309)))
 (let ((?x17972 (priv ?x51995)))
 (let ((?x18169 (repl ?x51995)))
 (let ((?x17345 (oracle ?x51995)))
 (let ((?x18154 (log ?x51995)))
 (let ((?x68244 (mkRData ?x18154 ?x17345 ?x18169 ?x17972 (mkShared ?x18325 ?x18204 ?x49663) ?x17760 $x18123)))
 (let ((?x52821 (g_granule_state (select ?x18204 (rtt_walk_abs.0_call ?x68244 rtt_gidx.458130 ipa_gidx.458130)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.458130)))
 (let ((?x68052 (mkRData ?x18154 ?x17345 ?x18169 ?x17972 (mkShared ?x18325 ?x18339 ?x49663) ?x17760 $x18123)))
 (let ((?x53310 (mkRData (log ?x68052) (oracle ?x68052) (repl ?x68052) (priv ?x68052) (mkShared (gpt (share ?x68052)) ?x18204 (globals (share ?x68052))) (stack ?x68052) (halt ?x68052))))
 (let (($x18035 (=> (and (and (distinct (rtt_walk_abs.0_call ?x53310 rtt_gidx.458130 ipa_gidx.458130) (- 1)) true) $x153) (or (= ?x52821 4) (= ?x52821 6)))))
 (=> (and (= (e_state_s_granule (select ?x69228 rtt_gidx.458130)) 5) (and (distinct (rtt_walk_abs.0_call ?x53310 rtt_gidx.458130 ipa_gidx.458130) (- 1)) true) $x153) (or (= ?x52821 4) (= ?x52821 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x18471)))
(check-sat)

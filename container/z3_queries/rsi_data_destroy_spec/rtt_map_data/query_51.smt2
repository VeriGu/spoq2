...
(assert
 (let (($x20010 (forall ((rtt_gidx.461997 Int) (ipa_gidx.461997 Int) (data_gidx.461997 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x7142 (rtt_walk_abs.0_call ?x7155 rtt_gidx.461997 ipa_gidx.461997)))
 (let ((?x7291 (share ?x7155)))
 (let ((?x7279 (granule_data ?x7291)))
 (let ((?x7167 (g_granule_state (select ?x7279 ?x7142))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.461997)))
 (let (($x7222 (=> $x153 (or (= ?x7167 4) (= ?x7167 6)))))
 (let (($x7100 (= (e_state_s_granule (select (g_granules (globals ?x7291)) rtt_gidx.461997)) 5)))
 (=> (and $x7100 (and (distinct ?x7142 (- 1)) true) $x153) (or (= ?x7167 4) (= ?x7167 6)))))))))))))))
 ))
 (not $x20010)))
(check-sat)

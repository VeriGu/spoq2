...
(assert
 ...
 (and $x3046 $x3043)))))))
(assert
 (forall ((rtt_gidx.393086 Int) (ipa_gidx.393086 Int) (data_gidx.393086 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2235 (rtt_walk_abs.0_call ?x2194 rtt_gidx.393086 ipa_gidx.393086)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2330 (g_granule_state (select ?x2311 ?x2235))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.393086)))
 (let (($x2378 (=> $x153 (or (= ?x2330 4) (= ?x2330 6)))))
 (let (($x2317 (= (e_state_s_granule (select (g_granules (globals ?x2304)) rtt_gidx.393086)) 5)))
 (=> (and $x2317 (and (distinct ?x2235 (- 1)) true) $x153) (or (= ?x2330 4) (= ?x2330 6)))))))))))))
 )
(assert
 (forall ((gidx.393139 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2255 (select ?x2311 gidx.393139)))
 (let (($x2337 (= (g_norm ?x2255) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x2304)) gidx.393139)) 1) $x2337))))))))
 )
(assert
 (let (($x2434 (forall ((rtt_gidx.393495 Int) (ipa_gidx.393495 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 ...
 (let ((?x2422 (rtt_walk_abs.0_call ?x2358 rtt_gidx.393495 ipa_gidx.393495)))
 (let ((?x2342 (granule_data ?x2299)))
 (let ((?x2429 (g_granule_state (select ?x2342 ?x2422))))
 (let (($x2427 (= ?x2429 6)))
 (let (($x2426 (= ?x2422 (- 1))))
 (let (($x2430 (= ?x2429 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.393495))))
 (let (($x2421 (not (= (e_state_s_granule (select (g_granules (globals ?x2299)) rtt_gidx.393495)) 5))))
 (or $x2421 $x176 $x2430 $x2426 $x2427))))))))))))))))))))))))
 ))
 (let (($x2424 (forall ((rtt_gidx.393448 Int) (ipa_gidx.393448 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2297 (rtt_walk_abs.0_call ?x2194 rtt_gidx.393448 ipa_gidx.393448)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2409 (g_granule_state (select ?x2311 ?x2297))))
 (let (($x2416 (= ?x2409 4)))
 (let (($x2412 (not (= (e_state_s_granule (select (g_granules (globals ?x2304)) rtt_gidx.393448)) 5))))
 (let (($x2408 (= ?x2297 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.393448))))
 (let (($x2407 (= ?x2409 6)))
 (or $x2407 $x176 $x2408 $x2412 $x2416)))))))))))))
 ))
 (or (not $x2424) $x2434))))
(assert
 (forall ((offset.394155 Int) (empty_pte.394155 abs_PTE_t) )(let (($x1832 (not (= (meta_granule_offset (meta_PA empty_pte.394155)) (- 1)))))
 (let ((?x1833 (div offset.394155 4096)))
 (let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let (($x2535 (forall ((rtt_gidx.394151 Int) (ipa_gidx.394151 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let (($x2216 (halt ?x2194)))
 (let ((?x2327 (stack ?x2194)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x1810 (test_PTE_Z.0_call empty_pte.394155)))
 (let ((?x1809 (mod offset.394155 4096)))
 (let ((?x2518 (store (g_norm (select (granule_data ?x2304) (div offset.394155 4096))) ?x1809 ?x1810)))
 (let ((?x2521 (mkr_granule_data (gd_g_idx (select (granule_data ?x2304) (div offset.394155 4096))) (g_granule_state (select (granule_data ?x2304) (div offset.394155 4096))) ?x2518 (g_rd (select (granule_data ?x2304) (div offset.394155 4096))) (g_rec (select (granule_data ?x2304) (div offset.394155 4096))))))
 (let ((?x1750 (div offset.394155 4096)))
 (let ((?x2311 (granule_data ?x2304)))
 ...
 (let ((?x2250 (oracle ?x2194)))
 (let ((?x2256 (log ?x2194)))
 (let ((?x2524 (rtt_walk_abs.0_call (mkRData ?x2256 ?x2250 ?x2391 ?x2303 (mkShared ?x2461 ?x2525 ?x2338) ?x2327 $x2216) rtt_gidx.394151 ipa_gidx.394151)))
 (let ((?x2530 (g_granule_state (select ?x2525 ?x2524))))
 (let (($x2528 (= ?x2530 6)))
 (let (($x2532 (= ?x2530 4)))
 (let (($x2529 (= ?x2524 (- 1))))
 (let (($x2412 (not (= (e_state_s_granule (select (g_granules ?x2338) rtt_gidx.394151)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.394151))))
 (or $x176 $x2412 $x2529 $x2532 $x2528)))))))))))))))))))))))))))
 ))
 (let (($x2493 (forall ((rtt_gidx.394038 Int) (ipa_gidx.394038 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2297 (rtt_walk_abs.0_call ?x2194 rtt_gidx.394038 ipa_gidx.394038)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2409 (g_granule_state (select ?x2311 ?x2297))))
 (let (($x2416 (= ?x2409 4)))
 (let (($x2412 (not (= (e_state_s_granule (select (g_granules (globals ?x2304)) rtt_gidx.394038)) 5))))
 (let (($x2408 (= ?x2297 (- 1))))
 (let (($x2407 (= ?x2409 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.394038))))
 (or $x176 $x2407 $x2408 $x2412 $x2416)))))))))))))
 ))
 (let (($x2494 (not $x2493)))
 (or $x2494 $x2535 (not (= (e_state_s_granule (select ?x2339 ?x1833)) 5)) $x1832))))))))))))
 )
(assert
 (forall ((offset.394714 Int) (state.394714 Int) )(let (($x2689 (forall ((rtt_gidx.394712 Int) (ipa_gidx.394712 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let ((?x2629 (select ?x2339 offset.394714)))
 (let ((?x2652 (store ?x2339 offset.394714 (mks_granule (e_lock ?x2629) state.394714 (e_ref ?x2629)))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.394712))))
 (let (($x2216 (halt ?x2194)))
 (let ((?x2327 (stack ?x2194)))
 ...
 (let ((?x2677 (mkr_granule_data (gd_g_idx (select (granule_data ?x2304) offset.394714)) (g_granule_state (select (granule_data ?x2304) offset.394714)) zero_granule_data (g_rd (select (granule_data ?x2304) offset.394714)) (g_rec (select (granule_data ?x2304) offset.394714)))))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2676 (store ?x2311 offset.394714 ?x2677)))
 (let ((?x2461 (gpt ?x2304)))
 (let ((?x2303 (priv ?x2194)))
 (let ((?x2391 (repl ?x2194)))
 (let ((?x2250 (oracle ?x2194)))
 (let ((?x2256 (log ?x2194)))
 (let ((?x2679 (rtt_walk_abs.0_call (mkRData ?x2256 ?x2250 ?x2391 ?x2303 (mkShared ?x2461 ?x2676 ?x2668) ?x2327 $x2216) rtt_gidx.394712 ipa_gidx.394712)))
 (let ((?x2684 (g_granule_state (select ?x2676 ?x2679))))
 (or (= ?x2679 (- 1)) (= ?x2684 4) (= ?x2684 6) $x176 (not (= (e_state_s_granule (select ?x2652 rtt_gidx.394712)) 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2657 (forall ((rtt_gidx.394613 Int) (ipa_gidx.394613 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let ((?x2403 (e_state_s_granule (select ?x2339 rtt_gidx.394613))))
 (let (($x2412 (not (= ?x2403 5))))
 (let ((?x2297 (rtt_walk_abs.0_call ?x2194 rtt_gidx.394613 ipa_gidx.394613)))
 (let (($x2408 (= ?x2297 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.394613))))
 (let ((?x2409 (g_granule_state (select (granule_data ?x2304) ?x2297))))
 (let (($x2416 (= ?x2409 4)))
 (let (($x2407 (= ?x2409 6)))
 (or $x2407 $x2416 $x176 $x2408 $x2412)))))))))))))))
 ))
 (let (($x2632 (not $x2657)))
 (or $x2632 $x2689)))))
 )
(assert
 (forall ((parent_gidx.395658 Int) (pte_z.395658 Int) (x.395658 Int) (y.395658 Int) (z.395658 Int) )(let (($x2850 (forall ((rtt_gidx.395656 Int) (ipa_gidx.395656 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.395656))))
 (let ((?x2136 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.395658))) 4096)))
 (let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 ...
 (let ((?x2166 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.395658)) x.395658 y.395658 z.395658))))
 (let ((?x2167 (mod parent_gidx.395658 4096)))
 (let ((?x2830 (store (g_norm (select (granule_data ?x2304) (div parent_gidx.395658 4096))) ?x2167 ?x2166)))
 (let ((?x2816 (mkr_granule_data (gd_g_idx (select (granule_data ?x2304) (div parent_gidx.395658 4096))) (g_granule_state (select (granule_data ?x2304) (div parent_gidx.395658 4096))) ?x2830 (g_rd (select (granule_data ?x2304) (div parent_gidx.395658 4096))) (g_rec (select (granule_data ?x2304) (div parent_gidx.395658 4096))))))
 (let ((?x2161 (div parent_gidx.395658 4096)))
 (let ((?x2311 (granule_data ?x2304)))
 ...
 (let ((?x2250 (oracle ?x2194)))
 (let ((?x2256 (log ?x2194)))
 (let ((?x2818 (rtt_walk_abs.0_call (mkRData ?x2256 ?x2250 ?x2391 ?x2303 (mkShared ?x2461 ?x2817 ?x2809) ?x2327 $x2216) rtt_gidx.395656 ipa_gidx.395656)))
 (let ((?x2841 (g_granule_state (select ?x2817 ?x2818))))
 (or (= ?x2818 (- 1)) (= ?x2841 6) (= ?x2841 4) (not (= (e_state_s_granule (select ?x2793 rtt_gidx.395656)) 5)) $x176))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2796 (forall ((rtt_gidx.395460 Int) (ipa_gidx.395460 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.395460))))
 (let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let ((?x2403 (e_state_s_granule (select ?x2339 rtt_gidx.395460))))
 (let (($x2412 (not (= ?x2403 5))))
 (let ((?x2297 (rtt_walk_abs.0_call ?x2194 rtt_gidx.395460 ipa_gidx.395460)))
 (let (($x2408 (= ?x2297 (- 1))))
 (let ((?x2409 (g_granule_state (select (granule_data ?x2304) ?x2297))))
 (let (($x2416 (= ?x2409 4)))
 (let (($x2407 (= ?x2409 6)))
 (or $x2407 $x2416 $x2408 $x2412 $x176)))))))))))))))
 ))
 (let (($x2772 (not $x2796)))
 (or $x2772 $x2850)))))
 )
(assert
 (forall ((offset.396089 Int) )(let (($x2976 (forall ((rtt_gidx.396086 Int) (ipa_gidx.396086 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let ((?x2245 (select ?x2339 offset.396089)))
 (let ((?x2960 (store ?x2339 offset.396089 (mks_granule (e_lock ?x2245) 4 (e_ref ?x2245)))))
 (let (($x2216 (halt ?x2194)))
 (let ((?x2327 (stack ?x2194)))
 (let ((?x2593 (g_realm_attest_private_key ?x2338)))
 (let ((?x2595 (g_get_realm_identity_identity ?x2338)))
 ...
 (let ((?x2250 (oracle ?x2194)))
 (let ((?x2256 (log ?x2194)))
 (let ((?x2963 (rtt_walk_abs.0_call (mkRData ?x2256 ?x2250 ?x2391 ?x2303 (mkShared ?x2461 ?x2311 ?x2943) ?x2327 $x2216) rtt_gidx.396086 ipa_gidx.396086)))
 (let ((?x2971 (g_granule_state (select ?x2311 ?x2963))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.396086))))
 (or $x176 (= ?x2963 (- 1)) (= ?x2971 6) (= ?x2971 4) (not (= (e_state_s_granule (select ?x2960 rtt_gidx.396086)) 5)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2962 (forall ((rtt_gidx.396016 Int) (ipa_gidx.396016 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2338 (globals ?x2304)))
 (let ((?x2339 (g_granules ?x2338)))
 (let ((?x2403 (e_state_s_granule (select ?x2339 rtt_gidx.396016))))
 (let (($x2412 (not (= ?x2403 5))))
 (let ((?x2297 (rtt_walk_abs.0_call ?x2194 rtt_gidx.396016 ipa_gidx.396016)))
 (let (($x2408 (= ?x2297 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.396016))))
 (let ((?x2409 (g_granule_state (select (granule_data ?x2304) ?x2297))))
 (let (($x2416 (= ?x2409 4)))
 (let (($x2407 (= ?x2409 6)))
 (or $x2407 $x2416 $x176 $x2408 $x2412)))))))))))))))
 ...
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2255 (select ?x2311 offset.396089)))
 (let (($x2337 (= (g_norm ?x2255) zero_granule_data)))
 (let (($x2975 (not $x2337)))
 (or $x2975 $x2942 $x2976))))))))))))
 )
(assert
 (forall ((rtt_gidx.396191 Int) (ipa_gidx.396191 Int) (i.396191 Int) (d.396191 r_granule_data) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let (($x2216 (halt ?x2194)))
 (let ((?x2327 (stack ?x2194)))
 (let ((?x2304 (share ?x2194)))
 ...
 (let ((?x2250 (oracle ?x2194)))
 (let ((?x2256 (log ?x2194)))
 (let ((?x3007 (mkRData ?x2256 ?x2250 ?x2391 ?x2303 (mkShared ?x2461 (store (granule_data ?x2304) i.396191 d.396191) ?x2338) ?x2327 $x2216)))
 (let ((?x3006 (rtt_walk_abs.0_call ?x3007 rtt_gidx.396191 ipa_gidx.396191)))
 (let (($x3011 (= (+ (rtt_walk_abs.0_call ?x2194 rtt_gidx.396191 ipa_gidx.396191) (* (- 1) ?x3006)) 0)))
 (let (($x2412 (not (= (e_state_s_granule (select (g_granules ?x2338) i.396191)) 5))))
 (let (($x3009 (and $x2412 (not (= (e_state_s_granule (select (g_granules ?x2338) i.396191)) 4)))))
 (=> $x3009 $x3011))))))))))))))))))
 )
(assert
 (let (($x3078 (forall ((rtt_gidx.396270 Int) (ipa_gidx.396270 Int) (data_gidx.396270 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2235 (rtt_walk_abs.0_call ?x2194 rtt_gidx.396270 ipa_gidx.396270)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2330 (g_granule_state (select ?x2311 ?x2235))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.396270)))
 (let (($x2378 (=> $x153 (or (= ?x2330 4) (= ?x2330 6)))))
 (let (($x2317 (= (e_state_s_granule (select (g_granules (globals ?x2304)) rtt_gidx.396270)) 5)))
 (=> (and $x2317 (and (distinct ?x2235 (- 1)) true) $x153) (or (= ?x2330 4) (= ?x2330 6)))))))))))))
 ))
 (not $x3078)))
(check-sat)

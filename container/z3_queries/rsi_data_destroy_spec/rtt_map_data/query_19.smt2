...
(assert
 (let (($x10705 (forall ((rtt_gidx.423675 Int) (ipa_gidx.423675 Int) (data_gidx.423675 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x7097 (query_oracle.0_call ?x2194)))
 (let ((?x7155 (value_RData ?x7097)))
 (let ((?x2187 (test_PA.0_call v_0.0)))
 ...
 (let ((?x9405 (query_oracle.0_call ?x34108)))
 (let ((?x10027 (value_RData ?x9405)))
 (let ((?x9590 (rtt_walk_abs.0_call ?x10027 rtt_gidx.423675 ipa_gidx.423675)))
 (let ((?x10103 (share ?x10027)))
 (let ((?x10110 (granule_data ?x10103)))
 (let ((?x10148 (g_granule_state (select ?x10110 ?x9590))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.423675)))
 (let (($x10256 (=> $x153 (or (= ?x10148 4) (= ?x10148 6)))))
 (let (($x10044 (= (e_state_s_granule (select (g_granules (globals ?x10103)) rtt_gidx.423675)) 5)))
 (=> (and $x10044 (and (distinct ?x9590 (- 1)) true) $x153) (or (= ?x10148 4) (= ?x10148 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10705)))
(check-sat)

...
(assert
 (let (($x7123 (forall ((rtt_gidx.410132 Int) (ipa_gidx.410132 Int) (data_gidx.410132 Int) )(let ((?x2192 (query_oracle.0_call st.0)))
 (let ((?x2194 (value_RData ?x2192)))
 (let ((?x2235 (rtt_walk_abs.0_call ?x2194 rtt_gidx.410132 ipa_gidx.410132)))
 (let ((?x2304 (share ?x2194)))
 (let ((?x2311 (granule_data ?x2304)))
 (let ((?x2330 (g_granule_state (select ?x2311 ?x2235))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.410132)))
 (let (($x2378 (=> $x153 (or (= ?x2330 4) (= ?x2330 6)))))
 (let (($x2317 (= (e_state_s_granule (select (g_granules (globals ?x2304)) rtt_gidx.410132)) 5)))
 (=> (and $x2317 (and (distinct ?x2235 (- 1)) true) $x153) (or (= ?x2330 4) (= ?x2330 6)))))))))))))
 ))
 (not $x7123)))
(check-sat)

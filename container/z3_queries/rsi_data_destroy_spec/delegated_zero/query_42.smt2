...
(assert
 (forall ((gidx.145600492 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x28330 (share ?x67269)))
 (let ((?x26743 (granule_data ?x28330)))
 (let ((?x25945 (select ?x26743 gidx.145600492)))
 (let (($x25524 (= (g_norm ?x25945) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x28330)) gidx.145600492)) 1) $x25524))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x67269 (value_RData ?x36395)))
 (let ((?x28330 (share ?x67269)))
 (let ((?x79529 (globals ?x28330)))
 (let ((?x18168 (g_granules ?x79529)))
 (= ?x18168 ?x66588))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x72575 (forall ((gidx.145600529 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x28330 (share ?x67269)))
 (let ((?x26743 (granule_data ?x28330)))
 (let ((?x25945 (select ?x26743 gidx.145600529)))
 (let (($x25524 (= (g_norm ?x25945) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x28330)) gidx.145600529)) 1) $x25524))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x72575)))
(check-sat)

...
(assert
 ...
 (let (($x28927 (= (g_norm (select ?x34029 gidx.145596484)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18501)) gidx.145596484)) 1) $x28927))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x31710))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x46139 (forall ((gidx.145597337 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18501 (share ?x51669)))
 (let ((?x34029 (granule_data ?x18501)))
 (let (($x28927 (= (g_norm (select ?x34029 gidx.145597337)) zero_granule_data)))
 (let ((?x72238 (mkPtr "granule_data" ?x41424)))
 (let ((?x40966 (abs_tte_read.0_call ?x72238 ?x32241)))
 (let ((?x41397 (meta_PA ?x40966)))
 (let ((?x40857 (meta_granule_offset ?x41397)))
 ...
 (let ((?x42423 (mks_granule ?x72611 ?x36119 ?x33740)))
 (let ((?x41229 (store ?x41077 ?x40803 ?x42423)))
 (=> (= (e_state_s_granule (select ?x41229 gidx.145597337)) 1) $x28927))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x46139)))
(check-sat)

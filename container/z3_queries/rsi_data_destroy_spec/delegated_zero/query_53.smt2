...
(assert
 (forall ((gidx.145602644 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x41275 (rtt_walk_lock_unlock_spec_abs.0_call ?x23371 ?x25339 0 64 v_1.0 3 ?x51317)))
 (let ((?x64328 (value_Tuple_abs_ret_rtt_RData ?x41275)))
 (let ((?x40511 (elem_1 ?x64328)))
 (let (($x63383 (halt ?x40511)))
 (let ((?x28676 (stack ?x40511)))
 (let ((?x21898 (elem_0 ?x64328)))
 (let ((?x39407 (e_2 ?x21898)))
 (let ((?x45585 (poffset ?x39407)))
 (let ((?x17685 (div ?x45585 4096)))
 (let ((?x18488 (share ?x40511)))
 (let ((?x66669 (globals ?x18488)))
 (let ((?x62525 (g_granules ?x66669)))
 (let ((?x18121 (select ?x62525 ?x17685)))
 (let ((?x28867 (e_ref ?x18121)))
 (let ((?x53758 (e_u_anon_3_0 ?x28867)))
 (let ((?x17666 (+ (- 1) ?x53758)))
 (let ((?x20424 (mku_anon_3 ?x17666)))
 (let ((?x30448 (mks_granule (e_lock ?x18121) (e_state_s_granule ?x18121) ?x20424)))
 (let ((?x66896 (store ?x62525 ?x17685 ?x30448)))
 (let ((?x28490 (mkGLOBALS (g_heap ?x66669) (g_debug_exits ?x66669) (g_vmid_count ?x66669) (g_vmid_lock ?x66669) (g_vmids ?x66669) (g_nr_lrs ?x66669) (g_nr_aprs ?x66669) (g_max_vintid ?x66669) (g_pri_res0_mask ?x66669) (g_default_gicstate ?x66669) (g_status_handler ?x66669) (g_rmm_trap_list ?x66669) (g_tt_l3_buffer ?x66669) (g_tt_l2_mem0_0 ?x66669) (g_tt_l2_mem0_1 ?x66669) (g_tt_l2_mem1_0 ?x66669) (g_tt_l2_mem1_1 ?x66669) (g_tt_l2_mem1_2 ?x66669) (g_tt_l2_mem1_3 ?x66669) (g_tt_l1_upper ?x66669) (g_mbedtls_mem_buf ?x66669) ?x66896 (g_rmm_attest_signing_key ?x66669) (g_rmm_attest_public_key ?x66669) (g_rmm_attest_public_key_len ?x66669) (g_rmm_attest_public_key_hash ?x66669) (g_rmm_attest_public_key_hash_len ?x66669) (g_platform_token_buf ?x66669) (g_rmm_platform_token ?x66669) (g_get_realm_identity_identity ?x66669) (g_realm_attest_private_key ?x66669))))
 (let ((?x64234 (e_3 ?x21898)))
 (let ((?x63045 (* 8 ?x64234)))
 (let ((?x32826 (+ ?x45585 ?x63045)))
 (let ((?x40359 (div ?x32826 4096)))
 (let ((?x66748 (granule_data ?x18488)))
 (let ((?x41906 (select ?x66748 ?x40359)))
 (let ((?x30757 (g_rec ?x41906)))
 (let ((?x41395 (g_rd ?x41906)))
 (let ((?x27478 (test_PTE_Z.0_call s2tte_create_destroyed_abs.0_call)))
 (let ((?x64423 (mod ?x32826 4096)))
 (let ((?x32399 (g_norm ?x41906)))
 (let ((?x42575 (store ?x32399 ?x64423 ?x27478)))
 (let ((?x41140 (g_granule_state ?x41906)))
 (let ((?x26485 (gd_g_idx ?x41906)))
 (let ((?x46325 (mkr_granule_data ?x26485 ?x41140 ?x42575 ?x41395 ?x30757)))
 (let ((?x67686 (store ?x66748 ?x40359 ?x46325)))
 (let ((?x27981 (gpt ?x18488)))
 (let ((?x42478 (priv ?x40511)))
 (let ((?x22800 (repl ?x40511)))
 (let ((?x32898 (oracle ?x40511)))
 (let ((?x28638 (log ?x40511)))
 (let ((?x63983 (query_oracle.0_call (mkRData ?x28638 ?x32898 ?x22800 ?x42478 (mkShared ?x27981 ?x67686 ?x28490) ?x28676 $x63383))))
 (let ((?x63883 (value_RData ?x63983)))
 (let ((?x41129 (share ?x63883)))
 (let ((?x63374 (granule_data ?x41129)))
 (let (($x45165 (= (g_norm (select ?x63374 gidx.145602644)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x41129)) gidx.145602644)) 1) $x45165)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x63883 (value_RData ?x63983)))
 (let ((?x41129 (share ?x63883)))
 (let ((?x28841 (globals ?x41129)))
 (let ((?x21370 (g_granules ?x28841)))
 (= ?x21370 ?x66896)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x45585 (poffset ?x39407)))
 (let ((?x32826 (+ ?x45585 ?x63045)))
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x64460 (meta_PA ?x28546)))
 (let ((?x37119 (meta_granule_offset ?x64460)))
 (let ((?x21771 (div ?x37119 16)))
 (let (($x63383 (halt ?x40511)))
 (let ((?x28676 (stack ?x40511)))
 (let ((?x17685 (div ?x45585 4096)))
 (let ((?x18488 (share ?x40511)))
 ...
 (let ((?x28841 (globals ?x41129)))
 (let ((?x21370 (g_granules ?x28841)))
 (let ((?x20755 (select ?x21370 ?x21771)))
 (let ((?x55698 (e_lock ?x20755)))
 (let ((?x25651 (e_val ?x55698)))
 (= ?x25651 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x21370 (g_granules ?x28841)))
 (let ((?x20755 (select ?x21370 ?x21771)))
 (let ((?x64482 (mks_granule ?x39586 (e_state_s_granule ?x20755) (e_ref ?x20755))))
 (let ((?x67432 (store ?x21370 ?x21771 ?x64482)))
 (let ((?x45859 (select ?x67432 ?x28794)))
 (let ((?x27487 (e_state_s_granule ?x45859)))
 (= ?x27487 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x63983 (query_oracle.0_call (mkRData ?x28638 ?x32898 ?x22800 ?x42478 (mkShared ?x27981 ?x67686 ?x28490) ?x28676 $x63383))))
 (let ((?x63883 (value_RData ?x63983)))
 (let (($x73294 (halt ?x63883)))
 (let ((?x67834 (stack ?x63883)))
 (let ((?x41129 (share ?x63883)))
 (let ((?x28841 (globals ?x41129)))
 (let ((?x28959 (g_realm_attest_private_key ?x28841)))
 (let ((?x32974 (g_get_realm_identity_identity ?x28841)))
 (let ((?x28439 (g_rmm_platform_token ?x28841)))
 (let ((?x32970 (g_platform_token_buf ?x28841)))
 (let ((?x28856 (g_rmm_attest_public_key_hash_len ?x28841)))
 (let ((?x32564 (g_rmm_attest_public_key_hash ?x28841)))
 (let ((?x32231 (g_rmm_attest_public_key_len ?x28841)))
 (let ((?x36946 (g_rmm_attest_public_key ?x28841)))
 (let ((?x33400 (g_rmm_attest_signing_key ?x28841)))
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x64460 (meta_PA ?x28546)))
 (let ((?x37119 (meta_granule_offset ?x64460)))
 (let ((?x28794 (div ?x37119 4096)))
 (let ((?x64482 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x28841) (div ?x37119 16))) (e_ref (select (g_granules ?x28841) (div ?x37119 16))))))
 (let ((?x21771 (div ?x37119 16)))
 (let ((?x21370 (g_granules ?x28841)))
 (let ((?x67432 (store ?x21370 ?x21771 ?x64482)))
 (let ((?x45859 (select ?x67432 ?x28794)))
 (let ((?x32971 (e_ref ?x45859)))
 (let ((?x62754 (e_u_anon_3_0 ?x32971)))
 (let ((?x27942 (+ (- 1) ?x62754)))
 (let ((?x27873 (mku_anon_3 ?x27942)))
 (let ((?x27487 (e_state_s_granule ?x45859)))
 (let ((?x45716 (e_lock ?x45859)))
 (let ((?x36882 (mks_granule ?x45716 ?x27487 ?x27873)))
 (let ((?x63137 (store ?x67432 ?x28794 ?x36882)))
 (let ((?x28846 (g_mbedtls_mem_buf ?x28841)))
 (let ((?x42608 (g_tt_l1_upper ?x28841)))
 (let ((?x63578 (g_tt_l2_mem1_3 ?x28841)))
 (let ((?x32679 (g_tt_l2_mem1_2 ?x28841)))
 (let ((?x32692 (g_tt_l2_mem1_1 ?x28841)))
 (let ((?x28612 (g_tt_l2_mem1_0 ?x28841)))
 (let ((?x42106 (g_tt_l2_mem0_1 ?x28841)))
 (let ((?x42198 (g_tt_l2_mem0_0 ?x28841)))
 (let ((?x22101 (g_tt_l3_buffer ?x28841)))
 (let ((?x36571 (g_rmm_trap_list ?x28841)))
 (let ((?x27847 (g_status_handler ?x28841)))
 (let ((?x28782 (g_default_gicstate ?x28841)))
 (let ((?x62251 (g_pri_res0_mask ?x28841)))
 (let ((?x36446 (g_max_vintid ?x28841)))
 (let ((?x28123 (g_nr_aprs ?x28841)))
 (let ((?x28202 (g_nr_lrs ?x28841)))
 (let ((?x45626 (g_vmids ?x28841)))
 (let ((?x28659 (g_vmid_lock ?x28841)))
 (let ((?x33198 (g_vmid_count ?x28841)))
 (let ((?x32686 (g_debug_exits ?x28841)))
 (let ((?x37022 (g_heap ?x28841)))
 (let ((?x56759 (mkGLOBALS ?x37022 ?x32686 ?x33198 ?x28659 ?x45626 ?x28202 ?x28123 ?x36446 ?x62251 ?x28782 ?x27847 ?x36571 ?x22101 ?x42198 ?x42106 ?x28612 ?x32692 ?x32679 ?x63578 ?x42608 ?x28846 ?x63137 ?x33400 ?x36946 ?x32231 ?x32564 ?x28856 ?x32970 ?x28439 ?x32974 ?x28959)))
 (let ((?x63374 (granule_data ?x41129)))
 (let ((?x21906 (gpt ?x41129)))
 (let ((?x20143 (priv ?x63883)))
 (let ((?x36774 (repl ?x63883)))
 (let ((?x32673 (oracle ?x63883)))
 (let ((?x33296 (log ?x63883)))
 (let ((?x27051 (mkRData ?x33296 ?x32673 ?x36774 ?x20143 (mkShared ?x21906 ?x63374 ?x56759) ?x67834 $x73294)))
 (let ((?x36727 (mkPtr "granules" ?x37119)))
 (let ((?x26837 (g_refcount_para.0_call ?x36727 ?x27051)))
 (= ?x26837 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x37309 (forall ((gidx.145603102 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x41129 (share ?x63883)))
 (let ((?x63374 (granule_data ?x41129)))
 (let ((?x41724 (select ?x63374 ?x28794)))
 (let ((?x64575 (mkr_granule_data (gd_g_idx ?x41724) (g_granule_state ?x41724) zero_granule_data (g_rd ?x41724) (g_rec ?x41724))))
 (let ((?x75174 (store ?x63374 ?x28794 ?x64575)))
 (let ((?x21771 (div ?x37119 16)))
 (let ((?x28841 (globals ?x41129)))
 (let ((?x21370 (g_granules ?x28841)))
 (let ((?x20755 (select ?x21370 ?x21771)))
 ...
 (let ((?x27873 (mku_anon_3 ?x27942)))
 (let ((?x45716 (e_lock ?x45859)))
 (let ((?x27300 (store ?x67432 ?x28794 (mks_granule ?x45716 1 ?x27873))))
 (=> (= (e_state_s_granule (select ?x27300 gidx.145603102)) 1) (= (g_norm (select ?x75174 gidx.145603102)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x37309)))
(check-sat)

...
(assert
 ...
 (not $x26180))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x31606 (forall ((gidx.145596336 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x16853 (share ?x17595)))
 (let ((?x40979 (granule_data ?x16853)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x16853)) gidx.145596336)) 1) (= (g_norm (select ?x40979 gidx.145596336)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x31606)))
(check-sat)

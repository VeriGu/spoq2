...
(assert
 (forall ((gidx.145601567 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x36395 (query_oracle.0_call ?x51317)))
 (let ((?x67269 (value_RData ?x36395)))
 (let ((?x1542 (mkPtr "granule_data" ?x37067)))
 (let ((?x25339 (rec_to_ttbr1_para.0_call ?x1542 ?x883)))
 (let ((?x23371 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x41103 (rtt_walk_lock_unlock_spec_abs.0_call ?x23371 ?x25339 0 64 v_1.0 3 ?x67269)))
 (let ((?x26783 (value_Tuple_abs_ret_rtt_RData ?x41103)))
 (let ((?x45709 (elem_1 ?x26783)))
 (let (($x64140 (halt ?x45709)))
 (let ((?x67180 (stack ?x45709)))
 (let ((?x46173 (elem_0 ?x26783)))
 (let ((?x18231 (e_2 ?x46173)))
 (let ((?x27080 (poffset ?x18231)))
 (let ((?x53132 (div ?x27080 4096)))
 (let ((?x28872 (share ?x45709)))
 (let ((?x27957 (globals ?x28872)))
 (let ((?x17578 (g_granules ?x27957)))
 (let ((?x59410 (select ?x17578 ?x53132)))
 (let ((?x46397 (e_ref ?x59410)))
 (let ((?x20717 (e_u_anon_3_0 ?x46397)))
 (let ((?x67370 (+ (- 1) ?x20717)))
 (let ((?x19786 (mku_anon_3 ?x67370)))
 (let ((?x21724 (mks_granule (e_lock ?x59410) (e_state_s_granule ?x59410) ?x19786)))
 (let ((?x41908 (store ?x17578 ?x53132 ?x21724)))
 (let ((?x46475 (mkGLOBALS (g_heap ?x27957) (g_debug_exits ?x27957) (g_vmid_count ?x27957) (g_vmid_lock ?x27957) (g_vmids ?x27957) (g_nr_lrs ?x27957) (g_nr_aprs ?x27957) (g_max_vintid ?x27957) (g_pri_res0_mask ?x27957) (g_default_gicstate ?x27957) (g_status_handler ?x27957) (g_rmm_trap_list ?x27957) (g_tt_l3_buffer ?x27957) (g_tt_l2_mem0_0 ?x27957) (g_tt_l2_mem0_1 ?x27957) (g_tt_l2_mem1_0 ?x27957) (g_tt_l2_mem1_1 ?x27957) (g_tt_l2_mem1_2 ?x27957) (g_tt_l2_mem1_3 ?x27957) (g_tt_l1_upper ?x27957) (g_mbedtls_mem_buf ?x27957) ?x41908 (g_rmm_attest_signing_key ?x27957) (g_rmm_attest_public_key ?x27957) (g_rmm_attest_public_key_len ?x27957) (g_rmm_attest_public_key_hash ?x27957) (g_rmm_attest_public_key_hash_len ?x27957) (g_platform_token_buf ?x27957) (g_rmm_platform_token ?x27957) (g_get_realm_identity_identity ?x27957) (g_realm_attest_private_key ?x27957))))
 (let ((?x16504 (e_3 ?x46173)))
 (let ((?x63649 (* 8 ?x16504)))
 (let ((?x60601 (+ ?x27080 ?x63649)))
 (let ((?x28735 (div ?x60601 4096)))
 (let ((?x45553 (granule_data ?x28872)))
 (let ((?x16505 (select ?x45553 ?x28735)))
 (let ((?x45127 (g_rec ?x16505)))
 (let ((?x46630 (g_rd ?x16505)))
 (let ((?x68542 (mkabs_PA_t (- 1))))
 (let ((?x1375 (mkabs_PTE_t ?x68542 0 0 0)))
 (let ((?x1184 (test_PTE_Z.0_call ?x1375)))
 (let ((?x16411 (mod ?x60601 4096)))
 (let ((?x17171 (g_norm ?x16505)))
 (let ((?x20200 (store ?x17171 ?x16411 ?x1184)))
 (let ((?x67411 (g_granule_state ?x16505)))
 (let ((?x64439 (gd_g_idx ?x16505)))
 (let ((?x41970 (mkr_granule_data ?x64439 ?x67411 ?x20200 ?x46630 ?x45127)))
 (let ((?x62563 (store ?x45553 ?x28735 ?x41970)))
 (let ((?x46333 (gpt ?x28872)))
 (let ((?x64208 (priv ?x45709)))
 (let ((?x59521 (repl ?x45709)))
 (let ((?x62753 (oracle ?x45709)))
 (let ((?x41919 (log ?x45709)))
 (let ((?x17657 (query_oracle.0_call (mkRData ?x41919 ?x62753 ?x59521 ?x64208 (mkShared ?x46333 ?x62563 ?x46475) ?x67180 $x64140))))
 (let ((?x46529 (value_RData ?x17657)))
 (let ((?x63594 (share ?x46529)))
 (let ((?x46199 (granule_data ?x63594)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x63594)) gidx.145601567)) 1) (= (g_norm (select ?x46199 gidx.145601567)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x46529 (value_RData ?x17657)))
 (let ((?x63594 (share ?x46529)))
 (let ((?x55610 (globals ?x63594)))
 (let ((?x44882 (g_granules ?x55610)))
 (= ?x44882 ?x41908)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x27080 (poffset ?x18231)))
 (let ((?x60601 (+ ?x27080 ?x63649)))
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x54982 (meta_PA ?x45099)))
 (let ((?x41306 (meta_granule_offset ?x54982)))
 (let ((?x8591 (div ?x41306 16)))
 (let (($x64140 (halt ?x45709)))
 (let ((?x67180 (stack ?x45709)))
 (let ((?x53132 (div ?x27080 4096)))
 (let ((?x28872 (share ?x45709)))
 ...
 (let ((?x55610 (globals ?x63594)))
 (let ((?x44882 (g_granules ?x55610)))
 (let ((?x46211 (select ?x44882 ?x8591)))
 (let ((?x45809 (e_lock ?x46211)))
 (let ((?x47100 (e_val ?x45809)))
 (= ?x47100 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x44882 (g_granules ?x55610)))
 (let ((?x46211 (select ?x44882 ?x8591)))
 (let ((?x45578 (mks_granule ?x39586 (e_state_s_granule ?x46211) (e_ref ?x46211))))
 (let ((?x45179 (store ?x44882 ?x8591 ?x45578)))
 (let ((?x42500 (select ?x45179 ?x45209)))
 (let ((?x68498 (e_state_s_granule ?x42500)))
 (= ?x68498 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x17657 (query_oracle.0_call (mkRData ?x41919 ?x62753 ?x59521 ?x64208 (mkShared ?x46333 ?x62563 ?x46475) ?x67180 $x64140))))
 (let ((?x46529 (value_RData ?x17657)))
 (let (($x46046 (halt ?x46529)))
 (let ((?x45601 (stack ?x46529)))
 (let ((?x63594 (share ?x46529)))
 (let ((?x55610 (globals ?x63594)))
 (let ((?x46312 (g_realm_attest_private_key ?x55610)))
 (let ((?x67160 (g_get_realm_identity_identity ?x55610)))
 (let ((?x67621 (g_rmm_platform_token ?x55610)))
 (let ((?x66680 (g_platform_token_buf ?x55610)))
 (let ((?x67368 (g_rmm_attest_public_key_hash_len ?x55610)))
 (let ((?x46492 (g_rmm_attest_public_key_hash ?x55610)))
 (let ((?x68219 (g_rmm_attest_public_key_len ?x55610)))
 (let ((?x46619 (g_rmm_attest_public_key ?x55610)))
 (let ((?x72222 (g_rmm_attest_signing_key ?x55610)))
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x54982 (meta_PA ?x45099)))
 (let ((?x41306 (meta_granule_offset ?x54982)))
 (let ((?x45209 (div ?x41306 4096)))
 (let ((?x45578 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x55610) (div ?x41306 16))) (e_ref (select (g_granules ?x55610) (div ?x41306 16))))))
 (let ((?x8591 (div ?x41306 16)))
 (let ((?x44882 (g_granules ?x55610)))
 (let ((?x45179 (store ?x44882 ?x8591 ?x45578)))
 (let ((?x42500 (select ?x45179 ?x45209)))
 (let ((?x45829 (e_ref ?x42500)))
 (let ((?x41791 (e_u_anon_3_0 ?x45829)))
 (let ((?x46754 (+ (- 1) ?x41791)))
 (let ((?x46234 (mku_anon_3 ?x46754)))
 (let ((?x68498 (e_state_s_granule ?x42500)))
 (let ((?x67440 (e_lock ?x42500)))
 (let ((?x67276 (mks_granule ?x67440 ?x68498 ?x46234)))
 (let ((?x66524 (store ?x45179 ?x45209 ?x67276)))
 (let ((?x15643 (g_mbedtls_mem_buf ?x55610)))
 (let ((?x46209 (g_tt_l1_upper ?x55610)))
 (let ((?x53251 (g_tt_l2_mem1_3 ?x55610)))
 (let ((?x45981 (g_tt_l2_mem1_2 ?x55610)))
 (let ((?x17043 (g_tt_l2_mem1_1 ?x55610)))
 (let ((?x63975 (g_tt_l2_mem1_0 ?x55610)))
 (let ((?x22261 (g_tt_l2_mem0_1 ?x55610)))
 (let ((?x56989 (g_tt_l2_mem0_0 ?x55610)))
 (let ((?x67357 (g_tt_l3_buffer ?x55610)))
 (let ((?x45855 (g_rmm_trap_list ?x55610)))
 (let ((?x46765 (g_status_handler ?x55610)))
 (let ((?x68378 (g_default_gicstate ?x55610)))
 (let ((?x64348 (g_pri_res0_mask ?x55610)))
 (let ((?x67395 (g_max_vintid ?x55610)))
 (let ((?x46264 (g_nr_aprs ?x55610)))
 (let ((?x65734 (g_nr_lrs ?x55610)))
 (let ((?x64110 (g_vmids ?x55610)))
 (let ((?x53197 (g_vmid_lock ?x55610)))
 (let ((?x15854 (g_vmid_count ?x55610)))
 (let ((?x46636 (g_debug_exits ?x55610)))
 (let ((?x46094 (g_heap ?x55610)))
 (let ((?x75577 (mkGLOBALS ?x46094 ?x46636 ?x15854 ?x53197 ?x64110 ?x65734 ?x46264 ?x67395 ?x64348 ?x68378 ?x46765 ?x45855 ?x67357 ?x56989 ?x22261 ?x63975 ?x17043 ?x45981 ?x53251 ?x46209 ?x15643 ?x66524 ?x72222 ?x46619 ?x68219 ?x46492 ?x67368 ?x66680 ?x67621 ?x67160 ?x46312)))
 (let ((?x46199 (granule_data ?x63594)))
 (let ((?x45846 (gpt ?x63594)))
 (let ((?x53543 (priv ?x46529)))
 (let ((?x66333 (repl ?x46529)))
 (let ((?x46703 (oracle ?x46529)))
 (let ((?x46524 (log ?x46529)))
 (let ((?x47061 (mkRData ?x46524 ?x46703 ?x66333 ?x53543 (mkShared ?x45846 ?x46199 ?x75577) ?x45601 $x46046)))
 (let ((?x28498 (mkPtr "granules" ?x41306)))
 (let ((?x46941 (g_refcount_para.0_call ?x28498 ?x47061)))
 (= ?x46941 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x45740 (forall ((gidx.145602025 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x63594 (share ?x46529)))
 (let ((?x46199 (granule_data ?x63594)))
 (let ((?x46266 (select ?x46199 ?x45209)))
 (let ((?x46290 (mkr_granule_data (gd_g_idx ?x46266) (g_granule_state ?x46266) zero_granule_data (g_rd ?x46266) (g_rec ?x46266))))
 (let ((?x69110 (store ?x46199 ?x45209 ?x46290)))
 (let ((?x8591 (div ?x41306 16)))
 (let ((?x55610 (globals ?x63594)))
 (let ((?x44882 (g_granules ?x55610)))
 (let ((?x46211 (select ?x44882 ?x8591)))
 ...
 (let ((?x46234 (mku_anon_3 ?x46754)))
 (let ((?x67440 (e_lock ?x42500)))
 (let ((?x45676 (store ?x45179 ?x45209 (mks_granule ?x67440 1 ?x46234))))
 (=> (= (e_state_s_granule (select ?x45676 gidx.145602025)) 1) (= (g_norm (select ?x69110 gidx.145602025)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x45740)))
(check-sat)

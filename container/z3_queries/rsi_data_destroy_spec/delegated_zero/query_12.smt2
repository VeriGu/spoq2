...
(assert
 ...
 (= ?x27763 "granules")))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x15822 (forall ((gidx.145594295 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145594295)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let ((?x1041 (div ?x37067 16)))
 ...
 (let ((?x891 (mks_granule ?x39586 ?x896 ?x63587)))
 (let ((?x31584 (store ?x660 ?x1041 ?x891)))
 (=> (= (e_state_s_granule (select ?x31584 gidx.145594295)) 1) $x36159))))))))))))))))))))
 ))
 (not $x15822)))
(check-sat)

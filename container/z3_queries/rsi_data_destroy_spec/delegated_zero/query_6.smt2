...
(assert
 (forall ((gidx.145593181 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x65878 (store ?x27245 ?x27229 ?x1184)))
 (let ((?x27068 (g_granule_state ?x27544)))
 (let ((?x26948 (gd_g_idx ?x27544)))
 (let ((?x16762 (mkr_granule_data ?x26948 ?x27068 ?x65878 ?x27404 ?x27418)))
 (let ((?x17994 (store ?x21216 ?x50169 ?x16762)))
 (let ((?x17933 (gpt ?x1411)))
 (let ((?x27349 (priv ?x49427)))
 (let ((?x27136 (repl ?x49427)))
 (let ((?x27401 (oracle ?x49427)))
 (let ((?x17731 (log ?x49427)))
 (let ((?x27497 (query_oracle.0_call (mkRData ?x17731 ?x27401 ?x27136 ?x27349 (mkShared ?x17933 ?x17994 ?x17283) ?x27426 $x27334))))
 (let ((?x18192 (value_RData ?x27497)))
 (let ((?x27446 (share ?x18192)))
 (let ((?x17500 (granule_data ?x27446)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x27446)) gidx.145593181)) 1) (= (g_norm (select ?x17500 gidx.145593181)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x18192 (value_RData ?x27497)))
 (let ((?x27446 (share ?x18192)))
 (let ((?x27325 (globals ?x27446)))
 (let ((?x27749 (g_granules ?x27325)))
 (= ?x27749 ?x92421))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x27325 (globals ?x27446)))
 (let ((?x27749 (g_granules ?x27325)))
 (let ((?x67790 (select ?x27749 ?x1856)))
 (let ((?x33153 (e_lock ?x67790)))
 (let ((?x24114 (e_val ?x33153)))
 (= ?x24114 None_Z))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x27749 (g_granules ?x27325)))
 (let ((?x67790 (select ?x27749 ?x1856)))
 (let ((?x27693 (mks_granule ?x39586 (e_state_s_granule ?x67790) (e_ref ?x67790))))
 (let ((?x52724 (store ?x27749 ?x1856 ?x27693)))
 (let ((?x21317 (select ?x52724 ?x1580)))
 (let ((?x27079 (e_state_s_granule ?x21317)))
 (= ?x27079 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x27497 (query_oracle.0_call (mkRData ?x17731 ?x27401 ?x27136 ?x27349 (mkShared ?x17933 ?x17994 ?x17283) ?x27426 $x27334))))
 (let ((?x18192 (value_RData ?x27497)))
 (let (($x35561 (halt ?x18192)))
 (let ((?x22319 (stack ?x18192)))
 (let ((?x27446 (share ?x18192)))
 (let ((?x27325 (globals ?x27446)))
 (let ((?x27788 (g_realm_attest_private_key ?x27325)))
 (let ((?x27488 (g_get_realm_identity_identity ?x27325)))
 (let ((?x27142 (g_rmm_platform_token ?x27325)))
 (let ((?x27507 (g_platform_token_buf ?x27325)))
 (let ((?x27775 (g_rmm_attest_public_key_hash_len ?x27325)))
 (let ((?x17211 (g_rmm_attest_public_key_hash ?x27325)))
 (let ((?x27852 (g_rmm_attest_public_key_len ?x27325)))
 (let ((?x42260 (g_rmm_attest_public_key ?x27325)))
 (let ((?x66712 (g_rmm_attest_signing_key ?x27325)))
 (let ((?x20042 (mkPtr "granule_data" ?x49471)))
 (let ((?x57774 (abs_tte_read.0_call ?x20042 ?x49427)))
 (let ((?x67338 (meta_PA ?x57774)))
 (let ((?x50094 (meta_granule_offset ?x67338)))
 (let ((?x1580 (div ?x50094 4096)))
 (let ((?x27693 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x27325) (div ?x50094 16))) (e_ref (select (g_granules ?x27325) (div ?x50094 16))))))
 (let ((?x1856 (div ?x50094 16)))
 (let ((?x27749 (g_granules ?x27325)))
 (let ((?x52724 (store ?x27749 ?x1856 ?x27693)))
 (let ((?x21317 (select ?x52724 ?x1580)))
 (let ((?x27515 (e_ref ?x21317)))
 (let ((?x17254 (e_u_anon_3_0 ?x27515)))
 (let ((?x17649 (+ (- 1) ?x17254)))
 (let ((?x18136 (mku_anon_3 ?x17649)))
 (let ((?x27079 (e_state_s_granule ?x21317)))
 (let ((?x27554 (e_lock ?x21317)))
 (let ((?x27723 (mks_granule ?x27554 ?x27079 ?x18136)))
 (let ((?x27818 (store ?x52724 ?x1580 ?x27723)))
 (let ((?x19713 (g_mbedtls_mem_buf ?x27325)))
 (let ((?x27491 (g_tt_l1_upper ?x27325)))
 (let ((?x27529 (g_tt_l2_mem1_3 ?x27325)))
 (let ((?x27641 (g_tt_l2_mem1_2 ?x27325)))
 (let ((?x51645 (g_tt_l2_mem1_1 ?x27325)))
 (let ((?x16757 (g_tt_l2_mem1_0 ?x27325)))
 (let ((?x77341 (g_tt_l2_mem0_1 ?x27325)))
 (let ((?x23693 (g_tt_l2_mem0_0 ?x27325)))
 (let ((?x50213 (g_tt_l3_buffer ?x27325)))
 (let ((?x1679 (g_rmm_trap_list ?x27325)))
 (let ((?x17678 (g_status_handler ?x27325)))
 (let ((?x17078 (g_default_gicstate ?x27325)))
 (let ((?x68085 (g_pri_res0_mask ?x27325)))
 (let ((?x27803 (g_max_vintid ?x27325)))
 (let ((?x27618 (g_nr_aprs ?x27325)))
 (let ((?x27020 (g_nr_lrs ?x27325)))
 (let ((?x27126 (g_vmids ?x27325)))
 (let ((?x17980 (g_vmid_lock ?x27325)))
 (let ((?x27787 (g_vmid_count ?x27325)))
 (let ((?x17643 (g_debug_exits ?x27325)))
 (let ((?x27814 (g_heap ?x27325)))
 (let ((?x19816 (mkGLOBALS ?x27814 ?x17643 ?x27787 ?x17980 ?x27126 ?x27020 ?x27618 ?x27803 ?x68085 ?x17078 ?x17678 ?x1679 ?x50213 ?x23693 ?x77341 ?x16757 ?x51645 ?x27641 ?x27529 ?x27491 ?x19713 ?x27818 ?x66712 ?x42260 ?x27852 ?x17211 ?x27775 ?x27507 ?x27142 ?x27488 ?x27788)))
 (let ((?x17500 (granule_data ?x27446)))
 (let ((?x18278 (gpt ?x27446)))
 (let ((?x27816 (priv ?x18192)))
 (let ((?x27741 (repl ?x18192)))
 (let ((?x28030 (oracle ?x18192)))
 (let ((?x67818 (log ?x18192)))
 (let ((?x23112 (mkRData ?x67818 ?x28030 ?x27741 ?x27816 (mkShared ?x18278 ?x17500 ?x19816) ?x22319 $x35561)))
 (let ((?x27450 (mkPtr "granules" ?x50094)))
 (let ((?x33714 (g_refcount_para.0_call ?x27450 ?x23112)))
 (= ?x33714 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x36006 (forall ((gidx.145593639 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x27446 (share ?x18192)))
 (let ((?x17500 (granule_data ?x27446)))
 (let ((?x17680 (select ?x17500 ?x1580)))
 (let ((?x27744 (mkr_granule_data (gd_g_idx ?x17680) (g_granule_state ?x17680) zero_granule_data (g_rd ?x17680) (g_rec ?x17680))))
 (let ((?x27630 (store ?x17500 ?x1580 ?x27744)))
 (let ((?x1856 (div ?x50094 16)))
 (let ((?x27325 (globals ?x27446)))
 (let ((?x27749 (g_granules ?x27325)))
 (let ((?x67790 (select ?x27749 ?x1856)))
 ...
 (let ((?x18136 (mku_anon_3 ?x17649)))
 (let ((?x27554 (e_lock ?x21317)))
 (let ((?x18065 (store ?x52724 ?x1580 (mks_granule ?x27554 1 ?x18136))))
 (=> (= (e_state_s_granule (select ?x18065 gidx.145593639)) 1) (= (g_norm (select ?x27630 gidx.145593639)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36006)))
(check-sat)

...
(assert
 (forall ((gidx.145596484 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x27751 (store ?x41454 ?x22320 ?x27478)))
 (let ((?x32887 (g_granule_state ?x1032)))
 (let ((?x41194 (gd_g_idx ?x1032)))
 (let ((?x28515 (mkr_granule_data ?x41194 ?x32887 ?x27751 ?x17265 ?x18281)))
 (let ((?x40707 (store ?x32865 ?x75555 ?x28515)))
 (let ((?x29054 (gpt ?x18063)))
 (let ((?x17560 (priv ?x32241)))
 (let ((?x41378 (repl ?x32241)))
 (let ((?x41437 (oracle ?x32241)))
 (let ((?x32795 (log ?x32241)))
 (let ((?x40926 (query_oracle.0_call (mkRData ?x32795 ?x41437 ?x41378 ?x17560 (mkShared ?x29054 ?x40707 ?x40147) ?x27729 $x21481))))
 (let ((?x51669 (value_RData ?x40926)))
 (let ((?x18501 (share ?x51669)))
 (let ((?x34029 (granule_data ?x18501)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18501)) gidx.145596484)) 1) (= (g_norm (select ?x34029 gidx.145596484)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x51669 (value_RData ?x40926)))
 (let ((?x18501 (share ?x51669)))
 (let ((?x41890 (globals ?x18501)))
 (let ((?x18812 (g_granules ?x41890)))
 (= ?x18812 ?x32805))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x41890 (globals ?x18501)))
 (let ((?x18812 (g_granules ?x41890)))
 (let ((?x41143 (select ?x18812 ?x40238)))
 (let ((?x41150 (e_lock ?x41143)))
 (let ((?x51830 (e_val ?x41150)))
 (= ?x51830 None_Z))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x18812 (g_granules ?x41890)))
 (let ((?x41143 (select ?x18812 ?x40238)))
 (let ((?x32696 (mks_granule ?x39586 (e_state_s_granule ?x41143) (e_ref ?x41143))))
 (let ((?x41077 (store ?x18812 ?x40238 ?x32696)))
 (let ((?x1991 (select ?x41077 ?x40803)))
 (let ((?x36119 (e_state_s_granule ?x1991)))
 (= ?x36119 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x40926 (query_oracle.0_call (mkRData ?x32795 ?x41437 ?x41378 ?x17560 (mkShared ?x29054 ?x40707 ?x40147) ?x27729 $x21481))))
 (let ((?x51669 (value_RData ?x40926)))
 (let (($x33806 (halt ?x51669)))
 (let ((?x41576 (stack ?x51669)))
 (let ((?x18501 (share ?x51669)))
 (let ((?x41890 (globals ?x18501)))
 (let ((?x33036 (g_realm_attest_private_key ?x41890)))
 (let ((?x32670 (g_get_realm_identity_identity ?x41890)))
 (let ((?x40604 (g_rmm_platform_token ?x41890)))
 (let ((?x33470 (g_platform_token_buf ?x41890)))
 (let ((?x33634 (g_rmm_attest_public_key_hash_len ?x41890)))
 (let ((?x41320 (g_rmm_attest_public_key_hash ?x41890)))
 (let ((?x41898 (g_rmm_attest_public_key_len ?x41890)))
 (let ((?x40567 (g_rmm_attest_public_key ?x41890)))
 (let ((?x39287 (g_rmm_attest_signing_key ?x41890)))
 (let ((?x72238 (mkPtr "granule_data" ?x41424)))
 (let ((?x40966 (abs_tte_read.0_call ?x72238 ?x32241)))
 (let ((?x41397 (meta_PA ?x40966)))
 (let ((?x40857 (meta_granule_offset ?x41397)))
 (let ((?x40803 (div ?x40857 4096)))
 (let ((?x32696 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x41890) (div ?x40857 16))) (e_ref (select (g_granules ?x41890) (div ?x40857 16))))))
 (let ((?x40238 (div ?x40857 16)))
 (let ((?x18812 (g_granules ?x41890)))
 (let ((?x41077 (store ?x18812 ?x40238 ?x32696)))
 (let ((?x1991 (select ?x41077 ?x40803)))
 (let ((?x32557 (e_ref ?x1991)))
 (let ((?x72875 (e_u_anon_3_0 ?x32557)))
 (let ((?x34111 (+ (- 1) ?x72875)))
 (let ((?x33740 (mku_anon_3 ?x34111)))
 (let ((?x36119 (e_state_s_granule ?x1991)))
 (let ((?x72611 (e_lock ?x1991)))
 (let ((?x42423 (mks_granule ?x72611 ?x36119 ?x33740)))
 (let ((?x41229 (store ?x41077 ?x40803 ?x42423)))
 (let ((?x32783 (g_mbedtls_mem_buf ?x41890)))
 (let ((?x17815 (g_tt_l1_upper ?x41890)))
 (let ((?x40884 (g_tt_l2_mem1_3 ?x41890)))
 (let ((?x41270 (g_tt_l2_mem1_2 ?x41890)))
 (let ((?x40888 (g_tt_l2_mem1_1 ?x41890)))
 (let ((?x32078 (g_tt_l2_mem1_0 ?x41890)))
 (let ((?x33541 (g_tt_l2_mem0_1 ?x41890)))
 (let ((?x41806 (g_tt_l2_mem0_0 ?x41890)))
 (let ((?x63144 (g_tt_l3_buffer ?x41890)))
 (let ((?x41225 (g_rmm_trap_list ?x41890)))
 (let ((?x41337 (g_status_handler ?x41890)))
 (let ((?x32811 (g_default_gicstate ?x41890)))
 (let ((?x42036 (g_pri_res0_mask ?x41890)))
 (let ((?x42232 (g_max_vintid ?x41890)))
 (let ((?x42564 (g_nr_aprs ?x41890)))
 (let ((?x40818 (g_nr_lrs ?x41890)))
 (let ((?x17974 (g_vmids ?x41890)))
 (let ((?x28729 (g_vmid_lock ?x41890)))
 (let ((?x33319 (g_vmid_count ?x41890)))
 (let ((?x33434 (g_debug_exits ?x41890)))
 (let ((?x41300 (g_heap ?x41890)))
 (let ((?x46078 (mkGLOBALS ?x41300 ?x33434 ?x33319 ?x28729 ?x17974 ?x40818 ?x42564 ?x42232 ?x42036 ?x32811 ?x41337 ?x41225 ?x63144 ?x41806 ?x33541 ?x32078 ?x40888 ?x41270 ?x40884 ?x17815 ?x32783 ?x41229 ?x39287 ?x40567 ?x41898 ?x41320 ?x33634 ?x33470 ?x40604 ?x32670 ?x33036)))
 (let ((?x34029 (granule_data ?x18501)))
 (let ((?x32508 (gpt ?x18501)))
 (let ((?x41547 (priv ?x51669)))
 (let ((?x42484 (repl ?x51669)))
 (let ((?x41872 (oracle ?x51669)))
 (let ((?x41429 (log ?x51669)))
 (let ((?x30669 (mkRData ?x41429 ?x41872 ?x42484 ?x41547 (mkShared ?x32508 ?x34029 ?x46078) ?x41576 $x33806)))
 (let ((?x40305 (mkPtr "granules" ?x40857)))
 (let ((?x24615 (g_refcount_para.0_call ?x40305 ?x30669)))
 (= ?x24615 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x45586 (forall ((gidx.145596942 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18501 (share ?x51669)))
 (let ((?x34029 (granule_data ?x18501)))
 (let ((?x41013 (select ?x34029 ?x40803)))
 (let ((?x30796 (mkr_granule_data (gd_g_idx ?x41013) (g_granule_state ?x41013) zero_granule_data (g_rd ?x41013) (g_rec ?x41013))))
 (let ((?x40994 (store ?x34029 ?x40803 ?x30796)))
 (let ((?x40238 (div ?x40857 16)))
 (let ((?x41890 (globals ?x18501)))
 (let ((?x18812 (g_granules ?x41890)))
 (let ((?x41143 (select ?x18812 ?x40238)))
 ...
 (let ((?x33740 (mku_anon_3 ?x34111)))
 (let ((?x72611 (e_lock ?x1991)))
 (let ((?x32910 (store ?x41077 ?x40803 (mks_granule ?x72611 1 ?x33740))))
 (=> (= (e_state_s_granule (select ?x32910 gidx.145596942)) 1) (= (g_norm (select ?x40994 gidx.145596942)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x45586)))
(check-sat)

...
(assert
 (forall ((gidx.145598488 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18488)) gidx.145598488)) 1) (= (g_norm (select ?x66748 gidx.145598488)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x68451 (select ?x62525 ?x40359)))
 (let ((?x71956 (e_state_s_granule ?x68451)))
 (= ?x71956 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x31685 (meta_desc_type ?x28546)))
 (let (($x30131 (= ?x31685 3)))
 (not $x30131))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x26939 (meta_mem_attr ?x28546)))
 (let (($x28917 (= ?x26939 1)))
 (let ((?x71717 (meta_ripas ?x28546)))
 (let (($x26397 (= ?x71717 0)))
 (let ((?x31685 (meta_desc_type ?x28546)))
 (let (($x65745 (= ?x31685 0)))
 (and $x65745 $x26397 $x28917))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 ...
 (let ((?x31933 (mod ?x45585 4096)))
 (let (($x26658 (= ?x31933 0)))
 (let ((?x42740 (pbase ?x39407)))
 (let (($x41220 (= ?x42740 "granules")))
 (and $x41220 $x26658 $x30036)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x26565 (forall ((gidx.145599452 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x30048 (= (e_state_s_granule (select ?x66896 gidx.145599452)) 1)))
 (=> $x30048 (= (g_norm (select ?x66346 gidx.145599452)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x26565)))
(check-sat)

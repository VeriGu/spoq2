...
(assert
 (forall ((gidx.145595407 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x23239 (mks_granule ?x39586 ?x68117 ?x17692)))
 (let ((?x27683 (store ?x66588 ?x27397 ?x23239)))
 ...
 (let ((?x27421 (mkGLOBALS ?x17377 ?x27772 ?x17663 ?x27924 ?x27501 ?x27524 ?x17385 ?x27659 ?x26995 ?x17827 ?x22920 ?x27882 ?x18965 ?x67197 ?x27711 ?x27672 ?x27390 ?x27629 ?x27918 ?x18330 ?x18496 ?x27683 ?x27725 ?x16965 ?x16800 ?x23681 ?x17368 ?x27257 ?x17367 ?x17944 ?x63542)))
 ...
 (let ((?x17908 (mkRData ?x26198 ?x27800 ?x27748 ?x18951 (mkShared ?x27829 ?x27608 ?x27421) ?x17880 $x27091)))
 (let ((?x23371 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x28737 (rtt_walk_lock_unlock_spec_abs.0_call ?x23371 ?x25339 0 64 v_1.0 3 ?x17908)))
 (let ((?x27613 (value_Tuple_abs_ret_rtt_RData ?x28737)))
 (let ((?x17595 (elem_1 ?x27613)))
 (let (($x33495 (halt ?x17595)))
 (let ((?x33237 (stack ?x17595)))
 (let ((?x21990 (elem_0 ?x27613)))
 (let ((?x21831 (e_2 ?x21990)))
 (let ((?x17590 (poffset ?x21831)))
 (let ((?x63111 (div ?x17590 4096)))
 (let ((?x16853 (share ?x17595)))
 (let ((?x16789 (globals ?x16853)))
 (let ((?x17644 (g_granules ?x16789)))
 (let ((?x40905 (select ?x17644 ?x63111)))
 (let ((?x40664 (e_ref ?x40905)))
 (let ((?x40002 (e_u_anon_3_0 ?x40664)))
 (let ((?x40663 (+ (- 1) ?x40002)))
 (let ((?x30006 (mku_anon_3 ?x40663)))
 (let ((?x32770 (mks_granule (e_lock ?x40905) (e_state_s_granule ?x40905) ?x30006)))
 (let ((?x40334 (store ?x17644 ?x63111 ?x32770)))
 (let ((?x48621 (mkGLOBALS (g_heap ?x16789) (g_debug_exits ?x16789) (g_vmid_count ?x16789) (g_vmid_lock ?x16789) (g_vmids ?x16789) (g_nr_lrs ?x16789) (g_nr_aprs ?x16789) (g_max_vintid ?x16789) (g_pri_res0_mask ?x16789) (g_default_gicstate ?x16789) (g_status_handler ?x16789) (g_rmm_trap_list ?x16789) (g_tt_l3_buffer ?x16789) (g_tt_l2_mem0_0 ?x16789) (g_tt_l2_mem0_1 ?x16789) (g_tt_l2_mem1_0 ?x16789) (g_tt_l2_mem1_1 ?x16789) (g_tt_l2_mem1_2 ?x16789) (g_tt_l2_mem1_3 ?x16789) (g_tt_l1_upper ?x16789) (g_mbedtls_mem_buf ?x16789) ?x40334 (g_rmm_attest_signing_key ?x16789) (g_rmm_attest_public_key ?x16789) (g_rmm_attest_public_key_len ?x16789) (g_rmm_attest_public_key_hash ?x16789) (g_rmm_attest_public_key_hash_len ?x16789) (g_platform_token_buf ?x16789) (g_rmm_platform_token ?x16789) (g_get_realm_identity_identity ?x16789) (g_realm_attest_private_key ?x16789))))
 (let ((?x27582 (e_3 ?x21990)))
 (let ((?x67033 (* 8 ?x27582)))
 (let ((?x27793 (+ ?x17590 ?x67033)))
 (let ((?x17930 (div ?x27793 4096)))
 (let ((?x40979 (granule_data ?x16853)))
 (let ((?x33397 (select ?x40979 ?x17930)))
 (let ((?x33497 (g_rec ?x33397)))
 (let ((?x32458 (g_rd ?x33397)))
 (let ((?x68542 (mkabs_PA_t (- 1))))
 (let ((?x1375 (mkabs_PTE_t ?x68542 0 0 0)))
 (let ((?x1184 (test_PTE_Z.0_call ?x1375)))
 (let ((?x16160 (mod ?x27793 4096)))
 (let ((?x28590 (g_norm ?x33397)))
 (let ((?x72700 (store ?x28590 ?x16160 ?x1184)))
 (let ((?x40735 (g_granule_state ?x33397)))
 (let ((?x17069 (gd_g_idx ?x33397)))
 (let ((?x68078 (mkr_granule_data ?x17069 ?x40735 ?x72700 ?x32458 ?x33497)))
 (let ((?x40617 (store ?x40979 ?x17930 ?x68078)))
 (let ((?x41304 (gpt ?x16853)))
 (let ((?x33464 (priv ?x17595)))
 (let ((?x40806 (repl ?x17595)))
 (let ((?x40634 (oracle ?x17595)))
 (let ((?x40578 (log ?x17595)))
 (let ((?x41004 (query_oracle.0_call (mkRData ?x40578 ?x40634 ?x40806 ?x33464 (mkShared ?x41304 ?x40617 ?x48621) ?x33237 $x33495))))
 (let ((?x40195 (value_RData ?x41004)))
 (let ((?x40985 (share ?x40195)))
 (let ((?x27655 (granule_data ?x40985)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x40985)) gidx.145595407)) 1) (= (g_norm (select ?x27655 gidx.145595407)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x40195 (value_RData ?x41004)))
 (let ((?x40985 (share ?x40195)))
 (let ((?x32705 (globals ?x40985)))
 (let ((?x33671 (g_granules ?x32705)))
 (= ?x33671 ?x40334)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x17590 (poffset ?x21831)))
 (let ((?x27793 (+ ?x17590 ?x67033)))
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x54153 (meta_PA ?x40903)))
 (let ((?x40676 (meta_granule_offset ?x54153)))
 (let ((?x40769 (div ?x40676 16)))
 (let (($x33495 (halt ?x17595)))
 (let ((?x33237 (stack ?x17595)))
 (let ((?x63111 (div ?x17590 4096)))
 (let ((?x16853 (share ?x17595)))
 ...
 (let ((?x32705 (globals ?x40985)))
 (let ((?x33671 (g_granules ?x32705)))
 (let ((?x20359 (select ?x33671 ?x40769)))
 (let ((?x40817 (e_lock ?x20359)))
 (let ((?x39510 (e_val ?x40817)))
 (= ?x39510 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x33671 (g_granules ?x32705)))
 (let ((?x20359 (select ?x33671 ?x40769)))
 (let ((?x33659 (mks_granule ?x39586 (e_state_s_granule ?x20359) (e_ref ?x20359))))
 (let ((?x63523 (store ?x33671 ?x40769 ?x33659)))
 (let ((?x1702 (select ?x63523 ?x41067)))
 (let ((?x41120 (e_state_s_granule ?x1702)))
 (= ?x41120 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x41004 (query_oracle.0_call (mkRData ?x40578 ?x40634 ?x40806 ?x33464 (mkShared ?x41304 ?x40617 ?x48621) ?x33237 $x33495))))
 (let ((?x40195 (value_RData ?x41004)))
 (let (($x32987 (halt ?x40195)))
 (let ((?x33037 (stack ?x40195)))
 (let ((?x40985 (share ?x40195)))
 (let ((?x32705 (globals ?x40985)))
 (let ((?x17373 (g_realm_attest_private_key ?x32705)))
 (let ((?x21617 (g_get_realm_identity_identity ?x32705)))
 (let ((?x33428 (g_rmm_platform_token ?x32705)))
 (let ((?x66624 (g_platform_token_buf ?x32705)))
 (let ((?x32583 (g_rmm_attest_public_key_hash_len ?x32705)))
 (let ((?x40306 (g_rmm_attest_public_key_hash ?x32705)))
 (let ((?x40870 (g_rmm_attest_public_key_len ?x32705)))
 (let ((?x32674 (g_rmm_attest_public_key ?x32705)))
 (let ((?x108061 (g_rmm_attest_signing_key ?x32705)))
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x54153 (meta_PA ?x40903)))
 (let ((?x40676 (meta_granule_offset ?x54153)))
 (let ((?x41067 (div ?x40676 4096)))
 (let ((?x33659 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x32705) (div ?x40676 16))) (e_ref (select (g_granules ?x32705) (div ?x40676 16))))))
 (let ((?x40769 (div ?x40676 16)))
 (let ((?x33671 (g_granules ?x32705)))
 (let ((?x63523 (store ?x33671 ?x40769 ?x33659)))
 (let ((?x1702 (select ?x63523 ?x41067)))
 (let ((?x41186 (e_ref ?x1702)))
 (let ((?x41073 (e_u_anon_3_0 ?x41186)))
 (let ((?x32821 (+ (- 1) ?x41073)))
 (let ((?x41152 (mku_anon_3 ?x32821)))
 (let ((?x41120 (e_state_s_granule ?x1702)))
 (let ((?x40743 (e_lock ?x1702)))
 (let ((?x41195 (mks_granule ?x40743 ?x41120 ?x41152)))
 (let ((?x40967 (store ?x63523 ?x41067 ?x41195)))
 (let ((?x18934 (g_mbedtls_mem_buf ?x32705)))
 (let ((?x17981 (g_tt_l1_upper ?x32705)))
 (let ((?x22916 (g_tt_l2_mem1_3 ?x32705)))
 (let ((?x40785 (g_tt_l2_mem1_2 ?x32705)))
 (let ((?x21405 (g_tt_l2_mem1_1 ?x32705)))
 (let ((?x41369 (g_tt_l2_mem1_0 ?x32705)))
 (let ((?x40468 (g_tt_l2_mem0_1 ?x32705)))
 (let ((?x40777 (g_tt_l2_mem0_0 ?x32705)))
 (let ((?x61961 (g_tt_l3_buffer ?x32705)))
 (let ((?x40768 (g_rmm_trap_list ?x32705)))
 (let ((?x33065 (g_status_handler ?x32705)))
 (let ((?x32526 (g_default_gicstate ?x32705)))
 (let ((?x33173 (g_pri_res0_mask ?x32705)))
 (let ((?x32387 (g_max_vintid ?x32705)))
 (let ((?x40894 (g_nr_aprs ?x32705)))
 (let ((?x33017 (g_nr_lrs ?x32705)))
 (let ((?x32637 (g_vmids ?x32705)))
 (let ((?x33176 (g_vmid_lock ?x32705)))
 (let ((?x27684 (g_vmid_count ?x32705)))
 (let ((?x41063 (g_debug_exits ?x32705)))
 (let ((?x53199 (g_heap ?x32705)))
 (let ((?x30789 (mkGLOBALS ?x53199 ?x41063 ?x27684 ?x33176 ?x32637 ?x33017 ?x40894 ?x32387 ?x33173 ?x32526 ?x33065 ?x40768 ?x61961 ?x40777 ?x40468 ?x41369 ?x21405 ?x40785 ?x22916 ?x17981 ?x18934 ?x40967 ?x108061 ?x32674 ?x40870 ?x40306 ?x32583 ?x66624 ?x33428 ?x21617 ?x17373)))
 (let ((?x27655 (granule_data ?x40985)))
 (let ((?x40537 (gpt ?x40985)))
 (let ((?x41170 (priv ?x40195)))
 (let ((?x40579 (repl ?x40195)))
 (let ((?x40312 (oracle ?x40195)))
 (let ((?x32776 (log ?x40195)))
 (let ((?x40691 (mkRData ?x32776 ?x40312 ?x40579 ?x41170 (mkShared ?x40537 ?x27655 ?x30789) ?x33037 $x32987)))
 (let ((?x40931 (mkPtr "granules" ?x40676)))
 (let ((?x39167 (g_refcount_para.0_call ?x40931 ?x40691)))
 (= ?x39167 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x36500 (forall ((gidx.145595865 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x40985 (share ?x40195)))
 (let ((?x27655 (granule_data ?x40985)))
 (let ((?x32382 (select ?x27655 ?x41067)))
 (let ((?x41155 (mkr_granule_data (gd_g_idx ?x32382) (g_granule_state ?x32382) zero_granule_data (g_rd ?x32382) (g_rec ?x32382))))
 (let ((?x33593 (store ?x27655 ?x41067 ?x41155)))
 (let ((?x40769 (div ?x40676 16)))
 (let ((?x32705 (globals ?x40985)))
 (let ((?x33671 (g_granules ?x32705)))
 (let ((?x20359 (select ?x33671 ?x40769)))
 ...
 (let ((?x41152 (mku_anon_3 ?x32821)))
 (let ((?x40743 (e_lock ?x1702)))
 (let ((?x33501 (store ?x63523 ?x41067 (mks_granule ?x40743 1 ?x41152))))
 (=> (= (e_state_s_granule (select ?x33501 gidx.145595865)) 1) (= (g_norm (select ?x33593 gidx.145595865)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36500)))
(check-sat)

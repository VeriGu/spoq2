...
(assert
 ...
 (let ((?x77630 (meta_desc_type ?x40966)))
 (let (($x16969 (= ?x77630 0)))
 (let (($x46662 (and $x16969 $x31554 $x28021)))
 (not $x46662))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x35203 (forall ((gidx.145598302 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18063 (share ?x32241)))
 (let ((?x32865 (granule_data ?x18063)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18063)) gidx.145598302)) 1) (= (g_norm (select ?x32865 gidx.145598302)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x35203)))
(check-sat)

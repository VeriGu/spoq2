...
(assert
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x33971)) gidx.145597411)) 1) (= (g_norm (select ?x32392 gidx.145597411)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (= ?x41263 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x39833 (forall ((gidx.145597869 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x33971 (share ?x17910)))
 (let ((?x32392 (granule_data ?x33971)))
 (let ((?x41091 (select ?x32392 ?x40803)))
 (let ((?x33698 (mkr_granule_data (gd_g_idx ?x41091) (g_granule_state ?x41091) zero_granule_data (g_rd ?x41091) (g_rec ?x41091))))
 (let ((?x41904 (store ?x32392 ?x40803 ?x33698)))
 (let ((?x40238 (div ?x40857 16)))
 (let ((?x62944 (globals ?x33971)))
 (let ((?x33055 (g_granules ?x62944)))
 (let ((?x41796 (select ?x33055 ?x40238)))
 ...
 (let ((?x42053 (mku_anon_3 ?x41144)))
 (let ((?x32830 (e_lock ?x26263)))
 (let ((?x42452 (store ?x17346 ?x40803 (mks_granule ?x32830 1 ?x42053))))
 (=> (= (e_state_s_granule (select ?x42452 gidx.145597869)) 1) (= (g_norm (select ?x41904 gidx.145597869)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39833)))
(check-sat)

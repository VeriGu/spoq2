...
(assert
 ...
 (let ((?x67327 (meta_desc_type ?x45099)))
 (let (($x41101 (= ?x67327 0)))
 (let (($x27576 (and $x41101 $x54752 $x41151)))
 (not $x27576)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x33342 (forall ((gidx.145602458 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x28872 (share ?x45709)))
 (let ((?x45553 (granule_data ?x28872)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x28872)) gidx.145602458)) 1) (= (g_norm (select ?x45553 gidx.145602458)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x33342)))
(check-sat)

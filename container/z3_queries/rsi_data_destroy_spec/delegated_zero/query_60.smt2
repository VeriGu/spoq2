...
(assert
 ...
 (not $x27607)))))))))))))))))))))
(assert
 (let (($x26107 (forall ((gidx.145604574 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145604574)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let ((?x1041 (div ?x37067 16)))
 ...
 (let ((?x49459 (mks_granule ?x47373 ?x896 ?x63587)))
 (let ((?x1922 (store ?x660 ?x1041 ?x49459)))
 (=> (= (e_state_s_granule (select ?x1922 gidx.145604574)) 1) $x36159)))))))))))))))))))
 ))
 (not $x26107)))
(check-sat)

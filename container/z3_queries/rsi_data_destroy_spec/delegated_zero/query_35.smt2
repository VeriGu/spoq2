...
(assert
 ...
 (let (($x45165 (= (g_norm (select ?x63374 gidx.145598562)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x41129)) gidx.145598562)) 1) $x45165)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x26290)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x36760 (forall ((gidx.145599415 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x41129 (share ?x63883)))
 (let ((?x63374 (granule_data ?x41129)))
 (let (($x45165 (= (g_norm (select ?x63374 gidx.145599415)) zero_granule_data)))
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x64460 (meta_PA ?x28546)))
 (let ((?x37119 (meta_granule_offset ?x64460)))
 ...
 (let ((?x36882 (mks_granule ?x45716 ?x27487 ?x27873)))
 (let ((?x63137 (store ?x67432 ?x28794 ?x36882)))
 (=> (= (e_state_s_granule (select ?x63137 gidx.145599415)) 1) $x45165)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36760)))
(check-sat)

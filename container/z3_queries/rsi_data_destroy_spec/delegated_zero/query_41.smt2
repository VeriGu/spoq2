...
(assert
 (forall ((gidx.145598414 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x28018 (select ?x27608 gidx.145598414)))
 (let (($x21700 (= (g_norm ?x28018) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x66777)) gidx.145598414)) 1) $x21700))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
...
(assert
 ...
 (let ((?x17934 (globals ?x66777)))
 (let ((?x66588 (g_granules ?x17934)))
 (let ((?x27614 (select ?x66588 ?x17123)))
 (let ((?x27753 (e_state_s_granule ?x27614)))
 (let (($x17006 (= ?x27753 5)))
 (not $x17006))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x36852 (forall ((gidx.145600455 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x66777 (share ?x51317)))
 (let ((?x27608 (granule_data ?x66777)))
 (let ((?x28018 (select ?x27608 gidx.145600455)))
 (let (($x21700 (= (g_norm ?x28018) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x66777)) gidx.145600455)) 1) $x21700))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36852)))
(check-sat)

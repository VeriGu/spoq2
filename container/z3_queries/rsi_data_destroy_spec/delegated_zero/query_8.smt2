...
(assert
 ...
 (let ((?x45886 (meta_desc_type ?x57774)))
 (let (($x36773 (= ?x45886 0)))
 (let (($x35052 (and $x36773 $x45887 $x27374)))
 (not $x35052))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x68760 (forall ((gidx.145594072 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x1411 (share ?x49427)))
 (let ((?x21216 (granule_data ?x1411)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x1411)) gidx.145594072)) 1) (= (g_norm (select ?x21216 gidx.145594072)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x68760)))
(check-sat)

...
(assert
 (forall ((gidx.145594332 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x28018 (select ?x27608 gidx.145594332)))
 (let (($x21700 (= (g_norm ?x28018) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x66777)) gidx.145594332)) 1) $x21700))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
...
(assert
 ...
 (let ((?x27778 (e_lock ?x36975)))
 (let ((?x17750 (e_val ?x27778)))
 (= ?x17750 None_Z))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x27512 (select ?x27683 ?x17123)))
 (let ((?x26676 (e_state_s_granule ?x27512)))
 (let (($x16253 (= ?x26676 5)))
 (not $x16253))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x39574 (forall ((gidx.145596373 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x66777 (share ?x51317)))
 (let ((?x27608 (granule_data ?x66777)))
 (let ((?x28018 (select ?x27608 gidx.145596373)))
 (let (($x21700 (= (g_norm ?x28018) zero_granule_data)))
 (let ((?x1542 (mkPtr "granule_data" ?x37067)))
 (let ((?x25339 (rec_to_ttbr1_para.0_call ?x1542 ?x883)))
 (let ((?x32010 (poffset ?x25339)))
 ...
 (=> (= (e_state_s_granule (select ?x17014 gidx.145596373)) 1) $x21700))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39574)))
(check-sat)

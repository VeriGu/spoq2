...
(assert
 (forall ((gidx.145594480 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x17899 (store ?x28590 ?x16160 ?x27478)))
 (let ((?x40735 (g_granule_state ?x33397)))
 (let ((?x17069 (gd_g_idx ?x33397)))
 (let ((?x42405 (mkr_granule_data ?x17069 ?x40735 ?x17899 ?x32458 ?x33497)))
 (let ((?x17648 (store ?x40979 ?x17930 ?x42405)))
 (let ((?x41304 (gpt ?x16853)))
 (let ((?x33464 (priv ?x17595)))
 (let ((?x40806 (repl ?x17595)))
 (let ((?x40634 (oracle ?x17595)))
 (let ((?x40578 (log ?x17595)))
 (let ((?x33331 (query_oracle.0_call (mkRData ?x40578 ?x40634 ?x40806 ?x33464 (mkShared ?x41304 ?x17648 ?x48621) ?x33237 $x33495))))
 (let ((?x32547 (value_RData ?x33331)))
 (let ((?x32710 (share ?x32547)))
 (let ((?x49316 (granule_data ?x32710)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x32710)) gidx.145594480)) 1) (= (g_norm (select ?x49316 gidx.145594480)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x32547 (value_RData ?x33331)))
 (let ((?x32710 (share ?x32547)))
 (let ((?x24398 (globals ?x32710)))
 (let ((?x32889 (g_granules ?x24398)))
 (= ?x32889 ?x40334)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x24398 (globals ?x32710)))
 (let ((?x32889 (g_granules ?x24398)))
 (let ((?x39327 (select ?x32889 ?x40769)))
 (let ((?x16863 (e_lock ?x39327)))
 (let ((?x40758 (e_val ?x16863)))
 (= ?x40758 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x32889 (g_granules ?x24398)))
 (let ((?x39327 (select ?x32889 ?x40769)))
 (let ((?x67966 (e_state_s_granule ?x39327)))
 (let ((?x33467 (mks_granule ?x39586 ?x67966 (e_ref ?x39327))))
 (let ((?x33588 (store ?x32889 ?x40769 ?x33467)))
 (let ((?x23818 (select ?x33588 ?x41067)))
 (let ((?x33744 (e_state_s_granule ?x23818)))
 (= ?x33744 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x33331 (query_oracle.0_call (mkRData ?x40578 ?x40634 ?x40806 ?x33464 (mkShared ?x41304 ?x17648 ?x48621) ?x33237 $x33495))))
 (let ((?x32547 (value_RData ?x33331)))
 (let (($x33662 (halt ?x32547)))
 (let ((?x40668 (stack ?x32547)))
 (let ((?x32710 (share ?x32547)))
 (let ((?x24398 (globals ?x32710)))
 (let ((?x33509 (g_realm_attest_private_key ?x24398)))
 (let ((?x40793 (g_get_realm_identity_identity ?x24398)))
 (let ((?x40941 (g_rmm_platform_token ?x24398)))
 (let ((?x41163 (g_platform_token_buf ?x24398)))
 (let ((?x40674 (g_rmm_attest_public_key_hash_len ?x24398)))
 (let ((?x40921 (g_rmm_attest_public_key_hash ?x24398)))
 (let ((?x42127 (g_rmm_attest_public_key_len ?x24398)))
 (let ((?x27767 (g_rmm_attest_public_key ?x24398)))
 (let ((?x49151 (g_rmm_attest_signing_key ?x24398)))
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x54153 (meta_PA ?x40903)))
 (let ((?x40676 (meta_granule_offset ?x54153)))
 ...
 (let ((?x33588 (store ?x32889 ?x40769 ?x33467)))
 (let ((?x23818 (select ?x33588 ?x41067)))
 (let ((?x80723 (e_ref ?x23818)))
 (let ((?x40860 (e_u_anon_3_0 ?x80723)))
 (let ((?x27750 (+ (- 1) ?x40860)))
 (let ((?x32929 (mku_anon_3 ?x27750)))
 (let ((?x33744 (e_state_s_granule ?x23818)))
 (let ((?x31996 (e_lock ?x23818)))
 (let ((?x33880 (mks_granule ?x31996 ?x33744 ?x32929)))
 (let ((?x24994 (store ?x33588 ?x41067 ?x33880)))
 (let ((?x27482 (g_mbedtls_mem_buf ?x24398)))
 (let ((?x49258 (g_tt_l1_upper ?x24398)))
 (let ((?x27675 (g_tt_l2_mem1_3 ?x24398)))
 (let ((?x1909 (g_tt_l2_mem1_2 ?x24398)))
 (let ((?x1709 (g_tt_l2_mem1_1 ?x24398)))
 (let ((?x40789 (g_tt_l2_mem1_0 ?x24398)))
 (let ((?x40980 (g_tt_l2_mem0_1 ?x24398)))
 (let ((?x27006 (g_tt_l2_mem0_0 ?x24398)))
 (let ((?x67585 (g_tt_l3_buffer ?x24398)))
 (let ((?x40605 (g_rmm_trap_list ?x24398)))
 (let ((?x41028 (g_status_handler ?x24398)))
 (let ((?x40959 (g_default_gicstate ?x24398)))
 (let ((?x28807 (g_pri_res0_mask ?x24398)))
 (let ((?x33487 (g_max_vintid ?x24398)))
 (let ((?x41128 (g_nr_aprs ?x24398)))
 (let ((?x33425 (g_nr_lrs ?x24398)))
 (let ((?x33791 (g_vmids ?x24398)))
 (let ((?x33778 (g_vmid_lock ?x24398)))
 (let ((?x49291 (g_vmid_count ?x24398)))
 (let ((?x27028 (g_debug_exits ?x24398)))
 (let ((?x41250 (g_heap ?x24398)))
 (let ((?x40992 (mkGLOBALS ?x41250 ?x27028 ?x49291 ?x33778 ?x33791 ?x33425 ?x41128 ?x33487 ?x28807 ?x40959 ?x41028 ?x40605 ?x67585 ?x27006 ?x40980 ?x40789 ?x1709 ?x1909 ?x27675 ?x49258 ?x27482 ?x24994 ?x49151 ?x27767 ?x42127 ?x40921 ?x40674 ?x41163 ?x40941 ?x40793 ?x33509)))
 (let ((?x49316 (granule_data ?x32710)))
 (let ((?x33099 (gpt ?x32710)))
 (let ((?x40972 (priv ?x32547)))
 (let ((?x40942 (repl ?x32547)))
 (let ((?x40807 (oracle ?x32547)))
 (let ((?x40788 (log ?x32547)))
 (let ((?x41181 (mkRData ?x40788 ?x40807 ?x40942 ?x40972 (mkShared ?x33099 ?x49316 ?x40992) ?x40668 $x33662)))
 (let ((?x40931 (mkPtr "granules" ?x40676)))
 (let ((?x40878 (g_refcount_para.0_call ?x40931 ?x41181)))
 (= ?x40878 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x66660 (forall ((gidx.145594938 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x32710 (share ?x32547)))
 (let ((?x49316 (granule_data ?x32710)))
 (let ((?x29252 (select ?x49316 ?x41067)))
 (let ((?x33030 (mkr_granule_data (gd_g_idx ?x29252) (g_granule_state ?x29252) zero_granule_data (g_rd ?x29252) (g_rec ?x29252))))
 (let ((?x40714 (store ?x49316 ?x41067 ?x33030)))
 (let ((?x40769 (div ?x40676 16)))
 (let ((?x24398 (globals ?x32710)))
 (let ((?x32889 (g_granules ?x24398)))
 (let ((?x39327 (select ?x32889 ?x40769)))
 ...
 (let ((?x32929 (mku_anon_3 ?x27750)))
 (let ((?x31996 (e_lock ?x23818)))
 (let ((?x40890 (store ?x33588 ?x41067 (mks_granule ?x31996 1 ?x32929))))
 (=> (= (e_state_s_granule (select ?x40890 gidx.145594938)) 1) (= (g_norm (select ?x40714 gidx.145594938)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x66660)))
(check-sat)

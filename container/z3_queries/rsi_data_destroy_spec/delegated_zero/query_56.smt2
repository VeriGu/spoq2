...
(assert
 (forall ((gidx.145603571 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x28194 (store ?x32399 ?x64423 ?x1184)))
 (let ((?x41140 (g_granule_state ?x41906)))
 (let ((?x26485 (gd_g_idx ?x41906)))
 (let ((?x27912 (mkr_granule_data ?x26485 ?x41140 ?x28194 ?x41395 ?x30757)))
 (let ((?x66346 (store ?x66748 ?x40359 ?x27912)))
 (let ((?x27981 (gpt ?x18488)))
 (let ((?x42478 (priv ?x40511)))
 (let ((?x22800 (repl ?x40511)))
 (let ((?x32898 (oracle ?x40511)))
 (let ((?x28638 (log ?x40511)))
 (let ((?x63370 (query_oracle.0_call (mkRData ?x28638 ?x32898 ?x22800 ?x42478 (mkShared ?x27981 ?x66346 ?x28490) ?x28676 $x63383))))
 (let ((?x17647 (value_RData ?x63370)))
 (let ((?x32991 (share ?x17647)))
 (let ((?x65769 (granule_data ?x32991)))
 (let (($x16465 (= (g_norm (select ?x65769 gidx.145603571)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x32991)) gidx.145603571)) 1) $x16465)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x17647 (value_RData ?x63370)))
 (let ((?x32991 (share ?x17647)))
 (let ((?x36803 (globals ?x32991)))
 (let ((?x67493 (g_granules ?x36803)))
 (= ?x67493 ?x66896)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x36803 (globals ?x32991)))
 (let ((?x67493 (g_granules ?x36803)))
 (let ((?x67655 (select ?x67493 ?x21771)))
 (let ((?x36585 (e_lock ?x67655)))
 (let ((?x37147 (e_val ?x36585)))
 (= ?x37147 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x67493 (g_granules ?x36803)))
 (let ((?x67655 (select ?x67493 ?x21771)))
 (let ((?x28375 (mks_granule ?x39586 (e_state_s_granule ?x67655) (e_ref ?x67655))))
 (let ((?x26149 (store ?x67493 ?x21771 ?x28375)))
 (let ((?x46490 (select ?x26149 ?x28794)))
 (let ((?x74933 (e_state_s_granule ?x46490)))
 (= ?x74933 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x63370 (query_oracle.0_call (mkRData ?x28638 ?x32898 ?x22800 ?x42478 (mkShared ?x27981 ?x66346 ?x28490) ?x28676 $x63383))))
 (let ((?x17647 (value_RData ?x63370)))
 (let (($x65970 (halt ?x17647)))
 (let ((?x65894 (stack ?x17647)))
 (let ((?x32991 (share ?x17647)))
 (let ((?x36803 (globals ?x32991)))
 (let ((?x68658 (g_realm_attest_private_key ?x36803)))
 (let ((?x33410 (g_get_realm_identity_identity ?x36803)))
 (let ((?x27995 (g_rmm_platform_token ?x36803)))
 (let ((?x79813 (g_platform_token_buf ?x36803)))
 (let ((?x17432 (g_rmm_attest_public_key_hash_len ?x36803)))
 (let ((?x28834 (g_rmm_attest_public_key_hash ?x36803)))
 (let ((?x75196 (g_rmm_attest_public_key_len ?x36803)))
 (let ((?x28091 (g_rmm_attest_public_key ?x36803)))
 (let ((?x17864 (g_rmm_attest_signing_key ?x36803)))
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x64460 (meta_PA ?x28546)))
 (let ((?x37119 (meta_granule_offset ?x64460)))
 (let ((?x28794 (div ?x37119 4096)))
 (let ((?x28375 (mks_granule ?x39586 (e_state_s_granule (select (g_granules ?x36803) (div ?x37119 16))) (e_ref (select (g_granules ?x36803) (div ?x37119 16))))))
 (let ((?x21771 (div ?x37119 16)))
 (let ((?x67493 (g_granules ?x36803)))
 (let ((?x26149 (store ?x67493 ?x21771 ?x28375)))
 (let ((?x46490 (select ?x26149 ?x28794)))
 (let ((?x28358 (e_ref ?x46490)))
 (let ((?x62591 (e_u_anon_3_0 ?x28358)))
 (let ((?x28082 (+ (- 1) ?x62591)))
 (let ((?x28448 (mku_anon_3 ?x28082)))
 (let ((?x74933 (e_state_s_granule ?x46490)))
 (let ((?x28401 (e_lock ?x46490)))
 (let ((?x45628 (mks_granule ?x28401 ?x74933 ?x28448)))
 (let ((?x65887 (store ?x26149 ?x28794 ?x45628)))
 (let ((?x28321 (g_mbedtls_mem_buf ?x36803)))
 (let ((?x28620 (g_tt_l1_upper ?x36803)))
 (let ((?x18082 (g_tt_l2_mem1_3 ?x36803)))
 (let ((?x66164 (g_tt_l2_mem1_2 ?x36803)))
 (let ((?x64244 (g_tt_l2_mem1_1 ?x36803)))
 (let ((?x28176 (g_tt_l2_mem1_0 ?x36803)))
 (let ((?x27909 (g_tt_l2_mem0_1 ?x36803)))
 (let ((?x28874 (g_tt_l2_mem0_0 ?x36803)))
 (let ((?x65007 (g_tt_l3_buffer ?x36803)))
 (let ((?x34128 (g_rmm_trap_list ?x36803)))
 (let ((?x28115 (g_status_handler ?x36803)))
 (let ((?x28801 (g_default_gicstate ?x36803)))
 (let ((?x27823 (g_pri_res0_mask ?x36803)))
 (let ((?x65730 (g_max_vintid ?x36803)))
 (let ((?x28639 (g_nr_aprs ?x36803)))
 (let ((?x27453 (g_nr_lrs ?x36803)))
 (let ((?x28725 (g_vmids ?x36803)))
 (let ((?x28685 (g_vmid_lock ?x36803)))
 (let ((?x66126 (g_vmid_count ?x36803)))
 (let ((?x46573 (g_debug_exits ?x36803)))
 (let ((?x66143 (g_heap ?x36803)))
 (let ((?x25560 (mkGLOBALS ?x66143 ?x46573 ?x66126 ?x28685 ?x28725 ?x27453 ?x28639 ?x65730 ?x27823 ?x28801 ?x28115 ?x34128 ?x65007 ?x28874 ?x27909 ?x28176 ?x64244 ?x66164 ?x18082 ?x28620 ?x28321 ?x65887 ?x17864 ?x28091 ?x75196 ?x28834 ?x17432 ?x79813 ?x27995 ?x33410 ?x68658)))
 (let ((?x65769 (granule_data ?x32991)))
 (let ((?x28681 (gpt ?x32991)))
 (let ((?x64910 (priv ?x17647)))
 (let ((?x67944 (repl ?x17647)))
 (let ((?x37077 (oracle ?x17647)))
 (let ((?x27538 (log ?x17647)))
 (let ((?x36579 (mkRData ?x27538 ?x37077 ?x67944 ?x64910 (mkShared ?x28681 ?x65769 ?x25560) ?x65894 $x65970)))
 (let ((?x36727 (mkPtr "granules" ?x37119)))
 (let ((?x36716 (g_refcount_para.0_call ?x36727 ?x36579)))
 (= ?x36716 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x27559 (forall ((gidx.145604029 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x32991 (share ?x17647)))
 (let ((?x65769 (granule_data ?x32991)))
 (let ((?x28806 (select ?x65769 ?x28794)))
 (let ((?x37006 (mkr_granule_data (gd_g_idx ?x28806) (g_granule_state ?x28806) zero_granule_data (g_rd ?x28806) (g_rec ?x28806))))
 (let ((?x32707 (store ?x65769 ?x28794 ?x37006)))
 (let ((?x21771 (div ?x37119 16)))
 (let ((?x36803 (globals ?x32991)))
 (let ((?x67493 (g_granules ?x36803)))
 (let ((?x67655 (select ?x67493 ?x21771)))
 ...
 (let ((?x28448 (mku_anon_3 ?x28082)))
 (let ((?x28401 (e_lock ?x46490)))
 (let ((?x68375 (store ?x26149 ?x28794 (mks_granule ?x28401 1 ?x28448))))
 (=> (= (e_state_s_granule (select ?x68375 gidx.145604029)) 1) (= (g_norm (select ?x32707 gidx.145604029)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x27559)))
(check-sat)

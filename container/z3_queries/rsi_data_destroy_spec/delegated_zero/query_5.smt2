...
(assert
 (forall ((gidx.145592180 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x1411)) gidx.145592180)) 1) (= (g_norm (select ?x21216 gidx.145592180)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x25372 (select ?x17640 ?x50169)))
 (let ((?x25051 (e_state_s_granule ?x25372)))
 (= ?x25051 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x45886 (meta_desc_type ?x57774)))
 (let (($x36617 (= ?x45886 3)))
 (not $x36617)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x20042 (mkPtr "granule_data" ?x49471)))
 (let ((?x57774 (abs_tte_read.0_call ?x20042 ?x49427)))
 (let ((?x23699 (meta_mem_attr ?x57774)))
 (let (($x27374 (= ?x23699 1)))
 (let ((?x59024 (meta_ripas ?x57774)))
 (let (($x45887 (= ?x59024 0)))
 (let ((?x45886 (meta_desc_type ?x57774)))
 (let (($x36773 (= ?x45886 0)))
 (and $x36773 $x45887 $x27374)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 ...
 (let ((?x49907 (poffset ?x21392)))
 (let (($x65674 (>= ?x49907 0)))
 (let ((?x35831 (mod ?x49907 4096)))
 (let (($x64357 (= ?x35831 0)))
 (let ((?x34773 (pbase ?x21392)))
 (let (($x63554 (= ?x34773 "granules")))
 (and $x63554 $x64357 $x65674))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x25881 (forall ((gidx.145593144 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x35964 (= (e_state_s_granule (select ?x92421 gidx.145593144)) 1)))
 (=> $x35964 (= (g_norm (select ?x17994 gidx.145593144)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x25881)))
(check-sat)

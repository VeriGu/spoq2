...
(assert
 (let (($x36845 (forall ((gidx.145602607 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x30048 (= (e_state_s_granule (select ?x66896 gidx.145602607)) 1)))
 (=> $x30048 (= (g_norm (select ?x67686 gidx.145602607)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36845)))
(check-sat)

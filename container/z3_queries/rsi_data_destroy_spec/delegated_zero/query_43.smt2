...
(assert
 (let (($x25509 (forall ((gidx.145600603 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (=> (= (e_state_s_granule (select ?x41908 gidx.145600603)) 1) (= (g_norm (select ?x56464 gidx.145600603)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x25509)))
(check-sat)

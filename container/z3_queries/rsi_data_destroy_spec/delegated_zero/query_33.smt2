...
(assert
 (let (($x30133 (forall ((gidx.145598525 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (=> (= (e_state_s_granule (select ?x66896 gidx.145598525)) 1) (= (g_norm (select ?x67686 gidx.145598525)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x30133)))
(check-sat)

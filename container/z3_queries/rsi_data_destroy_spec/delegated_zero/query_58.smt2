...
(assert
 ...
 (let ((?x31685 (meta_desc_type ?x28546)))
 (let (($x65745 (= ?x31685 0)))
 (let (($x26889 (and $x65745 $x26397 $x28917)))
 (not $x26889)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x41398 (forall ((gidx.145604462 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18488 (share ?x40511)))
 (let ((?x66748 (granule_data ?x18488)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18488)) gidx.145604462)) 1) (= (g_norm (select ?x66748 gidx.145604462)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x41398)))
(check-sat)

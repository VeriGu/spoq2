...
(assert
 ...
 (let (($x27636 (= (g_norm (select ?x18149 gidx.145592254)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x22197)) gidx.145592254)) 1) $x27636))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x17650))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x26056 (forall ((gidx.145593107 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x22197 (share ?x50085)))
 (let ((?x18149 (granule_data ?x22197)))
 (let (($x27636 (= (g_norm (select ?x18149 gidx.145593107)) zero_granule_data)))
 (let ((?x20042 (mkPtr "granule_data" ?x49471)))
 (let ((?x57774 (abs_tte_read.0_call ?x20042 ?x49427)))
 (let ((?x67338 (meta_PA ?x57774)))
 (let ((?x50094 (meta_granule_offset ?x67338)))
 ...
 (let ((?x17635 (mks_granule ?x26601 ?x27209 ?x20901)))
 (let ((?x27012 (store ?x50245 ?x1580 ?x17635)))
 (=> (= (e_state_s_granule (select ?x27012 gidx.145593107)) 1) $x27636)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x26056)))
(check-sat)

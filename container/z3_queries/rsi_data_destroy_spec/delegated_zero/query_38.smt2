...
(assert
 ...
 (let (($x16465 (= (g_norm (select ?x65769 gidx.145599489)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x32991)) gidx.145599489)) 1) $x16465)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x31116)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x64278 (forall ((gidx.145600342 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x32991 (share ?x17647)))
 (let ((?x65769 (granule_data ?x32991)))
 (let (($x16465 (= (g_norm (select ?x65769 gidx.145600342)) zero_granule_data)))
 (let ((?x28795 (mkPtr "granule_data" ?x32826)))
 (let ((?x28546 (abs_tte_read.0_call ?x28795 ?x40511)))
 (let ((?x64460 (meta_PA ?x28546)))
 (let ((?x37119 (meta_granule_offset ?x64460)))
 ...
 (let ((?x45628 (mks_granule ?x28401 ?x74933 ?x28448)))
 (let ((?x65887 (store ?x26149 ?x28794 ?x45628)))
 (=> (= (e_state_s_granule (select ?x65887 gidx.145600342)) 1) $x16465)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x64278)))
(check-sat)

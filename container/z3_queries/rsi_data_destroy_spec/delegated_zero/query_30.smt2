...
(assert
 ...
 (not $x40626)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x31090 (forall ((gidx.145598340 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18063 (share ?x32241)))
 (let ((?x32865 (granule_data ?x18063)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18063)) gidx.145598340)) 1) (= (g_norm (select ?x32865 gidx.145598340)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x31090)))
(check-sat)

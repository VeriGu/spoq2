...
(assert
 ...
 (let (($x36581 (= (g_norm (select ?x52963 gidx.145600640)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x45205)) gidx.145600640)) 1) $x36581)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x21998)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x28150 (forall ((gidx.145601493 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x45205 (share ?x46391)))
 (let ((?x52963 (granule_data ?x45205)))
 (let (($x36581 (= (g_norm (select ?x52963 gidx.145601493)) zero_granule_data)))
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x54982 (meta_PA ?x45099)))
 (let ((?x41306 (meta_granule_offset ?x54982)))
 ...
 (let ((?x46635 (mks_granule ?x46151 ?x53651 ?x17033)))
 (let ((?x67989 (store ?x33997 ?x45209 ?x46635)))
 (=> (= (e_state_s_granule (select ?x67989 gidx.145601493)) 1) $x36581))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x28150)))
(check-sat)

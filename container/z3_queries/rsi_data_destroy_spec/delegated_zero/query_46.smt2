...
(assert
 (forall ((gidx.145600566 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x28872)) gidx.145600566)) 1) (= (g_norm (select ?x45553 gidx.145600566)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x41264 (select ?x17578 ?x28735)))
 (let ((?x36969 (e_state_s_granule ?x41264)))
 (= ?x36969 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x67327 (meta_desc_type ?x45099)))
 (let (($x63411 (= ?x67327 3)))
 (not $x63411))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x18943 (meta_mem_attr ?x45099)))
 (let (($x41151 (= ?x18943 1)))
 (let ((?x80372 (meta_ripas ?x45099)))
 (let (($x54752 (= ?x80372 0)))
 (let ((?x67327 (meta_desc_type ?x45099)))
 (let (($x41101 (= ?x67327 0)))
 (and $x41101 $x54752 $x41151))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 ...
 (let ((?x66382 (mod ?x27080 4096)))
 (let (($x36806 (= ?x66382 0)))
 (let ((?x17065 (pbase ?x18231)))
 (let (($x24518 (= ?x17065 "granules")))
 (and $x24518 $x36806 $x42406)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x45805 (forall ((gidx.145601530 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x30517 (= (e_state_s_granule (select ?x41908 gidx.145601530)) 1)))
 (=> $x30517 (= (g_norm (select ?x62563 gidx.145601530)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x45805)))
(check-sat)

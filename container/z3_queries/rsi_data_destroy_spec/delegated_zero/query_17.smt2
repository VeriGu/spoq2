...
(assert
 (forall ((gidx.145594406 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x16853)) gidx.145594406)) 1) (= (g_norm (select ?x40979 gidx.145594406)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x36333 (select ?x17644 ?x17930)))
 (let ((?x32012 (e_state_s_granule ?x36333)))
 (= ?x32012 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x25581 (meta_desc_type ?x40903)))
 (let (($x17203 (= ?x25581 3)))
 (not $x17203))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x70212 (meta_mem_attr ?x40903)))
 (let (($x42034 (= ?x70212 1)))
 (let ((?x73997 (meta_ripas ?x40903)))
 (let (($x63093 (= ?x73997 0)))
 (let ((?x25581 (meta_desc_type ?x40903)))
 (let (($x16287 (= ?x25581 0)))
 (and $x16287 $x63093 $x42034))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 ...
 (let ((?x35711 (mod ?x17590 4096)))
 (let (($x24998 (= ?x35711 0)))
 (let ((?x26199 (pbase ?x21831)))
 (let (($x17816 (= ?x26199 "granules")))
 (and $x17816 $x24998 $x26129)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x39529 (forall ((gidx.145595370 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x77315 (= (e_state_s_granule (select ?x40334 gidx.145595370)) 1)))
 (=> $x77315 (= (g_norm (select ?x40617 gidx.145595370)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39529)))
(check-sat)

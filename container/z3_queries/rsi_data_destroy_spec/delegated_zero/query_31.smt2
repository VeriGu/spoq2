...
(assert
 (forall ((gidx.145594258 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145594258)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x39112)) gidx.145594258)) 1) $x36159))))))))
 )
(assert
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
...
(assert
 ...
 (let ((?x31333 (e_lock ?x669)))
 (let ((?x24480 (e_val ?x31333)))
 (= ?x24480 None_Z)))))))))))))
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let ((?x28235 (div ?x37067 4096)))
 (let ((?x1041 (div ?x37067 16)))
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x31597 (select ?x31584 ?x28235)))
 (let ((?x58524 (e_state_s_granule ?x31597)))
 (= ?x58524 3))))))))))))))))))))
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let (($x978 (>= ?x37067 0)))
 (let ((?x51388 (mod ?x37067 4096)))
 (let (($x37079 (= ?x51388 0)))
 (and $x37079 $x978)))))))
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 ...
 (let ((?x21772 (select ?x19 ?x28235)))
 (let ((?x1035 (g_granule_state ?x21772)))
 (= ?x1035 3)))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x27763 (pbase ?x25339)))
 (let (($x31526 (= ?x27763 "granules")))
 (not $x31526))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (= ?x27763 "vmid_lock")))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x41113 (forall ((gidx.145598377 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145598377)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let ((?x1041 (div ?x37067 16)))
 ...
 (let ((?x891 (mks_granule ?x39586 ?x896 ?x63587)))
 (let ((?x31584 (store ?x660 ?x1041 ?x891)))
 (=> (= (e_state_s_granule (select ?x31584 gidx.145598377)) 1) $x36159))))))))))))))))))))
 ))
 (not $x41113)))
(check-sat)

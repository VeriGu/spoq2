...
(assert
 ...
 (let (($x26957 (= (g_norm (select ?x49316 gidx.145594480)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x32710)) gidx.145594480)) 1) $x26957)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x48691)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x68084 (forall ((gidx.145595333 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x32710 (share ?x32547)))
 (let ((?x49316 (granule_data ?x32710)))
 (let (($x26957 (= (g_norm (select ?x49316 gidx.145595333)) zero_granule_data)))
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x54153 (meta_PA ?x40903)))
 (let ((?x40676 (meta_granule_offset ?x54153)))
 ...
 (let ((?x33880 (mks_granule ?x31996 ?x33744 ?x32929)))
 (let ((?x24994 (store ?x33588 ?x41067 ?x33880)))
 (=> (= (e_state_s_granule (select ?x24994 gidx.145595333)) 1) $x26957))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x68084)))
(check-sat)

...
(assert
 ...
 (not $x37100))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x36991 (forall ((gidx.145602496 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x28872 (share ?x45709)))
 (let ((?x45553 (granule_data ?x28872)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x28872)) gidx.145602496)) 1) (= (g_norm (select ?x45553 gidx.145602496)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36991)))
(check-sat)

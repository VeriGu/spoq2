...
(assert
 (forall ((gidx.145602570 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18488)) gidx.145602570)) 1) (= (g_norm (select ?x66748 gidx.145602570)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 (let (($x22259 (forall ((gidx.145603534 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x30048 (= (e_state_s_granule (select ?x66896 gidx.145603534)) 1)))
 (=> $x30048 (= (g_norm (select ?x66346 gidx.145603534)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x22259)))
(check-sat)

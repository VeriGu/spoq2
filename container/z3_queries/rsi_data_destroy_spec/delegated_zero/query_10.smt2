...
(assert
 (forall ((gidx.145592106 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145592106)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x39112)) gidx.145592106)) 1) $x36159))))))))
 )
(assert
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
...
(assert
 ...
 (not $x50060)))))))))))))))))))))
(assert
 (let (($x35427 (forall ((gidx.145594184 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let ((?x39112 (share ?x486)))
 (let ((?x9024 (granule_data ?x39112)))
 (let ((?x35101 (select ?x9024 gidx.145594184)))
 (let (($x36159 (= (g_norm ?x35101) zero_granule_data)))
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let ((?x37067 (meta_granule_offset ?x8333)))
 (let ((?x1041 (div ?x37067 16)))
 ...
 (=> (= (e_state_s_granule (select ?x1922 gidx.145594184)) 1) $x36159)))))))))))))))))))
 ))
 (not $x35427)))
(check-sat)

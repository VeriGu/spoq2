...
(assert
 (forall ((gidx.145600640 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x64319 (store ?x17171 ?x16411 ?x27478)))
 (let ((?x67411 (g_granule_state ?x16505)))
 (let ((?x64439 (gd_g_idx ?x16505)))
 (let ((?x55148 (mkr_granule_data ?x64439 ?x67411 ?x64319 ?x46630 ?x45127)))
 (let ((?x56464 (store ?x45553 ?x28735 ?x55148)))
 (let ((?x46333 (gpt ?x28872)))
 (let ((?x64208 (priv ?x45709)))
 (let ((?x59521 (repl ?x45709)))
 (let ((?x62753 (oracle ?x45709)))
 (let ((?x41919 (log ?x45709)))
 (let ((?x45072 (query_oracle.0_call (mkRData ?x41919 ?x62753 ?x59521 ?x64208 (mkShared ?x46333 ?x56464 ?x46475) ?x67180 $x64140))))
 (let ((?x46391 (value_RData ?x45072)))
 (let ((?x45205 (share ?x46391)))
 (let ((?x52963 (granule_data ?x45205)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x45205)) gidx.145600640)) 1) (= (g_norm (select ?x52963 gidx.145600640)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x46391 (value_RData ?x45072)))
 (let ((?x45205 (share ?x46391)))
 (let ((?x23433 (globals ?x45205)))
 (let ((?x68936 (g_granules ?x23433)))
 (= ?x68936 ?x41908)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x23433 (globals ?x45205)))
 (let ((?x68936 (g_granules ?x23433)))
 (let ((?x67696 (select ?x68936 ?x8591)))
 (let ((?x53891 (e_lock ?x67696)))
 (let ((?x42490 (e_val ?x53891)))
 (= ?x42490 None_Z)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 ...
 (let ((?x68936 (g_granules ?x23433)))
 (let ((?x67696 (select ?x68936 ?x8591)))
 (let ((?x42353 (e_state_s_granule ?x67696)))
 (let ((?x28151 (mks_granule ?x39586 ?x42353 (e_ref ?x67696))))
 (let ((?x33997 (store ?x68936 ?x8591 ?x28151)))
 (let ((?x26423 (select ?x33997 ?x45209)))
 (let ((?x53651 (e_state_s_granule ?x26423)))
 (= ?x53651 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x45072 (query_oracle.0_call (mkRData ?x41919 ?x62753 ?x59521 ?x64208 (mkShared ?x46333 ?x56464 ?x46475) ?x67180 $x64140))))
 (let ((?x46391 (value_RData ?x45072)))
 (let (($x53992 (halt ?x46391)))
 (let ((?x46471 (stack ?x46391)))
 (let ((?x45205 (share ?x46391)))
 (let ((?x23433 (globals ?x45205)))
 (let ((?x54619 (g_realm_attest_private_key ?x23433)))
 (let ((?x45844 (g_get_realm_identity_identity ?x23433)))
 (let ((?x45426 (g_rmm_platform_token ?x23433)))
 (let ((?x46385 (g_platform_token_buf ?x23433)))
 (let ((?x46500 (g_rmm_attest_public_key_hash_len ?x23433)))
 (let ((?x46583 (g_rmm_attest_public_key_hash ?x23433)))
 (let ((?x62575 (g_rmm_attest_public_key_len ?x23433)))
 (let ((?x28776 (g_rmm_attest_public_key ?x23433)))
 (let ((?x23210 (g_rmm_attest_signing_key ?x23433)))
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x54982 (meta_PA ?x45099)))
 (let ((?x41306 (meta_granule_offset ?x54982)))
 ...
 (let ((?x33997 (store ?x68936 ?x8591 ?x28151)))
 (let ((?x26423 (select ?x33997 ?x45209)))
 (let ((?x72912 (e_ref ?x26423)))
 (let ((?x27950 (e_u_anon_3_0 ?x72912)))
 (let ((?x16769 (+ (- 1) ?x27950)))
 (let ((?x17033 (mku_anon_3 ?x16769)))
 (let ((?x53651 (e_state_s_granule ?x26423)))
 (let ((?x46151 (e_lock ?x26423)))
 (let ((?x46635 (mks_granule ?x46151 ?x53651 ?x17033)))
 (let ((?x67989 (store ?x33997 ?x45209 ?x46635)))
 (let ((?x28839 (g_mbedtls_mem_buf ?x23433)))
 (let ((?x36889 (g_tt_l1_upper ?x23433)))
 (let ((?x45076 (g_tt_l2_mem1_3 ?x23433)))
 (let ((?x29798 (g_tt_l2_mem1_2 ?x23433)))
 (let ((?x17772 (g_tt_l2_mem1_1 ?x23433)))
 (let ((?x42422 (g_tt_l2_mem1_0 ?x23433)))
 (let ((?x62688 (g_tt_l2_mem0_1 ?x23433)))
 (let ((?x45637 (g_tt_l2_mem0_0 ?x23433)))
 (let ((?x45587 (g_tt_l3_buffer ?x23433)))
 (let ((?x68302 (g_rmm_trap_list ?x23433)))
 (let ((?x67477 (g_status_handler ?x23433)))
 (let ((?x89126 (g_default_gicstate ?x23433)))
 (let ((?x27627 (g_pri_res0_mask ?x23433)))
 (let ((?x46379 (g_max_vintid ?x23433)))
 (let ((?x80603 (g_nr_aprs ?x23433)))
 (let ((?x68200 (g_nr_lrs ?x23433)))
 (let ((?x68749 (g_vmids ?x23433)))
 (let ((?x36805 (g_vmid_lock ?x23433)))
 (let ((?x45732 (g_vmid_count ?x23433)))
 (let ((?x75150 (g_debug_exits ?x23433)))
 (let ((?x33822 (g_heap ?x23433)))
 (let ((?x28528 (mkGLOBALS ?x33822 ?x75150 ?x45732 ?x36805 ?x68749 ?x68200 ?x80603 ?x46379 ?x27627 ?x89126 ?x67477 ?x68302 ?x45587 ?x45637 ?x62688 ?x42422 ?x17772 ?x29798 ?x45076 ?x36889 ?x28839 ?x67989 ?x23210 ?x28776 ?x62575 ?x46583 ?x46500 ?x46385 ?x45426 ?x45844 ?x54619)))
 (let ((?x52963 (granule_data ?x45205)))
 (let ((?x55154 (gpt ?x45205)))
 (let ((?x46176 (priv ?x46391)))
 (let ((?x46106 (repl ?x46391)))
 (let ((?x46572 (oracle ?x46391)))
 (let ((?x46068 (log ?x46391)))
 (let ((?x45924 (mkRData ?x46068 ?x46572 ?x46106 ?x46176 (mkShared ?x55154 ?x52963 ?x28528) ?x46471 $x53992)))
 (let ((?x28498 (mkPtr "granules" ?x41306)))
 (let ((?x41239 (g_refcount_para.0_call ?x28498 ?x45924)))
 (= ?x41239 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x31445 (forall ((gidx.145601098 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x45205 (share ?x46391)))
 (let ((?x52963 (granule_data ?x45205)))
 (let ((?x37158 (select ?x52963 ?x45209)))
 (let ((?x36961 (mkr_granule_data (gd_g_idx ?x37158) (g_granule_state ?x37158) zero_granule_data (g_rd ?x37158) (g_rec ?x37158))))
 (let ((?x22852 (store ?x52963 ?x45209 ?x36961)))
 (let ((?x8591 (div ?x41306 16)))
 (let ((?x23433 (globals ?x45205)))
 (let ((?x68936 (g_granules ?x23433)))
 (let ((?x67696 (select ?x68936 ?x8591)))
 ...
 (let ((?x17033 (mku_anon_3 ?x16769)))
 (let ((?x46151 (e_lock ?x26423)))
 (let ((?x50197 (store ?x33997 ?x45209 (mks_granule ?x46151 1 ?x17033))))
 (=> (= (e_state_s_granule (select ?x50197 gidx.145601098)) 1) (= (g_norm (select ?x22852 gidx.145601098)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x31445)))
(check-sat)

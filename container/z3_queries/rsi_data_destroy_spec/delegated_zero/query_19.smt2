...
(assert
 ...
 (let (($x31693 (= (g_norm (select ?x27655 gidx.145595407)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x40985)) gidx.145595407)) 1) $x31693)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x40236)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x67713 (forall ((gidx.145596260 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x40985 (share ?x40195)))
 (let ((?x27655 (granule_data ?x40985)))
 (let (($x31693 (= (g_norm (select ?x27655 gidx.145596260)) zero_granule_data)))
 (let ((?x62347 (mkPtr "granule_data" ?x27793)))
 (let ((?x40903 (abs_tte_read.0_call ?x62347 ?x17595)))
 (let ((?x54153 (meta_PA ?x40903)))
 (let ((?x40676 (meta_granule_offset ?x54153)))
 ...
 (let ((?x41195 (mks_granule ?x40743 ?x41120 ?x41152)))
 (let ((?x40967 (store ?x63523 ?x41067 ?x41195)))
 (=> (= (e_state_s_granule (select ?x40967 gidx.145596260)) 1) $x31693)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x67713)))
(check-sat)

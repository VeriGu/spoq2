...
(assert
 ...
 (not $x27016)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x26430 (forall ((gidx.145594110 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x1411 (share ?x49427)))
 (let ((?x21216 (granule_data ?x1411)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x1411)) gidx.145594110)) 1) (= (g_norm (select ?x21216 gidx.145594110)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x26430)))
(check-sat)

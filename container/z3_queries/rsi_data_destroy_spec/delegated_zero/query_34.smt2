...
(assert
 (forall ((gidx.145598562 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x41129)) gidx.145598562)) 1) (= (g_norm (select ?x63374 gidx.145598562)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (= ?x26837 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x67115 (forall ((gidx.145599020 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (=> (= (e_state_s_granule (select ?x27300 gidx.145599020)) 1) (= (g_norm (select ?x75174 gidx.145599020)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x67115)))
(check-sat)

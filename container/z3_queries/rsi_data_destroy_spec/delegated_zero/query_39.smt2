...
(assert
 ...
 (not $x26889)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x41860 (forall ((gidx.145600380 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x18488 (share ?x40511)))
 (let ((?x66748 (granule_data ?x18488)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18488)) gidx.145600380)) 1) (= (g_norm (select ?x66748 gidx.145600380)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x41860)))
(check-sat)

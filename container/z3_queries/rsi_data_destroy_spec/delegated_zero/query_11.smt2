...
(assert
 (forall ((gidx.66798 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.66798)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.66798)) 1)))
 (=> $x62 $x59))))
 )
(assert
 (let (($x25550 (forall ((gidx.71852 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x53 (granule_data ?x17)))
 (let ((?x93 (select ?x53 gidx.71852)))
 (let (($x95 (= (g_norm ?x93) zero_granule_data)))
 (let (($x98 (= (e_state_s_granule (select (g_granules (globals ?x17)) gidx.71852)) 1)))
 (or (not $x98) $x95)))))))))))
 ))
 (let (($x23701 (forall ((gidx.71841 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71841)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71841)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x23701) $x25550))))
(assert
 (let ((?x8333 (test_PA.0_call v_0.0)))
 (let (($x35504 (check_rcsm_mask_para.0_call ?x8333)))
 (not $x35504))))
(assert
 (let (($x83504 (forall ((gidx.145594221 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.145594221)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.145594221)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x83504)))
(check-sat)

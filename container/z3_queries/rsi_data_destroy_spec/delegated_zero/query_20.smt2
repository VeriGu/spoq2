...
(assert
 ...
 (let ((?x25581 (meta_desc_type ?x40903)))
 (let (($x16287 (= ?x25581 0)))
 (let (($x67003 (and $x16287 $x63093 $x42034)))
 (not $x67003)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x56272 (forall ((gidx.145596298 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x16853 (share ?x17595)))
 (let ((?x40979 (granule_data ?x16853)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x16853)) gidx.145596298)) 1) (= (g_norm (select ?x40979 gidx.145596298)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x56272)))
(check-sat)

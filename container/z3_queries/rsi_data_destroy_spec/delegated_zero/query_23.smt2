...
(assert
 (let (($x46752 (forall ((gidx.145596447 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (=> (= (e_state_s_granule (select ?x32805 gidx.145596447)) 1) (= (g_norm (select ?x40707 gidx.145596447)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x46752)))
(check-sat)

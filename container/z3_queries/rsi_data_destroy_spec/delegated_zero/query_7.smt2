...
(assert
 ...
 (let (($x16203 (= (g_norm (select ?x17500 gidx.145593181)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x27446)) gidx.145593181)) 1) $x16203))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x25376))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x61253 (forall ((gidx.145594034 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x27446 (share ?x18192)))
 (let ((?x17500 (granule_data ?x27446)))
 (let (($x16203 (= (g_norm (select ?x17500 gidx.145594034)) zero_granule_data)))
 (let ((?x20042 (mkPtr "granule_data" ?x49471)))
 (let ((?x57774 (abs_tte_read.0_call ?x20042 ?x49427)))
 (let ((?x67338 (meta_PA ?x57774)))
 (let ((?x50094 (meta_granule_offset ?x67338)))
 ...
 (let ((?x27723 (mks_granule ?x27554 ?x27079 ?x18136)))
 (let ((?x27818 (store ?x52724 ?x1580 ?x27723)))
 (=> (= (e_state_s_granule (select ?x27818 gidx.145594034)) 1) $x16203))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x61253)))
(check-sat)

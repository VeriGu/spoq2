...
(assert
 ...
 (let (($x66002 (= (g_norm (select ?x46199 gidx.145601567)) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x63594)) gidx.145601567)) 1) $x66002)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (not $x46566)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x46688 (forall ((gidx.145602420 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x63594 (share ?x46529)))
 (let ((?x46199 (granule_data ?x63594)))
 (let (($x66002 (= (g_norm (select ?x46199 gidx.145602420)) zero_granule_data)))
 (let ((?x52532 (mkPtr "granule_data" ?x60601)))
 (let ((?x45099 (abs_tte_read.0_call ?x52532 ?x45709)))
 (let ((?x54982 (meta_PA ?x45099)))
 (let ((?x41306 (meta_granule_offset ?x54982)))
 ...
 (let ((?x67276 (mks_granule ?x67440 ?x68498 ?x46234)))
 (let ((?x66524 (store ?x45179 ?x45209 ?x67276)))
 (=> (= (e_state_s_granule (select ?x66524 gidx.145602420)) 1) $x66002)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x46688)))
(check-sat)

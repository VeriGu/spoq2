...
(assert
 (forall ((gidx.145596410 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x18063)) gidx.145596410)) 1) (= (g_norm (select ?x32865 gidx.145596410)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 ...
 (let ((?x65813 (select ?x71810 ?x75555)))
 (let ((?x29463 (e_state_s_granule ?x65813)))
 (= ?x29463 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
...
(assert
 ...
 (let ((?x77630 (meta_desc_type ?x40966)))
 (let (($x26128 (= ?x77630 3)))
 (not $x26128)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 ...
 (let ((?x72238 (mkPtr "granule_data" ?x41424)))
 (let ((?x40966 (abs_tte_read.0_call ?x72238 ?x32241)))
 (let ((?x25287 (meta_mem_attr ?x40966)))
 (let (($x28021 (= ?x25287 1)))
 (let ((?x76416 (meta_ripas ?x40966)))
 (let (($x31554 (= ?x76416 0)))
 (let ((?x77630 (meta_desc_type ?x40966)))
 (let (($x16969 (= ?x77630 0)))
 (and $x16969 $x31554 $x28021)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 ...
 (let ((?x19980 (mod ?x32610 4096)))
 (let (($x17378 (= ?x19980 0)))
 (let ((?x40420 (pbase ?x27461)))
 (let (($x67360 (= ?x40420 "granules")))
 (and $x67360 $x17378 $x30597))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x31146 (forall ((gidx.145597374 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let (($x43826 (= (e_state_s_granule (select ?x32805 gidx.145597374)) 1)))
 (=> $x43826 (= (g_norm (select ?x17336 gidx.145597374)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x31146)))
(check-sat)

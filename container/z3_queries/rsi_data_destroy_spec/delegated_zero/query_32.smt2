...
(assert
 ...
 (= ?x27753 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x16538 (forall ((gidx.145598451 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (let ((?x66777 (share ?x51317)))
 (let ((?x27608 (granule_data ?x66777)))
 (let ((?x28018 (select ?x27608 gidx.145598451)))
 (let (($x21700 (= (g_norm ?x28018) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x66777)) gidx.145598451)) 1) $x21700))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x16538)))
(check-sat)

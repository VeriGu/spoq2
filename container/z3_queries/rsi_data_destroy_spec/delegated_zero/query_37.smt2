...
(assert
 (forall ((gidx.145599489 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x32991)) gidx.145599489)) 1) (= (g_norm (select ?x65769 gidx.145599489)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
...
(assert
 ...
 (= ?x36716 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x56725 (forall ((gidx.145599947 Int) )(let ((?x547 (query_oracle.0_call st.0)))
 (let ((?x486 (value_RData ?x547)))
 (let (($x70847 (halt ?x486)))
 (let ((?x15857 (stack ?x486)))
 (let ((?x39112 (share ?x486)))
 ...
 (=> (= (e_state_s_granule (select ?x68375 gidx.145599947)) 1) (= (g_norm (select ?x32707 gidx.145599947)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x56725)))
(check-sat)

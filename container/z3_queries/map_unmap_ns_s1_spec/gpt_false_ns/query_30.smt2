...
(assert
 ...
 (= ?x49045 8)))))))))))))))
(assert
 (let (($x19517 (forall ((gidx.89629350 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x26040 (globals ?x64552)))
 (let ((?x49479 (g_granules ?x26040)))
 (let ((?x20338 (e_state_s_granule (select ?x49479 gidx.89629350))))
 (=> (not (select (gpt ?x64552) gidx.89629350)) (or (= ?x20338 0) (= ?x20338 6)))))))))))))))))))))
 ))
 (not $x19517)))
(check-sat)

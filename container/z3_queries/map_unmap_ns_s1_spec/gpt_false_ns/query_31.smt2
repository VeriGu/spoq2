...
(assert
 (forall ((gidx.94112 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.94112)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.94112)) (or $x62 $x61))))))))))
 )
(assert
 (let (($x22175 (forall ((gidx.101402 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x87 (gpt ?x17)))
 (let (($x102 (select ?x87 gidx.101402)))
 (let ((?x52 (globals ?x17)))
 (let ((?x53 (g_granules ?x52)))
 (let ((?x96 (select ?x53 gidx.101402)))
 (let ((?x98 (e_state_s_granule ?x96)))
 (let (($x100 (= ?x98 0)))
 (let (($x99 (= ?x98 6)))
 (or $x99 $x100 $x102)))))))))))))))
 ))
 (let (($x19156 (forall ((gidx.101385 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.101385)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.101385)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x62 (= ?x60 0)))
 (let (($x61 (= ?x60 6)))
 (or $x61 $x62 $x64)))))))))))
 ))
 (or (not $x19156) $x22175))))
(assert
 (forall ((gidx.89627238 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x669 (globals ?x39912)))
 (let ((?x560 (g_granules ?x669)))
 (let ((?x29395 (e_state_s_granule (select ?x560 gidx.89627238))))
 (=> (not (select (gpt ?x39912) gidx.89627238)) (or (= ?x29395 0) (= ?x29395 6))))))))))
 )
(assert
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x669 (globals ?x39912)))
 (let ((?x560 (g_granules ?x669)))
 (= ?x560 ?x21))))))))))
(assert
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x1398 (div ?x80037 16)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x669 (globals ?x39912)))
 (let ((?x560 (g_granules ?x669)))
 (let ((?x1460 (select ?x560 ?x1398)))
 (let ((?x837 (e_lock ?x1460)))
 (let ((?x1462 (e_val ?x837)))
 (= ?x1462 None_Z)))))))))))))
(assert
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x158847 (div ?x80037 4096)))
 (let ((?x1398 (div ?x80037 16)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 ...
 (let ((?x560 (g_granules ?x669)))
 (let ((?x1460 (select ?x560 ?x1398)))
 (let ((?x1468 (e_ref ?x1460)))
 (let ((?x1442 (e_state_s_granule ?x1460)))
 (let ((?x28845 (Some_Z CPU_ID.0)))
 (let ((?x39743 (mks_spinlock_t ?x28845)))
 (let ((?x1324 (mks_granule ?x39743 ?x1442 ?x1468)))
 (let ((?x88652 (store ?x560 ?x1398 ?x1324)))
 (let ((?x1248 (select ?x88652 ?x158847)))
 (let ((?x1159 (e_state_s_granule ?x1248)))
 (let (($x2627 (= ?x1159 5)))
 (not $x2627)))))))))))))))))))))
(assert
 (forall ((gidx.89628962 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 (let ((?x1304 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x17118 (rtt_walk_lock_unlock_spec_abs.0_call ?x1304 ?x150980 0 64 v_1.0 v_2.0 ?x39694)))
 (let ((?x24280 (value_Tuple_abs_ret_rtt_RData ?x17118)))
 (let ((?x19485 (elem_1 ?x24280)))
 (let ((?x59290 (share ?x19485)))
 (let ((?x24001 (globals ?x59290)))
 (let ((?x42369 (g_granules ?x24001)))
 (let ((?x49545 (e_state_s_granule (select ?x42369 gidx.89628962))))
 (=> (not (select (gpt ?x59290) gidx.89628962)) (or (= ?x49545 0) (= ?x49545 6)))))))))))))))))
 )
(assert
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 ...
 (let ((?x17118 (rtt_walk_lock_unlock_spec_abs.0_call ?x1304 ?x150980 0 64 v_1.0 v_2.0 ?x39694)))
 (let ((?x24280 (value_Tuple_abs_ret_rtt_RData ?x17118)))
 (let ((?x53351 (elem_0 ?x24280)))
 (let ((?x18524 (e_3 ?x53351)))
 (let ((?x22193 (* 8 ?x18524)))
 (let ((?x26223 (e_2 ?x53351)))
 (let ((?x33529 (poffset ?x26223)))
 (let ((?x26245 (+ ?x33529 ?x22193)))
 (let ((?x49460 (div ?x26245 4096)))
 (let ((?x19485 (elem_1 ?x24280)))
 (let ((?x59290 (share ?x19485)))
 (let ((?x24001 (globals ?x59290)))
 (let ((?x42369 (g_granules ?x24001)))
 (let ((?x25277 (select ?x42369 ?x49460)))
 (let ((?x22897 (e_state_s_granule ?x25277)))
 (= ?x22897 5)))))))))))))))))))))))
(assert
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x9130 (granule_data ?x39912)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 (let ((?x1304 (mkPtr "stack_s_rtt_walk" 0)))
 ...
 (let ((?x19485 (elem_1 ?x24280)))
 (let ((?x59290 (share ?x19485)))
 (let ((?x29148 (granule_data ?x59290)))
 (= ?x29148 ?x9130)))))))))))))))
(assert
 (let ((?x694 (* (- 1) v_2.0)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 ...
 (let ((?x24280 (value_Tuple_abs_ret_rtt_RData ?x17118)))
 (let ((?x53351 (elem_0 ?x24280)))
 (let ((?x30052 (e_1 ?x53351)))
 (let ((?x21686 (+ ?x30052 ?x694)))
 (= ?x21686 0))))))))))))))
(assert
 (= v_4.0 0))
(assert
 ...
 (let ((?x33529 (poffset ?x26223)))
 (let ((?x26245 (+ ?x33529 ?x22193)))
 (let ((?x54225 (mkPtr "granule_data" ?x26245)))
 (let ((?x72500 (abs_tte_read.0_call ?x54225 ?x19485)))
 (let ((?x53416 (meta_mem_attr ?x72500)))
 (let (($x14174 (= ?x53416 0)))
 (let ((?x53526 (meta_ripas ?x72500)))
 (let (($x15425 (= ?x53526 0)))
 (let ((?x18892 (meta_desc_type ?x72500)))
 (let (($x54747 (= ?x18892 0)))
 (and $x54747 $x15425 $x14174)))))))))))))))))))))))))
(assert
 (let ((?x1818 (test_Z_PTE.0_call v_3.0)))
 (let (($x59915 (uart0_phys_para.0_call ?x1818)))
 (not $x59915))))
(assert
 (forall ((gidx.89629128 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x24280 (value_Tuple_abs_ret_rtt_RData ?x17118)))
 (let ((?x19485 (elem_1 ?x24280)))
 (let ((?x40540 (query_oracle.0_call ?x19485)))
 (let ((?x30306 (value_RData ?x40540)))
 (let ((?x30576 (share ?x30306)))
 (let ((?x17973 (globals ?x30576)))
 (let ((?x57766 (g_granules ?x17973)))
 (let ((?x33587 (e_state_s_granule (select ?x57766 gidx.89629128))))
 (=> (not (select (gpt ?x30576) gidx.89629128)) (or (= ?x33587 0) (= ?x33587 6)))))))))))))))))))
 )
(assert
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
...
(assert
 (let ((?x1818 (test_Z_PTE.0_call v_3.0)))
 (let ((?x1715 (meta_PA ?x1818)))
 (let ((?x87835 (meta_granule_offset ?x1715)))
 (let ((?x72758 (div ?x87835 16)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 ...
 (let ((?x17973 (globals ?x30576)))
 (let ((?x57766 (g_granules ?x17973)))
 (let ((?x38088 (select ?x57766 ?x72758)))
 (let ((?x31740 (e_lock ?x38088)))
 (let ((?x44290 (e_val ?x31740)))
 (= ?x44290 None_Z)))))))))))))))))))))))
(assert
 (let ((?x1818 (test_Z_PTE.0_call v_3.0)))
 (let ((?x1715 (meta_PA ?x1818)))
 (let ((?x87835 (meta_granule_offset ?x1715)))
 (let ((?x1445 (div ?x87835 4096)))
 (let ((?x72758 (div ?x87835 16)))
 (let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 ...
 (let ((?x57766 (g_granules ?x17973)))
 (let ((?x38088 (select ?x57766 ?x72758)))
 (let ((?x51228 (e_ref ?x38088)))
 (let ((?x79198 (e_state_s_granule ?x38088)))
 (let ((?x28845 (Some_Z CPU_ID.0)))
 (let ((?x39743 (mks_spinlock_t ?x28845)))
 (let ((?x23584 (mks_granule ?x39743 ?x79198 ?x51228)))
 (let ((?x44647 (store ?x57766 ?x72758 ?x23584)))
 (let ((?x40520 (select ?x44647 ?x1445)))
 (let ((?x16856 (e_state_s_granule ?x40520)))
 (let (($x50554 (= ?x16856 0)))
 (not $x50554)))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.89629294 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x40540 (query_oracle.0_call ?x19485)))
 (let ((?x30306 (value_RData ?x40540)))
 (let ((?x20011 (query_oracle.0_call ?x30306)))
 (let ((?x58902 (value_RData ?x20011)))
 (let ((?x64552 (share ?x58902)))
 (let ((?x26040 (globals ?x64552)))
 (let ((?x49479 (g_granules ?x26040)))
 (let ((?x20338 (e_state_s_granule (select ?x49479 gidx.89629294))))
 (=> (not (select (gpt ?x64552) gidx.89629294)) (or (= ?x20338 0) (= ?x20338 6)))))))))))))))))))))
 )
(assert
 (let ((?x1818 (test_Z_PTE.0_call v_3.0)))
 (let ((?x1715 (meta_PA ?x1818)))
 ...
 (let ((?x51228 (e_ref ?x38088)))
 (let ((?x79198 (e_state_s_granule ?x38088)))
 (let ((?x47499 (mks_spinlock_t None_Z)))
 (let ((?x58947 (mks_granule ?x47499 ?x79198 ?x51228)))
 (let ((?x19171 (store ?x57766 ?x72758 ?x58947)))
 (let ((?x20011 (query_oracle.0_call ?x30306)))
 (let ((?x58902 (value_RData ?x20011)))
 (let ((?x64552 (share ?x58902)))
 (let ((?x26040 (globals ?x64552)))
...
(assert
 ...
 (let ((?x26040 (globals ?x64552)))
 (let ((?x49479 (g_granules ?x26040)))
 (let ((?x47069 (select ?x49479 ?x72758)))
 (let ((?x31183 (e_lock ?x47069)))
 (let ((?x53967 (e_val ?x31183)))
 (= ?x53967 None_Z)))))))))))))))))))))))))
(assert
 (let ((?x1818 (test_Z_PTE.0_call v_3.0)))
 (let ((?x1715 (meta_PA ?x1818)))
 ...
 (let ((?x28845 (Some_Z CPU_ID.0)))
 (let ((?x39743 (mks_spinlock_t ?x28845)))
 (let ((?x19814 (mks_granule ?x39743 (e_state_s_granule ?x47069) (e_ref ?x47069))))
 (let ((?x21117 (store ?x49479 ?x72758 ?x19814)))
 (let ((?x26056 (select ?x21117 ?x1445)))
 (let ((?x51612 (e_state_s_granule ?x26056)))
 (let (($x15811 (= ?x51612 6)))
 (not $x15811)))))))))))))))))))))))))))))))
(assert
 (let ((?x61422 (make_return_code_para.0_call 1)))
 (let ((?x61505 (pack_struct_return_code_para.0_call ?x61422)))
 (= ?x61505 0))))
(assert
 true)
(assert
...
(assert
 ...
 (let ((?x33529 (poffset ?x26223)))
 (let ((?x43403 (+ 8 ?x33529)))
 (let ((?x49045 (mod ?x43403 4096)))
 (= ?x49045 8)))))))))))))))
(assert
 (let (($x30806 (forall ((gidx.89629406 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x26040 (globals ?x64552)))
 (let ((?x49479 (g_granules ?x26040)))
 (let ((?x20338 (e_state_s_granule (select ?x49479 gidx.89629406))))
 (=> (not (select (gpt ?x64552) gidx.89629406)) (or (= ?x20338 0) (= ?x20338 6)))))))))))))))))))))
 ))
 (not $x30806)))
(check-sat)

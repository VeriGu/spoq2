...
(assert
 ...
 (not $x19473))))))))))))))))))))))))
(assert
 (let (($x24538 (forall ((gidx.89630354 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x24001 (globals ?x59290)))
 (let ((?x42369 (g_granules ?x24001)))
 (let ((?x49545 (e_state_s_granule (select ?x42369 gidx.89630354))))
 (=> (not (select (gpt ?x59290) gidx.89630354)) (or (= ?x49545 0) (= ?x49545 6)))))))))))))))))
 ))
 (not $x24538)))
(check-sat)

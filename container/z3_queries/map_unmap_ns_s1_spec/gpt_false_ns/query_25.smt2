...
(assert
 ...
 (not $x2627)))))))))))))))))))))
(assert
 (let (($x16002 (forall ((gidx.89628907 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x669 (globals ?x39912)))
 (let ((?x560 (g_granules ?x669)))
 (let ((?x29395 (e_state_s_granule (select ?x560 gidx.89628907))))
 (=> (not (select (gpt ?x39912) gidx.89628907)) (or (= ?x29395 0) (= ?x29395 6))))))))))
 ))
 (not $x16002)))
(check-sat)

...
(assert
 ...
 (= ?x49045 8)))))))))))))))
(assert
 (let (($x20875 (forall ((gidx.89628516 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x1321 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x80037 (meta_granule_offset ?x1321)))
 (let ((?x150980 (mkPtr "granules" ?x80037)))
 ...
 (let ((?x17973 (globals ?x30576)))
 (let ((?x57766 (g_granules ?x17973)))
 (let ((?x33587 (e_state_s_granule (select ?x57766 gidx.89628516))))
 (=> (not (select (gpt ?x30576) gidx.89628516)) (or (= ?x33587 0) (= ?x33587 6)))))))))))))))))))
 ))
 (not $x20875)))
(check-sat)

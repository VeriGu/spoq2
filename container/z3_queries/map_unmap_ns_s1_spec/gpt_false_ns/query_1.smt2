...
(assert
 ...
 (let ((?x24789 (select ?x560 gidx.89627238)))
 (let ((?x29395 (e_state_s_granule ?x24789)))
 (let (($x17230 (= ?x29395 6)))
 (let (($x34154 (= ?x29395 0)))
 (=> (not (select (gpt ?x39912) gidx.89627238)) (or $x34154 $x17230))))))))))))
 )
(assert
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
...
(assert
 ...
 (= ?x1159 5))))))))))))))))))))
(assert
 (let (($x17656 (forall ((gidx.89627293 Int) )(let ((?x39118 (query_oracle.0_call st.0)))
 (let ((?x39694 (value_RData ?x39118)))
 (let ((?x39912 (share ?x39694)))
 (let ((?x669 (globals ?x39912)))
 (let ((?x560 (g_granules ?x669)))
 (let ((?x24789 (select ?x560 gidx.89627293)))
 (let ((?x29395 (e_state_s_granule ?x24789)))
 (let (($x17230 (= ?x29395 6)))
 (let (($x34154 (= ?x29395 0)))
 (=> (not (select (gpt ?x39912) gidx.89627293)) (or $x34154 $x17230))))))))))))
 ))
 (not $x17656)))
(check-sat)

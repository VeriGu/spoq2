...
(assert
 ...
 (not $x2279))))
(assert
 (forall ((rtt_gidx.368803 Int) (ipa_gidx.368803 Int) (data_gidx.368803 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let ((?x1948 (rtt_walk_abs.0_call ?x1791 rtt_gidx.368803 ipa_gidx.368803)))
 (let ((?x1950 (share ?x1791)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2053 (g_granule_state (select ?x4788 ?x1948))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.368803)))
 (let (($x2120 (=> $x121 (or (= ?x2053 4) (= ?x2053 6)))))
 (let (($x1972 (= (e_state_s_granule (select (g_granules (globals ?x1950)) rtt_gidx.368803)) 5)))
 (=> (and $x1972 (and (distinct ?x1948 (- 1)) true) $x121) (or (= ?x2053 4) (= ?x2053 6))))))))))))))))))))
 )
(assert
 (forall ((v.368813 Int) )(let ((?x1100 (make_return_code_para.0_call v.368813)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.368826 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.368826)) (* (- 1) v.368826)) 0))
 )
(assert
 (forall ((offset.369324 Int) (empty_pte.369324 abs_PTE_t) )(let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.369324)) (- 1)))))
 (let ((?x1274 (div offset.369324 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1798 (g_granules ?x1800)))
 (let (($x2115 (not (= (e_state_s_granule (select ?x1798 ?x1274)) 5))))
 (let (($x4781 (forall ((rtt_gidx.369207 Int) (ipa_gidx.369207 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1798 (g_granules ?x1800)))
 (let (($x2089 (not (= (e_state_s_granule (select ?x1798 rtt_gidx.369207)) 5))))
 (let ((?x2081 (g_granule_state (select (granule_data ?x1950) (rtt_walk_abs.0_call ?x1791 rtt_gidx.369207 ipa_gidx.369207)))))
 (let (($x2085 (= ?x2081 4)))
 (let (($x2080 (= ?x2081 6)))
 (let ((?x2052 (rtt_walk_abs.0_call ?x1791 rtt_gidx.369207 ipa_gidx.369207)))
 (let (($x2077 (= ?x2052 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.369207))))
 (or $x144 $x2077 $x2080 $x2085 $x2089)))))))))))))))))))))
 ))
 (let (($x2069 (not $x4781)))
 (let (($x2152 (forall ((rtt_gidx.369320 Int) (ipa_gidx.369320 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let (($x1890 (halt ?x1791)))
 (let ((?x1951 (stack ?x1791)))
 (let ((?x1950 (share ?x1791)))
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1163 (div offset.369324 4096)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2132 (select ?x4788 ?x1163)))
 (let ((?x2135 (g_rec ?x2132)))
 (let ((?x2136 (g_rd ?x2132)))
 (let ((?x2139 (g_granule_state ?x2132)))
 (let ((?x2140 (gd_g_idx ?x2132)))
 (let ((?x2141 (mkr_granule_data ?x2140 ?x2139 (store (g_norm ?x2132) (mod offset.369324 4096) (test_PTE_Z.0_call empty_pte.369324)) ?x2136 ?x2135)))
 (let ((?x2142 (store ?x4788 ?x1163 ?x2141)))
 (let ((?x1814 (gpt ?x1950)))
 (let ((?x1849 (priv ?x1791)))
 (let ((?x1846 (repl ?x1791)))
 (let ((?x1845 (oracle ?x1791)))
 (let ((?x1844 (log ?x1791)))
 (let ((?x2145 (rtt_walk_abs.0_call (mkRData ?x1844 ?x1845 ?x1846 ?x1849 (mkShared ?x1814 ?x2142 ?x1800) ?x1951 $x1890) rtt_gidx.369320 ipa_gidx.369320)))
 (let (($x2089 (not (= (e_state_s_granule (select (g_granules ?x1800) rtt_gidx.369320)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.369320))))
 (or $x144 $x2089 (= (g_granule_state (select ?x2142 ?x2145)) 6) (= (g_granule_state (select ?x2142 ?x2145)) 4) (= ?x2145 (- 1))))))))))))))))))))))))))))))))))
 ))
 (or $x2152 $x2069 $x2115 $x1394))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.369865 Int) (pte_z.369865 Int) )(let (($x2204 (forall ((rtt_gidx.369722 Int) (ipa_gidx.369722 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let ((?x2052 (rtt_walk_abs.0_call ?x1791 rtt_gidx.369722 ipa_gidx.369722)))
 (let (($x2077 (= ?x2052 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.369722))))
 (let (($x2090 (= (e_state_s_granule (select (g_granules (globals (share ?x1791))) rtt_gidx.369722)) 5)))
 (let (($x2089 (not $x2090)))
 (let ((?x2081 (g_granule_state (select (granule_data (share ?x1791)) ?x2052))))
 (let (($x2085 (= ?x2081 4)))
 (let (($x2080 (= ?x2081 6)))
 (or $x2080 $x2085 $x2089 $x144 $x2077)))))))))))))))))))
 ))
 (let (($x2312 (not $x2204)))
 (let ((?x1274 (div parent_gidx.369865 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x1798 (g_granules ?x1800)))
 (let (($x2115 (not (= (e_state_s_granule (select ?x1798 ?x1274)) 5))))
 (let (($x2226 (forall ((rtt_gidx.369861 Int) (ipa_gidx.369861 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1950 (share ?x1791)))
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1163 (div parent_gidx.369865 4096)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2132 (select ?x4788 ?x1163)))
 (let ((?x2135 (g_rec ?x2132)))
 (let ((?x2136 (g_rd ?x2132)))
 (let ((?x2139 (g_granule_state ?x2132)))
 (let ((?x2140 (gd_g_idx ?x2132)))
 (let ((?x2185 (mkr_granule_data ?x2140 ?x2139 (store (g_norm ?x2132) (mod parent_gidx.369865 4096) pte_z.369865) ?x2136 ?x2135)))
 (let ((?x2182 (store ?x4788 ?x1163 ?x2185)))
 (let ((?x1814 (gpt ?x1950)))
 (let ((?x1849 (priv ?x1791)))
 (let ((?x1846 (repl ?x1791)))
 (let ((?x1845 (oracle ?x1791)))
 (let ((?x1844 (log ?x1791)))
 (let ((?x2220 (rtt_walk_abs.0_call (mkRData ?x1844 ?x1845 ?x1846 ?x1849 (mkShared ?x1814 ?x2182 ?x1800) ?x1951 $x1890) rtt_gidx.369861 ipa_gidx.369861)))
 (let ((?x2236 (g_granule_state (select ?x2182 ?x2220))))
 (let (($x2089 (not (= (e_state_s_granule (select (g_granules ?x1800) rtt_gidx.369861)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.369861))))
 (or $x144 (= ?x2236 6) $x2089 (= ?x2220 (- 1)) (= ?x2236 4))))))))))))))))))))))))))))))))))
 ))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.369865))) 4096)))
 (let ((?x2296 (e_state_s_granule (select ?x1798 ?x1280))))
 (or (not (or (= ?x2296 0) (= ?x2296 6))) $x2226 $x2115 $x2312)))))))))))))))))))))
 )
(assert
 (let (($x25837 (forall ((rtt_gidx.369944 Int) (ipa_gidx.369944 Int) (data_gidx.369944 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let ((?x1948 (rtt_walk_abs.0_call ?x1791 rtt_gidx.369944 ipa_gidx.369944)))
 (let ((?x1950 (share ?x1791)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2053 (g_granule_state (select ?x4788 ?x1948))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.369944)))
 (let (($x2120 (=> $x121 (or (= ?x2053 4) (= ?x2053 6)))))
 (let (($x1972 (= (e_state_s_granule (select (g_granules (globals ?x1950)) rtt_gidx.369944)) 5)))
 (=> (and $x1972 (and (distinct ?x1948 (- 1)) true) $x121) (or (= ?x2053 4) (= ?x2053 6))))))))))))))))))))
 ))
 (not $x25837)))
(check-sat)

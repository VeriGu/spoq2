...
(assert
 ...
 (let ((?x2420 (mkPtr "granule_data" ?x2224)))
 (let ((?x2539 (abs_tte_read.0_call ?x2420 ?x1791)))
 (let (($x4013 (uart0_phys_para.0_call ?x2539)))
 (not $x4013))))))))))))))))))))
(assert
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
...
(assert
 ...
 (let ((?x2420 (mkPtr "granule_data" ?x2224)))
 (let ((?x2539 (abs_tte_read.0_call ?x2420 ?x1791)))
 (let ((?x69785 (meta_PA ?x2539)))
 (let ((?x4231 (meta_granule_offset ?x69785)))
 (let ((?x4116 (div ?x4231 16)))
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let ((?x4241 (select ?x2453 ?x4116)))
 (let ((?x4450 (e_lock ?x4241)))
 (let ((?x4444 (e_val ?x4450)))
 (= ?x4444 None_Z))))))))))))))))))))))))))))))
(assert
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 ...
 (let ((?x1956 (Some_Z CPU_ID.0)))
 (let ((?x1955 (mks_spinlock_t ?x1956)))
 (let ((?x4447 (mks_granule ?x1955 (e_state_s_granule ?x4241) (e_ref ?x4241))))
 (let ((?x4227 (store ?x2453 ?x4116 ?x4447)))
 (let ((?x4223 (select ?x4227 ?x4362)))
 (let ((?x3806 (e_state_s_granule ?x4223)))
 (= ?x3806 6)))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
...
(assert
 ...
 (let ((?x2239 (poffset ?x2253)))
 (let (($x57588 (>= ?x2239 0)))
 (let ((?x77657 (mod ?x2239 4096)))
 (let (($x4441 (= ?x77657 0)))
 (let ((?x55172 (pbase ?x2253)))
 (let (($x2994 (= ?x55172 "granules")))
 (and $x2994 $x4441 $x57588))))))))))))))))))
(assert
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 ...
 (= ?x55205 8)))))))))))))))
(assert
 (forall ((rtt_gidx.372945 Int) (ipa_gidx.372945 Int) (data_gidx.372945 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x25981 (rtt_walk_abs.0_call ?x2361 rtt_gidx.372945 ipa_gidx.372945)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x18094 (g_granule_state (select ?x2276 ?x25981))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.372945)))
 (let (($x26024 (=> $x121 (or (= ?x18094 4) (= ?x18094 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.372945)) 5)))
 (=> (and $x26025 (and (distinct ?x25981 (- 1)) true) $x121) (or (= ?x18094 4) (= ?x18094 6))))))))))))))))))))))
 )
(assert
 (forall ((v.372955 Int) )(let ((?x1100 (make_return_code_para.0_call v.372955)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.372968 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.372968)) (* (- 1) v.372968)) 0))
 )
(assert
 (forall ((offset.373466 Int) (empty_pte.373466 abs_PTE_t) )(let ((?x1274 (div offset.373466 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x2691 (not (= (e_state_s_granule (select ?x2453 ?x1274)) 5))))
 (let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.373466)) (- 1)))))
 (let (($x19834 (forall ((rtt_gidx.373462 Int) (ipa_gidx.373462 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.373462)) 5))))
 (let (($x2370 (halt ?x2361)))
 (let ((?x25896 (stack ?x2361)))
 (let ((?x1163 (div offset.373466 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x2616 (select ?x2276 ?x1163)))
 (let ((?x18165 (g_rec ?x2616)))
 (let ((?x18164 (g_rd ?x2616)))
 (let ((?x2666 (g_granule_state ?x2616)))
 (let ((?x2681 (gd_g_idx ?x2616)))
 (let ((?x2668 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod offset.373466 4096) (test_PTE_Z.0_call empty_pte.373466)) ?x18164 ?x18165)))
 (let ((?x2667 (store ?x2276 ?x1163 ?x2668)))
 (let ((?x26029 (gpt ?x2520)))
 (let ((?x25943 (priv ?x2361)))
 (let ((?x2372 (repl ?x2361)))
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x2680 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2667 ?x25875) ?x25896 $x2370) rtt_gidx.373462 ipa_gidx.373462)))
 (let ((?x2672 (g_granule_state (select ?x2667 ?x2680))))
 (let (($x14289 (= ?x2672 4)))
 (let (($x2689 (= ?x2672 6)))
 (let (($x2675 (= ?x2680 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.373462))))
 (or $x144 $x2675 $x2689 $x14289 $x26091)))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3823 (forall ((rtt_gidx.373349 Int) (ipa_gidx.373349 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.373349)) 5))))
 (let ((?x26113 (g_granule_state (select (granule_data ?x2520) (rtt_walk_abs.0_call ?x2361 rtt_gidx.373349 ipa_gidx.373349)))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.373349 ipa_gidx.373349)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.373349))))
 (or $x144 $x2656 $x18166 $x18167 $x26091)))))))))))))))))))))))
 ))
 (let (($x19471 (not $x3823)))
 (or $x19471 $x19834 $x1394 $x2691))))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.374007 Int) (pte_z.374007 Int) )(let (($x19479 (forall ((rtt_gidx.373864 Int) (ipa_gidx.373864 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.373864 ipa_gidx.373864)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.373864))))
 (let (($x26090 (= (e_state_s_granule (select (g_granules (globals (share ?x2361))) rtt_gidx.373864)) 5)))
 (let (($x26091 (not $x26090)))
 (let ((?x26113 (g_granule_state (select (granule_data (share ?x2361)) ?x2644))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (or $x18166 $x18167 $x26091 $x144 $x2656)))))))))))))))))))))
 ))
 (let (($x64533 (not $x19479)))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.374007))) 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let ((?x2742 (e_state_s_granule (select ?x2453 ?x1280))))
 (let (($x2786 (not (or (= ?x2742 0) (= ?x2742 6)))))
 (let (($x2691 (not (= (e_state_s_granule (select ?x2453 (div parent_gidx.374007 4096))) 5))))
 (let (($x19883 (forall ((rtt_gidx.374003 Int) (ipa_gidx.374003 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2520 (share ?x2361)))
 (let ((?x25875 (globals ?x2520)))
 (let ((?x1163 (div parent_gidx.374007 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x2616 (select ?x2276 ?x1163)))
 (let ((?x18165 (g_rec ?x2616)))
 (let ((?x18164 (g_rd ?x2616)))
 (let ((?x2666 (g_granule_state ?x2616)))
 (let ((?x2681 (gd_g_idx ?x2616)))
 (let ((?x2779 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod parent_gidx.374007 4096) pte_z.374007) ?x18164 ?x18165)))
 (let ((?x2784 (store ?x2276 ?x1163 ?x2779)))
 (let ((?x26029 (gpt ?x2520)))
 (let ((?x25943 (priv ?x2361)))
 (let ((?x2372 (repl ?x2361)))
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x2805 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2784 ?x25875) ?x25896 $x2370) rtt_gidx.374003 ipa_gidx.374003)))
 (let (($x2804 (= ?x2805 (- 1))))
 (let ((?x2820 (g_granule_state (select ?x2784 ?x2805))))
 (let (($x2803 (= ?x2820 6)))
 (let (($x2807 (= ?x2820 4)))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.374003)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.374003))))
 (or $x144 $x26091 $x2807 $x2803 $x2804))))))))))))))))))))))))))))))))))))))
 ))
 (or $x19883 $x2691 $x2786 $x64533)))))))))))))))))))))))
 )
(assert
 (let (($x3825 (forall ((rtt_gidx.374173 Int) (ipa_gidx.374173 Int) (data_gidx.374173 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2225 (div ?x2224 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x3044 (select ?x2276 ?x2225)))
 (let ((?x3099 (g_rec ?x3044)))
 (let ((?x2977 (g_rd ?x3044)))
 (let ((?x4301 (mkabs_PA_t (- 1))))
 (let ((?x4474 (mkabs_PTE_t ?x4301 0 1 0)))
 (let ((?x4224 (test_PTE_Z.0_call ?x4474)))
 (let ((?x3051 (mod ?x2224 4096)))
 (let ((?x2849 (g_norm ?x3044)))
 (let ((?x3926 (store ?x2849 ?x3051 ?x4224)))
 (let ((?x3120 (g_granule_state ?x3044)))
 (let ((?x2369 (gd_g_idx ?x3044)))
 (let ((?x4517 (mkr_granule_data ?x2369 ?x3120 ?x3926 ?x2977 ?x3099)))
 (let ((?x4535 (store ?x2276 ?x2225 ?x4517)))
 (let ((?x26029 (gpt ?x2520)))
 (let ((?x25943 (priv ?x2361)))
 (let ((?x2372 (repl ?x2361)))
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x34341 (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x4535 ?x25875) ?x25896 $x2370)))
 (let ((?x4378 (rtt_walk_abs.0_call ?x34341 rtt_gidx.374173 ipa_gidx.374173)))
 (let ((?x28619 (g_granule_state (select ?x4535 ?x4378))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.374173)))
 (let (($x4452 (=> (and (and (distinct ?x4378 (- 1)) true) $x121) (or (= ?x28619 4) (= ?x28619 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.374173)) 5)))
 (=> (and $x26025 (and (distinct ?x4378 (- 1)) true) $x121) (or (= ?x28619 4) (= ?x28619 6)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3825)))
(check-sat)

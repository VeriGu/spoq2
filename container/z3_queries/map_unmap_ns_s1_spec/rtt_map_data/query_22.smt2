...
(assert
 ...
 (not $x3607)))))))))))))))))))))))))))))))
(assert
 (let ((?x3672 (make_return_code_para.0_call 1)))
 (let ((?x19454 (pack_struct_return_code_para.0_call ?x3672)))
 (let (($x27757 (= ?x19454 0)))
 (not $x27757)))))
(assert
...
(assert
 (let (($x6097 (forall ((rtt_gidx.380021 Int) (ipa_gidx.380021 Int) (data_gidx.380021 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x26845 (query_oracle.0_call ?x2361)))
 (let ((?x3155 (value_RData ?x26845)))
 (let ((?x3349 (rtt_walk_abs.0_call ?x3155 rtt_gidx.380021 ipa_gidx.380021)))
 (let ((?x33973 (share ?x3155)))
 (let ((?x26895 (granule_data ?x33973)))
 (let ((?x27084 (g_granule_state (select ?x26895 ?x3349))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.380021)))
 (let (($x3391 (=> $x121 (or (= ?x27084 4) (= ?x27084 6)))))
 (let (($x18867 (= (e_state_s_granule (select (g_granules (globals ?x33973)) rtt_gidx.380021)) 5)))
 (=> (and $x18867 (and (distinct ?x3349 (- 1)) true) $x121) (or (= ?x27084 4) (= ?x27084 6))))))))))))))))))))))))
 ))
 (not $x6097)))
(check-sat)

...
(assert
 (let (($x2014 (forall ((rtt_gidx.368724 Int) (ipa_gidx.368724 Int) (data_gidx.368724 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1447 (rtt_walk_abs.0_call ?x1426 rtt_gidx.368724 ipa_gidx.368724)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1484 (granule_data ?x1550)))
 (let ((?x1553 (g_granule_state (select ?x1484 ?x1447))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.368724)))
 (let (($x1549 (=> $x121 (or (= ?x1553 4) (= ?x1553 6)))))
 (let (($x1452 (= (e_state_s_granule (select (g_granules (globals ?x1550)) rtt_gidx.368724)) 5)))
 (=> (and $x1452 (and (distinct ?x1447 (- 1)) true) $x121) (or (= ?x1553 4) (= ?x1553 6)))))))))))))
 ))
 (not $x2014)))
(check-sat)

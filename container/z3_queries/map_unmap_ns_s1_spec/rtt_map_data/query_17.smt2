...
(assert
 ...
 (not $x1906)))))))))))))))))))
(assert
 (forall ((rtt_gidx.367583 Int) (ipa_gidx.367583 Int) (data_gidx.367583 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1447 (rtt_walk_abs.0_call ?x1426 rtt_gidx.367583 ipa_gidx.367583)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1484 (granule_data ?x1550)))
 (let ((?x1553 (g_granule_state (select ?x1484 ?x1447))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.367583)))
 (let (($x1549 (=> $x121 (or (= ?x1553 4) (= ?x1553 6)))))
 (let (($x1452 (= (e_state_s_granule (select (g_granules (globals ?x1550)) rtt_gidx.367583)) 5)))
 (=> (and $x1452 (and (distinct ?x1447 (- 1)) true) $x121) (or (= ?x1553 4) (= ?x1553 6)))))))))))))
 )
(assert
 (forall ((v.367593 Int) )(let ((?x1100 (make_return_code_para.0_call v.367593)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.367606 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.367606)) (* (- 1) v.367606)) 0))
 )
(assert
 (forall ((offset.368104 Int) (empty_pte.368104 abs_PTE_t) )(let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.368104)) (- 1)))))
 (let (($x1666 (forall ((rtt_gidx.368100 Int) (ipa_gidx.368100 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let (($x1622 (halt ?x1426)))
 (let ((?x1621 (stack ?x1426)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1476 (globals ?x1550)))
 (let ((?x1163 (div offset.368104 4096)))
 (let ((?x1484 (granule_data ?x1550)))
 (let ((?x1571 (select ?x1484 ?x1163)))
 (let ((?x1647 (g_rec ?x1571)))
 (let ((?x1648 (g_rd ?x1571)))
 (let ((?x1651 (g_granule_state ?x1571)))
 (let ((?x1652 (gd_g_idx ?x1571)))
 (let ((?x1653 (mkr_granule_data ?x1652 ?x1651 (store (g_norm ?x1571) (mod offset.368104 4096) (test_PTE_Z.0_call empty_pte.368104)) ?x1648 ?x1647)))
 (let ((?x1654 (store ?x1484 ?x1163 ?x1653)))
 (let ((?x1615 (gpt ?x1550)))
 (let ((?x1620 (priv ?x1426)))
 (let ((?x1614 (repl ?x1426)))
 (let ((?x1618 (oracle ?x1426)))
 (let ((?x1617 (log ?x1426)))
 (let ((?x1658 (rtt_walk_abs.0_call (mkRData ?x1617 ?x1618 ?x1614 ?x1620 (mkShared ?x1615 ?x1654 ?x1476) ?x1621 $x1622) rtt_gidx.368100 ipa_gidx.368100)))
 (let ((?x1660 (g_granule_state (select ?x1654 ?x1658))))
 (let (($x1661 (= ?x1660 4)))
 (let (($x1663 (= ?x1660 6)))
 (let (($x1664 (= ?x1658 (- 1))))
 (let (($x1634 (not (= (e_state_s_granule (select (g_granules ?x1476) rtt_gidx.368100)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.368100))))
 (or $x144 $x1634 $x1664 $x1663 $x1661)))))))))))))))))))))))))))))
 ))
 (let ((?x1274 (div offset.368104 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1476 (globals ?x1550)))
 (let ((?x1475 (g_granules ?x1476)))
 (let (($x1680 (not (= (e_state_s_granule (select ?x1475 ?x1274)) 5))))
 (let (($x1599 (forall ((rtt_gidx.367987 Int) (ipa_gidx.367987 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1476 (globals ?x1550)))
 (let ((?x1475 (g_granules ?x1476)))
 (let (($x1634 (not (= (e_state_s_granule (select ?x1475 rtt_gidx.367987)) 5))))
 (let ((?x1606 (rtt_walk_abs.0_call ?x1426 rtt_gidx.367987 ipa_gidx.367987)))
 (let (($x1630 (= ?x1606 (- 1))))
 (let ((?x1609 (g_granule_state (select (granule_data ?x1550) ?x1606))))
 (let (($x1629 (= ?x1609 4)))
 (let (($x1628 (= ?x1609 6)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.367987))))
 (or $x144 $x1628 $x1629 $x1630 $x1634))))))))))))))
 ))
 (let (($x1600 (not $x1599)))
 (or $x1600 $x1680 $x1666 $x1394)))))))))))))
 )
(assert
 (forall ((parent_gidx.368645 Int) (pte_z.368645 Int) )(let (($x1805 (forall ((rtt_gidx.368502 Int) (ipa_gidx.368502 Int) )(let (($x144 (not (rtt_is_root.0_call rtt_gidx.368502))))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1606 (rtt_walk_abs.0_call ?x1426 rtt_gidx.368502 ipa_gidx.368502)))
 (let (($x1630 (= ?x1606 (- 1))))
 (let (($x1633 (= (e_state_s_granule (select (g_granules (globals (share ?x1426))) rtt_gidx.368502)) 5)))
 (let (($x1634 (not $x1633)))
 (let ((?x1609 (g_granule_state (select (granule_data (share ?x1426)) ?x1606))))
 (let (($x1629 (= ?x1609 4)))
 (let (($x1628 (= ?x1609 6)))
 (or $x1628 $x1629 $x1634 $x1630 $x144))))))))))))
 ))
 (let (($x1854 (not $x1805)))
 (let ((?x1274 (div parent_gidx.368645 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1476 (globals ?x1550)))
 (let ((?x1475 (g_granules ?x1476)))
 (let (($x1680 (not (= (e_state_s_granule (select ?x1475 ?x1274)) 5))))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.368645))) 4096)))
 (let ((?x1765 (e_state_s_granule (select ?x1475 ?x1280))))
 (let (($x1785 (forall ((rtt_gidx.368641 Int) (ipa_gidx.368641 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let (($x1622 (halt ?x1426)))
 (let ((?x1621 (stack ?x1426)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1476 (globals ?x1550)))
 (let ((?x1163 (div parent_gidx.368645 4096)))
 (let ((?x1484 (granule_data ?x1550)))
 (let ((?x1571 (select ?x1484 ?x1163)))
 (let ((?x1647 (g_rec ?x1571)))
 (let ((?x1648 (g_rd ?x1571)))
 (let ((?x1651 (g_granule_state ?x1571)))
 (let ((?x1652 (gd_g_idx ?x1571)))
 (let ((?x1858 (mkr_granule_data ?x1652 ?x1651 (store (g_norm ?x1571) (mod parent_gidx.368645 4096) pte_z.368645) ?x1648 ?x1647)))
 (let ((?x1801 (store ?x1484 ?x1163 ?x1858)))
 (let ((?x1615 (gpt ?x1550)))
 (let ((?x1620 (priv ?x1426)))
 (let ((?x1614 (repl ?x1426)))
 (let ((?x1618 (oracle ?x1426)))
 (let ((?x1617 (log ?x1426)))
 (let ((?x1820 (rtt_walk_abs.0_call (mkRData ?x1617 ?x1618 ?x1614 ?x1620 (mkShared ?x1615 ?x1801 ?x1476) ?x1621 $x1622) rtt_gidx.368641 ipa_gidx.368641)))
 (let (($x1779 (= ?x1820 (- 1))))
 (let ((?x1781 (g_granule_state (select ?x1801 ?x1820))))
 (let (($x1782 (= ?x1781 4)))
 (let (($x1783 (= ?x1781 6)))
 (let (($x1634 (not (= (e_state_s_granule (select (g_granules ?x1476) rtt_gidx.368641)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.368641))))
 (or $x144 $x1634 $x1783 $x1782 $x1779)))))))))))))))))))))))))))))
 ))
 (or $x1785 (not (or (= ?x1765 0) (= ?x1765 6))) $x1680 $x1854))))))))))))))
 )
(assert
 (let (($x29130 (forall ((rtt_gidx.376038 Int) (ipa_gidx.376038 Int) (data_gidx.376038 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1447 (rtt_walk_abs.0_call ?x1426 rtt_gidx.376038 ipa_gidx.376038)))
 (let ((?x1550 (share ?x1426)))
 (let ((?x1484 (granule_data ?x1550)))
 (let ((?x1553 (g_granule_state (select ?x1484 ?x1447))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.376038)))
 (let (($x1549 (=> $x121 (or (= ?x1553 4) (= ?x1553 6)))))
 (let (($x1452 (= (e_state_s_granule (select (g_granules (globals ?x1550)) rtt_gidx.376038)) 5)))
 (=> (and $x1452 (and (distinct ?x1447 (- 1)) true) $x121) (or (= ?x1553 4) (= ?x1553 6)))))))))))))
 ))
 (not $x29130)))
(check-sat)

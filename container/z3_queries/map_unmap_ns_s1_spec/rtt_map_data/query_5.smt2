...
(assert
 ...
 (= ?x55205 8)))))))))))))))
(assert
 (forall ((rtt_gidx.371404 Int) (ipa_gidx.371404 Int) (data_gidx.371404 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x26845 (query_oracle.0_call ?x2361)))
 (let ((?x3155 (value_RData ?x26845)))
 (let ((?x3349 (rtt_walk_abs.0_call ?x3155 rtt_gidx.371404 ipa_gidx.371404)))
 (let ((?x33973 (share ?x3155)))
 (let ((?x26895 (granule_data ?x33973)))
 (let ((?x27084 (g_granule_state (select ?x26895 ?x3349))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.371404)))
 (let (($x3391 (=> $x121 (or (= ?x27084 4) (= ?x27084 6)))))
 (let (($x18867 (= (e_state_s_granule (select (g_granules (globals ?x33973)) rtt_gidx.371404)) 5)))
 (=> (and $x18867 (and (distinct ?x3349 (- 1)) true) $x121) (or (= ?x27084 4) (= ?x27084 6))))))))))))))))))))))))
 )
(assert
 (forall ((v.371414 Int) )(let ((?x1100 (make_return_code_para.0_call v.371414)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.371427 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.371427)) (* (- 1) v.371427)) 0))
 )
(assert
 (forall ((offset.371925 Int) (empty_pte.371925 abs_PTE_t) )(let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.371925)) (- 1)))))
 (let ((?x1274 (div offset.371925 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x14926 (forall ((rtt_gidx.371921 Int) (ipa_gidx.371921 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x3184 (globals ?x33973)))
 (let ((?x3379 (g_granules ?x3184)))
 (let (($x27163 (not (= (e_state_s_granule (select ?x3379 rtt_gidx.371921)) 5))))
 (let (($x18579 (halt ?x3155)))
 (let ((?x2674 (stack ?x3155)))
 (let ((?x1163 (div offset.371925 4096)))
 (let ((?x26895 (granule_data ?x33973)))
 ...
 (let ((?x3098 (mkr_granule_data ?x3469 ?x3334 (store (g_norm ?x18959) (mod offset.371925 4096) (test_PTE_Z.0_call empty_pte.371925)) ?x3460 ?x18798)))
 ...
 (let ((?x3274 (log ?x3155)))
 (let ((?x3459 (rtt_walk_abs.0_call (mkRData ?x3274 ?x3261 ?x2325 ?x33924 (mkShared ?x18831 ?x3420 ?x3184) ?x2674 $x18579) rtt_gidx.371921 ipa_gidx.371921)))
 (let ((?x3336 (g_granule_state (select ?x3420 ?x3459))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.371921))))
 (or $x144 (= ?x3459 (- 1)) (= ?x3336 4) (= ?x3336 6) $x27163))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3490 (forall ((rtt_gidx.371808 Int) (ipa_gidx.371808 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x26845 (query_oracle.0_call ?x2361)))
 (let ((?x3155 (value_RData ?x26845)))
 (let ((?x3473 (rtt_walk_abs.0_call ?x3155 rtt_gidx.371808 ipa_gidx.371808)))
 (let ((?x33973 (share ?x3155)))
 (let ((?x26895 (granule_data ?x33973)))
 (let ((?x27171 (g_granule_state (select ?x26895 ?x3473))))
 (let (($x27167 (= ?x27171 6)))
 (let (($x27163 (not (= (e_state_s_granule (select (g_granules (globals ?x33973)) rtt_gidx.371808)) 5))))
 (let (($x26795 (= ?x27171 4)))
 (let (($x3426 (= ?x3473 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.371808))))
 (or $x144 $x3426 $x26795 $x27163 $x27167))))))))))))))))))))))))
 ))
 (let (($x3286 (not $x3490)))
 (or $x3286 $x14926 $x18957 $x1394))))))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.372466 Int) (pte_z.372466 Int) )(let (($x3506 (forall ((rtt_gidx.372323 Int) (ipa_gidx.372323 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x26845 (query_oracle.0_call ?x2361)))
 (let ((?x3155 (value_RData ?x26845)))
 (let ((?x3473 (rtt_walk_abs.0_call ?x3155 rtt_gidx.372323 ipa_gidx.372323)))
 (let ((?x33973 (share ?x3155)))
 (let ((?x26895 (granule_data ?x33973)))
 (let ((?x27171 (g_granule_state (select ?x26895 ?x3473))))
 (let (($x26795 (= ?x27171 4)))
 (let (($x27167 (= ?x27171 6)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.372323))))
 (let (($x3426 (= ?x3473 (- 1))))
 (let (($x27163 (not (= (e_state_s_granule (select (g_granules (globals ?x33973)) rtt_gidx.372323)) 5))))
 (or $x27163 $x3426 $x144 $x27167 $x26795))))))))))))))))))))))))
 ))
 (let (($x3552 (not $x3506)))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.372466))) 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x18957 (not (= (e_state_s_granule (select ?x3379 (div parent_gidx.372466 4096))) 5))))
 (let (($x3550 (forall ((rtt_gidx.372462 Int) (ipa_gidx.372462 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x3184 (globals ?x33973)))
 (let ((?x3379 (g_granules ?x3184)))
 (let (($x27163 (not (= (e_state_s_granule (select ?x3379 rtt_gidx.372462)) 5))))
 (let (($x18579 (halt ?x3155)))
 (let ((?x2674 (stack ?x3155)))
 (let ((?x1163 (div parent_gidx.372466 4096)))
 (let ((?x26895 (granule_data ?x33973)))
 (let ((?x18959 (select ?x26895 ?x1163)))
 (let ((?x18798 (g_rec ?x18959)))
 (let ((?x3460 (g_rd ?x18959)))
 (let ((?x3334 (g_granule_state ?x18959)))
 (let ((?x3469 (gd_g_idx ?x18959)))
 (let ((?x3551 (mkr_granule_data ?x3469 ?x3334 (store (g_norm ?x18959) (mod parent_gidx.372466 4096) pte_z.372466) ?x3460 ?x18798)))
 ...
 (let ((?x3261 (oracle ?x3155)))
 (let ((?x3274 (log ?x3155)))
 (let ((?x3557 (rtt_walk_abs.0_call (mkRData ?x3274 ?x3261 ?x2325 ?x33924 (mkShared ?x18831 ?x3492 ?x3184) ?x2674 $x18579) rtt_gidx.372462 ipa_gidx.372462)))
 (let ((?x3086 (g_granule_state (select ?x3492 ?x3557))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.372462))))
 (or $x144 (= ?x3086 6) (= ?x3557 (- 1)) (= ?x3086 4) $x27163))))))))))))))))))))))))))))))))))))))
 ))
 (or $x3550 $x18957 (not (or (= ?x3497 0) (= ?x3497 6))) $x3552))))))))))))))))))))))))
 )
(assert
 (let (($x3692 (forall ((rtt_gidx.372627 Int) (ipa_gidx.372627 Int) (data_gidx.372627 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x3759 (rtt_walk_abs.0_call ?x34884 rtt_gidx.372627 ipa_gidx.372627)))
 (let ((?x3577 (g_granule_state (select ?x27808 ?x3759))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.372627)))
 (let (($x3717 (=> (and (and (distinct ?x3759 (- 1)) true) $x121) (or (= ?x3577 4) (= ?x3577 6)))))
 (let (($x18867 (= (e_state_s_granule (select (g_granules ?x3184) rtt_gidx.372627)) 5)))

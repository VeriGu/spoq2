...
(assert
 ...
 (= ?x55205 8)))))))))))))))
(assert
 (forall ((rtt_gidx.377337 Int) (ipa_gidx.377337 Int) (data_gidx.377337 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x25981 (rtt_walk_abs.0_call ?x2361 rtt_gidx.377337 ipa_gidx.377337)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x18094 (g_granule_state (select ?x2276 ?x25981))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.377337)))
 (let (($x26024 (=> $x121 (or (= ?x18094 4) (= ?x18094 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.377337)) 5)))
 (=> (and $x26025 (and (distinct ?x25981 (- 1)) true) $x121) (or (= ?x18094 4) (= ?x18094 6))))))))))))))))))))))
 )
(assert
 (forall ((v.377347 Int) )(let ((?x1100 (make_return_code_para.0_call v.377347)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.377360 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.377360)) (* (- 1) v.377360)) 0))
 )
(assert
 (forall ((offset.377858 Int) (empty_pte.377858 abs_PTE_t) )(let (($x5086 (forall ((rtt_gidx.377854 Int) (ipa_gidx.377854 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.377854)) 5))))
 (let (($x2370 (halt ?x2361)))
 (let ((?x25896 (stack ?x2361)))
 (let ((?x1163 (div offset.377858 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 ...
 (let ((?x2668 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod offset.377858 4096) (test_PTE_Z.0_call empty_pte.377858)) ?x18164 ?x18165)))
 ...
 (let ((?x2562 (log ?x2361)))
 (let ((?x2680 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2667 ?x25875) ?x25896 $x2370) rtt_gidx.377854 ipa_gidx.377854)))
 (let ((?x2672 (g_granule_state (select ?x2667 ?x2680))))
 (let (($x2689 (= ?x2672 6)))
 (let (($x2675 (= ?x2680 (- 1))))
 (let (($x14289 (= ?x2672 4)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.377854))))
 (or $x144 $x14289 $x2675 $x2689 $x26091)))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.377858)) (- 1)))))
 (let ((?x1274 (div offset.377858 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x21025 (forall ((rtt_gidx.377741 Int) (ipa_gidx.377741 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.377741)) 5))))
 (let ((?x26113 (g_granule_state (select (granule_data ?x2520) (rtt_walk_abs.0_call ?x2361 rtt_gidx.377741 ipa_gidx.377741)))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.377741 ipa_gidx.377741)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.377741))))
 (or $x144 $x2656 $x18166 $x18167 $x26091)))))))))))))))))))))))
 ))
 (let (($x5036 (not $x21025)))
 (or $x5036 $x2691 $x1394 $x5086))))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.378399 Int) (pte_z.378399 Int) )(let (($x4833 (forall ((rtt_gidx.378395 Int) (ipa_gidx.378395 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.378395)) 5))))
 (let (($x2370 (halt ?x2361)))
 (let ((?x25896 (stack ?x2361)))
 (let ((?x1163 (div parent_gidx.378399 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x2616 (select ?x2276 ?x1163)))
 (let ((?x18165 (g_rec ?x2616)))
 (let ((?x18164 (g_rd ?x2616)))
 (let ((?x2666 (g_granule_state ?x2616)))
 (let ((?x2681 (gd_g_idx ?x2616)))
 (let ((?x2779 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod parent_gidx.378399 4096) pte_z.378399) ?x18164 ?x18165)))
 ...
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x2805 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2784 ?x25875) ?x25896 $x2370) rtt_gidx.378395 ipa_gidx.378395)))
 (let (($x2804 (= ?x2805 (- 1))))
 (let ((?x2820 (g_granule_state (select ?x2784 ?x2805))))
 (let (($x2807 (= ?x2820 4)))
 (let (($x2803 (= ?x2820 6)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.378395))))
 (or $x144 $x2803 $x2807 $x2804 $x26091)))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x1274 (div parent_gidx.378399 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x2691 (not (= (e_state_s_granule (select ?x2453 ?x1274)) 5))))
 (let (($x5167 (forall ((rtt_gidx.378256 Int) (ipa_gidx.378256 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.378256 ipa_gidx.378256)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x26113 (g_granule_state (select ?x2276 ?x2644))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.378256))))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.378256)) 5))))
 (let (($x2656 (= ?x2644 (- 1))))
 (or $x2656 $x26091 $x144 $x18166 $x18167))))))))))))))))))))))
 ))
 (let (($x5109 (not $x5167)))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.378399))) 4096)))
 (let ((?x2742 (e_state_s_granule (select ?x2453 ?x1280))))
 (let (($x2786 (not (or (= ?x2742 0) (= ?x2742 6)))))
 (or $x2786 $x5109 $x2691 $x4833))))))))))))))))))))))))
 )
(assert
 (let (($x4949 (forall ((rtt_gidx.378560 Int) (ipa_gidx.378560 Int) (data_gidx.378560 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2990 (mkr_granule_data ?x2369 ?x3120 ?x2925 ?x2977 ?x3099)))
 ...
 (let ((?x3230 (rtt_walk_abs.0_call ?x18469 rtt_gidx.378560 ipa_gidx.378560)))
 (let ((?x3266 (g_granule_state (select ?x3125 ?x3230))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.378560)))
 (let (($x18673 (=> (and (and (distinct ?x3230 (- 1)) true) $x121) (or (= ?x3266 4) (= ?x3266 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.378560)) 5)))

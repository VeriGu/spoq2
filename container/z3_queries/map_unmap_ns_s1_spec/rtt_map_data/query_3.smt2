...
(assert
 ...
 (let ((?x1956 (Some_Z CPU_ID.0)))
 (let ((?x1955 (mks_spinlock_t ?x1956)))
 (let ((?x2996 (mks_granule ?x1955 (e_state_s_granule ?x2962) (e_ref ?x2962))))
...
(assert
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let ((?x55235 (select ?x2453 ?x2225)))
 (let ((?x2947 (e_state_s_granule ?x55235)))
 (= ?x2947 5)))))))))))))))))))))))))
(assert
 (let ((?x2245 (test_Z_PTE.0_call v_3.0)))
 (let ((?x66119 (meta_PA ?x2245)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let ((?x26562 (select ?x2453 ?x3021)))
 (let ((?x2872 (e_state_s_granule ?x26562)))
 (let (($x26630 (= ?x2872 6)))
 (let (($x3127 (= ?x2872 0)))
 (or $x3127 $x26630))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.370023 Int) (ipa_gidx.370023 Int) (data_gidx.370023 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x25981 (rtt_walk_abs.0_call ?x2361 rtt_gidx.370023 ipa_gidx.370023)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x18094 (g_granule_state (select ?x2276 ?x25981))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.370023)))
 (let (($x26024 (=> $x121 (or (= ?x18094 4) (= ?x18094 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.370023)) 5)))
 (=> (and $x26025 (and (distinct ?x25981 (- 1)) true) $x121) (or (= ?x18094 4) (= ?x18094 6))))))))))))))))))))))
 )
(assert
 (forall ((v.370033 Int) )(let ((?x1100 (make_return_code_para.0_call v.370033)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.370046 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.370046)) (* (- 1) v.370046)) 0))
 )
(assert
 (forall ((offset.370544 Int) (empty_pte.370544 abs_PTE_t) )(let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.370544)) (- 1)))))
 (let (($x2678 (forall ((rtt_gidx.370540 Int) (ipa_gidx.370540 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2520 (share ?x2361)))
 (let ((?x25875 (globals ?x2520)))
 (let ((?x1163 (div offset.370544 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 ...
 (let ((?x2668 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod offset.370544 4096) (test_PTE_Z.0_call empty_pte.370544)) ?x18164 ?x18165)))
 ...
 (let ((?x2562 (log ?x2361)))
 (let ((?x2680 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2667 ?x25875) ?x25896 $x2370) rtt_gidx.370540 ipa_gidx.370540)))
 (let ((?x2672 (g_granule_state (select ?x2667 ?x2680))))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.370540)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.370540))))
 (or $x144 $x26091 (= ?x2672 6) (= ?x2680 (- 1)) (= ?x2672 4))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2651 (forall ((rtt_gidx.370427 Int) (ipa_gidx.370427 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.370427)) 5))))
 (let ((?x26113 (g_granule_state (select (granule_data ?x2520) (rtt_walk_abs.0_call ?x2361 rtt_gidx.370427 ipa_gidx.370427)))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.370427 ipa_gidx.370427)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.370427))))
 (or $x144 $x2656 $x18166 $x18167 $x26091)))))))))))))))))))))))
 ))
 (let (($x2641 (not $x2651)))
 (let ((?x1274 (div offset.370544 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (or $x2691 $x2641 $x2678 $x1394))))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.371085 Int) (pte_z.371085 Int) )(let (($x2782 (forall ((rtt_gidx.370942 Int) (ipa_gidx.370942 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.370942 ipa_gidx.370942)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x26113 (g_granule_state (select ?x2276 ?x2644))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.370942)) 5))))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.370942))))
 (or $x144 $x2656 $x26091 $x18166 $x18167))))))))))))))))))))))
 ))
 (let (($x2781 (not $x2782)))
 (let ((?x1274 (div parent_gidx.371085 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x2691 (not (= (e_state_s_granule (select ?x2453 ?x1274)) 5))))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.371085))) 4096)))
 (let ((?x2742 (e_state_s_granule (select ?x2453 ?x1280))))
 (let (($x2809 (forall ((rtt_gidx.371081 Int) (ipa_gidx.371081 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.371081)) 5))))
 (let (($x2370 (halt ?x2361)))
 (let ((?x25896 (stack ?x2361)))
 (let ((?x1163 (div parent_gidx.371085 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x2616 (select ?x2276 ?x1163)))
 (let ((?x18165 (g_rec ?x2616)))
 (let ((?x18164 (g_rd ?x2616)))
 (let ((?x2666 (g_granule_state ?x2616)))
 (let ((?x2681 (gd_g_idx ?x2616)))
 (let ((?x2779 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod parent_gidx.371085 4096) pte_z.371085) ?x18164 ?x18165)))
 ...
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x2805 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2784 ?x25875) ?x25896 $x2370) rtt_gidx.371081 ipa_gidx.371081)))
 (let ((?x2820 (g_granule_state (select ?x2784 ?x2805))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.371081))))
 (or $x144 (= ?x2820 4) (= ?x2805 (- 1)) (= ?x2820 6) $x26091))))))))))))))))))))))))))))))))))))
 ))
 (or $x2809 (not (or (= ?x2742 0) (= ?x2742 6))) $x2691 $x2781)))))))))))))))))))))))
 )
(assert
 (let (($x26836 (forall ((rtt_gidx.371246 Int) (ipa_gidx.371246 Int) (data_gidx.371246 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2925 (store ?x2849 ?x3051 ?x68325)))
 (let ((?x2990 (mkr_granule_data (gd_g_idx ?x3044) (g_granule_state ?x3044) ?x2925 (g_rd ?x3044) (g_rec ?x3044))))
 (let ((?x3125 (store ?x2276 ?x2225 ?x2990)))
 (let ((?x26029 (gpt ?x2520)))
 (let ((?x25943 (priv ?x2361)))
 (let ((?x2372 (repl ?x2361)))
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x18469 (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x3125 ?x25875) ?x25896 $x2370)))
 (let ((?x3230 (rtt_walk_abs.0_call ?x18469 rtt_gidx.371246 ipa_gidx.371246)))
 (let ((?x3266 (g_granule_state (select ?x3125 ?x3230))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.371246)))
 (let (($x18673 (=> (and (and (distinct ?x3230 (- 1)) true) $x121) (or (= ?x3266 4) (= ?x3266 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.371246)) 5)))
 (=> (and $x26025 (and (distinct ?x3230 (- 1)) true) $x121) (or (= ?x3266 4) (= ?x3266 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x26836)))
(check-sat)

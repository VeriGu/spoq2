...
(assert
 ...
 (= ?x55205 8)))))))))))))))
(assert
 (forall ((rtt_gidx.380259 Int) (ipa_gidx.380259 Int) (data_gidx.380259 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x25981 (rtt_walk_abs.0_call ?x2361 rtt_gidx.380259 ipa_gidx.380259)))
 (let ((?x2520 (share ?x2361)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x18094 (g_granule_state (select ?x2276 ?x25981))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.380259)))
 (let (($x26024 (=> $x121 (or (= ?x18094 4) (= ?x18094 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules (globals ?x2520)) rtt_gidx.380259)) 5)))
 (=> (and $x26025 (and (distinct ?x25981 (- 1)) true) $x121) (or (= ?x18094 4) (= ?x18094 6))))))))))))))))))))))
 )
(assert
 (forall ((v.380269 Int) )(let ((?x1100 (make_return_code_para.0_call v.380269)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.380282 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.380282)) (* (- 1) v.380282)) 0))
 )
(assert
 (forall ((offset.380780 Int) (empty_pte.380780 abs_PTE_t) )(let ((?x1274 (div offset.380780 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x22248 (forall ((rtt_gidx.380663 Int) (ipa_gidx.380663 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x25875 (globals ?x2520)))
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x26091 (not (= (e_state_s_granule (select ?x2453 rtt_gidx.380663)) 5))))
 (let ((?x26113 (g_granule_state (select (granule_data ?x2520) (rtt_walk_abs.0_call ?x2361 rtt_gidx.380663 ipa_gidx.380663)))))
 (let (($x18167 (= ?x26113 4)))
 (let (($x18166 (= ?x26113 6)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.380663 ipa_gidx.380663)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.380663))))
 (or $x144 $x2656 $x18166 $x18167 $x26091)))))))))))))))))))))))
 ))
 (let (($x31089 (not $x22248)))
 (let (($x6205 (forall ((rtt_gidx.380776 Int) (ipa_gidx.380776 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2520 (share ?x2361)))
 (let ((?x25875 (globals ?x2520)))
 (let ((?x1163 (div offset.380780 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 ...
 (let ((?x2668 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod offset.380780 4096) (test_PTE_Z.0_call empty_pte.380780)) ?x18164 ?x18165)))
 ...
 (let ((?x2562 (log ?x2361)))
 (let ((?x2680 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2667 ?x25875) ?x25896 $x2370) rtt_gidx.380776 ipa_gidx.380776)))
 (let (($x2675 (= ?x2680 (- 1))))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.380776)) 5))))
 (let ((?x2672 (g_granule_state (select ?x2667 ?x2680))))
 (let (($x14289 (= ?x2672 4)))
 (let (($x2689 (= ?x2672 6)))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.380776))))
 (or $x144 $x2689 $x14289 $x26091 $x2675))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.380780)) (- 1)))))
 (or $x1394 $x6205 $x31089 $x2691))))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.381321 Int) (pte_z.381321 Int) )(let (($x22186 (forall ((rtt_gidx.381178 Int) (ipa_gidx.381178 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2349 (query_oracle.0_call ?x1791)))
 (let ((?x2361 (value_RData ?x2349)))
 (let ((?x2644 (rtt_walk_abs.0_call ?x2361 rtt_gidx.381178 ipa_gidx.381178)))
 (let (($x2656 (= ?x2644 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.381178))))
 (let (($x26090 (= (e_state_s_granule (select (g_granules (globals (share ?x2361))) rtt_gidx.381178)) 5)))
 ...
 (let (($x56776 (not $x22186)))
 (let (($x22614 (forall ((rtt_gidx.381317 Int) (ipa_gidx.381317 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x2520 (share ?x2361)))
 (let ((?x25875 (globals ?x2520)))
 (let ((?x1163 (div parent_gidx.381321 4096)))
 (let ((?x2276 (granule_data ?x2520)))
 (let ((?x2616 (select ?x2276 ?x1163)))
 (let ((?x18165 (g_rec ?x2616)))
 (let ((?x18164 (g_rd ?x2616)))
 (let ((?x2666 (g_granule_state ?x2616)))
 (let ((?x2681 (gd_g_idx ?x2616)))
 (let ((?x2779 (mkr_granule_data ?x2681 ?x2666 (store (g_norm ?x2616) (mod parent_gidx.381321 4096) pte_z.381321) ?x18164 ?x18165)))
 ...
 (let ((?x2348 (oracle ?x2361)))
 (let ((?x2562 (log ?x2361)))
 (let ((?x2805 (rtt_walk_abs.0_call (mkRData ?x2562 ?x2348 ?x2372 ?x25943 (mkShared ?x26029 ?x2784 ?x25875) ?x25896 $x2370) rtt_gidx.381317 ipa_gidx.381317)))
 (let ((?x2820 (g_granule_state (select ?x2784 ?x2805))))
 (let (($x2807 (= ?x2820 4)))
 (let (($x2804 (= ?x2805 (- 1))))
 (let (($x2803 (= ?x2820 6)))
 (let (($x26091 (not (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.381317)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.381317))))
 (or $x144 $x26091 $x2803 $x2804 $x2807))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x1274 (div parent_gidx.381321 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let ((?x2453 (g_granules ?x25875)))
 (let (($x2691 (not (= (e_state_s_granule (select ?x2453 ?x1274)) 5))))
 (let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.381321))) 4096)))
 (let ((?x2742 (e_state_s_granule (select ?x2453 ?x1280))))
 (let (($x2786 (not (or (= ?x2742 0) (= ?x2742 6)))))
 (or $x2786 $x2691 $x22614 $x56776))))))))))))))))))))))))
 )
(assert
 (let (($x5394 (forall ((rtt_gidx.381487 Int) (ipa_gidx.381487 Int) (data_gidx.381487 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x4378 (rtt_walk_abs.0_call ?x34341 rtt_gidx.381487 ipa_gidx.381487)))
 (let ((?x28619 (g_granule_state (select ?x4535 ?x4378))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.381487)))
 (let (($x4452 (=> (and (and (distinct ?x4378 (- 1)) true) $x121) (or (= ?x28619 4) (= ?x28619 6)))))
 (let (($x26025 (= (e_state_s_granule (select (g_granules ?x25875) rtt_gidx.381487)) 5)))

...
(assert
 ...
 (let ((?x1228 (select ?x41 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.68100))) 4096))))
 (let ((?x1298 (e_state_s_granule ?x1228)))
...
(assert
 (forall ((rtt_gidx.41204 Int) (ipa_gidx.41204 Int) (data_gidx.41204 Int) )(let ((?x115 (rtt_walk_abs.0_call st.0 rtt_gidx.41204 ipa_gidx.41204)))
 (let ((?x22 (share st.0)))
 (let ((?x24 (granule_data ?x22)))
 (let ((?x117 (g_granule_state (select ?x24 ?x115))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.41204)))
 (let (($x122 (=> $x121 (or (= ?x117 4) (= ?x117 6)))))
 (let (($x128 (= (e_state_s_granule (select (g_granules (globals ?x22)) rtt_gidx.41204)) 5)))
 (=> (and $x128 (and (distinct ?x115 (- 1)) true) $x121) (or (= ?x117 4) (= ?x117 6)))))))))))
 )
(assert
 (forall ((v.68224 Int) )(let ((?x1100 (make_return_code_para.0_call v.68224)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
...
(assert
 (let (($x1444 (forall ((rtt_gidx.367504 Int) (ipa_gidx.367504 Int) (data_gidx.367504 Int) )(let ((?x115 (rtt_walk_abs.0_call st.0 rtt_gidx.367504 ipa_gidx.367504)))
 (let ((?x22 (share st.0)))
 (let ((?x24 (granule_data ?x22)))
 (let ((?x117 (g_granule_state (select ?x24 ?x115))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.367504)))
 (let (($x122 (=> $x121 (or (= ?x117 4) (= ?x117 6)))))
 (let (($x128 (= (e_state_s_granule (select (g_granules (globals ?x22)) rtt_gidx.367504)) 5)))
 (=> (and $x128 (and (distinct ?x115 (- 1)) true) $x121) (or (= ?x117 4) (= ?x117 6)))))))))))
 ))
 (not $x1444)))
(check-sat)

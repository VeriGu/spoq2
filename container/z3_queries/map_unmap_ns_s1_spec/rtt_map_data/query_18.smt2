...
(assert
 ...
 (not $x2279))))
(assert
 (forall ((rtt_gidx.376117 Int) (ipa_gidx.376117 Int) (data_gidx.376117 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let ((?x1948 (rtt_walk_abs.0_call ?x1791 rtt_gidx.376117 ipa_gidx.376117)))
 (let ((?x1950 (share ?x1791)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2053 (g_granule_state (select ?x4788 ?x1948))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.376117)))
 (let (($x2120 (=> $x121 (or (= ?x2053 4) (= ?x2053 6)))))
 (let (($x1972 (= (e_state_s_granule (select (g_granules (globals ?x1950)) rtt_gidx.376117)) 5)))
 (=> (and $x1972 (and (distinct ?x1948 (- 1)) true) $x121) (or (= ?x2053 4) (= ?x2053 6))))))))))))))))))))
 )
(assert
 (forall ((v.376127 Int) )(let ((?x1100 (make_return_code_para.0_call v.376127)))
 (let ((?x1115 (pack_struct_return_code_para.0_call ?x1100)))
 (and (distinct ?x1115 0) true))))
 )
(assert
 (forall ((v.376140 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.376140)) (* (- 1) v.376140)) 0))
 )
(assert
 (forall ((offset.376638 Int) (empty_pte.376638 abs_PTE_t) )(let (($x28848 (forall ((rtt_gidx.376634 Int) (ipa_gidx.376634 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1950 (share ?x1791)))
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1163 (div offset.376638 4096)))
 (let ((?x4788 (granule_data ?x1950)))
 ...
 (let ((?x2141 (mkr_granule_data ?x2140 ?x2139 (store (g_norm ?x2132) (mod offset.376638 4096) (test_PTE_Z.0_call empty_pte.376638)) ?x2136 ?x2135)))
 ...
 (let ((?x1844 (log ?x1791)))
 (let ((?x2145 (rtt_walk_abs.0_call (mkRData ?x1844 ?x1845 ?x1846 ?x1849 (mkShared ?x1814 ?x2142 ?x1800) ?x1951 $x1890) rtt_gidx.376634 ipa_gidx.376634)))
 (let ((?x2148 (g_granule_state (select ?x2142 ?x2145))))
 (let (($x2150 (= ?x2148 6)))
 (let (($x2146 (= ?x2145 (- 1))))
 (let (($x2149 (= ?x2148 4)))
 (let (($x2089 (not (= (e_state_s_granule (select (g_granules ?x1800) rtt_gidx.376634)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.376634))))
 (or $x144 $x2089 $x2149 $x2146 $x2150))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x1274 (div offset.376638 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x1394 (not (= (meta_granule_offset (meta_PA empty_pte.376638)) (- 1)))))
 (let (($x4585 (forall ((rtt_gidx.376521 Int) (ipa_gidx.376521 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1798 (g_granules ?x1800)))
 (let (($x2089 (not (= (e_state_s_granule (select ?x1798 rtt_gidx.376521)) 5))))
 (let ((?x2081 (g_granule_state (select (granule_data ?x1950) (rtt_walk_abs.0_call ?x1791 rtt_gidx.376521 ipa_gidx.376521)))))
 (let (($x2085 (= ?x2081 4)))
 (let (($x2080 (= ?x2081 6)))
 (let ((?x2052 (rtt_walk_abs.0_call ?x1791 rtt_gidx.376521 ipa_gidx.376521)))
 (let (($x2077 (= ?x2052 (- 1))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.376521))))
 (or $x144 $x2077 $x2080 $x2085 $x2089)))))))))))))))))))))
 ))
 (let (($x3833 (not $x4585)))
 (or $x3833 $x1394 $x2115 $x28848))))))))))))))))))))
 )
(assert
 (forall ((parent_gidx.377179 Int) (pte_z.377179 Int) )(let ((?x1280 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.377179))) 4096)))
 (let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 ...
 (let (($x2315 (not (or (= ?x2296 0) (= ?x2296 6)))))
 (let (($x2115 (not (= (e_state_s_granule (select ?x1798 (div parent_gidx.377179 4096))) 5))))
 (let (($x4743 (forall ((rtt_gidx.377175 Int) (ipa_gidx.377175 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1950 (share ?x1791)))
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1163 (div parent_gidx.377179 4096)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2132 (select ?x4788 ?x1163)))
 (let ((?x2135 (g_rec ?x2132)))
 (let ((?x2136 (g_rd ?x2132)))
 (let ((?x2139 (g_granule_state ?x2132)))
 (let ((?x2140 (gd_g_idx ?x2132)))
 (let ((?x2185 (mkr_granule_data ?x2140 ?x2139 (store (g_norm ?x2132) (mod parent_gidx.377179 4096) pte_z.377179) ?x2136 ?x2135)))
 ...
 (let ((?x1845 (oracle ?x1791)))
 (let ((?x1844 (log ?x1791)))
 (let ((?x2220 (rtt_walk_abs.0_call (mkRData ?x1844 ?x1845 ?x1846 ?x1849 (mkShared ?x1814 ?x2182 ?x1800) ?x1951 $x1890) rtt_gidx.377175 ipa_gidx.377175)))
 (let ((?x2236 (g_granule_state (select ?x2182 ?x2220))))
 (let (($x2203 (= ?x2236 6)))
 (let (($x2205 (= ?x2236 4)))
 (let (($x2202 (= ?x2220 (- 1))))
 (let (($x2089 (not (= (e_state_s_granule (select (g_granules ?x1800) rtt_gidx.377175)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.377175))))
 (or $x144 $x2089 $x2202 $x2205 $x2203))))))))))))))))))))))))))))))))))))
 ))
 (let (($x5029 (forall ((rtt_gidx.377036 Int) (ipa_gidx.377036 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1800 (globals ?x1950)))
 (let ((?x1798 (g_granules ?x1800)))
 (let (($x2089 (not (= (e_state_s_granule (select ?x1798 rtt_gidx.377036)) 5))))
 (let (($x144 (not (rtt_is_root.0_call rtt_gidx.377036))))
 (let ((?x2052 (rtt_walk_abs.0_call ?x1791 rtt_gidx.377036 ipa_gidx.377036)))
 (let (($x2077 (= ?x2052 (- 1))))
 (let ((?x2081 (g_granule_state (select (granule_data ?x1950) ?x2052))))
 (let (($x2085 (= ?x2081 4)))
 (let (($x2080 (= ?x2081 6)))
 (or $x2080 $x2085 $x2077 $x144 $x2089)))))))))))))))))))))
 ))
 (let (($x4323 (not $x5029)))
 (or $x4323 $x4743 $x2115 $x2315)))))))))))))))))))))
 )
(assert
 (let (($x5112 (forall ((rtt_gidx.377258 Int) (ipa_gidx.377258 Int) (data_gidx.377258 Int) )(let ((?x1424 (query_oracle.0_call st.0)))
 (let ((?x1426 (value_RData ?x1424)))
 (let ((?x1940 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1794 (meta_granule_offset ?x1940)))
 (let ((?x924 (mkPtr "granules" ?x1794)))
 ...
 (let ((?x1803 (value_Tuple_abs_ret_rtt_RData ?x1958)))
 (let ((?x1791 (elem_1 ?x1803)))
 (let ((?x1948 (rtt_walk_abs.0_call ?x1791 rtt_gidx.377258 ipa_gidx.377258)))
 (let ((?x1950 (share ?x1791)))
 (let ((?x4788 (granule_data ?x1950)))
 (let ((?x2053 (g_granule_state (select ?x4788 ?x1948))))
 (let (($x121 (rtt_is_root.0_call rtt_gidx.377258)))
 (let (($x2120 (=> $x121 (or (= ?x2053 4) (= ?x2053 6)))))
 (let (($x1972 (= (e_state_s_granule (select (g_granules (globals ?x1950)) rtt_gidx.377258)) 5)))
 (=> (and $x1972 (and (distinct ?x1948 (- 1)) true) $x121) (or (= ?x2053 4) (= ?x2053 6))))))))))))))))))))
 ))
 (not $x5112)))
(check-sat)

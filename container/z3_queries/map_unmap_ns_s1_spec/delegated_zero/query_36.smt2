...
(assert
 ...
 (not $x50524)))))
(assert
 (let (($x41781 (forall ((gidx.6611045 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x45432 (share ?x37551)))
 (let ((?x32091 (granule_data ?x45432)))
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6611045)) 1)))
 (=> $x18861 (= (g_norm (select ?x32091 gidx.6611045)) zero_granule_data)))))))))))))))))
 ))
 (not $x41781)))
(check-sat)

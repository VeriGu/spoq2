...
(assert
 ...
 (= ?x1456 5))))))))))))))))))
(assert
 (forall ((gidx.6608005 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 ...
 (let (($x26358 (= (e_state_s_granule (select (g_granules (globals ?x1197)) gidx.6608005)) 1)))
 (=> $x26358 (= (g_norm (select ?x16791 gidx.6608005)) zero_granule_data)))))))))))))))
 )
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
...
(assert
 ...
 (let (($x46271 (uart0_phys_para.0_call ?x46309)))
 (not $x46271))))
(assert
 (forall ((gidx.6608198 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x1121 (value_Tuple_abs_ret_rtt_RData ?x68211)))
 (let ((?x1211 (elem_1 ?x1121)))
 (let ((?x48233 (query_oracle.0_call ?x1211)))
 (let ((?x37551 (value_RData ?x48233)))
 (let ((?x45432 (share ?x37551)))
 (let ((?x32091 (granule_data ?x45432)))
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6608198)) 1)))
 (=> $x18861 (= (g_norm (select ?x32091 gidx.6608198)) zero_granule_data)))))))))))))))))
 )
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 ...
 (let ((?x37551 (value_RData ?x48233)))
 (let ((?x45432 (share ?x37551)))
 (let ((?x32820 (globals ?x45432)))
 (let ((?x45090 (g_granules ?x32820)))
 (= ?x45090 ?x1472)))))))))))))))))))
(assert
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x70425 (meta_PA ?x46309)))
 (let ((?x21598 (meta_granule_offset ?x70425)))
 (let ((?x92334 (div ?x21598 16)))
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 ...
 (let ((?x32820 (globals ?x45432)))
 (let ((?x45090 (g_granules ?x32820)))
 (let ((?x18146 (select ?x45090 ?x92334)))
 (let ((?x45147 (e_lock ?x18146)))
 (let ((?x29914 (e_val ?x45147)))
 (= ?x29914 None_Z)))))))))))))))))))))))
(assert
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x70425 (meta_PA ?x46309)))
 (let ((?x21598 (meta_granule_offset ?x70425)))
 (let ((?x30417 (div ?x21598 4096)))
 (let ((?x92334 (div ?x21598 16)))
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 ...
 (let ((?x45090 (g_granules ?x32820)))
 (let ((?x18146 (select ?x45090 ?x92334)))
 (let ((?x45393 (e_ref ?x18146)))
 (let ((?x48164 (e_state_s_granule ?x18146)))
 (let ((?x24985 (Some_Z CPU_ID.0)))
 (let ((?x39732 (mks_spinlock_t ?x24985)))
 (let ((?x46357 (mks_granule ?x39732 ?x48164 ?x45393)))
 (let ((?x67426 (store ?x45090 ?x92334 ?x46357)))
 (let ((?x23624 (select ?x67426 ?x30417)))
 (let ((?x63463 (e_state_s_granule ?x23624)))
 (let (($x30307 (= ?x63463 0)))
 (not $x30307)))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.6608391 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x48233 (query_oracle.0_call ?x1211)))
 (let ((?x37551 (value_RData ?x48233)))
 (let ((?x41829 (query_oracle.0_call ?x37551)))
 (let ((?x43404 (value_RData ?x41829)))
 (let ((?x53634 (share ?x43404)))
 (let ((?x75006 (granule_data ?x53634)))
 (let (($x62502 (= (e_state_s_granule (select (g_granules (globals ?x53634)) gidx.6608391)) 1)))
 (=> $x62502 (= (g_norm (select ?x75006 gidx.6608391)) zero_granule_data)))))))))))))))))))
 )
(assert
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x70425 (meta_PA ?x46309)))
 ...
 (let ((?x45393 (e_ref ?x18146)))
 (let ((?x48164 (e_state_s_granule ?x18146)))
 (let ((?x47438 (mks_spinlock_t None_Z)))
 (let ((?x43148 (mks_granule ?x47438 ?x48164 ?x45393)))
 (let ((?x43644 (store ?x45090 ?x92334 ?x43148)))
 (let ((?x41829 (query_oracle.0_call ?x37551)))
 (let ((?x43404 (value_RData ?x41829)))
 (let ((?x53634 (share ?x43404)))
 (let ((?x18599 (globals ?x53634)))
 (let ((?x77402 (g_granules ?x18599)))
 (= ?x77402 ?x43644)))))))))))))))))))))))))))))))
(assert
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x70425 (meta_PA ?x46309)))
 ...
 (let ((?x18599 (globals ?x53634)))
 (let ((?x77402 (g_granules ?x18599)))
 (let ((?x34623 (select ?x77402 ?x92334)))
 (let ((?x48587 (e_lock ?x34623)))
 (let ((?x49093 (e_val ?x48587)))
 (= ?x49093 None_Z)))))))))))))))))))))))))
(assert
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x70425 (meta_PA ?x46309)))
 ...
 (let ((?x24985 (Some_Z CPU_ID.0)))
 (let ((?x39732 (mks_spinlock_t ?x24985)))
 (let ((?x43489 (mks_granule ?x39732 (e_state_s_granule ?x34623) (e_ref ?x34623))))
 (let ((?x46194 (store ?x77402 ?x92334 ?x43489)))
 (let ((?x43369 (select ?x46194 ?x30417)))
 (let ((?x43082 (e_state_s_granule ?x43369)))
 (let (($x54073 (= ?x43082 6)))
 (not $x54073)))))))))))))))))))))))))))))))
(assert
 (let ((?x15825 (make_return_code_para.0_call 1)))
 (let ((?x54355 (pack_struct_return_code_para.0_call ?x15825)))
 (= ?x54355 0))))
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x51673 (forall ((gidx.6608629 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x53634 (share ?x43404)))
 (let ((?x75006 (granule_data ?x53634)))
 (let ((?x43483 (select ?x75006 ?x1410)))
 (let ((?x46309 (test_Z_PTE.0_call v_3.0)))
 (let ((?x47385 (test_PTE_Z.0_call ?x46309)))
 (let ((?x48957 (mod ?x1153 4096)))
 (let ((?x48168 (g_norm ?x43483)))
 (let ((?x53933 (store ?x48168 ?x48957 ?x47385)))
 (let ((?x44859 (mkr_granule_data (gd_g_idx ?x43483) (g_granule_state ?x43483) ?x53933 (g_rd ?x43483) (g_rec ?x43483))))
 (let ((?x53955 (store ?x75006 ?x1410 ?x44859)))
 (let (($x62502 (= (e_state_s_granule (select (g_granules (globals ?x53634)) gidx.6608629)) 1)))
 (=> $x62502 (= (g_norm (select ?x53955 gidx.6608629)) zero_granule_data))))))))))))))))))))))))))))))))))
 ))
 (not $x51673)))
(check-sat)

...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x25431 (forall ((gidx.6609313 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x49188 (store ?x53525 ?x48957 ?x46643)))
 (let ((?x25368 (g_granule_state ?x29722)))
 (let ((?x45808 (gd_g_idx ?x29722)))
 (let ((?x49120 (mkr_granule_data ?x45808 ?x25368 ?x49188 ?x46405 ?x20642)))
 (let ((?x49446 (store ?x16791 ?x1410 ?x49120)))
 (let (($x26358 (= (e_state_s_granule (select (g_granules (globals ?x1197)) gidx.6609313)) 1)))
 (=> $x26358 (= (g_norm (select ?x49446 gidx.6609313)) zero_granule_data)))))))))))))))))))))))))))))))))))
 ))
 (not $x25431)))
(check-sat)

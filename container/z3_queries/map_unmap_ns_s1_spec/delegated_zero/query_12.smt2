...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x18566 (forall ((gidx.6609027 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6609027)) 1)))
 (=> $x18861 (= (g_norm (select ?x48315 gidx.6609027)) zero_granule_data)))))))))))))))))))))))))))))))))))))
 ))
 (not $x18566)))
(check-sat)

...
(assert
 ...
 (not $x70717)))
(assert
 (let (($x18075 (forall ((gidx.6609749 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x1197 (share ?x1211)))
 (let ((?x16791 (granule_data ?x1197)))
 (let (($x26358 (= (e_state_s_granule (select (g_granules (globals ?x1197)) gidx.6609749)) 1)))
 (=> $x26358 (= (g_norm (select ?x16791 gidx.6609749)) zero_granule_data)))))))))))))))
 ))
 (not $x18075)))
(check-sat)

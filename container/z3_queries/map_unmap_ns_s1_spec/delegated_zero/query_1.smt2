...
(assert
 ...
 (let (($x15551 (= (e_state_s_granule (select (g_granules (globals ?x39894)) gidx.6607931)) 1)))
 (=> $x15551 $x25028)))))))))
 )
(assert
 (let ((?x12 (share st.0)))
...
(assert
 ...
 (= ?x1456 5))))))))))))))))))
(assert
 (let (($x18067 (forall ((gidx.6607968 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x39894 (share ?x490)))
 (let ((?x8201 (granule_data ?x39894)))
 (let ((?x18023 (select ?x8201 gidx.6607968)))
 (let (($x25028 (= (g_norm ?x18023) zero_granule_data)))
 (let (($x15551 (= (e_state_s_granule (select (g_granules (globals ?x39894)) gidx.6607968)) 1)))
 (=> $x15551 $x25028)))))))))
 ))
 (not $x18067)))
(check-sat)

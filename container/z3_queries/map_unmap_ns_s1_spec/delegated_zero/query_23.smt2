...
(assert
 ...
 (not $x813)))))))))))))))))))
(assert
 (let (($x19186 (forall ((gidx.6609824 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x39894 (share ?x490)))
 (let ((?x8201 (granule_data ?x39894)))
 (let ((?x18023 (select ?x8201 gidx.6609824)))
 (let (($x25028 (= (g_norm ?x18023) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x39894)) gidx.6609824)) 1) $x25028))))))))
 ))
 (not $x19186)))
(check-sat)

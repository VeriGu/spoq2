...
(assert
 ...
 (not $x46271))))
(assert
 (let (($x19460 (forall ((gidx.6610017 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x1197 (share ?x1211)))
 (let ((?x16791 (granule_data ?x1197)))
 (let (($x26358 (= (e_state_s_granule (select (g_granules (globals ?x1197)) gidx.6610017)) 1)))
 (=> $x26358 (= (g_norm (select ?x16791 gidx.6610017)) zero_granule_data)))))))))))))))
 ))
 (not $x19460)))
(check-sat)

...
(assert
 ...
 (let ((?x46274 (mkPtr "granule_data" ?x1153)))
 (let ((?x54872 (abs_tte_read.0_call ?x46274 ?x1211)))
 (let (($x18758 (uart0_phys_para.0_call ?x54872)))
 (not $x18758))))))))))))))))))))
(assert
 (forall ((gidx.6609387 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6609387)) 1)))
 (=> $x18861 (= (g_norm (select ?x32091 gidx.6609387)) zero_granule_data)))))))))))))))))
 )
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
...
(assert
 ...
 (let ((?x46274 (mkPtr "granule_data" ?x1153)))
 (let ((?x54872 (abs_tte_read.0_call ?x46274 ?x1211)))
 (let ((?x72857 (meta_PA ?x54872)))
 (let ((?x19204 (meta_granule_offset ?x72857)))
 (let ((?x49462 (div ?x19204 16)))
 (let ((?x48233 (query_oracle.0_call ?x1211)))
 (let ((?x37551 (value_RData ?x48233)))
 (let ((?x45432 (share ?x37551)))
 (let ((?x32820 (globals ?x45432)))
 (let ((?x45090 (g_granules ?x32820)))
 (let ((?x17772 (select ?x45090 ?x49462)))
 (let ((?x48513 (e_lock ?x17772)))
 (let ((?x61332 (e_val ?x48513)))
 (= ?x61332 None_Z))))))))))))))))))))))))))))))
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 ...
 (let ((?x24985 (Some_Z CPU_ID.0)))
 (let ((?x39732 (mks_spinlock_t ?x24985)))
 (let ((?x25567 (mks_granule ?x39732 (e_state_s_granule ?x17772) (e_ref ?x17772))))
 (let ((?x51878 (store ?x45090 ?x49462 ?x25567)))
 (let ((?x49516 (select ?x51878 ?x49448)))
 (let ((?x49624 (e_state_s_granule ?x49516)))
 (let (($x25922 (= ?x49624 6)))
 (not $x25922))))))))))))))))))))))))))))))))))))
(assert
...
(assert
 ...
 (let ((?x724 (poffset ?x1302)))
 (let (($x53171 (>= ?x724 0)))
 (let ((?x34221 (mod ?x724 4096)))
 (let (($x54275 (= ?x34221 0)))
 (let ((?x46039 (pbase ?x1302)))
 (let (($x46166 (= ?x46039 "granules")))
 (and $x46166 $x54275 $x53171))))))))))))))))))
(assert
 (let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x51914 (forall ((gidx.6609635 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x45432 (share ?x37551)))
 (let ((?x32091 (granule_data ?x45432)))
 (let ((?x34116 (select ?x32091 ?x1410)))
 (let ((?x56312 (g_rec ?x34116)))
 (let ((?x43689 (g_rd ?x34116)))
 (let ((?x33685 (mkabs_PA_t (- 1))))
 (let ((?x54280 (mkabs_PTE_t ?x33685 0 1 0)))
 (let ((?x46643 (test_PTE_Z.0_call ?x54280)))
 (let ((?x48957 (mod ?x1153 4096)))
 (let ((?x48433 (g_norm ?x34116)))
 (let ((?x58794 (store ?x48433 ?x48957 ?x46643)))
 (let ((?x45801 (g_granule_state ?x34116)))
 (let ((?x43754 (gd_g_idx ?x34116)))
 (let ((?x53648 (mkr_granule_data ?x43754 ?x45801 ?x58794 ?x43689 ?x56312)))
 (let ((?x48315 (store ?x32091 ?x1410 ?x53648)))
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6609635)) 1)))
 (=> $x18861 (= (g_norm (select ?x48315 gidx.6609635)) zero_granule_data)))))))))))))))))))))))))))))))))))))
 ))
 (not $x51914)))
(check-sat)

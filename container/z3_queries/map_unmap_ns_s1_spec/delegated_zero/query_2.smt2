...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x47678 (forall ((gidx.6608124 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let (($x26358 (= (e_state_s_granule (select (g_granules (globals ?x1197)) gidx.6608124)) 1)))
 (=> $x26358 (= (g_norm (select ?x29702 gidx.6608124)) zero_granule_data))))))))))))))))))))))))))))))))))
 ))
 (not $x47678)))
(check-sat)

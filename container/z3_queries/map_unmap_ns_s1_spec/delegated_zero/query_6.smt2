...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x53106 (forall ((gidx.6608510 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let (($x62502 (= (e_state_s_granule (select (g_granules (globals ?x53634)) gidx.6608510)) 1)))
 (=> $x62502 (= (g_norm (select ?x53955 gidx.6608510)) zero_granule_data))))))))))))))))))))))))))))))))))
 ))
 (not $x53106)))
(check-sat)

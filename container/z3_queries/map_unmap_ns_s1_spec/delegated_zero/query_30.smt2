...
(assert
 ...
 (not $x50524)))))
(assert
 (let (($x27560 (forall ((gidx.6610523 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x53634 (share ?x43404)))
 (let ((?x75006 (granule_data ?x53634)))
 (let (($x62502 (= (e_state_s_granule (select (g_granules (globals ?x53634)) gidx.6610523)) 1)))
 (=> $x62502 (= (g_norm (select ?x75006 gidx.6610523)) zero_granule_data)))))))))))))))))))
 ))
 (not $x27560)))
(check-sat)

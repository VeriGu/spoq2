...
(assert
 ...
 (= ?x158658 8)))))))))))))))
(assert
 (let (($x56262 (forall ((gidx.6608317 Int) )(let ((?x441 (query_oracle.0_call st.0)))
 (let ((?x490 (value_RData ?x441)))
 (let ((?x1336 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x1329 (meta_granule_offset ?x1336)))
 (let ((?x1455 (mkPtr "granules" ?x1329)))
 ...
 (let ((?x42702 (store ?x48433 ?x48957 ?x47385)))
 (let ((?x45801 (g_granule_state ?x34116)))
 (let ((?x43754 (gd_g_idx ?x34116)))
 (let ((?x43957 (mkr_granule_data ?x43754 ?x45801 ?x42702 ?x43689 ?x56312)))
 (let ((?x56341 (store ?x32091 ?x1410 ?x43957)))
 (let (($x18861 (= (e_state_s_granule (select (g_granules (globals ?x45432)) gidx.6608317)) 1)))
 (=> $x18861 (= (g_norm (select ?x56341 gidx.6608317)) zero_granule_data))))))))))))))))))))))))))))))))))))
 ))
 (not $x56262)))
(check-sat)

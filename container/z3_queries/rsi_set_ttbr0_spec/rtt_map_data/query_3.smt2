...
(assert
 (let (($x970 (forall ((rtt_gidx.60013 Int) (ipa_gidx.60013 Int) (data_gidx.60013 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 (let ((?x599 (rtt_walk_abs.0_call ?x364 rtt_gidx.60013 ipa_gidx.60013)))
 (let ((?x585 (share ?x364)))
 (let ((?x384 (granule_data ?x585)))
 (let ((?x601 (g_granule_state (select ?x384 ?x599))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.60013)))
 (let (($x607 (=> (and (and (distinct ?x599 (- 1)) true) $x291) (or (= ?x601 4) (= ?x601 6)))))
 (let (($x610 (= (e_state_s_granule (select (g_granules (globals ?x585)) rtt_gidx.60013)) 5)))
 (=> (and $x610 (and (distinct ?x599 (- 1)) true) $x291) (or (= ?x601 4) (= ?x601 6))))))))))))))))
 ))
 (not $x970)))
(check-sat)

...
(assert
 (let (($x740 (forall ((rtt_gidx.59674 Int) (ipa_gidx.59674 Int) (data_gidx.59674 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x744 (rtt_walk_abs.0_call ?x748 rtt_gidx.59674 ipa_gidx.59674)))
 (let ((?x8211 (g_granule_state (select ?x735 ?x744))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.59674)))
 (let (($x733 (=> (and (and (distinct ?x744 (- 1)) true) $x291) (or (= ?x8211 4) (= ?x8211 6)))))
 (let (($x610 (= (e_state_s_granule (select (g_granules ?x587) rtt_gidx.59674)) 5)))
 (=> (and $x610 (and (distinct ?x744 (- 1)) true) $x291) (or (= ?x8211 4) (= ?x8211 6))))))))))))))))))))))))))))))))))))))
 ))
 (not $x740)))
(check-sat)

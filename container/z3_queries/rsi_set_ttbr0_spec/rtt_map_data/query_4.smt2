...
(assert
 (forall ((rtt_gidx.60092 Int) (ipa_gidx.60092 Int) (data_gidx.60092 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 (let ((?x33702 (spinlock_release_spec.0_call ?x391 ?x364)))
 (let ((?x931 (value_RData ?x33702)))
 (let ((?x889 (rtt_walk_abs.0_call ?x931 rtt_gidx.60092 ipa_gidx.60092)))
 (let ((?x890 (share ?x931)))
 (let ((?x878 (granule_data ?x890)))
 (let ((?x916 (g_granule_state (select ?x878 ?x889))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.60092)))
 (let (($x969 (=> (and (and (distinct ?x889 (- 1)) true) $x291) (or (= ?x916 4) (= ?x916 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x890)) rtt_gidx.60092)) 5) (and (distinct ?x889 (- 1)) true) $x291) (or (= ?x916 4) (= ?x916 6)))))))))))))))))
 )
(assert
 (forall ((v.60102 Int) )(let ((?x263 (make_return_code_para.0_call v.60102)))
 (let ((?x264 (pack_struct_return_code_para.0_call ?x263)))
 (and (distinct ?x264 0) true))))
 )
(assert
 (forall ((v.60115 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.60115)) (* (- 1) v.60115)) 0))
 )
(assert
 (forall ((rtt_gidx.60193 Int) (ipa_gidx.60193 Int) (i.60193 Int) (d.60193 r_granule_data) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x931 (value_RData ?x33702)))
 (let (($x8537 (halt ?x931)))
 (let ((?x8527 (stack ?x931)))
 (let ((?x890 (share ?x931)))
 (let ((?x891 (globals ?x890)))
 (let ((?x880 (gpt ?x890)))
 (let ((?x981 (priv ?x931)))
 (let ((?x978 (repl ?x931)))
 (let ((?x976 (oracle ?x931)))
 (let ((?x973 (log ?x931)))
 (let ((?x906 (mkRData ?x973 ?x976 ?x978 ?x981 (mkShared ?x880 (store (granule_data ?x890) i.60193 d.60193) ?x891) ?x8527 $x8537)))
 (let ((?x984 (+ (rtt_walk_abs.0_call ?x931 rtt_gidx.60193 ipa_gidx.60193) (* (- 1) (rtt_walk_abs.0_call ?x906 rtt_gidx.60193 ipa_gidx.60193)))))
 (let (($x992 (and (not (= (e_state_s_granule (select (g_granules ?x891) i.60193)) 5)) (not (= (e_state_s_granule (select (g_granules ?x891) i.60193)) 4)))))
 (=> $x992 (= ?x984 0))))))))))))))))))))))
 )
(assert
 (let (($x1010 (forall ((rtt_gidx.60273 Int) (ipa_gidx.60273 Int) (data_gidx.60273 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 (let ((?x33702 (spinlock_release_spec.0_call ?x391 ?x364)))
 (let ((?x931 (value_RData ?x33702)))
 (let ((?x889 (rtt_walk_abs.0_call ?x931 rtt_gidx.60273 ipa_gidx.60273)))
 (let ((?x890 (share ?x931)))
 (let ((?x878 (granule_data ?x890)))
 (let ((?x916 (g_granule_state (select ?x878 ?x889))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.60273)))
 (let (($x969 (=> (and (and (distinct ?x889 (- 1)) true) $x291) (or (= ?x916 4) (= ?x916 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x890)) rtt_gidx.60273)) 5) (and (distinct ?x889 (- 1)) true) $x291) (or (= ?x916 4) (= ?x916 6)))))))))))))))))
 ))
 (not $x1010)))
(check-sat)

...
(declare-fun test_Ptr_Z.0_call (Ptr) Int)
(assert
...
(assert
 ...
 (= ?x130 "granule_data")))
(assert
 (let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x685 (div ?x8166 4096)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 (let ((?x585 (share ?x364)))
 (let ((?x587 (globals ?x585)))
 (let ((?x382 (g_granules ?x587)))
 (let ((?x704 (select ?x382 ?x685)))
 (let ((?x705 (e_state_s_granule ?x704)))
 (= ?x705 5)))))))))))))
(assert
 (let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let (($x747 (>= ?x8166 0)))
 (let ((?x18352 (mod ?x8166 4096)))
 (let (($x746 (= ?x18352 0)))
 (and $x746 $x747)))))))
(assert
 (let ((?x133 (poffset v_0.0)))
 ...
 (let ((?x587 (globals ?x585)))
 (let ((?x382 (g_granules ?x587)))
 (let ((?x8458 (select ?x382 ?x354)))
 (let ((?x394 (e_state_s_granule ?x8458)))
 (= ?x394 3))))))))))))))
(assert
 ...
 (let (($x291 (rtt_is_root.0_call rtt_gidx.37708)))
 (let (($x294 (=> (and (and (distinct ?x285 (- 1)) true) $x291) (or (= ?x287 4) (= ?x287 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x23)) rtt_gidx.37708)) 5) (and (distinct ?x285 (- 1)) true) $x291) (or (= ?x287 4) (= ?x287 6))))))))))
 )
(assert
...
(assert
 (forall ((rtt_gidx.59494 Int) (ipa_gidx.59494 Int) (data_gidx.59494 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 (let ((?x599 (rtt_walk_abs.0_call ?x364 rtt_gidx.59494 ipa_gidx.59494)))
 (let ((?x585 (share ?x364)))
 (let ((?x384 (granule_data ?x585)))
 (let ((?x601 (g_granule_state (select ?x384 ?x599))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.59494)))
 (let (($x607 (=> (and (and (distinct ?x599 (- 1)) true) $x291) (or (= ?x601 4) (= ?x601 6)))))
 (let (($x610 (= (e_state_s_granule (select (g_granules (globals ?x585)) rtt_gidx.59494)) 5)))
 (=> (and $x610 (and (distinct ?x599 (- 1)) true) $x291) (or (= ?x601 4) (= ?x601 6))))))))))))))))
 )
(assert
 (forall ((v.59504 Int) )(let ((?x263 (make_return_code_para.0_call v.59504)))
 (let ((?x264 (pack_struct_return_code_para.0_call ?x263)))
 (and (distinct ?x264 0) true))))
 )
(assert
 (forall ((v.59517 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.59517)) (* (- 1) v.59517)) 0))
 )
(assert
 (forall ((rtt_gidx.59595 Int) (ipa_gidx.59595 Int) (i.59595 Int) (d.59595 r_granule_data) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x677 (priv ?x364)))
 (let ((?x676 (repl ?x364)))
 (let ((?x675 (oracle ?x364)))
 (let ((?x671 (log ?x364)))
 (let ((?x688 (mkRData ?x671 ?x675 ?x676 ?x677 (mkShared ?x667 (store (granule_data ?x585) i.59595 d.59595) ?x587) ?x678 $x679)))
 (let ((?x692 (+ (rtt_walk_abs.0_call ?x364 rtt_gidx.59595 ipa_gidx.59595) (* (- 1) (rtt_walk_abs.0_call ?x688 rtt_gidx.59595 ipa_gidx.59595)))))
 (let (($x700 (and (not (= (e_state_s_granule (select (g_granules ?x587) i.59595)) 5)) (not (= (e_state_s_granule (select (g_granules ?x587) i.59595)) 4)))))
 (=> $x700 (= ?x692 0))))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.59753 Int) (ipa_gidx.59753 Int) (data_gidx.59753 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x133 (poffset v_0.0)))
 (let ((?x763 (+ 1536 ?x133)))
 (let ((?x25291 (div ?x763 4096)))
 (let ((?x384 (granule_data ?x585)))
 (let ((?x765 (select ?x384 ?x25291)))
 (let ((?x775 (+ 392 ?x133)))
 (let ((?x754 (mod ?x775 4096)))
 (let ((?x749 (test_Ptr_Z.0_call ?x391)))
 (let ((?x767 (mod ?x763 4096)))
 (let ((?x738 (g_norm ?x765)))
 (let ((?x751 (store ?x738 ?x767 ?x749)))
 (let ((?x713 (store ?x751 ?x754 v_1.0)))
 (let ((?x717 (mkr_granule_data (gd_g_idx ?x765) (g_granule_state ?x765) ?x713 (g_rd ?x765) (g_rec ?x765))))
 (let ((?x735 (store ?x384 ?x25291 ?x717)))
 (let ((?x667 (gpt ?x585)))
 (let ((?x677 (priv ?x364)))
 (let ((?x676 (repl ?x364)))
 (let ((?x675 (oracle ?x364)))
 (let ((?x671 (log ?x364)))
 (let ((?x748 (mkRData ?x671 ?x675 ?x676 ?x677 (mkShared ?x667 ?x735 ?x587) ?x678 $x679)))
 (let ((?x8319 (granule_unlock_spec.0_call ?x391 ?x748)))
 (let ((?x771 (value_RData ?x8319)))
 (let ((?x813 (rtt_walk_abs.0_call ?x771 rtt_gidx.59753 ipa_gidx.59753)))
 (let ((?x809 (share ?x771)))
 (let ((?x824 (granule_data ?x809)))
 (let ((?x727 (g_granule_state (select ?x824 ?x813))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.59753)))
 (let (($x821 (=> (and (and (distinct ?x813 (- 1)) true) $x291) (or (= ?x727 4) (= ?x727 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x809)) rtt_gidx.59753)) 5) (and (distinct ?x813 (- 1)) true) $x291) (or (= ?x727 4) (= ?x727 6)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v.59763 Int) )(let ((?x263 (make_return_code_para.0_call v.59763)))
 (let ((?x264 (pack_struct_return_code_para.0_call ?x263)))
 (and (distinct ?x264 0) true))))
 )
(assert
 (forall ((v.59776 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.59776)) (* (- 1) v.59776)) 0))
 )
(assert
 (forall ((rtt_gidx.59854 Int) (ipa_gidx.59854 Int) (i.59854 Int) (d.59854 r_granule_data) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x836 (stack ?x771)))
 (let ((?x809 (share ?x771)))
 (let ((?x806 (globals ?x809)))
 (let ((?x8376 (gpt ?x809)))
 (let ((?x835 (priv ?x771)))
 (let ((?x834 (repl ?x771)))
 (let ((?x769 (oracle ?x771)))
 (let ((?x830 (log ?x771)))
 (let ((?x846 (mkRData ?x830 ?x769 ?x834 ?x835 (mkShared ?x8376 (store (granule_data ?x809) i.59854 d.59854) ?x806) ?x836 $x837)))
 (let ((?x850 (+ (rtt_walk_abs.0_call ?x771 rtt_gidx.59854 ipa_gidx.59854) (* (- 1) (rtt_walk_abs.0_call ?x846 rtt_gidx.59854 ipa_gidx.59854)))))
 (let (($x859 (and (not (= (e_state_s_granule (select (g_granules ?x806) i.59854)) 5)) (not (= (e_state_s_granule (select (g_granules ?x806) i.59854)) 4)))))
 (=> $x859 (= ?x850 0))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x877 (forall ((rtt_gidx.59934 Int) (ipa_gidx.59934 Int) (data_gidx.59934 Int) )(let ((?x378 (test_PA.0_call v_1.0)))
 (let ((?x8166 (meta_granule_offset ?x378)))
 (let ((?x391 (mkPtr "granules" ?x8166)))
 (let ((?x374 (spinlock_acquire_spec.0_call ?x391 st.0)))
 (let ((?x364 (value_RData ?x374)))
 ...
 (let ((?x8319 (granule_unlock_spec.0_call ?x391 ?x748)))
 (let ((?x771 (value_RData ?x8319)))
 (let ((?x813 (rtt_walk_abs.0_call ?x771 rtt_gidx.59934 ipa_gidx.59934)))
 (let ((?x809 (share ?x771)))
 (let ((?x824 (granule_data ?x809)))
 (let ((?x727 (g_granule_state (select ?x824 ?x813))))
 (let (($x291 (rtt_is_root.0_call rtt_gidx.59934)))
 (let (($x821 (=> (and (and (distinct ?x813 (- 1)) true) $x291) (or (= ?x727 4) (= ?x727 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x809)) rtt_gidx.59934)) 5) (and (distinct ?x813 (- 1)) true) $x291) (or (= ?x727 4) (= ?x727 6)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x877)))
(check-sat)

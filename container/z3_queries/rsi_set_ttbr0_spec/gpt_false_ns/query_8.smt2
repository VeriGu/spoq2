...
(declare-fun find_lock_granule_spec.0_call (Int Int RData) Option_Tuple_Ptr_RData)
(declare-fun land (Int Int) Int)
(declare-fun v_1.0 () Int)
(declare-fun ptr_eqb.0_call (Ptr Ptr) Bool)
...
(declare-fun store_RData.0_call (Int Ptr Int RData) Option_RData)
(declare-fun ptr_to_int.0_call (Ptr) Int)
(declare-fun ptr_offset.0_call (Ptr Int) Ptr)
(declare-fun iasm_82_spec.0_call (Int RData) Option_RData)
(declare-fun iasm_12_isb_spec.0_call (RData) Option_RData)
(declare-fun granule_unlock_spec.0_call (Ptr RData) Option_RData)
(assert
 (let ((?x108 (poffset v_0.0)))
 (let ((?x4256 (div ?x108 4096)))
 (let ((?x202 (share st.0)))
 (let ((?x211 (granule_data ?x202)))
 (let ((?x225 (select ?x211 ?x4256)))
 (let ((?x201 (g_granule_state ?x225)))
 (= ?x201 3))))))))
(assert
 (let ((?x108 (poffset v_0.0)))
 (let (($x112 (>= ?x108 0)))
 (let ((?x1328 (mod ?x108 4096)))
 (let (($x246 (= ?x1328 0)))
 (let ((?x105 (pbase v_0.0)))
 (let (($x243 (= ?x105 "granule_data")))
 (and $x243 $x246 $x112))))))))
(assert
 (let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x217 (elem_0 ?x216)))
 (let ((?x1572 (poffset ?x217)))
 (let (($x219 (>= ?x1572 0)))
 (let ((?x234 (mod ?x1572 16)))
 (let (($x218 (= ?x234 0)))
 (and $x218 $x219))))))))))
(assert
 (let ((?x1288 (land v_1.0 281474976710654)))
 ...
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x217 (elem_0 ?x216)))
 (let ((?x1808 (pbase ?x217)))
 (let (($x270 (= ?x1808 "null")))
 (let (($x1811 (= ?x1808 "granules")))
 (or $x1811 $x270)))))))))
(assert
 (let ((?x205 (mkPtr "null" 0)))
 (let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x217 (elem_0 ?x216)))
 (let (($x32365 (ptr_eqb.0_call ?x217 ?x205)))
 (not $x32365))))))))
(assert
 (forall ((gidx.37441 Int) )(let ((?x202 (share st.0)))
 (let ((?x257 (globals ?x202)))
 (let ((?x278 (g_granules ?x257)))
 (let ((?x294 (select ?x278 gidx.37441)))
 (let ((?x293 (e_state_s_granule ?x294)))
 (let (($x292 (= ?x293 6)))
 (let (($x291 (= ?x293 0)))
 (=> (not (select (gpt ?x202) gidx.37441)) (or $x291 $x292))))))))))
 )
(assert
 (forall ((v.38093 Int) )(let ((?x320 (make_return_code_para.0_call v.38093)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.37969 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.37969)) (* (- 1) v.37969)) 0))
 )
(assert
 (forall ((gidx.70664 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x9299 (share ?x252)))
 (let ((?x537 (globals ?x9299)))
 (let ((?x535 (g_granules ?x537)))
 (let ((?x542 (select ?x535 gidx.70664)))
 (let ((?x543 (e_state_s_granule ?x542)))
 (let (($x544 (= ?x543 6)))
 (let (($x545 (= ?x543 0)))
 (=> (not (select (gpt ?x9299) gidx.70664)) (or $x545 $x544))))))))))))))
 )
(assert
 (forall ((v.70674 Int) )(let ((?x320 (make_return_code_para.0_call v.70674)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.70687 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.70687)) (* (- 1) v.70687)) 0))
 )
(assert
 (forall ((gidx.70986 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 (let ((?x253 (ptr_to_int.0_call ?x217)))
 (let ((?x1302 (ptr_offset.0_call v_0.0 1536)))
 (let ((?x235 (store_RData.0_call 8 ?x1302 ?x253 ?x252)))
 (let ((?x238 (value_RData ?x235)))
 (let ((?x36962 (share ?x238)))
 (let ((?x8154 (globals ?x36962)))
 (let ((?x8108 (g_granules ?x8154)))
 (let ((?x563 (select ?x8108 gidx.70986)))
 (let ((?x629 (e_state_s_granule ?x563)))
 (let (($x630 (= ?x629 6)))
 (let (($x628 (= ?x629 0)))
 (let (($x592 (or $x628 $x630)))
 (=> (not (select (gpt ?x36962) gidx.70986)) $x592)))))))))))))))))))
 )
(assert
 (forall ((v.70996 Int) )(let ((?x320 (make_return_code_para.0_call v.70996)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.71009 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.71009)) (* (- 1) v.71009)) 0))
 )
(assert
 (forall ((gidx.71119 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 ...
 (let ((?x235 (store_RData.0_call 8 ?x1302 ?x253 ?x252)))
 (let ((?x238 (value_RData ?x235)))
 (let ((?x239 (ptr_offset.0_call v_0.0 392)))
 (let ((?x259 (store_RData.0_call 8 ?x239 v_1.0 ?x238)))
 (let ((?x280 (value_RData ?x259)))
 (let ((?x35553 (share ?x280)))
 (let ((?x665 (globals ?x35553)))
 (let ((?x649 (g_granules ?x665)))
 (let ((?x664 (select ?x649 gidx.71119)))
 (let ((?x646 (e_state_s_granule ?x664)))
 (let (($x647 (= ?x646 6)))
 (let (($x643 (= ?x646 0)))
 (=> (not (select (gpt ?x35553) gidx.71119)) (or $x643 $x647))))))))))))))))))))))
 )
(assert
 (forall ((v.71129 Int) )(let ((?x320 (make_return_code_para.0_call v.71129)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.71142 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.71142)) (* (- 1) v.71142)) 0))
 )
(assert
 (forall ((gidx.71252 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 ...
 (let ((?x259 (store_RData.0_call 8 ?x239 v_1.0 ?x238)))
 (let ((?x280 (value_RData ?x259)))
 (let ((?x281 (iasm_82_spec.0_call v_1.0 ?x280)))
 (let ((?x283 (value_RData ?x281)))
 (let ((?x43612 (share ?x283)))
 (let ((?x700 (globals ?x43612)))
 (let ((?x684 (g_granules ?x700)))
 (let ((?x702 (select ?x684 gidx.71252)))
 (let ((?x701 (e_state_s_granule ?x702)))
 (let (($x699 (= ?x701 6)))
 (let (($x680 (= ?x701 0)))
 (=> (not (select (gpt ?x43612) gidx.71252)) (or $x680 $x699))))))))))))))))))))))))
 )
(assert
 (forall ((v.71262 Int) )(let ((?x320 (make_return_code_para.0_call v.71262)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.71275 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.71275)) (* (- 1) v.71275)) 0))
 )
(assert
 (forall ((gidx.71385 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 ...
 (let ((?x281 (iasm_82_spec.0_call v_1.0 ?x280)))
 (let ((?x283 (value_RData ?x281)))
 (let ((?x284 (iasm_12_isb_spec.0_call ?x283)))
 (let ((?x286 (value_RData ?x284)))
 (let ((?x51396 (share ?x286)))
 (let ((?x735 (globals ?x51396)))
 (let ((?x682 (g_granules ?x735)))
 (let ((?x739 (select ?x682 gidx.71385)))
 (let ((?x738 (e_state_s_granule ?x739)))
 (let (($x737 (= ?x738 6)))
 (let (($x736 (= ?x738 0)))
 (=> (not (select (gpt ?x51396) gidx.71385)) (or $x736 $x737))))))))))))))))))))))))))
 )
(assert
 (forall ((v.71395 Int) )(let ((?x320 (make_return_code_para.0_call v.71395)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.71408 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.71408)) (* (- 1) v.71408)) 0))
 )
(assert
 (forall ((gidx.71518 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 ...
 (let ((?x284 (iasm_12_isb_spec.0_call ?x283)))
 (let ((?x286 (value_RData ?x284)))
 (let ((?x287 (granule_unlock_spec.0_call ?x217 ?x286)))
 (let ((?x289 (value_RData ?x287)))
 (let ((?x71036 (share ?x289)))
 (let ((?x767 (globals ?x71036)))
 (let ((?x721 (g_granules ?x767)))
 (let ((?x773 (select ?x721 gidx.71518)))
 (let ((?x772 (e_state_s_granule ?x773)))
 (let (($x771 (= ?x772 6)))
 (let (($x770 (= ?x772 0)))
 (=> (not (select (gpt ?x71036) gidx.71518)) (or $x770 $x771))))))))))))))))))))))))))))
 )
(assert
 (forall ((v.71528 Int) )(let ((?x320 (make_return_code_para.0_call v.71528)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.71541 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.71541)) (* (- 1) v.71541)) 0))
 )
(assert
 (let (($x20410 (forall ((gidx.71597 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x217 (elem_0 ?x216)))
 ...
 (let ((?x767 (globals ?x71036)))
 (let ((?x721 (g_granules ?x767)))
 (let ((?x773 (select ?x721 gidx.71597)))
 (let ((?x772 (e_state_s_granule ?x773)))
 (let (($x771 (= ?x772 6)))
 (let (($x770 (= ?x772 0)))
 (=> (not (select (gpt ?x71036) gidx.71597)) (or $x770 $x771))))))))))))))))))))))))))))
 ))
 (not $x20410)))
(check-sat)

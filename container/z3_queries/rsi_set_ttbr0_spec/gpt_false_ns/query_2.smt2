...
(declare-fun pack_return_code_spec.0_call (Int Int RData) Option_Tuple_Z_RData)
(assert
...
(assert
 (forall ((gidx.70797 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x1803 (pack_return_code_spec.0_call 1 2 ?x252)))
 (let ((?x1791 (value_Tuple_Z_RData ?x1803)))
 (let ((?x1319 (elem_1 ?x1791)))
 (let ((?x42214 (share ?x1319)))
 (let ((?x562 (globals ?x42214)))
 (let ((?x9305 (g_granules ?x562)))
 (let ((?x565 (select ?x9305 gidx.70797)))
 (let ((?x20116 (e_state_s_granule ?x565)))
 (let (($x572 (= ?x20116 6)))
 (let (($x20119 (= ?x20116 0)))
 (=> (not (select (gpt ?x42214) gidx.70797)) (or $x20119 $x572)))))))))))))))))
 )
(assert
 (forall ((v.70807 Int) )(let ((?x320 (make_return_code_para.0_call v.70807)))
 (let ((?x321 (pack_struct_return_code_para.0_call ?x320)))
 (and (distinct ?x321 0) true))))
 )
(assert
 (forall ((v.70820 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.70820)) (* (- 1) v.70820)) 0))
 )
(assert
 (let (($x9332 (forall ((gidx.70876 Int) )(let ((?x1288 (land v_1.0 281474976710654)))
 (let ((?x251 (find_lock_granule_spec.0_call ?x1288 5 st.0)))
 (let ((?x216 (value_Tuple_Ptr_RData ?x251)))
 (let ((?x252 (elem_1 ?x216)))
 (let ((?x1803 (pack_return_code_spec.0_call 1 2 ?x252)))
 ...
 (let ((?x562 (globals ?x42214)))
 (let ((?x9305 (g_granules ?x562)))
 (let ((?x565 (select ?x9305 gidx.70876)))
 (let ((?x20116 (e_state_s_granule ?x565)))
 (let (($x572 (= ?x20116 6)))
 (let (($x20119 (= ?x20116 0)))
 (=> (not (select (gpt ?x42214) gidx.70876)) (or $x20119 $x572)))))))))))))))))
 ))
 (not $x9332)))
(check-sat)

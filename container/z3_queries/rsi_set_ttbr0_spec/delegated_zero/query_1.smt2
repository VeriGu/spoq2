...
(assert
 ...
 (let ((?x287 (div ?x108 4096)))
 (let ((?x345 (share st.0)))
 (let ((?x321 (globals ?x345)))
 (let ((?x328 (g_granules ?x321)))
 (let ((?x149 (select ?x328 ?x287)))
 (let ((?x336 (e_state_s_granule ?x149)))
 (= ?x336 3)))))))))
(assert
 (let ((?x108 (poffset v_0.0)))
 (let (($x114 (>= ?x108 0)))
 (let ((?x8169 (mod ?x108 4096)))
 (let (($x456 (= ?x8169 0)))
 (and $x456 $x114))))))
(assert
 (let ((?x112 (pbase v_0.0)))
 (= ?x112 "granule_data")))
(assert
 (let ((?x345 (share st.0)))
 (let ((?x321 (globals ?x345)))
 (let ((?x328 (g_granules ?x321)))
 (let ((?x389 (query_oracle.0_call st.0)))
 (let ((?x234 (value_RData ?x389)))
 (let ((?x379 (share ?x234)))
 (let ((?x249 (globals ?x379)))
 (let ((?x214 (g_granules ?x249)))
 (= ?x214 ?x328))))))))))
(assert
 (let ((?x8168 (test_PA.0_call v_1.0)))
 (let ((?x483 (meta_granule_offset ?x8168)))
 (let ((?x486 (div ?x483 4096)))
 (let ((?x389 (query_oracle.0_call st.0)))
 (let ((?x234 (value_RData ?x389)))
 (let ((?x379 (share ?x234)))
 (let ((?x249 (globals ?x379)))
 (let ((?x214 (g_granules ?x249)))
 (let ((?x487 (select ?x214 ?x486)))
 (let ((?x488 (e_lock ?x487)))
 (let ((?x489 (e_val ?x488)))
 (= ?x489 None_Z)))))))))))))
(assert
 (let ((?x8168 (test_PA.0_call v_1.0)))
 ...
 (let ((?x214 (g_granules ?x249)))
 (let ((?x487 (select ?x214 ?x486)))
 (let ((?x493 (e_state_s_granule ?x487)))
 (= ?x493 5))))))))))))
(assert
 (let ((?x8168 (test_PA.0_call v_1.0)))
 (let ((?x483 (meta_granule_offset ?x8168)))
 (let (($x534 (>= ?x483 0)))
 (let ((?x30662 (mod ?x483 4096)))
 (let (($x8436 (= ?x30662 0)))
 (and $x8436 $x534)))))))
(assert
 (forall ((gidx.37612 Int) )(let (($x1044 (= (g_norm (select (granule_data (share st.0)) gidx.37612)) zero_granule_data)))
 (let (($x1052 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.37612)) 1)))
 (=> $x1052 $x1044))))
 )
(assert
 (forall ((v.38264 Int) )(let ((?x1171 (make_return_code_para.0_call v.38264)))
 (let ((?x1074 (pack_struct_return_code_para.0_call ?x1171)))
 (and (distinct ?x1074 0) true))))
 )
(assert
 (forall ((v.38140 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38140)) (* (- 1) v.38140)) 0))
 )
(assert
 (forall ((gidx.340962 Int) )(let ((?x389 (query_oracle.0_call st.0)))
 (let ((?x234 (value_RData ?x389)))
 (let ((?x379 (share ?x234)))
 (let ((?x8735 (granule_data ?x379)))
 (let ((?x8176 (select ?x8735 gidx.340962)))
 (let (($x1295 (= (g_norm ?x8176) zero_granule_data)))
 (let (($x1457 (= (e_state_s_granule (select (g_granules (globals ?x379)) gidx.340962)) 1)))
 (=> $x1457 $x1295)))))))))
 )
(assert
 (forall ((v.340972 Int) )(let ((?x1171 (make_return_code_para.0_call v.340972)))
 (let ((?x1074 (pack_struct_return_code_para.0_call ?x1171)))
 (and (distinct ?x1074 0) true))))
 )
(assert
 (forall ((v.340985 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.340985)) (* (- 1) v.340985)) 0))
 )
(assert
 (let (($x1136 (forall ((gidx.341093 Int) )(let ((?x108 (poffset v_0.0)))
 (let ((?x737 (+ 1536 ?x108)))
 (let ((?x736 (div ?x737 4096)))
 (let ((?x389 (query_oracle.0_call st.0)))
 (let ((?x234 (value_RData ?x389)))
 (let ((?x379 (share ?x234)))
 (let ((?x8735 (granule_data ?x379)))
 (let ((?x991 (select ?x8735 ?x736)))
 (let ((?x997 (g_rec ?x991)))
 (let ((?x1000 (g_rd ?x991)))
 (let ((?x743 (+ 392 ?x108)))
 (let ((?x742 (mod ?x743 4096)))
 (let ((?x8168 (test_PA.0_call v_1.0)))
 (let ((?x483 (meta_granule_offset ?x8168)))
 (let ((?x8422 (mkPtr "granules" ?x483)))
 (let ((?x740 (test_Ptr_Z.0_call ?x8422)))
 (let ((?x62244 (mod ?x737 4096)))
 (let ((?x992 (g_norm ?x991)))
 (let ((?x993 (store ?x992 ?x62244 ?x740)))
 (let ((?x994 (store ?x993 ?x742 v_1.0)))
 (let ((?x23047 (g_granule_state ?x991)))
 (let ((?x995 (gd_g_idx ?x991)))
 (let ((?x998 (mkr_granule_data ?x995 ?x23047 ?x994 ?x1000 ?x997)))
 (let ((?x999 (store ?x8735 ?x736 ?x998)))
 (let (($x1457 (= (e_state_s_granule (select (g_granules (globals ?x379)) gidx.341093)) 1)))
 (=> $x1457 (= (g_norm (select ?x999 gidx.341093)) zero_granule_data))))))))))))))))))))))))))))
 ))
 (not $x1136)))
(check-sat)

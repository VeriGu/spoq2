...
(assert
 (let (($x1302 (forall ((gidx.341131 Int) )(let ((?x389 (query_oracle.0_call st.0)))
 (let ((?x234 (value_RData ?x389)))
 (let ((?x379 (share ?x234)))
 (let ((?x8735 (granule_data ?x379)))
 (let ((?x8176 (select ?x8735 gidx.341131)))
 (let (($x1295 (= (g_norm ?x8176) zero_granule_data)))
 (let (($x1457 (= (e_state_s_granule (select (g_granules (globals ?x379)) gidx.341131)) 1)))
 (=> $x1457 $x1295)))))))))
 ))
 (not $x1302)))
(check-sat)

...
(assert
 (let (($x1048 (forall ((gidx.340925 Int) )(let (($x1044 (= (g_norm (select (granule_data (share st.0)) gidx.340925)) zero_granule_data)))
 (let (($x1052 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.340925)) 1)))
 (=> $x1052 $x1044))))
 ))
 (not $x1048)))
(check-sat)

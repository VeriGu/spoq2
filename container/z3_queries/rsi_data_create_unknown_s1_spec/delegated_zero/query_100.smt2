...
(assert
 ...
 (let ((?x55217 (meta_granule_offset ?x46025)))
 (let ((?x55744 (+ 8 ?x55217)))
 (let ((?x103457 (mod ?x55744 4096)))
 (= ?x103457 8)))))))
(assert
 (let (($x6321 (forall ((gidx.2520052 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87008 (share ?x54965)))
 (let ((?x6084 (granule_data ?x87008)))
 (let (($x6359 (= (g_norm (select ?x6084 gidx.2520052)) zero_granule_data)))
 (let ((?x52554 (test_Z_PTE.0_call v_0.2519836)))
 (let ((?x46025 (meta_PA ?x52554)))
 (let ((?x55217 (meta_granule_offset ?x46025)))
 ...
 (let ((?x6775 (mks_granule (e_lock ?x46896) 4 (e_ref ?x46896))))
 (let ((?x45129 (store ?x54915 ?x6324 ?x6775)))
 (=> (= (e_state_s_granule (select ?x45129 gidx.2520052)) 1) $x6359))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6321)))
(check-sat)

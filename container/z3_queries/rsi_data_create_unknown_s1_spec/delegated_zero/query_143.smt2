...
(assert
 ...
 (let ((?x37041 (meta_granule_offset ?x37128)))
 (let ((?x9048 (+ 8 ?x37041)))
 (let ((?x127983 (mod ?x9048 4096)))
 (= ?x127983 8)))))))
(assert
 (let (($x80424 (forall ((gidx.2526472 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x101971 (share ?x79075)))
 (let ((?x9191 (granule_data ?x101971)))
 (let (($x8812 (= (g_norm (select ?x9191 gidx.2526472)) zero_granule_data)))
 (let ((?x61135 (test_Z_PTE.0_call v_0.2526256)))
 (let ((?x37128 (meta_PA ?x61135)))
 (let ((?x37041 (meta_granule_offset ?x37128)))
 ...
 (let ((?x61468 (mks_granule (e_lock ?x9787) 4 (e_ref ?x9787))))
 (let ((?x62157 (store ?x58558 ?x9053 ?x61468)))
 (=> (= (e_state_s_granule (select ?x62157 gidx.2526472)) 1) $x8812))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x80424)))
(check-sat)

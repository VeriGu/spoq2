...
(assert
 ...
 (and $x48823 $x3143))))))))
(assert
 (let (($x4998 (forall ((gidx.2514170 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x47432 (share ?x2938)))
 (let ((?x3135 (granule_data ?x47432)))
 (let (($x2909 (= (g_norm (select ?x3135 gidx.2514170)) zero_granule_data)))
 (let ((?x3025 (test_Z_PTE.0_call v_0.2510475)))
 (let ((?x3011 (meta_PA ?x3025)))
 (let ((?x2741 (meta_granule_offset ?x3011)))
 (let ((?x3126 (div ?x2741 4096)))
 ...
 (let ((?x2874 (g_granules ?x3118)))
 (let ((?x64854 (select ?x2874 ?x3126)))
 (let ((?x4995 (mks_granule (e_lock ?x64854) 4 (e_ref ?x64854))))
 (let ((?x51222 (store ?x2874 ?x3126 ?x4995)))
 (=> (= (e_state_s_granule (select ?x51222 gidx.2514170)) 1) $x2909))))))))))))))))))))))))))))
 ))
 (not $x4998)))
(check-sat)

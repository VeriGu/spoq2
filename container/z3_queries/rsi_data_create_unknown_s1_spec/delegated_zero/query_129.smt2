...
(assert
 ...
 (let ((?x8895 (meta_granule_offset ?x67518)))
 (let ((?x8699 (+ 8 ?x8895)))
 (let ((?x117243 (mod ?x8699 4096)))
 (= ?x117243 8)))))))
(assert
 (let (($x8651 (forall ((gidx.2524335 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x102821 (share ?x6739)))
 (let ((?x5751 (granule_data ?x102821)))
 (let (($x68235 (= (g_norm (select ?x5751 gidx.2524335)) zero_granule_data)))
 (let ((?x5524 (test_Z_PTE.0_call v_0.2524119)))
 (let ((?x67518 (meta_PA ?x5524)))
 (let ((?x8895 (meta_granule_offset ?x67518)))
 ...
 (let ((?x68313 (mks_granule (e_lock ?x67896) 4 (e_ref ?x67896))))
 (let ((?x7943 (store ?x35563 ?x60200 ?x68313)))
 (=> (= (e_state_s_granule (select ?x7943 gidx.2524335)) 1) $x68235))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8651)))
(check-sat)

...
(assert
 ...
 (let ((?x5714 (meta_granule_offset ?x2120)))
 (let ((?x5739 (+ 8 ?x5714)))
 (let ((?x97813 (mod ?x5739 4096)))
 (= ?x97813 8)))))))
(assert
 (let (($x6194 (forall ((gidx.2519505 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87008 (share ?x54965)))
 (let ((?x6084 (granule_data ?x87008)))
 (let (($x6359 (= (g_norm (select ?x6084 gidx.2519505)) zero_granule_data)))
 (let ((?x6551 (test_Z_PTE.0_call v_0.2519289)))
 (let ((?x2120 (meta_PA ?x6551)))
 (let ((?x5714 (meta_granule_offset ?x2120)))
 ...
 (let ((?x6286 (mks_granule (e_lock ?x34004) 4 (e_ref ?x34004))))
 (let ((?x6608 (store ?x54915 ?x37796 ?x6286)))
 (=> (= (e_state_s_granule (select ?x6608 gidx.2519505)) 1) $x6359))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6194)))
(check-sat)

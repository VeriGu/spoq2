...
(assert
 ...
 (let ((?x4687 (meta_granule_offset ?x4539)))
 (let ((?x4969 (+ 8 ?x4687)))
 (let ((?x99627 (mod ?x4969 4096)))
 (= ?x99627 8)))))))
(assert
 (let (($x43411 (forall ((gidx.2515222 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x82843 (share ?x42693)))
 (let ((?x5267 (granule_data ?x82843)))
 (let (($x43439 (= (g_norm (select ?x5267 gidx.2515222)) zero_granule_data)))
 (let ((?x5480 (test_Z_PTE.0_call v_0.2515006)))
 (let ((?x4539 (meta_PA ?x5480)))
 (let ((?x4687 (meta_granule_offset ?x4539)))
 ...
 (let ((?x43277 (mks_granule (e_lock ?x42670) 4 (e_ref ?x42670))))
 (let ((?x4891 (store ?x46921 ?x4490 ?x43277)))
 (=> (= (e_state_s_granule (select ?x4891 gidx.2515222)) 1) $x43439))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43411)))
(check-sat)

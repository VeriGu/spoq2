...
(assert
 ...
 (and $x1381 $x1387)))))))
(assert
 (let (($x52557 (forall ((gidx.2514438 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x36036 (share ?x2834)))
 (let ((?x2838 (granule_data ?x36036)))
 (let ((?x2755 (select ?x2838 gidx.2514438)))
 (let (($x2714 (= (g_norm ?x2755) zero_granule_data)))
 (let (($x2896 (= (e_state_s_granule (select (g_granules (globals ?x36036)) gidx.2514438)) 1)))
 (=> $x2896 $x2714)))))))))))))
 ))
 (not $x52557)))
(check-sat)

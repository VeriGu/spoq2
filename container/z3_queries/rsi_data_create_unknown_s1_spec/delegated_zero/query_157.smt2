...
(assert
 ...
 (let ((?x10407 (meta_granule_offset ?x38377)))
 (let ((?x61058 (+ 8 ?x10407)))
 (let ((?x95509 (mod ?x61058 4096)))
 (= ?x95509 8)))))))
(assert
 (let (($x61881 (forall ((gidx.2528370 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x95885 (share ?x70867)))
 (let ((?x37629 (granule_data ?x95885)))
 (let (($x60307 (= (g_norm (select ?x37629 gidx.2528370)) zero_granule_data)))
 (let ((?x33923 (test_Z_PTE.0_call v_0.2528154)))
 (let ((?x38377 (meta_PA ?x33923)))
 (let ((?x10407 (meta_granule_offset ?x38377)))
 ...
 (let ((?x52773 (mks_granule (e_lock ?x51025) 4 (e_ref ?x51025))))
 (let ((?x9351 (store ?x58914 ?x10026 ?x52773)))
 (=> (= (e_state_s_granule (select ?x9351 gidx.2528370)) 1) $x60307))))))))))))))))))))))))))))))))))))))
 ))
 (not $x61881)))
(check-sat)

...
(assert
 ...
 (and $x103157 $x54996))))))))
(assert
 (let (($x5277 (forall ((gidx.2520274 Int) )(let ((?x52554 (test_Z_PTE.0_call v_0.2519836)))
 (let ((?x46025 (meta_PA ?x52554)))
 (let ((?x55217 (meta_granule_offset ?x46025)))
 ...
 (let (($x5891 (= (g_norm (select ?x6044 gidx.2520274)) zero_granule_data)))
 (let ((?x6224 (globals ?x87008)))
 (let ((?x54915 (g_granules ?x6224)))
 (let ((?x46896 (select ?x54915 ?x6324)))
 (let ((?x55092 (e_ref ?x46896)))
 (let ((?x43649 (e_lock ?x46896)))
 (let ((?x99680 (mks_granule ?x43649 1 ?x55092)))
 (let ((?x7078 (store ?x54915 ?x6324 ?x99680)))
 (=> (= (e_state_s_granule (select ?x7078 gidx.2520274)) 1) $x5891)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5277)))
(check-sat)

...
(assert
 ...
 (= ?x28813 2))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2523537 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x68235 (= (g_norm (select ?x5751 gidx.2523537)) zero_granule_data)))
 (let (($x68756 (= (e_state_s_granule (select (g_granules (globals ?x102821)) gidx.2523537)) 1)))
 (=> $x68756 $x68235))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2523572 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2523572))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x8059 (forall ((gidx.2523708 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!6 (value_Tuple_bool_RData
 ...
 (let (($x8168 (= (g_norm (select ?x8206 gidx.2523708)) zero_granule_data)))
 (let (($x7718 (= (e_state_s_granule (select (g_granules (globals ?x6667)) gidx.2523708)) 1)))
 (or (not $x7718) $x8168))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7356 (forall ((gidx.2523697 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x102821 (share ?x6739)))
 (let ((?x5751 (granule_data ?x102821)))
 (let (($x68235 (= (g_norm (select ?x5751 gidx.2523697)) zero_granule_data)))
 (let (($x68756 (= (e_state_s_granule (select (g_granules (globals ?x102821)) gidx.2523697)) 1)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x7936 (test_Z_PTE.0_call v_0.2523572)))
 (let ((?x7693 (meta_PA ?x7936)))
 (let ((?x7547 (meta_granule_offset ?x7693)))
 (let (($x77388 (>= ?x7547 0)))
 (let ((?x99951 (mod ?x7547 4096)))
 (let (($x127509 (= ?x99951 0)))
 (and $x127509 $x77388))))))))
(assert
 (let (($x7790 (forall ((gidx.2523899 Int) )(let ((?x7936 (test_Z_PTE.0_call v_0.2523572)))
 (let ((?x7693 (meta_PA ?x7936)))
 (let ((?x7547 (meta_granule_offset ?x7693)))
 (let ((?x7616 (div ?x7547 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x102821 (share ?x6739)))
 (let ((?x5751 (granule_data ?x102821)))
 (let ((?x117170 (select ?x5751 ?x7616)))
 (let ((?x7621 (mkr_granule_data (gd_g_idx ?x117170) (g_granule_state ?x117170) zero_granule_data (g_rd ?x117170) (g_rec ?x117170))))
 (let ((?x8356 (store ?x5751 ?x7616 ?x7621)))
 (let ((?x8683 (mks_granule (e_lock (select (g_granules (globals ?x102821)) ?x7616)) 4 (e_ref (select (g_granules (globals ?x102821)) ?x7616)))))
 (let ((?x6283 (globals ?x102821)))
 (let ((?x35563 (g_granules ?x6283)))
 (let ((?x6875 (store ?x35563 ?x7616 ?x8683)))
 (let (($x8150 (= (e_state_s_granule (select ?x6875 gidx.2523899)) 1)))
 (=> $x8150 (= (g_norm (select ?x8356 gidx.2523899)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7790)))
(check-sat)

...
(assert
 ...
 (= ?x82222 8)))))))))))))))))
(assert
 (let (($x2007 (forall ((gidx.2506841 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x65689 (share ?x1824)))
 (let ((?x36496 (granule_data ?x65689)))
 (let (($x45336 (= (g_norm (select ?x36496 gidx.2506841)) zero_granule_data)))
 (let ((?x36884 (test_Z_PTE.0_call v_0.2506625)))
 ...
 (let ((?x2006 (mks_granule (e_lock ?x82550) 4 (e_ref ?x82550))))
 (let ((?x45723 (store ?x1794 ?x2049 ?x2006)))
 (=> (= (e_state_s_granule (select ?x45723 gidx.2506841)) 1) $x45336)))))))))))))))))))))))))))))))))))
 ))
 (not $x2007)))
(check-sat)

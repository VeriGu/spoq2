...
(assert
 ...
 (and $x127509 $x77388))))))))
(assert
 (let (($x70870 (forall ((gidx.2524010 Int) )(let ((?x7936 (test_Z_PTE.0_call v_0.2523572)))
 (let ((?x7693 (meta_PA ?x7936)))
 (let ((?x7547 (meta_granule_offset ?x7693)))
 ...
 (let (($x6830 (= (g_norm (select ?x8356 gidx.2524010)) zero_granule_data)))
 (let ((?x6283 (globals ?x102821)))
 (let ((?x35563 (g_granules ?x6283)))
 (let ((?x8253 (select ?x35563 ?x7616)))
 (let ((?x6921 (e_ref ?x8253)))
 (let ((?x4914 (e_lock ?x8253)))
 (let ((?x113795 (mks_granule ?x4914 1 ?x6921)))
 (let ((?x8782 (store ?x35563 ?x7616 ?x113795)))
 (=> (= (e_state_s_granule (select ?x8782 gidx.2524010)) 1) $x6830)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x70870)))
(check-sat)

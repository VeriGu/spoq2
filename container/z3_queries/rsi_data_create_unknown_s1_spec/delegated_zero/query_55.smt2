...
(assert
 ...
 (and $x94055 $x42148))))))))
(assert
 (let (($x42413 (forall ((gidx.2513546 Int) )(let ((?x4158 (test_Z_PTE.0_call v_0.2513108)))
 (let ((?x3711 (meta_PA ?x4158)))
 (let ((?x9265 (meta_granule_offset ?x3711)))
 ...
 (let (($x4866 (= (g_norm (select ?x42002 gidx.2513546)) zero_granule_data)))
 (let ((?x41781 (globals ?x98745)))
 (let ((?x41900 (g_granules ?x41781)))
 (let ((?x41988 (select ?x41900 ?x49771)))
 (let ((?x59460 (e_ref ?x41988)))
 (let ((?x4256 (e_lock ?x41988)))
 (let ((?x103305 (mks_granule ?x4256 1 ?x59460)))
 (let ((?x4688 (store ?x41900 ?x49771 ?x103305)))
 (=> (= (e_state_s_granule (select ?x4688 gidx.2513546)) 1) $x4866)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x42413)))
(check-sat)

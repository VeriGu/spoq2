...
(assert
 ...
 (let ((?x3989 (meta_granule_offset ?x4354)))
 (let ((?x3732 (+ 8 ?x3989)))
 (let ((?x97978 (mod ?x3732 4096)))
 (= ?x97978 8)))))))
(assert
 (let (($x42658 (forall ((gidx.2513871 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2513871)) zero_granule_data)))
 (let ((?x4136 (test_Z_PTE.0_call v_0.2513655)))
 (let ((?x4354 (meta_PA ?x4136)))
 (let ((?x3989 (meta_granule_offset ?x4354)))
 ...
 (let ((?x42587 (mks_granule (e_lock ?x51126) 4 (e_ref ?x51126))))
 (let ((?x32072 (store ?x58847 ?x4709 ?x42587)))
 (=> (= (e_state_s_granule (select ?x32072 gidx.2513871)) 1) $x49214))))))))))))))))))))))))))))))))))))))
 ))
 (not $x42658)))
(check-sat)

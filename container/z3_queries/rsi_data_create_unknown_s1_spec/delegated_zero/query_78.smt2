...
(assert
 ...
 (and $x84845 $x5435))))))))
(assert
 (let (($x70729 (forall ((gidx.2516786 Int) )(let ((?x32678 (test_Z_PTE.0_call v_0.2516348)))
 (let ((?x60542 (meta_PA ?x32678)))
 (let ((?x44014 (meta_granule_offset ?x60542)))
 ...
 (let (($x5579 (= (g_norm (select ?x43767 gidx.2516786)) zero_granule_data)))
 (let ((?x52694 (globals ?x83592)))
 (let ((?x43571 (g_granules ?x52694)))
 (let ((?x5677 (select ?x43571 ?x43724)))
 (let ((?x1677 (e_ref ?x5677)))
 (let ((?x5621 (e_lock ?x5677)))
 (let ((?x103528 (mks_granule ?x5621 1 ?x1677)))
 (let ((?x5758 (store ?x43571 ?x43724 ?x103528)))
 (=> (= (e_state_s_granule (select ?x5758 gidx.2516786)) 1) $x5579)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x70729)))
(check-sat)

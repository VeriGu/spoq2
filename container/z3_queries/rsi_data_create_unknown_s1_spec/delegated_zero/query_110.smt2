...
(assert
 ...
 (let ((?x6942 (meta_granule_offset ?x6373)))
 (let ((?x6717 (+ 8 ?x6942)))
 (let ((?x115374 (mod ?x6717 4096)))
 (= ?x115374 8)))))))
(assert
 (let (($x7020 (forall ((gidx.2521642 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x14006 (share ?x55910)))
 (let ((?x7307 (granule_data ?x14006)))
 (let (($x57062 (= (g_norm (select ?x7307 gidx.2521642)) zero_granule_data)))
 (let ((?x6564 (test_Z_PTE.0_call v_0.2521426)))
 (let ((?x6373 (meta_PA ?x6564)))
 (let ((?x6942 (meta_granule_offset ?x6373)))
 ...
 (let ((?x66265 (mks_granule (e_lock ?x7537) 4 (e_ref ?x7537))))
 (let ((?x5936 (store ?x47663 ?x45704 ?x66265)))
 (=> (= (e_state_s_granule (select ?x5936 gidx.2521642)) 1) $x57062))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7020)))
(check-sat)

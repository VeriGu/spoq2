...
(assert
 ...
 (let ((?x46979 (meta_granule_offset ?x45903)))
 (let ((?x56370 (+ 8 ?x46979)))
 (let ((?x109562 (mod ?x56370 4096)))
 (= ?x109562 8)))))))
(assert
 (let (($x56609 (forall ((gidx.2522189 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87104 (share ?x55693)))
 (let ((?x21361 (granule_data ?x87104)))
 (let (($x45538 (= (g_norm (select ?x21361 gidx.2522189)) zero_granule_data)))
 (let ((?x47226 (test_Z_PTE.0_call v_0.2521973)))
 (let ((?x45903 (meta_PA ?x47226)))
 (let ((?x46979 (meta_granule_offset ?x45903)))
 ...
 (let ((?x45318 (mks_granule (e_lock ?x33936) 4 (e_ref ?x33936))))
 (let ((?x31771 (store ?x55531 ?x46128 ?x45318)))
 (=> (= (e_state_s_granule (select ?x31771 gidx.2522189)) 1) $x45538))))))))))))))))))))))))))))))))))))))
 ))
 (not $x56609)))
(check-sat)

...
(assert
 ...
 (let (($x3211 (= ?x3236 0)))
 (let (($x3208 (and $x3211 $x2817 $x3276)))
 (not $x3208)))))))))))))))))))))))))))))))
(assert
...
(assert
 ...
 (let ((?x44587 (meta_PA ?x6426)))
 (let ((?x63451 (meta_granule_offset ?x44587)))
 (let (($x103197 (>= ?x63451 0)))
 (let ((?x56136 (mod ?x63451 4096)))
 (let (($x72990 (= ?x56136 0)))
 (and $x72990 $x103197))))))))
(assert
 (let (($x55158 (forall ((gidx.2522565 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x47432 (share ?x2938)))
 (let ((?x3135 (granule_data ?x47432)))
 (let (($x2909 (= (g_norm (select ?x3135 gidx.2522565)) zero_granule_data)))
 (let ((?x6426 (test_Z_PTE.0_call v_0.2518793)))
 (let ((?x44587 (meta_PA ?x6426)))
 (let ((?x63451 (meta_granule_offset ?x44587)))
 (let ((?x72834 (div ?x63451 4096)))
 ...
 (let ((?x2874 (g_granules ?x3118)))
 (let ((?x71814 (select ?x2874 ?x72834)))
 (let ((?x6112 (e_ref ?x71814)))
 (let ((?x75802 (e_lock ?x71814)))
 (let ((?x75687 (mks_granule ?x75802 1 ?x6112)))
 (let ((?x46097 (store ?x2874 ?x72834 ?x75687)))
 (=> (= (e_state_s_granule (select ?x46097 gidx.2522565)) 1) $x2909))))))))))))))))))))))))))))))
 ))
 (not $x55158)))
(check-sat)

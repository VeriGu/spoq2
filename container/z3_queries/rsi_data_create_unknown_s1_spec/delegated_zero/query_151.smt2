...
(assert
 ...
 (= ?x3202 "granules"))))))))))))))))))
(assert
 (let (($x7777 (forall ((gidx.2527287 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x47432 (share ?x2938)))
 (let ((?x3135 (granule_data ?x47432)))
 (let (($x2909 (= (g_norm (select ?x3135 gidx.2527287)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x47432)) gidx.2527287)) 1)))
 (=> $x2971 $x2909))))))))))))))))))))
 ))
 (not $x7777)))
(check-sat)

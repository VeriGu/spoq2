...
(assert
 ...
 (and $x96379 $x49428))))))))
(assert
 (let (($x31109 (forall ((gidx.2511956 Int) )(let ((?x49410 (test_Z_PTE.0_call v_0.2511518)))
 (let ((?x48604 (meta_PA ?x49410)))
 (let ((?x3786 (meta_granule_offset ?x48604)))
 ...
 (let (($x3818 (= (g_norm (select ?x41154 gidx.2511956)) zero_granule_data)))
 (let ((?x30767 (globals ?x79850)))
 (let ((?x30576 (g_granules ?x30767)))
 (let ((?x41222 (select ?x30576 ?x3837)))
 (let ((?x49633 (e_ref ?x41222)))
 (let ((?x49107 (e_lock ?x41222)))
 (let ((?x94615 (mks_granule ?x49107 1 ?x49633)))
 (let ((?x3783 (store ?x30576 ?x3837 ?x94615)))
 (=> (= (e_state_s_granule (select ?x3783 gidx.2511956)) 1) $x3818)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x31109)))
(check-sat)

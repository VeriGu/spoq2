...
(assert
 ...
 (let ((?x3430 (meta_granule_offset ?x3295)))
 (let ((?x40891 (+ 8 ?x3430)))
 (let ((?x96038 (mod ?x40891 4096)))
 (= ?x96038 8)))))))
(assert
 (let (($x3388 (forall ((gidx.2511187 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x79850 (share ?x3398)))
 (let ((?x48794 (granule_data ?x79850)))
 (let (($x48830 (= (g_norm (select ?x48794 gidx.2511187)) zero_granule_data)))
 (let ((?x3485 (test_Z_PTE.0_call v_0.2510971)))
 (let ((?x3295 (meta_PA ?x3485)))
 (let ((?x3430 (meta_granule_offset ?x3295)))
 ...
 (let ((?x29843 (mks_granule (e_lock ?x3544) 4 (e_ref ?x3544))))
 (let ((?x3463 (store ?x30576 ?x3514 ?x29843)))
 (=> (= (e_state_s_granule (select ?x3463 gidx.2511187)) 1) $x48830))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3388)))
(check-sat)

...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2514971 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x43439 (= (g_norm (select ?x5267 gidx.2514971)) zero_granule_data)))
 (let (($x5364 (= (e_state_s_granule (select (g_granules (globals ?x82843)) gidx.2514971)) 1)))
 (=> $x5364 $x43439))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2515006 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2515006))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x50928 (forall ((gidx.2515142 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x5449 (= (g_norm (select ?x5077 gidx.2515142)) zero_granule_data)))
 (let (($x5382 (= (e_state_s_granule (select (g_granules (globals ?x51811)) gidx.2515142)) 1)))
 (or (not $x5382) $x5449))))))))))))))))))))))))))))))))))
 ))
 (let (($x5465 (forall ((gidx.2515131 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x82843 (share ?x42693)))
 (let ((?x5267 (granule_data ?x82843)))
 (let (($x43439 (= (g_norm (select ?x5267 gidx.2515131)) zero_granule_data)))
 (let (($x5364 (= (e_state_s_granule (select (g_granules (globals ?x82843)) gidx.2515131)) 1)))
 (or (not $x5364) $x43439))))))))))))))))))))))))))))))
 ))
 (or (not $x5465) $x50928))))
(assert
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x5480 (test_Z_PTE.0_call v_0.2515006)))
 (let ((?x4539 (meta_PA ?x5480)))
 (let ((?x4687 (meta_granule_offset ?x4539)))
 (let (($x5345 (>= ?x4687 0)))
 (let ((?x75220 (mod ?x4687 4096)))
 (let (($x109525 (= ?x75220 0)))
 (and $x109525 $x5345))))))))
(assert
 (let (($x54547 (forall ((gidx.2515333 Int) )(let ((?x5480 (test_Z_PTE.0_call v_0.2515006)))
 (let ((?x4539 (meta_PA ?x5480)))
 (let ((?x4687 (meta_granule_offset ?x4539)))
 (let ((?x4490 (div ?x4687 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x82843 (share ?x42693)))
 (let ((?x5267 (granule_data ?x82843)))
 (let ((?x77829 (select ?x5267 ?x4490)))
 (let ((?x50282 (mkr_granule_data (gd_g_idx ?x77829) (g_granule_state ?x77829) zero_granule_data (g_rd ?x77829) (g_rec ?x77829))))
 (let ((?x4548 (store ?x5267 ?x4490 ?x50282)))
 (let ((?x43277 (mks_granule (e_lock (select (g_granules (globals ?x82843)) ?x4490)) 4 (e_ref (select (g_granules (globals ?x82843)) ?x4490)))))
 (let ((?x61678 (globals ?x82843)))
 (let ((?x46921 (g_granules ?x61678)))
 (let ((?x4891 (store ?x46921 ?x4490 ?x43277)))
 (let (($x43440 (= (e_state_s_granule (select ?x4891 gidx.2515333)) 1)))
 (=> $x43440 (= (g_norm (select ?x4548 gidx.2515333)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x54547)))
(check-sat)

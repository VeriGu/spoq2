...
(declare-fun v_0.2528701 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2528701)))))
...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2528914 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x60842 (test_Z_PTE.0_call v_0.2528701)))
 (let ((?x38418 (meta_PA ?x60842)))
 (let ((?x82037 (meta_granule_offset ?x38418)))
 (let ((?x61189 (mkPtr "granule_data" ?x82037)))
 (let ((?x61724 (memcpy_ns_read_spec_state_oracle.0_call ?x61189 ?x1820 4096 ?x2828)))
 (let ((?x51276 (value_Tuple_bool_RData ?x61724)))
 (let ((?x57524 (elem_1 ?x51276)))
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2528914)) zero_granule_data)))
 (let (($x6211 (= (e_state_s_granule (select (g_granules (globals ?x99112)) gidx.2528914)) 1)))
 (=> $x6211 $x50562))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2528949 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2528949))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x57524 (elem_1 ?x51276)))
 (let ((?x99112 (share ?x57524)))
 (let ((?x61723 (gpt ?x99112)))
 (select ?x61723 ?x1107)))))))))))))))))))))))))))))
 )
(assert
 (let (($x8163 (forall ((gidx.2529085 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x57524 (elem_1 ?x51276)))
 (let ((?x99112 (share ?x57524)))
 (let ((?x61323 (log ?x57524)))
 (let ((?x38503 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2528701)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (oracle (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x61323)))
 (let ((?x8764 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2528701)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (repl (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x38503 ?x99112)))
 (let ((?x9093 (value_Shared ?x8764)))
 (let ((?x49969 (granule_data ?x9093)))
 (let (($x70260 (= (g_norm (select ?x49969 gidx.2529085)) zero_granule_data)))
 (let (($x50356 (= (e_state_s_granule (select (g_granules (globals ?x9093)) gidx.2529085)) 1)))
 (or (not $x50356) $x70260))))))))))))))))))))))))))))))))))
 ))
 (let (($x61928 (forall ((gidx.2529074 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2529074)) zero_granule_data)))
 (let (($x6211 (= (e_state_s_granule (select (g_granules (globals ?x99112)) gidx.2529074)) 1)))
 (or (not $x6211) $x50562))))))))))))))))))))))))))))))
 ))
 (or (not $x61928) $x8163))))
(assert
...
(assert
 ...
 (not $x1448)))))
(assert
 (let ((?x60091 (test_Z_PTE.0_call v_0.2528949)))
 (let ((?x70038 (meta_PA ?x60091)))
 (let ((?x9886 (meta_granule_offset ?x70038)))
 (let (($x6406 (>= ?x9886 0)))
 (let ((?x96718 (mod ?x9886 4096)))
 (let (($x120557 (= ?x96718 0)))
 (and $x120557 $x6406))))))))
(assert
 (let (($x60051 (forall ((gidx.2529387 Int) )(let ((?x60091 (test_Z_PTE.0_call v_0.2528949)))
 (let ((?x70038 (meta_PA ?x60091)))
 (let ((?x9886 (meta_granule_offset ?x70038)))
 (let ((?x60356 (div ?x9886 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let ((?x111626 (select ?x50459 ?x60356)))
 (let ((?x50713 (mkr_granule_data (gd_g_idx ?x111626) (g_granule_state ?x111626) zero_granule_data (g_rd ?x111626) (g_rec ?x111626))))
 (let ((?x10277 (store ?x50459 ?x60356 ?x50713)))
 (let (($x35524 (= (g_norm (select ?x10277 gidx.2529387)) zero_granule_data)))
 (let ((?x49323 (globals ?x99112)))
 (let ((?x46268 (g_granules ?x49323)))
 (let ((?x52026 (select ?x46268 ?x60356)))
 (let ((?x9955 (e_ref ?x52026)))
 (let ((?x10211 (e_lock ?x52026)))
 (let ((?x110725 (mks_granule ?x10211 1 ?x9955)))
 (let ((?x10731 (store ?x46268 ?x60356 ?x110725)))
 (=> (= (e_state_s_granule (select ?x10731 gidx.2529387)) 1) $x35524)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x60051)))
(check-sat)

...
(assert
 ...
 (= ?x82222 8)))))))))))))))))
(assert
 (let (($x29114 (forall ((gidx.2507636 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66461 (share ?x2074)))
 (let ((?x28615 (granule_data ?x66461)))
 (let (($x37090 (= (g_norm (select ?x28615 gidx.2507636)) zero_granule_data)))
 (let ((?x28984 (test_Z_PTE.0_call v_0.2507420)))
 ...
 (let ((?x2079 (mks_granule (e_lock ?x28888) 4 (e_ref ?x28888))))
 (let ((?x2226 (store ?x37115 ?x2181 ?x2079)))
 (=> (= (e_state_s_granule (select ?x2226 gidx.2507636)) 1) $x37090)))))))))))))))))))))))))))))))))))
 ))
 (not $x29114)))
(check-sat)

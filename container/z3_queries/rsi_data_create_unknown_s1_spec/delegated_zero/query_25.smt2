...
(assert
 ...
 (not $x1448)))))
(assert
 (let (($x2737 (forall ((gidx.2509200 Int) )(let ((?x2601 (test_Z_PTE.0_call v_0.2508762)))
 ...
 (let (($x36840 (= (g_norm (select ?x38012 gidx.2509200)) zero_granule_data)))
 (let ((?x37097 (globals ?x66461)))
 (let ((?x37115 (g_granules ?x37097)))
 (let ((?x97807 (select ?x37115 ?x2752)))
 (let ((?x29643 (e_ref ?x97807)))
 (let ((?x2722 (e_lock ?x97807)))
 (let ((?x84000 (mks_granule ?x2722 1 ?x29643)))
 (let ((?x37777 (store ?x37115 ?x2752 ?x84000)))
 (=> (= (e_state_s_granule (select ?x37777 gidx.2509200)) 1) $x36840))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2737)))
(check-sat)

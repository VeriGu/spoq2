...
(assert
 ...
 (let ((?x4003 (meta_granule_offset ?x4281)))
 (let ((?x41598 (+ 8 ?x4003)))
 (let ((?x96918 (mod ?x41598 4096)))
 (= ?x96918 8)))))))
(assert
 (let (($x41584 (forall ((gidx.2512529 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2512529)) zero_granule_data)))
 (let ((?x49790 (test_Z_PTE.0_call v_0.2512313)))
 (let ((?x4281 (meta_PA ?x49790)))
 (let ((?x4003 (meta_granule_offset ?x4281)))
 ...
 (let ((?x3911 (mks_granule (e_lock ?x4212) 4 (e_ref ?x4212))))
 (let ((?x3773 (store ?x58847 ?x1592 ?x3911)))
 (=> (= (e_state_s_granule (select ?x3773 gidx.2512529)) 1) $x49214))))))))))))))))))))))))))))))))))))))
 ))
 (not $x41584)))
(check-sat)

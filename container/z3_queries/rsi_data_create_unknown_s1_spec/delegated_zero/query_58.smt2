...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2513620 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2513620)) zero_granule_data)))
 (let (($x41128 (= (e_state_s_granule (select (g_granules (globals ?x80966)) gidx.2513620)) 1)))
 (=> $x41128 $x49214))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2513655 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2513655))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x51085 (forall ((gidx.2513791 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x4266 (= (g_norm (select ?x4215 gidx.2513791)) zero_granule_data)))
 (let (($x61759 (= (e_state_s_granule (select (g_granules (globals ?x3271)) gidx.2513791)) 1)))
 (or (not $x61759) $x4266))))))))))))))))))))))))))))))))))
 ))
 (let (($x4919 (forall ((gidx.2513780 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2513780)) zero_granule_data)))
 (let (($x41128 (= (e_state_s_granule (select (g_granules (globals ?x80966)) gidx.2513780)) 1)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x4136 (test_Z_PTE.0_call v_0.2513655)))
 (let ((?x4354 (meta_PA ?x4136)))
 (let ((?x3989 (meta_granule_offset ?x4354)))
 (let (($x4367 (>= ?x3989 0)))
 (let ((?x98531 (mod ?x3989 4096)))
 (let (($x108127 (= ?x98531 0)))
 (and $x108127 $x4367))))))))
(assert
 (let (($x3857 (forall ((gidx.2513982 Int) )(let ((?x4136 (test_Z_PTE.0_call v_0.2513655)))
 (let ((?x4354 (meta_PA ?x4136)))
 (let ((?x3989 (meta_granule_offset ?x4354)))
 (let ((?x4709 (div ?x3989 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let ((?x98251 (select ?x49086 ?x4709)))
 (let ((?x50970 (mkr_granule_data (gd_g_idx ?x98251) (g_granule_state ?x98251) zero_granule_data (g_rd ?x98251) (g_rec ?x98251))))
 (let ((?x4660 (store ?x49086 ?x4709 ?x50970)))
 (let ((?x42587 (mks_granule (e_lock (select (g_granules (globals ?x80966)) ?x4709)) 4 (e_ref (select (g_granules (globals ?x80966)) ?x4709)))))
 (let ((?x41076 (globals ?x80966)))
 (let ((?x58847 (g_granules ?x41076)))
 (let ((?x32072 (store ?x58847 ?x4709 ?x42587)))
 (let (($x51159 (= (e_state_s_granule (select ?x32072 gidx.2513982)) 1)))
 (=> $x51159 (= (g_norm (select ?x4660 gidx.2513982)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3857)))
(check-sat)

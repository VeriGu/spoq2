...
(assert
 ...
 (= ?x28813 2))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2524879 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x8812 (= (g_norm (select ?x9191 gidx.2524879)) zero_granule_data)))
 (let (($x69336 (= (e_state_s_granule (select (g_granules (globals ?x101971)) gidx.2524879)) 1)))
 (=> $x69336 $x8812))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2524914 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2524914))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x60483 (forall ((gidx.2525050 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!6 (value_Tuple_bool_RData
 ...
 (let (($x75738 (= (g_norm (select ?x7862 gidx.2525050)) zero_granule_data)))
 (let (($x8997 (= (e_state_s_granule (select (g_granules (globals ?x8624)) gidx.2525050)) 1)))
 (or (not $x8997) $x75738))))))))))))))))))))))))))))))))))))
 ))
 (let (($x8451 (forall ((gidx.2525039 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x101971 (share ?x79075)))
 (let ((?x9191 (granule_data ?x101971)))
 (let (($x8812 (= (g_norm (select ?x9191 gidx.2525039)) zero_granule_data)))
 (let (($x69336 (= (e_state_s_granule (select (g_granules (globals ?x101971)) gidx.2525039)) 1)))
 (or (not $x69336) $x8812))))))))))))))))))))))))))))))))
 ))
 (or (not $x8451) $x60483))))
(assert
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x69511 (test_Z_PTE.0_call v_0.2524914)))
 (let ((?x8810 (meta_PA ?x69511)))
 (let ((?x8204 (meta_granule_offset ?x8810)))
 (let (($x9250 (>= ?x8204 0)))
 (let ((?x111225 (mod ?x8204 4096)))
 (let (($x127153 (= ?x111225 0)))
 (and $x127153 $x9250))))))))
(assert
 (let (($x9170 (forall ((gidx.2525241 Int) )(let ((?x69511 (test_Z_PTE.0_call v_0.2524914)))
 (let ((?x8810 (meta_PA ?x69511)))
 (let ((?x8204 (meta_granule_offset ?x8810)))
 (let ((?x7477 (div ?x8204 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x101971 (share ?x79075)))
 (let ((?x9191 (granule_data ?x101971)))
 (let ((?x117934 (select ?x9191 ?x7477)))
 (let ((?x59623 (mkr_granule_data (gd_g_idx ?x117934) (g_granule_state ?x117934) zero_granule_data (g_rd ?x117934) (g_rec ?x117934))))
 (let ((?x8748 (store ?x9191 ?x7477 ?x59623)))
 (let ((?x6768 (mks_granule (e_lock (select (g_granules (globals ?x101971)) ?x7477)) 4 (e_ref (select (g_granules (globals ?x101971)) ?x7477)))))
 (let ((?x59976 (globals ?x101971)))
 (let ((?x58558 (g_granules ?x59976)))
 (let ((?x77861 (store ?x58558 ?x7477 ?x6768)))
 (let (($x72756 (= (e_state_s_granule (select ?x77861 gidx.2525241)) 1)))
 (=> $x72756 (= (g_norm (select ?x8748 gidx.2525241)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9170)))
(check-sat)

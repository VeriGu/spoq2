...
(assert
 ...
 (let (($x7144 (= ?x7789 0)))
 (let (($x7942 (and $x7144 $x7955 $x8165)))
 (not $x7942)))))))))))))))))))))))))))))))))
(assert
 (let ((?x84130 (make_return_code_para.0_call 9)))
 (let ((?x29592 (pack_struct_return_code_para.0_call ?x84130)))
 (let (($x2668 (= ?x29592 0)))
 (not $x2668)))))
(assert
 (let ((?x7773 (test_Z_PTE.0_call v_0.2523076)))
 ...
 (let ((?x6282 (meta_granule_offset ?x7022)))
 (let (($x7485 (>= ?x6282 0)))
 (let ((?x61444 (mod ?x6282 4096)))
 (let (($x7631 (= ?x61444 0)))
 (and $x7631 $x7485))))))))
(assert
 (let (($x62023 (forall ((gidx.2526848 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x66759 (share ?x6847)))
 (let ((?x7628 (granule_data ?x66759)))
 (let (($x7828 (= (g_norm (select ?x7628 gidx.2526848)) zero_granule_data)))
 (let ((?x7773 (test_Z_PTE.0_call v_0.2523076)))
 (let ((?x7022 (meta_PA ?x7773)))
 (let ((?x6282 (meta_granule_offset ?x7022)))
 (let ((?x8007 (div ?x6282 4096)))
 ...
 (let ((?x7556 (g_granules ?x6101)))
 (let ((?x7708 (select ?x7556 ?x8007)))
 (let ((?x8570 (e_ref ?x7708)))
 (let ((?x92223 (e_lock ?x7708)))
 (let ((?x92768 (mks_granule ?x92223 1 ?x8570)))
 (let ((?x70336 (store ?x7556 ?x8007 ?x92768)))
 (=> (= (e_state_s_granule (select ?x70336 gidx.2526848)) 1) $x7828))))))))))))))))))))))))))))))))
 ))
 (not $x62023)))
(check-sat)

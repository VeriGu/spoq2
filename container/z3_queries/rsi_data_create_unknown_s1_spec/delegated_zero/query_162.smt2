...
(assert
 ...
 (let ((?x9886 (meta_granule_offset ?x70038)))
 (let ((?x38778 (+ 8 ?x9886)))
 (let ((?x116308 (mod ?x38778 4096)))
 (= ?x116308 8)))))))
(assert
 (let (($x60312 (forall ((gidx.2529165 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2529165)) zero_granule_data)))
 (let ((?x60091 (test_Z_PTE.0_call v_0.2528949)))
 (let ((?x70038 (meta_PA ?x60091)))
 (let ((?x9886 (meta_granule_offset ?x70038)))
 ...
 (let ((?x9306 (mks_granule (e_lock ?x52026) 4 (e_ref ?x52026))))
 (let ((?x51563 (store ?x46268 ?x60356 ?x9306)))
 (=> (= (e_state_s_granule (select ?x51563 gidx.2529165)) 1) $x50562))))))))))))))))))))))))))))))))))))))
 ))
 (not $x60312)))
(check-sat)

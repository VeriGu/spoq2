...
(assert
 ...
 (and $x123671 $x61651))))))))
(assert
 (let (($x73290 (forall ((gidx.2530729 Int) )(let ((?x52237 (test_Z_PTE.0_call v_0.2530291)))
 (let ((?x51264 (meta_PA ?x52237)))
 (let ((?x71992 (meta_granule_offset ?x51264)))
 ...
 (let (($x10512 (= (g_norm (select ?x9939 gidx.2530729)) zero_granule_data)))
 (let ((?x49323 (globals ?x99112)))
 (let ((?x46268 (g_granules ?x49323)))
 (let ((?x46920 (select ?x46268 ?x10730)))
 (let ((?x51615 (e_ref ?x46920)))
 (let ((?x63172 (e_lock ?x46920)))
 (let ((?x115106 (mks_granule ?x63172 1 ?x51615)))
 (let ((?x9138 (store ?x46268 ?x10730 ?x115106)))
 (=> (= (e_state_s_granule (select ?x9138 gidx.2530729)) 1) $x10512)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x73290)))
(check-sat)

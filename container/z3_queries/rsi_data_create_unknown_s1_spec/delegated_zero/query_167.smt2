...
(assert
 ...
 (let ((?x11128 (meta_granule_offset ?x10747)))
 (let ((?x7767 (+ 8 ?x11128)))
 (let ((?x122545 (mod ?x7767 4096)))
 (= ?x122545 8)))))))
(assert
 (let (($x9434 (forall ((gidx.2529960 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x96623 (share ?x61173)))
 (let ((?x9564 (granule_data ?x96623)))
 (let (($x59262 (= (g_norm (select ?x9564 gidx.2529960)) zero_granule_data)))
 (let ((?x8554 (test_Z_PTE.0_call v_0.2529744)))
 (let ((?x10747 (meta_PA ?x8554)))
 (let ((?x11128 (meta_granule_offset ?x10747)))
 ...
 (let ((?x52108 (mks_granule (e_lock ?x9089) 4 (e_ref ?x9089))))
 (let ((?x9667 (store ?x8485 ?x52269 ?x52108)))
 (=> (= (e_state_s_granule (select ?x9667 gidx.2529960)) 1) $x59262))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9434)))
(check-sat)

...
(assert
 ...
 (let ((?x8204 (meta_granule_offset ?x8810)))
 (let ((?x68513 (+ 8 ?x8204)))
 (let ((?x116863 (mod ?x68513 4096)))
 (= ?x116863 8)))))))
(assert
 (let (($x69297 (forall ((gidx.2525130 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x101971 (share ?x79075)))
 (let ((?x9191 (granule_data ?x101971)))
 (let (($x8812 (= (g_norm (select ?x9191 gidx.2525130)) zero_granule_data)))
 (let ((?x69511 (test_Z_PTE.0_call v_0.2524914)))
 (let ((?x8810 (meta_PA ?x69511)))
 (let ((?x8204 (meta_granule_offset ?x8810)))
 ...
 (let ((?x6768 (mks_granule (e_lock ?x32956) 4 (e_ref ?x32956))))
 (let ((?x77861 (store ?x58558 ?x7477 ?x6768)))
 (=> (= (e_state_s_granule (select ?x77861 gidx.2525130)) 1) $x8812))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x69297)))
(check-sat)

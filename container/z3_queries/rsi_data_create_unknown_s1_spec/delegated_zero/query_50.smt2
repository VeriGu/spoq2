...
(assert
 ...
 (and $x106706 $x3995))))))))
(assert
 (let (($x41893 (forall ((gidx.2512751 Int) )(let ((?x49790 (test_Z_PTE.0_call v_0.2512313)))
 (let ((?x4281 (meta_PA ?x49790)))
 (let ((?x4003 (meta_granule_offset ?x4281)))
 ...
 (let (($x3864 (= (g_norm (select ?x4204 gidx.2512751)) zero_granule_data)))
 (let ((?x41076 (globals ?x80966)))
 (let ((?x58847 (g_granules ?x41076)))
 (let ((?x4212 (select ?x58847 ?x1592)))
 (let ((?x49952 (e_ref ?x4212)))
 (let ((?x3928 (e_lock ?x4212)))
 (let ((?x95495 (mks_granule ?x3928 1 ?x49952)))
 (let ((?x49357 (store ?x58847 ?x1592 ?x95495)))
 (=> (= (e_state_s_granule (select ?x49357 gidx.2512751)) 1) $x3864)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x41893)))
(check-sat)

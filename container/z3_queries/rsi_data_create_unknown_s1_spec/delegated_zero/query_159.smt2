...
(assert
 ...
 (and $x119658 $x49729))))))))
(assert
 (let (($x8292 (forall ((gidx.2528592 Int) )(let ((?x33923 (test_Z_PTE.0_call v_0.2528154)))
 (let ((?x38377 (meta_PA ?x33923)))
 (let ((?x10407 (meta_granule_offset ?x38377)))
 ...
 (let (($x51050 (= (g_norm (select ?x9738 gidx.2528592)) zero_granule_data)))
 (let ((?x60410 (globals ?x95885)))
 (let ((?x58914 (g_granules ?x60410)))
 (let ((?x51025 (select ?x58914 ?x10026)))
 (let ((?x8876 (e_ref ?x51025)))
 (let ((?x49938 (e_lock ?x51025)))
 (let ((?x45233 (mks_granule ?x49938 1 ?x8876)))
 (let ((?x48479 (store ?x58914 ?x10026 ?x45233)))
 (=> (= (e_state_s_granule (select ?x48479 gidx.2528592)) 1) $x51050)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8292)))
(check-sat)

...
(assert
 ...
 (and $x108127 $x4367))))))))
(assert
 (let (($x42584 (forall ((gidx.2514093 Int) )(let ((?x4136 (test_Z_PTE.0_call v_0.2513655)))
 (let ((?x4354 (meta_PA ?x4136)))
 (let ((?x3989 (meta_granule_offset ?x4354)))
 ...
 (let (($x42765 (= (g_norm (select ?x4660 gidx.2514093)) zero_granule_data)))
 (let ((?x41076 (globals ?x80966)))
 (let ((?x58847 (g_granules ?x41076)))
 (let ((?x51126 (select ?x58847 ?x4709)))
 (let ((?x4300 (e_ref ?x51126)))
 (let ((?x51112 (e_lock ?x51126)))
 (let ((?x95913 (mks_granule ?x51112 1 ?x4300)))
 (let ((?x42048 (store ?x58847 ?x4709 ?x95913)))
 (=> (= (e_state_s_granule (select ?x42048 gidx.2514093)) 1) $x42765)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x42584)))
(check-sat)

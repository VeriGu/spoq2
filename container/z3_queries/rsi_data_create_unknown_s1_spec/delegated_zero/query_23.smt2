...
(assert
 ...
 (= ?x82222 8)))))))))))))))))
(assert
 (let (($x29500 (forall ((gidx.2508978 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66461 (share ?x2074)))
 (let ((?x28615 (granule_data ?x66461)))
 (let (($x37090 (= (g_norm (select ?x28615 gidx.2508978)) zero_granule_data)))
 (let ((?x2601 (test_Z_PTE.0_call v_0.2508762)))
 ...
 (let ((?x29319 (mks_granule (e_lock ?x97807) 4 (e_ref ?x97807))))
 (let ((?x29513 (store ?x37115 ?x2752 ?x29319)))
 (=> (= (e_state_s_granule (select ?x29513 gidx.2508978)) 1) $x37090)))))))))))))))))))))))))))))))))))
 ))
 (not $x29500)))
(check-sat)

...
(assert
 ...
 (= ?x28813 2))))))))))))))))))))))))))))
(assert
 (let (($x78570 (forall ((gidx.2524842 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x84091 (share ?x5147)))
 (let ((?x68037 (granule_data ?x84091)))
 (let (($x56749 (= (g_norm (select ?x68037 gidx.2524842)) zero_granule_data)))
 (let (($x57010 (= (e_state_s_granule (select (g_granules (globals ?x84091)) gidx.2524842)) 1)))
 (=> $x57010 $x56749))))))))))))))))))))))))
 ))
 (not $x78570)))
(check-sat)

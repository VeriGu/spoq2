...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let (($x1877 (forall ((gidx.2506405 Int) )(let ((?x1870 (test_Z_PTE.0_call v_0.2506078)))
 ...
 (let ((?x65689 (share ?x1824)))
 (let ((?x36496 (granule_data ?x65689)))
 (let ((?x1956 (select ?x36496 ?x1519)))
 (let ((?x36264 (mkr_granule_data (gd_g_idx ?x1956) (g_granule_state ?x1956) zero_granule_data (g_rd ?x1956) (g_rec ?x1956))))
 (let ((?x1826 (store ?x36496 ?x1519 ?x36264)))
 (let ((?x1836 (mks_granule (e_lock (select (g_granules (globals ?x65689)) ?x1519)) 4 (e_ref (select (g_granules (globals ?x65689)) ?x1519)))))
 (let ((?x1790 (globals ?x65689)))
 (let ((?x1794 (g_granules ?x1790)))
 (let ((?x1837 (store ?x1794 ?x1519 ?x1836)))
 (let (($x28678 (= (e_state_s_granule (select ?x1837 gidx.2506405)) 1)))
 (=> $x28678 (= (g_norm (select ?x1826 gidx.2506405)) zero_granule_data))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1877)))
(check-sat)

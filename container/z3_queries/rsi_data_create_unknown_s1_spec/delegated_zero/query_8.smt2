...
(assert
 ...
 (not $x1757)))))))))))))))))))))))))
(assert
 (let (($x1577 (forall ((gidx.2506553 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x52792 (share ?x36240)))
 (let ((?x36242 (granule_data ?x52792)))
 (let (($x28436 (= (g_norm (select ?x36242 gidx.2506553)) zero_granule_data)))
 (let (($x36156 (= (e_state_s_granule (select (g_granules (globals ?x52792)) gidx.2506553)) 1)))
 (=> $x36156 $x28436)))))))))))))))))))
 ))
 (not $x1577)))
(check-sat)

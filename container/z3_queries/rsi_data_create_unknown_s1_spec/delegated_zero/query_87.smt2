...
(assert
 ...
 (and $x111777 $x80862))))))))
(assert
 (let (($x54539 (forall ((gidx.2518128 Int) )(let ((?x44149 (test_Z_PTE.0_call v_0.2517690)))
 (let ((?x44510 (meta_PA ?x44149)))
 (let ((?x45095 (meta_granule_offset ?x44510)))
 ...
 (let (($x82137 (= (g_norm (select ?x63479 gidx.2518128)) zero_granule_data)))
 (let ((?x52694 (globals ?x83592)))
 (let ((?x43571 (g_granules ?x52694)))
 (let ((?x54155 (select ?x43571 ?x44927)))
 (let ((?x52473 (e_ref ?x54155)))
 (let ((?x52680 (e_lock ?x54155)))
 (let ((?x50697 (mks_granule ?x52680 1 ?x52473)))
 (let ((?x5075 (store ?x43571 ?x44927 ?x50697)))
 (=> (= (e_state_s_granule (select ?x5075 gidx.2518128)) 1) $x82137)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x54539)))
(check-sat)

...
(assert
 ...
 (let ((?x62037 (meta_granule_offset ?x61559)))
 (let ((?x52054 (+ 8 ?x62037)))
 (let ((?x95077 (mod ?x52054 4096)))
 (= ?x95077 8)))))))
(assert
 (let (($x52016 (forall ((gidx.2515769 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x82843 (share ?x42693)))
 (let ((?x5267 (granule_data ?x82843)))
 (let (($x43439 (= (g_norm (select ?x5267 gidx.2515769)) zero_granule_data)))
 (let ((?x43953 (test_Z_PTE.0_call v_0.2515553)))
 (let ((?x61559 (meta_PA ?x43953)))
 (let ((?x62037 (meta_granule_offset ?x61559)))
 ...
 (let ((?x52648 (mks_granule (e_lock ?x43318) 4 (e_ref ?x43318))))
 (let ((?x5602 (store ?x46921 ?x5067 ?x52648)))
 (=> (= (e_state_s_granule (select ?x5602 gidx.2515769)) 1) $x43439))))))))))))))))))))))))))))))))))))))
 ))
 (not $x52016)))
(check-sat)

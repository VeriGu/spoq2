...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let (($x37159 (forall ((gidx.2507747 Int) )(let ((?x28984 (test_Z_PTE.0_call v_0.2507420)))
 ...
 (let ((?x2079 (mks_granule (e_lock (select (g_granules (globals ?x66461)) ?x2181)) 4 (e_ref (select (g_granules (globals ?x66461)) ?x2181)))))
 (let ((?x37097 (globals ?x66461)))
 (let ((?x37115 (g_granules ?x37097)))
 (let ((?x2226 (store ?x37115 ?x2181 ?x2079)))
 (let (($x2382 (= (e_state_s_granule (select ?x2226 gidx.2507747)) 1)))
 (=> $x2382 (= (g_norm (select ?x29076 gidx.2507747)) zero_granule_data))))))))))))))))))))))))))))))))))))))
 ))
 (not $x37159)))
(check-sat)

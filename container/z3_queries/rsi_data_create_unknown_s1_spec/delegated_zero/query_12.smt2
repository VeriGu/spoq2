...
(assert
 ...
 (= ?x1649 "vmid_lock"))))))))))))))))
(assert
 (let (($x2039 (forall ((gidx.2507100 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x33808 (share ?x1488)))
 (let ((?x1527 (granule_data ?x33808)))
 (let (($x1499 (= (g_norm (select ?x1527 gidx.2507100)) zero_granule_data)))
 (let (($x1506 (= (e_state_s_granule (select (g_granules (globals ?x33808)) gidx.2507100)) 1)))
 (=> $x1506 $x1499)))))))))))))))))
 ))
 (not $x2039)))
(check-sat)

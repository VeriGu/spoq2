...
(assert
 ...
 (and $x86135 $x65845))))))))
(assert
 (let (($x44135 (forall ((gidx.2517581 Int) )(let ((?x5879 (test_Z_PTE.0_call v_0.2517143)))
 (let ((?x5334 (meta_PA ?x5879)))
 (let ((?x5292 (meta_granule_offset ?x5334)))
 ...
 (let (($x5905 (= (g_norm (select ?x5762 gidx.2517581)) zero_granule_data)))
 (let ((?x53607 (globals ?x97095)))
 (let ((?x33229 (g_granules ?x53607)))
 (let ((?x53538 (select ?x33229 ?x43162)))
 (let ((?x62498 (e_ref ?x53538)))
 (let ((?x41553 (e_lock ?x53538)))
 (let ((?x106421 (mks_granule ?x41553 1 ?x62498)))
 (let ((?x52364 (store ?x33229 ?x43162 ?x106421)))
 (=> (= (e_state_s_granule (select ?x52364 gidx.2517581)) 1) $x5905)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x44135)))
(check-sat)

...
(assert
 ...
 (and $x127153 $x9250))))))))
(assert
 (let (($x67935 (forall ((gidx.2525352 Int) )(let ((?x69511 (test_Z_PTE.0_call v_0.2524914)))
 (let ((?x8810 (meta_PA ?x69511)))
 (let ((?x8204 (meta_granule_offset ?x8810)))
 ...
 (let (($x35083 (= (g_norm (select ?x8748 gidx.2525352)) zero_granule_data)))
 (let ((?x59976 (globals ?x101971)))
 (let ((?x58558 (g_granules ?x59976)))
 (let ((?x32956 (select ?x58558 ?x7477)))
 (let ((?x8907 (e_ref ?x32956)))
 (let ((?x68012 (e_lock ?x32956)))
 (let ((?x115113 (mks_granule ?x68012 1 ?x8907)))
 (let ((?x8114 (store ?x58558 ?x7477 ?x115113)))
 (=> (= (e_state_s_granule (select ?x8114 gidx.2525352)) 1) $x35083)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x67935)))
(check-sat)

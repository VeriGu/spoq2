...
(assert
 ...
 (and $x129838 $x60102))))))))
(assert
 (let (($x9572 (forall ((gidx.2526583 Int) )(let ((?x61135 (test_Z_PTE.0_call v_0.2526256)))
 (let ((?x37128 (meta_PA ?x61135)))
 (let ((?x37041 (meta_granule_offset ?x37128)))
 ...
 (let ((?x61468 (mks_granule (e_lock (select (g_granules (globals ?x101971)) ?x9053)) 4 (e_ref (select (g_granules (globals ?x101971)) ?x9053)))))
 (let ((?x59976 (globals ?x101971)))
 (let ((?x58558 (g_granules ?x59976)))
 (let ((?x62157 (store ?x58558 ?x9053 ?x61468)))
 (let (($x36442 (= (e_state_s_granule (select ?x62157 gidx.2526583)) 1)))
 (=> $x36442 (= (g_norm (select ?x69525 gidx.2526583)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9572)))
(check-sat)

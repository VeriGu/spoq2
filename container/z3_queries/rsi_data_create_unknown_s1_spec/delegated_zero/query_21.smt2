...
(assert
 ...
 (not $x1448)))))
(assert
 (let (($x37479 (forall ((gidx.2508653 Int) )(let ((?x2525 (test_Z_PTE.0_call v_0.2508215)))
 ...
 (let (($x2763 (= (g_norm (select ?x29503 gidx.2508653)) zero_granule_data)))
 (let ((?x1428 (globals ?x37349)))
 (let ((?x37047 (g_granules ?x1428)))
 (let ((?x94627 (select ?x37047 ?x2018)))
 (let ((?x2665 (e_ref ?x94627)))
 (let ((?x2586 (e_lock ?x94627)))
 (let ((?x95462 (mks_granule ?x2586 1 ?x2665)))
 (let ((?x2713 (store ?x37047 ?x2018 ?x95462)))
 (=> (= (e_state_s_granule (select ?x2713 gidx.2508653)) 1) $x2763))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x37479)))
(check-sat)

...
(assert
 ...
 (= ?x2352 ?x36239)))))))))))))))))))))))
(assert
 (let (($x2031 (forall ((gidx.2508143 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66587 (share ?x2394)))
 (let ((?x2184 (granule_data ?x66587)))
 (let (($x29118 (= (g_norm (select ?x2184 gidx.2508143)) zero_granule_data)))
 (let (($x2334 (= (e_state_s_granule (select (g_granules (globals ?x66587)) gidx.2508143)) 1)))
 (=> $x2334 $x29118)))))))))))))))))))))
 ))
 (not $x2031)))
(check-sat)

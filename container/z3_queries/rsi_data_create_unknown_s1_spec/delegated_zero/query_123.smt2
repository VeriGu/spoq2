...
(assert
 ...
 (= ?x6438 "granules"))))))))))))))))))))
(assert
 (let (($x67583 (forall ((gidx.2523252 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x66759 (share ?x6847)))
 (let ((?x7628 (granule_data ?x66759)))
 (let (($x7828 (= (g_norm (select ?x7628 gidx.2523252)) zero_granule_data)))
 (let (($x7002 (= (e_state_s_granule (select (g_granules (globals ?x66759)) gidx.2523252)) 1)))
 (=> $x7002 $x7828))))))))))))))))))))))
 ))
 (not $x67583)))
(check-sat)

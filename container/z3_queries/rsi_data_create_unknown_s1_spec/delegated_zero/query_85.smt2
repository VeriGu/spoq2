...
(assert
 ...
 (let ((?x45095 (meta_granule_offset ?x44510)))
 (let ((?x4246 (+ 8 ?x45095)))
 (let ((?x100015 (mod ?x4246 4096)))
 (= ?x100015 8)))))))
(assert
 (let (($x81762 (forall ((gidx.2517906 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x83592 (share ?x52315)))
 (let ((?x5186 (granule_data ?x83592)))
 (let (($x70873 (= (g_norm (select ?x5186 gidx.2517906)) zero_granule_data)))
 (let ((?x44149 (test_Z_PTE.0_call v_0.2517690)))
 (let ((?x44510 (meta_PA ?x44149)))
 (let ((?x45095 (meta_granule_offset ?x44510)))
 ...
 (let ((?x54219 (mks_granule (e_lock ?x54155) 4 (e_ref ?x54155))))
 (let ((?x51185 (store ?x43571 ?x44927 ?x54219)))
 (=> (= (e_state_s_granule (select ?x51185 gidx.2517906)) 1) $x70873))))))))))))))))))))))))))))))))))))))
 ))
 (not $x81762)))
(check-sat)

...
(assert
 ...
 (= ?x8010 ?x58908))))))))))))))))))))))))))))
(assert
 (let (($x8347 (forall ((gidx.2525637 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x93795 (share ?x5050)))
 (let ((?x68804 (granule_data ?x93795)))
 (let (($x8124 (= (g_norm (select ?x68804 gidx.2525637)) zero_granule_data)))
 (let (($x69345 (= (e_state_s_granule (select (g_granules (globals ?x93795)) gidx.2525637)) 1)))
 (=> $x69345 $x8124))))))))))))))))))))))))))
 ))
 (not $x8347)))
(check-sat)

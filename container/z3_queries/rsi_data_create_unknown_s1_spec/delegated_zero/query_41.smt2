...
(assert
 ...
 (and $x105602 $x49057))))))))
(assert
 (let (($x40899 (forall ((gidx.2511409 Int) )(let ((?x3485 (test_Z_PTE.0_call v_0.2510971)))
 (let ((?x3295 (meta_PA ?x3485)))
 (let ((?x3430 (meta_granule_offset ?x3295)))
 ...
 (let (($x41173 (= (g_norm (select ?x49039 gidx.2511409)) zero_granule_data)))
 (let ((?x30767 (globals ?x79850)))
 (let ((?x30576 (g_granules ?x30767)))
 (let ((?x3544 (select ?x30576 ?x3514)))
 (let ((?x3177 (e_ref ?x3544)))
 (let ((?x3405 (e_lock ?x3544)))
 (let ((?x94096 (mks_granule ?x3405 1 ?x3177)))
 (let ((?x3800 (store ?x30576 ?x3514 ?x94096)))
 (=> (= (e_state_s_granule (select ?x3800 gidx.2511409)) 1) $x41173)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x40899)))
(check-sat)

...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2520596 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x45538 (= (g_norm (select ?x21361 gidx.2520596)) zero_granule_data)))
 (let (($x45948 (= (e_state_s_granule (select (g_granules (globals ?x87104)) gidx.2520596)) 1)))
 (=> $x45948 $x45538))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2520631 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2520631))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x56169 (forall ((gidx.2520767 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x61966 (= (g_norm (select ?x54702 gidx.2520767)) zero_granule_data)))
 (let (($x56144 (= (e_state_s_granule (select (g_granules (globals ?x33077)) gidx.2520767)) 1)))
 (or (not $x56144) $x61966))))))))))))))))))))))))))))))))))
 ))
 (let (($x54813 (forall ((gidx.2520756 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87104 (share ?x55693)))
 (let ((?x21361 (granule_data ?x87104)))
 (let (($x45538 (= (g_norm (select ?x21361 gidx.2520756)) zero_granule_data)))
 (let (($x45948 (= (e_state_s_granule (select (g_granules (globals ?x87104)) gidx.2520756)) 1)))
 (or (not $x45948) $x45538))))))))))))))))))))))))))))))
 ))
 (or (not $x54813) $x56169))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x45014 (test_Z_PTE.0_call v_0.2520631)))
 (let ((?x6934 (meta_PA ?x45014)))
 (let ((?x5988 (meta_granule_offset ?x6934)))
 (let (($x6987 (>= ?x5988 0)))
 (let ((?x80854 (mod ?x5988 4096)))
 (let (($x119450 (= ?x80854 0)))
 (and $x119450 $x6987))))))))
(assert
 (let (($x65393 (forall ((gidx.2520958 Int) )(let ((?x45014 (test_Z_PTE.0_call v_0.2520631)))
 (let ((?x6934 (meta_PA ?x45014)))
 (let ((?x5988 (meta_granule_offset ?x6934)))
 (let ((?x54634 (div ?x5988 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x87104 (share ?x55693)))
 (let ((?x21361 (granule_data ?x87104)))
 (let ((?x94239 (select ?x21361 ?x54634)))
 (let ((?x44810 (mkr_granule_data (gd_g_idx ?x94239) (g_granule_state ?x94239) zero_granule_data (g_rd ?x94239) (g_rec ?x94239))))
 (let ((?x5813 (store ?x21361 ?x54634 ?x44810)))
 (let ((?x33862 (mks_granule (e_lock (select (g_granules (globals ?x87104)) ?x54634)) 4 (e_ref (select (g_granules (globals ?x87104)) ?x54634)))))
 (let ((?x56408 (globals ?x87104)))
 (let ((?x55531 (g_granules ?x56408)))
 (let ((?x7459 (store ?x55531 ?x54634 ?x33862)))
 (let (($x7009 (= (e_state_s_granule (select ?x7459 gidx.2520958)) 1)))
 (=> $x7009 (= (g_norm (select ?x5813 gidx.2520958)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x65393)))
(check-sat)

...
(declare-fun v_0.2507967 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507967)))))
...
(assert
 ...
 (= ?x1649 "vmid_lock"))))))))))))))))
(assert
 (forall ((gidx.2507137 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let (($x28436 (= (g_norm (select ?x36242 gidx.2507137)) zero_granule_data)))
 (let (($x36156 (= (e_state_s_granule (select (g_granules (globals ?x52792)) gidx.2507137)) 1)))
 (=> $x36156 $x28436)))))))))))))))))))
 )
(assert
 (forall ((v_0.2507172 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2507172))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x36880 (forall ((gidx.2507308 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
...
(let ((a!3 (value_RData (query_oracle.0_call
 ...
 (let (($x1602 (= (g_norm (select ?x1668 gidx.2507308)) zero_granule_data)))
 (let (($x1697 (= (e_state_s_granule (select (g_granules (globals ?x1725)) gidx.2507308)) 1)))
 (or (not $x1697) $x1602)))))))))))))))))))))))
 ))
 (let (($x36934 (forall ((gidx.2507297 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x52792 (share ?x36240)))
 (let ((?x36242 (granule_data ?x52792)))
 (let (($x28436 (= (g_norm (select ?x36242 gidx.2507297)) zero_granule_data)))
 (let (($x36156 (= (e_state_s_granule (select (g_granules (globals ?x52792)) gidx.2507297)) 1)))
 (or (not $x36156) $x28436)))))))))))))))))))
 ))
 (or (not $x36934) $x36880))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (let ((?x33808 (share ?x1488)))
 (let ((?x1510 (globals ?x33808)))
 (let ((?x28985 (g_vmid_lock ?x1510)))
 (let ((?x28904 (e_val ?x28985)))
 (= ?x28904 None_Z)))))))))))))))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 ...
 (not $x1757)))))))))))))))))))))))))
(assert
 (forall ((gidx.2507932 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x36182 (query_oracle.0_call ?x1488)))
 (let ((?x36240 (value_RData ?x36182)))
 (let ((?x1705 (query_oracle.0_call ?x36240)))
 (let ((?x2394 (value_RData ?x1705)))
 (let ((?x66587 (share ?x2394)))
 (let ((?x2184 (granule_data ?x66587)))
 (let (($x29118 (= (g_norm (select ?x2184 gidx.2507932)) zero_granule_data)))
 (let (($x2334 (= (e_state_s_granule (select (g_granules (globals ?x66587)) gidx.2507932)) 1)))
 (=> $x2334 $x29118)))))))))))))))))))))
 )
(assert
 (forall ((v_0.2507967 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2507967))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x2394 (value_RData ?x1705)))
 (let ((?x66587 (share ?x2394)))
 (let ((?x28913 (gpt ?x66587)))
 (select ?x28913 ?x1107))))))))))))))))))))
 )
(assert
 (let (($x37478 (forall ((gidx.2508103 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x2394 (value_RData ?x1705)))
 (let ((?x66587 (share ?x2394)))
 (let ((?x29161 (log ?x2394)))
 (let ((?x2400 (|(let ((a!1 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
(let ((a!2 (rtt_walk_lock_unlock_spec_abs.0_call
             (mkPtr "stack_s_rtt_walk" 0)
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
...
(let ((a!3 (value_RData (query_oracle.0_call
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!2))))))
  (oracle (value_RData (query_oracle.0_call a!3))))))_call| ?x29161)))
 (let ((?x2439 (|(let ((a!1 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
(let ((a!2 (rtt_walk_lock_unlock_spec_abs.0_call
             (mkPtr "stack_s_rtt_walk" 0)
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
...
(let ((a!3 (value_RData (query_oracle.0_call
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!2))))))
  (repl (value_RData (query_oracle.0_call a!3))))))_call| ?x2400 ?x66587)))
 (let ((?x2461 (value_Shared ?x2439)))
 (let ((?x2427 (granule_data ?x2461)))
 (let (($x29042 (= (g_norm (select ?x2427 gidx.2508103)) zero_granule_data)))
 (let (($x1972 (= (e_state_s_granule (select (g_granules (globals ?x2461)) gidx.2508103)) 1)))
 (or (not $x1972) $x29042)))))))))))))))))))))))))
 ))
 (let (($x29258 (forall ((gidx.2508092 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66587 (share ?x2394)))
 (let ((?x2184 (granule_data ?x66587)))
 (let (($x29118 (= (g_norm (select ?x2184 gidx.2508092)) zero_granule_data)))
 (let (($x2334 (= (e_state_s_granule (select (g_granules (globals ?x66587)) gidx.2508092)) 1)))
 (or (not $x2334) $x29118)))))))))))))))))))))
 ))
 (or (not $x29258) $x37478))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 ...
 (let ((?x2394 (value_RData ?x1705)))
 (let ((?x66587 (share ?x2394)))
 (let ((?x54690 (globals ?x66587)))
 (let ((?x2352 (g_granules ?x54690)))
 (= ?x2352 ?x36239)))))))))))))))))))))))
(assert
 (forall ((gidx.2508180 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x2448 (test_Z_PTE.0_call v_0.2507967)))
 (let ((?x2411 (meta_PA ?x2448)))
 (let ((?x2458 (meta_granule_offset ?x2411)))
 (let ((?x37083 (mkPtr "granule_data" ?x2458)))
 (let ((?x37488 (memcpy_ns_read_spec_state_oracle.0_call ?x37083 ?x1820 4096 ?x2394)))
 (let ((?x29379 (value_Tuple_bool_RData ?x37488)))
 (let ((?x37483 (elem_1 ?x29379)))
 (let ((?x37349 (share ?x37483)))
 (let ((?x37538 (granule_data ?x37349)))
 (let (($x29140 (= (g_norm (select ?x37538 gidx.2508180)) zero_granule_data)))
 (let (($x2383 (= (e_state_s_granule (select (g_granules (globals ?x37349)) gidx.2508180)) 1)))
 (=> $x2383 $x29140)))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2508215 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2508215))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x37483 (elem_1 ?x29379)))
 (let ((?x37349 (share ?x37483)))
 (let ((?x2491 (gpt ?x37349)))
 (select ?x2491 ?x1107))))))))))))))))))))))))))))
 )
(assert
 (let (($x2501 (forall ((gidx.2508351 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x37483 (elem_1 ?x29379)))
 (let ((?x37349 (share ?x37483)))
 (let ((?x2531 (log ?x37483)))
 (let ((?x37248 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507967)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (value_Tuple_bool_RData
             (memcpy_ns_read_spec_state_oracle.0_call
               ...
               4096
               (value_RData (query_oracle.0_call a!4))))))
  (oracle (elem_1 a!5))))))_call| ?x2531)))
 (let ((?x2468 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507967)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (value_Tuple_bool_RData
             (memcpy_ns_read_spec_state_oracle.0_call
               ...
               4096
               (value_RData (query_oracle.0_call a!4))))))
  (repl (elem_1 a!5))))))_call| ?x37248 ?x37349)))
 (let ((?x2240 (value_Shared ?x2468)))
 (let ((?x2552 (granule_data ?x2240)))
 (let (($x2509 (= (g_norm (select ?x2552 gidx.2508351)) zero_granule_data)))
 (let (($x37408 (= (e_state_s_granule (select (g_granules (globals ?x2240)) gidx.2508351)) 1)))
 (or (not $x37408) $x2509)))))))))))))))))))))))))))))))))
 ))
 (let (($x2444 (forall ((gidx.2508340 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x37349 (share ?x37483)))
 (let ((?x37538 (granule_data ?x37349)))
 (let (($x29140 (= (g_norm (select ?x37538 gidx.2508340)) zero_granule_data)))
 (let (($x2383 (= (e_state_s_granule (select (g_granules (globals ?x37349)) gidx.2508340)) 1)))
 (or (not $x2383) $x29140)))))))))))))))))))))))))))))
 ))
 (or (not $x2444) $x2501))))
(assert
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let (($x2321 (forall ((gidx.2508542 Int) )(let ((?x2525 (test_Z_PTE.0_call v_0.2508215)))
 (let ((?x2530 (meta_PA ?x2525)))
 (let ((?x2524 (meta_granule_offset ?x2530)))
 (let ((?x2018 (div ?x2524 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x37349 (share ?x37483)))
 (let ((?x37538 (granule_data ?x37349)))
 (let ((?x2715 (select ?x37538 ?x2018)))
 (let ((?x29554 (mkr_granule_data (gd_g_idx ?x2715) (g_granule_state ?x2715) zero_granule_data (g_rd ?x2715) (g_rec ?x2715))))
 (let ((?x29503 (store ?x37538 ?x2018 ?x29554)))
 (let ((?x2380 (mks_granule (e_lock (select (g_granules (globals ?x37349)) ?x2018)) 4 (e_ref (select (g_granules (globals ?x37349)) ?x2018)))))
 (let ((?x1428 (globals ?x37349)))
 (let ((?x37047 (g_granules ?x1428)))
 (let ((?x46248 (store ?x37047 ?x2018 ?x2380)))
 (let (($x29331 (= (e_state_s_granule (select ?x46248 gidx.2508542)) 1)))
 (=> $x29331 (= (g_norm (select ?x29503 gidx.2508542)) zero_granule_data))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2321)))
(check-sat)

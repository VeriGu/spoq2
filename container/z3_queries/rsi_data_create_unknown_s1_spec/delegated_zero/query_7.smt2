...
(assert
 ...
 (not $x1448)))))
(assert
 (let (($x2034 (forall ((gidx.2506516 Int) )(let ((?x1870 (test_Z_PTE.0_call v_0.2506078)))
 ...
 (let (($x2081 (= (g_norm (select ?x1826 gidx.2506516)) zero_granule_data)))
 (let ((?x1790 (globals ?x65689)))
 (let ((?x1794 (g_granules ?x1790)))
 (let ((?x82248 (select ?x1794 ?x1519)))
 (let ((?x1905 (e_ref ?x82248)))
 (let ((?x1682 (e_lock ?x82248)))
 (let ((?x82348 (mks_granule ?x1682 1 ?x1905)))
 (let ((?x1382 (store ?x1794 ?x1519 ?x82348)))
 (=> (= (e_state_s_granule (select ?x1382 gidx.2506516)) 1) $x2081))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2034)))
(check-sat)

...
(assert
 ...
 (and $x118270 $x38010))))))))
(assert
 (let (($x50963 (forall ((gidx.2527934 Int) )(let ((?x8501 (test_Z_PTE.0_call v_0.2527607)))
 (let ((?x9278 (meta_PA ?x8501)))
 (let ((?x8457 (meta_granule_offset ?x9278)))
 ...
 (let ((?x8686 (mks_granule (e_lock (select (g_granules (globals ?x95885)) ?x9276)) 4 (e_ref (select (g_granules (globals ?x95885)) ?x9276)))))
 (let ((?x60410 (globals ?x95885)))
 (let ((?x58914 (g_granules ?x60410)))
 (let ((?x8896 (store ?x58914 ?x9276 ?x8686)))
 (let (($x70134 (= (e_state_s_granule (select ?x8896 gidx.2527934)) 1)))
 (=> $x70134 (= (g_norm (select ?x42951 gidx.2527934)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x50963)))
(check-sat)

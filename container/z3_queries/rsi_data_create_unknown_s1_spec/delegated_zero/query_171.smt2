...
(assert
 ...
 (let ((?x71992 (meta_granule_offset ?x51264)))
 (let ((?x9830 (+ 8 ?x71992)))
 (let ((?x116021 (mod ?x9830 4096)))
 (= ?x116021 8)))))))
(assert
 (let (($x62797 (forall ((gidx.2530507 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2530507)) zero_granule_data)))
 (let ((?x52237 (test_Z_PTE.0_call v_0.2530291)))
 (let ((?x51264 (meta_PA ?x52237)))
 (let ((?x71992 (meta_granule_offset ?x51264)))
 ...
 (let ((?x33804 (mks_granule (e_lock ?x46920) 4 (e_ref ?x46920))))
 (let ((?x39679 (store ?x46268 ?x10730 ?x33804)))
 (=> (= (e_state_s_granule (select ?x39679 gidx.2530507)) 1) $x50562))))))))))))))))))))))))))))))))))))))
 ))
 (not $x62797)))
(check-sat)

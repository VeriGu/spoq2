...
(declare-fun v_0.2516100 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2516100)))))
...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2516313 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x62060 (test_Z_PTE.0_call v_0.2516100)))
 (let ((?x29053 (meta_PA ?x62060)))
 (let ((?x5060 (meta_granule_offset ?x29053)))
 (let ((?x61585 (mkPtr "granule_data" ?x5060)))
 (let ((?x51477 (memcpy_ns_read_spec_state_oracle.0_call ?x61585 ?x1820 4096 ?x2828)))
 (let ((?x51673 (value_Tuple_bool_RData ?x51477)))
 (let ((?x52315 (elem_1 ?x51673)))
 (let ((?x83592 (share ?x52315)))
 (let ((?x5186 (granule_data ?x83592)))
 (let (($x70873 (= (g_norm (select ?x5186 gidx.2516313)) zero_granule_data)))
 (let (($x52510 (= (e_state_s_granule (select (g_granules (globals ?x83592)) gidx.2516313)) 1)))
 (=> $x52510 $x70873))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2516348 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2516348))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x52315 (elem_1 ?x51673)))
 (let ((?x83592 (share ?x52315)))
 (let ((?x43107 (gpt ?x83592)))
 (select ?x43107 ?x1107)))))))))))))))))))))))))))))
 )
(assert
 (let (($x44098 (forall ((gidx.2516484 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x52315 (elem_1 ?x51673)))
 (let ((?x83592 (share ?x52315)))
 (let ((?x5515 (log ?x52315)))
 (let ((?x4259 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2516100)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (oracle (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x5515)))
 (let ((?x52638 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2516100)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (repl (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x4259 ?x83592)))
 (let ((?x5582 (value_Shared ?x52638)))
 (let ((?x5591 (granule_data ?x5582)))
 (let (($x51939 (= (g_norm (select ?x5591 gidx.2516484)) zero_granule_data)))
 (let (($x5711 (= (e_state_s_granule (select (g_granules (globals ?x5582)) gidx.2516484)) 1)))
 (or (not $x5711) $x51939))))))))))))))))))))))))))))))))))
 ))
 (let (($x32664 (forall ((gidx.2516473 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x83592 (share ?x52315)))
 (let ((?x5186 (granule_data ?x83592)))
 (let (($x70873 (= (g_norm (select ?x5186 gidx.2516473)) zero_granule_data)))
 (let (($x52510 (= (e_state_s_granule (select (g_granules (globals ?x83592)) gidx.2516473)) 1)))
 (or (not $x52510) $x70873))))))))))))))))))))))))))))))
 ))
 (or (not $x32664) $x44098))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x32678 (test_Z_PTE.0_call v_0.2516348)))
 (let ((?x60542 (meta_PA ?x32678)))
 (let ((?x44014 (meta_granule_offset ?x60542)))
 (let (($x5435 (>= ?x44014 0)))
 (let ((?x84140 (mod ?x44014 4096)))
 (let (($x84845 (= ?x84140 0)))
 (and $x84845 $x5435))))))))
(assert
 (let (($x5629 (forall ((gidx.2516675 Int) )(let ((?x32678 (test_Z_PTE.0_call v_0.2516348)))
 (let ((?x60542 (meta_PA ?x32678)))
 (let ((?x44014 (meta_granule_offset ?x60542)))
 (let ((?x43724 (div ?x44014 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x83592 (share ?x52315)))
 (let ((?x5186 (granule_data ?x83592)))
 (let ((?x100709 (select ?x5186 ?x43724)))
 (let ((?x5620 (mkr_granule_data (gd_g_idx ?x100709) (g_granule_state ?x100709) zero_granule_data (g_rd ?x100709) (g_rec ?x100709))))
 (let ((?x43767 (store ?x5186 ?x43724 ?x5620)))
 (let ((?x5100 (mks_granule (e_lock (select (g_granules (globals ?x83592)) ?x43724)) 4 (e_ref (select (g_granules (globals ?x83592)) ?x43724)))))
 (let ((?x52694 (globals ?x83592)))
 (let ((?x43571 (g_granules ?x52694)))
 (let ((?x5404 (store ?x43571 ?x43724 ?x5100)))
 (let (($x4913 (= (e_state_s_granule (select ?x5404 gidx.2516675)) 1)))
 (=> $x4913 (= (g_norm (select ?x43767 gidx.2516675)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5629)))
(check-sat)

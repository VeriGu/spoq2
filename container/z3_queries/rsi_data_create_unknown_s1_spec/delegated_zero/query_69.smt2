...
(assert
 ...
 (and $x109525 $x5345))))))))
(assert
 (let (($x43427 (forall ((gidx.2515444 Int) )(let ((?x5480 (test_Z_PTE.0_call v_0.2515006)))
 (let ((?x4539 (meta_PA ?x5480)))
 (let ((?x4687 (meta_granule_offset ?x4539)))
 ...
 (let (($x43336 (= (g_norm (select ?x4548 gidx.2515444)) zero_granule_data)))
 (let ((?x61678 (globals ?x82843)))
 (let ((?x46921 (g_granules ?x61678)))
 (let ((?x42670 (select ?x46921 ?x4490)))
 (let ((?x43233 (e_ref ?x42670)))
 (let ((?x5284 (e_lock ?x42670)))
 (let ((?x97840 (mks_granule ?x5284 1 ?x43233)))
 (let ((?x5432 (store ?x46921 ?x4490 ?x97840)))
 (=> (= (e_state_s_granule (select ?x5432 gidx.2515444)) 1) $x43336)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43427)))
(check-sat)

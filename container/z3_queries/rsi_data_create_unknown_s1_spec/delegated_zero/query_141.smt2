...
(assert
 ...
 (and $x141087 $x9145))))))))
(assert
 (let (($x61165 (forall ((gidx.2526147 Int) )(let ((?x9181 (test_Z_PTE.0_call v_0.2525709)))
 (let ((?x9311 (meta_PA ?x9181)))
 (let ((?x9322 (meta_granule_offset ?x9311)))
 ...
 (let (($x62754 (= (g_norm (select ?x9084 gidx.2526147)) zero_granule_data)))
 (let ((?x78132 (globals ?x113384)))
 (let ((?x69353 (g_granules ?x78132)))
 (let ((?x9219 (select ?x69353 ?x6824)))
 (let ((?x9097 (e_ref ?x9219)))
 (let ((?x61055 (e_lock ?x9219)))
 (let ((?x122574 (mks_granule ?x61055 1 ?x9097)))
 (let ((?x9298 (store ?x69353 ?x6824 ?x122574)))
 (=> (= (e_state_s_granule (select ?x9298 gidx.2526147)) 1) $x62754)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x61165)))
(check-sat)

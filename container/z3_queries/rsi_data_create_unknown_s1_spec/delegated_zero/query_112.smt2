...
(assert
 ...
 (and $x125616 $x5205))))))))
(assert
 (let (($x6825 (forall ((gidx.2521864 Int) )(let ((?x6564 (test_Z_PTE.0_call v_0.2521426)))
 (let ((?x6373 (meta_PA ?x6564)))
 (let ((?x6942 (meta_granule_offset ?x6373)))
 ...
 (let (($x56142 (= (g_norm (select ?x4844 gidx.2521864)) zero_granule_data)))
 (let ((?x7638 (globals ?x14006)))
 (let ((?x47663 (g_granules ?x7638)))
 (let ((?x7537 (select ?x47663 ?x45704)))
 (let ((?x6958 (e_ref ?x7537)))
 (let ((?x47114 (e_lock ?x7537)))
 (let ((?x109767 (mks_granule ?x47114 1 ?x6958)))
 (let ((?x7480 (store ?x47663 ?x45704 ?x109767)))
 (=> (= (e_state_s_granule (select ?x7480 gidx.2521864)) 1) $x56142)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6825)))
(check-sat)

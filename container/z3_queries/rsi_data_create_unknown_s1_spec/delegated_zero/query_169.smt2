...
(assert
 ...
 (and $x105227 $x10129))))))))
(assert
 (let (($x93238 (forall ((gidx.2530182 Int) )(let ((?x8554 (test_Z_PTE.0_call v_0.2529744)))
 (let ((?x10747 (meta_PA ?x8554)))
 (let ((?x11128 (meta_granule_offset ?x10747)))
 ...
 (let (($x60398 (= (g_norm (select ?x37968 gidx.2530182)) zero_granule_data)))
 (let ((?x9976 (globals ?x96623)))
 (let ((?x8485 (g_granules ?x9976)))
 (let ((?x9089 (select ?x8485 ?x52269)))
 (let ((?x51408 (e_ref ?x9089)))
 (let ((?x8632 (e_lock ?x9089)))
 (let ((?x117799 (mks_granule ?x8632 1 ?x51408)))
 (let ((?x11335 (store ?x8485 ?x52269 ?x117799)))
 (=> (= (e_state_s_granule (select ?x11335 gidx.2530182)) 1) $x60398)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x93238)))
(check-sat)

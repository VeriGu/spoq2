...
(assert
 ...
 (let ((?x5988 (meta_granule_offset ?x6934)))
 (let ((?x63418 (+ 8 ?x5988)))
 (let ((?x103236 (mod ?x63418 4096)))
 (= ?x103236 8)))))))
(assert
 (let (($x64459 (forall ((gidx.2520847 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87104 (share ?x55693)))
 (let ((?x21361 (granule_data ?x87104)))
 (let (($x45538 (= (g_norm (select ?x21361 gidx.2520847)) zero_granule_data)))
 (let ((?x45014 (test_Z_PTE.0_call v_0.2520631)))
 (let ((?x6934 (meta_PA ?x45014)))
 (let ((?x5988 (meta_granule_offset ?x6934)))
 ...
 (let ((?x33862 (mks_granule (e_lock ?x6791) 4 (e_ref ?x6791))))
 (let ((?x7459 (store ?x55531 ?x54634 ?x33862)))
 (=> (= (e_state_s_granule (select ?x7459 gidx.2520847)) 1) $x45538))))))))))))))))))))))))))))))))))))))
 ))
 (not $x64459)))
(check-sat)

...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2530256 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2530256)) zero_granule_data)))
 (let (($x6211 (= (e_state_s_granule (select (g_granules (globals ?x99112)) gidx.2530256)) 1)))
 (=> $x6211 $x50562))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2530291 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2530291))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x46716 (forall ((gidx.2530427 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x70260 (= (g_norm (select ?x49969 gidx.2530427)) zero_granule_data)))
 (let (($x50356 (= (e_state_s_granule (select (g_granules (globals ?x9093)) gidx.2530427)) 1)))
 (or (not $x50356) $x70260))))))))))))))))))))))))))))))))))
 ))
 (let (($x51488 (forall ((gidx.2530416 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let (($x50562 (= (g_norm (select ?x50459 gidx.2530416)) zero_granule_data)))
 (let (($x6211 (= (e_state_s_granule (select (g_granules (globals ?x99112)) gidx.2530416)) 1)))
 (or (not $x6211) $x50562))))))))))))))))))))))))))))))
 ))
 (or (not $x51488) $x46716))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x52237 (test_Z_PTE.0_call v_0.2530291)))
 (let ((?x51264 (meta_PA ?x52237)))
 (let ((?x71992 (meta_granule_offset ?x51264)))
 (let (($x61651 (>= ?x71992 0)))
 (let ((?x7533 (mod ?x71992 4096)))
 (let (($x123671 (= ?x7533 0)))
 (and $x123671 $x61651))))))))
(assert
 (let (($x10040 (forall ((gidx.2530618 Int) )(let ((?x52237 (test_Z_PTE.0_call v_0.2530291)))
 (let ((?x51264 (meta_PA ?x52237)))
 (let ((?x71992 (meta_granule_offset ?x51264)))
 (let ((?x10730 (div ?x71992 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x99112 (share ?x57524)))
 (let ((?x50459 (granule_data ?x99112)))
 (let ((?x114063 (select ?x50459 ?x10730)))
 (let ((?x49763 (mkr_granule_data (gd_g_idx ?x114063) (g_granule_state ?x114063) zero_granule_data (g_rd ?x114063) (g_rec ?x114063))))
 (let ((?x9939 (store ?x50459 ?x10730 ?x49763)))
 (let ((?x33804 (mks_granule (e_lock (select (g_granules (globals ?x99112)) ?x10730)) 4 (e_ref (select (g_granules (globals ?x99112)) ?x10730)))))
 (let ((?x49323 (globals ?x99112)))
 (let ((?x46268 (g_granules ?x49323)))
 (let ((?x39679 (store ?x46268 ?x10730 ?x33804)))
 (let (($x70253 (= (e_state_s_granule (select ?x39679 gidx.2530618)) 1)))
 (=> $x70253 (= (g_norm (select ?x9939 gidx.2530618)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10040)))
(check-sat)

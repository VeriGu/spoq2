...
(assert
 ...
 (and $x1381 $x1387)))))))
(assert
 (let (($x8249 (forall ((gidx.2523004 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x56368 (share ?x66036)))
 (let ((?x47346 (granule_data ?x56368)))
 (let ((?x47055 (select ?x47346 gidx.2523004)))
 (let (($x56949 (= (g_norm ?x47055) zero_granule_data)))
 (let (($x57112 (= (e_state_s_granule (select (g_granules (globals ?x56368)) gidx.2523004)) 1)))
 (=> $x57112 $x56949)))))))))))))))
 ))
 (not $x8249)))
(check-sat)

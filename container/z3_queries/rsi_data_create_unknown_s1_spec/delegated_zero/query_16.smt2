...
(declare-fun v_0.2507172 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507172)))))
...
(assert
 ...
 (= ?x1748 2))))))))))))))))))))))))
(assert
 (forall ((gidx.2507385 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x1711 (test_Z_PTE.0_call v_0.2507172)))
 (let ((?x36794 (meta_PA ?x1711)))
 (let ((?x28792 (meta_granule_offset ?x36794)))
 (let ((?x28741 (mkPtr "granule_data" ?x28792)))
 (let ((?x45835 (memcpy_ns_read_spec_state_oracle.0_call ?x28741 ?x1820 4096 ?x36240)))
 (let ((?x37062 (value_Tuple_bool_RData ?x45835)))
 (let ((?x2074 (elem_1 ?x37062)))
 (let ((?x66461 (share ?x2074)))
 (let ((?x28615 (granule_data ?x66461)))
 (let (($x37090 (= (g_norm (select ?x28615 gidx.2507385)) zero_granule_data)))
 (let (($x37078 (= (e_state_s_granule (select (g_granules (globals ?x66461)) gidx.2507385)) 1)))
 (=> $x37078 $x37090)))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2507420 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2507420))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x2074 (elem_1 ?x37062)))
 (let ((?x66461 (share ?x2074)))
 (let ((?x28988 (gpt ?x66461)))
 (select ?x28988 ?x1107))))))))))))))))))))))))))
 )
(assert
 (let (($x36968 (forall ((gidx.2507556 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66461 (share ?x2074)))
 (let ((?x2130 (log ?x2074)))
 (let ((?x2182 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507172)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec_state_oracle.0_call
                       ...
                       4096
                       a!4)))))
  (oracle a!5)))))_call| ?x2130)))
 (let ((?x2047 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2507172)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec_state_oracle.0_call
                       ...
                       4096
                       a!4)))))
  (repl a!5)))))_call| ?x2182 ?x66461)))
 (let ((?x2091 (value_Shared ?x2047)))
 (let ((?x28974 (granule_data ?x2091)))
 (let (($x2035 (= (g_norm (select ?x28974 gidx.2507556)) zero_granule_data)))
 (let (($x36715 (= (e_state_s_granule (select (g_granules (globals ?x2091)) gidx.2507556)) 1)))
 (or (not $x36715) $x2035)))))))))))))))))))))))))))))))
 ))
 (let (($x37039 (forall ((gidx.2507545 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x66461 (share ?x2074)))
 (let ((?x28615 (granule_data ?x66461)))
 (let (($x37090 (= (g_norm (select ?x28615 gidx.2507545)) zero_granule_data)))
 (let (($x37078 (= (e_state_s_granule (select (g_granules (globals ?x66461)) gidx.2507545)) 1)))
 (or (not $x37078) $x37090)))))))))))))))))))))))))))
 ))
 (or (not $x37039) $x36968))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (not $x1448)))))
(assert
 (let (($x46027 (forall ((gidx.2507858 Int) )(let ((?x28984 (test_Z_PTE.0_call v_0.2507420)))
 (let ((?x2244 (meta_PA ?x28984)))
 (let ((?x2234 (meta_granule_offset ?x2244)))
 (let ((?x2181 (div ?x2234 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x66461 (share ?x2074)))
 (let ((?x28615 (granule_data ?x66461)))
 (let ((?x2402 (select ?x28615 ?x2181)))
 (let ((?x29226 (mkr_granule_data (gd_g_idx ?x2402) (g_granule_state ?x2402) zero_granule_data (g_rd ?x2402) (g_rec ?x2402))))
 (let ((?x29076 (store ?x28615 ?x2181 ?x29226)))
 (let (($x2110 (= (g_norm (select ?x29076 gidx.2507858)) zero_granule_data)))
 (let ((?x37097 (globals ?x66461)))
 (let ((?x37115 (g_granules ?x37097)))
 (let ((?x28888 (select ?x37115 ?x2181)))
 (let ((?x36982 (e_ref ?x28888)))
 (let ((?x28933 (e_lock ?x28888)))
 (let ((?x82974 (mks_granule ?x28933 1 ?x36982)))
 (let ((?x2399 (store ?x37115 ?x2181 ?x82974)))
 (=> (= (e_state_s_granule (select ?x2399 gidx.2507858)) 1) $x2110))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x46027)))
(check-sat)

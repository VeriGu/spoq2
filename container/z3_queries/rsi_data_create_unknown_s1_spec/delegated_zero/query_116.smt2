...
(assert
 ...
 (and $x114631 $x5228))))))))
(assert
 (let (($x56846 (forall ((gidx.2522411 Int) )(let ((?x47226 (test_Z_PTE.0_call v_0.2521973)))
 (let ((?x45903 (meta_PA ?x47226)))
 (let ((?x46979 (meta_granule_offset ?x45903)))
 ...
 (let (($x6909 (= (g_norm (select ?x51809 gidx.2522411)) zero_granule_data)))
 (let ((?x56408 (globals ?x87104)))
 (let ((?x55531 (g_granules ?x56408)))
 (let ((?x33936 (select ?x55531 ?x46128)))
 (let ((?x57276 (e_ref ?x33936)))
 (let ((?x67301 (e_lock ?x33936)))
 (let ((?x102488 (mks_granule ?x67301 1 ?x57276)))
 (let ((?x56543 (store ?x55531 ?x46128 ?x102488)))
 (=> (= (e_state_s_granule (select ?x56543 gidx.2522411)) 1) $x6909)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x56846)))
(check-sat)

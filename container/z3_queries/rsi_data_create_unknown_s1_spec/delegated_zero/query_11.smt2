...
(assert
 ...
 (not $x1448)))))
(assert
 (let (($x2128 (forall ((gidx.2507063 Int) )(let ((?x36884 (test_Z_PTE.0_call v_0.2506625)))
 ...
 (let (($x2137 (= (g_norm (select ?x36958 gidx.2507063)) zero_granule_data)))
 (let ((?x1790 (globals ?x65689)))
 (let ((?x1794 (g_granules ?x1790)))
 (let ((?x82550 (select ?x1794 ?x2049)))
 (let ((?x2053 (e_ref ?x82550)))
 (let ((?x36885 (e_lock ?x82550)))
 (let ((?x82498 (mks_granule ?x36885 1 ?x2053)))
 (let ((?x36654 (store ?x1794 ?x2049 ?x82498)))
 (=> (= (e_state_s_granule (select ?x36654 gidx.2507063)) 1) $x2137))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2128)))
(check-sat)

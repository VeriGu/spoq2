...
(declare-fun v_0.2512065 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2512065)))))
...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2512278 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x3881 (test_Z_PTE.0_call v_0.2512065)))
 (let ((?x49865 (meta_PA ?x3881)))
 (let ((?x3972 (meta_granule_offset ?x49865)))
 (let ((?x48814 (mkPtr "granule_data" ?x3972)))
 (let ((?x49765 (memcpy_ns_read_spec_state_oracle.0_call ?x48814 ?x1820 4096 ?x2828)))
 (let ((?x41291 (value_Tuple_bool_RData ?x49765)))
 (let ((?x49787 (elem_1 ?x41291)))
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2512278)) zero_granule_data)))
 (let (($x41128 (= (e_state_s_granule (select (g_granules (globals ?x80966)) gidx.2512278)) 1)))
 (=> $x41128 $x49214))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2512313 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2512313))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x49787 (elem_1 ?x41291)))
 (let ((?x80966 (share ?x49787)))
 (let ((?x49774 (gpt ?x80966)))
 (select ?x49774 ?x1107)))))))))))))))))))))))))))))
 )
(assert
 (let (($x31162 (forall ((gidx.2512449 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x49787 (elem_1 ?x41291)))
 (let ((?x80966 (share ?x49787)))
 (let ((?x67537 (log ?x49787)))
 (let ((?x4202 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2512065)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (oracle (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x67537)))
 (let ((?x41530 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2512065)))))
      (a!2 (value_RData (query_oracle.0_call
                          (value_RData (query_oracle.0_call st.0))))))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             4096
             (value_RData (query_oracle.0_call (elem_1 a!4))))))
  (repl (elem_1 (value_Tuple_bool_RData a!5)))))))_call| ?x4202 ?x80966)))
 (let ((?x3271 (value_Shared ?x41530)))
 (let ((?x4215 (granule_data ?x3271)))
 (let (($x4266 (= (g_norm (select ?x4215 gidx.2512449)) zero_granule_data)))
 (let (($x61759 (= (e_state_s_granule (select (g_granules (globals ?x3271)) gidx.2512449)) 1)))
 (or (not $x61759) $x4266))))))))))))))))))))))))))))))))))
 ))
 (let (($x3502 (forall ((gidx.2512438 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let (($x49214 (= (g_norm (select ?x49086 gidx.2512438)) zero_granule_data)))
 (let (($x41128 (= (e_state_s_granule (select (g_granules (globals ?x80966)) gidx.2512438)) 1)))
 (or (not $x41128) $x49214))))))))))))))))))))))))))))))
 ))
 (or (not $x3502) $x31162))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x49790 (test_Z_PTE.0_call v_0.2512313)))
 (let ((?x4281 (meta_PA ?x49790)))
 (let ((?x4003 (meta_granule_offset ?x4281)))
 (let (($x3995 (>= ?x4003 0)))
 (let ((?x97087 (mod ?x4003 4096)))
 (let (($x106706 (= ?x97087 0)))
 (and $x106706 $x3995))))))))
(assert
 (let (($x4342 (forall ((gidx.2512640 Int) )(let ((?x49790 (test_Z_PTE.0_call v_0.2512313)))
 (let ((?x4281 (meta_PA ?x49790)))
 (let ((?x4003 (meta_granule_offset ?x4281)))
 (let ((?x1592 (div ?x4003 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x80966 (share ?x49787)))
 (let ((?x49086 (granule_data ?x80966)))
 (let ((?x97163 (select ?x49086 ?x1592)))
 (let ((?x3765 (mkr_granule_data (gd_g_idx ?x97163) (g_granule_state ?x97163) zero_granule_data (g_rd ?x97163) (g_rec ?x97163))))
 (let ((?x4204 (store ?x49086 ?x1592 ?x3765)))
 (let ((?x3911 (mks_granule (e_lock (select (g_granules (globals ?x80966)) ?x1592)) 4 (e_ref (select (g_granules (globals ?x80966)) ?x1592)))))
 (let ((?x41076 (globals ?x80966)))
 (let ((?x58847 (g_granules ?x41076)))
 (let ((?x3773 (store ?x58847 ?x1592 ?x3911)))
 (let (($x49973 (= (e_state_s_granule (select ?x3773 gidx.2512640)) 1)))
 (=> $x49973 (= (g_norm (select ?x4204 gidx.2512640)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4342)))
(check-sat)

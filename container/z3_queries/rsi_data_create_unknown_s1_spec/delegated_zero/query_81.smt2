...
(assert
 ...
 (let ((?x5292 (meta_granule_offset ?x5334)))
 (let ((?x62528 (+ 8 ?x5292)))
 (let ((?x112550 (mod ?x62528 4096)))
 (= ?x112550 8)))))))
(assert
 (let (($x4586 (forall ((gidx.2517359 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x97095 (share ?x53610)))
 (let ((?x53214 (granule_data ?x97095)))
 (let (($x53346 (= (g_norm (select ?x53214 gidx.2517359)) zero_granule_data)))
 (let ((?x5879 (test_Z_PTE.0_call v_0.2517143)))
 (let ((?x5334 (meta_PA ?x5879)))
 (let ((?x5292 (meta_granule_offset ?x5334)))
 ...
 (let ((?x42427 (mks_granule (e_lock ?x53538) 4 (e_ref ?x53538))))
 (let ((?x62550 (store ?x33229 ?x43162 ?x42427)))
 (=> (= (e_state_s_granule (select ?x62550 gidx.2517359)) 1) $x53346))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4586)))
(check-sat)

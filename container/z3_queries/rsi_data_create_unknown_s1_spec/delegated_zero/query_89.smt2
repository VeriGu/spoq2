...
(assert
 ...
 (let ((?x42536 (meta_granule_offset ?x42761)))
 (let (($x99212 (>= ?x42536 0)))
 (let ((?x62847 (mod ?x42536 4096)))
 (let (($x3553 (= ?x62847 0)))
 (and $x3553 $x99212))))))))
(assert
 (let (($x63787 (forall ((gidx.2518282 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x47432 (share ?x2938)))
 (let ((?x3135 (granule_data ?x47432)))
 (let (($x2909 (= (g_norm (select ?x3135 gidx.2518282)) zero_granule_data)))
 (let ((?x42339 (test_Z_PTE.0_call v_0.2514510)))
 (let ((?x42761 (meta_PA ?x42339)))
 (let ((?x42536 (meta_granule_offset ?x42761)))
 (let ((?x51012 (div ?x42536 4096)))
 ...
 (let ((?x2874 (g_granules ?x3118)))
 (let ((?x31574 (select ?x2874 ?x51012)))
 (let ((?x6314 (e_ref ?x31574)))
 (let ((?x72457 (e_lock ?x31574)))
 (let ((?x65545 (mks_granule ?x72457 1 ?x6314)))
 (let ((?x44741 (store ?x2874 ?x51012 ?x65545)))
 (=> (= (e_state_s_granule (select ?x44741 gidx.2518282)) 1) $x2909))))))))))))))))))))))))))))))
 ))
 (not $x63787)))
(check-sat)

...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2527572 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x60307 (= (g_norm (select ?x37629 gidx.2527572)) zero_granule_data)))
 (let (($x57534 (= (e_state_s_granule (select (g_granules (globals ?x95885)) gidx.2527572)) 1)))
 (=> $x57534 $x60307))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2527607 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2527607))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x59782 (forall ((gidx.2527743 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x9917 (= (g_norm (select ?x10341 gidx.2527743)) zero_granule_data)))
 (let (($x8582 (= (e_state_s_granule (select (g_granules (globals ?x50507)) gidx.2527743)) 1)))
 (or (not $x8582) $x9917))))))))))))))))))))))))))))))))))
 ))
 (let (($x10201 (forall ((gidx.2527732 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x95885 (share ?x70867)))
 (let ((?x37629 (granule_data ?x95885)))
 (let (($x60307 (= (g_norm (select ?x37629 gidx.2527732)) zero_granule_data)))
 (let (($x57534 (= (e_state_s_granule (select (g_granules (globals ?x95885)) gidx.2527732)) 1)))
 (or (not $x57534) $x60307))))))))))))))))))))))))))))))
 ))
 (or (not $x10201) $x59782))))
(assert
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
...
(assert
 ...
 (not $x1448)))))
(assert
 (let ((?x8501 (test_Z_PTE.0_call v_0.2527607)))
 (let ((?x9278 (meta_PA ?x8501)))
 (let ((?x8457 (meta_granule_offset ?x9278)))
 (let (($x38010 (>= ?x8457 0)))
 (let ((?x111441 (mod ?x8457 4096)))
 (let (($x118270 (= ?x111441 0)))
 (and $x118270 $x38010))))))))
(assert
 (let (($x47565 (forall ((gidx.2528045 Int) )(let ((?x8501 (test_Z_PTE.0_call v_0.2527607)))
 (let ((?x9278 (meta_PA ?x8501)))
 (let ((?x8457 (meta_granule_offset ?x9278)))
 (let ((?x9276 (div ?x8457 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x95885 (share ?x70867)))
 (let ((?x37629 (granule_data ?x95885)))
 (let ((?x44160 (select ?x37629 ?x9276)))
 (let ((?x37983 (mkr_granule_data (gd_g_idx ?x44160) (g_granule_state ?x44160) zero_granule_data (g_rd ?x44160) (g_rec ?x44160))))
 (let ((?x42951 (store ?x37629 ?x9276 ?x37983)))
 (let (($x38194 (= (g_norm (select ?x42951 gidx.2528045)) zero_granule_data)))
 (let ((?x60410 (globals ?x95885)))
 (let ((?x58914 (g_granules ?x60410)))
 (let ((?x7173 (select ?x58914 ?x9276)))
 (let ((?x59573 (e_ref ?x7173)))
 (let ((?x9467 (e_lock ?x7173)))
 (let ((?x109688 (mks_granule ?x9467 1 ?x59573)))
 (let ((?x10011 (store ?x58914 ?x9276 ?x109688)))
 (=> (= (e_state_s_granule (select ?x10011 gidx.2528045)) 1) $x38194)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x47565)))
(check-sat)

...
(assert
 ...
 (and $x119450 $x6987))))))))
(assert
 (let (($x56167 (forall ((gidx.2521069 Int) )(let ((?x45014 (test_Z_PTE.0_call v_0.2520631)))
 (let ((?x6934 (meta_PA ?x45014)))
 (let ((?x5988 (meta_granule_offset ?x6934)))
 ...
 (let (($x47474 (= (g_norm (select ?x5813 gidx.2521069)) zero_granule_data)))
 (let ((?x56408 (globals ?x87104)))
 (let ((?x55531 (g_granules ?x56408)))
 (let ((?x6791 (select ?x55531 ?x54634)))
 (let ((?x6385 (e_ref ?x6791)))
 (let ((?x7249 (e_lock ?x6791)))
 (let ((?x95165 (mks_granule ?x7249 1 ?x6385)))
 (let ((?x6753 (store ?x55531 ?x54634 ?x95165)))
 (=> (= (e_state_s_granule (select ?x6753 gidx.2521069)) 1) $x47474)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x56167)))
(check-sat)

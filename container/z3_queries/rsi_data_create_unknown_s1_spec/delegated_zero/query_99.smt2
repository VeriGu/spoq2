...
(assert
 ...
 (not $x3402)))))))))))))))))))))))))))
(assert
 (let (($x54196 (forall ((gidx.2519764 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x66689 (share ?x2828)))
 (let ((?x3026 (granule_data ?x66689)))
 (let (($x48588 (= (g_norm (select ?x3026 gidx.2519764)) zero_granule_data)))
 (let (($x40199 (= (e_state_s_granule (select (g_granules (globals ?x66689)) gidx.2519764)) 1)))
 (=> $x40199 $x48588))))))))))))))))))))))
 ))
 (not $x54196)))
(check-sat)

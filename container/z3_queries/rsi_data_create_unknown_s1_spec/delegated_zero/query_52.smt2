...
(assert
 ...
 (= ?x30824 ?x3085))))))))))))))))))))))))))
(assert
 (let (($x4596 (forall ((gidx.2513036 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x81704 (share ?x4062)))
 (let ((?x4363 (granule_data ?x81704)))
 (let (($x46753 (= (g_norm (select ?x4363 gidx.2513036)) zero_granule_data)))
 (let (($x3469 (= (e_state_s_granule (select (g_granules (globals ?x81704)) gidx.2513036)) 1)))
 (=> $x3469 $x46753))))))))))))))))))))))))
 ))
 (not $x4596)))
(check-sat)

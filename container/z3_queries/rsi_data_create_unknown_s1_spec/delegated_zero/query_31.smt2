...
(assert
 ...
 (not $x1215))))))))))))))
(assert
 (let (($x2678 (forall ((gidx.2509584 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x10102 (share ?x1112)))
 (let ((?x1084 (granule_data ?x10102)))
 (let ((?x1134 (select ?x1084 gidx.2509584)))
 (let (($x1155 (= (g_norm ?x1134) zero_granule_data)))
 (let (($x1158 (= (e_state_s_granule (select (g_granules (globals ?x10102)) gidx.2509584)) 1)))
 (=> $x1158 $x1155)))))))))
 ))
 (not $x2678)))
(check-sat)

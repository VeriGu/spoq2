...
(assert
 ...
 (and $x107134 $x52298))))))))
(assert
 (let (($x43853 (forall ((gidx.2515880 Int) )(let ((?x43953 (test_Z_PTE.0_call v_0.2515553)))
 (let ((?x61559 (meta_PA ?x43953)))
 (let ((?x62037 (meta_granule_offset ?x61559)))
 ...
 (let ((?x52648 (mks_granule (e_lock (select (g_granules (globals ?x82843)) ?x5067)) 4 (e_ref (select (g_granules (globals ?x82843)) ?x5067)))))
 (let ((?x61678 (globals ?x82843)))
 (let ((?x46921 (g_granules ?x61678)))
 (let ((?x5602 (store ?x46921 ?x5067 ?x52648)))
 (let (($x32560 (= (e_state_s_granule (select ?x5602 gidx.2515880)) 1)))
 (=> $x32560 (= (g_norm (select ?x52558 gidx.2515880)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43853)))
(check-sat)

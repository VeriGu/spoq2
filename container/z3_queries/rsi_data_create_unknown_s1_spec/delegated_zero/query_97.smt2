...
(assert
 ...
 (= ?x3231 2))))))))))))))))))))))))))
(assert
 (forall ((gidx.2519254 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x6359 (= (g_norm (select ?x6084 gidx.2519254)) zero_granule_data)))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x87008)) gidx.2519254)) 1)))
 (=> $x5214 $x6359))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2519289 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2519289))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x55210 (forall ((gidx.2519425 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x6592 (= (g_norm (select ?x54759 gidx.2519425)) zero_granule_data)))
 (let (($x6489 (= (e_state_s_granule (select (g_granules (globals ?x45837)) gidx.2519425)) 1)))
 (or (not $x6489) $x6592))))))))))))))))))))))))))))))))))
 ))
 (let (($x6339 (forall ((gidx.2519414 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x87008 (share ?x54965)))
 (let ((?x6084 (granule_data ?x87008)))
 (let (($x6359 (= (g_norm (select ?x6084 gidx.2519414)) zero_granule_data)))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x87008)) gidx.2519414)) 1)))
 (or (not $x5214) $x6359))))))))))))))))))))))))))))))
 ))
 (or (not $x6339) $x55210))))
(assert
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x6551 (test_Z_PTE.0_call v_0.2519289)))
 (let ((?x2120 (meta_PA ?x6551)))
 (let ((?x5714 (meta_granule_offset ?x2120)))
 (let (($x5606 (>= ?x5714 0)))
 (let ((?x102172 (mod ?x5714 4096)))
 (let (($x113053 (= ?x102172 0)))
 (and $x113053 $x5606))))))))
(assert
 (let (($x54551 (forall ((gidx.2519616 Int) )(let ((?x6551 (test_Z_PTE.0_call v_0.2519289)))
 (let ((?x2120 (meta_PA ?x6551)))
 (let ((?x5714 (meta_granule_offset ?x2120)))
 (let ((?x37796 (div ?x5714 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x87008 (share ?x54965)))
 (let ((?x6084 (granule_data ?x87008)))
 (let ((?x31840 (select ?x6084 ?x37796)))
 (let ((?x6190 (mkr_granule_data (gd_g_idx ?x31840) (g_granule_state ?x31840) zero_granule_data (g_rd ?x31840) (g_rec ?x31840))))
 (let ((?x6778 (store ?x6084 ?x37796 ?x6190)))
 (let ((?x6286 (mks_granule (e_lock (select (g_granules (globals ?x87008)) ?x37796)) 4 (e_ref (select (g_granules (globals ?x87008)) ?x37796)))))
 (let ((?x6224 (globals ?x87008)))
 (let ((?x54915 (g_granules ?x6224)))
 (let ((?x6608 (store ?x54915 ?x37796 ?x6286)))
 (let (($x45593 (= (e_state_s_granule (select ?x6608 gidx.2519616)) 1)))
 (=> $x45593 (= (g_norm (select ?x6778 gidx.2519616)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x54551)))
(check-sat)

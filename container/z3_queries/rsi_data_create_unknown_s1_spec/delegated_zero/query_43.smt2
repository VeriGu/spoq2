...
(assert
 ...
 (let ((?x3786 (meta_granule_offset ?x48604)))
 (let ((?x3937 (+ 8 ?x3786)))
 (let ((?x96771 (mod ?x3937 4096)))
 (= ?x96771 8)))))))
(assert
 (let (($x49319 (forall ((gidx.2511734 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x79850 (share ?x3398)))
 (let ((?x48794 (granule_data ?x79850)))
 (let (($x48830 (= (g_norm (select ?x48794 gidx.2511734)) zero_granule_data)))
 (let ((?x49410 (test_Z_PTE.0_call v_0.2511518)))
 (let ((?x48604 (meta_PA ?x49410)))
 (let ((?x3786 (meta_granule_offset ?x48604)))
 ...
 (let ((?x49649 (mks_granule (e_lock ?x41222) 4 (e_ref ?x41222))))
 (let ((?x3883 (store ?x30576 ?x3837 ?x49649)))
 (=> (= (e_state_s_granule (select ?x3883 gidx.2511734)) 1) $x48830))))))))))))))))))))))))))))))))))))))
 ))
 (not $x49319)))
(check-sat)

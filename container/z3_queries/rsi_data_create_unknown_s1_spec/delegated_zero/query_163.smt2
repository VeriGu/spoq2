...
(assert
 ...
 (and $x120557 $x6406))))))))
(assert
 (let (($x58650 (forall ((gidx.2529276 Int) )(let ((?x60091 (test_Z_PTE.0_call v_0.2528949)))
 (let ((?x70038 (meta_PA ?x60091)))
 (let ((?x9886 (meta_granule_offset ?x70038)))
 ...
 (let ((?x9306 (mks_granule (e_lock (select (g_granules (globals ?x99112)) ?x60356)) 4 (e_ref (select (g_granules (globals ?x99112)) ?x60356)))))
 (let ((?x49323 (globals ?x99112)))
 (let ((?x46268 (g_granules ?x49323)))
 (let ((?x51563 (store ?x46268 ?x60356 ?x9306)))
 (let (($x73336 (= (e_state_s_granule (select ?x51563 gidx.2529276)) 1)))
 (=> $x73336 (= (g_norm (select ?x10277 gidx.2529276)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x58650)))
(check-sat)

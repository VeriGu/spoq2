...
(assert
 ...
 (not $x3402)))))))))))))))))))))))))))
(assert
 (forall ((gidx.2511483 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let (($x48830 (= (g_norm (select ?x48794 gidx.2511483)) zero_granule_data)))
 (let (($x40475 (= (e_state_s_granule (select (g_granules (globals ?x79850)) gidx.2511483)) 1)))
 (=> $x40475 $x48830))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2511518 Int) )(let ((?x1107 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2511518))) 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
...
(assert
 (let (($x3785 (forall ((gidx.2511654 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
...
(let ((a!5 (memcpy_ns_read_spec_state_oracle.0_call
 ...
 (let (($x3318 (= (g_norm (select ?x3497 gidx.2511654)) zero_granule_data)))
 (let (($x3421 (= (e_state_s_granule (select (g_granules (globals ?x30411)) gidx.2511654)) 1)))
 (or (not $x3421) $x3318))))))))))))))))))))))))))))))))))
 ))
 (let (($x3769 (forall ((gidx.2511643 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x79850 (share ?x3398)))
 (let ((?x48794 (granule_data ?x79850)))
 (let (($x48830 (= (g_norm (select ?x48794 gidx.2511643)) zero_granule_data)))
 (let (($x40475 (= (e_state_s_granule (select (g_granules (globals ?x79850)) gidx.2511643)) 1)))
...
(assert
 ...
 (= ?x1994 0))))
(assert
 (let ((?x49410 (test_Z_PTE.0_call v_0.2511518)))
 (let ((?x48604 (meta_PA ?x49410)))
 (let ((?x3786 (meta_granule_offset ?x48604)))
 (let (($x49428 (>= ?x3786 0)))
 (let ((?x96609 (mod ?x3786 4096)))
 (let (($x96379 (= ?x96609 0)))
 (and $x96379 $x49428))))))))
(assert
 (let (($x49523 (forall ((gidx.2511845 Int) )(let ((?x49410 (test_Z_PTE.0_call v_0.2511518)))
 (let ((?x48604 (meta_PA ?x49410)))
 (let ((?x3786 (meta_granule_offset ?x48604)))
 (let ((?x3837 (div ?x3786 4096)))
 (let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 ...
 (let ((?x79850 (share ?x3398)))
 (let ((?x48794 (granule_data ?x79850)))
 (let ((?x96732 (select ?x48794 ?x3837)))
 (let ((?x3586 (mkr_granule_data (gd_g_idx ?x96732) (g_granule_state ?x96732) zero_granule_data (g_rd ?x96732) (g_rec ?x96732))))
 (let ((?x41154 (store ?x48794 ?x3837 ?x3586)))
 (let ((?x49649 (mks_granule (e_lock (select (g_granules (globals ?x79850)) ?x3837)) 4 (e_ref (select (g_granules (globals ?x79850)) ?x3837)))))
 (let ((?x30767 (globals ?x79850)))
 (let ((?x30576 (g_granules ?x30767)))
 (let ((?x3883 (store ?x30576 ?x3837 ?x49649)))
 (let (($x31183 (= (e_state_s_granule (select ?x3883 gidx.2511845)) 1)))
 (=> $x31183 (= (g_norm (select ?x41154 gidx.2511845)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x49523)))
(check-sat)

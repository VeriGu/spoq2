...
(assert
 ...
 (and $x58296 $x111564))))))))
(assert
 (let (($x11354 (forall ((gidx.2530960 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x47432 (share ?x2938)))
 (let ((?x3135 (granule_data ?x47432)))
 (let (($x2909 (= (g_norm (select ?x3135 gidx.2530960)) zero_granule_data)))
 (let ((?x38436 (test_Z_PTE.0_call v_0.2527111)))
 (let ((?x36427 (meta_PA ?x38436)))
 (let ((?x70967 (meta_granule_offset ?x36427)))
 (let ((?x70122 (div ?x70967 4096)))
 ...
 (let ((?x9388 (mks_granule ?x83733 4 ?x52673)))
 (let ((?x63675 (store ?x2874 ?x70122 ?x9388)))
 (=> (= (e_state_s_granule (select ?x63675 gidx.2530960)) 1) $x2909))))))))))))))))))))))))))))))
 ))
 (not $x11354)))
(check-sat)

...
(assert
 ...
 (let ((?x44014 (meta_granule_offset ?x60542)))
 (let ((?x5625 (+ 8 ?x44014)))
 (let ((?x100339 (mod ?x5625 4096)))
 (= ?x100339 8)))))))
(assert
 (let (($x43148 (forall ((gidx.2516564 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x83592 (share ?x52315)))
 (let ((?x5186 (granule_data ?x83592)))
 (let (($x70873 (= (g_norm (select ?x5186 gidx.2516564)) zero_granule_data)))
 (let ((?x32678 (test_Z_PTE.0_call v_0.2516348)))
 (let ((?x60542 (meta_PA ?x32678)))
 (let ((?x44014 (meta_granule_offset ?x60542)))
 ...
 (let ((?x5100 (mks_granule (e_lock ?x5677) 4 (e_ref ?x5677))))
 (let ((?x5404 (store ?x43571 ?x43724 ?x5100)))
 (=> (= (e_state_s_granule (select ?x5404 gidx.2516564)) 1) $x70873))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43148)))
(check-sat)

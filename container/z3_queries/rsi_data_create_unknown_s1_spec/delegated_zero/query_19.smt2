...
(assert
 ...
 (= ?x82222 8)))))))))))))))))
(assert
 (let (($x37571 (forall ((gidx.2508431 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x37349 (share ?x37483)))
 (let ((?x37538 (granule_data ?x37349)))
 (let (($x29140 (= (g_norm (select ?x37538 gidx.2508431)) zero_granule_data)))
 (let ((?x2525 (test_Z_PTE.0_call v_0.2508215)))
 ...
 (let ((?x2380 (mks_granule (e_lock ?x94627) 4 (e_ref ?x94627))))
 (let ((?x46248 (store ?x37047 ?x2018 ?x2380)))
 (=> (= (e_state_s_granule (select ?x46248 gidx.2508431)) 1) $x29140)))))))))))))))))))))))))))))))))))))
 ))
 (not $x37571)))
(check-sat)

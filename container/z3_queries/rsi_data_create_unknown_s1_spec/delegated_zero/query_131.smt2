...
(assert
 ...
 (and $x128048 $x67187))))))))
(assert
 (let (($x8512 (forall ((gidx.2524557 Int) )(let ((?x5524 (test_Z_PTE.0_call v_0.2524119)))
 (let ((?x67518 (meta_PA ?x5524)))
 (let ((?x8895 (meta_granule_offset ?x67518)))
 ...
 (let (($x8242 (= (g_norm (select ?x8004 gidx.2524557)) zero_granule_data)))
 (let ((?x6283 (globals ?x102821)))
 (let ((?x35563 (g_granules ?x6283)))
 (let ((?x67896 (select ?x35563 ?x60200)))
 (let ((?x76999 (e_ref ?x67896)))
 (let ((?x7388 (e_lock ?x67896)))
 (let ((?x113825 (mks_granule ?x7388 1 ?x76999)))
 (let ((?x76365 (store ?x35563 ?x60200 ?x113825)))
 (=> (= (e_state_s_granule (select ?x76365 gidx.2524557)) 1) $x8242)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8512)))
(check-sat)

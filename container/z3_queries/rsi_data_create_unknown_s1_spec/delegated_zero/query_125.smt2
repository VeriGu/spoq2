...
(assert
 ...
 (let ((?x7547 (meta_granule_offset ?x7693)))
 (let ((?x7967 (+ 8 ?x7547)))
 (let ((?x117804 (mod ?x7967 4096)))
 (= ?x117804 8)))))))
(assert
 (let (($x48077 (forall ((gidx.2523788 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x102821 (share ?x6739)))
 (let ((?x5751 (granule_data ?x102821)))
 (let (($x68235 (= (g_norm (select ?x5751 gidx.2523788)) zero_granule_data)))
 (let ((?x7936 (test_Z_PTE.0_call v_0.2523572)))
 (let ((?x7693 (meta_PA ?x7936)))
 (let ((?x7547 (meta_granule_offset ?x7693)))
 ...
 (let ((?x8683 (mks_granule (e_lock ?x8253) 4 (e_ref ?x8253))))
 (let ((?x6875 (store ?x35563 ?x7616 ?x8683)))
 (=> (= (e_state_s_granule (select ?x6875 gidx.2523788)) 1) $x68235))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x48077)))
(check-sat)

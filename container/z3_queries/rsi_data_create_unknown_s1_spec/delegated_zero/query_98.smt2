...
(assert
 ...
 (and $x113053 $x5606))))))))
(assert
 (let (($x6455 (forall ((gidx.2519727 Int) )(let ((?x6551 (test_Z_PTE.0_call v_0.2519289)))
 (let ((?x2120 (meta_PA ?x6551)))
 (let ((?x5714 (meta_granule_offset ?x2120)))
 ...
 (let (($x34644 (= (g_norm (select ?x6778 gidx.2519727)) zero_granule_data)))
 (let ((?x6224 (globals ?x87008)))
 (let ((?x54915 (g_granules ?x6224)))
 (let ((?x34004 (select ?x54915 ?x37796)))
 (let ((?x44952 (e_ref ?x34004)))
 (let ((?x6679 (e_lock ?x34004)))
 (let ((?x91843 (mks_granule ?x6679 1 ?x44952)))
 (let ((?x46658 (store ?x54915 ?x37796 ?x91843)))
 (=> (= (e_state_s_granule (select ?x46658 gidx.2519727)) 1) $x34644)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6455)))
(check-sat)

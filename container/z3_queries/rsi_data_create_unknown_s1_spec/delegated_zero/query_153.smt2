...
(assert
 ...
 (let ((?x8457 (meta_granule_offset ?x9278)))
 (let ((?x8317 (+ 8 ?x8457)))
 (let ((?x110449 (mod ?x8317 4096)))
 (= ?x110449 8)))))))
(assert
 (let (($x55024 (forall ((gidx.2527823 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x95885 (share ?x70867)))
 (let ((?x37629 (granule_data ?x95885)))
 (let (($x60307 (= (g_norm (select ?x37629 gidx.2527823)) zero_granule_data)))
 (let ((?x8501 (test_Z_PTE.0_call v_0.2527607)))
 (let ((?x9278 (meta_PA ?x8501)))
 (let ((?x8457 (meta_granule_offset ?x9278)))
 ...
 (let ((?x8686 (mks_granule (e_lock ?x7173) 4 (e_ref ?x7173))))
 (let ((?x8896 (store ?x58914 ?x9276 ?x8686)))
 (=> (= (e_state_s_granule (select ?x8896 gidx.2527823)) 1) $x60307))))))))))))))))))))))))))))))))))))))
 ))
 (not $x55024)))
(check-sat)

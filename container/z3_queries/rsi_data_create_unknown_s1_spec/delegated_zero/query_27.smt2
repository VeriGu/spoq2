...
(assert
 ...
 (let (($x2670 (= ?x1523 0)))
 (let (($x1644 (and $x2670 $x1712 $x1600)))
 (not $x1644))))))))))))))))))))))))))))
(assert
 ...
 (not $x2668)))))
(assert
 (let (($x38100 (forall ((gidx.2509354 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x1105 (test_PA.0_call v_1.0)))
 ...
 (let ((?x33808 (share ?x1488)))
 (let ((?x1527 (granule_data ?x33808)))
 (let (($x1499 (= (g_norm (select ?x1527 gidx.2509354)) zero_granule_data)))
 (let ((?x1501 (test_Z_PTE.0_call v_0.2505582)))
 (let ((?x1502 (meta_PA ?x1501)))
 (let ((?x1452 (meta_granule_offset ?x1502)))
 (let ((?x1475 (div ?x1452 4096)))
 ...
 (let ((?x1515 (g_granules ?x1510)))
 (let ((?x51696 (select ?x1515 ?x1475)))
 (let ((?x2492 (e_ref ?x51696)))
 (let ((?x95534 (e_lock ?x51696)))
 (let ((?x54888 (mks_granule ?x95534 1 ?x2492)))
 (let ((?x47704 (store ?x1515 ?x1475 ?x54888)))
 (=> (= (e_state_s_granule (select ?x47704 gidx.2509354)) 1) $x1499)))))))))))))))))))))))))))
 ))
 (not $x38100)))
(check-sat)

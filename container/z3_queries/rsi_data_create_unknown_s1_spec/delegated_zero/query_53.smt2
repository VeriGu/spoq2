...
(assert
 ...
 (let ((?x9265 (meta_granule_offset ?x3711)))
 (let ((?x50962 (+ 8 ?x9265)))
 (let ((?x99020 (mod ?x50962 4096)))
 (= ?x99020 8)))))))
(assert
 (let (($x4763 (forall ((gidx.2513324 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x2510 (query_oracle.0_call ?x1256)))
 ...
 (let ((?x98745 (share ?x38240)))
 (let ((?x3660 (granule_data ?x98745)))
 (let (($x50205 (= (g_norm (select ?x3660 gidx.2513324)) zero_granule_data)))
 (let ((?x4158 (test_Z_PTE.0_call v_0.2513108)))
 (let ((?x3711 (meta_PA ?x4158)))
 (let ((?x9265 (meta_granule_offset ?x3711)))
 ...
 (let ((?x42126 (mks_granule (e_lock ?x41988) 4 (e_ref ?x41988))))
 (let ((?x3849 (store ?x41900 ?x49771 ?x42126)))
 (=> (= (e_state_s_granule (select ?x3849 gidx.2513324)) 1) $x50205))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4763)))
(check-sat)

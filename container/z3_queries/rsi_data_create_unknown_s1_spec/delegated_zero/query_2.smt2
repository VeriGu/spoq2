...
(assert
 ...
 (and $x1381 $x1387)))))))
(assert
 (let (($x1437 (forall ((gidx.2505510 Int) )(let ((?x1079 (query_oracle.0_call st.0)))
 (let ((?x1112 (value_RData ?x1079)))
 (let ((?x1257 (query_oracle.0_call ?x1112)))
 (let ((?x1256 (value_RData ?x1257)))
 (let ((?x20968 (share ?x1256)))
 (let ((?x1314 (granule_data ?x20968)))
 (let ((?x1249 (select ?x1314 gidx.2505510)))
 (let (($x1295 (= (g_norm ?x1249) zero_granule_data)))
 (let (($x1251 (= (e_state_s_granule (select (g_granules (globals ?x20968)) gidx.2505510)) 1)))
 (=> $x1251 $x1295)))))))))))
 ))
 (not $x1437)))
(check-sat)

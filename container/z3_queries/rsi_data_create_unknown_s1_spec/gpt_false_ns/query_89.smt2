...
(assert
 ...
 (and $x9319 $x50850))))))))
(assert
 (let (($x9430 (forall ((gidx.2453491 Int) )(let ((?x52118 (test_Z_PTE.0_call v_0.2453245)))
 (let ((?x43687 (meta_PA ?x52118)))
 (let ((?x32975 (meta_granule_offset ?x43687)))
 ...
 (let ((?x33179 (e_state_s_granule (select ?x43330 gidx.2453491))))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2453491)))
 (let (($x98161 (not $x9125)))
 (=> $x98161 (or (= ?x33179 0) (= ?x33179 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9430)))
(check-sat)

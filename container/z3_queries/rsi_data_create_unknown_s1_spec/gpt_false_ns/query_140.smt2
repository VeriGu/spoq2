...
(assert
 ...
 (and $x12676 $x14035))))))))
(assert
 (let (($x14221 (forall ((gidx.2467547 Int) )(let ((?x14365 (test_Z_PTE.0_call v_0.2467301)))
 (let ((?x14179 (meta_PA ?x14365)))
 (let ((?x14449 (meta_granule_offset ?x14179)))
 ...
 (let ((?x13433 (e_state_s_granule (select ?x13444 gidx.2467547))))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2467547)))
 (let (($x62406 (not $x13479)))
 (=> $x62406 (or (= ?x13433 0) (= ?x13433 6))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x14221)))
(check-sat)

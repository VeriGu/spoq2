...
(assert
 ...
 (not $x10093)))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x11729 (forall ((gidx.2459819 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x10273 (globals ?x69090)))
 (let ((?x10196 (g_granules ?x10273)))
 (let ((?x10075 (e_state_s_granule (select ?x10196 gidx.2459819))))
 (let (($x9914 (= ?x10075 6)))
 (let (($x10051 (= ?x10075 0)))
 (=> (not (select (gpt ?x69090) gidx.2459819)) (or $x10051 $x9914)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x11729)))
(check-sat)

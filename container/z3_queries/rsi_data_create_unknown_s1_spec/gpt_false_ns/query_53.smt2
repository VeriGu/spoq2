...
(let ((a!11 (granule_unlock_spec.0_call
 ...
 (or (not $x6158) $x6336))))
(assert
 (let (($x6504 (forall ((gidx.2443635 Int) )(let ((?x6167 (test_Z_PTE.0_call v_0.2443389)))
 ...
 (let ((?x13533 (e_state_s_granule (select ?x47734 gidx.2443635))))
 (let ((?x6271 (gpt ?x94842)))
 (let (($x5962 (select ?x6271 gidx.2443635)))
 (let (($x6285 (not $x5962)))
 (=> $x6285 (or (= ?x13533 0) (= ?x13533 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6504)))
(check-sat)

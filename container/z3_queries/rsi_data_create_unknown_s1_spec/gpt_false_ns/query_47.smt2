...
(assert
 ...
 (and $x1370 $x1371)))))))
(assert
 (let (($x4561 (forall ((gidx.2441619 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5413 (globals ?x29595)))
 (let ((?x5262 (g_granules ?x5413)))
 (let ((?x4710 (e_state_s_granule (select ?x5262 gidx.2441619))))
 (let (($x5355 (= ?x4710 6)))
 (let (($x5240 (= ?x4710 0)))
 (=> (not (select (gpt ?x29595) gidx.2441619)) (or $x5240 $x5355)))))))))))))))))))))))))))
 ))
 (not $x4561)))
(check-sat)

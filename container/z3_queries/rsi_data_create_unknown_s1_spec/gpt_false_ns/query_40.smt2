...
(assert
 ...
 (not $x1319))))))))))))))))))))
(assert
 (forall ((gidx.2439826 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x28049 (e_state_s_granule (select ?x5085 gidx.2439826))))
 (let (($x3001 (= ?x28049 6)))
 (let (($x4548 (= ?x28049 0)))
 (=> (not (select (gpt ?x29045) gidx.2439826)) (or $x4548 $x3001))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2439861 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2439861))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x4416 (forall ((gidx.2440049 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
...
(let ((a!3 (spinlock_release_spec.0_call
 ...
 (let ((?x5178 (e_state_s_granule (select ?x29156 gidx.2440049))))
 (let (($x37127 (= ?x5178 0)))
 (let ((?x4821 (gpt ?x35761)))
 (let (($x5007 (select ?x4821 gidx.2440049)))
 (let (($x4526 (= ?x5178 6)))
 (or $x4526 $x5007 $x37127)))))))))))))))))))))))))))
 ))
 (let (($x10758 (forall ((gidx.2440032 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x29045 (share ?x1378)))
 (let ((?x4808 (gpt ?x29045)))
 (let (($x4778 (select ?x4808 gidx.2440032)))
 (let ((?x28049 (e_state_s_granule (select (g_granules (globals ?x29045)) gidx.2440032))))
 (let (($x4548 (= ?x28049 0)))
 (let (($x3001 (= ?x28049 6)))
 ...
 (or (not $x10758) $x4416))))
(assert
 (let (($x37325 (forall ((gidx.2440108 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x36129 (globals ?x29045)))
 (let ((?x5085 (g_granules ?x36129)))
 (let ((?x28049 (e_state_s_granule (select ?x5085 gidx.2440108))))
 (let (($x3001 (= ?x28049 6)))
 (let (($x4548 (= ?x28049 0)))
 (=> (not (select (gpt ?x29045) gidx.2440108)) (or $x4548 $x3001))))))))))))))))))))))
 ))
 (not $x37325)))
(check-sat)

...
(assert
 ...
 (and $x13214 $x59442))))))))
(assert
 (let (($x14274 (forall ((gidx.2465755 Int) )(let ((?x14212 (test_Z_PTE.0_call v_0.2465509)))
 (let ((?x14393 (meta_PA ?x14212)))
 (let ((?x13372 (meta_granule_offset ?x14393)))
 ...
 (let ((?x64533 (e_state_s_granule (select ?x38081 gidx.2465755))))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2465755)))
 (let (($x62406 (not $x13479)))
 (=> $x62406 (or (= ?x64533 0) (= ?x64533 6))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x14274)))
(check-sat)

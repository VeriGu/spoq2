...
(let ((a!9 (elem_1 (value_Tuple_bool_RData
 ...
 (or (not $x1966) $x33820))))
(assert
 (let (($x2328 (forall ((gidx.2432547 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1763 (globals ?x65503)))
 (let ((?x2593 (g_granules ?x1763)))
 (let ((?x2334 (e_state_s_granule (select ?x2593 gidx.2432547))))
 (let (($x2223 (= ?x2334 6)))
 (let (($x33775 (= ?x2334 0)))
 (=> (not (select (gpt ?x65503) gidx.2432547)) (or $x33775 $x2223))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2328)))
(check-sat)

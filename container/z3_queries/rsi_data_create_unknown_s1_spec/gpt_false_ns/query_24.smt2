...
(let ((a!11 (granule_unlock_spec.0_call
 ...
 (or (not $x43835) $x3225))))
(assert
 (let (($x3458 (forall ((gidx.2436411 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3516 (globals ?x90483)))
 (let ((?x1973 (g_granules ?x3516)))
 (let ((?x3836 (e_state_s_granule (select ?x1973 gidx.2436411))))
 (let (($x3979 (= ?x3836 6)))
 (let (($x3168 (= ?x3836 0)))
 (=> (not (select (gpt ?x90483) gidx.2436411)) (or $x3168 $x3979))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3458)))
(check-sat)

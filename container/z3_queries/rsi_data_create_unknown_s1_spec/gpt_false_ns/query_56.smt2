...
(let ((a!10 (elem_1 (value_Tuple_bool_RData
 ...
 (or (not $x6121) $x6388))))
(assert
 (let (($x5913 (forall ((gidx.2444363 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x6771 (globals ?x79556)))
 (let ((?x45849 (g_granules ?x6771)))
 (let ((?x5843 (e_state_s_granule (select ?x45849 gidx.2444363))))
 (let (($x5794 (= ?x5843 6)))
 (let (($x6215 (= ?x5843 0)))
 (=> (not (select (gpt ?x79556) gidx.2444363)) (or $x6215 $x5794))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5913)))
(check-sat)

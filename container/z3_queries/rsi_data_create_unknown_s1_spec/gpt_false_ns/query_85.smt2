...
(assert
 ...
 (and $x7837 $x42713))))))))
(assert
 (let (($x9539 (forall ((gidx.2452427 Int) )(let ((?x9550 (test_Z_PTE.0_call v_0.2452181)))
 (let ((?x9584 (meta_PA ?x9550)))
 (let ((?x9387 (meta_granule_offset ?x9584)))
 ...
 (let ((?x8900 (e_state_s_granule (select ?x9659 gidx.2452427))))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2452427)))
 (let (($x98161 (not $x9125)))
 (=> $x98161 (or (= ?x8900 0) (= ?x8900 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9539)))
(check-sat)

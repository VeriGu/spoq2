...
(assert
 (let (($x11691 (forall ((gidx.2461499 Int) )(let ((?x12401 (test_Z_PTE.0_call v_0.2461253)))
 ...
 (let ((?x54768 (e_state_s_granule (select ?x63303 gidx.2461499))))
 (let ((?x71356 (gpt ?x119052)))
 (let (($x12182 (select ?x71356 gidx.2461499)))
 (let (($x12463 (not $x12182)))
 (=> $x12463 (or (= ?x54768 0) (= ?x54768 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x11691)))
(check-sat)

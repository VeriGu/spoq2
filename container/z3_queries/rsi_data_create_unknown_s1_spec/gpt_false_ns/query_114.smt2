...
(assert
 ...
 (elem_0 ?x10791)))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x12337 (forall ((gidx.2460491 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12255 (globals ?x86271)))
 (let ((?x62100 (g_granules ?x12255)))
 (let ((?x12320 (e_state_s_granule (select ?x62100 gidx.2460491))))
 (let (($x11104 (= ?x12320 6)))
 (let (($x12522 (= ?x12320 0)))
 (=> (not (select (gpt ?x86271) gidx.2460491)) (or $x12522 $x11104)))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12337)))
(check-sat)

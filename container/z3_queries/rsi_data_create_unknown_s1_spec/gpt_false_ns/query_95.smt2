...
(assert
 ...
 (and $x1370 $x1371)))))))
(assert
 (let (($x9465 (forall ((gidx.2454947 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x9574 (globals ?x42432)))
 (let ((?x9487 (g_granules ?x9574)))
 (let ((?x10151 (e_state_s_granule (select ?x9487 gidx.2454947))))
 (let (($x10211 (= ?x10151 6)))
 (let (($x9623 (= ?x10151 0)))
 (=> (not (select (gpt ?x42432) gidx.2454947)) (or $x9623 $x10211)))))))))))))))))))))))))))))
 ))
 (not $x9465)))
(check-sat)

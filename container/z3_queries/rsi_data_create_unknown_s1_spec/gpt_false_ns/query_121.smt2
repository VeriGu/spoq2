...
(assert
 (let (($x12660 (forall ((gidx.2462563 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x63705 (globals ?x119657)))
 (let ((?x55639 (g_granules ?x63705)))
 (let ((?x63664 (e_state_s_granule (select ?x55639 gidx.2462563))))
 (let (($x64169 (= ?x63664 6)))
 (let (($x63810 (= ?x63664 0)))
 (=> (not (select (gpt ?x119657) gidx.2462563)) (or $x63810 $x64169))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12660)))
(check-sat)

...
(assert
 (let (($x11504 (forall ((gidx.2457691 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x61782 (globals ?x93837)))
 (let ((?x10778 (g_granules ?x61782)))
 (let ((?x9164 (e_state_s_granule (select ?x10778 gidx.2457691))))
 (let (($x57860 (= ?x9164 6)))
 (let (($x52954 (= ?x9164 0)))
 (=> (not (select (gpt ?x93837) gidx.2457691)) (or $x52954 $x57860))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x11504)))
(check-sat)

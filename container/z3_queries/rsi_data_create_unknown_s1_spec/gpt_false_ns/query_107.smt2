...
(assert
 ...
 (and $x10397 $x10776))))))))
(assert
 (let (($x9985 (forall ((gidx.2458699 Int) )(let ((?x27271 (test_Z_PTE.0_call v_0.2458453)))
 (let ((?x11710 (meta_PA ?x27271)))
 (let ((?x11573 (meta_granule_offset ?x11710)))
 ...
 (let ((?x54399 (e_state_s_granule (select ?x11848 gidx.2458699))))
 (let ((?x62034 (gpt ?x125259)))
 (let (($x11630 (select ?x62034 gidx.2458699)))
 (let (($x11491 (not $x11630)))
 (=> $x11491 (or (= ?x54399 0) (= ?x54399 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9985)))
(check-sat)

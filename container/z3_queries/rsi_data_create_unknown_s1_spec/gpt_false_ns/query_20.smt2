...
(let ((a!10 (granule_unlock_spec.0_call
 ...
 (or (not $x27489) $x3512))))
(assert
 (let (($x3300 (forall ((gidx.2435347 Int) )(let ((?x3507 (test_Z_PTE.0_call v_0.2435101)))
 ...
 (let ((?x3436 (e_state_s_granule (select ?x3316 gidx.2435347))))
 (let ((?x19244 (gpt ?x82221)))
 (let (($x27444 (select ?x19244 gidx.2435347)))
 (let (($x3339 (not $x27444)))
 (=> $x3339 (or (= ?x3436 0) (= ?x3436 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3300)))
(check-sat)

...
(assert
 ...
 (= ?x96858 8)))))))
(assert
 (let (($x47573 (forall ((gidx.2447499 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x7549 (globals ?x88882)))
 (let ((?x40832 (g_granules ?x7549)))
 (let ((?x7756 (e_state_s_granule (select ?x40832 gidx.2447499))))
 (let (($x7219 (= ?x7756 6)))
 (let (($x7193 (= ?x7756 0)))
 (=> (not (select (gpt ?x88882) gidx.2447499)) (or $x7193 $x7219)))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x47573)))
(check-sat)

...
(assert
 ...
 (= ?x26393 0))))
(assert
 (let (($x4008 (forall ((gidx.2436747 Int) )(let ((?x3244 (test_Z_PTE.0_call v_0.2436501)))
 ...
 (let ((?x3886 (e_state_s_granule (select ?x3812 gidx.2436747))))
 (let ((?x59572 (gpt ?x98382)))
 (let (($x3488 (select ?x59572 gidx.2436747)))
 (let (($x3957 (not $x3488)))
 (=> $x3957 (or (= ?x3886 0) (= ?x3886 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4008)))
(check-sat)

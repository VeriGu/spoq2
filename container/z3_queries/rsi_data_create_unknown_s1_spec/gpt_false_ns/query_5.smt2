...
(assert
 ...
 (elem_0 ?x1614)))))))))))))))))))))))))))))))
(assert
 (let (($x1851 (forall ((gidx.2431147 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1777 (globals ?x49238)))
 (let ((?x1779 (g_granules ?x1777)))
 (let ((?x1800 (e_state_s_granule (select ?x1779 gidx.2431147))))
 (let (($x1843 (= ?x1800 6)))
 (let (($x1844 (= ?x1800 0)))
 (=> (not (select (gpt ?x49238) gidx.2431147)) (or $x1844 $x1843)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1851)))
(check-sat)

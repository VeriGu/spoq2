...
(assert
 ...
 (= ?x72746 8)))))))))))))))))))))
(assert
 (let (($x66184 (forall ((gidx.2435011 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x34960 (globals ?x74345)))
 (let ((?x35123 (g_granules ?x34960)))
 (let ((?x35126 (e_state_s_granule (select ?x35123 gidx.2435011))))
 (let (($x3108 (= ?x35126 6)))
 (let (($x3258 (= ?x35126 0)))
 (=> (not (select (gpt ?x74345) gidx.2435011)) (or $x3258 $x3108)))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x66184)))
(check-sat)

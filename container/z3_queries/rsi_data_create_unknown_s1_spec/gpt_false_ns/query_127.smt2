...
(declare-fun v_0.2459909 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2459909)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(declare-fun v_0.2460245 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!12 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!11)))))
  (repl (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!12))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
      (a!2 (mkPtr "granule_data"
...
(let ((a!12 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!11)))))
  (oracle (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!12))))))))))))))_call| (List_Event) List_Event)
...
(let ((a!14 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (value_RData a!13)))))
  (repl a!14)))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!14 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (value_RData a!13)))))
  (oracle a!14)))))))))))))_call| (List_Event) List_Event)
...
(let ((a!15 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
              a!14)))
  (repl (value_RData a!15)))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!15 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
              a!14)))
  (oracle (value_RData a!15)))))))))))))))_call| (List_Event) List_Event)
(declare-fun v_0.2463717 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2463717)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!9 (mkPtr "granule_data"
                  (meta_granule_offset
      ...
      (a!10 (mkPtr "granule_data"
                   (meta_granule_offset
                     (meta_PA (test_Z_PTE.0_call v_0.2459909)))))
      (a!39 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2463717)))
                 4096)))
(let ((a!3 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!2 st.0)))))
...
(let ((a!11 (value_RData (spinlock_acquire_spec.0_call
                           (mkPtr (pbase a!8) (poffset a!8))
                           (elem_1 a!7)))))
(let ((a!12 (value_RData (spinlock_release_spec.0_call
                           (mkPtr (pbase a!8) (poffset a!8))
                           a!11))))
(let ((a!13 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        a!10
                        (mkPtr "granule_data" 0)
                        4096
...
(let ((a!14 (granule_unlock_spec.0_call
              a!8
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!9 0 4096 a!13))))))
(let ((a!15 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!7))
                           (value_RData a!14)))))
(let ((a!16 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
              a!15)))
(let ((a!17 (g_heap (globals (share (value_RData a!16)))))
      (a!18 (g_debug_exits (globals (share (value_RData a!16)))))
      (a!19 (g_vmid_count (globals (share (value_RData a!16)))))
      (a!20 (g_vmid_lock (globals (share (value_RData a!16)))))
      (a!21 (g_vmids (globals (share (value_RData a!16)))))
      (a!22 (g_nr_lrs (globals (share (value_RData a!16)))))
      (a!23 (g_nr_aprs (globals (share (value_RData a!16)))))
      (a!24 (g_max_vintid (globals (share (value_RData a!16)))))
      (a!25 (g_pri_res0_mask (globals (share (value_RData a!16)))))
      (a!26 (g_default_gicstate (globals (share (value_RData a!16)))))
      (a!27 (g_status_handler (globals (share (value_RData a!16)))))
      (a!28 (g_rmm_trap_list (globals (share (value_RData a!16)))))
      (a!29 (g_tt_l3_buffer (globals (share (value_RData a!16)))))
      (a!30 (g_tt_l2_mem0_0 (globals (share (value_RData a!16)))))
      (a!31 (g_tt_l2_mem0_1 (globals (share (value_RData a!16)))))
      (a!32 (g_tt_l2_mem1_0 (globals (share (value_RData a!16)))))
      (a!33 (g_tt_l2_mem1_1 (globals (share (value_RData a!16)))))
      (a!34 (g_tt_l2_mem1_2 (globals (share (value_RData a!16)))))
      (a!35 (g_tt_l2_mem1_3 (globals (share (value_RData a!16)))))
      (a!36 (g_tt_l1_upper (globals (share (value_RData a!16)))))
      (a!37 (g_mbedtls_mem_buf (globals (share (value_RData a!16)))))
      (a!38 (g_granules (globals (share (value_RData a!16)))))
      (a!41 (g_rmm_attest_signing_key (globals (share (value_RData a!16)))))
      (a!42 (g_rmm_attest_public_key (globals (share (value_RData a!16)))))
      (a!43 (g_rmm_attest_public_key_len (globals (share (value_RData a!16)))))
      (a!44 (g_rmm_attest_public_key_hash (globals (share (value_RData a!16)))))
      (a!45 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!16)))))
      (a!46 (g_platform_token_buf (globals (share (value_RData a!16)))))
      (a!47 (g_rmm_platform_token (globals (share (value_RData a!16)))))
      (a!48 (g_get_realm_identity_identity (globals (share (value_RData a!16)))))
      (a!49 (g_realm_attest_private_key (globals (share (value_RData a!16))))))
(let ((a!40 (store a!38
                   a!39
                   (mks_granule (e_lock (select a!38 a!39))
                                1
                                (e_ref (select a!38 a!39))))))
(let ((a!50 (mkShared (gpt (share (value_RData a!16)))
                      (granule_data (share (value_RData a!16)))
                      (mkGLOBALS a!17
                                 a!18
                                 a!19
                                 a!20
...
(let ((a!51 (granule_unlock_spec.0_call
              a!1
              (mkRData (log (value_RData a!16))
                       (oracle (value_RData a!16))
                       (repl (value_RData a!16))
                       (priv (value_RData a!16))
                       a!50
                       (stack (value_RData a!16))
                       (halt (value_RData a!16))))))
...
(assert
 ...
 (not $x10093)))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2459874 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x60121 (spinlock_acquire_spec.0_call ?x10369 ?x9613)))
 (let ((?x9587 (value_RData ?x60121)))
 (let ((?x145973 (spinlock_release_spec.0_call ?x10369 ?x9587)))
 (let ((?x7976 (value_RData ?x145973)))
 (let ((?x79259 (share ?x7976)))
 (let ((?x12324 (globals ?x79259)))
 (let ((?x62523 (g_granules ?x12324)))
 (let ((?x11984 (e_state_s_granule (select ?x62523 gidx.2459874))))
 (let (($x11040 (= ?x11984 6)))
 (let (($x102354 (= ?x11984 0)))
 (=> (not (select (gpt ?x79259) gidx.2459874)) (or $x102354 $x11040)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2459909 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2459909))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x7976 (value_RData ?x145973)))
 (let ((?x79259 (share ?x7976)))
 (let ((?x80548 (gpt ?x79259)))
 (select ?x80548 ?x1047)))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x11413 (forall ((gidx.2460097 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x7976 (value_RData ?x145973)))
 (let ((?x79259 (share ?x7976)))
 (let ((?x54790 (log ?x7976)))
 (let ((?x12192 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!9 (value_RData (spinlock_release_spec.0_call
                          (mkPtr (pbase a!7) (poffset a!7))
                          a!8))))
  (oracle a!9))))))))))_call| ?x54790)))
 (let ((?x10338 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!9 (value_RData (spinlock_release_spec.0_call
                          (mkPtr (pbase a!7) (poffset a!7))
                          a!8))))
  (repl a!9))))))))))_call| ?x12192 ?x79259)))
 (let ((?x12505 (value_Shared ?x10338)))
 (let ((?x11662 (globals ?x12505)))
 (let ((?x9968 (g_granules ?x11662)))
 (let ((?x54861 (e_state_s_granule (select ?x9968 gidx.2460097))))
 (let (($x101778 (= ?x54861 0)))
 (let (($x11884 (= ?x54861 6)))
 (let ((?x12443 (gpt ?x12505)))
 (let (($x8228 (select ?x12443 gidx.2460097)))
 (or $x8228 $x11884 $x101778))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x10353 (forall ((gidx.2460080 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12324 (globals ?x79259)))
 (let ((?x62523 (g_granules ?x12324)))
 (let ((?x11984 (e_state_s_granule (select ?x62523 gidx.2460080))))
 (let (($x102354 (= ?x11984 0)))
 (let ((?x80548 (gpt ?x79259)))
 (let (($x11507 (select ?x80548 gidx.2460080)))
 (let (($x11040 (= ?x11984 6)))
 (or $x11040 $x11507 $x102354))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x10353) $x11413))))
(assert
 (forall ((gidx.2460210 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x11822 (test_Z_PTE.0_call v_0.2459909)))
 (let ((?x63145 (meta_PA ?x11822)))
 (let ((?x94465 (meta_granule_offset ?x63145)))
 (let ((?x11252 (mkPtr "granule_data" ?x94465)))
 (let ((?x11406 (memcpy_ns_read_spec.0_call ?x11252 ?x1721 4096 ?x7976)))
 (let ((?x10791 (value_Tuple_bool_RData ?x11406)))
 (let ((?x11704 (elem_1 ?x10791)))
 (let ((?x86271 (share ?x11704)))
 (let ((?x12255 (globals ?x86271)))
 (let ((?x62100 (g_granules ?x12255)))
 (let ((?x12320 (e_state_s_granule (select ?x62100 gidx.2460210))))
 (let (($x11104 (= ?x12320 6)))
 (let (($x12522 (= ?x12320 0)))
 (=> (not (select (gpt ?x86271) gidx.2460210)) (or $x12522 $x11104)))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2460245 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2460245))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x11704 (elem_1 ?x10791)))
 (let ((?x86271 (share ?x11704)))
 (let ((?x62290 (gpt ?x86271)))
 (select ?x62290 ?x1047)))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x11374 (forall ((gidx.2460433 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x11704 (elem_1 ?x10791)))
 (let ((?x86271 (share ?x11704)))
 (let ((?x62537 (log ?x11704)))
 (let ((?x58920 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2459909)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!11 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!10)))))
  (oracle a!11)))))))))))_call| ?x62537)))
 (let ((?x57203 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2459909)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!11 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!10)))))
  (repl a!11)))))))))))_call| ?x58920 ?x86271)))
 (let ((?x63186 (value_Shared ?x57203)))
 (let ((?x102537 (globals ?x63186)))
 (let ((?x102023 (g_granules ?x102537)))
 (let ((?x11176 (e_state_s_granule (select ?x102023 gidx.2460433))))
 (let (($x56133 (= ?x11176 0)))
 (let (($x19240 (= ?x11176 6)))
 (let ((?x10784 (gpt ?x63186)))
 (let (($x11447 (select ?x10784 gidx.2460433)))
 (or $x11447 $x19240 $x56133))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x54692 (forall ((gidx.2460416 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x86271 (share ?x11704)))
 (let ((?x62290 (gpt ?x86271)))
 (let (($x78352 (select ?x62290 gidx.2460416)))
 (let ((?x12320 (e_state_s_granule (select (g_granules (globals ?x86271)) gidx.2460416))))
 (let (($x12522 (= ?x12320 0)))
 (let (($x11104 (= ?x12320 6)))
 (or $x11104 $x12522 $x78352))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x54692) $x11374))))
(assert
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 ...
 (let ((?x11406 (memcpy_ns_read_spec.0_call ?x11252 ?x1721 4096 ?x7976)))
 (let ((?x10791 (value_Tuple_bool_RData ?x11406)))
 (let (($x11762 (elem_0 ?x10791)))
 (not $x11762))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2461946 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x10791 (value_Tuple_bool_RData ?x11406)))
 (let ((?x11704 (elem_1 ?x10791)))
 (let ((?x9820 (test_Z_PTE.0_call v_0.2460245)))
 (let ((?x10243 (meta_PA ?x9820)))
 (let ((?x78857 (meta_granule_offset ?x10243)))
 (let ((?x139106 (mkPtr "granule_data" ?x78857)))
 (let ((?x12018 (memset_spec.0_call ?x139106 0 4096 ?x11704)))
 (let ((?x54518 (value_Tuple_Ptr_RData ?x12018)))
 (let ((?x13321 (elem_1 ?x54518)))
 (let ((?x103723 (share ?x13321)))
 (let ((?x12770 (globals ?x103723)))
 (let ((?x59370 (g_granules ?x12770)))
 (let ((?x13111 (e_state_s_granule (select ?x59370 gidx.2461946))))
 (let (($x55815 (= ?x13111 6)))
 (let (($x11904 (= ?x13111 0)))
 (=> (not (select (gpt ?x103723) gidx.2461946)) (or $x11904 $x55815))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2461981 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2461981))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x13321 (elem_1 ?x54518)))
 (let ((?x103723 (share ?x13321)))
 (let ((?x12146 (gpt ?x103723)))
 (select ?x12146 ?x1047))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x62206 (forall ((gidx.2462169 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13321 (elem_1 ?x54518)))
 (let ((?x103723 (share ?x13321)))
 (let ((?x11945 (log ?x13321)))
 (let ((?x13083 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
      (a!2 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!12 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!11)))))
  (oracle (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!12))))))))))))))_call| ?x11945)))
 (let ((?x53559 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
      (a!2 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!12 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec.0_call
                        ...
                        4096
                        a!11)))))
  (repl (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!12))))))))))))))_call| ?x13083 ?x103723)))
 (let ((?x12335 (value_Shared ?x53559)))
 (let ((?x10486 (globals ?x12335)))
 (let ((?x55916 (g_granules ?x10486)))
 (let ((?x13190 (e_state_s_granule (select ?x55916 gidx.2462169))))
 (let (($x12678 (= ?x13190 6)))
 (let ((?x10820 (gpt ?x12335)))
 (let (($x12650 (select ?x10820 gidx.2462169)))
 (let (($x12314 (= ?x13190 0)))
 (or $x12314 $x12650 $x12678)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12756 (forall ((gidx.2462152 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12770 (globals ?x103723)))
 (let ((?x59370 (g_granules ?x12770)))
 (let ((?x13111 (e_state_s_granule (select ?x59370 gidx.2462152))))
 (let (($x55815 (= ?x13111 6)))
 (let ((?x12146 (gpt ?x103723)))
 (let (($x12653 (select ?x12146 gidx.2462152)))
 (let (($x11904 (= ?x13111 0)))
 (or $x11904 $x12653 $x55815)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x12756) $x62206))))
(assert
 (forall ((gidx.2462282 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x54518 (value_Tuple_Ptr_RData ?x12018)))
 (let ((?x13321 (elem_1 ?x54518)))
 (let ((?x12509 (granule_unlock_spec.0_call ?x10416 ?x13321)))
 (let ((?x13222 (value_RData ?x12509)))
 (let ((?x119657 (share ?x13222)))
 (let ((?x63705 (globals ?x119657)))
 (let ((?x55639 (g_granules ?x63705)))
 (let ((?x63664 (e_state_s_granule (select ?x55639 gidx.2462282))))
 (let (($x64169 (= ?x63664 6)))
 (let (($x63810 (= ?x63664 0)))
 (=> (not (select (gpt ?x119657) gidx.2462282)) (or $x63810 $x64169))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2462317 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2462317))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x13222 (value_RData ?x12509)))
 (let ((?x119657 (share ?x13222)))
 (let ((?x62212 (gpt ?x119657)))
 (select ?x62212 ?x1047))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x55708 (forall ((gidx.2462505 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13222 (value_RData ?x12509)))
 (let ((?x119657 (share ?x13222)))
 (let ((?x55132 (log ?x13222)))
 (let ((?x11826 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!13 (granule_unlock_spec.0_call
              ...
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!8 0 4096 a!12))))))
  (oracle (value_RData a!13)))))))))))))_call| ?x55132)))
 (let ((?x13010 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!13 (granule_unlock_spec.0_call
              ...
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!8 0 4096 a!12))))))
  (repl (value_RData a!13)))))))))))))_call| ?x11826 ?x119657)))
 (let ((?x12631 (value_Shared ?x13010)))
 (let ((?x13160 (globals ?x12631)))
 (let ((?x12249 (g_granules ?x13160)))
 (let ((?x12515 (e_state_s_granule (select ?x12249 gidx.2462505))))
 (let (($x13077 (= ?x12515 0)))
 (let ((?x12429 (gpt ?x12631)))
 (let (($x12743 (select ?x12429 gidx.2462505)))
 (let (($x9982 (= ?x12515 6)))
 (or $x9982 $x12743 $x13077)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12379 (forall ((gidx.2462488 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x63705 (globals ?x119657)))
 (let ((?x55639 (g_granules ?x63705)))
 (let ((?x63664 (e_state_s_granule (select ?x55639 gidx.2462488))))
 (let (($x64169 (= ?x63664 6)))
 (let (($x63810 (= ?x63664 0)))
 (let ((?x62212 (gpt ?x119657)))
 (let (($x12865 (select ?x62212 gidx.2462488)))
 (or $x12865 $x63810 $x64169)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x12379) $x55708))))
(assert
 (forall ((gidx.2462618 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x26171 (elem_0 ?x34511)))
 (let ((?x10187 (e_2 ?x26171)))
 (let ((?x8582 (granule_unlock_spec.0_call ?x10187 ?x13222)))
 (let ((?x12968 (value_RData ?x8582)))
 (let ((?x127691 (share ?x12968)))
 (let ((?x64607 (globals ?x127691)))
 (let ((?x56061 (g_granules ?x64607)))
 (let ((?x12661 (e_state_s_granule (select ?x56061 gidx.2462618))))
 (let (($x13349 (= ?x12661 6)))
 (let (($x55640 (= ?x12661 0)))
 (=> (not (select (gpt ?x127691) gidx.2462618)) (or $x55640 $x13349))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2462653 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2462653))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x12968 (value_RData ?x8582)))
 (let ((?x127691 (share ?x12968)))
 (let ((?x110030 (gpt ?x127691)))
 (select ?x110030 ?x1047))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x11617 (forall ((gidx.2462841 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12968 (value_RData ?x8582)))
 (let ((?x127691 (share ?x12968)))
 (let ((?x55535 (log ?x12968)))
 (let ((?x54833 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!14 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (value_RData a!13)))))
  (oracle a!14)))))))))))))_call| ?x55535)))
 (let ((?x11949 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!14 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (value_RData a!13)))))
  (repl a!14)))))))))))))_call| ?x54833 ?x127691)))
 (let ((?x11409 (value_Shared ?x11949)))
 (let ((?x13253 (gpt ?x11409)))
 (let (($x56344 (select ?x13253 gidx.2462841)))
 (let ((?x13298 (e_state_s_granule (select (g_granules (globals ?x11409)) gidx.2462841))))
 (let (($x12088 (= ?x13298 6)))
 (let (($x11707 (= ?x13298 0)))
 (or $x11707 $x12088 $x56344)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12663 (forall ((gidx.2462824 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x64607 (globals ?x127691)))
 (let ((?x56061 (g_granules ?x64607)))
 (let ((?x12661 (e_state_s_granule (select ?x56061 gidx.2462824))))
 (let (($x55640 (= ?x12661 0)))
 (let (($x13349 (= ?x12661 6)))
 (let ((?x110030 (gpt ?x127691)))
 (let (($x11551 (select ?x110030 gidx.2462824)))
 (or $x11551 $x13349 $x55640)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x12663) $x11617))))
(assert
 ...
 (not $x2640)))))
(assert
 (forall ((gidx.2463682 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x8582 (granule_unlock_spec.0_call ?x10187 ?x13222)))
 (let ((?x12968 (value_RData ?x8582)))
 (let ((?x13006 (granule_unlock_spec.0_call ?x1244 ?x12968)))
 (let ((?x13355 (value_RData ?x13006)))
 (let ((?x134703 (share ?x13355)))
 (let ((?x13416 (globals ?x134703)))
 (let ((?x64798 (g_granules ?x13416)))
 (let ((?x12331 (e_state_s_granule (select ?x64798 gidx.2463682))))
 (let (($x13242 (= ?x12331 6)))
 (let (($x13440 (= ?x12331 0)))
 (let ((?x13273 (gpt ?x134703)))
 (let (($x9497 (select ?x13273 gidx.2463682)))
 (let (($x13122 (not $x9497)))
 (=> $x13122 (or $x13440 $x13242)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2463717 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2463717))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x12911 (forall ((gidx.2463905 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13355 (value_RData ?x13006)))
 (let ((?x134703 (share ?x13355)))
 (let ((?x12144 (log ?x13355)))
 (let ((?x13413 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!15 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
              a!14)))
  (oracle (value_RData a!15)))))))))))))))_call| ?x12144)))
 (let ((?x11928 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!8 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2460245)))))
...
(let ((a!15 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
              a!14)))
  (repl (value_RData a!15)))))))))))))))_call| ?x13413 ?x134703)))
 (let ((?x11298 (value_Shared ?x11928)))
 (let ((?x72766 (globals ?x11298)))
 (let ((?x13009 (g_granules ?x72766)))
 (let ((?x79331 (e_state_s_granule (select ?x13009 gidx.2463905))))
 (let (($x64041 (= ?x79331 6)))
 (let (($x13369 (= ?x79331 0)))
 (let ((?x11994 (gpt ?x11298)))
 (let (($x13362 (select ?x11994 gidx.2463905)))
 (or $x13362 $x13369 $x64041)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x13608 (forall ((gidx.2463888 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13416 (globals ?x134703)))
 (let ((?x64798 (g_granules ?x13416)))
 (let ((?x12331 (e_state_s_granule (select ?x64798 gidx.2463888))))
 (let (($x13440 (= ?x12331 0)))
 (let (($x13242 (= ?x12331 6)))
 (let ((?x13273 (gpt ?x134703)))
 (let (($x9497 (select ?x13273 gidx.2463888)))
 (or $x9497 $x13242 $x13440)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x13608) $x12911))))
(assert
 (let ((?x12871 (test_Z_PTE.0_call v_0.2463717)))
 (let ((?x104303 (meta_PA ?x12871)))
 (let ((?x13907 (meta_granule_offset ?x104303)))
 (let (($x13626 (>= ?x13907 0)))
 (let ((?x14053 (mod ?x13907 4096)))
 (let (($x12201 (= ?x14053 0)))
 (and $x12201 $x13626))))))))
(assert
 (forall ((gidx.2464018 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13006 (granule_unlock_spec.0_call ?x1244 ?x12968)))
 (let ((?x13355 (value_RData ?x13006)))
 (let (($x24676 (halt ?x13355)))
 (let ((?x12156 (stack ?x13355)))
 (let ((?x134703 (share ?x13355)))
 (let ((?x13416 (globals ?x134703)))
 (let ((?x13603 (g_realm_attest_private_key ?x13416)))
 (let ((?x9476 (g_get_realm_identity_identity ?x13416)))
 (let ((?x111819 (g_rmm_platform_token ?x13416)))
 (let ((?x111674 (g_platform_token_buf ?x13416)))
 (let ((?x12593 (g_rmm_attest_public_key_hash_len ?x13416)))
 (let ((?x12514 (g_rmm_attest_public_key_hash ?x13416)))
 (let ((?x13491 (g_rmm_attest_public_key_len ?x13416)))
 (let ((?x13336 (g_rmm_attest_public_key ?x13416)))
 (let ((?x63979 (g_rmm_attest_signing_key ?x13416)))
 (let ((?x12871 (test_Z_PTE.0_call v_0.2463717)))
 (let ((?x104303 (meta_PA ?x12871)))
 (let ((?x13907 (meta_granule_offset ?x104303)))
 (let ((?x12875 (div ?x13907 4096)))
 (let ((?x64798 (g_granules ?x13416)))
 (let ((?x64928 (select ?x64798 ?x12875)))
 (let ((?x10303 (mks_granule (e_lock ?x64928) 1 (e_ref ?x64928))))
 (let ((?x13965 (store ?x64798 ?x12875 ?x10303)))
 (let ((?x13180 (g_mbedtls_mem_buf ?x13416)))
 (let ((?x11816 (g_tt_l1_upper ?x13416)))
 (let ((?x64416 (g_tt_l2_mem1_3 ?x13416)))
 (let ((?x13482 (g_tt_l2_mem1_2 ?x13416)))
 (let ((?x12597 (g_tt_l2_mem1_1 ?x13416)))
 (let ((?x27740 (g_tt_l2_mem1_0 ?x13416)))
 (let ((?x12464 (g_tt_l2_mem0_1 ?x13416)))
 (let ((?x10433 (g_tt_l2_mem0_0 ?x13416)))
 (let ((?x11922 (g_tt_l3_buffer ?x13416)))
 (let ((?x11655 (g_rmm_trap_list ?x13416)))
 (let ((?x64297 (g_status_handler ?x13416)))
 (let ((?x12390 (g_default_gicstate ?x13416)))
 (let ((?x13309 (g_pri_res0_mask ?x13416)))
 (let ((?x104598 (g_max_vintid ?x13416)))
 (let ((?x12843 (g_nr_aprs ?x13416)))
 (let ((?x12449 (g_nr_lrs ?x13416)))
 (let ((?x12627 (g_vmids ?x13416)))
 (let ((?x12338 (g_vmid_lock ?x13416)))
 (let ((?x12955 (g_vmid_count ?x13416)))
 (let ((?x13647 (g_debug_exits ?x13416)))
 (let ((?x12315 (g_heap ?x13416)))
 (let ((?x13917 (mkGLOBALS ?x12315 ?x13647 ?x12955 ?x12338 ?x12627 ?x12449 ?x12843 ?x104598 ?x13309 ?x12390 ?x64297 ?x11655 ?x11922 ?x10433 ?x12464 ?x27740 ?x12597 ?x13482 ?x64416 ?x11816 ?x13180 ?x13965 ?x63979 ?x13336 ?x13491 ?x12514 ?x12593 ?x111674 ?x111819 ?x9476 ?x13603)))
 (let ((?x55922 (granule_data ?x134703)))
 (let ((?x13273 (gpt ?x134703)))
 (let ((?x13350 (priv ?x13355)))
 (let ((?x111547 (repl ?x13355)))
 (let ((?x12866 (oracle ?x13355)))
 (let ((?x12144 (log ?x13355)))
 (let ((?x13016 (mkRData ?x12144 ?x12866 ?x111547 ?x13350 (mkShared ?x13273 ?x55922 ?x13917) ?x12156 $x24676)))
 (let ((?x143811 (mkPtr "granules" ?x13907)))
 (let ((?x13637 (granule_unlock_spec.0_call ?x143811 ?x13016)))
 (let ((?x104386 (value_RData ?x13637)))
 (let ((?x143778 (share ?x104386)))
 (let ((?x12611 (globals ?x143778)))
 (let ((?x13724 (g_granules ?x12611)))
 (let ((?x104748 (e_state_s_granule (select ?x13724 gidx.2464018))))
 (let (($x57337 (= ?x104748 6)))
 (let (($x55022 (= ?x104748 0)))
 (=> (not (select (gpt ?x143778) gidx.2464018)) (or $x55022 $x57337)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2464053 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2464053))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x104386 (value_RData ?x13637)))
 (let ((?x143778 (share ?x104386)))
 (let ((?x12603 (gpt ?x143778)))
 (select ?x12603 ?x1047)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x12849 (forall ((gidx.2464241 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x104386 (value_RData ?x13637)))
 (let ((?x143778 (share ?x104386)))
 (let ((?x111573 (log ?x104386)))
 (let ((?x55830 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2463717)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!51 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!16))
                       ...
                       (stack (value_RData a!16))
                       (halt (value_RData a!16))))))
  (oracle (value_RData a!51)))))))))))))))))))_call| ?x111573)))
 (let ((?x12623 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2463717)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!51 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!16))
                       ...
                       (stack (value_RData a!16))
                       (halt (value_RData a!16))))))
  (repl (value_RData a!51)))))))))))))))))))_call| ?x55830 ?x143778)))
 (let ((?x13916 (value_Shared ?x12623)))
 (let ((?x65102 (globals ?x13916)))
 (let ((?x13109 (g_granules ?x65102)))
 (let ((?x13985 (e_state_s_granule (select ?x13109 gidx.2464241))))
 (let (($x13938 (= ?x13985 6)))
 (let ((?x13727 (gpt ?x13916)))
 (let (($x13268 (select ?x13727 gidx.2464241)))
 (let (($x13177 (= ?x13985 0)))
 (or $x13177 $x13268 $x13938))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x13296 (forall ((gidx.2464224 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12611 (globals ?x143778)))
 (let ((?x13724 (g_granules ?x12611)))
 (let ((?x104748 (e_state_s_granule (select ?x13724 gidx.2464224))))
 (let (($x57337 (= ?x104748 6)))
 (let (($x55022 (= ?x104748 0)))
 (let ((?x12603 (gpt ?x143778)))
 (let (($x11644 (select ?x12603 gidx.2464224)))
 (or $x11644 $x55022 $x57337))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x13296) $x12849))))
(assert
 (let (($x13945 (forall ((gidx.2464300 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12611 (globals ?x143778)))
 (let ((?x13724 (g_granules ?x12611)))
 (let ((?x104748 (e_state_s_granule (select ?x13724 gidx.2464300))))
 (let (($x57337 (= ?x104748 6)))
 (let (($x55022 (= ?x104748 0)))
 (=> (not (select (gpt ?x143778) gidx.2464300)) (or $x55022 $x57337)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x13945)))
(check-sat)

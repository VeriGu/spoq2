...
(assert
 ...
 (not $x28374)))))
(assert
 (let (($x4892 (forall ((gidx.2439379 Int) )(let ((?x3650 (test_Z_PTE.0_call v_0.2438741)))
 ...
 (let ((?x4483 (e_state_s_granule (select ?x37085 gidx.2439379))))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2439379)))
 (let (($x4368 (not $x4378)))
 (=> $x4368 (or (= ?x4483 0) (= ?x4483 6)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4892)))
(check-sat)

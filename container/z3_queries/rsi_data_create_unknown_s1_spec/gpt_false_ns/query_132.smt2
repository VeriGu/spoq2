...
(assert
 ...
 (not $x28107)))))
(assert
 (let (($x13740 (forall ((gidx.2465419 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12097 (globals ?x73041)))
 (let ((?x13783 (g_granules ?x12097)))
 (let ((?x13357 (e_state_s_granule (select ?x13783 gidx.2465419))))
 (let (($x13420 (= ?x13357 6)))
 (let (($x14010 (= ?x13357 0)))
 (=> (not (select (gpt ?x73041) gidx.2465419)) (or $x14010 $x13420)))))))))))))))))))))))))))))))))))))
 ))
 (not $x13740)))
(check-sat)

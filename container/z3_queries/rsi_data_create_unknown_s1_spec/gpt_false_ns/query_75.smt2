...
(assert
 ...
 (and $x7785 $x8235))))))))
(assert
 (let (($x8289 (forall ((gidx.2449907 Int) )(let ((?x7892 (test_Z_PTE.0_call v_0.2449661)))
 (let ((?x8069 (meta_PA ?x7892)))
 (let ((?x41586 (meta_granule_offset ?x8069)))
 ...
 (let ((?x42023 (e_state_s_granule (select ?x8708 gidx.2449907))))
 (let ((?x50757 (gpt ?x121039)))
 (let (($x8607 (select ?x50757 gidx.2449907)))
 (let (($x8308 (not $x8607)))
 (=> $x8308 (or (= ?x42023 0) (= ?x42023 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8289)))
(check-sat)

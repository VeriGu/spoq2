...
(assert
 ...
 (not $x2640)))))
(assert
 (let (($x11036 (forall ((gidx.2459091 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x93994 (globals ?x117347)))
 (let ((?x62121 (g_granules ?x93994)))
 (let ((?x10828 (e_state_s_granule (select ?x62121 gidx.2459091))))
 (let (($x10710 (= ?x10828 6)))
 (let (($x10531 (= ?x10828 0)))
 (=> (not (select (gpt ?x117347) gidx.2459091)) (or $x10531 $x10710))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x11036)))
(check-sat)

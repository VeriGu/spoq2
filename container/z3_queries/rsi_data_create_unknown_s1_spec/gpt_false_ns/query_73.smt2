...
(let ((a!12 (granule_unlock_spec.0_call
 ...
 (or (not $x7564) $x50481))))
(assert
 (let (($x7437 (forall ((gidx.2449235 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x20440 (globals ?x105289)))
 (let ((?x49609 (g_granules ?x20440)))
 (let ((?x57803 (e_state_s_granule (select ?x49609 gidx.2449235))))
 (let (($x49656 (= ?x57803 6)))
 (let (($x7787 (= ?x57803 0)))
 (=> (not (select (gpt ?x105289) gidx.2449235)) (or $x7787 $x49656))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7437)))
(check-sat)

...
(assert
 ...
 (or (not $x1121) $x1045))))
(assert
 (forall ((v_0.96777 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (select ?x48 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))) 4096)))))
 )
(assert
 (let ((?x1089 (test_PA.0_call v_1.0)))
 (check_rcsm_mask_para.0_call ?x1089)))
(assert
 (let (($x1131 (forall ((gidx.2429467 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.2429467)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.2429467)) (or $x62 $x61))))))))))
 ))
 (not $x1131)))
(check-sat)

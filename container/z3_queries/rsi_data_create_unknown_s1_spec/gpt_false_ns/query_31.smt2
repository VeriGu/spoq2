...
(declare-fun v_0.2437621 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2437621)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!28 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2437621)))
                 4096)))
...
(let ((a!29 (store a!27
                   a!28
                   (mks_granule (e_lock (select a!27 a!28))
                                4
                                (e_ref (select a!27 a!28))))))
...
(assert
 ...
 (let (($x1549 (= ?x1611 0)))
 (let (($x33230 (and $x1549 $x1613 $x25501)))
 (not $x33230))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2437586 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1427 (elem_0 ?x1426)))
 (let ((?x1380 (e_2 ?x1427)))
 (let ((?x118732 (granule_unlock_spec.0_call ?x1380 ?x1423)))
 (let ((?x1634 (value_RData ?x118732)))
 (let ((?x44604 (share ?x1634)))
 (let ((?x3847 (globals ?x44604)))
 (let ((?x43345 (g_granules ?x3847)))
 (let ((?x3514 (e_state_s_granule (select ?x43345 gidx.2437586))))
 (let (($x4147 (= ?x3514 6)))
 (let (($x4186 (= ?x3514 0)))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2437586)))
 (let (($x4368 (not $x4378)))
 (=> $x4368 (or $x4186 $x4147)))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2437621 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2437621))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x4448 (forall ((gidx.2437809 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x44604 (share ?x1634)))
 (let ((?x4258 (log ?x1634)))
 (let ((?x36294 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!4 (granule_unlock_spec.0_call
             (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
             (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))))
  (oracle (value_RData a!4))))))_call| ?x4258)))
 (let ((?x4609 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!4 (granule_unlock_spec.0_call
             (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
             (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))))
  (repl (value_RData a!4))))))_call| ?x36294 ?x44604)))
 (let ((?x4355 (value_Shared ?x4609)))
 (let ((?x4051 (globals ?x4355)))
 (let ((?x4440 (g_granules ?x4051)))
 (let ((?x36588 (e_state_s_granule (select ?x4440 gidx.2437809))))
 (let (($x74149 (= ?x36588 0)))
 (let ((?x28529 (gpt ?x4355)))
 (let (($x3938 (select ?x28529 gidx.2437809)))
 (let (($x3467 (= ?x36588 6)))
 (or $x3467 $x3938 $x74149)))))))))))))))))))))))))))))))))
 ))
 (let (($x4376 (forall ((gidx.2437792 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x44604 (share ?x1634)))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2437792)))
 (let ((?x3514 (e_state_s_granule (select (g_granules (globals ?x44604)) gidx.2437792))))
 (let (($x4186 (= ?x3514 0)))
 (let (($x4147 (= ?x3514 6)))
 (or $x4147 $x4186 $x4378)))))))))))))))))))))))))))
 ))
 (or (not $x4376) $x4448))))
(assert
 (let ((?x4284 (make_return_code_para.0_call 9)))
 (let ((?x36573 (pack_struct_return_code_para.0_call ?x4284)))
 (= ?x36573 0))))
(assert
 (forall ((gidx.2437922 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x118732 (granule_unlock_spec.0_call ?x1380 ?x1423)))
 (let ((?x1634 (value_RData ?x118732)))
 (let ((?x4094 (test_Z_PTE.0_call v_0.2437621)))
 (let ((?x4228 (meta_PA ?x4094)))
 (let ((?x4366 (meta_granule_offset ?x4228)))
 (let ((?x28490 (div ?x4366 4096)))
 (let ((?x44604 (share ?x1634)))
 (let ((?x3847 (globals ?x44604)))
 (let ((?x43345 (g_granules ?x3847)))
 (let ((?x4182 (select ?x43345 ?x28490)))
 (let ((?x4093 (mks_granule (e_lock ?x4182) 4 (e_ref ?x4182))))
 (let ((?x4044 (store ?x43345 ?x28490 ?x4093)))
 (let ((?x4650 (mkGLOBALS (g_heap ?x3847) (g_debug_exits ?x3847) (g_vmid_count ?x3847) (g_vmid_lock ?x3847) (g_vmids ?x3847) (g_nr_lrs ?x3847) (g_nr_aprs ?x3847) (g_max_vintid ?x3847) (g_pri_res0_mask ?x3847) (g_default_gicstate ?x3847) (g_status_handler ?x3847) (g_rmm_trap_list ?x3847) (g_tt_l3_buffer ?x3847) (g_tt_l2_mem0_0 ?x3847) (g_tt_l2_mem0_1 ?x3847) (g_tt_l2_mem1_0 ?x3847) (g_tt_l2_mem1_1 ?x3847) (g_tt_l2_mem1_2 ?x3847) (g_tt_l2_mem1_3 ?x3847) (g_tt_l1_upper ?x3847) (g_mbedtls_mem_buf ?x3847) ?x4044 (g_rmm_attest_signing_key ?x3847) (g_rmm_attest_public_key ?x3847) (g_rmm_attest_public_key_len ?x3847) (g_rmm_attest_public_key_hash ?x3847) (g_rmm_attest_public_key_hash_len ?x3847) (g_platform_token_buf ?x3847) (g_rmm_platform_token ?x3847) (g_get_realm_identity_identity ?x3847) (g_realm_attest_private_key ?x3847))))
 (let ((?x4276 (gpt ?x44604)))
 (let ((?x27608 (repl ?x1634)))
 (let ((?x3246 (oracle ?x1634)))
 (let ((?x4258 (log ?x1634)))
 (let ((?x36384 (mkRData ?x4258 ?x3246 ?x27608 (priv ?x1634) (mkShared ?x4276 (granule_data ?x44604) ?x4650) (stack ?x1634) (halt ?x1634))))
 (let ((?x4137 (mkPtr "granules" ?x4366)))
 (let ((?x36496 (granule_unlock_spec.0_call ?x4137 ?x36384)))
 (let ((?x28408 (value_RData ?x36496)))
 (let ((?x52580 (share ?x28408)))
 (let ((?x1095 (globals ?x52580)))
 (let ((?x4263 (g_granules ?x1095)))
 (let ((?x4627 (e_state_s_granule (select ?x4263 gidx.2437922))))
 (let (($x4388 (= ?x4627 6)))
 (let (($x4209 (= ?x4627 0)))
 (=> (not (select (gpt ?x52580) gidx.2437922)) (or $x4209 $x4388)))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2437957 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2437957))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x28408 (value_RData ?x36496)))
 (let ((?x52580 (share ?x28408)))
 (let ((?x4412 (gpt ?x52580)))
 (select ?x4412 ?x1047)))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x3893 (forall ((gidx.2438145 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x28408 (value_RData ?x36496)))
 (let ((?x52580 (share ?x28408)))
 (let ((?x3438 (log ?x28408)))
 (let ((?x3896 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2437621)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!40 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!5))
                       ...
                       (stack (value_RData a!5))
                       (halt (value_RData a!5))))))
  (oracle (value_RData a!40))))))))))_call| ?x3438)))
 (let ((?x60160 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2437621)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!40 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!5))
                       ...
                       (stack (value_RData a!5))
                       (halt (value_RData a!5))))))
  (repl (value_RData a!40))))))))))_call| ?x3896 ?x52580)))
 (let ((?x4282 (value_Shared ?x60160)))
 (let ((?x4188 (globals ?x4282)))
 (let ((?x4264 (g_granules ?x4188)))
 (let ((?x4142 (e_state_s_granule (select ?x4264 gidx.2438145))))
 (let (($x4659 (= ?x4142 6)))
 (let ((?x4527 (gpt ?x4282)))
 (let (($x4086 (select ?x4527 gidx.2438145)))
 (let (($x3523 (= ?x4142 0)))
 (or $x3523 $x4086 $x4659))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3026 (forall ((gidx.2438128 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x52580 (share ?x28408)))
 (let ((?x4412 (gpt ?x52580)))
 (let (($x28502 (select ?x4412 gidx.2438128)))
 (let ((?x4627 (e_state_s_granule (select (g_granules (globals ?x52580)) gidx.2438128))))
 (let (($x4388 (= ?x4627 6)))
 (let (($x4209 (= ?x4627 0)))
 (or $x4209 $x4388 $x28502))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x3026) $x3893))))
(assert
 (let (($x3989 (forall ((gidx.2438204 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1095 (globals ?x52580)))
 (let ((?x4263 (g_granules ?x1095)))
 (let ((?x4627 (e_state_s_granule (select ?x4263 gidx.2438204))))
 (let (($x4388 (= ?x4627 6)))
 (let (($x4209 (= ?x4627 0)))
 (=> (not (select (gpt ?x52580) gidx.2438204)) (or $x4209 $x4388)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3989)))
(check-sat)

...
(assert
 ...
 (and $x33452 $x42387))))))))
(assert
 (let (($x8779 (forall ((gidx.2451699 Int) )(let ((?x7915 (test_Z_PTE.0_call v_0.2451453)))
 (let ((?x8388 (meta_PA ?x7915)))
 (let ((?x9240 (meta_granule_offset ?x8388)))
 ...
 (let ((?x8763 (e_state_s_granule (select ?x6731 gidx.2451699))))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2451699)))
 (let (($x98161 (not $x9125)))
 (=> $x98161 (or (= ?x8763 0) (= ?x8763 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8779)))
(check-sat)

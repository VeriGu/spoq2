...
(let ((a!12 (granule_unlock_spec.0_call
 ...
 (or (not $x7890) $x7235))))
(assert
 (let (($x7920 (forall ((gidx.2448171 Int) )(let ((?x7688 (test_Z_PTE.0_call v_0.2447925)))
 ...
 (let ((?x8160 (e_state_s_granule (select ?x7792 gidx.2448171))))
 (let ((?x39507 (gpt ?x104826)))
 (let (($x48710 (select ?x39507 gidx.2448171)))
 (let (($x7476 (not $x48710)))
 (=> $x7476 (or (= ?x8160 0) (= ?x8160 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7920)))
(check-sat)

...
(assert
 ...
 (not $x5269))))))))))))))))))))))))))
(assert
 (let (($x51953 (forall ((gidx.2452819 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5395 (globals ?x4932)))
 (let ((?x5402 (g_granules ?x5395)))
 (let ((?x5516 (e_state_s_granule (select ?x5402 gidx.2452819))))
 (let (($x5641 (= ?x5516 6)))
 (let (($x21368 (= ?x5516 0)))
 (=> (not (select (gpt ?x4932) gidx.2452819)) (or $x21368 $x5641)))))))))))))))))))))))))))))))
 ))
 (not $x51953)))
(check-sat)

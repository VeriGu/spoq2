...
(assert
 ...
 (not $x33222)))))))))))))))))))))))))))))))
(assert
 (let (($x34919 (forall ((gidx.2434003 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x33257 (globals ?x41218)))
 (let ((?x33265 (g_granules ?x33257)))
 (let ((?x1572 (e_state_s_granule (select ?x33265 gidx.2434003))))
 (let (($x1594 (= ?x1572 6)))
 (let (($x1599 (= ?x1572 0)))
 (=> (not (select (gpt ?x41218) gidx.2434003)) (or $x1599 $x1594)))))))))))))))))))))))))))))))
 ))
 (not $x34919)))
(check-sat)

...
(declare-fun v_0.2465509 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2465509)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!32 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2465509)))
                 4096)))
...
(let ((a!9 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!8)))
(let ((a!10 (g_heap (globals (share (value_RData a!9)))))
      (a!11 (g_debug_exits (globals (share (value_RData a!9)))))
      (a!12 (g_vmid_count (globals (share (value_RData a!9)))))
      (a!13 (g_vmid_lock (globals (share (value_RData a!9)))))
      (a!14 (g_vmids (globals (share (value_RData a!9)))))
      (a!15 (g_nr_lrs (globals (share (value_RData a!9)))))
      (a!16 (g_nr_aprs (globals (share (value_RData a!9)))))
      (a!17 (g_max_vintid (globals (share (value_RData a!9)))))
      (a!18 (g_pri_res0_mask (globals (share (value_RData a!9)))))
      (a!19 (g_default_gicstate (globals (share (value_RData a!9)))))
      (a!20 (g_status_handler (globals (share (value_RData a!9)))))
      (a!21 (g_rmm_trap_list (globals (share (value_RData a!9)))))
      (a!22 (g_tt_l3_buffer (globals (share (value_RData a!9)))))
      (a!23 (g_tt_l2_mem0_0 (globals (share (value_RData a!9)))))
      (a!24 (g_tt_l2_mem0_1 (globals (share (value_RData a!9)))))
      (a!25 (g_tt_l2_mem1_0 (globals (share (value_RData a!9)))))
      (a!26 (g_tt_l2_mem1_1 (globals (share (value_RData a!9)))))
      (a!27 (g_tt_l2_mem1_2 (globals (share (value_RData a!9)))))
      (a!28 (g_tt_l2_mem1_3 (globals (share (value_RData a!9)))))
      (a!29 (g_tt_l1_upper (globals (share (value_RData a!9)))))
      (a!30 (g_mbedtls_mem_buf (globals (share (value_RData a!9)))))
      (a!31 (g_granules (globals (share (value_RData a!9)))))
      (a!34 (g_rmm_attest_signing_key (globals (share (value_RData a!9)))))
      (a!35 (g_rmm_attest_public_key (globals (share (value_RData a!9)))))
      (a!36 (g_rmm_attest_public_key_len (globals (share (value_RData a!9)))))
      (a!37 (g_rmm_attest_public_key_hash (globals (share (value_RData a!9)))))
      (a!38 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!9)))))
      (a!39 (g_platform_token_buf (globals (share (value_RData a!9)))))
      (a!40 (g_rmm_platform_token (globals (share (value_RData a!9)))))
      (a!41 (g_get_realm_identity_identity (globals (share (value_RData a!9)))))
      (a!42 (g_realm_attest_private_key (globals (share (value_RData a!9))))))
(let ((a!33 (store a!31
                   a!32
                   (mks_granule (e_lock (select a!31 a!32))
                                1
                                (e_ref (select a!31 a!32))))))
(let ((a!43 (mkShared (gpt (share (value_RData a!9)))
                      (granule_data (share (value_RData a!9)))
                      (mkGLOBALS a!10
                                 a!11
                                 a!12
                                 a!13
...
(let ((a!44 (granule_unlock_spec.0_call
              a!1
              (mkRData (log (value_RData a!9))
                       (oracle (value_RData a!9))
                       (repl (value_RData a!9))
                       (priv (value_RData a!9))
                       a!43
                       (stack (value_RData a!9))
                       (halt (value_RData a!9))))))
...
(assert
 ...
 (let (($x9774 (= ?x9654 0)))
 (let (($x51535 (and $x9774 $x31671 $x9572)))
 (not $x51535)))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2464410 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x26171 (elem_0 ?x34511)))
 (let ((?x10187 (e_2 ?x26171)))
 (let ((?x156130 (granule_unlock_spec.0_call ?x10187 ?x9613)))
 (let ((?x9887 (value_RData ?x156130)))
 (let ((?x73041 (share ?x9887)))
 (let ((?x12097 (globals ?x73041)))
 (let ((?x13783 (g_granules ?x12097)))
 (let ((?x13357 (e_state_s_granule (select ?x13783 gidx.2464410))))
 (let (($x13420 (= ?x13357 6)))
 (let (($x14010 (= ?x13357 0)))
 (=> (not (select (gpt ?x73041) gidx.2464410)) (or $x14010 $x13420)))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2464445 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2464445))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x9887 (value_RData ?x156130)))
 (let ((?x73041 (share ?x9887)))
 (let ((?x13331 (gpt ?x73041)))
 (select ?x13331 ?x1047)))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x12501 (forall ((gidx.2464633 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x9887 (value_RData ?x156130)))
 (let ((?x73041 (share ?x9887)))
 (let ((?x14065 (log ?x9887)))
 (let ((?x13682 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (value_RData (granule_unlock_spec.0_call
                          (e_2 (elem_0 a!6))
                          (elem_1 a!6)))))
  (oracle a!7))))))))_call| ?x14065)))
 (let ((?x13914 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (value_RData (granule_unlock_spec.0_call
                          (e_2 (elem_0 a!6))
                          (elem_1 a!6)))))
  (repl a!7))))))))_call| ?x13682 ?x73041)))
 (let ((?x13466 (value_Shared ?x13914)))
 (let ((?x14066 (globals ?x13466)))
 (let ((?x13156 (g_granules ?x14066)))
 (let ((?x13342 (e_state_s_granule (select ?x13156 gidx.2464633))))
 (let (($x105274 (= ?x13342 6)))
 (let (($x13146 (= ?x13342 0)))
 (let ((?x55128 (gpt ?x13466)))
 (let (($x12269 (select ?x55128 gidx.2464633)))
 (or $x12269 $x13146 $x105274))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12176 (forall ((gidx.2464616 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x73041 (share ?x9887)))
 (let ((?x13331 (gpt ?x73041)))
 (let (($x14064 (select ?x13331 gidx.2464616)))
 (let ((?x13357 (e_state_s_granule (select (g_granules (globals ?x73041)) gidx.2464616))))
 (let (($x14010 (= ?x13357 0)))
 (let (($x13420 (= ?x13357 6)))
 (or $x13420 $x14010 $x14064))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x12176) $x12501))))
(assert
 ...
 (not $x28107)))))
(assert
 (forall ((gidx.2465474 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x156130 (granule_unlock_spec.0_call ?x10187 ?x9613)))
 (let ((?x9887 (value_RData ?x156130)))
 (let ((?x13988 (granule_unlock_spec.0_call ?x1244 ?x9887)))
 (let ((?x12549 (value_RData ?x13988)))
 (let ((?x81795 (share ?x12549)))
 (let ((?x12633 (globals ?x81795)))
 (let ((?x13802 (g_granules ?x12633)))
 (let ((?x13952 (e_state_s_granule (select ?x13802 gidx.2465474))))
 (let (($x13393 (= ?x13952 6)))
 (let (($x13462 (= ?x13952 0)))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2465474)))
 (let (($x62406 (not $x13479)))
 (=> $x62406 (or $x13462 $x13393))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2465509 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2465509))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x11866 (forall ((gidx.2465697 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12549 (value_RData ?x13988)))
 (let ((?x81795 (share ?x12549)))
 (let ((?x65393 (log ?x12549)))
 (let ((?x13983 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!8 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!7)))
  (oracle (value_RData a!8))))))))))_call| ?x65393)))
 (let ((?x61766 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!8 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!7)))
  (repl (value_RData a!8))))))))))_call| ?x13983 ?x81795)))
 (let ((?x53130 (value_Shared ?x61766)))
 (let ((?x12476 (gpt ?x53130)))
 (let (($x62456 (select ?x12476 gidx.2465697)))
 (let ((?x13806 (e_state_s_granule (select (g_granules (globals ?x53130)) gidx.2465697))))
 (let (($x56201 (= ?x13806 6)))
 (let (($x13882 (= ?x13806 0)))
 (or $x13882 $x56201 $x62456))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x65420 (forall ((gidx.2465680 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x81795 (share ?x12549)))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2465680)))
 (let ((?x13952 (e_state_s_granule (select (g_granules (globals ?x81795)) gidx.2465680))))
 (let (($x13462 (= ?x13952 0)))
 (let (($x13393 (= ?x13952 6)))
 (or $x13393 $x13462 $x13479))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x65420) $x11866))))
(assert
 (let ((?x14212 (test_Z_PTE.0_call v_0.2465509)))
 (let ((?x14393 (meta_PA ?x14212)))
 (let ((?x13372 (meta_granule_offset ?x14393)))
 (let (($x59442 (>= ?x13372 0)))
 (let ((?x105315 (mod ?x13372 4096)))
 (let (($x13214 (= ?x105315 0)))
 (and $x13214 $x59442))))))))
(assert
 (forall ((gidx.2465810 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13988 (granule_unlock_spec.0_call ?x1244 ?x9887)))
 (let ((?x12549 (value_RData ?x13988)))
 (let (($x13742 (halt ?x12549)))
 (let ((?x13567 (stack ?x12549)))
 (let ((?x81795 (share ?x12549)))
 (let ((?x12633 (globals ?x81795)))
 (let ((?x13979 (g_realm_attest_private_key ?x12633)))
 (let ((?x56882 (g_get_realm_identity_identity ?x12633)))
 (let ((?x65653 (g_rmm_platform_token ?x12633)))
 (let ((?x13848 (g_platform_token_buf ?x12633)))
 (let ((?x12197 (g_rmm_attest_public_key_hash_len ?x12633)))
 (let ((?x12457 (g_rmm_attest_public_key_hash ?x12633)))
 (let ((?x13196 (g_rmm_attest_public_key_len ?x12633)))
 (let ((?x65216 (g_rmm_attest_public_key ?x12633)))
 (let ((?x56698 (g_rmm_attest_signing_key ?x12633)))
 (let ((?x14212 (test_Z_PTE.0_call v_0.2465509)))
 (let ((?x14393 (meta_PA ?x14212)))
 (let ((?x13372 (meta_granule_offset ?x14393)))
 (let ((?x14529 (div ?x13372 4096)))
 (let ((?x13802 (g_granules ?x12633)))
 (let ((?x14223 (select ?x13802 ?x14529)))
 (let ((?x21065 (mks_granule (e_lock ?x14223) 1 (e_ref ?x14223))))
 (let ((?x38081 (store ?x13802 ?x14529 ?x21065)))
 (let ((?x56889 (g_mbedtls_mem_buf ?x12633)))
 (let ((?x12986 (g_tt_l1_upper ?x12633)))
 (let ((?x12589 (g_tt_l2_mem1_3 ?x12633)))
 (let ((?x65259 (g_tt_l2_mem1_2 ?x12633)))
 (let ((?x14246 (g_tt_l2_mem1_1 ?x12633)))
 (let ((?x13772 (g_tt_l2_mem1_0 ?x12633)))
 (let ((?x13088 (g_tt_l2_mem0_1 ?x12633)))
 (let ((?x88297 (g_tt_l2_mem0_0 ?x12633)))
 (let ((?x56591 (g_tt_l3_buffer ?x12633)))
 (let ((?x12604 (g_rmm_trap_list ?x12633)))
 (let ((?x13464 (g_status_handler ?x12633)))
 (let ((?x13596 (g_default_gicstate ?x12633)))
 (let ((?x14026 (g_pri_res0_mask ?x12633)))
 (let ((?x14225 (g_max_vintid ?x12633)))
 (let ((?x112333 (g_nr_aprs ?x12633)))
 (let ((?x20759 (g_nr_lrs ?x12633)))
 (let ((?x56209 (g_vmids ?x12633)))
 (let ((?x13384 (g_vmid_lock ?x12633)))
 (let ((?x13285 (g_vmid_count ?x12633)))
 (let ((?x13904 (g_debug_exits ?x12633)))
 (let ((?x62582 (g_heap ?x12633)))
 (let ((?x14216 (mkGLOBALS ?x62582 ?x13904 ?x13285 ?x13384 ?x56209 ?x20759 ?x112333 ?x14225 ?x14026 ?x13596 ?x13464 ?x12604 ?x56591 ?x88297 ?x13088 ?x13772 ?x14246 ?x65259 ?x12589 ?x12986 ?x56889 ?x38081 ?x56698 ?x65216 ?x13196 ?x12457 ?x12197 ?x13848 ?x65653 ?x56882 ?x13979)))
 (let ((?x11205 (granule_data ?x81795)))
 (let ((?x13266 (gpt ?x81795)))
 (let ((?x12444 (priv ?x12549)))
 (let ((?x64526 (repl ?x12549)))
 (let ((?x56704 (oracle ?x12549)))
 (let ((?x65393 (log ?x12549)))
 (let ((?x13911 (mkRData ?x65393 ?x56704 ?x64526 ?x12444 (mkShared ?x13266 ?x11205 ?x14216) ?x13567 $x13742)))
 (let ((?x88764 (mkPtr "granules" ?x13372)))
 (let ((?x13976 (granule_unlock_spec.0_call ?x88764 ?x13911)))
 (let ((?x14421 (value_RData ?x13976)))
 (let ((?x90092 (share ?x14421)))
 (let ((?x13418 (globals ?x90092)))
 (let ((?x14167 (g_granules ?x13418)))
 (let ((?x14408 (e_state_s_granule (select ?x14167 gidx.2465810))))
 (let (($x13830 (= ?x14408 6)))
 (let (($x105228 (= ?x14408 0)))
 (=> (not (select (gpt ?x90092) gidx.2465810)) (or $x105228 $x13830))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2465845 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2465845))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x14421 (value_RData ?x13976)))
 (let ((?x90092 (share ?x14421)))
 (let ((?x13756 (gpt ?x90092)))
 (select ?x13756 ?x1047))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x13269 (forall ((gidx.2466033 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x14421 (value_RData ?x13976)))
 (let ((?x90092 (share ?x14421)))
 (let ((?x14410 (log ?x14421)))
 (let ((?x13116 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2465509)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!44 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!9))
                       ...
                       (stack (value_RData a!9))
                       (halt (value_RData a!9))))))
  (oracle (value_RData a!44))))))))))))))_call| ?x14410)))
 (let ((?x13823 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2465509)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!44 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!9))
                       ...
                       (stack (value_RData a!9))
                       (halt (value_RData a!9))))))
  (repl (value_RData a!44))))))))))))))_call| ?x13116 ?x90092)))
 (let ((?x12924 (value_Shared ?x13823)))
 (let ((?x74321 (globals ?x12924)))
 (let ((?x104297 (g_granules ?x74321)))
 (let ((?x14376 (e_state_s_granule (select ?x104297 gidx.2466033))))
 (let (($x55016 (= ?x14376 0)))
 (let ((?x13822 (gpt ?x12924)))
 (let (($x29972 (select ?x13822 gidx.2466033)))
 (let (($x14415 (= ?x14376 6)))
 (or $x14415 $x29972 $x55016)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x11352 (forall ((gidx.2466016 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13418 (globals ?x90092)))
 (let ((?x14167 (g_granules ?x13418)))
 (let ((?x14408 (e_state_s_granule (select ?x14167 gidx.2466016))))
 (let (($x105228 (= ?x14408 0)))
 (let ((?x13756 (gpt ?x90092)))
 (let (($x14220 (select ?x13756 gidx.2466016)))
 (let (($x13830 (= ?x14408 6)))
 (or $x13830 $x14220 $x105228)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x11352) $x13269))))
(assert
 (let (($x12830 (forall ((gidx.2466092 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13418 (globals ?x90092)))
 (let ((?x14167 (g_granules ?x13418)))
 (let ((?x14408 (e_state_s_granule (select ?x14167 gidx.2466092))))
 (let (($x13830 (= ?x14408 6)))
 (let (($x105228 (= ?x14408 0)))
 (=> (not (select (gpt ?x90092) gidx.2466092)) (or $x105228 $x13830))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12830)))
(check-sat)

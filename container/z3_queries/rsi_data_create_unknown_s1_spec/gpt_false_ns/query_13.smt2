...
(assert
 ...
 (= ?x26393 0))))
(assert
 (forall ((gidx.2433274 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3806 (mks_granule (e_lock ?x10555) 4 (e_ref ?x10555))))
 (let ((?x2394 (store ?x18538 ?x2647 ?x3806)))
 (let ((?x2651 (mkGLOBALS (g_heap ?x26504) (g_debug_exits ?x26504) (g_vmid_count ?x26504) (g_vmid_lock ?x26504) (g_vmids ?x26504) (g_nr_lrs ?x26504) (g_nr_aprs ?x26504) (g_max_vintid ?x26504) (g_pri_res0_mask ?x26504) (g_default_gicstate ?x26504) (g_status_handler ?x26504) (g_rmm_trap_list ?x26504) (g_tt_l3_buffer ?x26504) (g_tt_l2_mem0_0 ?x26504) (g_tt_l2_mem0_1 ?x26504) (g_tt_l2_mem1_0 ?x26504) (g_tt_l2_mem1_1 ?x26504) (g_tt_l2_mem1_2 ?x26504) (g_tt_l2_mem1_3 ?x26504) (g_tt_l1_upper ?x26504) (g_mbedtls_mem_buf ?x26504) ?x2394 (g_rmm_attest_signing_key ?x26504) (g_rmm_attest_public_key ?x26504) (g_rmm_attest_public_key_len ?x26504) (g_rmm_attest_public_key_hash ?x26504) (g_rmm_attest_public_key_hash_len ?x26504) (g_platform_token_buf ?x26504) (g_rmm_platform_token ?x26504) (g_get_realm_identity_identity ?x26504) (g_realm_attest_private_key ?x26504))))
 (let ((?x26520 (gpt ?x89056)))
 (let ((?x34360 (repl ?x34207)))
 (let ((?x34438 (oracle ?x34207)))
 (let ((?x73346 (log ?x34207)))
 (let ((?x2657 (mkRData ?x73346 ?x34438 ?x34360 (priv ?x34207) (mkShared ?x26520 (granule_data ?x89056) ?x2651) (stack ?x34207) (halt ?x34207))))
 (let ((?x2546 (mkPtr "granules" ?x2706)))
 (let ((?x1046 (granule_unlock_spec.0_call ?x2546 ?x2657)))
 (let ((?x2567 (value_RData ?x1046)))
 (let ((?x97039 (share ?x2567)))
 (let ((?x2869 (globals ?x97039)))
 (let ((?x2725 (g_granules ?x2869)))
 (let ((?x2955 (e_state_s_granule (select ?x2725 gidx.2433274))))
 (let (($x2949 (= ?x2955 6)))
 (let (($x2933 (= ?x2955 0)))
 (=> (not (select (gpt ?x97039) gidx.2433274)) (or $x2933 $x2949)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2433309 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2433309))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x2567 (value_RData ?x1046)))
 (let ((?x97039 (share ?x2567)))
 (let ((?x2837 (gpt ?x97039)))
 (select ?x2837 ?x1047)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x26624 (forall ((gidx.2433497 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x97039 (share ?x2567)))
 (let ((?x2859 (log ?x2567)))
 (let ((?x2381 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2432973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!47 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!12))
                       ...
                       (stack (value_RData a!12))
                       (halt (value_RData a!12))))))
  (oracle (value_RData a!47))))))))))))))_call| ?x2859)))
 (let ((?x2841 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2432973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!47 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!12))
                       ...
                       (stack (value_RData a!12))
                       (halt (value_RData a!12))))))
  (repl (value_RData a!47))))))))))))))_call| ?x2381 ?x97039)))
 (let ((?x2741 (value_Shared ?x2841)))
 (let ((?x2713 (gpt ?x2741)))
 (let (($x65597 (select ?x2713 gidx.2433497)))
 (let ((?x42332 (e_state_s_granule (select (g_granules (globals ?x2741)) gidx.2433497))))
 (let (($x42318 (= ?x42332 6)))
 (let (($x34178 (= ?x42332 0)))
 (or $x34178 $x42318 $x65597))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x26620 (forall ((gidx.2433480 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x97039 (share ?x2567)))
 (let ((?x2837 (gpt ?x97039)))
 (let (($x34579 (select ?x2837 gidx.2433480)))
 (let ((?x2955 (e_state_s_granule (select (g_granules (globals ?x97039)) gidx.2433480))))
 (let (($x2949 (= ?x2955 6)))
 (let (($x2933 (= ?x2955 0)))
 (or $x2933 $x2949 $x34579))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x26620) $x26624))))
(assert
 (let (($x2569 (forall ((gidx.2433556 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2869 (globals ?x97039)))
 (let ((?x2725 (g_granules ?x2869)))
 (let ((?x2955 (e_state_s_granule (select ?x2725 gidx.2433556))))
 (let (($x2949 (= ?x2955 6)))
 (let (($x2933 (= ?x2955 0)))
 (=> (not (select (gpt ?x97039) gidx.2433556)) (or $x2933 $x2949)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2569)))
(check-sat)

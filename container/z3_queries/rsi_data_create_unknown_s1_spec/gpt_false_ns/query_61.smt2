...
(assert
 ...
 (not $x2640)))))
(assert
 (let (($x80014 (forall ((gidx.2445763 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x47516 (globals ?x103049)))
 (let ((?x40102 (g_granules ?x47516)))
 (let ((?x6799 (e_state_s_granule (select ?x40102 gidx.2445763))))
 (let (($x6444 (= ?x6799 6)))
 (let (($x6784 (= ?x6799 0)))
 (=> (not (select (gpt ?x103049) gidx.2445763)) (or $x6784 $x6444))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x80014)))
(check-sat)

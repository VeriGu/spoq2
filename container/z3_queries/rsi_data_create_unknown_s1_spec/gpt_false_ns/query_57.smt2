...
(let ((a!11 (granule_unlock_spec.0_call
 ...
 (or (not $x6458) $x48318))))
(assert
 (let (($x6328 (forall ((gidx.2444699 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x6199 (globals ?x95216)))
 (let ((?x5918 (g_granules ?x6199)))
 (let ((?x6530 (e_state_s_granule (select ?x5918 gidx.2444699))))
 (let (($x63037 (= ?x6530 6)))
 (let (($x39690 (= ?x6530 0)))
 (=> (not (select (gpt ?x95216) gidx.2444699)) (or $x39690 $x63037))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6328)))
(check-sat)

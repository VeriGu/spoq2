...
(assert
 (let (($x8597 (forall ((gidx.2448899 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x50090 (globals ?x89664)))
 (let ((?x7962 (g_granules ?x50090)))
 (let ((?x8212 (e_state_s_granule (select ?x7962 gidx.2448899))))
 (let (($x7258 (= ?x8212 6)))
 (let (($x6544 (= ?x8212 0)))
 (=> (not (select (gpt ?x89664) gidx.2448899)) (or $x6544 $x7258))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x8597)))
(check-sat)

...
(assert
 (let (($x35930 (forall ((gidx.2462227 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12770 (globals ?x103723)))
 (let ((?x59370 (g_granules ?x12770)))
 (let ((?x13111 (e_state_s_granule (select ?x59370 gidx.2462227))))
 (let (($x55815 (= ?x13111 6)))
 (let (($x11904 (= ?x13111 0)))
 (=> (not (select (gpt ?x103723) gidx.2462227)) (or $x11904 $x55815))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x35930)))
(check-sat)

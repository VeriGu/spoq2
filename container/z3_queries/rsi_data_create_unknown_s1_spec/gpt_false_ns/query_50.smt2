...
(assert
 ...
 (elem_0 ?x5225)))))))))))))))))))))))))))))))))))))
(assert
 (let (($x6040 (forall ((gidx.2442627 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5564 (globals ?x62858)))
 (let ((?x4820 (g_granules ?x5564)))
 (let ((?x5793 (e_state_s_granule (select ?x4820 gidx.2442627))))
 (let (($x6030 (= ?x5793 6)))
 (let (($x5999 (= ?x5793 0)))
 (=> (not (select (gpt ?x62858) gidx.2442627)) (or $x5999 $x6030)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x6040)))
(check-sat)

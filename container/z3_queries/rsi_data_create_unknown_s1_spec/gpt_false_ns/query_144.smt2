...
(declare-fun v_0.2468029 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2468029)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!3 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!2 st.0)))))
(let ((a!4 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!3))))
  (repl (value_RData (granule_unlock_spec.0_call a!1 (value_RData a!4)))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2468029)))))
      (a!2 (mkPtr "granules"
...
(let ((a!4 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!3))))
  (oracle (value_RData (granule_unlock_spec.0_call a!1 (value_RData a!4)))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (not $x5322))))))))))))))))))))
(assert
 (forall ((gidx.2467994 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1210 (spinlock_acquire_spec.0_call ?x1244 ?x1125)))
 (let ((?x1212 (value_RData ?x1210)))
 (let ((?x64633 (spinlock_release_spec.0_call ?x1244 ?x1212)))
 (let ((?x1378 (value_RData ?x64633)))
 (let ((?x29045 (share ?x1378)))
 (let ((?x36129 (globals ?x29045)))
 (let ((?x5085 (g_granules ?x36129)))
 (let ((?x28049 (e_state_s_granule (select ?x5085 gidx.2467994))))
 (let (($x3001 (= ?x28049 6)))
 (let (($x4548 (= ?x28049 0)))
 (=> (not (select (gpt ?x29045) gidx.2467994)) (or $x4548 $x3001))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2468029 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2468029))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x1378 (value_RData ?x64633)))
 (let ((?x29045 (share ?x1378)))
 (let ((?x4808 (gpt ?x29045)))
 (select ?x4808 ?x1047))))))))))))))))))
 )
(assert
 (let (($x13167 (forall ((gidx.2468217 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x29045 (share ?x1378)))
 (let ((?x1474 (log ?x1378)))
 (let ((?x5041 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
(let ((a!3 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!2))))
  (oracle (value_RData a!3)))))_call| ?x1474)))
 (let ((?x5086 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
(let ((a!3 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!2))))
  (repl (value_RData a!3)))))_call| ?x5041 ?x29045)))
 (let ((?x35761 (value_Shared ?x5086)))
 (let ((?x37092 (globals ?x35761)))
 (let ((?x29156 (g_granules ?x37092)))
 (let ((?x5178 (e_state_s_granule (select ?x29156 gidx.2468217))))
 (let (($x37127 (= ?x5178 0)))
 (let ((?x4821 (gpt ?x35761)))
 (let (($x5007 (select ?x4821 gidx.2468217)))
 (let (($x4526 (= ?x5178 6)))
 (or $x4526 $x5007 $x37127)))))))))))))))))))))))))))
 ))
 (let (($x56922 (forall ((gidx.2468200 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x29045 (share ?x1378)))
 (let ((?x4808 (gpt ?x29045)))
 (let (($x4778 (select ?x4808 gidx.2468200)))
 (let ((?x28049 (e_state_s_granule (select (g_granules (globals ?x29045)) gidx.2468200))))
 (let (($x4548 (= ?x28049 0)))
 (let (($x3001 (= ?x28049 6)))
 (or $x3001 $x4548 $x4778)))))))))))))))))))))
 ))
 (or (not $x56922) $x13167))))
(assert
 (forall ((gidx.2468330 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x64633 (spinlock_release_spec.0_call ?x1244 ?x1212)))
 (let ((?x1378 (value_RData ?x64633)))
 (let ((?x14667 (test_Z_PTE.0_call v_0.2468029)))
 (let ((?x14417 (meta_PA ?x14667)))
 (let ((?x15155 (meta_granule_offset ?x14417)))
 (let ((?x65721 (mkPtr "granules" ?x15155)))
 (let ((?x14125 (granule_unlock_spec.0_call ?x65721 ?x1378)))
 (let ((?x57183 (value_RData ?x14125)))
 (let ((?x48178 (share ?x57183)))
 (let ((?x13318 (globals ?x48178)))
 (let ((?x13734 (g_granules ?x13318)))
 (let ((?x14463 (e_state_s_granule (select ?x13734 gidx.2468330))))
 (let (($x14557 (= ?x14463 6)))
 (let (($x55263 (= ?x14463 0)))
 (=> (not (select (gpt ?x48178) gidx.2468330)) (or $x55263 $x14557))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2468365 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2468365))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x57183 (value_RData ?x14125)))
 (let ((?x48178 (share ?x57183)))
 (let ((?x13924 (gpt ?x48178)))
 (select ?x13924 ?x1047))))))))))))))))))))))))
 )
(assert
 (let (($x14647 (forall ((gidx.2468553 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x57183 (value_RData ?x14125)))
 (let ((?x48178 (share ?x57183)))
 (let ((?x14595 (log ?x57183)))
 (let ((?x13024 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2468029)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!4 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!3))))
  (oracle (value_RData (granule_unlock_spec.0_call a!1 (value_RData a!4)))))))_call| ?x14595)))
 (let ((?x14187 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2468029)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!4 (spinlock_release_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData a!3))))
  (repl (value_RData (granule_unlock_spec.0_call a!1 (value_RData a!4)))))))_call| ?x13024 ?x48178)))
 (let ((?x30361 (value_Shared ?x14187)))
 (let ((?x14353 (globals ?x30361)))
 (let ((?x13553 (g_granules ?x14353)))
 (let ((?x57071 (e_state_s_granule (select ?x13553 gidx.2468553))))
 (let (($x14896 (= ?x57071 6)))
 (let (($x14471 (= ?x57071 0)))
 (let ((?x14386 (gpt ?x30361)))
 (let (($x13915 (select ?x14386 gidx.2468553)))
 (or $x13915 $x14471 $x14896)))))))))))))))))))))))))))))))))
 ))
 (let (($x13744 (forall ((gidx.2468536 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x48178 (share ?x57183)))
 (let ((?x13924 (gpt ?x48178)))
 (let (($x65485 (select ?x13924 gidx.2468536)))
 (let ((?x14463 (e_state_s_granule (select (g_granules (globals ?x48178)) gidx.2468536))))
 (let (($x55263 (= ?x14463 0)))
 (let (($x14557 (= ?x14463 6)))
 (or $x14557 $x55263 $x65485)))))))))))))))))))))))))))
 ))
 (or (not $x13744) $x14647))))
(assert
 (let (($x14287 (forall ((gidx.2468612 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x13318 (globals ?x48178)))
 (let ((?x13734 (g_granules ?x13318)))
 (let ((?x14463 (e_state_s_granule (select ?x13734 gidx.2468612))))
 (let (($x14557 (= ?x14463 6)))
 (let (($x55263 (= ?x14463 0)))
 (=> (not (select (gpt ?x48178) gidx.2468612)) (or $x55263 $x14557))))))))))))))))))))))))))))
 ))
 (not $x14287)))
(check-sat)

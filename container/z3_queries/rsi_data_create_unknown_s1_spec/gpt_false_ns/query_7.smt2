...
(assert
 ...
 (select ?x2068 ?x1920))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x2230 (forall ((gidx.2431819 Int) )(let ((?x1921 (test_Z_PTE.0_call v_0.2431573)))
 (let ((?x41665 (meta_PA ?x1921)))
 (let ((?x18108 (meta_granule_offset ?x41665)))
 (let ((?x1920 (div ?x18108 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 ...
 (let ((?x2122 (e_state_s_granule (select ?x2067 gidx.2431819))))
 (let ((?x2068 (gpt ?x72843)))
 (let (($x33780 (select ?x2068 gidx.2431819)))
 (let (($x25994 (not $x33780)))
 (=> $x25994 (or (= ?x2122 0) (= ?x2122 6))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2230)))
(check-sat)

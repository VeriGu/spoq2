...
(let ((a!11 (value_RData (granule_unlock_spec.0_call
 ...
 (or (not $x32069) $x7503))))
(assert
 (let (($x7695 (forall ((gidx.2447835 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x7213 (globals ?x97032)))
 (let ((?x7427 (g_granules ?x7213)))
 (let ((?x7063 (e_state_s_granule (select ?x7427 gidx.2447835))))
 (let (($x23694 (= ?x7063 6)))
 (let (($x15895 (= ?x7063 0)))
 (=> (not (select (gpt ?x97032) gidx.2447835)) (or $x15895 $x23694)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7695)))
(check-sat)

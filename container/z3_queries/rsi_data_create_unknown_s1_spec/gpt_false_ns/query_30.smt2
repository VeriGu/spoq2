...
(assert
 ...
 (= ?x36573 0))))
(assert
 (let (($x4240 (forall ((gidx.2437867 Int) )(let ((?x4094 (test_Z_PTE.0_call v_0.2437621)))
 ...
 (let ((?x28453 (e_state_s_granule (select ?x4044 gidx.2437867))))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2437867)))
 (let (($x4368 (not $x4378)))
 (=> $x4368 (or (= ?x28453 0) (= ?x28453 6)))))))))))))))))))))))))))))))))))))
 ))
 (not $x4240)))
(check-sat)

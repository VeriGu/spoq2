...
(assert
 ...
 (not $x9927))))))))))))))))))))))))))))
(assert
 (let (($x14496 (forall ((gidx.2466147 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x9616 (globals ?x9907)))
 (let ((?x9694 (g_granules ?x9616)))
 (let ((?x33122 (e_state_s_granule (select ?x9694 gidx.2466147))))
 (let (($x43312 (= ?x33122 6)))
 (let (($x9486 (= ?x33122 0)))
 (=> (not (select (gpt ?x9907) gidx.2466147)) (or $x9486 $x43312)))))))))))))))))))))))))))))))))
 ))
 (not $x14496)))
(check-sat)

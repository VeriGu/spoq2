...
(assert
 ...
 (and $x12788 $x12406))))))))
(assert
 (let (($x55544 (forall ((gidx.2463235 Int) )(let ((?x13348 (test_Z_PTE.0_call v_0.2462989)))
 (let ((?x12578 (meta_PA ?x13348)))
 (let ((?x111700 (meta_granule_offset ?x12578)))
 ...
 (let ((?x72438 (e_state_s_granule (select ?x13388 gidx.2463235))))
 (let ((?x13273 (gpt ?x134703)))
 (let (($x9497 (select ?x13273 gidx.2463235)))
 (let (($x13122 (not $x9497)))
 (=> $x13122 (or (= ?x72438 0) (= ?x72438 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x55544)))
(check-sat)

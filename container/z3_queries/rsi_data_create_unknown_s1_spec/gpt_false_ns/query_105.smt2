...
(assert
 (let (($x10479 (forall ((gidx.2458027 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x19507 (globals ?x109534)))
 (let ((?x10944 (g_granules ?x19507)))
 (let ((?x70239 (e_state_s_granule (select ?x10944 gidx.2458027))))
 (let (($x58319 (= ?x70239 6)))
 (let (($x11238 (= ?x70239 0)))
 (=> (not (select (gpt ?x109534) gidx.2458027)) (or $x11238 $x58319))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10479)))
(check-sat)

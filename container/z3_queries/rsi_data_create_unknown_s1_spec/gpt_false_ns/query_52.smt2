...
(let ((a!10 (value_RData (granule_unlock_spec.0_call
 ...
 (or (not $x5575) $x5844))))
(assert
 (let (($x5873 (forall ((gidx.2443299 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x47572 (globals ?x86840)))
 (let ((?x5396 (g_granules ?x47572)))
 (let ((?x21944 (e_state_s_granule (select ?x5396 gidx.2443299))))
 (let (($x5569 (= ?x21944 6)))
 (let (($x30312 (= ?x21944 0)))
 (=> (not (select (gpt ?x86840) gidx.2443299)) (or $x30312 $x5569)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5873)))
(check-sat)

...
(assert
 (let (($x10934 (forall ((gidx.2456963 Int) )(let ((?x10750 (test_Z_PTE.0_call v_0.2456717)))
 ...
 (let ((?x10009 (e_state_s_granule (select ?x11011 gidx.2456963))))
 (let ((?x118389 (gpt ?x109000)))
 (let (($x9603 (select ?x118389 gidx.2456963)))
 (let (($x10522 (not $x9603)))
 (=> $x10522 (or (= ?x10009 0) (= ?x10009 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10934)))
(check-sat)

...
(assert
 ...
 (not $x2640)))))
(assert
 (forall ((gidx.2437194 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x27627 (granule_unlock_spec.0_call ?x1380 ?x3895)))
 (let ((?x33660 (value_RData ?x27627)))
 (let (($x3793 (halt ?x33660)))
 (let ((?x3577 (stack ?x33660)))
 (let ((?x98382 (share ?x33660)))
 (let ((?x43886 (globals ?x98382)))
 (let ((?x35787 (g_realm_attest_private_key ?x43886)))
 (let ((?x4064 (g_get_realm_identity_identity ?x43886)))
 (let ((?x3858 (g_rmm_platform_token ?x43886)))
 (let ((?x2864 (g_platform_token_buf ?x43886)))
 (let ((?x2471 (g_rmm_attest_public_key_hash_len ?x43886)))
 (let ((?x3256 (g_rmm_attest_public_key_hash ?x43886)))
 (let ((?x18933 (g_rmm_attest_public_key_len ?x43886)))
 (let ((?x4026 (g_rmm_attest_public_key ?x43886)))
 (let ((?x4079 (g_rmm_attest_signing_key ?x43886)))
 ...
 (let ((?x4171 (e_ref ?x3883)))
 (let ((?x3891 (e_lock ?x3883)))
 (let ((?x118539 (mks_granule ?x3891 1 ?x4171)))
 (let ((?x36424 (store ?x36162 ?x4048 ?x118539)))
 (let ((?x3687 (g_mbedtls_mem_buf ?x43886)))
 (let ((?x4150 (g_tt_l1_upper ?x43886)))
 (let ((?x4203 (g_tt_l2_mem1_3 ?x43886)))
 (let ((?x3995 (g_tt_l2_mem1_2 ?x43886)))
 (let ((?x3983 (g_tt_l2_mem1_1 ?x43886)))
 (let ((?x3856 (g_tt_l2_mem1_0 ?x43886)))
 (let ((?x4154 (g_tt_l2_mem0_1 ?x43886)))
 (let ((?x4080 (g_tt_l2_mem0_0 ?x43886)))
 (let ((?x3789 (g_tt_l3_buffer ?x43886)))
 (let ((?x3553 (g_rmm_trap_list ?x43886)))
 (let ((?x4036 (g_status_handler ?x43886)))
 (let ((?x4071 (g_default_gicstate ?x43886)))
 (let ((?x3388 (g_pri_res0_mask ?x43886)))
 (let ((?x3915 (g_max_vintid ?x43886)))
 (let ((?x3290 (g_nr_aprs ?x43886)))
 (let ((?x3841 (g_nr_lrs ?x43886)))
 (let ((?x27961 (g_vmids ?x43886)))
 (let ((?x3012 (g_vmid_lock ?x43886)))
 (let ((?x3464 (g_vmid_count ?x43886)))
 (let ((?x3900 (g_debug_exits ?x43886)))
 (let ((?x73972 (g_heap ?x43886)))
 (let ((?x35872 (mkGLOBALS ?x73972 ?x3900 ?x3464 ?x3012 ?x27961 ?x3841 ?x3290 ?x3915 ?x3388 ?x4071 ?x4036 ?x3553 ?x3789 ?x4080 ?x4154 ?x3856 ?x3983 ?x3995 ?x4203 ?x4150 ?x3687 ?x36424 ?x4079 ?x4026 ?x18933 ?x3256 ?x2471 ?x2864 ?x3858 ?x4064 ?x35787)))
 (let ((?x3876 (granule_data ?x98382)))
 (let ((?x59572 (gpt ?x98382)))
 (let ((?x4055 (priv ?x33660)))
 (let ((?x3695 (repl ?x33660)))
 (let ((?x3691 (oracle ?x33660)))
 (let ((?x4042 (log ?x33660)))
 (let ((?x36292 (mkRData ?x4042 ?x3691 ?x3695 ?x4055 (mkShared ?x59572 ?x3876 ?x35872) ?x3577 $x3793)))
 (let ((?x4054 (mkPtr "granules" ?x3271)))
 (let ((?x75048 (granule_unlock_spec.0_call ?x4054 ?x36292)))
 (let ((?x28389 (value_RData ?x75048)))
 (let ((?x102288 (share ?x28389)))
 (let ((?x3878 (globals ?x102288)))
 (let ((?x4148 (g_granules ?x3878)))
 (let ((?x83275 (e_state_s_granule (select ?x4148 gidx.2437194))))
 (let (($x4270 (= ?x83275 6)))
 (let (($x28385 (= ?x83275 0)))
 (=> (not (select (gpt ?x102288) gidx.2437194)) (or $x28385 $x4270)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2437229 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2437229))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x28389 (value_RData ?x75048)))
 (let ((?x102288 (share ?x28389)))
 (let ((?x82664 (gpt ?x102288)))
 (select ?x82664 ?x1047)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x4151 (forall ((gidx.2437417 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x28389 (value_RData ?x75048)))
 (let ((?x102288 (share ?x28389)))
 (let ((?x4332 (log ?x28389)))
 (let ((?x4194 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2436501)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!48 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!13))
                       ...
                       (stack (value_RData a!13))
                       (halt (value_RData a!13))))))
  (oracle (value_RData a!48)))))))))))))))_call| ?x4332)))
 (let ((?x35583 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2436501)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!48 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!13))
                       ...
                       (stack (value_RData a!13))
                       (halt (value_RData a!13))))))
  (repl (value_RData a!48)))))))))))))))_call| ?x4194 ?x102288)))
 (let ((?x4494 (value_Shared ?x35583)))
 (let ((?x4246 (globals ?x4494)))
 (let ((?x27833 (g_granules ?x4246)))
 (let ((?x4411 (e_state_s_granule (select ?x27833 gidx.2437417))))
 (let (($x4519 (= ?x4411 6)))
 (let (($x4467 (= ?x4411 0)))
 (let ((?x4345 (gpt ?x4494)))
 (let (($x4233 (select ?x4345 gidx.2437417)))
 (or $x4233 $x4467 $x4519))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3539 (forall ((gidx.2437400 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3878 (globals ?x102288)))
 (let ((?x4148 (g_granules ?x3878)))
 (let ((?x83275 (e_state_s_granule (select ?x4148 gidx.2437400))))
 (let (($x28385 (= ?x83275 0)))
 (let (($x4270 (= ?x83275 6)))
 (let ((?x82664 (gpt ?x102288)))
 (let (($x4115 (select ?x82664 gidx.2437400)))
 (or $x4115 $x4270 $x28385))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x3539) $x4151))))
(assert
 (let (($x4578 (forall ((gidx.2437476 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3878 (globals ?x102288)))
 (let ((?x4148 (g_granules ?x3878)))
 (let ((?x83275 (e_state_s_granule (select ?x4148 gidx.2437476))))
 (let (($x4270 (= ?x83275 6)))
 (let (($x28385 (= ?x83275 0)))
 (=> (not (select (gpt ?x102288) gidx.2437476)) (or $x28385 $x4270)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4578)))
(check-sat)

...
(assert
 ...
 (elem_0 ?x2617)))))))))))))))))))))))))))))))))
(assert
 (let (($x2856 (forall ((gidx.2434675 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3115 (globals ?x58573)))
 (let ((?x2961 (g_granules ?x3115)))
 (let ((?x3092 (e_state_s_granule (select ?x2961 gidx.2434675))))
 (let (($x66177 (= ?x3092 6)))
 (let (($x2831 (= ?x3092 0)))
 (=> (not (select (gpt ?x58573) gidx.2434675)) (or $x2831 $x66177)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2856)))
(check-sat)

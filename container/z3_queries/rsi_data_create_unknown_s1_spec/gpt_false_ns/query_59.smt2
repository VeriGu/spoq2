...
(assert
 ...
 (and $x6840 $x48206))))))))
(assert
 (let (($x39465 (forall ((gidx.2445371 Int) )(let ((?x6163 (test_Z_PTE.0_call v_0.2445125)))
 (let ((?x6287 (meta_PA ?x6163)))
 (let ((?x6457 (meta_granule_offset ?x6287)))
 ...
 (let ((?x6278 (e_state_s_granule (select ?x87720 gidx.2445371))))
 (let ((?x79923 (gpt ?x110901)))
 (let (($x6548 (select ?x79923 gidx.2445371)))
 (let (($x5697 (not $x6548)))
 (=> $x5697 (or (= ?x6278 0) (= ?x6278 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39465)))
(check-sat)

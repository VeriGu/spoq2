...
(declare-fun v_0.2453973 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2453973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!31 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2453973)))
                 4096)))
...
(let ((a!8 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!7)))
(let ((a!9 (g_heap (globals (share (value_RData a!8)))))
      (a!10 (g_debug_exits (globals (share (value_RData a!8)))))
      (a!11 (g_vmid_count (globals (share (value_RData a!8)))))
      (a!12 (g_vmid_lock (globals (share (value_RData a!8)))))
      (a!13 (g_vmids (globals (share (value_RData a!8)))))
      (a!14 (g_nr_lrs (globals (share (value_RData a!8)))))
      (a!15 (g_nr_aprs (globals (share (value_RData a!8)))))
      (a!16 (g_max_vintid (globals (share (value_RData a!8)))))
      (a!17 (g_pri_res0_mask (globals (share (value_RData a!8)))))
      (a!18 (g_default_gicstate (globals (share (value_RData a!8)))))
      (a!19 (g_status_handler (globals (share (value_RData a!8)))))
      (a!20 (g_rmm_trap_list (globals (share (value_RData a!8)))))
      (a!21 (g_tt_l3_buffer (globals (share (value_RData a!8)))))
      (a!22 (g_tt_l2_mem0_0 (globals (share (value_RData a!8)))))
      (a!23 (g_tt_l2_mem0_1 (globals (share (value_RData a!8)))))
      (a!24 (g_tt_l2_mem1_0 (globals (share (value_RData a!8)))))
      (a!25 (g_tt_l2_mem1_1 (globals (share (value_RData a!8)))))
      (a!26 (g_tt_l2_mem1_2 (globals (share (value_RData a!8)))))
      (a!27 (g_tt_l2_mem1_3 (globals (share (value_RData a!8)))))
      (a!28 (g_tt_l1_upper (globals (share (value_RData a!8)))))
      (a!29 (g_mbedtls_mem_buf (globals (share (value_RData a!8)))))
      (a!30 (g_granules (globals (share (value_RData a!8)))))
      (a!33 (g_rmm_attest_signing_key (globals (share (value_RData a!8)))))
      (a!34 (g_rmm_attest_public_key (globals (share (value_RData a!8)))))
      (a!35 (g_rmm_attest_public_key_len (globals (share (value_RData a!8)))))
      (a!36 (g_rmm_attest_public_key_hash (globals (share (value_RData a!8)))))
      (a!37 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!8)))))
      (a!38 (g_platform_token_buf (globals (share (value_RData a!8)))))
      (a!39 (g_rmm_platform_token (globals (share (value_RData a!8)))))
      (a!40 (g_get_realm_identity_identity (globals (share (value_RData a!8)))))
      (a!41 (g_realm_attest_private_key (globals (share (value_RData a!8))))))
(let ((a!32 (store a!30
                   a!31
                   (mks_granule (e_lock (select a!30 a!31))
                                1
                                (e_ref (select a!30 a!31))))))
(let ((a!42 (mkShared (gpt (share (value_RData a!8)))
                      (granule_data (share (value_RData a!8)))
                      (mkGLOBALS a!9
                                 a!10
                                 a!11
                                 a!12
                                 ...
                                 a!40
                                 a!41))))
(let ((a!43 (granule_unlock_spec.0_call
              a!1
  ...
  (repl (value_RData a!43)))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2453973)))))
      (a!2 (mkPtr "granules"
...
(let ((a!43 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!8))
                       ...
                       (stack (value_RData a!8))
                       (halt (value_RData a!8))))))
  (oracle (value_RData a!43)))))))))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (not $x5269))))))))))))))))))))))))))
(assert
 (forall ((gidx.2452874 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5675 (elem_0 ?x5113)))
 (let ((?x5433 (e_2 ?x5675)))
 (let ((?x141750 (granule_unlock_spec.0_call ?x5433 ?x5393)))
 (let ((?x5584 (value_RData ?x141750)))
 (let ((?x58737 (share ?x5584)))
 (let ((?x51230 (globals ?x58737)))
 (let ((?x41443 (g_granules ?x51230)))
 (let ((?x73695 (e_state_s_granule (select ?x41443 gidx.2452874))))
 (let (($x8346 (= ?x73695 6)))
 (let (($x4913 (= ?x73695 0)))
 (=> (not (select (gpt ?x58737) gidx.2452874)) (or $x4913 $x8346)))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2452909 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2452909))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x5584 (value_RData ?x141750)))
 (let ((?x58737 (share ?x5584)))
 (let ((?x90561 (gpt ?x58737)))
 (select ?x90561 ?x1047)))))))))))))))))))))))))))))))
 )
(assert
 (let (($x33890 (forall ((gidx.2453097 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5584 (value_RData ?x141750)))
 (let ((?x58737 (share ?x5584)))
 (let ((?x32856 (log ?x5584)))
 (let ((?x8971 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (granule_unlock_spec.0_call
                          (e_2 (elem_0 a!5))
                          (elem_1 a!5)))))
  (oracle a!6)))))))_call| ?x32856)))
 (let ((?x8467 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (granule_unlock_spec.0_call
                          (e_2 (elem_0 a!5))
                          (elem_1 a!5)))))
  (repl a!6)))))))_call| ?x8971 ?x58737)))
 (let ((?x8713 (value_Shared ?x8467)))
 (let ((?x7812 (globals ?x8713)))
 (let ((?x7605 (g_granules ?x7812)))
 (let ((?x42764 (e_state_s_granule (select ?x7605 gidx.2453097))))
 (let (($x90708 (= ?x42764 0)))
 (let (($x8450 (= ?x42764 6)))
 (let ((?x8328 (gpt ?x8713)))
 (let (($x8368 (select ?x8328 gidx.2453097)))
 (or $x8368 $x8450 $x90708))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x8290 (forall ((gidx.2453080 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x58737 (share ?x5584)))
 (let ((?x90561 (gpt ?x58737)))
 (let (($x8724 (select ?x90561 gidx.2453080)))
 (let ((?x73695 (e_state_s_granule (select (g_granules (globals ?x58737)) gidx.2453080))))
 (let (($x8346 (= ?x73695 6)))
 (let (($x4913 (= ?x73695 0)))
 (or $x4913 $x8346 $x8724))))))))))))))))))))))))))))))))))
 ))
 (or (not $x8290) $x33890))))
(assert
 ...
 (not $x28374)))))
(assert
 (forall ((gidx.2453938 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x141750 (granule_unlock_spec.0_call ?x5433 ?x5393)))
 (let ((?x5584 (value_RData ?x141750)))
 (let ((?x7759 (granule_unlock_spec.0_call ?x1244 ?x5584)))
 (let ((?x8557 (value_RData ?x7759)))
 (let ((?x67386 (share ?x8557)))
 (let ((?x51060 (globals ?x67386)))
 (let ((?x8884 (g_granules ?x51060)))
 (let ((?x8788 (e_state_s_granule (select ?x8884 gidx.2453938))))
 (let (($x51437 (= ?x8788 6)))
 (let (($x7796 (= ?x8788 0)))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2453938)))
 (let (($x98161 (not $x9125)))
 (=> $x98161 (or $x7796 $x51437))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2453973 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2453973))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x51832 (forall ((gidx.2454161 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x67386 (share ?x8557)))
 (let ((?x8408 (log ?x8557)))
 (let ((?x43158 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!6)))
  (oracle (value_RData a!7)))))))))_call| ?x8408)))
 (let ((?x8810 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (granule_unlock_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             a!6)))
  (repl (value_RData a!7)))))))))_call| ?x43158 ?x67386)))
 (let ((?x43297 (value_Shared ?x8810)))
 (let ((?x8762 (globals ?x43297)))
 (let ((?x9214 (g_granules ?x8762)))
 (let ((?x8555 (e_state_s_granule (select ?x9214 gidx.2454161))))
 (let (($x9208 (= ?x8555 6)))
 (let ((?x8787 (gpt ?x43297)))
 (let (($x9013 (select ?x8787 gidx.2454161)))
 (let (($x7758 (= ?x8555 0)))
 (or $x7758 $x9013 $x9208))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x9601 (forall ((gidx.2454144 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x51060 (globals ?x67386)))
 (let ((?x8884 (g_granules ?x51060)))
 (let ((?x8788 (e_state_s_granule (select ?x8884 gidx.2454144))))
 (let (($x51437 (= ?x8788 6)))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2454144)))
 (let (($x7796 (= ?x8788 0)))
 (or $x7796 $x9125 $x51437))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x9601) $x51832))))
(assert
 (let ((?x9687 (test_Z_PTE.0_call v_0.2453973)))
 (let ((?x58521 (meta_PA ?x9687)))
 (let ((?x9770 (meta_granule_offset ?x58521)))
 (let (($x8928 (>= ?x9770 0)))
 (let ((?x9187 (mod ?x9770 4096)))
 (let (($x9818 (= ?x9187 0)))
 (and $x9818 $x8928))))))))
(assert
 (forall ((gidx.2454274 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x7759 (granule_unlock_spec.0_call ?x1244 ?x5584)))
 (let ((?x8557 (value_RData ?x7759)))
 (let (($x8425 (halt ?x8557)))
 (let ((?x50511 (stack ?x8557)))
 (let ((?x67386 (share ?x8557)))
 (let ((?x51060 (globals ?x67386)))
 (let ((?x9002 (g_realm_attest_private_key ?x51060)))
 (let ((?x8256 (g_get_realm_identity_identity ?x51060)))
 (let ((?x51331 (g_rmm_platform_token ?x51060)))
 (let ((?x51083 (g_platform_token_buf ?x51060)))
 (let ((?x51215 (g_rmm_attest_public_key_hash_len ?x51060)))
 (let ((?x48386 (g_rmm_attest_public_key_hash ?x51060)))
 (let ((?x59287 (g_rmm_attest_public_key_len ?x51060)))
 (let ((?x42795 (g_rmm_attest_public_key ?x51060)))
 (let ((?x42866 (g_rmm_attest_signing_key ?x51060)))
 (let ((?x9687 (test_Z_PTE.0_call v_0.2453973)))
 (let ((?x58521 (meta_PA ?x9687)))
 (let ((?x9770 (meta_granule_offset ?x58521)))
 (let ((?x9926 (div ?x9770 4096)))
 (let ((?x8884 (g_granules ?x51060)))
 (let ((?x9268 (select ?x8884 ?x9926)))
 (let ((?x10001 (mks_granule (e_lock ?x9268) 1 (e_ref ?x9268))))
 (let ((?x9459 (store ?x8884 ?x9926 ?x10001)))
 (let ((?x43135 (g_mbedtls_mem_buf ?x51060)))
 (let ((?x50789 (g_tt_l1_upper ?x51060)))
 (let ((?x51382 (g_tt_l2_mem1_3 ?x51060)))
 (let ((?x50919 (g_tt_l2_mem1_2 ?x51060)))
 (let ((?x51251 (g_tt_l2_mem1_1 ?x51060)))
 (let ((?x90736 (g_tt_l2_mem1_0 ?x51060)))
 (let ((?x9370 (g_tt_l2_mem0_1 ?x51060)))
 (let ((?x8548 (g_tt_l2_mem0_0 ?x51060)))
 (let ((?x8783 (g_tt_l3_buffer ?x51060)))
 (let ((?x8716 (g_rmm_trap_list ?x51060)))
 (let ((?x8217 (g_status_handler ?x51060)))
 (let ((?x9171 (g_default_gicstate ?x51060)))
 (let ((?x9219 (g_pri_res0_mask ?x51060)))
 (let ((?x8734 (g_max_vintid ?x51060)))
 (let ((?x98367 (g_nr_aprs ?x51060)))
 (let ((?x42244 (g_nr_lrs ?x51060)))
 (let ((?x51293 (g_vmids ?x51060)))
 (let ((?x9280 (g_vmid_lock ?x51060)))
 (let ((?x9246 (g_vmid_count ?x51060)))
 (let ((?x9003 (g_debug_exits ?x51060)))
 (let ((?x98342 (g_heap ?x51060)))
 (let ((?x10070 (mkGLOBALS ?x98342 ?x9003 ?x9246 ?x9280 ?x51293 ?x42244 ?x98367 ?x8734 ?x9219 ?x9171 ?x8217 ?x8716 ?x8783 ?x8548 ?x9370 ?x90736 ?x51251 ?x50919 ?x51382 ?x50789 ?x43135 ?x9459 ?x42866 ?x42795 ?x59287 ?x48386 ?x51215 ?x51083 ?x51331 ?x8256 ?x9002)))
 (let ((?x7575 (granule_data ?x67386)))
 (let ((?x8940 (gpt ?x67386)))
 (let ((?x33165 (priv ?x8557)))
 (let ((?x8481 (repl ?x8557)))
 (let ((?x8722 (oracle ?x8557)))
 (let ((?x8408 (log ?x8557)))
 (let ((?x9894 (mkRData ?x8408 ?x8722 ?x8481 ?x33165 (mkShared ?x8940 ?x7575 ?x10070) ?x50511 $x8425)))
 (let ((?x76089 (mkPtr "granules" ?x9770)))
 (let ((?x9924 (granule_unlock_spec.0_call ?x76089 ?x9894)))
 (let ((?x51889 (value_RData ?x9924)))
 (let ((?x75986 (share ?x51889)))
 (let ((?x9418 (globals ?x75986)))
 (let ((?x9759 (g_granules ?x9418)))
 (let ((?x9891 (e_state_s_granule (select ?x9759 gidx.2454274))))
 (let (($x9973 (= ?x9891 6)))
 (let (($x9939 (= ?x9891 0)))
 (=> (not (select (gpt ?x75986) gidx.2454274)) (or $x9939 $x9973))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2454309 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2454309))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x51889 (value_RData ?x9924)))
 (let ((?x75986 (share ?x51889)))
 (let ((?x10060 (gpt ?x75986)))
 (select ?x10060 ?x1047))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x44275 (forall ((gidx.2454497 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x51889 (value_RData ?x9924)))
 (let ((?x75986 (share ?x51889)))
 (let ((?x9413 (log ?x51889)))
 (let ((?x51950 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2453973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!43 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!8))
                       ...
                       (stack (value_RData a!8))
                       (halt (value_RData a!8))))))
  (oracle (value_RData a!43)))))))))))))_call| ?x9413)))
 (let ((?x9991 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2453973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!43 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!8))
                       ...
                       (stack (value_RData a!8))
                       (halt (value_RData a!8))))))
  (repl (value_RData a!43)))))))))))))_call| ?x51950 ?x75986)))
 (let ((?x32543 (value_Shared ?x9991)))
 (let ((?x9724 (globals ?x32543)))
 (let ((?x9808 (g_granules ?x9724)))
 (let ((?x10052 (e_state_s_granule (select ?x9808 gidx.2454497))))
 (let (($x51818 (= ?x10052 6)))
 (let (($x43485 (= ?x10052 0)))
 (let ((?x8761 (gpt ?x32543)))
 (let (($x9299 (select ?x8761 gidx.2454497)))
 (or $x9299 $x43485 $x51818)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x10050 (forall ((gidx.2454480 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x75986 (share ?x51889)))
 (let ((?x10060 (gpt ?x75986)))
 (let (($x33893 (select ?x10060 gidx.2454480)))
 (let ((?x9891 (e_state_s_granule (select (g_granules (globals ?x75986)) gidx.2454480))))
 (let (($x9973 (= ?x9891 6)))
 (let (($x9939 (= ?x9891 0)))
 (or $x9939 $x9973 $x33893)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x10050) $x44275))))
(assert
 (let (($x39422 (forall ((gidx.2454556 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x9418 (globals ?x75986)))
 (let ((?x9759 (g_granules ?x9418)))
 (let ((?x9891 (e_state_s_granule (select ?x9759 gidx.2454556))))
 (let (($x9973 (= ?x9891 6)))
 (let (($x9939 (= ?x9891 0)))
 (=> (not (select (gpt ?x75986) gidx.2454556)) (or $x9939 $x9973))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39422)))
(check-sat)

...
(assert
 ...
 (= ?x26393 0))))
(assert
 (let (($x7869 (forall ((gidx.2449571 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x97336 (globals ?x113187)))
 (let ((?x89551 (g_granules ?x97336)))
 (let ((?x8485 (e_state_s_granule (select ?x89551 gidx.2449571))))
 (let (($x8657 (= ?x8485 6)))
 (let (($x8370 (= ?x8485 0)))
 (=> (not (select (gpt ?x113187) gidx.2449571)) (or $x8370 $x8657))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7869)))
(check-sat)

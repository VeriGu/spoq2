...
(assert
 ...
 (= ?x72746 8)))))))))))))))))))))
(assert
 (let (($x2094 (forall ((gidx.2431483 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1894 (globals ?x64866)))
 (let ((?x1896 (g_granules ?x1894)))
 (let ((?x1913 (e_state_s_granule (select ?x1896 gidx.2431483))))
 (let (($x1964 (= ?x1913 6)))
 (let (($x1970 (= ?x1913 0)))
 (=> (not (select (gpt ?x64866) gidx.2431483)) (or $x1970 $x1964)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2094)))
(check-sat)

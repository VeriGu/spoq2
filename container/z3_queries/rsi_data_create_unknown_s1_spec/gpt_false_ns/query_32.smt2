...
(assert
 ...
 (not $x28107)))))
(assert
 (let (($x3382 (forall ((gidx.2438259 Int) )(let ((?x4094 (test_Z_PTE.0_call v_0.2437621)))
 ...
 (let ((?x4095 (e_state_s_granule (select ?x83458 gidx.2438259))))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2438259)))
 (let (($x4368 (not $x4378)))
 (=> $x4368 (or (= ?x4095 0) (= ?x4095 6)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3382)))
(check-sat)

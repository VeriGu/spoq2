...
(assert
 (let (($x1565 (forall ((gidx.2430475 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1480 (globals ?x25258)))
 (let ((?x1492 (g_granules ?x1480)))
 (let ((?x1493 (e_state_s_granule (select ?x1492 gidx.2430475))))
 (let (($x1515 (= ?x1493 6)))
 (let (($x1516 (= ?x1493 0)))
 (=> (not (select (gpt ?x25258) gidx.2430475)) (or $x1516 $x1515))))))))))))))))))))))))
 ))
 (not $x1565)))
(check-sat)

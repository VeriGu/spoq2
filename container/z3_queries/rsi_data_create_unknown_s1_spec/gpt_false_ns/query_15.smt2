...
(declare-fun v_0.2430565 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430565)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(declare-fun v_0.2430901 () Int)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
...
(let ((a!9 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!8)))))
  (repl (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!9))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
      (a!2 (mkPtr "granule_data"
...
(let ((a!9 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!8)))))
  (oracle (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!9))))))))))_call| (List_Event) List_Event)
...
(let ((a!10 (granule_unlock_spec.0_call
              ...
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!4 0 4096 a!9))))))
...
(declare-fun v_0.2432973 () Int)
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2432973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!5 (mkPtr "granule_data"
                  (meta_granule_offset
      ...
      (a!6 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430565)))))
      (a!35 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2432973)))
                 4096)))
(let ((a!3 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!2 st.0)))))
...
(let ((a!11 (granule_unlock_spec.0_call
              (rec_to_rd_para.0_call
                ...
                (elem_1 (value_Tuple_abs_ret_rtt_RData a!4)))
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!5 0 4096 a!10))))))
(let ((a!12 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!4)))
              (value_RData a!11))))
(let ((a!13 (g_heap (globals (share (value_RData a!12)))))
      (a!14 (g_debug_exits (globals (share (value_RData a!12)))))
      (a!15 (g_vmid_count (globals (share (value_RData a!12)))))
      (a!16 (g_vmid_lock (globals (share (value_RData a!12)))))
      (a!17 (g_vmids (globals (share (value_RData a!12)))))
      (a!18 (g_nr_lrs (globals (share (value_RData a!12)))))
      (a!19 (g_nr_aprs (globals (share (value_RData a!12)))))
      (a!20 (g_max_vintid (globals (share (value_RData a!12)))))
      (a!21 (g_pri_res0_mask (globals (share (value_RData a!12)))))
      (a!22 (g_default_gicstate (globals (share (value_RData a!12)))))
      (a!23 (g_status_handler (globals (share (value_RData a!12)))))
      (a!24 (g_rmm_trap_list (globals (share (value_RData a!12)))))
      (a!25 (g_tt_l3_buffer (globals (share (value_RData a!12)))))
      (a!26 (g_tt_l2_mem0_0 (globals (share (value_RData a!12)))))
      (a!27 (g_tt_l2_mem0_1 (globals (share (value_RData a!12)))))
      (a!28 (g_tt_l2_mem1_0 (globals (share (value_RData a!12)))))
      (a!29 (g_tt_l2_mem1_1 (globals (share (value_RData a!12)))))
      (a!30 (g_tt_l2_mem1_2 (globals (share (value_RData a!12)))))
      (a!31 (g_tt_l2_mem1_3 (globals (share (value_RData a!12)))))
      (a!32 (g_tt_l1_upper (globals (share (value_RData a!12)))))
      (a!33 (g_mbedtls_mem_buf (globals (share (value_RData a!12)))))
      (a!34 (g_granules (globals (share (value_RData a!12)))))
      (a!37 (g_rmm_attest_signing_key (globals (share (value_RData a!12)))))
      (a!38 (g_rmm_attest_public_key (globals (share (value_RData a!12)))))
      (a!39 (g_rmm_attest_public_key_len (globals (share (value_RData a!12)))))
      (a!40 (g_rmm_attest_public_key_hash (globals (share (value_RData a!12)))))
      (a!41 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!12)))))
      (a!42 (g_platform_token_buf (globals (share (value_RData a!12)))))
      (a!43 (g_rmm_platform_token (globals (share (value_RData a!12)))))
      (a!44 (g_get_realm_identity_identity (globals (share (value_RData a!12)))))
      (a!45 (g_realm_attest_private_key (globals (share (value_RData a!12))))))
(let ((a!36 (store a!34
                   a!35
                   (mks_granule (e_lock (select a!34 a!35))
                                1
                                (e_ref (select a!34 a!35))))))
(let ((a!46 (mkShared (gpt (share (value_RData a!12)))
                      (granule_data (share (value_RData a!12)))
                      (mkGLOBALS a!13
                                 a!14
                                 a!15
                                 a!16
...
(let ((a!47 (granule_unlock_spec.0_call
              a!1
              (mkRData (log (value_RData a!12))
                       (oracle (value_RData a!12))
                       (repl (value_RData a!12))
                       (priv (value_RData a!12))
                       a!46
                       (stack (value_RData a!12))
                       (halt (value_RData a!12))))))
...
(assert
 ...
 (= ?x1629 2))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2430866 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2665 (test_Z_PTE.0_call v_0.2430565)))
 (let ((?x1574 (meta_PA ?x2665)))
 (let ((?x1734 (meta_granule_offset ?x1574)))
 (let ((?x1609 (mkPtr "granule_data" ?x1734)))
 (let ((?x1720 (memcpy_ns_read_spec.0_call ?x1609 ?x1721 4096 ?x33226)))
 (let ((?x1614 (value_Tuple_bool_RData ?x1720)))
 (let ((?x1705 (elem_1 ?x1614)))
 (let ((?x49238 (share ?x1705)))
 (let ((?x1777 (globals ?x49238)))
 (let ((?x1779 (g_granules ?x1777)))
 (let ((?x1800 (e_state_s_granule (select ?x1779 gidx.2430866))))
 (let (($x1843 (= ?x1800 6)))
 (let (($x1844 (= ?x1800 0)))
 (=> (not (select (gpt ?x49238) gidx.2430866)) (or $x1844 $x1843)))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2430901 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2430901))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x1705 (elem_1 ?x1614)))
 (let ((?x49238 (share ?x1705)))
 (let ((?x1775 (gpt ?x49238)))
 (select ?x1775 ?x1047)))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1789 (forall ((gidx.2431089 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x49238 (share ?x1705)))
 (let ((?x1749 (log ?x1705)))
 (let ((?x1746 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430565)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!8 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!7)))))
  (oracle a!8)))))))_call| ?x1749)))
 (let ((?x1748 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430565)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
...
(let ((a!8 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!7)))))
  (repl a!8)))))))_call| ?x1746 ?x49238)))
 (let ((?x1743 (value_Shared ?x1748)))
 (let ((?x33336 (globals ?x1743)))
 (let ((?x1825 (g_granules ?x33336)))
 (let ((?x33331 (e_state_s_granule (select ?x1825 gidx.2431089))))
 (let (($x33332 (= ?x33331 6)))
 (let ((?x33338 (gpt ?x1743)))
 (let (($x25607 (select ?x33338 gidx.2431089)))
 (let (($x17701 (= ?x33331 0)))
 (or $x17701 $x25607 $x33332))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x25602 (forall ((gidx.2431072 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1777 (globals ?x49238)))
 (let ((?x1779 (g_granules ?x1777)))
 (let ((?x1800 (e_state_s_granule (select ?x1779 gidx.2431072))))
 (let (($x1844 (= ?x1800 0)))
 (let (($x1843 (= ?x1800 6)))
 (let ((?x1775 (gpt ?x49238)))
 (let (($x1835 (select ?x1775 gidx.2431072)))
 (or $x1835 $x1843 $x1844))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x25602) $x1789))))
(assert
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 ...
 (let ((?x1720 (memcpy_ns_read_spec.0_call ?x1609 ?x1721 4096 ?x33226)))
 (let ((?x1614 (value_Tuple_bool_RData ?x1720)))
 (let (($x4549 (elem_0 ?x1614)))
 (not $x4549))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2432266 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1614 (value_Tuple_bool_RData ?x1720)))
 (let ((?x1705 (elem_1 ?x1614)))
 (let ((?x2670 (test_Z_PTE.0_call v_0.2430901)))
 (let ((?x1820 (meta_PA ?x2670)))
 (let ((?x1831 (meta_granule_offset ?x1820)))
 (let ((?x92940 (mkPtr "granule_data" ?x1831)))
 (let ((?x1767 (memset_spec.0_call ?x92940 0 4096 ?x1705)))
 (let ((?x2083 (value_Tuple_Ptr_RData ?x1767)))
 (let ((?x2249 (elem_1 ?x2083)))
 (let ((?x65503 (share ?x2249)))
 (let ((?x1763 (globals ?x65503)))
 (let ((?x2593 (g_granules ?x1763)))
 (let ((?x2334 (e_state_s_granule (select ?x2593 gidx.2432266))))
 (let (($x2223 (= ?x2334 6)))
 (let (($x33775 (= ?x2334 0)))
 (=> (not (select (gpt ?x65503) gidx.2432266)) (or $x33775 $x2223))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2432301 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2432301))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x2249 (elem_1 ?x2083)))
 (let ((?x65503 (share ?x2249)))
 (let ((?x2446 (gpt ?x65503)))
 (select ?x2446 ?x1047))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x33820 (forall ((gidx.2432489 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x65503 (share ?x2249)))
 (let ((?x2314 (log ?x2249)))
 (let ((?x2217 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
      (a!2 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!9 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!8)))))
  (oracle (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!9))))))))))_call| ?x2314)))
 (let ((?x2143 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
      (a!2 (mkPtr "granule_data"
                  (meta_granule_offset
...
(let ((a!9 (elem_1 (value_Tuple_bool_RData
                     (memcpy_ns_read_spec.0_call
                       ...
                       4096
                       a!8)))))
  (repl (elem_1 (value_Tuple_Ptr_RData (memset_spec.0_call a!1 0 4096 a!9))))))))))_call| ?x2217 ?x65503)))
 (let ((?x2397 (value_Shared ?x2143)))
 (let ((?x2616 (globals ?x2397)))
 (let ((?x2479 (g_granules ?x2616)))
 (let ((?x767 (e_state_s_granule (select ?x2479 gidx.2432489))))
 (let (($x2460 (= ?x767 6)))
 (let (($x2443 (= ?x767 0)))
 (let ((?x2431 (gpt ?x2397)))
 (let (($x1404 (select ?x2431 gidx.2432489)))
 (or $x1404 $x2443 $x2460)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1966 (forall ((gidx.2432472 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1763 (globals ?x65503)))
 (let ((?x2593 (g_granules ?x1763)))
 (let ((?x2334 (e_state_s_granule (select ?x2593 gidx.2432472))))
 (let (($x33775 (= ?x2334 0)))
 (let ((?x2446 (gpt ?x65503)))
 (let (($x2689 (select ?x2446 gidx.2432472)))
 (let (($x2223 (= ?x2334 6)))
 (or $x2223 $x2689 $x33775)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x1966) $x33820))))
(assert
 (forall ((gidx.2432602 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2083 (value_Tuple_Ptr_RData ?x1767)))
 (let ((?x2249 (elem_1 ?x2083)))
 (let ((?x2411 (granule_unlock_spec.0_call ?x1709 ?x2249)))
 (let ((?x2458 (value_RData ?x2411)))
 (let ((?x81145 (share ?x2458)))
 (let ((?x2407 (globals ?x81145)))
 (let ((?x2352 (g_granules ?x2407)))
 (let ((?x2403 (e_state_s_granule (select ?x2352 gidx.2432602))))
 (let (($x1863 (= ?x2403 6)))
 (let (($x34307 (= ?x2403 0)))
 (=> (not (select (gpt ?x81145) gidx.2432602)) (or $x34307 $x1863))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2432637 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2432637))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x2458 (value_RData ?x2411)))
 (let ((?x81145 (share ?x2458)))
 (let ((?x2034 (gpt ?x81145)))
 (select ?x2034 ?x1047))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x26481 (forall ((gidx.2432825 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2458 (value_RData ?x2411)))
 (let ((?x81145 (share ?x2458)))
 (let ((?x49985 (log ?x2458)))
 (let ((?x42183 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!4 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
...
(let ((a!10 (granule_unlock_spec.0_call
              ...
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!4 0 4096 a!9))))))
  (oracle (value_RData a!10)))))))))_call| ?x49985)))
 (let ((?x34196 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!4 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
...
(let ((a!10 (granule_unlock_spec.0_call
              ...
              (elem_1 (value_Tuple_Ptr_RData
                        (memset_spec.0_call a!4 0 4096 a!9))))))
  (repl (value_RData a!10)))))))))_call| ?x42183 ?x81145)))
 (let ((?x42179 (value_Shared ?x34196)))
 (let ((?x2309 (gpt ?x42179)))
 (let (($x2594 (select ?x2309 gidx.2432825)))
 (let ((?x26027 (e_state_s_granule (select (g_granules (globals ?x42179)) gidx.2432825))))
 (let (($x2517 (= ?x26027 0)))
 (let (($x2011 (= ?x26027 6)))
 (or $x2011 $x2517 $x2594)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2509 (forall ((gidx.2432808 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2407 (globals ?x81145)))
 (let ((?x2352 (g_granules ?x2407)))
 (let ((?x2403 (e_state_s_granule (select ?x2352 gidx.2432808))))
 (let (($x34307 (= ?x2403 0)))
 (let ((?x2034 (gpt ?x81145)))
 (let (($x34193 (select ?x2034 gidx.2432808)))
 (let (($x1863 (= ?x2403 6)))
 (or $x1863 $x34193 $x34307)))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2509) $x26481))))
(assert
 (forall ((gidx.2432938 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x1427 (elem_0 ?x1426)))
 (let ((?x1380 (e_2 ?x1427)))
 (let ((?x42156 (granule_unlock_spec.0_call ?x1380 ?x2458)))
 (let ((?x34207 (value_RData ?x42156)))
 (let ((?x89056 (share ?x34207)))
 (let ((?x26504 (globals ?x89056)))
 (let ((?x18538 (g_granules ?x26504)))
 (let ((?x2761 (e_state_s_granule (select ?x18538 gidx.2432938))))
 (let (($x2764 (= ?x2761 6)))
 (let (($x2633 (= ?x2761 0)))
 (let ((?x26520 (gpt ?x89056)))
 (let (($x2447 (select ?x26520 gidx.2432938)))
 (let (($x1282 (not $x2447)))
 (=> $x1282 (or $x2633 $x2764)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2432973 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2432973))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
...
(assert
 (let (($x2783 (forall ((gidx.2433161 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x34207 (value_RData ?x42156)))
 (let ((?x89056 (share ?x34207)))
 (let ((?x73346 (log ?x34207)))
 (let ((?x34440 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!4 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
...
(let ((a!11 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              (value_RData a!10))))
  (oracle (value_RData a!11))))))))))_call| ?x73346)))
 (let ((?x34361 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
      (a!4 (mkPtr "granule_data"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2430901)))))
...
(let ((a!11 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              (value_RData a!10))))
  (repl (value_RData a!11))))))))))_call| ?x34440 ?x89056)))
 (let ((?x26509 (value_Shared ?x34361)))
 (let ((?x2638 (globals ?x26509)))
 (let ((?x34194 (g_granules ?x2638)))
 (let ((?x3621 (e_state_s_granule (select ?x34194 gidx.2433161))))
 (let (($x73349 (= ?x3621 0)))
 (let ((?x2636 (gpt ?x26509)))
 (let (($x2712 (select ?x2636 gidx.2433161)))
 (let (($x2704 (= ?x3621 6)))
 (or $x2704 $x2712 $x73349)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x26472 (forall ((gidx.2433144 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x26504 (globals ?x89056)))
 (let ((?x18538 (g_granules ?x26504)))
 (let ((?x2761 (e_state_s_granule (select ?x18538 gidx.2433144))))
 (let (($x2764 (= ?x2761 6)))
 (let (($x2633 (= ?x2761 0)))
 (let ((?x26520 (gpt ?x89056)))
 (let (($x2447 (select ?x26520 gidx.2433144)))
 (or $x2447 $x2633 $x2764)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x26472) $x2783))))
(assert
 ...
 (not $x2640)))))
(assert
 (forall ((gidx.2433666 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x42156 (granule_unlock_spec.0_call ?x1380 ?x2458)))
 (let ((?x34207 (value_RData ?x42156)))
 (let (($x1771 (halt ?x34207)))
 (let ((?x2556 (stack ?x34207)))
 (let ((?x89056 (share ?x34207)))
 (let ((?x26504 (globals ?x89056)))
 (let ((?x2598 (g_realm_attest_private_key ?x26504)))
 (let ((?x2139 (g_get_realm_identity_identity ?x26504)))
 (let ((?x1993 (g_rmm_platform_token ?x26504)))
 (let ((?x2558 (g_platform_token_buf ?x26504)))
 (let ((?x2549 (g_rmm_attest_public_key_hash_len ?x26504)))
 (let ((?x2418 (g_rmm_attest_public_key_hash ?x26504)))
 (let ((?x2461 (g_rmm_attest_public_key_len ?x26504)))
 (let ((?x1284 (g_rmm_attest_public_key ?x26504)))
 (let ((?x2523 (g_rmm_attest_signing_key ?x26504)))
 (let ((?x2620 (test_Z_PTE.0_call v_0.2432973)))
 (let ((?x2548 (meta_PA ?x2620)))
 (let ((?x2706 (meta_granule_offset ?x2548)))
 (let ((?x2647 (div ?x2706 4096)))
 (let ((?x18538 (g_granules ?x26504)))
 (let ((?x10555 (select ?x18538 ?x2647)))
 (let ((?x2637 (e_ref ?x10555)))
 (let ((?x25986 (e_lock ?x10555)))
 (let ((?x109104 (mks_granule ?x25986 1 ?x2637)))
 (let ((?x65957 (store ?x18538 ?x2647 ?x109104)))
 (let ((?x2468 (g_mbedtls_mem_buf ?x26504)))
 (let ((?x2814 (g_tt_l1_upper ?x26504)))
 (let ((?x2820 (g_tt_l2_mem1_3 ?x26504)))
 (let ((?x2531 (g_tt_l2_mem1_2 ?x26504)))
 (let ((?x2815 (g_tt_l2_mem1_1 ?x26504)))
 (let ((?x2776 (g_tt_l2_mem1_0 ?x26504)))
 (let ((?x2731 (g_tt_l2_mem0_1 ?x26504)))
 (let ((?x2653 (g_tt_l2_mem0_0 ?x26504)))
 (let ((?x2588 (g_tt_l3_buffer ?x26504)))
 (let ((?x2750 (g_rmm_trap_list ?x26504)))
 (let ((?x2542 (g_status_handler ?x26504)))
 (let ((?x4103 (g_default_gicstate ?x26504)))
 (let ((?x2763 (g_pri_res0_mask ?x26504)))
 (let ((?x2703 (g_max_vintid ?x26504)))
 (let ((?x2732 (g_nr_aprs ?x26504)))
 (let ((?x2729 (g_nr_lrs ?x26504)))
 (let ((?x2722 (g_vmids ?x26504)))
 (let ((?x2645 (g_vmid_lock ?x26504)))
 (let ((?x2671 (g_vmid_count ?x26504)))
 (let ((?x2521 (g_debug_exits ?x26504)))
 (let ((?x2663 (g_heap ?x26504)))
 (let ((?x50514 (mkGLOBALS ?x2663 ?x2521 ?x2671 ?x2645 ?x2722 ?x2729 ?x2732 ?x2703 ?x2763 ?x4103 ?x2542 ?x2750 ?x2588 ?x2653 ?x2731 ?x2776 ?x2815 ?x2531 ?x2820 ?x2814 ?x2468 ?x65957 ?x2523 ?x1284 ?x2461 ?x2418 ?x2549 ?x2558 ?x1993 ?x2139 ?x2598)))
 (let ((?x26345 (granule_data ?x89056)))
 (let ((?x26520 (gpt ?x89056)))
 (let ((?x2708 (priv ?x34207)))
 (let ((?x34360 (repl ?x34207)))
 (let ((?x34438 (oracle ?x34207)))
 (let ((?x73346 (log ?x34207)))
 (let ((?x42717 (mkRData ?x73346 ?x34438 ?x34360 ?x2708 (mkShared ?x26520 ?x26345 ?x50514) ?x2556 $x1771)))
 (let ((?x2546 (mkPtr "granules" ?x2706)))
 (let ((?x42716 (granule_unlock_spec.0_call ?x2546 ?x42717)))
 (let ((?x34666 (value_RData ?x42716)))
 (let ((?x92936 (share ?x34666)))
 (let ((?x2829 (globals ?x92936)))
 (let ((?x2757 (g_granules ?x2829)))
 (let ((?x66197 (e_state_s_granule (select ?x2757 gidx.2433666))))
 (let (($x3153 (= ?x66197 6)))
 (let (($x3118 (= ?x66197 0)))
 (=> (not (select (gpt ?x92936) gidx.2433666)) (or $x3118 $x3153)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2433701 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2433701))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x34666 (value_RData ?x42716)))
 (let ((?x92936 (share ?x34666)))
 (let ((?x2825 (gpt ?x92936)))
 (select ?x2825 ?x1047)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2705 (forall ((gidx.2433889 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x34666 (value_RData ?x42716)))
 (let ((?x92936 (share ?x34666)))
 (let ((?x3091 (log ?x34666)))
 (let ((?x73503 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2432973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!47 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!12))
                       ...
                       (stack (value_RData a!12))
                       (halt (value_RData a!12))))))
  (oracle (value_RData a!47))))))))))))))_call| ?x3091)))
 (let ((?x3087 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2432973)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!47 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!12))
                       ...
                       (stack (value_RData a!12))
                       (halt (value_RData a!12))))))
  (repl (value_RData a!47))))))))))))))_call| ?x73503 ?x92936)))
 (let ((?x2980 (value_Shared ?x3087)))
 (let ((?x3014 (globals ?x2980)))
 (let ((?x65747 (g_granules ?x3014)))
 (let ((?x3182 (e_state_s_granule (select ?x65747 gidx.2433889))))
 (let (($x3058 (= ?x3182 6)))
 (let (($x2941 (= ?x3182 0)))
 (let ((?x3125 (gpt ?x2980)))
 (let (($x2816 (select ?x3125 gidx.2433889)))
 (or $x2816 $x2941 $x3058))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2339 (forall ((gidx.2433872 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x92936 (share ?x34666)))
 (let ((?x2825 (gpt ?x92936)))
 (let (($x3623 (select ?x2825 gidx.2433872)))
 (let ((?x66197 (e_state_s_granule (select (g_granules (globals ?x92936)) gidx.2433872))))
 (let (($x3153 (= ?x66197 6)))
 (let (($x3118 (= ?x66197 0)))
 (or $x3118 $x3153 $x3623))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2339) $x2705))))
(assert
 (let (($x3049 (forall ((gidx.2433948 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2829 (globals ?x92936)))
 (let ((?x2757 (g_granules ?x2829)))
 (let ((?x66197 (e_state_s_granule (select ?x2757 gidx.2433948))))
 (let (($x3153 (= ?x66197 6)))
 (let (($x3118 (= ?x66197 0)))
 (=> (not (select (gpt ?x92936) gidx.2433948)) (or $x3118 $x3153)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3049)))
(check-sat)

...
(assert
 ...
 (= ?x43747 0))))
(assert
 (let (($x28247 (forall ((gidx.2438987 Int) )(let ((?x3650 (test_Z_PTE.0_call v_0.2438741)))
 ...
 (let ((?x4790 (e_state_s_granule (select ?x44447 gidx.2438987))))
 (let ((?x4276 (gpt ?x44604)))
 (let (($x4378 (select ?x4276 gidx.2438987)))
 (let (($x4368 (not $x4378)))
 (=> $x4368 (or (= ?x4790 0) (= ?x4790 6)))))))))))))))))))))))))))))))))))))
 ))
 (not $x28247)))
(check-sat)

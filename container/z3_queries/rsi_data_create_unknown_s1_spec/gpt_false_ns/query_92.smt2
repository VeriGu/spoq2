...
(assert
 ...
 (and $x9818 $x8928))))))))
(assert
 (let (($x9218 (forall ((gidx.2454219 Int) )(let ((?x9687 (test_Z_PTE.0_call v_0.2453973)))
 (let ((?x58521 (meta_PA ?x9687)))
 (let ((?x9770 (meta_granule_offset ?x58521)))
 ...
 (let ((?x9242 (e_state_s_granule (select ?x9459 gidx.2454219))))
 (let ((?x8940 (gpt ?x67386)))
 (let (($x9125 (select ?x8940 gidx.2454219)))
 (let (($x98161 (not $x9125)))
 (=> $x98161 (or (= ?x9242 0) (= ?x9242 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9218)))
(check-sat)

...
(let ((a!10 (value_Tuple_Ptr_RData
 ...
 (or (not $x7487) $x73502))))
(assert
 (let (($x3987 (forall ((gidx.2436075 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2459 (globals ?x75078)))
 (let ((?x3619 (g_granules ?x2459)))
 (let ((?x3397 (e_state_s_granule (select ?x3619 gidx.2436075))))
 (let (($x3473 (= ?x3397 6)))
 (let (($x3445 (= ?x3397 0)))
 (=> (not (select (gpt ?x75078) gidx.2436075)) (or $x3445 $x3473))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3987)))
(check-sat)

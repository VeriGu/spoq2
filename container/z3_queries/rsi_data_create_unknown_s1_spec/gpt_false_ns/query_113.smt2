...
(assert
 (let (($x10727 (forall ((gidx.2460155 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12324 (globals ?x79259)))
 (let ((?x62523 (g_granules ?x12324)))
 (let ((?x11984 (e_state_s_granule (select ?x62523 gidx.2460155))))
 (let (($x11040 (= ?x11984 6)))
 (let (($x102354 (= ?x11984 0)))
 (=> (not (select (gpt ?x79259) gidx.2460155)) (or $x102354 $x11040)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10727)))
(check-sat)

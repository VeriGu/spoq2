...
(assert
 ...
 (not $x28107)))))
(assert
 (forall ((gidx.2438314 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x118732 (granule_unlock_spec.0_call ?x1380 ?x1423)))
 (let ((?x1634 (value_RData ?x118732)))
 (let (($x36466 (halt ?x1634)))
 (let ((?x36056 (stack ?x1634)))
 (let ((?x44604 (share ?x1634)))
 (let ((?x3847 (globals ?x44604)))
 (let ((?x4522 (g_realm_attest_private_key ?x3847)))
 (let ((?x28525 (g_get_realm_identity_identity ?x3847)))
 (let ((?x3249 (g_rmm_platform_token ?x3847)))
 (let ((?x20230 (g_platform_token_buf ?x3847)))
 (let ((?x4485 (g_rmm_attest_public_key_hash_len ?x3847)))
 (let ((?x82866 (g_rmm_attest_public_key_hash ?x3847)))
 (let ((?x36578 (g_rmm_attest_public_key_len ?x3847)))
 (let ((?x3248 (g_rmm_attest_public_key ?x3847)))
 (let ((?x43439 (g_rmm_attest_signing_key ?x3847)))
 ...
 (let ((?x4155 (e_ref ?x4182)))
 (let ((?x3448 (e_lock ?x4182)))
 (let ((?x64345 (mks_granule ?x3448 1 ?x4155)))
 (let ((?x83458 (store ?x43345 ?x28490 ?x64345)))
 (let ((?x36279 (g_mbedtls_mem_buf ?x3847)))
 (let ((?x3557 (g_tt_l1_upper ?x3847)))
 (let ((?x4050 (g_tt_l2_mem1_3 ?x3847)))
 (let ((?x4301 (g_tt_l2_mem1_2 ?x3847)))
 (let ((?x4193 (g_tt_l2_mem1_1 ?x3847)))
 (let ((?x3947 (g_tt_l2_mem1_0 ?x3847)))
 (let ((?x4620 (g_tt_l2_mem0_1 ?x3847)))
 (let ((?x4293 (g_tt_l2_mem0_0 ?x3847)))
 (let ((?x3865 (g_tt_l3_buffer ?x3847)))
 (let ((?x3855 (g_rmm_trap_list ?x3847)))
 (let ((?x35720 (g_status_handler ?x3847)))
 (let ((?x4113 (g_default_gicstate ?x3847)))
 (let ((?x4470 (g_pri_res0_mask ?x3847)))
 (let ((?x3884 (g_max_vintid ?x3847)))
 (let ((?x4405 (g_nr_aprs ?x3847)))
 (let ((?x28533 (g_nr_lrs ?x3847)))
 (let ((?x4418 (g_vmids ?x3847)))
 (let ((?x4508 (g_vmid_lock ?x3847)))
 (let ((?x27629 (g_vmid_count ?x3847)))
 (let ((?x44381 (g_debug_exits ?x3847)))
 (let ((?x3805 (g_heap ?x3847)))
 (let ((?x83470 (mkGLOBALS ?x3805 ?x44381 ?x27629 ?x4508 ?x4418 ?x28533 ?x4405 ?x3884 ?x4470 ?x4113 ?x35720 ?x3855 ?x3865 ?x4293 ?x4620 ?x3947 ?x4193 ?x4301 ?x4050 ?x3557 ?x36279 ?x83458 ?x43439 ?x3248 ?x36578 ?x82866 ?x4485 ?x20230 ?x3249 ?x28525 ?x4522)))
 (let ((?x4390 (granule_data ?x44604)))
 (let ((?x4276 (gpt ?x44604)))
 (let ((?x3997 (priv ?x1634)))
 (let ((?x27608 (repl ?x1634)))
 (let ((?x3246 (oracle ?x1634)))
 (let ((?x4258 (log ?x1634)))
 (let ((?x75915 (mkRData ?x4258 ?x3246 ?x27608 ?x3997 (mkShared ?x4276 ?x4390 ?x83470) ?x36056 $x36466)))
 (let ((?x4137 (mkPtr "granules" ?x4366)))
 (let ((?x75267 (granule_unlock_spec.0_call ?x4137 ?x75915)))
 (let ((?x60168 (value_RData ?x75267)))
 (let ((?x118716 (share ?x60168)))
 (let ((?x4628 (globals ?x118716)))
 (let ((?x4691 (g_granules ?x4628)))
 (let ((?x4712 (e_state_s_granule (select ?x4691 gidx.2438314))))
 (let (($x4592 (= ?x4712 6)))
 (let (($x4715 (= ?x4712 0)))
 (=> (not (select (gpt ?x118716) gidx.2438314)) (or $x4715 $x4592)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.2438349 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2438349))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x60168 (value_RData ?x75267)))
 (let ((?x118716 (share ?x60168)))
 (let ((?x36636 (gpt ?x118716)))
 (select ?x36636 ?x1047)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x3869 (forall ((gidx.2438537 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x60168 (value_RData ?x75267)))
 (let ((?x118716 (share ?x60168)))
 (let ((?x4084 (log ?x60168)))
 (let ((?x2278 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2437621)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!40 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!5))
                       ...
                       (stack (value_RData a!5))
                       (halt (value_RData a!5))))))
  (oracle (value_RData a!40))))))))))_call| ?x4084)))
 (let ((?x4389 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2437621)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777)))))
...
(let ((a!40 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!5))
                       ...
                       (stack (value_RData a!5))
                       (halt (value_RData a!5))))))
  (repl (value_RData a!40))))))))))_call| ?x2278 ?x118716)))
 (let ((?x3888 (value_Shared ?x4389)))
 (let ((?x4290 (globals ?x3888)))
 (let ((?x4567 (g_granules ?x4290)))
 (let ((?x4643 (e_state_s_granule (select ?x4567 gidx.2438537))))
 (let (($x36082 (= ?x4643 6)))
 (let (($x35922 (= ?x4643 0)))
 (let ((?x4683 (gpt ?x3888)))
 (let (($x28254 (select ?x4683 gidx.2438537)))
 (or $x28254 $x35922 $x36082))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x75781 (forall ((gidx.2438520 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x4628 (globals ?x118716)))
 (let ((?x4691 (g_granules ?x4628)))
 (let ((?x4712 (e_state_s_granule (select ?x4691 gidx.2438520))))
 (let (($x4715 (= ?x4712 0)))
 (let ((?x36636 (gpt ?x118716)))
 (let (($x4714 (select ?x36636 gidx.2438520)))
 (let (($x4592 (= ?x4712 6)))
 (or $x4592 $x4714 $x4715))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x75781) $x3869))))
(assert
 (let (($x4179 (forall ((gidx.2438596 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x4628 (globals ?x118716)))
 (let ((?x4691 (g_granules ?x4628)))
 (let ((?x4712 (e_state_s_granule (select ?x4691 gidx.2438596))))
 (let (($x4592 (= ?x4712 6)))
 (let (($x4715 (= ?x4712 0)))
 (=> (not (select (gpt ?x118716) gidx.2438596)) (or $x4715 $x4592)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4179)))
(check-sat)

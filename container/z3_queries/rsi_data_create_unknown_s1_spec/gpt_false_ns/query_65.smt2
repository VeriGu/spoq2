...
(let ((a!8 (value_RData (spinlock_release_spec.0_call
 ...
 (or (not $x6886) $x6991))))
(assert
 (let (($x7678 (forall ((gidx.2446827 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x7223 (globals ?x64410)))
 (let ((?x7090 (g_granules ?x7223)))
 (let ((?x7176 (e_state_s_granule (select ?x7090 gidx.2446827))))
 (let (($x7429 (= ?x7176 6)))
 (let (($x49061 (= ?x7176 0)))
 (=> (not (select (gpt ?x64410) gidx.2446827)) (or $x49061 $x7429)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7678)))
(check-sat)

...
(assert
 ...
 (= ?x5778 2))))))))))))))))))))))))))))))))))))
(assert
 (let (($x5688 (forall ((gidx.2442291 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x5646 (globals ?x54883)))
 (let ((?x5851 (g_granules ?x5646)))
 (let ((?x4403 (e_state_s_granule (select ?x5851 gidx.2442291))))
 (let (($x5580 (= ?x4403 6)))
 (let (($x5562 (= ?x4403 0)))
 (=> (not (select (gpt ?x54883) gidx.2442291)) (or $x5562 $x5580)))))))))))))))))))))))))))))))))))))
 ))
 (not $x5688)))
(check-sat)

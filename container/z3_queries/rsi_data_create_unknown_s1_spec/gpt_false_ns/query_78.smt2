...
(assert
 ...
 (and $x8775 $x8896))))))))
(assert
 (let (($x51152 (forall ((gidx.2450635 Int) )(let ((?x8430 (test_Z_PTE.0_call v_0.2450389)))
 (let ((?x8620 (meta_PA ?x8430)))
 (let ((?x8423 (meta_granule_offset ?x8620)))
 ...
 (let ((?x8171 (e_state_s_granule (select ?x7967 gidx.2450635))))
 (let ((?x50757 (gpt ?x121039)))
 (let (($x8607 (select ?x50757 gidx.2450635)))
 (let (($x8308 (not $x8607)))
 (=> $x8308 (or (= ?x8171 0) (= ?x8171 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x51152)))
(check-sat)

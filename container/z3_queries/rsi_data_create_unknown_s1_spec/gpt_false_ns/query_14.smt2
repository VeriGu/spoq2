...
(assert
 ...
 (not $x2640)))))
(assert
 (let (($x2993 (forall ((gidx.2433611 Int) )(let ((?x2620 (test_Z_PTE.0_call v_0.2432973)))
 ...
 (let ((?x2116 (e_state_s_granule (select ?x65957 gidx.2433611))))
 (let ((?x26520 (gpt ?x89056)))
 (let (($x2447 (select ?x26520 gidx.2433611)))
 (let (($x1282 (not $x2447)))
 (=> $x1282 (or (= ?x2116 0) (= ?x2116 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2993)))
(check-sat)

...
(assert
 ...
 (= ?x100619 8)))))))
(assert
 (let (($x34499 (forall ((gidx.2456291 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x10630 (globals ?x92758)))
 (let ((?x10199 (g_granules ?x10630)))
 (let ((?x10886 (e_state_s_granule (select ?x10199 gidx.2456291))))
 (let (($x9571 (= ?x10886 6)))
 (let (($x10300 (= ?x10886 0)))
 (=> (not (select (gpt ?x92758) gidx.2456291)) (or $x10300 $x9571)))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x34499)))
(check-sat)

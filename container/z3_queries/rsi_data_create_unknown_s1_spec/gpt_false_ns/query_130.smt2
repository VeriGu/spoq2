...
(assert
 ...
 (and $x65110 $x65262))))))))
(assert
 (let (($x12690 (forall ((gidx.2465027 Int) )(let ((?x88851 (test_Z_PTE.0_call v_0.2464781)))
 (let ((?x13743 (meta_PA ?x88851)))
 (let ((?x13289 (meta_granule_offset ?x13743)))
 ...
 (let ((?x57049 (e_state_s_granule (select ?x11678 gidx.2465027))))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2465027)))
 (let (($x62406 (not $x13479)))
 (=> $x62406 (or (= ?x57049 0) (= ?x57049 6))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12690)))
(check-sat)

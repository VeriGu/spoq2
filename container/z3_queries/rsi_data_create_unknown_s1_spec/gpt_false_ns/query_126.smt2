...
(assert
 ...
 (and $x12201 $x13626))))))))
(assert
 (let (($x43221 (forall ((gidx.2463963 Int) )(let ((?x12871 (test_Z_PTE.0_call v_0.2463717)))
 (let ((?x104303 (meta_PA ?x12871)))
 (let ((?x13907 (meta_granule_offset ?x104303)))
 ...
 (let ((?x12256 (e_state_s_granule (select ?x13965 gidx.2463963))))
 (let ((?x13273 (gpt ?x134703)))
 (let (($x9497 (select ?x13273 gidx.2463963)))
 (let (($x13122 (not $x9497)))
 (=> $x13122 (or (= ?x12256 0) (= ?x12256 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43221)))
(check-sat)

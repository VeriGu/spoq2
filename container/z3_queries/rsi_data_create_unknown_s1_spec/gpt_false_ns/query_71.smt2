...
(assert
 ...
 (not $x7062))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x40851 (forall ((gidx.2448563 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x6833 (globals ?x72957)))
 (let ((?x6624 (g_granules ?x6833)))
 (let ((?x6737 (e_state_s_granule (select ?x6624 gidx.2448563))))
 (let (($x6366 (= ?x6737 6)))
 (let (($x6377 (= ?x6737 0)))
 (=> (not (select (gpt ?x72957) gidx.2448563)) (or $x6377 $x6366)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x40851)))
(check-sat)

...
(assert
 ...
 (and $x14183 $x13632))))))))
(assert
 (let (($x13610 (forall ((gidx.2466819 Int) )(let ((?x65225 (test_Z_PTE.0_call v_0.2466573)))
 (let ((?x66322 (meta_PA ?x65225)))
 (let ((?x38297 (meta_granule_offset ?x66322)))
 ...
 (let ((?x5123 (e_state_s_granule (select ?x14295 gidx.2466819))))
 (let ((?x13266 (gpt ?x81795)))
 (let (($x13479 (select ?x13266 gidx.2466819)))
 (let (($x62406 (not $x13479)))
 (=> $x62406 (or (= ?x5123 0) (= ?x5123 6))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x13610)))
(check-sat)

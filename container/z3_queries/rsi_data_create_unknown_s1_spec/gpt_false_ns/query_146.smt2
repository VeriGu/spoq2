...
(declare-fun |(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2440701)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!3 (value_RData (spinlock_release_spec.0_call
                          a!1
...
(assert
 ...
 (not $x2576))))))))))))))))))
(assert
 (forall ((gidx.2468722 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x4895 (meta_PA ?x5251)))
 (let ((?x5084 (meta_granule_offset ?x4895)))
 (let ((?x56978 (mkPtr "granules" ?x5084)))
 (let ((?x14298 (spinlock_release_spec.0_call ?x56978 ?x1125)))
 (let ((?x14649 (value_RData ?x14298)))
 (let ((?x31270 (share ?x14649)))
 (let ((?x15021 (globals ?x31270)))
 (let ((?x14890 (g_granules ?x15021)))
 (let ((?x66309 (e_state_s_granule (select ?x14890 gidx.2468722))))
 (let (($x15369 (= ?x66309 6)))
 (let (($x14292 (= ?x66309 0)))
 (=> (not (select (gpt ?x31270) gidx.2468722)) (or $x14292 $x15369)))))))))))))))))))))
 )
(assert
 (forall ((v_0.2468757 Int) )(let ((?x1047 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.2468757))) 4096)))
 (let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 ...
 (let ((?x14649 (value_RData ?x14298)))
 (let ((?x31270 (share ?x14649)))
 (let ((?x11912 (gpt ?x31270)))
 (select ?x11912 ?x1047)))))))))))))))))
 )
(assert
 (let (($x66938 (forall ((gidx.2468945 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x14649 (value_RData ?x14298)))
 (let ((?x31270 (share ?x14649)))
 (let ((?x66332 (log ?x14649)))
 (let ((?x13804 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2440701)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!3 (value_RData (spinlock_release_spec.0_call
                          a!1
                          (value_RData (spinlock_acquire_spec.0_call a!2 st.0))))))
  (oracle a!3)))_call| ?x66332)))
 (let ((?x12527 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset
                    (meta_PA (test_Z_PTE.0_call v_0.2440701)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.96777))))))
(let ((a!3 (value_RData (spinlock_release_spec.0_call
                          a!1
                          (value_RData (spinlock_acquire_spec.0_call a!2 st.0))))))
  (repl a!3)))_call| ?x13804 ?x31270)))
 (let ((?x12805 (value_Shared ?x12527)))
 (let ((?x12366 (gpt ?x12805)))
 (let (($x29511 (select ?x12366 gidx.2468945)))
 (let ((?x14823 (e_state_s_granule (select (g_granules (globals ?x12805)) gidx.2468945))))
 (let (($x22554 (= ?x14823 0)))
 (let (($x10027 (= ?x14823 6)))
 (or $x10027 $x22554 $x29511))))))))))))))))))))))))
 ))
 (let (($x14547 (forall ((gidx.2468928 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x31270 (share ?x14649)))
 (let ((?x11912 (gpt ?x31270)))
 (let (($x57883 (select ?x11912 gidx.2468928)))
 (let ((?x66309 (e_state_s_granule (select (g_granules (globals ?x31270)) gidx.2468928))))
 (let (($x15369 (= ?x66309 6)))
 (let (($x14292 (= ?x66309 0)))
 (or $x14292 $x15369 $x57883))))))))))))))))))))
 ))
 (or (not $x14547) $x66938))))
(assert
 (let (($x14493 (forall ((gidx.2469004 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x15021 (globals ?x31270)))
 (let ((?x14890 (g_granules ?x15021)))
 (let ((?x66309 (e_state_s_granule (select ?x14890 gidx.2469004))))
 (let (($x15369 (= ?x66309 6)))
 (let (($x14292 (= ?x66309 0)))
 (=> (not (select (gpt ?x31270) gidx.2469004)) (or $x14292 $x15369)))))))))))))))))))))
 ))
 (not $x14493)))
(check-sat)

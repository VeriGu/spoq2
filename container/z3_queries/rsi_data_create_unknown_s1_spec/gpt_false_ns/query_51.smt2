...
(assert
 ...
 (= ?x86711 8)))))))
(assert
 (let (($x47112 (forall ((gidx.2442963 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x6063 (globals ?x78834)))
 (let ((?x5786 (g_granules ?x6063)))
 (let ((?x6034 (e_state_s_granule (select ?x5786 gidx.2442963))))
 (let (($x5997 (= ?x6034 6)))
 (let (($x5418 (= ?x6034 0)))
 (=> (not (select (gpt ?x78834) gidx.2442963)) (or $x5418 $x5997)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x47112)))
(check-sat)

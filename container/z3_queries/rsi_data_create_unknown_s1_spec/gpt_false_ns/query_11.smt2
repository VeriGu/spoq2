...
(let ((a!10 (granule_unlock_spec.0_call
 ...
 (or (not $x2509) $x26481))))
(assert
 (let (($x2136 (forall ((gidx.2432883 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x2407 (globals ?x81145)))
 (let ((?x2352 (g_granules ?x2407)))
 (let ((?x2403 (e_state_s_granule (select ?x2352 gidx.2432883))))
 (let (($x1863 (= ?x2403 6)))
 (let (($x34307 (= ?x2403 0)))
 (=> (not (select (gpt ?x81145) gidx.2432883)) (or $x34307 $x1863))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2136)))
(check-sat)

...
(assert
 ...
 (not $x2640)))))
(assert
 (let (($x12523 (forall ((gidx.2463627 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x64607 (globals ?x127691)))
 (let ((?x56061 (g_granules ?x64607)))
 (let ((?x12661 (e_state_s_granule (select ?x56061 gidx.2463627))))
 (let (($x13349 (= ?x12661 6)))
 (let (($x55640 (= ?x12661 0)))
 (=> (not (select (gpt ?x127691) gidx.2463627)) (or $x55640 $x13349))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12523)))
(check-sat)

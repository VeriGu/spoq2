...
(assert
 ...
 (not $x2640)))))
(assert
 (let (($x4261 (forall ((gidx.2437139 Int) )(let ((?x3244 (test_Z_PTE.0_call v_0.2436501)))
 ...
 (let ((?x3076 (e_state_s_granule (select ?x36424 gidx.2437139))))
 (let ((?x59572 (gpt ?x98382)))
 (let (($x3488 (select ?x59572 gidx.2437139)))
 (let (($x3957 (not $x3488)))
 (=> $x3957 (or (= ?x3076 0) (= ?x3076 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4261)))
(check-sat)

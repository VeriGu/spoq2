...
(assert
 (let (($x10483 (forall ((gidx.2456627 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x53582 (globals ?x100840)))
 (let ((?x10528 (g_granules ?x53582)))
 (let ((?x10797 (e_state_s_granule (select ?x10528 gidx.2456627))))
 (let (($x10640 (= ?x10797 6)))
 (let (($x10959 (= ?x10797 0)))
 (=> (not (select (gpt ?x100840) gidx.2456627)) (or $x10959 $x10640)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10483)))
(check-sat)

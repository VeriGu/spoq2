...
(assert
 ...
 (= ?x36573 0))))
(assert
 (let (($x98148 (forall ((gidx.2451363 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x51230 (globals ?x58737)))
 (let ((?x41443 (g_granules ?x51230)))
 (let ((?x73695 (e_state_s_granule (select ?x41443 gidx.2451363))))
 (let (($x8346 (= ?x73695 6)))
 (let (($x4913 (= ?x73695 0)))
 (=> (not (select (gpt ?x58737) gidx.2451363)) (or $x4913 $x8346)))))))))))))))))))))))))))))))))))
 ))
 (not $x98148)))
(check-sat)

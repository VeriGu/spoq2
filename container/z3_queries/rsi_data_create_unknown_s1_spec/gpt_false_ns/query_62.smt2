...
(assert
 ...
 (and $x6882 $x6516))))))))
(assert
 (let (($x7315 (forall ((gidx.2446099 Int) )(let ((?x7355 (test_Z_PTE.0_call v_0.2445853)))
 (let ((?x7282 (meta_PA ?x7355)))
 (let ((?x7220 (meta_granule_offset ?x7282)))
 ...
 (let ((?x6016 (e_state_s_granule (select ?x7634 gidx.2446099))))
 (let ((?x79923 (gpt ?x110901)))
 (let (($x6548 (select ?x79923 gidx.2446099)))
 (let (($x5697 (not $x6548)))
 (=> $x5697 (or (= ?x6016 0) (= ?x6016 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7315)))
(check-sat)

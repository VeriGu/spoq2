...
(assert
 (let (($x58110 (forall ((gidx.2468275 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x36129 (globals ?x29045)))
 (let ((?x5085 (g_granules ?x36129)))
 (let ((?x28049 (e_state_s_granule (select ?x5085 gidx.2468275))))
 (let (($x3001 (= ?x28049 6)))
 (let (($x4548 (= ?x28049 0)))
 (=> (not (select (gpt ?x29045) gidx.2468275)) (or $x4548 $x3001))))))))))))))))))))))
 ))
 (not $x58110)))
(check-sat)

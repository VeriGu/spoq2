...
(assert
 ...
 (and $x11282 $x11898))))))))
(assert
 (let (($x62150 (forall ((gidx.2459427 Int) )(let ((?x11114 (test_Z_PTE.0_call v_0.2459181)))
 (let ((?x12148 (meta_PA ?x11114)))
 (let ((?x11475 (meta_granule_offset ?x12148)))
 ...
 (let ((?x102324 (e_state_s_granule (select ?x10059 gidx.2459427))))
 (let ((?x62034 (gpt ?x125259)))
 (let (($x11630 (select ?x62034 gidx.2459427)))
 (let (($x11491 (not $x11630)))
 (=> $x11491 (or (= ?x102324 0) (= ?x102324 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x62150)))
(check-sat)

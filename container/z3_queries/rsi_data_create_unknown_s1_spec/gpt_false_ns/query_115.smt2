...
(assert
 ...
 (= ?x110979 8)))))))
(assert
 (let (($x71074 (forall ((gidx.2460827 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x12372 (globals ?x102203)))
 (let ((?x53566 (g_granules ?x12372)))
 (let ((?x11459 (e_state_s_granule (select ?x53566 gidx.2460827))))
 (let (($x12195 (= ?x11459 6)))
 (let (($x11627 (= ?x11459 0)))
 (=> (not (select (gpt ?x102203) gidx.2460827)) (or $x11627 $x12195)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x71074)))
(check-sat)

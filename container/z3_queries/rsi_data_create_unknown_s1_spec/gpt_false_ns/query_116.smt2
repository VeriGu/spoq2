...
(assert
 (let (($x12239 (forall ((gidx.2461163 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x70945 (globals ?x111224)))
 (let ((?x11488 (g_granules ?x70945)))
 (let ((?x54492 (e_state_s_granule (select ?x11488 gidx.2461163))))
 (let (($x12011 (= ?x54492 6)))
 (let (($x62140 (= ?x54492 0)))
 (=> (not (select (gpt ?x111224) gidx.2461163)) (or $x62140 $x12011)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x12239)))
(check-sat)

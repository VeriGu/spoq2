...
(assert
 ...
 (= ?x26393 0))))
(assert
 (let (($x516 (forall ((gidx.2433219 Int) )(let ((?x2620 (test_Z_PTE.0_call v_0.2432973)))
 ...
 (let ((?x2286 (e_state_s_granule (select ?x2394 gidx.2433219))))
 (let ((?x26520 (gpt ?x89056)))
 (let (($x2447 (select ?x26520 gidx.2433219)))
 (let (($x1282 (not $x2447)))
 (=> $x1282 (or (= ?x2286 0) (= ?x2286 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x516)))
(check-sat)

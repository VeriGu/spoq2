...
(let ((a!6 (value_RData (spinlock_acquire_spec.0_call
 ...
 (or (not $x3080) $x3158))))
(assert
 (let (($x2579 (forall ((gidx.2434339 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x3065 (globals ?x50715)))
 (let ((?x2940 (g_granules ?x3065)))
 (let ((?x26877 (e_state_s_granule (select ?x2940 gidx.2434339))))
 (let (($x2028 (= ?x26877 6)))
 (let (($x2720 (= ?x26877 0)))
 (=> (not (select (gpt ?x50715) gidx.2434339)) (or $x2720 $x2028)))))))))))))))))))))))))))))))))
 ))
 (not $x2579)))
(check-sat)

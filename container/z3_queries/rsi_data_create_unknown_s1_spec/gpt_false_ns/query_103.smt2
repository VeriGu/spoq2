...
(assert
 ...
 (not $x52586))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x53392 (forall ((gidx.2457355 Int) )(let ((?x4757 (test_Z_PTE.0_call v_0.96777)))
 (let ((?x3748 (meta_PA ?x4757)))
 (let ((?x2607 (meta_granule_offset ?x3748)))
 (let ((?x1109 (mkPtr "granules" ?x2607)))
 (let ((?x1076 (spinlock_acquire_spec.0_call ?x1109 st.0)))
 ...
 (let ((?x10400 (globals ?x77249)))
 (let ((?x10098 (g_granules ?x10400)))
 (let ((?x10468 (e_state_s_granule (select ?x10098 gidx.2457355))))
 (let (($x10025 (= ?x10468 6)))
 (let (($x10220 (= ?x10468 0)))
 (=> (not (select (gpt ?x77249) gidx.2457355)) (or $x10220 $x10025)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x53392)))
(check-sat)

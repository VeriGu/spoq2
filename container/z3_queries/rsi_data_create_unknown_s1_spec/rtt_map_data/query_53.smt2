...
(assert
 (let (($x65645 (forall ((rtt_gidx.2582450 Int) (ipa_gidx.2582450 Int) (data_gidx.2582450 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x25012 (rtt_walk_abs.0_call ?x58651 rtt_gidx.2582450 ipa_gidx.2582450)))
 (let ((?x66140 (g_granule_state (select ?x20644 ?x25012))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2582450)))
 (let (($x312187 (=> (and (and (distinct ?x25012 (- 1)) true) $x153) (or (= ?x66140 4) (= ?x66140 6)))))
 (=> (and (= (e_state_s_granule (select ?x25216 rtt_gidx.2582450)) 5) (and (distinct ?x25012 (- 1)) true) $x153) (or (= ?x66140 4) (= ?x66140 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x65645)))
(check-sat)

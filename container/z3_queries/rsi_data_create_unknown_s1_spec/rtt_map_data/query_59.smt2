...
(assert
 ...
 (not $x3220)))))))))))))))
(assert
 (forall ((rtt_gidx.2586112 Int) (ipa_gidx.2586112 Int) (data_gidx.2586112 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x10855 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2586112 ipa_gidx.2586112)))
 (let ((?x10803 (share ?x4030)))
 (let ((?x10906 (granule_data ?x10803)))
 (let ((?x9915 (g_granule_state (select ?x10906 ?x10855))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2586112)))
 (let (($x11034 (=> $x153 (or (= ?x9915 4) (= ?x9915 6)))))
 (let (($x10756 (= (e_state_s_granule (select (g_granules (globals ?x10803)) rtt_gidx.2586112)) 5)))
 (=> (and $x10756 (and (distinct ?x10855 (- 1)) true) $x153) (or (= ?x9915 4) (= ?x9915 6)))))))))))))))))))
 )
(assert
 (let (($x26930 (forall ((rtt_gidx.2586468 Int) (ipa_gidx.2586468 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
...
(let ((a!2 (value_RData (spinlock_release_spec.0_call
 ...
 (let ((?x10792 (globals ?x10478)))
 (let ((?x11139 (g_granules ?x10792)))
 (let (($x11108 (not (= (e_state_s_granule (select ?x11139 rtt_gidx.2586468)) 5))))
 ...
 (let ((?x11153 (rtt_walk_abs.0_call ?x11024 rtt_gidx.2586468 ipa_gidx.2586468)))
 (let (($x11113 (= ?x11153 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2586468))))
 (let ((?x11026 (g_granule_state (select (granule_data ?x10478) ?x11153))))
 (let (($x11087 (= ?x11026 4)))
 (let (($x11201 (= ?x11026 6)))
 (or $x11201 $x11087 $x176 $x11113 $x11108)))))))))))))))))))))))))))))))
 ))
 (let (($x26249 (forall ((rtt_gidx.2586421 Int) (ipa_gidx.2586421 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x10985 (e_state_s_granule (select ?x10957 rtt_gidx.2586421))))
 (let (($x11179 (not (= ?x10985 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2586421))))
 (let ((?x11176 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2586421 ipa_gidx.2586421)))
 (let (($x11208 (= ?x11176 (- 1))))
 (let ((?x11142 (g_granule_state (select (granule_data ?x10803) ?x11176))))
 (let (($x11168 (= ?x11142 4)))
 (let (($x11063 (= ?x11142 6)))
 (or $x11063 $x11168 $x11208 $x176 $x11179)))))))))))))))))))))
 ))
 (or (not $x26249) $x26930))))
(assert
 (forall ((offset.2587128 Int) (empty_pte.2587128 abs_PTE_t) )(let (($x27226 (forall ((rtt_gidx.2587011 Int) (ipa_gidx.2587011 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x44027 (spinlock_release_spec.0_call ?x2326 ?x2329)))
 (let ((?x4030 (value_RData ?x44027)))
 (let ((?x11176 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2587011 ipa_gidx.2587011)))
 (let (($x11208 (= ?x11176 (- 1))))
 (let ((?x10985 (e_state_s_granule (select (g_granules (globals (share ?x4030))) rtt_gidx.2587011))))
 (let (($x11179 (not (= ?x10985 5))))
 (let ((?x11142 (g_granule_state (select (granule_data (share ?x4030)) ?x11176))))
 (let (($x11168 (= ?x11142 4)))
 (let (($x11063 (= ?x11142 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2587011))))
 (or $x176 $x11063 $x11168 $x11179 $x11208))))))))))))))))))
 ))
 (let (($x27424 (not $x27226)))
 (let (($x27274 (forall ((rtt_gidx.2587124 Int) (ipa_gidx.2587124 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x10803 (share ?x4030)))
 (let ((?x11017 (globals ?x10803)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2587128)))
 (let ((?x2023 (mod offset.2587128 4096)))
 (let ((?x11181 (store (g_norm (select (granule_data ?x10803) (div offset.2587128 4096))) ?x2023 ?x2022)))
 (let ((?x11101 (mkr_granule_data (gd_g_idx (select (granule_data ?x10803) (div offset.2587128 4096))) (g_granule_state (select (granule_data ?x10803) (div offset.2587128 4096))) ?x11181 (g_rd (select (granule_data ?x10803) (div offset.2587128 4096))) (g_rec (select (granule_data ?x10803) (div offset.2587128 4096))))))
 (let ((?x2017 (div offset.2587128 4096)))
 (let ((?x10906 (granule_data ?x10803)))
 ...
 (let ((?x11030 (oracle ?x4030)))
 (let ((?x11178 (log ?x4030)))
 (let ((?x11205 (rtt_walk_abs.0_call (mkRData ?x11178 ?x11030 ?x10551 ?x10686 (mkShared ?x10975 ?x2510 ?x11017) ?x10701 $x10742) rtt_gidx.2587124 ipa_gidx.2587124)))
 (let ((?x10822 (g_granule_state (select ?x2510 ?x11205))))
 (let (($x11248 (= ?x10822 4)))
 (let (($x11293 (= ?x10822 6)))
 (let (($x11099 (= ?x11205 (- 1))))
 (let (($x11179 (not (= (e_state_s_granule (select (g_granules ?x11017) rtt_gidx.2587124)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2587124))))
 (or $x176 $x11179 $x11099 $x11293 $x11248)))))))))))))))))))))))))))))))))
 ))
 (let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2587128)) (- 1)))))
 (let ((?x2001 (div offset.2587128 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x11017 (globals ?x10803)))
 (let ((?x10957 (g_granules ?x11017)))
 (let (($x11261 (not (= (e_state_s_granule (select ?x10957 ?x2001)) 5))))
 (or $x11261 $x2000 $x27274 $x27424)))))))))))))))))))
 )
(assert
 (forall ((offset.2587687 Int) (state.2587687 Int) )(let (($x26186 (forall ((rtt_gidx.2587685 Int) (ipa_gidx.2587685 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x11522 (mks_granule (e_lock (select (g_granules ?x11017) offset.2587687)) state.2587687 (e_ref (select (g_granules ?x11017) offset.2587687)))))
 (let ((?x10957 (g_granules ?x11017)))
 (let ((?x11542 (store ?x10957 offset.2587687 ?x11522)))
 ...
 (let ((?x11524 (mkr_granule_data (gd_g_idx (select (granule_data ?x10803) offset.2587687)) (g_granule_state (select (granule_data ?x10803) offset.2587687)) zero_granule_data (g_rd (select (granule_data ?x10803) offset.2587687)) (g_rec (select (granule_data ?x10803) offset.2587687)))))
 (let ((?x10906 (granule_data ?x10803)))
 (let ((?x11548 (store ?x10906 offset.2587687 ?x11524)))
 (let ((?x10975 (gpt ?x10803)))
 (let ((?x10686 (priv ?x4030)))
 (let ((?x10551 (repl ?x4030)))
 (let ((?x11030 (oracle ?x4030)))
 (let ((?x11178 (log ?x4030)))
 (let ((?x10836 (rtt_walk_abs.0_call (mkRData ?x11178 ?x11030 ?x10551 ?x10686 (mkShared ?x10975 ?x11548 ?x11533) ?x10701 $x10742) rtt_gidx.2587685 ipa_gidx.2587685)))
 (let ((?x11566 (g_granule_state (select ?x11548 ?x10836))))
 (let (($x11534 (= ?x11566 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2587685))))
 (let (($x11550 (= ?x10836 (- 1))))
 (let (($x11557 (not (= (e_state_s_granule (select ?x11542 rtt_gidx.2587685)) 5))))
 (let (($x2386 (= ?x11566 6)))
 (or $x2386 $x11557 $x11550 $x176 $x11534)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x26718 (forall ((rtt_gidx.2587586 Int) (ipa_gidx.2587586 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x11017 (globals ?x10803)))
 (let ((?x10957 (g_granules ?x11017)))
 (let ((?x10985 (e_state_s_granule (select ?x10957 rtt_gidx.2587586))))
 (let (($x11179 (not (= ?x10985 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2587586))))
 (let ((?x11176 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2587586 ipa_gidx.2587586)))
 (let (($x11208 (= ?x11176 (- 1))))
 (let ((?x11142 (g_granule_state (select (granule_data ?x10803) ?x11176))))
 (let (($x11168 (= ?x11142 4)))
 (let (($x11063 (= ?x11142 6)))
 ...
 (let (($x26621 (not $x26718)))
 (or $x26621 $x26186)))))
 )
(assert
 (forall ((parent_gidx.2588631 Int) (pte_z.2588631 Int) (x.2588631 Int) (y.2588631 Int) (z.2588631 Int) )(let (($x27367 (forall ((rtt_gidx.2588629 Int) (ipa_gidx.2588629 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2518 (g_rmm_attest_public_key ?x11017)))
 (let ((?x2520 (g_rmm_attest_signing_key ?x11017)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2588631))) 4096)))
 (let ((?x10957 (g_granules ?x11017)))
 ...
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2588631)) x.2588631 y.2588631 z.2588631))))
 (let ((?x1892 (mod parent_gidx.2588631 4096)))
 (let ((?x11680 (store (g_norm (select (granule_data ?x10803) (div parent_gidx.2588631 4096))) ?x1892 ?x1891)))
 (let ((?x11236 (mkr_granule_data (gd_g_idx (select (granule_data ?x10803) (div parent_gidx.2588631 4096))) (g_granule_state (select (granule_data ?x10803) (div parent_gidx.2588631 4096))) ?x11680 (g_rd (select (granule_data ?x10803) (div parent_gidx.2588631 4096))) (g_rec (select (granule_data ?x10803) (div parent_gidx.2588631 4096))))))
 (let ((?x1886 (div parent_gidx.2588631 4096)))
 (let ((?x10906 (granule_data ?x10803)))
 ...
 (let ((?x11030 (oracle ?x4030)))
 (let ((?x11178 (log ?x4030)))
 (let ((?x11659 (rtt_walk_abs.0_call (mkRData ?x11178 ?x11030 ?x10551 ?x10686 (mkShared ?x10975 ?x10846 ?x11298) ?x10701 $x10742) rtt_gidx.2588629 ipa_gidx.2588629)))
 (let ((?x11633 (g_granule_state (select ?x10846 ?x11659))))
 (let (($x11530 (= ?x11633 4)))
 (let (($x11661 (= ?x11633 6)))
 (let (($x11676 (not (= (e_state_s_granule (select ?x11688 rtt_gidx.2588629)) 5))))
 (let (($x11654 (= ?x11659 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2588629))))
 (or $x176 $x11654 $x11676 $x11661 $x11530))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x23184 (forall ((rtt_gidx.2588433 Int) (ipa_gidx.2588433 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x11017 (globals ?x10803)))
 (let ((?x10957 (g_granules ?x11017)))
 (let ((?x10985 (e_state_s_granule (select ?x10957 rtt_gidx.2588433))))
 (let (($x11179 (not (= ?x10985 5))))
 (let ((?x11176 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2588433 ipa_gidx.2588433)))
 (let (($x11208 (= ?x11176 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2588433))))
 (let ((?x11142 (g_granule_state (select (granule_data ?x10803) ?x11176))))
 (let (($x11168 (= ?x11142 4)))
 (let (($x11063 (= ?x11142 6)))
 (or $x11063 $x11168 $x176 $x11208 $x11179)))))))))))))))))))))
 ))
 (let (($x26868 (not $x23184)))
 (or $x26868 $x27367)))))
 )
(assert
 (forall ((offset.2589038 Int) )(let (($x27594 (forall ((rtt_gidx.2589036 Int) (ipa_gidx.2589036 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2518 (g_rmm_attest_public_key ?x11017)))
 (let ((?x2520 (g_rmm_attest_signing_key ?x11017)))
 (let ((?x11714 (mks_granule (e_lock (select (g_granules ?x11017) offset.2589038)) 4 (e_ref (select (g_granules ?x11017) offset.2589038)))))
 (let ((?x10957 (g_granules ?x11017)))
 (let ((?x11561 (store ?x10957 offset.2589038 ?x11714)))
 (let ((?x7562 (g_mbedtls_mem_buf ?x11017)))
 (let ((?x11483 (g_tt_l1_upper ?x11017)))
 (let ((?x11485 (g_tt_l2_mem1_3 ?x11017)))
 (let ((?x11462 (g_tt_l2_mem1_2 ?x11017)))
 ...
 (let ((?x11030 (oracle ?x4030)))
 (let ((?x11178 (log ?x4030)))
 (let ((?x10868 (rtt_walk_abs.0_call (mkRData ?x11178 ?x11030 ?x10551 ?x10686 (mkShared ?x10975 ?x10906 ?x11638) ?x10701 $x10742) rtt_gidx.2589036 ipa_gidx.2589036)))
 (let ((?x11767 (g_granule_state (select ?x10906 ?x10868))))
 (let (($x11687 (= ?x11767 6)))
 (let (($x11823 (= ?x10868 (- 1))))
 (let (($x11619 (not (= (e_state_s_granule (select ?x11561 rtt_gidx.2589036)) 5))))
 (let (($x11821 (= ?x11767 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2589036))))
 (or $x176 $x11821 $x11619 $x11823 $x11687)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x27283 (forall ((rtt_gidx.2588971 Int) (ipa_gidx.2588971 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x44027 (spinlock_release_spec.0_call ?x2326 ?x2329)))
 (let ((?x4030 (value_RData ?x44027)))
 (let ((?x11176 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2588971 ipa_gidx.2588971)))
 (let (($x11208 (= ?x11176 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2588971))))
 (let ((?x10985 (e_state_s_granule (select (g_granules (globals (share ?x4030))) rtt_gidx.2588971))))
 (let (($x11179 (not (= ?x10985 5))))
 (let ((?x11142 (g_granule_state (select (granule_data (share ?x4030)) ?x11176))))
 (let (($x11168 (= ?x11142 4)))
 (let (($x11063 (= ?x11142 6)))
 ...
 (let (($x27377 (not $x27283)))
 (or $x27377 $x27594)))))
 )
(assert
 (forall ((rtt_gidx.2589140 Int) (ipa_gidx.2589140 Int) (i.2589140 Int) (d.2589140 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x11030 (oracle ?x4030)))
 (let ((?x11178 (log ?x4030)))
 (let ((?x11898 (mkRData ?x11178 ?x11030 ?x10551 ?x10686 (mkShared ?x10975 (store (granule_data ?x10803) i.2589140 d.2589140) ?x11017) ?x10701 $x10742)))
 (let ((?x11620 (+ (rtt_walk_abs.0_call ?x4030 rtt_gidx.2589140 ipa_gidx.2589140) (* (- 1) (rtt_walk_abs.0_call ?x11898 rtt_gidx.2589140 ipa_gidx.2589140)))))
 (let (($x11179 (not (= (e_state_s_granule (select (g_granules ?x11017) i.2589140)) 5))))
 (let (($x11815 (and $x11179 (not (= (e_state_s_granule (select (g_granules ?x11017) i.2589140)) 4)))))
 (=> $x11815 (= ?x11620 0))))))))))))))))))))))))
 )
(assert
 (let (($x27112 (forall ((rtt_gidx.2589220 Int) (ipa_gidx.2589220 Int) (data_gidx.2589220 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x44027 (spinlock_release_spec.0_call ?x2326 ?x2329)))
 (let ((?x4030 (value_RData ?x44027)))
 (let ((?x10855 (rtt_walk_abs.0_call ?x4030 rtt_gidx.2589220 ipa_gidx.2589220)))
 (let ((?x10803 (share ?x4030)))
 (let ((?x10906 (granule_data ?x10803)))
 (let ((?x9915 (g_granule_state (select ?x10906 ?x10855))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2589220)))
 (let (($x11034 (=> $x153 (or (= ?x9915 4) (= ?x9915 6)))))
 (let (($x10756 (= (e_state_s_granule (select (g_granules (globals ?x10803)) rtt_gidx.2589220)) 5)))
 (=> (and $x10756 (and (distinct ?x10855 (- 1)) true) $x153) (or (= ?x9915 4) (= ?x9915 6)))))))))))))))))))
 ))
 (not $x27112)))
(check-sat)

...
(assert
 (let (($x62541 (forall ((rtt_gidx.2575022 Int) (ipa_gidx.2575022 Int) (data_gidx.2575022 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x22192 (granule_data ?x21901)))
 (let ((?x62709 (select ?x22192 ?x63049)))
 (let ((?x16094 (mkabs_PTE_t ?x2324 0 0 3)))
 (let ((?x53970 (test_PTE_Z.0_call ?x16094)))
 (let ((?x22774 (mod ?x122879 4096)))
 (let ((?x62415 (g_norm ?x62709)))
 (let ((?x23427 (store ?x62415 ?x22774 ?x53970)))
 (let ((?x23134 (mkr_granule_data (gd_g_idx ?x62709) (g_granule_state ?x62709) ?x23427 (g_rd ?x62709) (g_rec ?x62709))))
 (let ((?x22946 (store ?x22192 ?x63049 ?x23134)))
 (let ((?x583620 (gpt ?x21901)))
 (let ((?x20616 (priv ?x21149)))
 (let ((?x22564 (repl ?x21149)))
 (let ((?x21628 (oracle ?x21149)))
 (let ((?x22565 (log ?x21149)))
 (let ((?x366712 (mkRData ?x22565 ?x21628 ?x22564 ?x20616 (mkShared ?x583620 ?x22946 ?x62747) ?x22118 $x22085)))
 (let ((?x580078 (g_granule_state (select ?x22946 (rtt_walk_abs.0_call ?x366712 rtt_gidx.2575022 ipa_gidx.2575022)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2575022)))
 (let ((?x23455 (mkRData ?x22565 ?x21628 ?x22564 ?x20616 (mkShared ?x583620 ?x22192 ?x62747) ?x22118 $x22085)))
 (let ((?x18992 (mkRData (log ?x23455) (oracle ?x23455) (repl ?x23455) (priv ?x23455) (mkShared (gpt (share ?x23455)) ?x22946 (globals (share ?x23455))) (stack ?x23455) (halt ?x23455))))
 (let (($x43347 (=> (and (and (distinct (rtt_walk_abs.0_call ?x18992 rtt_gidx.2575022 ipa_gidx.2575022) (- 1)) true) $x153) (or (= ?x580078 4) (= ?x580078 6)))))
 (=> (and (= (e_state_s_granule (select ?x78807 rtt_gidx.2575022)) 5) (and (distinct (rtt_walk_abs.0_call ?x18992 rtt_gidx.2575022 ipa_gidx.2575022) (- 1)) true) $x153) (or (= ?x580078 4) (= ?x580078 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x62541)))
(check-sat)

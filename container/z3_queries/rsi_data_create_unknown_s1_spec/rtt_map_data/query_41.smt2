...
(assert
 ...
 (and $x4147 $x4148)))))))
(assert
 (forall ((rtt_gidx.2562230 Int) (ipa_gidx.2562230 Int) (data_gidx.2562230 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x65104 (spinlock_release_spec.0_call ?x12290 ?x3355)))
 (let ((?x5286 (value_RData ?x65104)))
 (let ((?x19555 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2562230 ipa_gidx.2562230)))
 (let ((?x22053 (share ?x5286)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x18946 (g_granule_state (select ?x19742 ?x19555))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2562230)))
 (let (($x19693 (=> $x153 (or (= ?x18946 4) (= ?x18946 6)))))
 (let (($x19540 (= (e_state_s_granule (select (g_granules (globals ?x22053)) rtt_gidx.2562230)) 5)))
 (=> (and $x19540 (and (distinct ?x19555 (- 1)) true) $x153) (or (= ?x18946 4) (= ?x18946 6)))))))))))))))))))))))))))))))
 )
(assert
 (let (($x19322 (forall ((rtt_gidx.2562586 Int) (ipa_gidx.2562586 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x65104 (spinlock_release_spec.0_call ?x12290 ?x3355)))
 (let ((?x5286 (value_RData ?x65104)))
 (let (($x18581 (halt ?x5286)))
 (let ((?x22336 (stack ?x5286)))
 (let ((?x22053 (share ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x18242 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!5 (value_RData (spinlock_release_spec.0_call
                          (mkPtr (pbase a!3) (poffset a!3))
                          a!4))))
  (oracle a!5))))))_call| ?x18264)))
 (let ((?x19316 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!5 (value_RData (spinlock_release_spec.0_call
                          (mkPtr (pbase a!3) (poffset a!3))
                          a!4))))
  (repl a!5))))))_call| ?x18242 ?x22053)))
 (let ((?x19604 (value_Shared ?x19316)))
 (let ((?x19387 (priv ?x5286)))
 (let ((?x18916 (repl ?x5286)))
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x19729 (List_Event_concat ?x18242 ?x18264)))
 (let ((?x19304 (mkRData ?x19729 ?x18798 ?x18916 ?x19387 ?x19604 ?x22336 $x18581)))
 (let ((?x19264 (rtt_walk_abs.0_call ?x19304 rtt_gidx.2562586 ipa_gidx.2562586)))
 (let ((?x18624 (granule_data ?x19604)))
 (let ((?x18995 (g_granule_state (select ?x18624 ?x19264))))
 (let (($x19758 (not (= (e_state_s_granule (select (g_granules (globals ?x19604)) rtt_gidx.2562586)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2562586))))
 (or (= ?x19264 (- 1)) (= ?x18995 6) $x176 $x19758 (= ?x18995 4))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x13427 (forall ((rtt_gidx.2562539 Int) (ipa_gidx.2562539 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x19576 (e_state_s_granule (select ?x18905 rtt_gidx.2562539))))
 (let (($x18810 (not (= ?x19576 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2562539))))
 (let ((?x19837 (g_granule_state (select (granule_data ?x22053) (rtt_walk_abs.0_call ?x5286 rtt_gidx.2562539 ipa_gidx.2562539)))))
 (let (($x20075 (= ?x19837 6)))
 (let ((?x18067 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2562539 ipa_gidx.2562539)))
 (let (($x34768 (= ?x18067 (- 1))))
 (let (($x4330 (= ?x19837 4)))
 (or $x4330 $x34768 $x20075 $x176 $x18810)))))))))))))))))))))))))))))))))
 ))
 (or (not $x13427) $x19322))))
(assert
 (forall ((offset.2563246 Int) (empty_pte.2563246 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2563246)) (- 1)))))
 (let ((?x2001 (div offset.2563246 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x17625 (globals ?x22053)))
 (let ((?x18905 (g_granules ?x17625)))
 (let (($x19702 (forall ((rtt_gidx.2563129 Int) (ipa_gidx.2563129 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x65104 (spinlock_release_spec.0_call ?x12290 ?x3355)))
 (let ((?x5286 (value_RData ?x65104)))
 (let ((?x18067 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2563129 ipa_gidx.2563129)))
 (let (($x34768 (= ?x18067 (- 1))))
 (let ((?x19837 (g_granule_state (select (granule_data (share ?x5286)) ?x18067))))
 (let (($x20075 (= ?x19837 6)))
 (let ((?x19576 (e_state_s_granule (select (g_granules (globals (share ?x5286))) rtt_gidx.2563129))))
 (let (($x18810 (not (= ?x19576 5))))
 (let (($x4330 (= ?x19837 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2563129))))
 (or $x176 $x4330 $x18810 $x20075 $x34768))))))))))))))))))))))))))))))
 ))
 (let (($x19752 (not $x19702)))
 (let (($x19970 (forall ((rtt_gidx.2563242 Int) (ipa_gidx.2563242 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x22053 (share ?x5286)))
 (let ((?x17625 (globals ?x22053)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2563246)))
 (let ((?x2023 (mod offset.2563246 4096)))
 (let ((?x22297 (store (g_norm (select (granule_data ?x22053) (div offset.2563246 4096))) ?x2023 ?x2022)))
 (let ((?x19842 (mkr_granule_data (gd_g_idx (select (granule_data ?x22053) (div offset.2563246 4096))) (g_granule_state (select (granule_data ?x22053) (div offset.2563246 4096))) ?x22297 (g_rd (select (granule_data ?x22053) (div offset.2563246 4096))) (g_rec (select (granule_data ?x22053) (div offset.2563246 4096))))))
 (let ((?x2017 (div offset.2563246 4096)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x22266 (store ?x19742 ?x2017 ?x19842)))
 (let ((?x19694 (gpt ?x22053)))
 (let ((?x19387 (priv ?x5286)))
 (let ((?x18916 (repl ?x5286)))
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x19720 (rtt_walk_abs.0_call (mkRData ?x18264 ?x18798 ?x18916 ?x19387 (mkShared ?x19694 ?x22266 ?x17625) ?x22336 $x18581) rtt_gidx.2563242 ipa_gidx.2563242)))
 (let ((?x19972 (g_granule_state (select ?x22266 ?x19720))))
 (let (($x18810 (not (= (e_state_s_granule (select (g_granules ?x17625) rtt_gidx.2563242)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2563242))))
 (or $x176 $x18810 (= ?x19720 (- 1)) (= ?x19972 6) (= ?x19972 4)))))))))))))))))))))))))))))))))))))))))))
 ))
 (or $x19970 $x19752 (not (= (e_state_s_granule (select ?x18905 ?x2001)) 5)) $x2000))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2563805 Int) (state.2563805 Int) )(let (($x16878 (forall ((rtt_gidx.2563803 Int) (ipa_gidx.2563803 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x22053 (share ?x5286)))
 (let ((?x17625 (globals ?x22053)))
 (let ((?x19818 (g_realm_attest_private_key ?x17625)))
 (let ((?x20029 (g_get_realm_identity_identity ?x17625)))
 (let ((?x19813 (g_rmm_platform_token ?x17625)))
 (let ((?x17977 (g_platform_token_buf ?x17625)))
 (let ((?x19076 (g_rmm_attest_public_key_hash_len ?x17625)))
 (let ((?x22279 (g_rmm_attest_public_key_hash ?x17625)))
 (let ((?x19915 (g_rmm_attest_public_key_len ?x17625)))
 (let ((?x20004 (g_rmm_attest_public_key ?x17625)))
 (let ((?x22272 (g_rmm_attest_signing_key ?x17625)))
 (let ((?x19309 (mks_granule (e_lock (select (g_granules ?x17625) offset.2563805)) state.2563805 (e_ref (select (g_granules ?x17625) offset.2563805)))))
 (let ((?x18905 (g_granules ?x17625)))
 (let ((?x19921 (store ?x18905 offset.2563805 ?x19309)))
 (let ((?x19722 (g_mbedtls_mem_buf ?x17625)))
 (let ((?x19663 (g_tt_l1_upper ?x17625)))
 (let ((?x19999 (g_tt_l2_mem1_3 ?x17625)))
 (let ((?x22058 (g_tt_l2_mem1_2 ?x17625)))
 (let ((?x19901 (g_tt_l2_mem1_1 ?x17625)))
 (let ((?x19980 (g_tt_l2_mem1_0 ?x17625)))
 (let ((?x20012 (g_tt_l2_mem0_1 ?x17625)))
 (let ((?x19859 (g_tt_l2_mem0_0 ?x17625)))
 (let ((?x22041 (g_tt_l3_buffer ?x17625)))
 (let ((?x19206 (g_rmm_trap_list ?x17625)))
 (let ((?x19221 (g_status_handler ?x17625)))
 (let ((?x20002 (g_default_gicstate ?x17625)))
 (let ((?x13429 (g_pri_res0_mask ?x17625)))
 (let ((?x19762 (g_max_vintid ?x17625)))
 (let ((?x22246 (g_nr_aprs ?x17625)))
 (let ((?x20001 (g_nr_lrs ?x17625)))
 (let ((?x19783 (g_vmids ?x17625)))
 (let ((?x13438 (g_vmid_lock ?x17625)))
 (let ((?x19898 (g_vmid_count ?x17625)))
 (let ((?x12430 (g_debug_exits ?x17625)))
 (let ((?x19798 (g_heap ?x17625)))
 (let ((?x19874 (mkGLOBALS ?x19798 ?x12430 ?x19898 ?x13438 ?x19783 ?x20001 ?x22246 ?x19762 ?x13429 ?x20002 ?x19221 ?x19206 ?x22041 ?x19859 ?x20012 ?x19980 ?x19901 ?x22058 ?x19999 ?x19663 ?x19722 ?x19921 ?x22272 ?x20004 ?x19915 ?x22279 ?x19076 ?x17977 ?x19813 ?x20029 ?x19818)))
 (let ((?x19989 (mkr_granule_data (gd_g_idx (select (granule_data ?x22053) offset.2563805)) (g_granule_state (select (granule_data ?x22053) offset.2563805)) zero_granule_data (g_rd (select (granule_data ?x22053) offset.2563805)) (g_rec (select (granule_data ?x22053) offset.2563805)))))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x19728 (store ?x19742 offset.2563805 ?x19989)))
 (let ((?x19694 (gpt ?x22053)))
 (let ((?x19387 (priv ?x5286)))
 (let ((?x18916 (repl ?x5286)))
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x19807 (rtt_walk_abs.0_call (mkRData ?x18264 ?x18798 ?x18916 ?x19387 (mkShared ?x19694 ?x19728 ?x19874) ?x22336 $x18581) rtt_gidx.2563803 ipa_gidx.2563803)))
 (let ((?x19938 (g_granule_state (select ?x19728 ?x19807))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2563803))))
 (or (= ?x19938 4) $x176 (= ?x19807 (- 1)) (not (= (e_state_s_granule (select ?x19921 rtt_gidx.2563803)) 5)) (= ?x19938 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x19801 (forall ((rtt_gidx.2563704 Int) (ipa_gidx.2563704 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17625 (globals ?x22053)))
 (let ((?x18905 (g_granules ?x17625)))
 (let ((?x19576 (e_state_s_granule (select ?x18905 rtt_gidx.2563704))))
 (let (($x18810 (not (= ?x19576 5))))
 (let ((?x18067 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2563704 ipa_gidx.2563704)))
 (let (($x34768 (= ?x18067 (- 1))))
 (let ((?x19837 (g_granule_state (select (granule_data ?x22053) ?x18067))))
 (let (($x20075 (= ?x19837 6)))
 (let (($x4330 (= ?x19837 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2563704))))
 (or $x176 $x4330 $x20075 $x34768 $x18810)))))))))))))))))))))))))))))))))
 ))
 (let (($x19914 (not $x19801)))
 (or $x19914 $x16878)))))
 )
(assert
 (forall ((parent_gidx.2564749 Int) (pte_z.2564749 Int) (x.2564749 Int) (y.2564749 Int) (z.2564749 Int) )(let (($x20126 (forall ((rtt_gidx.2564747 Int) (ipa_gidx.2564747 Int) )(let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2564749))) 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x17625 (globals ?x22053)))
 (let ((?x18905 (g_granules ?x17625)))
 (let ((?x19899 (select ?x18905 ?x1845)))
 (let ((?x20037 (store ?x18905 ?x1845 (mks_granule (e_lock ?x19899) 4 (e_ref ?x19899)))))
 (let (($x18581 (halt ?x5286)))
 (let ((?x22336 (stack ?x5286)))
 (let ((?x19818 (g_realm_attest_private_key ?x17625)))
 (let ((?x20029 (g_get_realm_identity_identity ?x17625)))
 ...
 (let ((?x12430 (g_debug_exits ?x17625)))
 (let ((?x19798 (g_heap ?x17625)))
 (let ((?x19471 (mkGLOBALS ?x19798 ?x12430 ?x19898 ?x13438 ?x19783 ?x20001 ?x22246 ?x19762 ?x13429 ?x20002 ?x19221 ?x19206 ?x22041 ?x19859 ?x20012 ?x19980 ?x19901 ?x22058 ?x19999 ?x19663 ?x19722 ?x20037 ?x22272 ?x20004 ?x19915 ?x22279 ?x19076 ?x17977 ?x19813 ?x20029 ?x19818)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2564749)) x.2564749 y.2564749 z.2564749))))
 (let ((?x1892 (mod parent_gidx.2564749 4096)))
 (let ((?x19754 (store (g_norm (select (granule_data ?x22053) (div parent_gidx.2564749 4096))) ?x1892 ?x1891)))
 (let ((?x20273 (mkr_granule_data (gd_g_idx (select (granule_data ?x22053) (div parent_gidx.2564749 4096))) (g_granule_state (select (granule_data ?x22053) (div parent_gidx.2564749 4096))) ?x19754 (g_rd (select (granule_data ?x22053) (div parent_gidx.2564749 4096))) (g_rec (select (granule_data ?x22053) (div parent_gidx.2564749 4096))))))
 (let ((?x1886 (div parent_gidx.2564749 4096)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x20317 (store ?x19742 ?x1886 ?x20273)))
 (let ((?x19694 (gpt ?x22053)))
 (let ((?x19387 (priv ?x5286)))
 (let ((?x18916 (repl ?x5286)))
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x19328 (rtt_walk_abs.0_call (mkRData ?x18264 ?x18798 ?x18916 ?x19387 (mkShared ?x19694 ?x20317 ?x19471) ?x22336 $x18581) rtt_gidx.2564747 ipa_gidx.2564747)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2564747))))
 (or $x176 (= (g_granule_state (select ?x20317 ?x19328)) 4) (= (g_granule_state (select ?x20317 ?x19328)) 6) (= ?x19328 (- 1)) (not (= (e_state_s_granule (select ?x20037 rtt_gidx.2564747)) 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x20092 (forall ((rtt_gidx.2564551 Int) (ipa_gidx.2564551 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x65104 (spinlock_release_spec.0_call ?x12290 ?x3355)))
 (let ((?x5286 (value_RData ?x65104)))
 (let ((?x18067 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2564551 ipa_gidx.2564551)))
 (let ((?x22053 (share ?x5286)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x19837 (g_granule_state (select ?x19742 ?x18067))))
 (let (($x20075 (= ?x19837 6)))
 (let (($x4330 (= ?x19837 4)))
 (let (($x18810 (not (= (e_state_s_granule (select (g_granules (globals ?x22053)) rtt_gidx.2564551)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2564551))))
 (let (($x34768 (= ?x18067 (- 1))))
 (or $x34768 $x176 $x18810 $x4330 $x20075)))))))))))))))))))))))))))))))
 ))
 (let (($x19985 (not $x20092)))
 (or $x19985 $x20126)))))
 )
(assert
 (forall ((offset.2565156 Int) )(let (($x19834 (forall ((rtt_gidx.2565154 Int) (ipa_gidx.2565154 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x20004 (g_rmm_attest_public_key ?x17625)))
 (let ((?x22272 (g_rmm_attest_signing_key ?x17625)))
 (let ((?x20324 (mks_granule (e_lock (select (g_granules ?x17625) offset.2565156)) 4 (e_ref (select (g_granules ?x17625) offset.2565156)))))
 (let ((?x18905 (g_granules ?x17625)))
 (let ((?x20034 (store ?x18905 offset.2565156 ?x20324)))
 (let ((?x19722 (g_mbedtls_mem_buf ?x17625)))
 (let ((?x19663 (g_tt_l1_upper ?x17625)))
 (let ((?x19999 (g_tt_l2_mem1_3 ?x17625)))
 (let ((?x22058 (g_tt_l2_mem1_2 ?x17625)))
 ...
 (let ((?x12430 (g_debug_exits ?x17625)))
 (let ((?x19798 (g_heap ?x17625)))
 (let ((?x20153 (mkGLOBALS ?x19798 ?x12430 ?x19898 ?x13438 ?x19783 ?x20001 ?x22246 ?x19762 ?x13429 ?x20002 ?x19221 ?x19206 ?x22041 ?x19859 ?x20012 ?x19980 ?x19901 ?x22058 ?x19999 ?x19663 ?x19722 ?x20034 ?x22272 ?x20004 ?x19915 ?x22279 ?x19076 ?x17977 ?x19813 ?x20029 ?x19818)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x19694 (gpt ?x22053)))
 (let ((?x19387 (priv ?x5286)))
 (let ((?x18916 (repl ?x5286)))
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x20072 (rtt_walk_abs.0_call (mkRData ?x18264 ?x18798 ?x18916 ?x19387 (mkShared ?x19694 ?x19742 ?x20153) ?x22336 $x18581) rtt_gidx.2565154 ipa_gidx.2565154)))
 (let ((?x20366 (g_granule_state (select ?x19742 ?x20072))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2565154))))
 (or (= ?x20366 4) (= ?x20072 (- 1)) $x176 (not (= (e_state_s_granule (select ?x20034 rtt_gidx.2565154)) 5)) (= ?x20366 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x19960 (forall ((rtt_gidx.2565089 Int) (ipa_gidx.2565089 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2565089))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x17625 (globals ?x22053)))
 (let ((?x18905 (g_granules ?x17625)))
 (let ((?x19576 (e_state_s_granule (select ?x18905 rtt_gidx.2565089))))
 (let (($x18810 (not (= ?x19576 5))))
 (let ((?x19837 (g_granule_state (select (granule_data ?x22053) (rtt_walk_abs.0_call ?x5286 rtt_gidx.2565089 ipa_gidx.2565089)))))
 (let (($x20075 (= ?x19837 6)))
 (let (($x4330 (= ?x19837 4)))
 (let ((?x18067 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2565089 ipa_gidx.2565089)))
 (let (($x34768 (= ?x18067 (- 1))))
 (or $x34768 $x4330 $x20075 $x18810 $x176)))))))))))))))))))))))))))))))))
 ))
 (let (($x19737 (not $x19960)))
 (or $x19737 $x19834)))))
 )
(assert
 (forall ((rtt_gidx.2565258 Int) (ipa_gidx.2565258 Int) (i.2565258 Int) (d.2565258 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18798 (oracle ?x5286)))
 (let ((?x18264 (log ?x5286)))
 (let ((?x20495 (mkRData ?x18264 ?x18798 ?x18916 ?x19387 (mkShared ?x19694 (store (granule_data ?x22053) i.2565258 d.2565258) ?x17625) ?x22336 $x18581)))
 (let ((?x19864 (+ (rtt_walk_abs.0_call ?x5286 rtt_gidx.2565258 ipa_gidx.2565258) (* (- 1) (rtt_walk_abs.0_call ?x20495 rtt_gidx.2565258 ipa_gidx.2565258)))))
 (let (($x18810 (not (= (e_state_s_granule (select (g_granules ?x17625) i.2565258)) 5))))
 (let (($x19697 (and $x18810 (not (= (e_state_s_granule (select (g_granules ?x17625) i.2565258)) 4)))))
 (=> $x19697 (= ?x19864 0))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x20332 (forall ((rtt_gidx.2565337 Int) (ipa_gidx.2565337 Int) (data_gidx.2565337 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x65104 (spinlock_release_spec.0_call ?x12290 ?x3355)))
 (let ((?x5286 (value_RData ?x65104)))
 (let ((?x19555 (rtt_walk_abs.0_call ?x5286 rtt_gidx.2565337 ipa_gidx.2565337)))
 (let ((?x22053 (share ?x5286)))
 (let ((?x19742 (granule_data ?x22053)))
 (let ((?x18946 (g_granule_state (select ?x19742 ?x19555))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2565337)))
 (let (($x19693 (=> $x153 (or (= ?x18946 4) (= ?x18946 6)))))
 (let (($x19540 (= (e_state_s_granule (select (g_granules (globals ?x22053)) rtt_gidx.2565337)) 5)))
 (=> (and $x19540 (and (distinct ?x19555 (- 1)) true) $x153) (or (= ?x18946 4) (= ?x18946 6)))))))))))))))))))))))))))))))
 ))
 (not $x20332)))
(check-sat)

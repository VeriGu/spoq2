...
(assert
 ...
 (let (($x28240 (= ?x28239 0)))
 (let (($x28276 (and $x28240 $x36170 $x36123)))
 (not $x28276))))))))))))))))))))))))))))))))
(assert
...
(assert
 (let (($x7512 (forall ((rtt_gidx.2528115 Int) (ipa_gidx.2528115 Int) (data_gidx.2528115 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x4728 (g_rmm_attest_public_key ?x4409)))
 (let ((?x4556 (g_rmm_attest_signing_key ?x4409)))
 (let ((?x9443 (mks_granule (e_lock (select (g_granules ?x4409) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x4409) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x4396 (g_granules ?x4409)))
 ...
 (let ((?x9155 (rtt_walk_abs.0_call ?x9451 rtt_gidx.2528115 ipa_gidx.2528115)))
 (let ((?x24575 (g_granule_state (select ?x4519 ?x9155))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2528115)))
 (let (($x7786 (=> (and (and (distinct ?x9155 (- 1)) true) $x153) (or (= ?x24575 4) (= ?x24575 6)))))
 (=> (and (= (e_state_s_granule (select ?x9440 rtt_gidx.2528115)) 5) (and (distinct ?x9155 (- 1)) true) $x153) (or (= ?x24575 4) (= ?x24575 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7512)))
(check-sat)

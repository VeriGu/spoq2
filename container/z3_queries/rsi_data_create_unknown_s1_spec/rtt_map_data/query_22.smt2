...
(assert
 ...
 (not $x36219))))))))))
(assert
 (forall ((rtt_gidx.66608 Int) (ipa_gidx.66608 Int) (data_gidx.66608 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.66608 ipa_gidx.66608)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.66608)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.66608)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 )
(assert
 (forall ((parent_gidx.101094 Int) (pte_z.101094 Int) (x.101094 Int) (y.101094 Int) (z.101094 Int) )(let (($x1912 (forall ((rtt_gidx.101092 Int) (ipa_gidx.101092 Int) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 ...
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.101094))) 4096)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x1840 (select ?x35 ?x1845)))
 (let ((?x1884 (store ?x35 ?x1845 (mks_granule (e_lock ?x1840) 4 (e_ref ?x1840)))))
 ...
 (let ((?x50 (g_heap ?x31)))
 (let ((?x1885 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x1884 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.101094)) x.101094 y.101094 z.101094))))
 (let ((?x1892 (mod parent_gidx.101094 4096)))
 (let ((?x1875 (store (g_norm (select (granule_data ?x15) (div parent_gidx.101094 4096))) ?x1892 ?x1891)))
 (let ((?x1856 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) (div parent_gidx.101094 4096))) (g_granule_state (select (granule_data ?x15) (div parent_gidx.101094 4096))) ?x1875 (g_rd (select (granule_data ?x15) (div parent_gidx.101094 4096))) (g_rec (select (granule_data ?x15) (div parent_gidx.101094 4096))))))
 (let ((?x1886 (div parent_gidx.101094 4096)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x1824 (store ?x17 ?x1886 ?x1856)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x1882 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x1824 ?x1885) ?x87 $x88) rtt_gidx.101092 ipa_gidx.101092)))
 (let ((?x1903 (g_granule_state (select ?x1824 ?x1882))))
 (let (($x1904 (= ?x1903 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.101092))))
 (let (($x1905 (= ?x1903 6)))
 (let (($x1909 (not (= (e_state_s_granule (select ?x1884 rtt_gidx.101092)) 5))))
 (let (($x1910 (= ?x1882 (- 1))))
 (or $x1910 $x1909 $x1905 $x176 $x1904))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1867 (forall ((rtt_gidx.100896 Int) (ipa_gidx.100896 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.100896)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.100896))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.100896 ipa_gidx.100896)))
 (let (($x174 (= ?x169 (- 1))))
...
(assert
 (forall ((offset.137957 Int) (empty_pte.137957 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.137957)) (- 1)))))
 (let ((?x2003 (e_state_s_granule (select (g_granules (globals (share st.0))) (div offset.137957 4096)))))
 (let (($x2015 (not (= ?x2003 5))))
 (let (($x2039 (forall ((rtt_gidx.137953 Int) (ipa_gidx.137953 Int) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.137957)))
 (let ((?x2023 (mod offset.137957 4096)))
 (let ((?x2025 (store (g_norm (select (granule_data ?x15) (div offset.137957 4096))) ?x2023 ?x2022)))
 (let ((?x2028 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) (div offset.137957 4096))) (g_granule_state (select (granule_data ?x15) (div offset.137957 4096))) ?x2025 (g_rd (select (granule_data ?x15) (div offset.137957 4096))) (g_rec (select (granule_data ?x15) (div offset.137957 4096))))))
 (let ((?x2017 (div offset.137957 4096)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x2029 (store ?x17 ?x2017 ?x2028)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2032 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x2029 ?x31) ?x87 $x88) rtt_gidx.137953 ipa_gidx.137953)))
 (let ((?x2034 (g_granule_state (select ?x2029 ?x2032))))
 (let (($x2035 (= ?x2034 4)))
 (let (($x2036 (= ?x2034 6)))
 (let (($x2037 (= ?x2032 (- 1))))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.137953)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.137953))))
 (or $x176 $x180 $x2037 $x2036 $x2035)))))))))))))))))))))))))))))
 ))
 (let (($x1989 (forall ((rtt_gidx.137840 Int) (ipa_gidx.137840 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.137840)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.137840))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.137840 ipa_gidx.137840)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
 ...
 (let (($x1968 (not $x1989)))
 (or $x1968 $x2039 $x2015 $x2000))))))))
 )
(assert
 (forall ((rtt_gidx.102002 Int) (ipa_gidx.102002 Int) (i.102002 Int) (d.102002 r_granule_data) )(let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x81 (gpt ?x15)))
 ...
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2069 (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 (store (granule_data ?x15) i.102002 d.102002) ?x31) ?x87 $x88)))
 (let ((?x2070 (rtt_walk_abs.0_call ?x2069 rtt_gidx.102002 ipa_gidx.102002)))
 (let ((?x2072 (rtt_walk_abs.0_call st.0 rtt_gidx.102002 ipa_gidx.102002)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 i.102002)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (=> (and $x180 (not (= ?x178 4))) (= (+ ?x2072 (* (- 1) ?x2070)) 0))))))))))))))))))))
 )
(assert
 (forall ((offset.114525 Int) )(let (($x2182 (forall ((rtt_gidx.114523 Int) (ipa_gidx.114523 Int) )(let ((?x2153 (mks_granule (e_lock (select (g_granules (globals (share st.0))) offset.114525)) 4 (e_ref (select (g_granules (globals (share st.0))) offset.114525)))))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x2154 (store ?x35 offset.114525 ?x2153)))
 (let (($x2171 (not (= (e_state_s_granule (select ?x2154 rtt_gidx.114523)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.114523))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x79 (g_realm_attest_private_key ?x31)))
 (let ((?x78 (g_get_realm_identity_identity ?x31)))
 ...
 (let ((?x51 (g_debug_exits ?x31)))
 (let ((?x50 (g_heap ?x31)))
 (let ((?x2172 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x2154 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2175 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x17 ?x2172) ?x87 $x88) rtt_gidx.114523 ipa_gidx.114523)))
 (let ((?x2177 (g_granule_state (select ?x17 ?x2175))))
 (let (($x2178 (= ?x2177 4)))
 (let (($x2179 (= ?x2177 6)))
 (let (($x2180 (= ?x2175 (- 1))))
 (or $x2180 $x2179 $x2178 $x176 $x2171)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2159 (forall ((rtt_gidx.114458 Int) (ipa_gidx.114458 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.114458)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.114458))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.114458 ipa_gidx.114458)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
...
(assert
 (let (($x2241 (forall ((rtt_gidx.149169 Int) (ipa_gidx.149169 Int) )(let ((?x15 (share st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x524 (|(oracle st.0)_call| ?x83)))
 (let ((?x523 (|(repl st.0)_call| ?x524 ?x15)))
 (let ((?x526 (value_Shared ?x523)))
 (let ((?x629 (globals ?x526)))
 (let ((?x630 (g_granules ?x629)))
 (let (($x678 (not (= (e_state_s_granule (select ?x630 rtt_gidx.149169)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.149169))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x503 (List_Event_concat ?x524 ?x83)))
 (let ((?x598 (mkRData ?x503 ?x84 ?x85 ?x86 ?x526 ?x87 $x88)))
 (let ((?x669 (rtt_walk_abs.0_call ?x598 rtt_gidx.149169 ipa_gidx.149169)))
 (let (($x670 (= ?x669 (- 1))))
 (let ((?x672 (g_granule_state (select (granule_data ?x526) ?x669))))
 (let (($x674 (= ?x672 4)))
 (let (($x673 (= ?x672 6)))
 (or $x673 $x674 $x670 $x176 $x678)))))))))))))))))))))))
 ))
 (let (($x2240 (forall ((rtt_gidx.149122 Int) (ipa_gidx.149122 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.149122)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.149122))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.149122 ipa_gidx.149122)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
 ...
 (or (not $x2240) $x2241))))
(assert
 (forall ((offset.169257 Int) (state.169257 Int) )(let (($x2376 (forall ((rtt_gidx.169255 Int) (ipa_gidx.169255 Int) )(let ((?x2289 (mks_granule (e_lock (select (g_granules (globals (share st.0))) offset.169257)) state.169257 (e_ref (select (g_granules (globals (share st.0))) offset.169257)))))
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x2322 (store ?x35 offset.169257 ?x2289)))
 (let (($x2373 (not (= (e_state_s_granule (select ?x2322 rtt_gidx.169255)) 5))))
 (let (($x88 (halt st.0)))
 (let ((?x87 (stack st.0)))
 (let ((?x79 (g_realm_attest_private_key ?x31)))
 (let ((?x78 (g_get_realm_identity_identity ?x31)))
 ...
 (let ((?x51 (g_debug_exits ?x31)))
 (let ((?x50 (g_heap ?x31)))
 (let ((?x2375 (mkGLOBALS ?x50 ?x51 ?x52 ?x53 ?x54 ?x55 ?x56 ?x57 ?x58 ?x59 ?x60 ?x61 ?x62 ?x63 ?x64 ?x65 ?x66 ?x67 ?x68 ?x69 ?x70 ?x2322 ?x71 ?x72 ?x73 ?x74 ?x75 ?x76 ?x77 ?x78 ?x79)))
 (let ((?x2306 (mkr_granule_data (gd_g_idx (select (granule_data ?x15) offset.169257)) (g_granule_state (select (granule_data ?x15) offset.169257)) zero_granule_data (g_rd (select (granule_data ?x15) offset.169257)) (g_rec (select (granule_data ?x15) offset.169257)))))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x2307 (store ?x17 offset.169257 ?x2306)))
 (let ((?x81 (gpt ?x15)))
 (let ((?x86 (priv st.0)))
 (let ((?x85 (repl st.0)))
 (let ((?x84 (oracle st.0)))
 (let ((?x83 (log st.0)))
 (let ((?x2310 (rtt_walk_abs.0_call (mkRData ?x83 ?x84 ?x85 ?x86 (mkShared ?x81 ?x2307 ?x2375) ?x87 $x88) rtt_gidx.169255 ipa_gidx.169255)))
 (let (($x3282 (= ?x2310 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.169255))))
 (let ((?x2312 (g_granule_state (select ?x2307 ?x2310))))
 (let (($x2351 (= ?x2312 4)))
 (let (($x2390 (= ?x2312 6)))
 (or $x2390 $x2351 $x176 $x3282 $x2373)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2290 (forall ((rtt_gidx.169156 Int) (ipa_gidx.169156 Int) )(let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x35 (g_granules ?x31)))
 (let ((?x177 (select ?x35 rtt_gidx.169156)))
 (let ((?x178 (e_state_s_granule ?x177)))
 (let (($x179 (= ?x178 5)))
 (let (($x180 (not $x179)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.169156))))
 (let ((?x169 (rtt_walk_abs.0_call st.0 rtt_gidx.169156 ipa_gidx.169156)))
 (let (($x174 (= ?x169 (- 1))))
 (let ((?x171 (g_granule_state (select (granule_data ?x15) ?x169))))
 (let (($x173 (= ?x171 4)))
 (let (($x172 (= ?x171 6)))
...
(assert
 (let (($x12207 (forall ((rtt_gidx.2535163 Int) (ipa_gidx.2535163 Int) (data_gidx.2535163 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.2535163 ipa_gidx.2535163)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2535163)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.2535163)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 ))
 (not $x12207)))
(check-sat)

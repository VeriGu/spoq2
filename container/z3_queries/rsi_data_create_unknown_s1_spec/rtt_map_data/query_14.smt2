...
(assert
 (let (($x64614 (forall ((rtt_gidx.2528234 Int) (ipa_gidx.2528234 Int) (data_gidx.2528234 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x9124 (mks_granule ?x9129 1 ?x9201)))
 (let ((?x9261 (store ?x4396 ?x3159 ?x9124)))
 (let ((?x4719 (g_mbedtls_mem_buf ?x4409)))
 (let ((?x4563 (g_tt_l1_upper ?x4409)))
 (let ((?x4547 (g_tt_l2_mem1_3 ?x4409)))
 (let ((?x4555 (g_tt_l2_mem1_2 ?x4409)))
 ...
 (let ((?x4712 (g_debug_exits ?x4409)))
 (let ((?x4704 (g_heap ?x4409)))
 (let ((?x40235 (mkGLOBALS ?x4704 ?x4712 ?x4666 ?x4672 ?x4558 ?x4542 ?x4708 ?x4706 ?x4660 ?x4668 ?x4664 ?x4661 ?x4667 ?x4709 ?x4718 ?x4721 ?x4714 ?x4555 ?x4547 ?x4563 ?x4719 ?x9261 ?x4556 ?x4728 ?x4731 ?x4724 ?x4743 ?x4729 ?x4746 ?x4740 ?x4732)))
 (let ((?x4519 (granule_data ?x2419)))
 (let ((?x4408 (gpt ?x2419)))
 (let ((?x4188 (priv ?x4102)))
 (let ((?x4258 (repl ?x4102)))
 (let ((?x4227 (oracle ?x4102)))
 (let ((?x4229 (log ?x4102)))
 (let ((?x40917 (mkRData ?x4229 ?x4227 ?x4258 ?x4188 (mkShared ?x4408 ?x4519 ?x40235) ?x4182 $x4212)))
 (let ((?x9445 (rtt_walk_abs.0_call ?x40917 rtt_gidx.2528234 ipa_gidx.2528234)))
 (let ((?x32670 (g_granule_state (select ?x4519 ?x9445))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2528234)))
 (let (($x9361 (=> (and (and (distinct ?x9445 (- 1)) true) $x153) (or (= ?x32670 4) (= ?x32670 6)))))
 (=> (and (= (e_state_s_granule (select ?x9261 rtt_gidx.2528234)) 5) (and (distinct ?x9445 (- 1)) true) $x153) (or (= ?x32670 4) (= ?x32670 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x64614)))
(check-sat)

...
(assert
 ...
 (= ?x3228 1))))))))))))))
(assert
 (forall ((rtt_gidx.2535242 Int) (ipa_gidx.2535242 Int) (data_gidx.2535242 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2383 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2535242 ipa_gidx.2535242)))
 (let ((?x2443 (share ?x2329)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2431 (g_granule_state (select ?x2445 ?x2383))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2535242)))
 (let (($x5228 (=> $x153 (or (= ?x2431 4) (= ?x2431 6)))))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x2443)) rtt_gidx.2535242)) 5)))
 (=> (and $x5214 (and (distinct ?x2383 (- 1)) true) $x153) (or (= ?x2431 4) (= ?x2431 6)))))))))))))))))
 )
(assert
 (let (($x12126 (forall ((rtt_gidx.2535598 Int) (ipa_gidx.2535598 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2443 (share ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x2384 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
  (oracle (value_RData (spinlock_acquire_spec.0_call a!1 st.0))))_call| ?x2537)))
 (let ((?x5233 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
  (repl (value_RData (spinlock_acquire_spec.0_call a!1 st.0))))_call| ?x2384 ?x2443)))
 (let ((?x5219 (value_Shared ?x5233)))
 (let ((?x2489 (globals ?x5219)))
 (let ((?x2486 (g_granules ?x2489)))
 (let (($x2562 (not (= (e_state_s_granule (select ?x2486 rtt_gidx.2535598)) 5))))
 (let (($x2369 (halt ?x2329)))
 (let ((?x2362 (stack ?x2329)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2365 (List_Event_concat ?x2384 ?x2537)))
 (let ((?x5236 (mkRData ?x2365 ?x2534 ?x5217 ?x2380 ?x5219 ?x2362 $x2369)))
 (let ((?x2389 (rtt_walk_abs.0_call ?x5236 rtt_gidx.2535598 ipa_gidx.2535598)))
 (let (($x2554 (= ?x2389 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2535598))))
 (let ((?x2561 (g_granule_state (select (granule_data ?x5219) ?x2389))))
 (let (($x2563 (= ?x2561 4)))
 (let (($x2565 (= ?x2561 6)))
 (or $x2565 $x2563 $x176 $x2554 $x2562)))))))))))))))))))))))))))))
 ))
 (let (($x11919 (forall ((rtt_gidx.2535551 Int) (ipa_gidx.2535551 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2535551))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2535551 ipa_gidx.2535551)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2535551))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x2550 $x176 $x2548 $x2555)))))))))))))))))))
 ))
 (or (not $x11919) $x12126))))
(assert
 (forall ((offset.2536258 Int) (empty_pte.2536258 abs_PTE_t) )(let (($x11725 (forall ((rtt_gidx.2536254 Int) (ipa_gidx.2536254 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2443 (share ?x2329)))
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2536258)))
 (let ((?x2023 (mod offset.2536258 4096)))
 (let ((?x2655 (store (g_norm (select (granule_data ?x2443) (div offset.2536258 4096))) ?x2023 ?x2022)))
 (let ((?x2652 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) (div offset.2536258 4096))) (g_granule_state (select (granule_data ?x2443) (div offset.2536258 4096))) ?x2655 (g_rd (select (granule_data ?x2443) (div offset.2536258 4096))) (g_rec (select (granule_data ?x2443) (div offset.2536258 4096))))))
 (let ((?x2017 (div offset.2536258 4096)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2656 (store ?x2445 ?x2017 ?x2652)))
 (let ((?x2592 (gpt ?x2443)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x2654 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2656 ?x2449) ?x2362 $x2369) rtt_gidx.2536254 ipa_gidx.2536254)))
 (let ((?x2661 (g_granule_state (select ?x2656 ?x2654))))
 (let (($x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) rtt_gidx.2536254)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2536254))))
 (or $x176 $x2555 (= ?x2654 (- 1)) (= ?x2661 4) (= ?x2661 6)))))))))))))))))))))))))))))
 ))
 (let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2536258)) (- 1)))))
 (let (($x12333 (forall ((rtt_gidx.2536141 Int) (ipa_gidx.2536141 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2536141))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) (rtt_walk_abs.0_call ?x2329 rtt_gidx.2536141 ipa_gidx.2536141)))))
 (let (($x2550 (= ?x2544 4)))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2536141 ipa_gidx.2536141)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let (($x2546 (= ?x2544 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2536141))))
 (or $x176 $x2546 $x2548 $x2550 $x2555)))))))))))))))))))
 ))
 (let (($x12181 (not $x12333)))
 (let ((?x2001 (div offset.2536258 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let (($x2667 (not (= (e_state_s_granule (select ?x2527 ?x2001)) 5))))
 (or $x2667 $x12181 $x2000 $x11725)))))))))))))))))
 )
(assert
 (forall ((offset.2536817 Int) (state.2536817 Int) )(let (($x12271 (forall ((rtt_gidx.2536815 Int) (ipa_gidx.2536815 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2443 (share ?x2329)))
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2730 (g_realm_attest_private_key ?x2449)))
 (let ((?x2729 (g_get_realm_identity_identity ?x2449)))
 (let ((?x2728 (g_rmm_platform_token ?x2449)))
 (let ((?x2725 (g_platform_token_buf ?x2449)))
 (let ((?x2722 (g_rmm_attest_public_key_hash_len ?x2449)))
 (let ((?x2721 (g_rmm_attest_public_key_hash ?x2449)))
 (let ((?x2723 (g_rmm_attest_public_key_len ?x2449)))
 (let ((?x2717 (g_rmm_attest_public_key ?x2449)))
 (let ((?x2718 (g_rmm_attest_signing_key ?x2449)))
 (let ((?x2766 (mks_granule (e_lock (select (g_granules ?x2449) offset.2536817)) state.2536817 (e_ref (select (g_granules ?x2449) offset.2536817)))))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2767 (store ?x2527 offset.2536817 ?x2766)))
 (let ((?x2724 (g_mbedtls_mem_buf ?x2449)))
 (let ((?x2720 (g_tt_l1_upper ?x2449)))
 (let ((?x2716 (g_tt_l2_mem1_3 ?x2449)))
 (let ((?x2712 (g_tt_l2_mem1_2 ?x2449)))
 (let ((?x2713 (g_tt_l2_mem1_1 ?x2449)))
 (let ((?x2719 (g_tt_l2_mem1_0 ?x2449)))
 (let ((?x2715 (g_tt_l2_mem0_1 ?x2449)))
 (let ((?x2711 (g_tt_l2_mem0_0 ?x2449)))
 (let ((?x2707 (g_tt_l3_buffer ?x2449)))
 (let ((?x2708 (g_rmm_trap_list ?x2449)))
 (let ((?x2714 (g_status_handler ?x2449)))
 (let ((?x2710 (g_default_gicstate ?x2449)))
 (let ((?x2706 (g_pri_res0_mask ?x2449)))
 (let ((?x2702 (g_max_vintid ?x2449)))
 (let ((?x2703 (g_nr_aprs ?x2449)))
 (let ((?x2709 (g_nr_lrs ?x2449)))
 (let ((?x2705 (g_vmids ?x2449)))
 (let ((?x2701 (g_vmid_lock ?x2449)))
 (let ((?x2697 (g_vmid_count ?x2449)))
 (let ((?x2698 (g_debug_exits ?x2449)))
 (let ((?x2704 (g_heap ?x2449)))
 (let ((?x3906 (mkGLOBALS ?x2704 ?x2698 ?x2697 ?x2701 ?x2705 ?x2709 ?x2703 ?x2702 ?x2706 ?x2710 ?x2714 ?x2708 ?x2707 ?x2711 ?x2715 ?x2719 ?x2713 ?x2712 ?x2716 ?x2720 ?x2724 ?x2767 ?x2718 ?x2717 ?x2723 ?x2721 ?x2722 ?x2725 ?x2728 ?x2729 ?x2730)))
 (let ((?x2859 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) offset.2536817)) (g_granule_state (select (granule_data ?x2443) offset.2536817)) zero_granule_data (g_rd (select (granule_data ?x2443) offset.2536817)) (g_rec (select (granule_data ?x2443) offset.2536817)))))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2874 (store ?x2445 offset.2536817 ?x2859)))
 (let ((?x2592 (gpt ?x2443)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x2892 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2874 ?x3906) ?x2362 $x2369) rtt_gidx.2536815 ipa_gidx.2536815)))
 (let (($x2848 (= ?x2892 (- 1))))
 (let ((?x3952 (g_granule_state (select ?x2874 ?x2892))))
 (let (($x3954 (= ?x3952 4)))
 (let (($x2865 (= ?x3952 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2536815))))
 (let (($x2850 (not (= (e_state_s_granule (select ?x2767 rtt_gidx.2536815)) 5))))
 (or $x2850 $x176 $x2865 $x3954 $x2848)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x11285 (forall ((rtt_gidx.2536716 Int) (ipa_gidx.2536716 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2536716 ipa_gidx.2536716)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2536716))))
 (let ((?x2549 (e_state_s_granule (select (g_granules (globals (share ?x2329))) rtt_gidx.2536716))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2544 (g_granule_state (select (granule_data (share ?x2329)) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x2550 $x2555 $x176 $x2548))))))))))))))))
 ))
 (let (($x12441 (not $x11285)))
 (or $x12441 $x12271)))))
 )
(assert
 (forall ((parent_gidx.2537761 Int) (pte_z.2537761 Int) (x.2537761 Int) (y.2537761 Int) (z.2537761 Int) )(let (($x12616 (forall ((rtt_gidx.2537759 Int) (ipa_gidx.2537759 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2537759))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x2717 (g_rmm_attest_public_key ?x2449)))
 (let ((?x2718 (g_rmm_attest_signing_key ?x2449)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2537761))) 4096)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2978 (select ?x2527 ?x1845)))
 (let ((?x2986 (store ?x2527 ?x1845 (mks_granule (e_lock ?x2978) 4 (e_ref ?x2978)))))
 (let ((?x2724 (g_mbedtls_mem_buf ?x2449)))
 (let ((?x2720 (g_tt_l1_upper ?x2449)))
 (let ((?x2716 (g_tt_l2_mem1_3 ?x2449)))
 (let ((?x2712 (g_tt_l2_mem1_2 ?x2449)))
 ...
 (let ((?x2698 (g_debug_exits ?x2449)))
 (let ((?x2704 (g_heap ?x2449)))
 (let ((?x3010 (mkGLOBALS ?x2704 ?x2698 ?x2697 ?x2701 ?x2705 ?x2709 ?x2703 ?x2702 ?x2706 ?x2710 ?x2714 ?x2708 ?x2707 ?x2711 ?x2715 ?x2719 ?x2713 ?x2712 ?x2716 ?x2720 ?x2724 ?x2986 ?x2718 ?x2717 ?x2723 ?x2721 ?x2722 ?x2725 ?x2728 ?x2729 ?x2730)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2537761)) x.2537761 y.2537761 z.2537761))))
 (let ((?x1892 (mod parent_gidx.2537761 4096)))
 (let ((?x3027 (store (g_norm (select (granule_data ?x2443) (div parent_gidx.2537761 4096))) ?x1892 ?x1891)))
 (let ((?x3039 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) (div parent_gidx.2537761 4096))) (g_granule_state (select (granule_data ?x2443) (div parent_gidx.2537761 4096))) ?x3027 (g_rd (select (granule_data ?x2443) (div parent_gidx.2537761 4096))) (g_rec (select (granule_data ?x2443) (div parent_gidx.2537761 4096))))))
 (let ((?x1886 (div parent_gidx.2537761 4096)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x3035 (store ?x2445 ?x1886 ?x3039)))
 (let ((?x2592 (gpt ?x2443)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3024 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x3035 ?x3010) ?x2362 $x2369) rtt_gidx.2537759 ipa_gidx.2537759)))
 (let ((?x3042 (g_granule_state (select ?x3035 ?x3024))))
 (let (($x3036 (= ?x3042 6)))
 (let (($x3031 (= ?x3024 (- 1))))
 (let (($x3029 (= ?x3042 4)))
 (let (($x3041 (not (= (e_state_s_granule (select ?x2986 rtt_gidx.2537759)) 5))))
 (or $x3041 $x3029 $x3031 $x3036 $x176))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12627 (forall ((rtt_gidx.2537563 Int) (ipa_gidx.2537563 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2537563))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2537563))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2537563 ipa_gidx.2537563)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x2550 $x2548 $x2555 $x176)))))))))))))))))))
 ))
 (let (($x12500 (not $x12627)))
 (or $x12500 $x12616)))))
 )
(assert
 (forall ((offset.2538168 Int) )(let (($x11800 (forall ((rtt_gidx.2538166 Int) (ipa_gidx.2538166 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x5211 (select ?x2527 offset.2538168)))
 (let ((?x3095 (store ?x2527 offset.2538168 (mks_granule (e_lock ?x5211) 4 (e_ref ?x5211)))))
 (let (($x2369 (halt ?x2329)))
 (let ((?x2362 (stack ?x2329)))
 (let ((?x2730 (g_realm_attest_private_key ?x2449)))
 (let ((?x2729 (g_get_realm_identity_identity ?x2449)))
 ...
 (let ((?x2698 (g_debug_exits ?x2449)))
 (let ((?x2704 (g_heap ?x2449)))
 (let ((?x3110 (mkGLOBALS ?x2704 ?x2698 ?x2697 ?x2701 ?x2705 ?x2709 ?x2703 ?x2702 ?x2706 ?x2710 ?x2714 ?x2708 ?x2707 ?x2711 ?x2715 ?x2719 ?x2713 ?x2712 ?x2716 ?x2720 ?x2724 ?x3095 ?x2718 ?x2717 ?x2723 ?x2721 ?x2722 ?x2725 ?x2728 ?x2729 ?x2730)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2592 (gpt ?x2443)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3130 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2445 ?x3110) ?x2362 $x2369) rtt_gidx.2538166 ipa_gidx.2538166)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2538166))))
 (or (= (g_granule_state (select ?x2445 ?x3130)) 6) (= (g_granule_state (select ?x2445 ?x3130)) 4) $x176 (= ?x3130 (- 1)) (not (= (e_state_s_granule (select ?x3095 rtt_gidx.2538166)) 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x12559 (forall ((rtt_gidx.2538101 Int) (ipa_gidx.2538101 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2538101 ipa_gidx.2538101)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let ((?x2549 (e_state_s_granule (select (g_granules (globals (share ?x2329))) rtt_gidx.2538101))))
 (let (($x2555 (not (= ?x2549 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2538101))))
 (let ((?x2544 (g_granule_state (select (granule_data (share ?x2329)) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x2550 $x176 $x2555 $x2548))))))))))))))))
 ))
 (let (($x12644 (not $x12559)))
 (or $x12644 $x11800)))))
 )
(assert
 (forall ((rtt_gidx.2538270 Int) (ipa_gidx.2538270 Int) (i.2538270 Int) (d.2538270 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3144 (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 (store (granule_data ?x2443) i.2538270 d.2538270) ?x2449) ?x2362 $x2369)))
 (let ((?x3154 (+ (rtt_walk_abs.0_call ?x2329 rtt_gidx.2538270 ipa_gidx.2538270) (* (- 1) (rtt_walk_abs.0_call ?x3144 rtt_gidx.2538270 ipa_gidx.2538270)))))
 (let (($x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) i.2538270)) 5))))
 (let (($x3155 (and $x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) i.2538270)) 4)))))
 (=> $x3155 (= ?x3154 0))))))))))))))))))))))
 )
(assert
 (let (($x12733 (forall ((rtt_gidx.2538349 Int) (ipa_gidx.2538349 Int) (data_gidx.2538349 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2383 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2538349 ipa_gidx.2538349)))
 (let ((?x2443 (share ?x2329)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2431 (g_granule_state (select ?x2445 ?x2383))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2538349)))
 (let (($x5228 (=> $x153 (or (= ?x2431 4) (= ?x2431 6)))))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x2443)) rtt_gidx.2538349)) 5)))
 (=> (and $x5214 (and (distinct ?x2383 (- 1)) true) $x153) (or (= ?x2431 4) (= ?x2431 6)))))))))))))))))
 ))
 (not $x12733)))
(check-sat)

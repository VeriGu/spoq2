...
(assert
 (let (($x43937 (forall ((rtt_gidx.2568523 Int) (ipa_gidx.2568523 Int) (data_gidx.2568523 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x19391 (value_Tuple_abs_ret_rtt_RData ?x193381)))
 (let ((?x20259 (elem_1 ?x19391)))
 (let ((?x20443 (rtt_walk_abs.0_call ?x20259 rtt_gidx.2568523 ipa_gidx.2568523)))
 (let ((?x20152 (share ?x20259)))
 (let ((?x20644 (granule_data ?x20152)))
 (let ((?x19657 (g_granule_state (select ?x20644 ?x20443))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2568523)))
 (let (($x20551 (=> $x153 (or (= ?x19657 4) (= ?x19657 6)))))
 (let (($x20055 (= (e_state_s_granule (select (g_granules (globals ?x20152)) rtt_gidx.2568523)) 5)))
 (=> (and $x20055 (and (distinct ?x20443 (- 1)) true) $x153) (or (= ?x19657 4) (= ?x19657 6)))))))))))))))))))))))))))))))))))
 ))
 (not $x43937)))
(check-sat)

...
(assert
 ...
 (not $x28329)))))))))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.2521270 Int) (ipa_gidx.2521270 Int) (data_gidx.2521270 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x30866 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2521270 ipa_gidx.2521270)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x53967 (g_granule_state (select ?x7611 ?x30866))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2521270)))
 (let (($x7165 (=> $x153 (or (= ?x53967 4) (= ?x53967 6)))))
 (let (($x7245 (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2521270)) 5)))
 (=> (and $x7245 (and (distinct ?x30866 (- 1)) true) $x153) (or (= ?x53967 4) (= ?x53967 6)))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x7615 (forall ((rtt_gidx.2521626 Int) (ipa_gidx.2521626 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x7310 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr a!4 a!5)
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
  (oracle (value_RData (spinlock_release_spec.0_call (mkPtr a!4 a!5) a!6))))))))_call| ?x46239)))
 (let ((?x53795 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr a!4 a!5)
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
  (repl (value_RData (spinlock_release_spec.0_call (mkPtr a!4 a!5) a!6))))))))_call| ?x7310 ?x30953)))
 (let ((?x7281 (value_Shared ?x53795)))
 (let ((?x30959 (globals ?x7281)))
 (let ((?x30984 (g_granules ?x30959)))
 (let (($x7297 (halt ?x7014)))
 (let ((?x6586 (stack ?x7014)))
 (let ((?x7383 (priv ?x7014)))
 (let ((?x38559 (repl ?x7014)))
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x7331 (List_Event_concat ?x7310 ?x46239)))
 (let ((?x7623 (mkRData ?x7331 ?x7243 ?x38559 ?x7383 ?x7281 ?x6586 $x7297)))
 (let ((?x7561 (rtt_walk_abs.0_call ?x7623 rtt_gidx.2521626 ipa_gidx.2521626)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2521626))))
 (or (= (g_granule_state (select (granule_data ?x7281) ?x7561)) 6) $x176 (= (g_granule_state (select (granule_data ?x7281) ?x7561)) 4) (= ?x7561 (- 1)) (not (= (e_state_s_granule (select ?x30984 rtt_gidx.2521626)) 5))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7565 (forall ((rtt_gidx.2521579 Int) (ipa_gidx.2521579 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x73747 (spinlock_release_spec.0_call ?x28250 ?x36171)))
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30205 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2521579 ipa_gidx.2521579)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7543 (g_granule_state (select ?x7611 ?x30205))))
 (let (($x7584 (= ?x7543 6)))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2521579)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2521579))))
 (let (($x6821 (= ?x30205 (- 1))))
 (let (($x7401 (= ?x7543 4)))
 (or $x7401 $x6821 $x176 $x7586 $x7584)))))))))))))))))))))))))))))))))))
 ))
 (or (not $x7565) $x7615))))
(assert
 (forall ((offset.2522286 Int) (empty_pte.2522286 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2522286)) (- 1)))))
 (let ((?x2001 (div offset.2522286 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let (($x7685 (forall ((rtt_gidx.2522282 Int) (ipa_gidx.2522282 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x30953 (share ?x7014)))
 (let ((?x53949 (globals ?x30953)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2522286)))
 (let ((?x2023 (mod offset.2522286 4096)))
 (let ((?x7669 (store (g_norm (select (granule_data ?x30953) (div offset.2522286 4096))) ?x2023 ?x2022)))
 (let ((?x7663 (mkr_granule_data (gd_g_idx (select (granule_data ?x30953) (div offset.2522286 4096))) (g_granule_state (select (granule_data ?x30953) (div offset.2522286 4096))) ?x7669 (g_rd (select (granule_data ?x30953) (div offset.2522286 4096))) (g_rec (select (granule_data ?x30953) (div offset.2522286 4096))))))
 (let ((?x2017 (div offset.2522286 4096)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7664 (store ?x7611 ?x2017 ?x7663)))
 (let ((?x31133 (gpt ?x30953)))
 (let ((?x7383 (priv ?x7014)))
 (let ((?x38559 (repl ?x7014)))
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x7674 (rtt_walk_abs.0_call (mkRData ?x46239 ?x7243 ?x38559 ?x7383 (mkShared ?x31133 ?x7664 ?x53949) ?x6586 $x7297) rtt_gidx.2522282 ipa_gidx.2522282)))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules ?x53949) rtt_gidx.2522282)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2522282))))
 (or $x176 (= (g_granule_state (select ?x7664 ?x7674)) 6) $x7586 (= (g_granule_state (select ?x7664 ?x7674)) 4) (= ?x7674 (- 1)))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7649 (forall ((rtt_gidx.2522169 Int) (ipa_gidx.2522169 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x53949 (globals ?x30953)))
 (let ((?x53782 (g_granules ?x53949)))
 (let ((?x7460 (e_state_s_granule (select ?x53782 rtt_gidx.2522169))))
 (let (($x7586 (not (= ?x7460 5))))
 (let ((?x7543 (g_granule_state (select (granule_data ?x30953) (rtt_walk_abs.0_call ?x7014 rtt_gidx.2522169 ipa_gidx.2522169)))))
 (let (($x7584 (= ?x7543 6)))
 (let (($x7401 (= ?x7543 4)))
 (let ((?x30205 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2522169 ipa_gidx.2522169)))
 (let (($x6821 (= ?x30205 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2522169))))
 (or $x176 $x6821 $x7401 $x7584 $x7586)))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7631 (not $x7649)))
 (or $x7631 $x7685 (not (= (e_state_s_granule (select ?x53782 ?x2001)) 5)) $x2000))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2522845 Int) (state.2522845 Int) )(let (($x7866 (forall ((rtt_gidx.2522843 Int) (ipa_gidx.2522843 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x30953 (share ?x7014)))
 (let ((?x53949 (globals ?x30953)))
 (let ((?x7769 (g_realm_attest_private_key ?x53949)))
 (let ((?x6947 (g_get_realm_identity_identity ?x53949)))
 (let ((?x7753 (g_rmm_platform_token ?x53949)))
 (let ((?x7715 (g_platform_token_buf ?x53949)))
 (let ((?x7733 (g_rmm_attest_public_key_hash_len ?x53949)))
 (let ((?x7730 (g_rmm_attest_public_key_hash ?x53949)))
 (let ((?x7765 (g_rmm_attest_public_key_len ?x53949)))
 (let ((?x7762 (g_rmm_attest_public_key ?x53949)))
 (let ((?x7766 (g_rmm_attest_signing_key ?x53949)))
 (let ((?x7728 (mks_granule (e_lock (select (g_granules ?x53949) offset.2522845)) state.2522845 (e_ref (select (g_granules ?x53949) offset.2522845)))))
 (let ((?x53782 (g_granules ?x53949)))
 (let ((?x7729 (store ?x53782 offset.2522845 ?x7728)))
 (let ((?x7774 (g_mbedtls_mem_buf ?x53949)))
 (let ((?x7742 (g_tt_l1_upper ?x53949)))
 (let ((?x7582 (g_tt_l2_mem1_3 ?x53949)))
 (let ((?x7741 (g_tt_l2_mem1_2 ?x53949)))
 (let ((?x7749 (g_tt_l2_mem1_1 ?x53949)))
 (let ((?x7696 (g_tt_l2_mem1_0 ?x53949)))
 (let ((?x7704 (g_tt_l2_mem0_1 ?x53949)))
 (let ((?x7703 (g_tt_l2_mem0_0 ?x53949)))
 (let ((?x7204 (g_tt_l3_buffer ?x53949)))
 (let ((?x6939 (g_rmm_trap_list ?x53949)))
 (let ((?x7756 (g_status_handler ?x53949)))
 (let ((?x7764 (g_default_gicstate ?x53949)))
 (let ((?x7711 (g_pri_res0_mask ?x53949)))
 (let ((?x7763 (g_max_vintid ?x53949)))
 (let ((?x7760 (g_nr_aprs ?x53949)))
 (let ((?x7757 (g_nr_lrs ?x53949)))
 (let ((?x6926 (g_vmids ?x53949)))
 (let ((?x3776 (g_vmid_lock ?x53949)))
 (let ((?x7748 (g_vmid_count ?x53949)))
 (let ((?x7745 (g_debug_exits ?x53949)))
 (let ((?x7581 (g_heap ?x53949)))
 (let ((?x7808 (mkGLOBALS ?x7581 ?x7745 ?x7748 ?x3776 ?x6926 ?x7757 ?x7760 ?x7763 ?x7711 ?x7764 ?x7756 ?x6939 ?x7204 ?x7703 ?x7704 ?x7696 ?x7749 ?x7741 ?x7582 ?x7742 ?x7774 ?x7729 ?x7766 ?x7762 ?x7765 ?x7730 ?x7733 ?x7715 ?x7753 ?x6947 ?x7769)))
 (let ((?x7422 (mkr_granule_data (gd_g_idx (select (granule_data ?x30953) offset.2522845)) (g_granule_state (select (granule_data ?x30953) offset.2522845)) zero_granule_data (g_rd (select (granule_data ?x30953) offset.2522845)) (g_rec (select (granule_data ?x30953) offset.2522845)))))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7495 (store ?x7611 offset.2522845 ?x7422)))
 (let ((?x31133 (gpt ?x30953)))
 (let ((?x7383 (priv ?x7014)))
 (let ((?x38559 (repl ?x7014)))
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x7709 (rtt_walk_abs.0_call (mkRData ?x46239 ?x7243 ?x38559 ?x7383 (mkShared ?x31133 ?x7495 ?x7808) ?x6586 $x7297) rtt_gidx.2522843 ipa_gidx.2522843)))
 (let ((?x7509 (g_granule_state (select ?x7495 ?x7709))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2522843))))
 (or (= ?x7709 (- 1)) (not (= (e_state_s_granule (select ?x7729 rtt_gidx.2522843)) 5)) $x176 (= ?x7509 6) (= ?x7509 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7805 (forall ((rtt_gidx.2522744 Int) (ipa_gidx.2522744 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x73747 (spinlock_release_spec.0_call ?x28250 ?x36171)))
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30205 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2522744 ipa_gidx.2522744)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7543 (g_granule_state (select ?x7611 ?x30205))))
 (let (($x7584 (= ?x7543 6)))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2522744)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2522744))))
 (let (($x6821 (= ?x30205 (- 1))))
 (let (($x7401 (= ?x7543 4)))
 (or $x7401 $x6821 $x176 $x7586 $x7584)))))))))))))))))))))))))))))))))))
 ))
...
(assert
 (forall ((parent_gidx.2523789 Int) (pte_z.2523789 Int) (x.2523789 Int) (y.2523789 Int) (z.2523789 Int) )(let (($x7979 (forall ((rtt_gidx.2523787 Int) (ipa_gidx.2523787 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x7762 (g_rmm_attest_public_key ?x53949)))
 (let ((?x7766 (g_rmm_attest_signing_key ?x53949)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2523789))) 4096)))
 (let ((?x53782 (g_granules ?x53949)))
 (let ((?x7898 (select ?x53782 ?x1845)))
 (let ((?x7930 (store ?x53782 ?x1845 (mks_granule (e_lock ?x7898) 4 (e_ref ?x7898)))))
 (let ((?x7774 (g_mbedtls_mem_buf ?x53949)))
 (let ((?x7742 (g_tt_l1_upper ?x53949)))
 (let ((?x7582 (g_tt_l2_mem1_3 ?x53949)))
 (let ((?x7741 (g_tt_l2_mem1_2 ?x53949)))
 ...
 (let ((?x7745 (g_debug_exits ?x53949)))
 (let ((?x7581 (g_heap ?x53949)))
 (let ((?x7978 (mkGLOBALS ?x7581 ?x7745 ?x7748 ?x3776 ?x6926 ?x7757 ?x7760 ?x7763 ?x7711 ?x7764 ?x7756 ?x6939 ?x7204 ?x7703 ?x7704 ?x7696 ?x7749 ?x7741 ?x7582 ?x7742 ?x7774 ?x7930 ?x7766 ?x7762 ?x7765 ?x7730 ?x7733 ?x7715 ?x7753 ?x6947 ?x7769)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2523789)) x.2523789 y.2523789 z.2523789))))
 (let ((?x1892 (mod parent_gidx.2523789 4096)))
 (let ((?x7971 (store (g_norm (select (granule_data ?x30953) (div parent_gidx.2523789 4096))) ?x1892 ?x1891)))
 (let ((?x7990 (mkr_granule_data (gd_g_idx (select (granule_data ?x30953) (div parent_gidx.2523789 4096))) (g_granule_state (select (granule_data ?x30953) (div parent_gidx.2523789 4096))) ?x7971 (g_rd (select (granule_data ?x30953) (div parent_gidx.2523789 4096))) (g_rec (select (granule_data ?x30953) (div parent_gidx.2523789 4096))))))
 (let ((?x1886 (div parent_gidx.2523789 4096)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7994 (store ?x7611 ?x1886 ?x7990)))
 (let ((?x31133 (gpt ?x30953)))
 (let ((?x7383 (priv ?x7014)))
 (let ((?x38559 (repl ?x7014)))
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x7993 (rtt_walk_abs.0_call (mkRData ?x46239 ?x7243 ?x38559 ?x7383 (mkShared ?x31133 ?x7994 ?x7978) ?x6586 $x7297) rtt_gidx.2523787 ipa_gidx.2523787)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2523787))))
 (or (not (= (e_state_s_granule (select ?x7930 rtt_gidx.2523787)) 5)) $x176 (= (g_granule_state (select ?x7994 ?x7993)) 6) (= (g_granule_state (select ?x7994 ?x7993)) 4) (= ?x7993 (- 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x7986 (forall ((rtt_gidx.2523591 Int) (ipa_gidx.2523591 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x73747 (spinlock_release_spec.0_call ?x28250 ?x36171)))
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30205 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2523591 ipa_gidx.2523591)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7543 (g_granule_state (select ?x7611 ?x30205))))
 (let (($x7584 (= ?x7543 6)))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2523591)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2523591))))
 (let (($x6821 (= ?x30205 (- 1))))
 (let (($x7401 (= ?x7543 4)))
 (or $x7401 $x6821 $x176 $x7586 $x7584)))))))))))))))))))))))))))))))))))
 ))
...
(assert
 (forall ((offset.2524196 Int) )(let (($x8070 (forall ((rtt_gidx.2524194 Int) (ipa_gidx.2524194 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x7762 (g_rmm_attest_public_key ?x53949)))
 (let ((?x7766 (g_rmm_attest_signing_key ?x53949)))
 (let ((?x8037 (mks_granule (e_lock (select (g_granules ?x53949) offset.2524196)) 4 (e_ref (select (g_granules ?x53949) offset.2524196)))))
 (let ((?x53782 (g_granules ?x53949)))
 (let ((?x7845 (store ?x53782 offset.2524196 ?x8037)))
 (let ((?x7774 (g_mbedtls_mem_buf ?x53949)))
 (let ((?x7742 (g_tt_l1_upper ?x53949)))
 (let ((?x7582 (g_tt_l2_mem1_3 ?x53949)))
 (let ((?x7741 (g_tt_l2_mem1_2 ?x53949)))
 ...
 (let ((?x7745 (g_debug_exits ?x53949)))
 (let ((?x7581 (g_heap ?x53949)))
 (let ((?x8017 (mkGLOBALS ?x7581 ?x7745 ?x7748 ?x3776 ?x6926 ?x7757 ?x7760 ?x7763 ?x7711 ?x7764 ?x7756 ?x6939 ?x7204 ?x7703 ?x7704 ?x7696 ?x7749 ?x7741 ?x7582 ?x7742 ?x7774 ?x7845 ?x7766 ?x7762 ?x7765 ?x7730 ?x7733 ?x7715 ?x7753 ?x6947 ?x7769)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x31133 (gpt ?x30953)))
 (let ((?x7383 (priv ?x7014)))
 (let ((?x38559 (repl ?x7014)))
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x8061 (rtt_walk_abs.0_call (mkRData ?x46239 ?x7243 ?x38559 ?x7383 (mkShared ?x31133 ?x7611 ?x8017) ?x6586 $x7297) rtt_gidx.2524194 ipa_gidx.2524194)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2524194))))
 (or (= (g_granule_state (select ?x7611 ?x8061)) 4) (= (g_granule_state (select ?x7611 ?x8061)) 6) $x176 (not (= (e_state_s_granule (select ?x7845 rtt_gidx.2524194)) 5)) (= ?x8061 (- 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x8031 (forall ((rtt_gidx.2524129 Int) (ipa_gidx.2524129 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x73747 (spinlock_release_spec.0_call ?x28250 ?x36171)))
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30205 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2524129 ipa_gidx.2524129)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x7543 (g_granule_state (select ?x7611 ?x30205))))
 (let (($x7584 (= ?x7543 6)))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2524129)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2524129))))
 (let (($x6821 (= ?x30205 (- 1))))
 (let (($x7401 (= ?x7543 4)))
 (or $x7401 $x6821 $x176 $x7586 $x7584)))))))))))))))))))))))))))))))))))
 ))
...
(assert
 (forall ((rtt_gidx.2524298 Int) (ipa_gidx.2524298 Int) (i.2524298 Int) (d.2524298 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x7243 (oracle ?x7014)))
 (let ((?x46239 (log ?x7014)))
 (let ((?x8073 (mkRData ?x46239 ?x7243 ?x38559 ?x7383 (mkShared ?x31133 (store (granule_data ?x30953) i.2524298 d.2524298) ?x53949) ?x6586 $x7297)))
 (let ((?x7963 (+ (rtt_walk_abs.0_call ?x7014 rtt_gidx.2524298 ipa_gidx.2524298) (* (- 1) (rtt_walk_abs.0_call ?x8073 rtt_gidx.2524298 ipa_gidx.2524298)))))
 (let (($x7586 (not (= (e_state_s_granule (select (g_granules ?x53949) i.2524298)) 5))))
 (let (($x8101 (and $x7586 (not (= (e_state_s_granule (select (g_granules ?x53949) i.2524298)) 4)))))
 (=> $x8101 (= ?x7963 0))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x8071 (forall ((rtt_gidx.2524377 Int) (ipa_gidx.2524377 Int) (data_gidx.2524377 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x73747 (spinlock_release_spec.0_call ?x28250 ?x36171)))
 (let ((?x7014 (value_RData ?x73747)))
 (let ((?x30866 (rtt_walk_abs.0_call ?x7014 rtt_gidx.2524377 ipa_gidx.2524377)))
 (let ((?x30953 (share ?x7014)))
 (let ((?x7611 (granule_data ?x30953)))
 (let ((?x53967 (g_granule_state (select ?x7611 ?x30866))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2524377)))
 (let (($x7165 (=> $x153 (or (= ?x53967 4) (= ?x53967 6)))))
 (let (($x7245 (= (e_state_s_granule (select (g_granules (globals ?x30953)) rtt_gidx.2524377)) 5)))
 (=> (and $x7245 (and (distinct ?x30866 (- 1)) true) $x153) (or (= ?x53967 4) (= ?x53967 6)))))))))))))))))))))))))))))))))))
 ))
 (not $x8071)))
(check-sat)

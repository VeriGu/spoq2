...
(assert
 (let (($x65661 (forall ((rtt_gidx.2582059 Int) (ipa_gidx.2582059 Int) (data_gidx.2582059 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x25277 (mkr_granule_data (gd_g_idx (select (granule_data ?x24053) ?x3159)) (g_granule_state (select (granule_data ?x24053) ?x3159)) zero_granule_data (g_rd (select (granule_data ?x24053) ?x3159)) (g_rec (select (granule_data ?x24053) ?x3159)))))
 (let ((?x21667 (granule_data ?x24053)))
 (let ((?x40275 (store ?x21667 ?x3159 ?x25277)))
 (let ((?x66792 (gpt ?x24053)))
 (let ((?x24141 (priv ?x24369)))
 (let ((?x24295 (repl ?x24369)))
 (let ((?x23842 (oracle ?x24369)))
 (let ((?x23067 (log ?x24369)))
 (let ((?x64700 (mkRData ?x23067 ?x23842 ?x24295 ?x24141 (mkShared ?x66792 ?x40275 ?x58795) ?x23982 $x23802)))
 (let ((?x63535 (g_granule_state (select ?x40275 (rtt_walk_abs.0_call ?x64700 rtt_gidx.2582059 ipa_gidx.2582059)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2582059)))
 (let ((?x65544 (mkRData ?x23067 ?x23842 ?x24295 ?x24141 (mkShared ?x66792 ?x21667 ?x58795) ?x23982 $x23802)))
 (let (($x65508 (halt ?x65544)))
 (let ((?x65447 (stack ?x65544)))
 (let ((?x65500 (priv ?x65544)))
 (let ((?x24784 (repl ?x65544)))
 (let ((?x24997 (oracle ?x65544)))
 (let ((?x103731 (log ?x65544)))
 (let ((?x25274 (mkRData ?x103731 ?x24997 ?x24784 ?x65500 (mkShared (gpt (share ?x65544)) ?x40275 (globals (share ?x65544))) ?x65447 $x65508)))
 (let (($x72321 (=> (and (and (distinct (rtt_walk_abs.0_call ?x25274 rtt_gidx.2582059 ipa_gidx.2582059) (- 1)) true) $x153) (or (= ?x63535 4) (= ?x63535 6)))))
 (let (($x58478 (= (e_state_s_granule (select ?x25286 rtt_gidx.2582059)) 5)))
 (=> (and $x58478 (and (distinct (rtt_walk_abs.0_call ?x25274 rtt_gidx.2582059 ipa_gidx.2582059) (- 1)) true) $x153) (or (= ?x63535 4) (= ?x63535 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x65661)))
(check-sat)

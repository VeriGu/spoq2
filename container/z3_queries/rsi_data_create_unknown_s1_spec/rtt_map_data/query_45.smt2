...
(assert
 (let (($x62513 (forall ((rtt_gidx.2575175 Int) (ipa_gidx.2575175 Int) (data_gidx.2575175 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x22537 (g_rmm_attest_public_key ?x21187)))
 (let ((?x22418 (g_rmm_attest_signing_key ?x21187)))
 (let ((?x62732 (mks_granule (e_lock (select (g_granules ?x21187) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x21187) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x21525 (g_granules ?x21187)))
 (let ((?x78807 (store ?x21525 ?x3159 ?x62732)))
 (let ((?x22001 (g_mbedtls_mem_buf ?x21187)))
 (let ((?x22782 (g_tt_l1_upper ?x21187)))
 (let ((?x22219 (g_tt_l2_mem1_3 ?x21187)))
 (let ((?x22628 (g_tt_l2_mem1_2 ?x21187)))
 ...
 (let ((?x22432 (g_debug_exits ?x21187)))
 (let ((?x21601 (g_heap ?x21187)))
 (let ((?x62747 (mkGLOBALS ?x21601 ?x22432 ?x22350 ?x22618 ?x21734 ?x4297 ?x21618 ?x21647 ?x22202 ?x22507 ?x22603 ?x22583 ?x22029 ?x22080 ?x22408 ?x22497 ?x22206 ?x22628 ?x22219 ?x22782 ?x22001 ?x78807 ?x22418 ?x22537 ?x22541 ?x22657 ?x22321 ?x18498 ?x22172 ?x22634 ?x22190)))
 ...
 (let ((?x21628 (oracle ?x21149)))
 (let ((?x22565 (log ?x21149)))
 (let ((?x23237 (mkRData ?x22565 ?x21628 ?x22564 ?x20616 (mkShared ?x583620 ?x22325 ?x62747) ?x22118 $x22085)))
 (let ((?x62199 (g_granule_state (select ?x22325 (rtt_walk_abs.0_call ?x23237 rtt_gidx.2575175 ipa_gidx.2575175)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2575175)))
 (let ((?x23455 (mkRData ?x22565 ?x21628 ?x22564 ?x20616 (mkShared ?x583620 ?x22192 ?x62747) ?x22118 $x22085)))
 (let (($x276831 (halt ?x23455)))
 (let ((?x62723 (stack ?x23455)))
 (let ((?x20234 (priv ?x23455)))
 (let ((?x62193 (repl ?x23455)))
 (let ((?x22901 (oracle ?x23455)))
 (let ((?x23200 (log ?x23455)))
 (let ((?x22773 (mkRData ?x23200 ?x22901 ?x62193 ?x20234 (mkShared (gpt (share ?x23455)) ?x22325 (globals (share ?x23455))) ?x62723 $x276831)))
 (let (($x71140 (=> (and (and (distinct (rtt_walk_abs.0_call ?x22773 rtt_gidx.2575175 ipa_gidx.2575175) (- 1)) true) $x153) (or (= ?x62199 4) (= ?x62199 6)))))
 (let (($x22885 (= (e_state_s_granule (select ?x78807 rtt_gidx.2575175)) 5)))
 (=> (and $x22885 (and (distinct (rtt_walk_abs.0_call ?x22773 rtt_gidx.2575175 ipa_gidx.2575175) (- 1)) true) $x153) (or (= ?x62199 4) (= ?x62199 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x62513)))
(check-sat)

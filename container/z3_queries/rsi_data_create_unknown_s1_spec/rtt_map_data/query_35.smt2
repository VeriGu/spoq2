...
(assert
 (let (($x43080 (forall ((rtt_gidx.2561596 Int) (ipa_gidx.2561596 Int) (data_gidx.2561596 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x85376 (select ?x17237 ?x3159)))
 (let ((?x48363 (e_ref ?x85376)))
 (let ((?x18710 (e_lock ?x85376)))
 (let ((?x42521 (mks_granule ?x18710 1 ?x48363)))
 (let ((?x18879 (store ?x17237 ?x3159 ?x42521)))
 (let ((?x18212 (g_mbedtls_mem_buf ?x13162)))
 (let ((?x17913 (g_tt_l1_upper ?x13162)))
 (let ((?x17767 (g_tt_l2_mem1_3 ?x13162)))
 (let ((?x18248 (g_tt_l2_mem1_2 ?x13162)))
 ...
 (let ((?x18089 (g_debug_exits ?x13162)))
 (let ((?x18188 (g_heap ?x13162)))
 (let ((?x48680 (mkGLOBALS ?x18188 ?x18089 ?x17883 ?x18135 ?x18101 ?x17813 ?x17871 ?x18055 ?x18097 ?x18263 ?x18241 ?x18001 ?x17993 ?x17333 ?x18044 ?x18262 ?x17628 ?x18248 ?x17767 ?x17913 ?x18212 ?x18879 ?x18122 ?x17939 ?x18287 ?x17023 ?x17634 ?x18268 ?x18284 ?x18306 ?x18046)))
 ...
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x57514 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18425 ?x48680) ?x114807 $x17367)))
 (let ((?x57868 (g_granule_state (select ?x18425 (rtt_walk_abs.0_call ?x57514 rtt_gidx.2561596 ipa_gidx.2561596)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561596)))
 (let ((?x18387 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x17401 ?x48680) ?x114807 $x17367)))
 (let ((?x49290 (mkRData (log ?x18387) (oracle ?x18387) (repl ?x18387) (priv ?x18387) (mkShared (gpt (share ?x18387)) ?x18425 (globals (share ?x18387))) (stack ?x18387) (halt ?x18387))))
 (let (($x48918 (=> (and (and (distinct (rtt_walk_abs.0_call ?x49290 rtt_gidx.2561596 ipa_gidx.2561596) (- 1)) true) $x153) (or (= ?x57868 4) (= ?x57868 6)))))
 (=> (and (= (e_state_s_granule (select ?x18879 rtt_gidx.2561596)) 5) (and (distinct (rtt_walk_abs.0_call ?x49290 rtt_gidx.2561596 ipa_gidx.2561596) (- 1)) true) $x153) (or (= ?x57868 4) (= ?x57868 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x43080)))
(check-sat)

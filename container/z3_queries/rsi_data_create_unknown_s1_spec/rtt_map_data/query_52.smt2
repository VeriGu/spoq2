...
(assert
 ...
 (let (($x123681 (and $x352019 $x18841 $x65203)))
 (not $x123681)))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x83338 (make_return_code_para.0_call 9)))
 (let ((?x9082 (pack_struct_return_code_para.0_call ?x83338)))
 (= ?x9082 0))))
(assert
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
...
(assert
 (let (($x65405 (forall ((rtt_gidx.2582331 Int) (ipa_gidx.2582331 Int) (data_gidx.2582331 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x12047 (g_rmm_attest_public_key ?x20444)))
 (let ((?x20630 (g_rmm_attest_signing_key ?x20444)))
 (let ((?x24655 (mks_granule (e_lock (select (g_granules ?x20444) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x20444) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x20144 (g_granules ?x20444)))
 (let ((?x73605 (store ?x20144 ?x3159 ?x24655)))
 (let ((?x20648 (g_mbedtls_mem_buf ?x20444)))
 (let ((?x20593 (g_tt_l1_upper ?x20444)))
 (let ((?x20871 (g_tt_l2_mem1_3 ?x20444)))
 (let ((?x19833 (g_tt_l2_mem1_2 ?x20444)))
 ...
 (let ((?x20640 (g_debug_exits ?x20444)))
 (let ((?x19931 (g_heap ?x20444)))
 (let ((?x25071 (mkGLOBALS ?x19931 ?x20640 ?x17064 ?x21033 ?x21001 ?x20696 ?x20744 ?x20641 ?x20526 ?x20336 ?x20885 ?x20937 ?x21029 ?x19861 ?x16681 ?x20016 ?x19770 ?x19833 ?x20871 ?x20593 ?x20648 ?x73605 ?x20630 ?x12047 ?x20726 ?x20908 ?x20181 ?x20943 ?x19851 ?x21014 ?x20678)))
 (let ((?x20644 (granule_data ?x20152)))
 (let ((?x16787 (gpt ?x20152)))
 (let ((?x19958 (priv ?x20259)))
 (let ((?x19893 (repl ?x20259)))
 (let ((?x16684 (oracle ?x20259)))
 (let ((?x19212 (log ?x20259)))
 (let ((?x65702 (mkRData ?x19212 ?x16684 ?x19893 ?x19958 (mkShared ?x16787 ?x20644 ?x25071) ?x19532 $x20253)))
 (let ((?x66008 (rtt_walk_abs.0_call ?x65702 rtt_gidx.2582331 ipa_gidx.2582331)))
 (let ((?x61997 (g_granule_state (select ?x20644 ?x66008))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2582331)))
 (let (($x63181 (=> (and (and (distinct ?x66008 (- 1)) true) $x153) (or (= ?x61997 4) (= ?x61997 6)))))
 (=> (and (= (e_state_s_granule (select ?x73605 rtt_gidx.2582331)) 5) (and (distinct ?x66008 (- 1)) true) $x153) (or (= ?x61997 4) (= ?x61997 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x65405)))
(check-sat)

...
(assert
 (let (($x54632 (forall ((rtt_gidx.2554406 Int) (ipa_gidx.2554406 Int) (data_gidx.2554406 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x15976 (granule_data ?x16009)))
 (let ((?x16591 (select ?x15976 ?x15175)))
 (let ((?x16094 (mkabs_PTE_t ?x2324 0 0 3)))
 (let ((?x53970 (test_PTE_Z.0_call ?x16094)))
 (let ((?x16742 (mod ?x14201 4096)))
 (let ((?x16093 (g_norm ?x16591)))
 (let ((?x16373 (store ?x16093 ?x16742 ?x53970)))
 (let ((?x53918 (mkr_granule_data (gd_g_idx ?x16591) (g_granule_state ?x16591) ?x16373 (g_rd ?x16591) (g_rec ?x16591))))
 (let ((?x53945 (store ?x15976 ?x15175 ?x53918)))
 (let ((?x324022 (gpt ?x16009)))
 (let ((?x15931 (priv ?x15459)))
 (let ((?x15891 (repl ?x15459)))
 (let ((?x15305 (oracle ?x15459)))
 (let ((?x16058 (log ?x15459)))
 (let ((?x54701 (mkRData ?x16058 ?x15305 ?x15891 ?x15931 (mkShared ?x324022 ?x53945 ?x16611) ?x14868 $x15858)))
 (let ((?x16650 (g_granule_state (select ?x53945 (rtt_walk_abs.0_call ?x54701 rtt_gidx.2554406 ipa_gidx.2554406)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2554406)))
 (let ((?x16755 (mkRData ?x16058 ?x15305 ?x15891 ?x15931 (mkShared ?x324022 ?x15976 ?x16611) ?x14868 $x15858)))
 (let ((?x54558 (mkRData (log ?x16755) (oracle ?x16755) (repl ?x16755) (priv ?x16755) (mkShared (gpt (share ?x16755)) ?x53945 (globals (share ?x16755))) (stack ?x16755) (halt ?x16755))))
 (let (($x67118 (=> (and (and (distinct (rtt_walk_abs.0_call ?x54558 rtt_gidx.2554406 ipa_gidx.2554406) (- 1)) true) $x153) (or (= ?x16650 4) (= ?x16650 6)))))
 (=> (and (= (e_state_s_granule (select ?x16627 rtt_gidx.2554406)) 5) (and (distinct (rtt_walk_abs.0_call ?x54558 rtt_gidx.2554406 ipa_gidx.2554406) (- 1)) true) $x153) (or (= ?x16650 4) (= ?x16650 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x54632)))
(check-sat)

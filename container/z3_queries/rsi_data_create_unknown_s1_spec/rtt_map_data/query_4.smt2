...
(assert
 ...
 (= ?x36206 2))))))))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.2514386 Int) (ipa_gidx.2514386 Int) (data_gidx.2514386 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x20757 (spinlock_acquire_spec.0_call ?x28250 ?x4102)))
 (let ((?x36171 (value_RData ?x20757)))
 (let ((?x5393 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2514386 ipa_gidx.2514386)))
 (let ((?x5388 (share ?x36171)))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5414 (g_granule_state (select ?x5510 ?x5393))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2514386)))
 (let (($x5429 (=> $x153 (or (= ?x5414 4) (= ?x5414 6)))))
 (let (($x5191 (= (e_state_s_granule (select (g_granules (globals ?x5388)) rtt_gidx.2514386)) 5)))
 (=> (and $x5191 (and (distinct ?x5393 (- 1)) true) $x153) (or (= ?x5414 4) (= ?x5414 6)))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x4844 (forall ((rtt_gidx.2514742 Int) (ipa_gidx.2514742 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x20757 (spinlock_acquire_spec.0_call ?x28250 ?x4102)))
 (let ((?x36171 (value_RData ?x20757)))
 (let (($x5149 (halt ?x36171)))
 (let ((?x5181 (stack ?x36171)))
 (let ((?x5388 (share ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x5358 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr a!4 a!5)
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
  (oracle a!6))))))_call| ?x5410)))
 (let ((?x5155 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!6 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr a!4 a!5)
                          (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
  (repl a!6))))))_call| ?x5358 ?x5388)))
 (let ((?x5205 (value_Shared ?x5155)))
 (let ((?x4850 (priv ?x36171)))
 (let ((?x5194 (repl ?x36171)))
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5169 (List_Event_concat ?x5358 ?x5410)))
 (let ((?x5374 (mkRData ?x5169 ?x5402 ?x5194 ?x4850 ?x5205 ?x5181 $x5149)))
 (let ((?x5532 (rtt_walk_abs.0_call ?x5374 rtt_gidx.2514742 ipa_gidx.2514742)))
 (let ((?x5551 (granule_data ?x5205)))
 (let ((?x5567 (g_granule_state (select ?x5551 ?x5532))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2514742))))
 (let (($x5531 (not (= (e_state_s_granule (select (g_granules (globals ?x5205)) rtt_gidx.2514742)) 5))))
 (or $x5531 $x176 (= ?x5532 (- 1)) (= ?x5567 4) (= ?x5567 6))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x5542 (forall ((rtt_gidx.2514695 Int) (ipa_gidx.2514695 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5514 (e_state_s_granule (select ?x5172 rtt_gidx.2514695))))
 (let (($x5524 (not (= ?x5514 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2514695))))
 (let ((?x5520 (g_granule_state (select (granule_data ?x5388) (rtt_walk_abs.0_call ?x36171 rtt_gidx.2514695 ipa_gidx.2514695)))))
 (let (($x5505 (= ?x5520 6)))
 (let (($x5519 (= ?x5520 4)))
 (let ((?x5521 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2514695 ipa_gidx.2514695)))
 (let (($x4993 (= ?x5521 (- 1))))
 (or $x4993 $x5519 $x5505 $x176 $x5524)))))))))))))))))))))))))))))))))))
 ))
 (or (not $x5542) $x4844))))
(assert
 (forall ((offset.2515402 Int) (empty_pte.2515402 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2515402)) (- 1)))))
 (let (($x5596 (forall ((rtt_gidx.2515398 Int) (ipa_gidx.2515398 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5388 (share ?x36171)))
 (let ((?x5335 (globals ?x5388)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2515402)))
 (let ((?x2023 (mod offset.2515402 4096)))
 (let ((?x5576 (store (g_norm (select (granule_data ?x5388) (div offset.2515402 4096))) ?x2023 ?x2022)))
 (let ((?x5598 (mkr_granule_data (gd_g_idx (select (granule_data ?x5388) (div offset.2515402 4096))) (g_granule_state (select (granule_data ?x5388) (div offset.2515402 4096))) ?x5576 (g_rd (select (granule_data ?x5388) (div offset.2515402 4096))) (g_rec (select (granule_data ?x5388) (div offset.2515402 4096))))))
 (let ((?x2017 (div offset.2515402 4096)))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5623 (store ?x5510 ?x2017 ?x5598)))
 (let ((?x5461 (gpt ?x5388)))
 (let ((?x4850 (priv ?x36171)))
 (let ((?x5194 (repl ?x36171)))
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x5612 (rtt_walk_abs.0_call (mkRData ?x5410 ?x5402 ?x5194 ?x4850 (mkShared ?x5461 ?x5623 ?x5335) ?x5181 $x5149) rtt_gidx.2515398 ipa_gidx.2515398)))
 (let ((?x5610 (g_granule_state (select ?x5623 ?x5612))))
 (let (($x5524 (not (= (e_state_s_granule (select (g_granules ?x5335) rtt_gidx.2515398)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2515398))))
 (or $x176 $x5524 (= ?x5612 (- 1)) (= ?x5610 4) (= ?x5610 6)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x2001 (div offset.2515402 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let (($x4998 (forall ((rtt_gidx.2515285 Int) (ipa_gidx.2515285 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5514 (e_state_s_granule (select ?x5172 rtt_gidx.2515285))))
 (let (($x5524 (not (= ?x5514 5))))
 (let ((?x5520 (g_granule_state (select (granule_data ?x5388) (rtt_walk_abs.0_call ?x36171 rtt_gidx.2515285 ipa_gidx.2515285)))))
 (let (($x5519 (= ?x5520 4)))
 (let (($x5505 (= ?x5520 6)))
 (let ((?x5521 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2515285 ipa_gidx.2515285)))
 (let (($x4993 (= ?x5521 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2515285))))
 (or $x176 $x4993 $x5505 $x5519 $x5524)))))))))))))))))))))))))))))))))))
 ))
 (let (($x5176 (not $x4998)))
 (or $x5176 (not (= (e_state_s_granule (select ?x5172 ?x2001)) 5)) $x5596 $x2000))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2515961 Int) (state.2515961 Int) )(let (($x5789 (forall ((rtt_gidx.2515959 Int) (ipa_gidx.2515959 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5388 (share ?x36171)))
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5674 (g_realm_attest_private_key ?x5335)))
 (let ((?x5676 (g_get_realm_identity_identity ?x5335)))
 (let ((?x5687 (g_rmm_platform_token ?x5335)))
 (let ((?x5512 (g_platform_token_buf ?x5335)))
 (let ((?x5680 (g_rmm_attest_public_key_hash_len ?x5335)))
 (let ((?x5683 (g_rmm_attest_public_key_hash ?x5335)))
 (let ((?x5684 (g_rmm_attest_public_key_len ?x5335)))
 (let ((?x5686 (g_rmm_attest_public_key ?x5335)))
 (let ((?x5677 (g_rmm_attest_signing_key ?x5335)))
 (let ((?x5726 (mks_granule (e_lock (select (g_granules ?x5335) offset.2515961)) state.2515961 (e_ref (select (g_granules ?x5335) offset.2515961)))))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5728 (store ?x5172 offset.2515961 ?x5726)))
 (let ((?x5670 (g_mbedtls_mem_buf ?x5335)))
 (let ((?x5673 (g_tt_l1_upper ?x5335)))
 (let ((?x5515 (g_tt_l2_mem1_3 ?x5335)))
 (let ((?x5669 (g_tt_l2_mem1_2 ?x5335)))
 (let ((?x4848 (g_tt_l2_mem1_1 ?x5335)))
 (let ((?x5671 (g_tt_l2_mem1_0 ?x5335)))
 (let ((?x5700 (g_tt_l2_mem0_1 ?x5335)))
 (let ((?x5278 (g_tt_l2_mem0_0 ?x5335)))
 (let ((?x5690 (g_tt_l3_buffer ?x5335)))
 (let ((?x5678 (g_rmm_trap_list ?x5335)))
 (let ((?x5658 (g_status_handler ?x5335)))
 (let ((?x5659 (g_default_gicstate ?x5335)))
 (let ((?x5662 (g_pri_res0_mask ?x5335)))
 (let ((?x5316 (g_max_vintid ?x5335)))
 (let ((?x5661 (g_nr_aprs ?x5335)))
 (let ((?x5672 (g_nr_lrs ?x5335)))
 (let ((?x5665 (g_vmids ?x5335)))
 (let ((?x5668 (g_vmid_lock ?x5335)))
 (let ((?x5664 (g_vmid_count ?x5335)))
 (let ((?x5627 (g_debug_exits ?x5335)))
 (let ((?x5666 (g_heap ?x5335)))
 (let ((?x5751 (mkGLOBALS ?x5666 ?x5627 ?x5664 ?x5668 ?x5665 ?x5672 ?x5661 ?x5316 ?x5662 ?x5659 ?x5658 ?x5678 ?x5690 ?x5278 ?x5700 ?x5671 ?x4848 ?x5669 ?x5515 ?x5673 ?x5670 ?x5728 ?x5677 ?x5686 ?x5684 ?x5683 ?x5680 ?x5512 ?x5687 ?x5676 ?x5674)))
 (let ((?x5769 (mkr_granule_data (gd_g_idx (select (granule_data ?x5388) offset.2515961)) (g_granule_state (select (granule_data ?x5388) offset.2515961)) zero_granule_data (g_rd (select (granule_data ?x5388) offset.2515961)) (g_rec (select (granule_data ?x5388) offset.2515961)))))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5779 (store ?x5510 offset.2515961 ?x5769)))
 (let ((?x5461 (gpt ?x5388)))
 (let ((?x4850 (priv ?x36171)))
 (let ((?x5194 (repl ?x36171)))
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x5767 (rtt_walk_abs.0_call (mkRData ?x5410 ?x5402 ?x5194 ?x4850 (mkShared ?x5461 ?x5779 ?x5751) ?x5181 $x5149) rtt_gidx.2515959 ipa_gidx.2515959)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2515959))))
 (or $x176 (not (= (e_state_s_granule (select ?x5728 rtt_gidx.2515959)) 5)) (= (g_granule_state (select ?x5779 ?x5767)) 6) (= (g_granule_state (select ?x5779 ?x5767)) 4) (= ?x5767 (- 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x5747 (forall ((rtt_gidx.2515860 Int) (ipa_gidx.2515860 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5514 (e_state_s_granule (select ?x5172 rtt_gidx.2515860))))
 (let (($x5524 (not (= ?x5514 5))))
 (let ((?x5521 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2515860 ipa_gidx.2515860)))
 (let (($x4993 (= ?x5521 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2515860))))
 (let ((?x5520 (g_granule_state (select (granule_data ?x5388) ?x5521))))
 (let (($x5505 (= ?x5520 6)))
 (let (($x5519 (= ?x5520 4)))
 (or $x5519 $x5505 $x176 $x4993 $x5524)))))))))))))))))))))))))))))))))))
 ))
 (let (($x5744 (not $x5747)))
 (or $x5744 $x5789)))))
 )
(assert
 (forall ((parent_gidx.2516905 Int) (pte_z.2516905 Int) (x.2516905 Int) (y.2516905 Int) (z.2516905 Int) )(let (($x5936 (forall ((rtt_gidx.2516903 Int) (ipa_gidx.2516903 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5686 (g_rmm_attest_public_key ?x5335)))
 (let ((?x5677 (g_rmm_attest_signing_key ?x5335)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2516905))) 4096)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5876 (select ?x5172 ?x1845)))
 (let ((?x5830 (store ?x5172 ?x1845 (mks_granule (e_lock ?x5876) 4 (e_ref ?x5876)))))
 (let ((?x5670 (g_mbedtls_mem_buf ?x5335)))
 (let ((?x5673 (g_tt_l1_upper ?x5335)))
 (let ((?x5515 (g_tt_l2_mem1_3 ?x5335)))
 (let ((?x5669 (g_tt_l2_mem1_2 ?x5335)))
 ...
 (let ((?x5627 (g_debug_exits ?x5335)))
 (let ((?x5666 (g_heap ?x5335)))
 (let ((?x5905 (mkGLOBALS ?x5666 ?x5627 ?x5664 ?x5668 ?x5665 ?x5672 ?x5661 ?x5316 ?x5662 ?x5659 ?x5658 ?x5678 ?x5690 ?x5278 ?x5700 ?x5671 ?x4848 ?x5669 ?x5515 ?x5673 ?x5670 ?x5830 ?x5677 ?x5686 ?x5684 ?x5683 ?x5680 ?x5512 ?x5687 ?x5676 ?x5674)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2516905)) x.2516905 y.2516905 z.2516905))))
 (let ((?x1892 (mod parent_gidx.2516905 4096)))
 (let ((?x5895 (store (g_norm (select (granule_data ?x5388) (div parent_gidx.2516905 4096))) ?x1892 ?x1891)))
 (let ((?x5888 (mkr_granule_data (gd_g_idx (select (granule_data ?x5388) (div parent_gidx.2516905 4096))) (g_granule_state (select (granule_data ?x5388) (div parent_gidx.2516905 4096))) ?x5895 (g_rd (select (granule_data ?x5388) (div parent_gidx.2516905 4096))) (g_rec (select (granule_data ?x5388) (div parent_gidx.2516905 4096))))))
 (let ((?x1886 (div parent_gidx.2516905 4096)))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5919 (store ?x5510 ?x1886 ?x5888)))
 (let ((?x5461 (gpt ?x5388)))
 (let ((?x4850 (priv ?x36171)))
 (let ((?x5194 (repl ?x36171)))
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x5814 (rtt_walk_abs.0_call (mkRData ?x5410 ?x5402 ?x5194 ?x4850 (mkShared ?x5461 ?x5919 ?x5905) ?x5181 $x5149) rtt_gidx.2516903 ipa_gidx.2516903)))
 (let ((?x5923 (g_granule_state (select ?x5919 ?x5814))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2516903))))
 (or (= ?x5814 (- 1)) $x176 (not (= (e_state_s_granule (select ?x5830 rtt_gidx.2516903)) 5)) (= ?x5923 6) (= ?x5923 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x5903 (forall ((rtt_gidx.2516707 Int) (ipa_gidx.2516707 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5514 (e_state_s_granule (select ?x5172 rtt_gidx.2516707))))
 (let (($x5524 (not (= ?x5514 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2516707))))
 (let ((?x5521 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2516707 ipa_gidx.2516707)))
 (let (($x4993 (= ?x5521 (- 1))))
 (let ((?x5520 (g_granule_state (select (granule_data ?x5388) ?x5521))))
 (let (($x5505 (= ?x5520 6)))
 (let (($x5519 (= ?x5520 4)))
 (or $x5519 $x5505 $x4993 $x176 $x5524)))))))))))))))))))))))))))))))))))
 ))
 (let (($x5715 (not $x5903)))
 (or $x5715 $x5936)))))
 )
(assert
 (forall ((offset.2517312 Int) )(let (($x6052 (forall ((rtt_gidx.2517310 Int) (ipa_gidx.2517310 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5686 (g_rmm_attest_public_key ?x5335)))
 (let ((?x5677 (g_rmm_attest_signing_key ?x5335)))
 (let ((?x6000 (mks_granule (e_lock (select (g_granules ?x5335) offset.2517312)) 4 (e_ref (select (g_granules ?x5335) offset.2517312)))))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5984 (store ?x5172 offset.2517312 ?x6000)))
 (let ((?x5670 (g_mbedtls_mem_buf ?x5335)))
 (let ((?x5673 (g_tt_l1_upper ?x5335)))
 (let ((?x5515 (g_tt_l2_mem1_3 ?x5335)))
 (let ((?x5669 (g_tt_l2_mem1_2 ?x5335)))
 ...
 (let ((?x5627 (g_debug_exits ?x5335)))
 (let ((?x5666 (g_heap ?x5335)))
 (let ((?x5986 (mkGLOBALS ?x5666 ?x5627 ?x5664 ?x5668 ?x5665 ?x5672 ?x5661 ?x5316 ?x5662 ?x5659 ?x5658 ?x5678 ?x5690 ?x5278 ?x5700 ?x5671 ?x4848 ?x5669 ?x5515 ?x5673 ?x5670 ?x5984 ?x5677 ?x5686 ?x5684 ?x5683 ?x5680 ?x5512 ?x5687 ?x5676 ?x5674)))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5461 (gpt ?x5388)))
 (let ((?x4850 (priv ?x36171)))
 (let ((?x5194 (repl ?x36171)))
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x5885 (rtt_walk_abs.0_call (mkRData ?x5410 ?x5402 ?x5194 ?x4850 (mkShared ?x5461 ?x5510 ?x5986) ?x5181 $x5149) rtt_gidx.2517310 ipa_gidx.2517310)))
 (let ((?x6039 (g_granule_state (select ?x5510 ?x5885))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2517310))))
 (or (= ?x5885 (- 1)) (= ?x6039 4) $x176 (not (= (e_state_s_granule (select ?x5984 rtt_gidx.2517310)) 5)) (= ?x6039 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x6024 (forall ((rtt_gidx.2517245 Int) (ipa_gidx.2517245 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5335 (globals ?x5388)))
 (let ((?x5172 (g_granules ?x5335)))
 (let ((?x5514 (e_state_s_granule (select ?x5172 rtt_gidx.2517245))))
 (let (($x5524 (not (= ?x5514 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2517245))))
 (let ((?x5521 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2517245 ipa_gidx.2517245)))
 (let (($x4993 (= ?x5521 (- 1))))
 (let ((?x5520 (g_granule_state (select (granule_data ?x5388) ?x5521))))
 (let (($x5505 (= ?x5520 6)))
 (let (($x5519 (= ?x5520 4)))
...
(assert
 (forall ((rtt_gidx.2517414 Int) (ipa_gidx.2517414 Int) (i.2517414 Int) (d.2517414 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5402 (oracle ?x36171)))
 (let ((?x5410 (log ?x36171)))
 (let ((?x6094 (mkRData ?x5410 ?x5402 ?x5194 ?x4850 (mkShared ?x5461 (store (granule_data ?x5388) i.2517414 d.2517414) ?x5335) ?x5181 $x5149)))
 (let ((?x6100 (+ (rtt_walk_abs.0_call ?x36171 rtt_gidx.2517414 ipa_gidx.2517414) (* (- 1) (rtt_walk_abs.0_call ?x6094 rtt_gidx.2517414 ipa_gidx.2517414)))))
 (let (($x5524 (not (= (e_state_s_granule (select (g_granules ?x5335) i.2517414)) 5))))
 (let (($x5896 (and $x5524 (not (= (e_state_s_granule (select (g_granules ?x5335) i.2517414)) 4)))))
 (=> $x5896 (= ?x6100 0))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x37148 (forall ((rtt_gidx.2517493 Int) (ipa_gidx.2517493 Int) (data_gidx.2517493 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x20757 (spinlock_acquire_spec.0_call ?x28250 ?x4102)))
 (let ((?x36171 (value_RData ?x20757)))
 (let ((?x5393 (rtt_walk_abs.0_call ?x36171 rtt_gidx.2517493 ipa_gidx.2517493)))
 (let ((?x5388 (share ?x36171)))
 (let ((?x5510 (granule_data ?x5388)))
 (let ((?x5414 (g_granule_state (select ?x5510 ?x5393))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2517493)))
 (let (($x5429 (=> $x153 (or (= ?x5414 4) (= ?x5414 6)))))
 (let (($x5191 (= (e_state_s_granule (select (g_granules (globals ?x5388)) rtt_gidx.2517493)) 5)))
 (=> (and $x5191 (and (distinct ?x5393 (- 1)) true) $x153) (or (= ?x5414 4) (= ?x5414 6)))))))))))))))))))))))))))))))))
 ))
 (not $x37148)))
(check-sat)

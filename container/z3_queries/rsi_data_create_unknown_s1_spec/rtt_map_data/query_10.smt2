...
(assert
 (let (($x48072 (forall ((rtt_gidx.2527690 Int) (ipa_gidx.2527690 Int) (data_gidx.2527690 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x5317 (poffset ?x36155)))
 (let ((?x36157 (+ ?x5317 ?x36136)))
 (let ((?x6990 (div ?x36157 4096)))
 (let ((?x8435 (granule_data ?x8320)))
 (let ((?x9012 (select ?x8435 ?x6990)))
 (let ((?x6579 (mkabs_PTE_t ?x2324 0 0 1)))
 (let ((?x6987 (test_PTE_Z.0_call ?x6579)))
 (let ((?x6991 (mod ?x36157 4096)))
 (let ((?x8717 (g_norm ?x9012)))
 (let ((?x8841 (store ?x8717 ?x6991 ?x6987)))
 (let ((?x8904 (mkr_granule_data (gd_g_idx ?x9012) (g_granule_state ?x9012) ?x8841 (g_rd ?x9012) (g_rec ?x9012))))
 (let ((?x9014 (store ?x8435 ?x6990 ?x8904)))
 (let ((?x31869 (gpt ?x8320)))
 (let ((?x7794 (priv ?x8102)))
 (let ((?x8416 (repl ?x8102)))
 (let ((?x7485 (oracle ?x8102)))
 (let ((?x8168 (log ?x8102)))
 (let ((?x6950 (mkRData ?x8168 ?x7485 ?x8416 ?x7794 (mkShared ?x31869 ?x9014 ?x40344) ?x8086 $x8212)))
 (let ((?x32373 (g_granule_state (select ?x9014 (rtt_walk_abs.0_call ?x6950 rtt_gidx.2527690 ipa_gidx.2527690)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2527690)))
 (let ((?x9000 (mkRData ?x8168 ?x7485 ?x8416 ?x7794 (mkShared ?x31869 ?x8435 ?x40344) ?x8086 $x8212)))
 (let ((?x67294 (mkRData (log ?x9000) (oracle ?x9000) (repl ?x9000) (priv ?x9000) (mkShared (gpt (share ?x9000)) ?x9014 (globals (share ?x9000))) (stack ?x9000) (halt ?x9000))))
 (let (($x9006 (=> (and (and (distinct (rtt_walk_abs.0_call ?x67294 rtt_gidx.2527690 ipa_gidx.2527690) (- 1)) true) $x153) (or (= ?x32373 4) (= ?x32373 6)))))
 (=> (and (= (e_state_s_granule (select ?x9002 rtt_gidx.2527690)) 5) (and (distinct (rtt_walk_abs.0_call ?x67294 rtt_gidx.2527690 ipa_gidx.2527690) (- 1)) true) $x153) (or (= ?x32373 4) (= ?x32373 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x48072)))
(check-sat)

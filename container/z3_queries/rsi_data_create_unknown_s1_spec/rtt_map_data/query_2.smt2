...
(assert
 (let (($x4168 (forall ((rtt_gidx.2511121 Int) (ipa_gidx.2511121 Int) (data_gidx.2511121 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x3195 (spinlock_acquire_spec.0_call ?x3156 ?x2329)))
 (let ((?x3160 (value_RData ?x3195)))
 (let ((?x3482 (rtt_walk_abs.0_call ?x3160 rtt_gidx.2511121 ipa_gidx.2511121)))
 (let ((?x3452 (share ?x3160)))
 (let ((?x3550 (granule_data ?x3452)))
 (let ((?x3475 (g_granule_state (select ?x3550 ?x3482))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2511121)))
 (let (($x3489 (=> $x153 (or (= ?x3475 4) (= ?x3475 6)))))
 (let (($x3417 (= (e_state_s_granule (select (g_granules (globals ?x3452)) rtt_gidx.2511121)) 5)))
 (=> (and $x3417 (and (distinct ?x3482 (- 1)) true) $x153) (or (= ?x3475 4) (= ?x3475 6))))))))))))))))))))))
 ))
 (not $x4168)))
(check-sat)

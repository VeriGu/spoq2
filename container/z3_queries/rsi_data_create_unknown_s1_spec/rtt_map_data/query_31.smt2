...
(assert
 ...
 (not $x15860)))))))))))))))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.2547986 Int) (ipa_gidx.2547986 Int) (data_gidx.2547986 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x13576 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2547986 ipa_gidx.2547986)))
 (let ((?x15020 (share ?x52099)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x14928 (g_granule_state (select ?x15078 ?x13576))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2547986)))
 (let (($x14378 (=> $x153 (or (= ?x14928 4) (= ?x14928 6)))))
 (let (($x14494 (= (e_state_s_granule (select (g_granules (globals ?x15020)) rtt_gidx.2547986)) 5)))
 (=> (and $x14494 (and (distinct ?x13576 (- 1)) true) $x153) (or (= ?x14928 4) (= ?x14928 6)))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x15370 (forall ((rtt_gidx.2548342 Int) (ipa_gidx.2548342 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let (($x14893 (halt ?x52099)))
 (let ((?x14837 (stack ?x52099)))
 (let ((?x15020 (share ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x14875 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr (pbase a!6) (poffset a!6))
                          a!5))))
  (oracle a!7))))))))_call| ?x14603)))
 (let ((?x14991 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!7 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr (pbase a!6) (poffset a!6))
                          a!5))))
  (repl a!7))))))))_call| ?x14875 ?x15020)))
 (let ((?x14943 (value_Shared ?x14991)))
 (let ((?x14894 (priv ?x52099)))
 (let ((?x14930 (repl ?x52099)))
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14895 (List_Event_concat ?x14875 ?x14603)))
 (let ((?x15389 (mkRData ?x14895 ?x14550 ?x14930 ?x14894 ?x14943 ?x14837 $x14893)))
 (let ((?x15185 (rtt_walk_abs.0_call ?x15389 rtt_gidx.2548342 ipa_gidx.2548342)))
 (let ((?x15381 (granule_data ?x14943)))
 (let ((?x15021 (g_granule_state (select ?x15381 ?x15185))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2548342))))
 (let (($x15144 (not (= (e_state_s_granule (select (g_granules (globals ?x14943)) rtt_gidx.2548342)) 5))))
 (or (= ?x15185 (- 1)) $x15144 $x176 (= ?x15021 4) (= ?x15021 6))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14427 (forall ((rtt_gidx.2548295 Int) (ipa_gidx.2548295 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x15188 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2548295 ipa_gidx.2548295)))
 (let ((?x15020 (share ?x52099)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x14999 (g_granule_state (select ?x15078 ?x15188))))
 (let (($x14350 (= ?x14999 4)))
 (let (($x15235 (not (= (e_state_s_granule (select (g_granules (globals ?x15020)) rtt_gidx.2548295)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2548295))))
 (let (($x14538 (= ?x15188 (- 1))))
 (let (($x15126 (= ?x14999 6)))
 (or $x15126 $x14538 $x176 $x15235 $x14350)))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x14427) $x15370))))
(assert
 (forall ((offset.2549002 Int) (empty_pte.2549002 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2549002)) (- 1)))))
 (let ((?x2001 (div offset.2549002 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x14966 (globals ?x15020)))
 (let ((?x15121 (g_granules ?x14966)))
 (let (($x15165 (forall ((rtt_gidx.2548885 Int) (ipa_gidx.2548885 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14966 (globals ?x15020)))
 (let ((?x15121 (g_granules ?x14966)))
 (let ((?x14897 (e_state_s_granule (select ?x15121 rtt_gidx.2548885))))
 (let (($x15235 (not (= ?x14897 5))))
 (let ((?x14999 (g_granule_state (select (granule_data ?x15020) (rtt_walk_abs.0_call ?x52099 rtt_gidx.2548885 ipa_gidx.2548885)))))
 (let (($x15126 (= ?x14999 6)))
 (let ((?x15188 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2548885 ipa_gidx.2548885)))
 (let (($x14538 (= ?x15188 (- 1))))
 (let (($x14350 (= ?x14999 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2548885))))
 (or $x176 $x14350 $x14538 $x15126 $x15235)))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15142 (not $x15165)))
 (let (($x15425 (forall ((rtt_gidx.2548998 Int) (ipa_gidx.2548998 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x15020 (share ?x52099)))
 (let ((?x14966 (globals ?x15020)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2549002)))
 (let ((?x2023 (mod offset.2549002 4096)))
 (let ((?x15411 (store (g_norm (select (granule_data ?x15020) (div offset.2549002 4096))) ?x2023 ?x2022)))
 (let ((?x15427 (mkr_granule_data (gd_g_idx (select (granule_data ?x15020) (div offset.2549002 4096))) (g_granule_state (select (granule_data ?x15020) (div offset.2549002 4096))) ?x15411 (g_rd (select (granule_data ?x15020) (div offset.2549002 4096))) (g_rec (select (granule_data ?x15020) (div offset.2549002 4096))))))
 (let ((?x2017 (div offset.2549002 4096)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x15102 (store ?x15078 ?x2017 ?x15427)))
 (let ((?x31036 (gpt ?x15020)))
 (let ((?x14894 (priv ?x52099)))
 (let ((?x14930 (repl ?x52099)))
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x15410 (rtt_walk_abs.0_call (mkRData ?x14603 ?x14550 ?x14930 ?x14894 (mkShared ?x31036 ?x15102 ?x14966) ?x14837 $x14893) rtt_gidx.2548998 ipa_gidx.2548998)))
 (let (($x15235 (not (= (e_state_s_granule (select (g_granules ?x14966) rtt_gidx.2548998)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2548998))))
 (or $x176 (= (g_granule_state (select ?x15102 ?x15410)) 4) $x15235 (= (g_granule_state (select ?x15102 ?x15410)) 6) (= ?x15410 (- 1)))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or $x15425 $x15142 (not (= (e_state_s_granule (select ?x15121 ?x2001)) 5)) $x2000))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2549561 Int) (state.2549561 Int) )(let (($x14993 (forall ((rtt_gidx.2549559 Int) (ipa_gidx.2549559 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14966 (globals ?x15020)))
 (let ((?x15121 (g_granules ?x14966)))
 (let ((?x15379 (select ?x15121 offset.2549561)))
 (let ((?x15498 (store ?x15121 offset.2549561 (mks_granule (e_lock ?x15379) state.2549561 (e_ref ?x15379)))))
 (let (($x14893 (halt ?x52099)))
 (let ((?x14837 (stack ?x52099)))
 (let ((?x14390 (g_realm_attest_private_key ?x14966)))
 (let ((?x14715 (g_get_realm_identity_identity ?x14966)))
 (let ((?x15438 (g_rmm_platform_token ?x14966)))
 (let ((?x15456 (g_platform_token_buf ?x14966)))
 (let ((?x15464 (g_rmm_attest_public_key_hash_len ?x14966)))
 (let ((?x15137 (g_rmm_attest_public_key_hash ?x14966)))
 (let ((?x15229 (g_rmm_attest_public_key_len ?x14966)))
 (let ((?x15473 (g_rmm_attest_public_key ?x14966)))
 (let ((?x15364 (g_rmm_attest_signing_key ?x14966)))
 (let ((?x15453 (g_mbedtls_mem_buf ?x14966)))
 (let ((?x14243 (g_tt_l1_upper ?x14966)))
 (let ((?x15323 (g_tt_l2_mem1_3 ?x14966)))
 (let ((?x15466 (g_tt_l2_mem1_2 ?x14966)))
 (let ((?x15451 (g_tt_l2_mem1_1 ?x14966)))
 (let ((?x15199 (g_tt_l2_mem1_0 ?x14966)))
 (let ((?x15025 (g_tt_l2_mem0_1 ?x14966)))
 (let ((?x15189 (g_tt_l2_mem0_0 ?x14966)))
 (let ((?x15345 (g_tt_l3_buffer ?x14966)))
 (let ((?x14205 (g_rmm_trap_list ?x14966)))
 (let ((?x15224 (g_status_handler ?x14966)))
 (let ((?x15344 (g_default_gicstate ?x14966)))
 (let ((?x15471 (g_pri_res0_mask ?x14966)))
 (let ((?x15330 (g_max_vintid ?x14966)))
 (let ((?x15479 (g_nr_aprs ?x14966)))
 (let ((?x15096 (g_nr_lrs ?x14966)))
 (let ((?x15177 (g_vmids ?x14966)))
 (let ((?x15218 (g_vmid_lock ?x14966)))
 (let ((?x15362 (g_vmid_count ?x14966)))
 (let ((?x15433 (g_debug_exits ?x14966)))
 (let ((?x15326 (g_heap ?x14966)))
 (let ((?x15552 (mkGLOBALS ?x15326 ?x15433 ?x15362 ?x15218 ?x15177 ?x15096 ?x15479 ?x15330 ?x15471 ?x15344 ?x15224 ?x14205 ?x15345 ?x15189 ?x15025 ?x15199 ?x15451 ?x15466 ?x15323 ?x14243 ?x15453 ?x15498 ?x15364 ?x15473 ?x15229 ?x15137 ?x15464 ?x15456 ?x15438 ?x14715 ?x14390)))
 (let ((?x15544 (mkr_granule_data (gd_g_idx (select (granule_data ?x15020) offset.2549561)) (g_granule_state (select (granule_data ?x15020) offset.2549561)) zero_granule_data (g_rd (select (granule_data ?x15020) offset.2549561)) (g_rec (select (granule_data ?x15020) offset.2549561)))))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x15494 (store ?x15078 offset.2549561 ?x15544)))
 (let ((?x31036 (gpt ?x15020)))
 (let ((?x14894 (priv ?x52099)))
 (let ((?x14930 (repl ?x52099)))
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x15517 (rtt_walk_abs.0_call (mkRData ?x14603 ?x14550 ?x14930 ?x14894 (mkShared ?x31036 ?x15494 ?x15552) ?x14837 $x14893) rtt_gidx.2549559 ipa_gidx.2549559)))
 (let ((?x14710 (g_granule_state (select ?x15494 ?x15517))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2549559))))
 (or $x176 (= ?x14710 4) (= ?x15517 (- 1)) (= ?x14710 6) (not (= (e_state_s_granule (select ?x15498 rtt_gidx.2549559)) 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15174 (forall ((rtt_gidx.2549460 Int) (ipa_gidx.2549460 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x15188 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2549460 ipa_gidx.2549460)))
 (let (($x14538 (= ?x15188 (- 1))))
 (let ((?x14897 (e_state_s_granule (select (g_granules (globals (share ?x52099))) rtt_gidx.2549460))))
 (let (($x15235 (not (= ?x14897 5))))
 (let ((?x14999 (g_granule_state (select (granule_data (share ?x52099)) ?x15188))))
 (let (($x14350 (= ?x14999 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2549460))))
 (let (($x15126 (= ?x14999 6)))
 (or $x15126 $x176 $x14350 $x15235 $x14538))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15184 (not $x15174)))
 (or $x15184 $x14993)))))
 )
(assert
 (forall ((parent_gidx.2550505 Int) (pte_z.2550505 Int) (x.2550505 Int) (y.2550505 Int) (z.2550505 Int) )(let (($x15683 (forall ((rtt_gidx.2550503 Int) (ipa_gidx.2550503 Int) )(let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2550505))) 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x14966 (globals ?x15020)))
 (let ((?x15121 (g_granules ?x14966)))
 (let ((?x15465 (select ?x15121 ?x1845)))
 (let ((?x15657 (store ?x15121 ?x1845 (mks_granule (e_lock ?x15465) 4 (e_ref ?x15465)))))
 (let (($x14893 (halt ?x52099)))
 (let ((?x14837 (stack ?x52099)))
 (let ((?x14390 (g_realm_attest_private_key ?x14966)))
 (let ((?x14715 (g_get_realm_identity_identity ?x14966)))
 ...
 (let ((?x15433 (g_debug_exits ?x14966)))
 (let ((?x15326 (g_heap ?x14966)))
 (let ((?x15236 (mkGLOBALS ?x15326 ?x15433 ?x15362 ?x15218 ?x15177 ?x15096 ?x15479 ?x15330 ?x15471 ?x15344 ?x15224 ?x14205 ?x15345 ?x15189 ?x15025 ?x15199 ?x15451 ?x15466 ?x15323 ?x14243 ?x15453 ?x15657 ?x15364 ?x15473 ?x15229 ?x15137 ?x15464 ?x15456 ?x15438 ?x14715 ?x14390)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2550505)) x.2550505 y.2550505 z.2550505))))
 (let ((?x1892 (mod parent_gidx.2550505 4096)))
 (let ((?x15191 (store (g_norm (select (granule_data ?x15020) (div parent_gidx.2550505 4096))) ?x1892 ?x1891)))
 (let ((?x15594 (mkr_granule_data (gd_g_idx (select (granule_data ?x15020) (div parent_gidx.2550505 4096))) (g_granule_state (select (granule_data ?x15020) (div parent_gidx.2550505 4096))) ?x15191 (g_rd (select (granule_data ?x15020) (div parent_gidx.2550505 4096))) (g_rec (select (granule_data ?x15020) (div parent_gidx.2550505 4096))))))
 (let ((?x1886 (div parent_gidx.2550505 4096)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x15596 (store ?x15078 ?x1886 ?x15594)))
 (let ((?x31036 (gpt ?x15020)))
 (let ((?x14894 (priv ?x52099)))
 (let ((?x14930 (repl ?x52099)))
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x15490 (rtt_walk_abs.0_call (mkRData ?x14603 ?x14550 ?x14930 ?x14894 (mkShared ?x31036 ?x15596 ?x15236) ?x14837 $x14893) rtt_gidx.2550503 ipa_gidx.2550503)))
 (let ((?x15717 (g_granule_state (select ?x15596 ?x15490))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2550503))))
 (or (= ?x15490 (- 1)) $x176 (= ?x15717 4) (= ?x15717 6) (not (= (e_state_s_granule (select ?x15657 rtt_gidx.2550503)) 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15573 (forall ((rtt_gidx.2550307 Int) (ipa_gidx.2550307 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x15188 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2550307 ipa_gidx.2550307)))
 (let (($x14538 (= ?x15188 (- 1))))
 (let ((?x14897 (e_state_s_granule (select (g_granules (globals (share ?x52099))) rtt_gidx.2550307))))
 (let (($x15235 (not (= ?x14897 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2550307))))
 (let ((?x14999 (g_granule_state (select (granule_data (share ?x52099)) ?x15188))))
 (let (($x14350 (= ?x14999 4)))
 (let (($x15126 (= ?x14999 6)))
 (or $x15126 $x14350 $x176 $x15235 $x14538))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14736 (not $x15573)))
 (or $x14736 $x15683)))))
 )
(assert
 (forall ((offset.2550912 Int) )(let (($x15445 (forall ((rtt_gidx.2550910 Int) (ipa_gidx.2550910 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x15473 (g_rmm_attest_public_key ?x14966)))
 (let ((?x15364 (g_rmm_attest_signing_key ?x14966)))
 (let ((?x15653 (mks_granule (e_lock (select (g_granules ?x14966) offset.2550912)) 4 (e_ref (select (g_granules ?x14966) offset.2550912)))))
 (let ((?x15121 (g_granules ?x14966)))
 (let ((?x15637 (store ?x15121 offset.2550912 ?x15653)))
 (let ((?x15453 (g_mbedtls_mem_buf ?x14966)))
 (let ((?x14243 (g_tt_l1_upper ?x14966)))
 (let ((?x15323 (g_tt_l2_mem1_3 ?x14966)))
 (let ((?x15466 (g_tt_l2_mem1_2 ?x14966)))
 ...
 (let ((?x15433 (g_debug_exits ?x14966)))
 (let ((?x15326 (g_heap ?x14966)))
 (let ((?x15734 (mkGLOBALS ?x15326 ?x15433 ?x15362 ?x15218 ?x15177 ?x15096 ?x15479 ?x15330 ?x15471 ?x15344 ?x15224 ?x14205 ?x15345 ?x15189 ?x15025 ?x15199 ?x15451 ?x15466 ?x15323 ?x14243 ?x15453 ?x15637 ?x15364 ?x15473 ?x15229 ?x15137 ?x15464 ?x15456 ?x15438 ?x14715 ?x14390)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x31036 (gpt ?x15020)))
 (let ((?x14894 (priv ?x52099)))
 (let ((?x14930 (repl ?x52099)))
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x15649 (rtt_walk_abs.0_call (mkRData ?x14603 ?x14550 ?x14930 ?x14894 (mkShared ?x31036 ?x15078 ?x15734) ?x14837 $x14893) rtt_gidx.2550910 ipa_gidx.2550910)))
 (let ((?x15810 (g_granule_state (select ?x15078 ?x15649))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2550910))))
 (or $x176 (= ?x15649 (- 1)) (= ?x15810 4) (not (= (e_state_s_granule (select ?x15637 rtt_gidx.2550910)) 5)) (= ?x15810 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15728 (forall ((rtt_gidx.2550845 Int) (ipa_gidx.2550845 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x15188 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2550845 ipa_gidx.2550845)))
 (let (($x14538 (= ?x15188 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2550845))))
 (let ((?x14897 (e_state_s_granule (select (g_granules (globals (share ?x52099))) rtt_gidx.2550845))))
 (let (($x15235 (not (= ?x14897 5))))
 (let ((?x14999 (g_granule_state (select (granule_data (share ?x52099)) ?x15188))))
 (let (($x14350 (= ?x14999 4)))
 (let (($x15126 (= ?x14999 6)))
 (or $x15126 $x14350 $x15235 $x176 $x14538))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x15704 (not $x15728)))
 (or $x15704 $x15445)))))
 )
(assert
 (forall ((rtt_gidx.2551014 Int) (ipa_gidx.2551014 Int) (i.2551014 Int) (d.2551014 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14550 (oracle ?x52099)))
 (let ((?x14603 (log ?x52099)))
 (let ((?x15136 (mkRData ?x14603 ?x14550 ?x14930 ?x14894 (mkShared ?x31036 (store (granule_data ?x15020) i.2551014 d.2551014) ?x14966) ?x14837 $x14893)))
 (let ((?x15198 (+ (rtt_walk_abs.0_call ?x52099 rtt_gidx.2551014 ipa_gidx.2551014) (* (- 1) (rtt_walk_abs.0_call ?x15136 rtt_gidx.2551014 ipa_gidx.2551014)))))
 (let (($x15235 (not (= (e_state_s_granule (select (g_granules ?x14966) i.2551014)) 5))))
 (let (($x15310 (and $x15235 (not (= (e_state_s_granule (select (g_granules ?x14966) i.2551014)) 4)))))
 (=> $x15310 (= ?x15198 0))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x16710 (forall ((rtt_gidx.2554791 Int) (ipa_gidx.2554791 Int) (data_gidx.2554791 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x13576 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2554791 ipa_gidx.2554791)))
 (let ((?x15020 (share ?x52099)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x14928 (g_granule_state (select ?x15078 ?x13576))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2554791)))
 (let (($x14378 (=> $x153 (or (= ?x14928 4) (= ?x14928 6)))))
 (let (($x14494 (= (e_state_s_granule (select (g_granules (globals ?x15020)) rtt_gidx.2554791)) 5)))
 (=> (and $x14494 (and (distinct ?x13576 (- 1)) true) $x153) (or (= ?x14928 4) (= ?x14928 6)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x16710)))
(check-sat)

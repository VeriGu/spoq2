...
(assert
 (let (($x9030 (forall ((rtt_gidx.2527996 Int) (ipa_gidx.2527996 Int) (data_gidx.2527996 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x8332 (g_granules ?x8325)))
 (let ((?x55934 (select ?x8332 ?x3159)))
 (let ((?x40350 (e_ref ?x55934)))
 (let ((?x32430 (e_lock ?x55934)))
 (let ((?x9315 (mks_granule ?x32430 1 ?x40350)))
 (let ((?x9060 (store ?x8332 ?x3159 ?x9315)))
 (let ((?x8572 (g_mbedtls_mem_buf ?x8325)))
 (let ((?x8574 (g_tt_l1_upper ?x8325)))
 (let ((?x7875 (g_tt_l2_mem1_3 ?x8325)))
 (let ((?x14700 (g_tt_l2_mem1_2 ?x8325)))
 ...
 (let ((?x8479 (g_debug_exits ?x8325)))
 (let ((?x8552 (g_heap ?x8325)))
 (let ((?x9302 (mkGLOBALS ?x8552 ?x8479 ?x8602 ?x8611 ?x8540 ?x7890 ?x8619 ?x8542 ?x8617 ?x4380 ?x8610 ?x8456 ?x8607 ?x8595 ?x8606 ?x8477 ?x7893 ?x14700 ?x7875 ?x8574 ?x8572 ?x9060 ?x8547 ?x8460 ?x8613 ?x8577 ?x8569 ?x8573 ?x7874 ?x8462 ?x8590)))
 ...
 (let ((?x7485 (oracle ?x8102)))
 (let ((?x8168 (log ?x8102)))
 (let ((?x8952 (mkRData ?x8168 ?x7485 ?x8416 ?x7794 (mkShared ?x31869 ?x9342 ?x9302) ?x8086 $x8212)))
 (let ((?x32416 (g_granule_state (select ?x9342 (rtt_walk_abs.0_call ?x8952 rtt_gidx.2527996 ipa_gidx.2527996)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2527996)))
 (let ((?x9294 (mkRData ?x8168 ?x7485 ?x8416 ?x7794 (mkShared ?x31869 ?x8435 ?x9302) ?x8086 $x8212)))
 (let ((?x9360 (mkRData (log ?x9294) (oracle ?x9294) (repl ?x9294) (priv ?x9294) (mkShared (gpt (share ?x9294)) ?x9342 (globals (share ?x9294))) (stack ?x9294) (halt ?x9294))))
 (let (($x9270 (=> (and (and (distinct (rtt_walk_abs.0_call ?x9360 rtt_gidx.2527996 ipa_gidx.2527996) (- 1)) true) $x153) (or (= ?x32416 4) (= ?x32416 6)))))
 (=> (and (= (e_state_s_granule (select ?x9060 rtt_gidx.2527996)) 5) (and (distinct (rtt_walk_abs.0_call ?x9360 rtt_gidx.2527996 ipa_gidx.2527996) (- 1)) true) $x153) (or (= ?x32416 4) (= ?x32416 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9030)))
(check-sat)

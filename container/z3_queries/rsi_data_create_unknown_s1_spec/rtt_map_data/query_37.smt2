...
(assert
 ...
 (let (($x51982 (= ?x37728 0)))
 (let (($x10631 (and $x51982 $x52098 $x46384)))
 (not $x10631)))))))))))))))))))))))))))))))))))))))
(assert
...
(assert
 ...
 (let ((?x14265 (share ?x37096)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x114072 (select ?x14171 ?x3159)))
 (let ((?x57244 (g_norm ?x114072)))
 (= ?x57244 zero_granule_data)))))))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.2544800 Int) (ipa_gidx.2544800 Int) (data_gidx.2544800 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13914 (value_Tuple_abs_ret_rtt_RData ?x46111)))
 (let ((?x37096 (elem_1 ?x13914)))
 (let ((?x14276 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2544800 ipa_gidx.2544800)))
 (let ((?x14265 (share ?x37096)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x13117 (g_granule_state (select ?x14171 ?x14276))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2544800)))
 (let (($x14112 (=> $x153 (or (= ?x13117 4) (= ?x13117 6)))))
 (let (($x14280 (= (e_state_s_granule (select (g_granules (globals ?x14265)) rtt_gidx.2544800)) 5)))
 (=> (and $x14280 (and (distinct ?x14276 (- 1)) true) $x153) (or (= ?x13117 4) (= ?x13117 6)))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x14193 (forall ((rtt_gidx.2545156 Int) (ipa_gidx.2545156 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2545156))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x13914 (value_Tuple_abs_ret_rtt_RData ?x46111)))
 (let ((?x37096 (elem_1 ?x13914)))
 (let (($x14047 (halt ?x37096)))
 (let ((?x14026 (stack ?x37096)))
 (let ((?x14265 (share ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x14241 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!5 (elem_1 (value_Tuple_abs_ret_rtt_RData
                     (rtt_walk_lock_unlock_spec_abs.0_call
                       ...
                       3
                       a!4)))))
  (oracle a!5))))))_call| ?x14300)))
 (let ((?x13141 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!5 (elem_1 (value_Tuple_abs_ret_rtt_RData
                     (rtt_walk_lock_unlock_spec_abs.0_call
                       ...
                       3
                       a!4)))))
  (repl a!5))))))_call| ?x14241 ?x14265)))
 (let ((?x13965 (value_Shared ?x13141)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x13485 (List_Event_concat ?x14241 ?x14300)))
 (let ((?x12671 (mkRData ?x13485 ?x14206 ?x13708 ?x14052 ?x13965 ?x14026 $x14047)))
 (let ((?x14322 (rtt_walk_abs.0_call ?x12671 rtt_gidx.2545156 ipa_gidx.2545156)))
 (let ((?x13459 (granule_data ?x13965)))
 (let ((?x38198 (g_granule_state (select ?x13459 ?x14322))))
 (let (($x13241 (not (= (e_state_s_granule (select (g_granules (globals ?x13965)) rtt_gidx.2545156)) 5))))
 (or (= ?x14322 (- 1)) $x13241 (= ?x38198 4) (= ?x38198 6) $x176)))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14203 (forall ((rtt_gidx.2545109 Int) (ipa_gidx.2545109 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13914 (value_Tuple_abs_ret_rtt_RData ?x46111)))
 (let ((?x37096 (elem_1 ?x13914)))
 (let ((?x14333 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2545109 ipa_gidx.2545109)))
 (let ((?x14265 (share ?x37096)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14035 (g_granule_state (select ?x14171 ?x14333))))
 (let (($x13676 (= ?x14035 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2545109))))
 (let (($x14063 (= ?x14333 (- 1))))
 (let (($x13483 (= ?x14035 6)))
 (let (($x14325 (not (= (e_state_s_granule (select (g_granules (globals ?x14265)) rtt_gidx.2545109)) 5))))
 (or $x14325 $x13483 $x14063 $x176 $x13676)))))))))))))))))))))))))))))))))
 ))
 (or (not $x14203) $x14193))))
(assert
 (forall ((offset.2545816 Int) (empty_pte.2545816 abs_PTE_t) )(let (($x14342 (forall ((rtt_gidx.2545699 Int) (ipa_gidx.2545699 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14130 (globals ?x14265)))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x13540 (e_state_s_granule (select ?x14270 rtt_gidx.2545699))))
 (let (($x14325 (not (= ?x13540 5))))
 (let ((?x14333 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2545699 ipa_gidx.2545699)))
 (let (($x14063 (= ?x14333 (- 1))))
 (let ((?x14035 (g_granule_state (select (granule_data ?x14265) ?x14333))))
 (let (($x13676 (= ?x14035 4)))
 (let (($x13483 (= ?x14035 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2545699))))
 (or $x176 $x13483 $x13676 $x14063 $x14325)))))))))))))))))))))))))))))))))))
 ))
 (let (($x14274 (not $x14342)))
 (let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2545816)) (- 1)))))
 (let ((?x2001 (div offset.2545816 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x14130 (globals ?x14265)))
 (let ((?x14270 (g_granules ?x14130)))
 (let (($x14420 (forall ((rtt_gidx.2545812 Int) (ipa_gidx.2545812 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14265 (share ?x37096)))
 (let ((?x14130 (globals ?x14265)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2545816)))
 (let ((?x2023 (mod offset.2545816 4096)))
 (let ((?x14425 (store (g_norm (select (granule_data ?x14265) (div offset.2545816 4096))) ?x2023 ?x2022)))
 (let ((?x14249 (mkr_granule_data (gd_g_idx (select (granule_data ?x14265) (div offset.2545816 4096))) (g_granule_state (select (granule_data ?x14265) (div offset.2545816 4096))) ?x14425 (g_rd (select (granule_data ?x14265) (div offset.2545816 4096))) (g_rec (select (granule_data ?x14265) (div offset.2545816 4096))))))
 (let ((?x2017 (div offset.2545816 4096)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14019 (store ?x14171 ?x2017 ?x14249)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x14414 (rtt_walk_abs.0_call (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14019 ?x14130) ?x14026 $x14047) rtt_gidx.2545812 ipa_gidx.2545812)))
 (let ((?x14415 (g_granule_state (select ?x14019 ?x14414))))
 (let (($x14325 (not (= (e_state_s_granule (select (g_granules ?x14130) rtt_gidx.2545812)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2545812))))
 (or $x176 (= ?x14414 (- 1)) (= ?x14415 6) $x14325 (= ?x14415 4)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or $x14420 (not (= (e_state_s_granule (select ?x14270 ?x2001)) 5)) $x2000 $x14274))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2546375 Int) (state.2546375 Int) )(let (($x14472 (forall ((rtt_gidx.2546373 Int) (ipa_gidx.2546373 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14265 (share ?x37096)))
 (let ((?x14130 (globals ?x14265)))
 (let ((?x14476 (g_realm_attest_private_key ?x14130)))
 (let ((?x14493 (g_get_realm_identity_identity ?x14130)))
 (let ((?x14530 (g_rmm_platform_token ?x14130)))
 (let ((?x13439 (g_platform_token_buf ?x14130)))
 (let ((?x14510 (g_rmm_attest_public_key_hash_len ?x14130)))
 (let ((?x14311 (g_rmm_attest_public_key_hash ?x14130)))
 (let ((?x14169 (g_rmm_attest_public_key_len ?x14130)))
 (let ((?x13938 (g_rmm_attest_public_key ?x14130)))
 (let ((?x14377 (g_rmm_attest_signing_key ?x14130)))
 (let ((?x14455 (mks_granule (e_lock (select (g_granules ?x14130) offset.2546375)) state.2546375 (e_ref (select (g_granules ?x14130) offset.2546375)))))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x14486 (store ?x14270 offset.2546375 ?x14455)))
 (let ((?x14456 (g_mbedtls_mem_buf ?x14130)))
 (let ((?x14489 (g_tt_l1_upper ?x14130)))
 (let ((?x14491 (g_tt_l2_mem1_3 ?x14130)))
 (let ((?x14471 (g_tt_l2_mem1_2 ?x14130)))
 (let ((?x14437 (g_tt_l2_mem1_1 ?x14130)))
 (let ((?x14450 (g_tt_l2_mem1_0 ?x14130)))
 (let ((?x14484 (g_tt_l2_mem0_1 ?x14130)))
 (let ((?x13957 (g_tt_l2_mem0_0 ?x14130)))
 (let ((?x14505 (g_tt_l3_buffer ?x14130)))
 (let ((?x13803 (g_rmm_trap_list ?x14130)))
 (let ((?x14123 (g_status_handler ?x14130)))
 (let ((?x14331 (g_default_gicstate ?x14130)))
 (let ((?x13770 (g_pri_res0_mask ?x14130)))
 (let ((?x14468 (g_max_vintid ?x14130)))
 (let ((?x14426 (g_nr_aprs ?x14130)))
 (let ((?x16689 (g_nr_lrs ?x14130)))
 (let ((?x14429 (g_vmids ?x14130)))
 (let ((?x13532 (g_vmid_lock ?x14130)))
 (let ((?x14428 (g_vmid_count ?x14130)))
 (let ((?x13534 (g_debug_exits ?x14130)))
 (let ((?x14439 (g_heap ?x14130)))
 (let ((?x14411 (mkGLOBALS ?x14439 ?x13534 ?x14428 ?x13532 ?x14429 ?x16689 ?x14426 ?x14468 ?x13770 ?x14331 ?x14123 ?x13803 ?x14505 ?x13957 ?x14484 ?x14450 ?x14437 ?x14471 ?x14491 ?x14489 ?x14456 ?x14486 ?x14377 ?x13938 ?x14169 ?x14311 ?x14510 ?x13439 ?x14530 ?x14493 ?x14476)))
 (let ((?x14100 (mkr_granule_data (gd_g_idx (select (granule_data ?x14265) offset.2546375)) (g_granule_state (select (granule_data ?x14265) offset.2546375)) zero_granule_data (g_rd (select (granule_data ?x14265) offset.2546375)) (g_rec (select (granule_data ?x14265) offset.2546375)))))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14522 (store ?x14171 offset.2546375 ?x14100)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x14517 (rtt_walk_abs.0_call (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14522 ?x14411) ?x14026 $x14047) rtt_gidx.2546373 ipa_gidx.2546373)))
 (let ((?x14132 (g_granule_state (select ?x14522 ?x14517))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2546373))))
 (or (= ?x14132 4) (= ?x14517 (- 1)) (not (= (e_state_s_granule (select ?x14486 rtt_gidx.2546373)) 5)) $x176 (= ?x14132 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14575 (forall ((rtt_gidx.2546274 Int) (ipa_gidx.2546274 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2546274))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x14130 (globals ?x14265)))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x13540 (e_state_s_granule (select ?x14270 rtt_gidx.2546274))))
 (let (($x14325 (not (= ?x13540 5))))
 (let ((?x14333 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2546274 ipa_gidx.2546274)))
 (let (($x14063 (= ?x14333 (- 1))))
 (let ((?x14035 (g_granule_state (select (granule_data ?x14265) ?x14333))))
 (let (($x13676 (= ?x14035 4)))
 (let (($x13483 (= ?x14035 6)))
 (or $x13483 $x13676 $x14063 $x14325 $x176)))))))))))))))))))))))))))))))))))
 ))
 (let (($x14177 (not $x14575)))
 (or $x14177 $x14472)))))
 )
(assert
 (forall ((parent_gidx.2547319 Int) (pte_z.2547319 Int) (x.2547319 Int) (y.2547319 Int) (z.2547319 Int) )(let (($x14232 (forall ((rtt_gidx.2547317 Int) (ipa_gidx.2547317 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2547317))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x13938 (g_rmm_attest_public_key ?x14130)))
 (let ((?x14377 (g_rmm_attest_signing_key ?x14130)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2547319))) 4096)))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x14501 (select ?x14270 ?x1845)))
 (let ((?x14805 (store ?x14270 ?x1845 (mks_granule (e_lock ?x14501) 4 (e_ref ?x14501)))))
 (let ((?x14456 (g_mbedtls_mem_buf ?x14130)))
 (let ((?x14489 (g_tt_l1_upper ?x14130)))
 (let ((?x14491 (g_tt_l2_mem1_3 ?x14130)))
 (let ((?x14471 (g_tt_l2_mem1_2 ?x14130)))
 ...
 (let ((?x13534 (g_debug_exits ?x14130)))
 (let ((?x14439 (g_heap ?x14130)))
 (let ((?x14545 (mkGLOBALS ?x14439 ?x13534 ?x14428 ?x13532 ?x14429 ?x16689 ?x14426 ?x14468 ?x13770 ?x14331 ?x14123 ?x13803 ?x14505 ?x13957 ?x14484 ?x14450 ?x14437 ?x14471 ?x14491 ?x14489 ?x14456 ?x14805 ?x14377 ?x13938 ?x14169 ?x14311 ?x14510 ?x13439 ?x14530 ?x14493 ?x14476)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2547319)) x.2547319 y.2547319 z.2547319))))
 (let ((?x1892 (mod parent_gidx.2547319 4096)))
 (let ((?x14666 (store (g_norm (select (granule_data ?x14265) (div parent_gidx.2547319 4096))) ?x1892 ?x1891)))
 (let ((?x13445 (mkr_granule_data (gd_g_idx (select (granule_data ?x14265) (div parent_gidx.2547319 4096))) (g_granule_state (select (granule_data ?x14265) (div parent_gidx.2547319 4096))) ?x14666 (g_rd (select (granule_data ?x14265) (div parent_gidx.2547319 4096))) (g_rec (select (granule_data ?x14265) (div parent_gidx.2547319 4096))))))
 (let ((?x1886 (div parent_gidx.2547319 4096)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14811 (store ?x14171 ?x1886 ?x13445)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x14566 (rtt_walk_abs.0_call (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14811 ?x14545) ?x14026 $x14047) rtt_gidx.2547317 ipa_gidx.2547317)))
 (let ((?x14825 (g_granule_state (select ?x14811 ?x14566))))
 (or (= ?x14566 (- 1)) (not (= (e_state_s_granule (select ?x14805 rtt_gidx.2547317)) 5)) (= ?x14825 4) (= ?x14825 6) $x176))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14781 (forall ((rtt_gidx.2547121 Int) (ipa_gidx.2547121 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14130 (globals ?x14265)))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x13540 (e_state_s_granule (select ?x14270 rtt_gidx.2547121))))
 (let (($x14325 (not (= ?x13540 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2547121))))
 (let ((?x14035 (g_granule_state (select (granule_data ?x14265) (rtt_walk_abs.0_call ?x37096 rtt_gidx.2547121 ipa_gidx.2547121)))))
 (let (($x13676 (= ?x14035 4)))
 (let ((?x14333 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2547121 ipa_gidx.2547121)))
 (let (($x14063 (= ?x14333 (- 1))))
 (let (($x13483 (= ?x14035 6)))
 (or $x13483 $x14063 $x13676 $x176 $x14325)))))))))))))))))))))))))))))))))))
 ))
 (let (($x13763 (not $x14781)))
 (or $x13763 $x14232)))))
 )
(assert
 (forall ((offset.2547726 Int) )(let (($x14588 (forall ((rtt_gidx.2547724 Int) (ipa_gidx.2547724 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13938 (g_rmm_attest_public_key ?x14130)))
 (let ((?x14377 (g_rmm_attest_signing_key ?x14130)))
 (let ((?x14116 (mks_granule (e_lock (select (g_granules ?x14130) offset.2547726)) 4 (e_ref (select (g_granules ?x14130) offset.2547726)))))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x14562 (store ?x14270 offset.2547726 ?x14116)))
 (let ((?x14456 (g_mbedtls_mem_buf ?x14130)))
 (let ((?x14489 (g_tt_l1_upper ?x14130)))
 (let ((?x14491 (g_tt_l2_mem1_3 ?x14130)))
 (let ((?x14471 (g_tt_l2_mem1_2 ?x14130)))
 ...
 (let ((?x13534 (g_debug_exits ?x14130)))
 (let ((?x14439 (g_heap ?x14130)))
 (let ((?x14739 (mkGLOBALS ?x14439 ?x13534 ?x14428 ?x13532 ?x14429 ?x16689 ?x14426 ?x14468 ?x13770 ?x14331 ?x14123 ?x13803 ?x14505 ?x13957 ?x14484 ?x14450 ?x14437 ?x14471 ?x14491 ?x14489 ?x14456 ?x14562 ?x14377 ?x13938 ?x14169 ?x14311 ?x14510 ?x13439 ?x14530 ?x14493 ?x14476)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x13928 (rtt_walk_abs.0_call (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14171 ?x14739) ?x14026 $x14047) rtt_gidx.2547724 ipa_gidx.2547724)))
 (let ((?x14636 (g_granule_state (select ?x14171 ?x13928))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2547724))))
 (or (= ?x14636 4) (not (= (e_state_s_granule (select ?x14562 rtt_gidx.2547724)) 5)) $x176 (= ?x13928 (- 1)) (= ?x14636 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x14399 (forall ((rtt_gidx.2547659 Int) (ipa_gidx.2547659 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13914 (value_Tuple_abs_ret_rtt_RData ?x46111)))
 (let ((?x37096 (elem_1 ?x13914)))
 (let ((?x14333 (rtt_walk_abs.0_call ?x37096 rtt_gidx.2547659 ipa_gidx.2547659)))
 (let (($x14063 (= ?x14333 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2547659))))
 (let ((?x13540 (e_state_s_granule (select (g_granules (globals (share ?x37096))) rtt_gidx.2547659))))
 (let (($x14325 (not (= ?x13540 5))))
 (let ((?x14035 (g_granule_state (select (granule_data (share ?x37096)) ?x14333))))
 (let (($x13676 (= ?x14035 4)))
 (let (($x13483 (= ?x14035 6)))
 (or $x13483 $x13676 $x14325 $x176 $x14063))))))))))))))))))))))))))))))))
 ))
 (let (($x14761 (not $x14399)))
 (or $x14761 $x14588)))))
 )
(assert
 (forall ((rtt_gidx.2547828 Int) (ipa_gidx.2547828 Int) (i.2547828 Int) (d.2547828 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x14616 (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 (store (granule_data ?x14265) i.2547828 d.2547828) ?x14130) ?x14026 $x14047)))
 (let ((?x14856 (+ (rtt_walk_abs.0_call ?x37096 rtt_gidx.2547828 ipa_gidx.2547828) (* (- 1) (rtt_walk_abs.0_call ?x14616 rtt_gidx.2547828 ipa_gidx.2547828)))))
 (let (($x14325 (not (= (e_state_s_granule (select (g_granules ?x14130) i.2547828)) 5))))
 (let (($x14630 (and $x14325 (not (= (e_state_s_granule (select (g_granules ?x14130) i.2547828)) 4)))))
 (=> $x14630 (= ?x14856 0))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x49516 (forall ((rtt_gidx.2561834 Int) (ipa_gidx.2561834 Int) (data_gidx.2561834 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x49289 (select ?x14270 ?x3159)))
 (let ((?x19145 (e_ref ?x49289)))
 (let ((?x19232 (e_lock ?x49289)))
 (let ((?x19112 (mks_granule ?x19232 1 ?x19145)))
 (let ((?x18564 (store ?x14270 ?x3159 ?x19112)))
 (let ((?x14456 (g_mbedtls_mem_buf ?x14130)))
 (let ((?x14489 (g_tt_l1_upper ?x14130)))
 (let ((?x14491 (g_tt_l2_mem1_3 ?x14130)))
 (let ((?x14471 (g_tt_l2_mem1_2 ?x14130)))
 ...
 (let ((?x13534 (g_debug_exits ?x14130)))
 (let ((?x14439 (g_heap ?x14130)))
 (let ((?x58084 (mkGLOBALS ?x14439 ?x13534 ?x14428 ?x13532 ?x14429 ?x16689 ?x14426 ?x14468 ?x13770 ?x14331 ?x14123 ?x13803 ?x14505 ?x13957 ?x14484 ?x14450 ?x14437 ?x14471 ?x14491 ?x14489 ?x14456 ?x18564 ?x14377 ?x13938 ?x14169 ?x14311 ?x14510 ?x13439 ?x14530 ?x14493 ?x14476)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x18827 (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14171 ?x58084) ?x14026 $x14047)))
 (let ((?x57234 (rtt_walk_abs.0_call ?x18827 rtt_gidx.2561834 ipa_gidx.2561834)))
 (let ((?x57969 (g_granule_state (select ?x14171 ?x57234))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561834)))
 (let (($x58122 (=> (and (and (distinct ?x57234 (- 1)) true) $x153) (or (= ?x57969 4) (= ?x57969 6)))))
 (=> (and (= (e_state_s_granule (select ?x18564 rtt_gidx.2561834)) 5) (and (distinct ?x57234 (- 1)) true) $x153) (or (= ?x57969 4) (= ?x57969 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x49516)))
(check-sat)

...
(assert
 ...
 (let ((?x52117 (e_2 ?x14002)))
 (let ((?x14873 (poffset ?x52117)))
 (let ((?x154435 (+ 8 ?x14873)))
 (let ((?x15996 (mod ?x154435 4096)))
 (= ?x15996 8))))))))))))))))))))))))))))
(assert
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
...
(assert
 (let (($x48781 (forall ((rtt_gidx.2561290 Int) (ipa_gidx.2561290 Int) (data_gidx.2561290 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x14873 (poffset ?x52117)))
 (let ((?x14201 (+ ?x14873 ?x52538)))
 (let ((?x15175 (div ?x14201 4096)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x57360 (select ?x17401 ?x15175)))
 (let ((?x16094 (mkabs_PTE_t ?x2324 0 0 3)))
 (let ((?x53970 (test_PTE_Z.0_call ?x16094)))
 (let ((?x16742 (mod ?x14201 4096)))
 (let ((?x7290 (g_norm ?x57360)))
 (let ((?x18849 (store ?x7290 ?x16742 ?x53970)))
 (let ((?x18876 (mkr_granule_data (gd_g_idx ?x57360) (g_granule_state ?x57360) ?x18849 (g_rd ?x57360) (g_rec ?x57360))))
 (let ((?x18596 (store ?x17401 ?x15175 ?x18876)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x69248 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18596 ?x53835) ?x114807 $x17367)))
 (let ((?x48775 (g_granule_state (select ?x18596 (rtt_walk_abs.0_call ?x69248 rtt_gidx.2561290 ipa_gidx.2561290)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561290)))
 (let ((?x129293 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x17401 ?x53835) ?x114807 $x17367)))
 (let ((?x18618 (mkRData (log ?x129293) (oracle ?x129293) (repl ?x129293) (priv ?x129293) (mkShared (gpt (share ?x129293)) ?x18596 (globals (share ?x129293))) (stack ?x129293) (halt ?x129293))))
 (let (($x17778 (=> (and (and (distinct (rtt_walk_abs.0_call ?x18618 rtt_gidx.2561290 ipa_gidx.2561290) (- 1)) true) $x153) (or (= ?x48775 4) (= ?x48775 6)))))
 (=> (and (= (e_state_s_granule (select ?x57295 rtt_gidx.2561290)) 5) (and (distinct (rtt_walk_abs.0_call ?x18618 rtt_gidx.2561290 ipa_gidx.2561290) (- 1)) true) $x153) (or (= ?x48775 4) (= ?x48775 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x48781)))
(check-sat)

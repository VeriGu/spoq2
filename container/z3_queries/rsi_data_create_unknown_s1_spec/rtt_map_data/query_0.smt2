...
(assert
 ...
 (let ((?x1875 (store (g_norm (select (granule_data ?x15) (div parent_gidx.101094 4096))) (mod parent_gidx.101094 4096) ?x1891)))
...
(assert
 ...
 (let ((?x15 (share st.0)))
 (let ((?x31 (globals ?x15)))
 (let ((?x2025 (store (g_norm (select (granule_data ?x15) (div offset.137957 4096))) (mod offset.137957 4096) (test_PTE_Z.0_call empty_pte.137957))))
...
(assert
 (let (($x2346 (forall ((rtt_gidx.2504749 Int) (ipa_gidx.2504749 Int) (data_gidx.2504749 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.2504749 ipa_gidx.2504749)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2504749)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.2504749)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 ))
 (not $x2346)))
(check-sat)

...
(assert
 (let (($x11782 (forall ((rtt_gidx.2535084 Int) (ipa_gidx.2535084 Int) (data_gidx.2535084 Int) )(let ((?x147 (rtt_walk_abs.0_call st.0 rtt_gidx.2535084 ipa_gidx.2535084)))
 (let ((?x15 (share st.0)))
 (let ((?x17 (granule_data ?x15)))
 (let ((?x149 (g_granule_state (select ?x17 ?x147))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2535084)))
 (let (($x154 (=> $x153 (or (= ?x149 4) (= ?x149 6)))))
 (let (($x160 (= (e_state_s_granule (select (g_granules (globals ?x15)) rtt_gidx.2535084)) 5)))
 (=> (and $x160 (and (distinct ?x147 (- 1)) true) $x153) (or (= ?x149 4) (= ?x149 6)))))))))))
 ))
 (not $x11782)))
(check-sat)

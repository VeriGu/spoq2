...
(assert
 (let (($x25044 (forall ((rtt_gidx.2528472 Int) (ipa_gidx.2528472 Int) (data_gidx.2528472 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x9445 (rtt_walk_abs.0_call ?x40917 rtt_gidx.2528472 ipa_gidx.2528472)))
 (let ((?x32670 (g_granule_state (select ?x4519 ?x9445))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2528472)))
 (let (($x9361 (=> (and (and (distinct ?x9445 (- 1)) true) $x153) (or (= ?x32670 4) (= ?x32670 6)))))
 (=> (and (= (e_state_s_granule (select ?x9261 rtt_gidx.2528472)) 5) (and (distinct ?x9445 (- 1)) true) $x153) (or (= ?x32670 4) (= ?x32670 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x25044)))
(check-sat)

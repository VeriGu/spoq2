...
(assert
 ...
 (let ((?x17630 (memcpy_ns_read_spec_state_oracle.0_call ?x6082 ?x5902 4096 ?x101639)))
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x17613 (share ?x16897)))
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (= ?x17237 ?x67786)))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x2393 (test_PA.0_call v_1.0)))
 (let ((?x19072 (meta_granule_offset ?x2393)))
 ...
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x69356 (select ?x17237 ?x4130)))
 (let ((?x18327 (e_state_s_granule ?x69356)))
 (= ?x18327 5)))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 ...
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x85376 (select ?x17237 ?x3159)))
 (let ((?x54618 (e_state_s_granule ?x85376)))
 (= ?x54618 1)))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
...
(assert
 ...
 (and $x3222 $x3185))))))))
(assert
 (forall ((rtt_gidx.2558056 Int) (ipa_gidx.2558056 Int) (data_gidx.2558056 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x18127 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2558056 ipa_gidx.2558056)))
 (let ((?x17613 (share ?x16897)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18169 (g_granule_state (select ?x17401 ?x18127))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2558056)))
 (let (($x18187 (=> $x153 (or (= ?x18169 4) (= ?x18169 6)))))
 (let (($x17968 (= (e_state_s_granule (select (g_granules (globals ?x17613)) rtt_gidx.2558056)) 5)))
 (=> (and $x17968 (and (distinct ?x18127 (- 1)) true) $x153) (or (= ?x18169 4) (= ?x18169 6))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x18052 (forall ((rtt_gidx.2558412 Int) (ipa_gidx.2558412 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x17613 (share ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x114802 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!3 (spinlock_acquire_spec.0_call
...
(let ((a!10 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec_state_oracle.0_call
                        ...
                        4096
                        a!9)))))
  (oracle a!10))))))))))_call| ?x17921)))
 (let ((?x17958 (|(let ((a!1 (mkPtr "granule_data"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0)))))
      (a!2 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!3 (spinlock_acquire_spec.0_call
...
(let ((a!10 (elem_1 (value_Tuple_bool_RData
                      (memcpy_ns_read_spec_state_oracle.0_call
                        ...
                        4096
                        a!9)))))
  (repl a!10))))))))))_call| ?x114802 ?x17613)))
 (let ((?x17927 (value_Shared ?x17958)))
 (let ((?x18009 (globals ?x17927)))
 (let ((?x18189 (g_granules ?x18009)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2558412))))
 (let (($x17367 (halt ?x16897)))
 (let ((?x114807 (stack ?x16897)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17725 (List_Event_concat ?x114802 ?x17921)))
 (let ((?x17601 (mkRData ?x17725 ?x16999 ?x17611 ?x17930 ?x17927 ?x114807 $x17367)))
 (let ((?x18026 (rtt_walk_abs.0_call ?x17601 rtt_gidx.2558412 ipa_gidx.2558412)))
 (let ((?x17621 (granule_data ?x17927)))
 (let ((?x17979 (g_granule_state (select ?x17621 ?x18026))))
 (or (= ?x18026 (- 1)) (= ?x17979 6) (= ?x17979 4) $x176 (not (= (e_state_s_granule (select ?x18189 rtt_gidx.2558412)) 5)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18202 (forall ((rtt_gidx.2558365 Int) (ipa_gidx.2558365 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x18182 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2558365 ipa_gidx.2558365)))
 (let ((?x17613 (share ?x16897)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18148 (g_granule_state (select ?x17401 ?x18182))))
 (let (($x18197 (= ?x18148 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2558365))))
 (let (($x18158 (= ?x18148 6)))
 (let (($x18012 (not (= (e_state_s_granule (select (g_granules (globals ?x17613)) rtt_gidx.2558365)) 5))))
 (let (($x18175 (= ?x18182 (- 1))))
 (or $x18175 $x18012 $x18158 $x176 $x18197))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x18202) $x18052))))
(assert
 (forall ((offset.2559072 Int) (empty_pte.2559072 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2559072)) (- 1)))))
 (let (($x18190 (forall ((rtt_gidx.2558955 Int) (ipa_gidx.2558955 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x18182 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2558955 ipa_gidx.2558955)))
 (let ((?x17613 (share ?x16897)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18148 (g_granule_state (select ?x17401 ?x18182))))
 (let (($x18197 (= ?x18148 4)))
 (let (($x18175 (= ?x18182 (- 1))))
 (let (($x18158 (= ?x18148 6)))
 (let (($x18012 (not (= (e_state_s_granule (select (g_granules (globals ?x17613)) rtt_gidx.2558955)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2558955))))
 (or $x176 $x18012 $x18158 $x18175 $x18197))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x17385 (not $x18190)))
 (let (($x17403 (forall ((rtt_gidx.2559068 Int) (ipa_gidx.2559068 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17613 (share ?x16897)))
 (let ((?x13162 (globals ?x17613)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2559072)))
 (let ((?x2023 (mod offset.2559072 4096)))
 (let ((?x17946 (store (g_norm (select (granule_data ?x17613) (div offset.2559072 4096))) ?x2023 ?x2022)))
 (let ((?x18039 (mkr_granule_data (gd_g_idx (select (granule_data ?x17613) (div offset.2559072 4096))) (g_granule_state (select (granule_data ?x17613) (div offset.2559072 4096))) ?x17946 (g_rd (select (granule_data ?x17613) (div offset.2559072 4096))) (g_rec (select (granule_data ?x17613) (div offset.2559072 4096))))))
 (let ((?x2017 (div offset.2559072 4096)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18151 (store ?x17401 ?x2017 ?x18039)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x18013 (rtt_walk_abs.0_call (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18151 ?x13162) ?x114807 $x17367) rtt_gidx.2559068 ipa_gidx.2559068)))
 (let ((?x17339 (g_granule_state (select ?x18151 ?x18013))))
 (let (($x18012 (not (= (e_state_s_granule (select (g_granules ?x13162) rtt_gidx.2559068)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2559068))))
 (or $x176 (= ?x17339 4) $x18012 (= ?x18013 (- 1)) (= ?x17339 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x2001 (div offset.2559072 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (or (not (= (e_state_s_granule (select ?x17237 ?x2001)) 5)) $x17403 $x17385 $x2000)))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2559631 Int) (state.2559631 Int) )(let (($x18399 (forall ((rtt_gidx.2559629 Int) (ipa_gidx.2559629 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x18463 (select ?x17237 offset.2559631)))
 (let ((?x18447 (store ?x17237 offset.2559631 (mks_granule (e_lock ?x18463) state.2559631 (e_ref ?x18463)))))
 (let (($x17367 (halt ?x16897)))
 (let ((?x114807 (stack ?x16897)))
 (let ((?x18046 (g_realm_attest_private_key ?x13162)))
 (let ((?x18306 (g_get_realm_identity_identity ?x13162)))
 (let ((?x18284 (g_rmm_platform_token ?x13162)))
 (let ((?x18268 (g_platform_token_buf ?x13162)))
 (let ((?x17634 (g_rmm_attest_public_key_hash_len ?x13162)))
 (let ((?x17023 (g_rmm_attest_public_key_hash ?x13162)))
 (let ((?x18287 (g_rmm_attest_public_key_len ?x13162)))
 (let ((?x17939 (g_rmm_attest_public_key ?x13162)))
 (let ((?x18122 (g_rmm_attest_signing_key ?x13162)))
 (let ((?x18212 (g_mbedtls_mem_buf ?x13162)))
 (let ((?x17913 (g_tt_l1_upper ?x13162)))
 (let ((?x17767 (g_tt_l2_mem1_3 ?x13162)))
 (let ((?x18248 (g_tt_l2_mem1_2 ?x13162)))
 (let ((?x17628 (g_tt_l2_mem1_1 ?x13162)))
 (let ((?x18262 (g_tt_l2_mem1_0 ?x13162)))
 (let ((?x18044 (g_tt_l2_mem0_1 ?x13162)))
 (let ((?x17333 (g_tt_l2_mem0_0 ?x13162)))
 (let ((?x17993 (g_tt_l3_buffer ?x13162)))
 (let ((?x18001 (g_rmm_trap_list ?x13162)))
 (let ((?x18241 (g_status_handler ?x13162)))
 (let ((?x18263 (g_default_gicstate ?x13162)))
 (let ((?x18097 (g_pri_res0_mask ?x13162)))
 (let ((?x18055 (g_max_vintid ?x13162)))
 (let ((?x17871 (g_nr_aprs ?x13162)))
 (let ((?x17813 (g_nr_lrs ?x13162)))
 (let ((?x18101 (g_vmids ?x13162)))
 (let ((?x18135 (g_vmid_lock ?x13162)))
 (let ((?x17883 (g_vmid_count ?x13162)))
 (let ((?x18089 (g_debug_exits ?x13162)))
 (let ((?x18188 (g_heap ?x13162)))
 (let ((?x18484 (mkGLOBALS ?x18188 ?x18089 ?x17883 ?x18135 ?x18101 ?x17813 ?x17871 ?x18055 ?x18097 ?x18263 ?x18241 ?x18001 ?x17993 ?x17333 ?x18044 ?x18262 ?x17628 ?x18248 ?x17767 ?x17913 ?x18212 ?x18447 ?x18122 ?x17939 ?x18287 ?x17023 ?x17634 ?x18268 ?x18284 ?x18306 ?x18046)))
 (let ((?x18497 (mkr_granule_data (gd_g_idx (select (granule_data ?x17613) offset.2559631)) (g_granule_state (select (granule_data ?x17613) offset.2559631)) zero_granule_data (g_rd (select (granule_data ?x17613) offset.2559631)) (g_rec (select (granule_data ?x17613) offset.2559631)))))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18506 (store ?x17401 offset.2559631 ?x18497)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x18346 (rtt_walk_abs.0_call (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18506 ?x18484) ?x114807 $x17367) rtt_gidx.2559629 ipa_gidx.2559629)))
 (let ((?x18632 (g_granule_state (select ?x18506 ?x18346))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2559629))))
 (or $x176 (= ?x18632 4) (= ?x18346 (- 1)) (= ?x18632 6) (not (= (e_state_s_granule (select ?x18447 rtt_gidx.2559629)) 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18219 (forall ((rtt_gidx.2559530 Int) (ipa_gidx.2559530 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x18182 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2559530 ipa_gidx.2559530)))
 (let (($x18175 (= ?x18182 (- 1))))
 (let ((?x18154 (e_state_s_granule (select (g_granules (globals (share ?x16897))) rtt_gidx.2559530))))
 (let (($x18012 (not (= ?x18154 5))))
 (let ((?x18148 (g_granule_state (select (granule_data (share ?x16897)) ?x18182))))
 (let (($x18197 (= ?x18148 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2559530))))
 (let (($x18158 (= ?x18148 6)))
 (or $x18158 $x176 $x18197 $x18012 $x18175)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18105 (not $x18219)))
 (or $x18105 $x18399)))))
 )
(assert
 (forall ((parent_gidx.2560575 Int) (pte_z.2560575 Int) (x.2560575 Int) (y.2560575 Int) (z.2560575 Int) )(let (($x18432 (forall ((rtt_gidx.2560573 Int) (ipa_gidx.2560573 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17939 (g_rmm_attest_public_key ?x13162)))
 (let ((?x18122 (g_rmm_attest_signing_key ?x13162)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2560575))) 4096)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x17702 (select ?x17237 ?x1845)))
 (let ((?x18474 (store ?x17237 ?x1845 (mks_granule (e_lock ?x17702) 4 (e_ref ?x17702)))))
 (let ((?x18212 (g_mbedtls_mem_buf ?x13162)))
 (let ((?x17913 (g_tt_l1_upper ?x13162)))
 (let ((?x17767 (g_tt_l2_mem1_3 ?x13162)))
 (let ((?x18248 (g_tt_l2_mem1_2 ?x13162)))
 ...
 (let ((?x18089 (g_debug_exits ?x13162)))
 (let ((?x18188 (g_heap ?x13162)))
 (let ((?x18298 (mkGLOBALS ?x18188 ?x18089 ?x17883 ?x18135 ?x18101 ?x17813 ?x17871 ?x18055 ?x18097 ?x18263 ?x18241 ?x18001 ?x17993 ?x17333 ?x18044 ?x18262 ?x17628 ?x18248 ?x17767 ?x17913 ?x18212 ?x18474 ?x18122 ?x17939 ?x18287 ?x17023 ?x17634 ?x18268 ?x18284 ?x18306 ?x18046)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2560575)) x.2560575 y.2560575 z.2560575))))
 (let ((?x1892 (mod parent_gidx.2560575 4096)))
 (let ((?x18379 (store (g_norm (select (granule_data ?x17613) (div parent_gidx.2560575 4096))) ?x1892 ?x1891)))
 (let ((?x18453 (mkr_granule_data (gd_g_idx (select (granule_data ?x17613) (div parent_gidx.2560575 4096))) (g_granule_state (select (granule_data ?x17613) (div parent_gidx.2560575 4096))) ?x18379 (g_rd (select (granule_data ?x17613) (div parent_gidx.2560575 4096))) (g_rec (select (granule_data ?x17613) (div parent_gidx.2560575 4096))))))
 (let ((?x1886 (div parent_gidx.2560575 4096)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18307 (store ?x17401 ?x1886 ?x18453)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x18702 (rtt_walk_abs.0_call (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18307 ?x18298) ?x114807 $x17367) rtt_gidx.2560573 ipa_gidx.2560573)))
 (let ((?x18430 (g_granule_state (select ?x18307 ?x18702))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2560573))))
 (or (not (= (e_state_s_granule (select ?x18474 rtt_gidx.2560573)) 5)) (= ?x18702 (- 1)) (= ?x18430 6) $x176 (= ?x18430 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18343 (forall ((rtt_gidx.2560377 Int) (ipa_gidx.2560377 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2560377))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x17742 (value_Tuple_bool_RData ?x17630)))
 (let ((?x16897 (elem_1 ?x17742)))
 (let ((?x18182 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2560377 ipa_gidx.2560377)))
 (let (($x18175 (= ?x18182 (- 1))))
 (let ((?x18154 (e_state_s_granule (select (g_granules (globals (share ?x16897))) rtt_gidx.2560377))))
 (let (($x18012 (not (= ?x18154 5))))
 (let ((?x18148 (g_granule_state (select (granule_data (share ?x16897)) ?x18182))))
 (let (($x18197 (= ?x18148 4)))
 (let (($x18158 (= ?x18148 6)))
 (or $x18158 $x18197 $x18012 $x18175 $x176)))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x17644 (not $x18343)))
 (or $x17644 $x18432)))))
 )
(assert
 (forall ((offset.2560982 Int) )(let (($x18352 (forall ((rtt_gidx.2560980 Int) (ipa_gidx.2560980 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17939 (g_rmm_attest_public_key ?x13162)))
 (let ((?x18122 (g_rmm_attest_signing_key ?x13162)))
 (let ((?x18405 (mks_granule (e_lock (select (g_granules ?x13162) offset.2560982)) 4 (e_ref (select (g_granules ?x13162) offset.2560982)))))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x18002 (store ?x17237 offset.2560982 ?x18405)))
 (let ((?x18212 (g_mbedtls_mem_buf ?x13162)))
 (let ((?x17913 (g_tt_l1_upper ?x13162)))
 (let ((?x17767 (g_tt_l2_mem1_3 ?x13162)))
 (let ((?x18248 (g_tt_l2_mem1_2 ?x13162)))
 ...
 (let ((?x18089 (g_debug_exits ?x13162)))
 (let ((?x18188 (g_heap ?x13162)))
 (let ((?x18171 (mkGLOBALS ?x18188 ?x18089 ?x17883 ?x18135 ?x18101 ?x17813 ?x17871 ?x18055 ?x18097 ?x18263 ?x18241 ?x18001 ?x17993 ?x17333 ?x18044 ?x18262 ?x17628 ?x18248 ?x17767 ?x17913 ?x18212 ?x18002 ?x18122 ?x17939 ?x18287 ?x17023 ?x17634 ?x18268 ?x18284 ?x18306 ?x18046)))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x17668 (rtt_walk_abs.0_call (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x17401 ?x18171) ?x114807 $x17367) rtt_gidx.2560980 ipa_gidx.2560980)))
 (let ((?x18375 (g_granule_state (select ?x17401 ?x17668))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2560980))))
 (or (not (= (e_state_s_granule (select ?x18002 rtt_gidx.2560980)) 5)) $x176 (= ?x18375 6) (= ?x17668 (- 1)) (= ?x18375 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18258 (forall ((rtt_gidx.2560915 Int) (ipa_gidx.2560915 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13162 (globals ?x17613)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x18154 (e_state_s_granule (select ?x17237 rtt_gidx.2560915))))
 (let (($x18012 (not (= ?x18154 5))))
 (let ((?x18182 (rtt_walk_abs.0_call ?x16897 rtt_gidx.2560915 ipa_gidx.2560915)))
 (let (($x18175 (= ?x18182 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2560915))))
 (let ((?x18148 (g_granule_state (select (granule_data ?x17613) ?x18182))))
 (let (($x18197 (= ?x18148 4)))
 (let (($x18158 (= ?x18148 6)))
 (or $x18158 $x18197 $x176 $x18175 $x18012))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x18566 (not $x18258)))
 (or $x18566 $x18352)))))
 )
(assert
 (forall ((rtt_gidx.2561084 Int) (ipa_gidx.2561084 Int) (i.2561084 Int) (d.2561084 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x18465 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 (store (granule_data ?x17613) i.2561084 d.2561084) ?x13162) ?x114807 $x17367)))
 (let ((?x17976 (+ (rtt_walk_abs.0_call ?x16897 rtt_gidx.2561084 ipa_gidx.2561084) (* (- 1) (rtt_walk_abs.0_call ?x18465 rtt_gidx.2561084 ipa_gidx.2561084)))))
 (let (($x18012 (not (= (e_state_s_granule (select (g_granules ?x13162) i.2561084)) 5))))
 (let (($x18574 (and $x18012 (not (= (e_state_s_granule (select (g_granules ?x13162) i.2561084)) 4)))))
 (=> $x18574 (= ?x17976 0)))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x57715 (forall ((rtt_gidx.2561443 Int) (ipa_gidx.2561443 Int) (data_gidx.2561443 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x17939 (g_rmm_attest_public_key ?x13162)))
 (let ((?x18122 (g_rmm_attest_signing_key ?x13162)))
 (let ((?x57384 (mks_granule (e_lock (select (g_granules ?x13162) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x13162) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x17237 (g_granules ?x13162)))
 (let ((?x57295 (store ?x17237 ?x3159 ?x57384)))
 (let ((?x18212 (g_mbedtls_mem_buf ?x13162)))
 (let ((?x17913 (g_tt_l1_upper ?x13162)))
 (let ((?x17767 (g_tt_l2_mem1_3 ?x13162)))
 (let ((?x18248 (g_tt_l2_mem1_2 ?x13162)))
 ...
 (let ((?x18089 (g_debug_exits ?x13162)))
 (let ((?x18188 (g_heap ?x13162)))
 (let ((?x53835 (mkGLOBALS ?x18188 ?x18089 ?x17883 ?x18135 ?x18101 ?x17813 ?x17871 ?x18055 ?x18097 ?x18263 ?x18241 ?x18001 ?x17993 ?x17333 ?x18044 ?x18262 ?x17628 ?x18248 ?x17767 ?x17913 ?x18212 ?x57295 ?x18122 ?x17939 ?x18287 ?x17023 ?x17634 ?x18268 ?x18284 ?x18306 ?x18046)))
 (let ((?x33719 (mkr_granule_data (gd_g_idx (select (granule_data ?x17613) ?x3159)) (g_granule_state (select (granule_data ?x17613) ?x3159)) zero_granule_data (g_rd (select (granule_data ?x17613) ?x3159)) (g_rec (select (granule_data ?x17613) ?x3159)))))
 (let ((?x17401 (granule_data ?x17613)))
 (let ((?x18425 (store ?x17401 ?x3159 ?x33719)))
 (let ((?x42380 (gpt ?x17613)))
 (let ((?x17930 (priv ?x16897)))
 (let ((?x17611 (repl ?x16897)))
 (let ((?x16999 (oracle ?x16897)))
 (let ((?x17921 (log ?x16897)))
 (let ((?x18429 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x18425 ?x53835) ?x114807 $x17367)))
 (let ((?x48621 (g_granule_state (select ?x18425 (rtt_walk_abs.0_call ?x18429 rtt_gidx.2561443 ipa_gidx.2561443)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561443)))
 (let ((?x129293 (mkRData ?x17921 ?x16999 ?x17611 ?x17930 (mkShared ?x42380 ?x17401 ?x53835) ?x114807 $x17367)))
 (let (($x124079 (halt ?x129293)))
 (let ((?x18569 (stack ?x129293)))
 (let ((?x154644 (priv ?x129293)))
 (let ((?x18512 (repl ?x129293)))
 (let ((?x57105 (oracle ?x129293)))
 (let ((?x57413 (log ?x129293)))
 (let ((?x18772 (mkRData ?x57413 ?x57105 ?x18512 ?x154644 (mkShared (gpt (share ?x129293)) ?x18425 (globals (share ?x129293))) ?x18569 $x124079)))
 (let (($x57663 (=> (and (and (distinct (rtt_walk_abs.0_call ?x18772 rtt_gidx.2561443 ipa_gidx.2561443) (- 1)) true) $x153) (or (= ?x48621 4) (= ?x48621 6)))))
 (let (($x57434 (= (e_state_s_granule (select ?x57295 rtt_gidx.2561443)) 5)))
 (=> (and $x57434 (and (distinct (rtt_walk_abs.0_call ?x18772 rtt_gidx.2561443 ipa_gidx.2561443) (- 1)) true) $x153) (or (= ?x48621 4) (= ?x48621 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x57715)))
(check-sat)

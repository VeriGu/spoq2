...
(assert
 (let (($x80444 (forall ((rtt_gidx.2562072 Int) (ipa_gidx.2562072 Int) (data_gidx.2562072 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x57234 (rtt_walk_abs.0_call ?x18827 rtt_gidx.2562072 ipa_gidx.2562072)))
 (let ((?x57969 (g_granule_state (select ?x14171 ?x57234))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2562072)))
 (let (($x58122 (=> (and (and (distinct ?x57234 (- 1)) true) $x153) (or (= ?x57969 4) (= ?x57969 6)))))
 (=> (and (= (e_state_s_granule (select ?x18564 rtt_gidx.2562072)) 5) (and (distinct ?x57234 (- 1)) true) $x153) (or (= ?x57969 4) (= ?x57969 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x80444)))
(check-sat)

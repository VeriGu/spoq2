...
(assert
 (let (($x15487 (forall ((rtt_gidx.2551093 Int) (ipa_gidx.2551093 Int) (data_gidx.2551093 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x46145 (spinlock_acquire_spec.0_call ?x45144 ?x37096)))
 (let ((?x52099 (value_RData ?x46145)))
 (let ((?x13576 (rtt_walk_abs.0_call ?x52099 rtt_gidx.2551093 ipa_gidx.2551093)))
 (let ((?x15020 (share ?x52099)))
 (let ((?x15078 (granule_data ?x15020)))
 (let ((?x14928 (g_granule_state (select ?x15078 ?x13576))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2551093)))
 (let (($x14378 (=> $x153 (or (= ?x14928 4) (= ?x14928 6)))))
 (let (($x14494 (= (e_state_s_granule (select (g_granules (globals ?x15020)) rtt_gidx.2551093)) 5)))
 (=> (and $x14494 (and (distinct ?x13576 (- 1)) true) $x153) (or (= ?x14928 4) (= ?x14928 6)))))))))))))))))))))))))))))))))))))))
 ))
 (not $x15487)))
(check-sat)

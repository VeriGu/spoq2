...
(assert
 (let (($x28282 (forall ((rtt_gidx.2514307 Int) (ipa_gidx.2514307 Int) (data_gidx.2514307 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x4160 (value_Tuple_abs_ret_rtt_RData ?x4101)))
 (let ((?x4102 (elem_1 ?x4160)))
 (let ((?x4451 (rtt_walk_abs.0_call ?x4102 rtt_gidx.2514307 ipa_gidx.2514307)))
 (let ((?x2419 (share ?x4102)))
 (let ((?x4519 (granule_data ?x2419)))
 (let ((?x4444 (g_granule_state (select ?x4519 ?x4451))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2514307)))
 (let (($x4437 (=> $x153 (or (= ?x4444 4) (= ?x4444 6)))))
 (let (($x4503 (= (e_state_s_granule (select (g_granules (globals ?x2419)) rtt_gidx.2514307)) 5)))
 (=> (and $x4503 (and (distinct ?x4451 (- 1)) true) $x153) (or (= ?x4444 4) (= ?x4444 6))))))))))))))))))))))))))
 ))
 (not $x28282)))
(check-sat)

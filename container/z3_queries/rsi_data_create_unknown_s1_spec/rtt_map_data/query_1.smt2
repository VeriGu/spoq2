...
(assert
 ...
 (and $x3222 $x3185))))))))
(assert
 (forall ((rtt_gidx.2504828 Int) (ipa_gidx.2504828 Int) (data_gidx.2504828 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2383 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2504828 ipa_gidx.2504828)))
 (let ((?x2443 (share ?x2329)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2431 (g_granule_state (select ?x2445 ?x2383))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2504828)))
 (let (($x5228 (=> $x153 (or (= ?x2431 4) (= ?x2431 6)))))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x2443)) rtt_gidx.2504828)) 5)))
 (=> (and $x5214 (and (distinct ?x2383 (- 1)) true) $x153) (or (= ?x2431 4) (= ?x2431 6)))))))))))))))))
 )
(assert
 (let (($x2568 (forall ((rtt_gidx.2505184 Int) (ipa_gidx.2505184 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2389 (rtt_walk_abs.0_call ?x5236 rtt_gidx.2505184 ipa_gidx.2505184)))
 (let ((?x2500 (granule_data ?x5219)))
 (let ((?x2561 (g_granule_state (select ?x2500 ?x2389))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2505184))))
 (let (($x2562 (not (= (e_state_s_granule (select (g_granules (globals ?x5219)) rtt_gidx.2505184)) 5))))
 (or (= ?x2389 (- 1)) $x2562 $x176 (= ?x2561 6) (= ?x2561 4))))))))))))))))))))))))))
 ))
 (let (($x2557 (forall ((rtt_gidx.2505137 Int) (ipa_gidx.2505137 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2505137))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2505137 ipa_gidx.2505137)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2505137))))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x176 $x2550 $x2548 $x2555)))))))))))))))))))
 ))
 (or (not $x2557) $x2568))))
(assert
 (forall ((offset.2505844 Int) (empty_pte.2505844 abs_PTE_t) )(let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2505844)) (- 1)))))
 (let (($x2666 (forall ((rtt_gidx.2505840 Int) (ipa_gidx.2505840 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2443 (share ?x2329)))
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2505844)))
 (let ((?x2023 (mod offset.2505844 4096)))
 (let ((?x2655 (store (g_norm (select (granule_data ?x2443) (div offset.2505844 4096))) ?x2023 ?x2022)))
 (let ((?x2652 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) (div offset.2505844 4096))) (g_granule_state (select (granule_data ?x2443) (div offset.2505844 4096))) ?x2655 (g_rd (select (granule_data ?x2443) (div offset.2505844 4096))) (g_rec (select (granule_data ?x2443) (div offset.2505844 4096))))))
 (let ((?x2017 (div offset.2505844 4096)))
 (let ((?x2445 (granule_data ?x2443)))
 ...
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x2654 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2656 ?x2449) ?x2362 $x2369) rtt_gidx.2505840 ipa_gidx.2505840)))
 (let ((?x2661 (g_granule_state (select ?x2656 ?x2654))))
 (let (($x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) rtt_gidx.2505840)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2505840))))
 (or $x176 $x2555 (= ?x2654 (- 1)) (= ?x2661 4) (= ?x2661 6)))))))))))))))))))))))))))))
 ))
 (let ((?x2001 (div offset.2505844 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let (($x2628 (forall ((rtt_gidx.2505727 Int) (ipa_gidx.2505727 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2505727))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) (rtt_walk_abs.0_call ?x2329 rtt_gidx.2505727 ipa_gidx.2505727)))))
 (let (($x2550 (= ?x2544 4)))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2505727 ipa_gidx.2505727)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let (($x2546 (= ?x2544 6)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2505727))))
 (or $x176 $x2546 $x2548 $x2550 $x2555)))))))))))))))))))
 ))
 (let (($x2614 (not $x2628)))
 (or $x2614 (not (= (e_state_s_granule (select ?x2527 ?x2001)) 5)) $x2666 $x2000))))))))))))))))
 )
(assert
 (forall ((offset.2506403 Int) (state.2506403 Int) )(let (($x2857 (forall ((rtt_gidx.2506401 Int) (ipa_gidx.2506401 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2766 (mks_granule (e_lock (select (g_granules ?x2449) offset.2506403)) state.2506403 (e_ref (select (g_granules ?x2449) offset.2506403)))))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2767 (store ?x2527 offset.2506403 ?x2766)))
 ...
 (let ((?x2859 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) offset.2506403)) (g_granule_state (select (granule_data ?x2443) offset.2506403)) zero_granule_data (g_rd (select (granule_data ?x2443) offset.2506403)) (g_rec (select (granule_data ?x2443) offset.2506403)))))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2874 (store ?x2445 offset.2506403 ?x2859)))
 (let ((?x2592 (gpt ?x2443)))
 (let ((?x2380 (priv ?x2329)))
 (let ((?x5217 (repl ?x2329)))
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x2892 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2874 ?x3906) ?x2362 $x2369) rtt_gidx.2506401 ipa_gidx.2506401)))
 (let ((?x3952 (g_granule_state (select ?x2874 ?x2892))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2506401))))
 (or (= ?x3952 6) (not (= (e_state_s_granule (select ?x2767 rtt_gidx.2506401)) 5)) $x176 (= ?x2892 (- 1)) (= ?x3952 4))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2794 (forall ((rtt_gidx.2506302 Int) (ipa_gidx.2506302 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2506302))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2506302 ipa_gidx.2506302)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2506302))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
...
(assert
 (forall ((parent_gidx.2507347 Int) (pte_z.2507347 Int) (x.2507347 Int) (y.2507347 Int) (z.2507347 Int) )(let (($x3050 (forall ((rtt_gidx.2507345 Int) (ipa_gidx.2507345 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2717 (g_rmm_attest_public_key ?x2449)))
 (let ((?x2718 (g_rmm_attest_signing_key ?x2449)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2507347))) 4096)))
 (let ((?x2527 (g_granules ?x2449)))
 ...
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2507347)) x.2507347 y.2507347 z.2507347))))
 (let ((?x1892 (mod parent_gidx.2507347 4096)))
 (let ((?x3027 (store (g_norm (select (granule_data ?x2443) (div parent_gidx.2507347 4096))) ?x1892 ?x1891)))
 (let ((?x3039 (mkr_granule_data (gd_g_idx (select (granule_data ?x2443) (div parent_gidx.2507347 4096))) (g_granule_state (select (granule_data ?x2443) (div parent_gidx.2507347 4096))) ?x3027 (g_rd (select (granule_data ?x2443) (div parent_gidx.2507347 4096))) (g_rec (select (granule_data ?x2443) (div parent_gidx.2507347 4096))))))
 (let ((?x1886 (div parent_gidx.2507347 4096)))
 (let ((?x2445 (granule_data ?x2443)))
 ...
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3024 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x3035 ?x3010) ?x2362 $x2369) rtt_gidx.2507345 ipa_gidx.2507345)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2507345))))
 (or (not (= (e_state_s_granule (select ?x2986 rtt_gidx.2507345)) 5)) (= (g_granule_state (select ?x3035 ?x3024)) 4) $x176 (= (g_granule_state (select ?x3035 ?x3024)) 6) (= ?x3024 (- 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3011 (forall ((rtt_gidx.2507149 Int) (ipa_gidx.2507149 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2507149))))
 (let (($x2555 (not (= ?x2549 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2507149))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2507149 ipa_gidx.2507149)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
 (or $x2546 $x2550 $x2548 $x176 $x2555)))))))))))))))))))
 ))
 (let (($x2992 (not $x3011)))
 (or $x2992 $x3050)))))
 )
(assert
 (forall ((offset.2507754 Int) )(let (($x1956 (forall ((rtt_gidx.2507752 Int) (ipa_gidx.2507752 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x5211 (select ?x2527 offset.2507754)))
 (let ((?x3095 (store ?x2527 offset.2507754 (mks_granule (e_lock ?x5211) 4 (e_ref ?x5211)))))
 (let (($x2369 (halt ?x2329)))
 (let ((?x2362 (stack ?x2329)))
 (let ((?x2730 (g_realm_attest_private_key ?x2449)))
 (let ((?x2729 (g_get_realm_identity_identity ?x2449)))
 ...
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3130 (rtt_walk_abs.0_call (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 ?x2445 ?x3110) ?x2362 $x2369) rtt_gidx.2507752 ipa_gidx.2507752)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2507752))))
 (or (= (g_granule_state (select ?x2445 ?x3130)) 6) (= (g_granule_state (select ?x2445 ?x3130)) 4) $x176 (= ?x3130 (- 1)) (not (= (e_state_s_granule (select ?x3095 rtt_gidx.2507752)) 5))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3105 (forall ((rtt_gidx.2507687 Int) (ipa_gidx.2507687 Int) )(let (($x176 (not (rtt_is_root.0_call rtt_gidx.2507687))))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x2449 (globals ?x2443)))
 (let ((?x2527 (g_granules ?x2449)))
 (let ((?x2549 (e_state_s_granule (select ?x2527 rtt_gidx.2507687))))
 (let (($x2555 (not (= ?x2549 5))))
 (let ((?x2451 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2507687 ipa_gidx.2507687)))
 (let (($x2548 (= ?x2451 (- 1))))
 (let ((?x2544 (g_granule_state (select (granule_data ?x2443) ?x2451))))
 (let (($x2550 (= ?x2544 4)))
 (let (($x2546 (= ?x2544 6)))
...
(assert
 (forall ((rtt_gidx.2507856 Int) (ipa_gidx.2507856 Int) (i.2507856 Int) (d.2507856 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x2534 (oracle ?x2329)))
 (let ((?x2537 (log ?x2329)))
 (let ((?x3144 (mkRData ?x2537 ?x2534 ?x5217 ?x2380 (mkShared ?x2592 (store (granule_data ?x2443) i.2507856 d.2507856) ?x2449) ?x2362 $x2369)))
 (let ((?x3154 (+ (rtt_walk_abs.0_call ?x2329 rtt_gidx.2507856 ipa_gidx.2507856) (* (- 1) (rtt_walk_abs.0_call ?x3144 rtt_gidx.2507856 ipa_gidx.2507856)))))
 (let (($x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) i.2507856)) 5))))
 (let (($x3155 (and $x2555 (not (= (e_state_s_granule (select (g_granules ?x2449) i.2507856)) 4)))))
 (=> $x3155 (= ?x3154 0))))))))))))))))))))))
 )
(assert
 (let (($x3219 (forall ((rtt_gidx.2507935 Int) (ipa_gidx.2507935 Int) (data_gidx.2507935 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 (let ((?x2329 (value_RData ?x2327)))
 (let ((?x2383 (rtt_walk_abs.0_call ?x2329 rtt_gidx.2507935 ipa_gidx.2507935)))
 (let ((?x2443 (share ?x2329)))
 (let ((?x2445 (granule_data ?x2443)))
 (let ((?x2431 (g_granule_state (select ?x2445 ?x2383))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2507935)))
 (let (($x5228 (=> $x153 (or (= ?x2431 4) (= ?x2431 6)))))
 (let (($x5214 (= (e_state_s_granule (select (g_granules (globals ?x2443)) rtt_gidx.2507935)) 5)))
 (=> (and $x5214 (and (distinct ?x2383 (- 1)) true) $x153) (or (= ?x2431 4) (= ?x2431 6)))))))))))))))))
 ))
 (not $x3219)))
(check-sat)

...
(assert
 (let (($x49378 (forall ((rtt_gidx.2561715 Int) (ipa_gidx.2561715 Int) (data_gidx.2561715 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13938 (g_rmm_attest_public_key ?x14130)))
 (let ((?x14377 (g_rmm_attest_signing_key ?x14130)))
 (let ((?x19164 (mks_granule (e_lock (select (g_granules ?x14130) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x14130) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x14270 (g_granules ?x14130)))
 (let ((?x57263 (store ?x14270 ?x3159 ?x19164)))
 (let ((?x14456 (g_mbedtls_mem_buf ?x14130)))
 (let ((?x14489 (g_tt_l1_upper ?x14130)))
 (let ((?x14491 (g_tt_l2_mem1_3 ?x14130)))
 (let ((?x14471 (g_tt_l2_mem1_2 ?x14130)))
 ...
 (let ((?x13534 (g_debug_exits ?x14130)))
 (let ((?x14439 (g_heap ?x14130)))
 (let ((?x18887 (mkGLOBALS ?x14439 ?x13534 ?x14428 ?x13532 ?x14429 ?x16689 ?x14426 ?x14468 ?x13770 ?x14331 ?x14123 ?x13803 ?x14505 ?x13957 ?x14484 ?x14450 ?x14437 ?x14471 ?x14491 ?x14489 ?x14456 ?x57263 ?x14377 ?x13938 ?x14169 ?x14311 ?x14510 ?x13439 ?x14530 ?x14493 ?x14476)))
 (let ((?x14171 (granule_data ?x14265)))
 (let ((?x14208 (gpt ?x14265)))
 (let ((?x14052 (priv ?x37096)))
 (let ((?x13708 (repl ?x37096)))
 (let ((?x14206 (oracle ?x37096)))
 (let ((?x14300 (log ?x37096)))
 (let ((?x57944 (mkRData ?x14300 ?x14206 ?x13708 ?x14052 (mkShared ?x14208 ?x14171 ?x18887) ?x14026 $x14047)))
 (let ((?x57578 (rtt_walk_abs.0_call ?x57944 rtt_gidx.2561715 ipa_gidx.2561715)))
 (let ((?x49415 (g_granule_state (select ?x14171 ?x57578))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561715)))
 (let (($x57946 (=> (and (and (distinct ?x57578 (- 1)) true) $x153) (or (= ?x49415 4) (= ?x49415 6)))))
 (=> (and (= (e_state_s_granule (select ?x57263 rtt_gidx.2561715)) 5) (and (distinct ?x57578 (- 1)) true) $x153) (or (= ?x49415 4) (= ?x49415 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x49378)))
(check-sat)

...
(assert
 (let (($x41129 (forall ((rtt_gidx.2554712 Int) (ipa_gidx.2554712 Int) (data_gidx.2554712 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x15933 (g_granules ?x16032)))
 (let ((?x61738 (select ?x15933 ?x3159)))
 (let ((?x16609 (e_ref ?x61738)))
 (let ((?x54622 (e_lock ?x61738)))
 (let ((?x154532 (mks_granule ?x54622 1 ?x16609)))
 (let ((?x40724 (store ?x15933 ?x3159 ?x154532)))
 (let ((?x16226 (g_mbedtls_mem_buf ?x16032)))
 (let ((?x16364 (g_tt_l1_upper ?x16032)))
 (let ((?x16358 (g_tt_l2_mem1_3 ?x16032)))
 (let ((?x16324 (g_tt_l2_mem1_2 ?x16032)))
 ...
 (let ((?x16146 (g_debug_exits ?x16032)))
 (let ((?x16270 (g_heap ?x16032)))
 (let ((?x16870 (mkGLOBALS ?x16270 ?x16146 ?x16135 ?x16326 ?x15519 ?x16371 ?x16423 ?x15959 ?x15915 ?x16242 ?x16253 ?x15792 ?x15994 ?x16359 ?x16372 ?x15299 ?x16382 ?x16324 ?x16358 ?x16364 ?x16226 ?x40724 ?x15648 ?x15664 ?x16261 ?x16225 ?x16344 ?x16340 ?x16221 ?x16083 ?x16345)))
 ...
 (let ((?x15305 (oracle ?x15459)))
 (let ((?x16058 (log ?x15459)))
 (let ((?x54750 (mkRData ?x16058 ?x15305 ?x15891 ?x15931 (mkShared ?x324022 ?x15963 ?x16870) ?x14868 $x15858)))
 (let ((?x55116 (g_granule_state (select ?x15963 (rtt_walk_abs.0_call ?x54750 rtt_gidx.2554712 ipa_gidx.2554712)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2554712)))
 (let ((?x16842 (mkRData ?x16058 ?x15305 ?x15891 ?x15931 (mkShared ?x324022 ?x15976 ?x16870) ?x14868 $x15858)))
 (let ((?x46312 (mkRData (log ?x16842) (oracle ?x16842) (repl ?x16842) (priv ?x16842) (mkShared (gpt (share ?x16842)) ?x15963 (globals (share ?x16842))) (stack ?x16842) (halt ?x16842))))
 (let (($x101636 (=> (and (and (distinct (rtt_walk_abs.0_call ?x46312 rtt_gidx.2554712 ipa_gidx.2554712) (- 1)) true) $x153) (or (= ?x55116 4) (= ?x55116 6)))))
 (=> (and (= (e_state_s_granule (select ?x40724 rtt_gidx.2554712)) 5) (and (distinct (rtt_walk_abs.0_call ?x46312 rtt_gidx.2554712 ipa_gidx.2554712) (- 1)) true) $x153) (or (= ?x55116 4) (= ?x55116 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x41129)))
(check-sat)

...
(assert
 (let (($x66358 (forall ((rtt_gidx.2582569 Int) (ipa_gidx.2582569 Int) (data_gidx.2582569 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x24655 (mks_granule ?x23947 4 ?x24570)))
 ...
 (let ((?x66008 (rtt_walk_abs.0_call ?x65702 rtt_gidx.2582569 ipa_gidx.2582569)))
 (let ((?x61997 (g_granule_state (select ?x20644 ?x66008))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2582569)))
 (let (($x63181 (=> (and (and (distinct ?x66008 (- 1)) true) $x153) (or (= ?x61997 4) (= ?x61997 6)))))
 (=> (and (= (e_state_s_granule (select ?x73605 rtt_gidx.2582569)) 5) (and (distinct ?x66008 (- 1)) true) $x153) (or (= ?x61997 4) (= ?x61997 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x66358)))
(check-sat)

...
(assert
 ...
 (not $x21637)))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((rtt_gidx.2568602 Int) (ipa_gidx.2568602 Int) (data_gidx.2568602 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x20819 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2568602 ipa_gidx.2568602)))
 (let ((?x21337 (share ?x64213)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x20539 (g_granule_state (select ?x21664 ?x20819))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2568602)))
 (let (($x21582 (=> $x153 (or (= ?x20539 4) (= ?x20539 6)))))
 (let (($x21196 (= (e_state_s_granule (select (g_granules (globals ?x21337)) rtt_gidx.2568602)) 5)))
 (=> (and $x21196 (and (distinct ?x20819 (- 1)) true) $x153) (or (= ?x20539 4) (= ?x20539 6)))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x20881 (forall ((rtt_gidx.2568958 Int) (ipa_gidx.2568958 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let (($x21313 (halt ?x64213)))
 (let ((?x21503 (stack ?x64213)))
 (let ((?x21337 (share ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x21217 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!8 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr (pbase a!7) (poffset a!7))
                          a!6))))
  (oracle a!8)))))))))_call| ?x4307)))
 (let ((?x17797 (|(let ((a!1 (mkPtr "granules"
                  (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.0))))))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_1.0)))
             (value_RData (spinlock_acquire_spec.0_call a!1 st.0)))))
...
(let ((a!8 (value_RData (spinlock_acquire_spec.0_call
                          (mkPtr (pbase a!7) (poffset a!7))
                          a!6))))
  (repl a!8)))))))))_call| ?x21217 ?x21337)))
 (let ((?x21458 (value_Shared ?x17797)))
 (let ((?x21264 (priv ?x64213)))
 (let ((?x21379 (repl ?x64213)))
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x21477 (List_Event_concat ?x21217 ?x4307)))
 (let ((?x20993 (mkRData ?x21477 ?x21388 ?x21379 ?x21264 ?x21458 ?x21503 $x21313)))
 (let ((?x21576 (rtt_walk_abs.0_call ?x20993 rtt_gidx.2568958 ipa_gidx.2568958)))
 (let ((?x4318 (granule_data ?x21458)))
 (let ((?x20857 (g_granule_state (select ?x4318 ?x21576))))
 (let (($x20563 (not (= (e_state_s_granule (select (g_granules (globals ?x21458)) rtt_gidx.2568958)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2568958))))
 (or (= ?x21576 (- 1)) $x176 $x20563 (= ?x20857 4) (= ?x20857 6))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21439 (forall ((rtt_gidx.2568911 Int) (ipa_gidx.2568911 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x19865 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2568911 ipa_gidx.2568911)))
 (let (($x21421 (= ?x19865 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2568911))))
 (let ((?x21348 (e_state_s_granule (select (g_granules (globals (share ?x64213))) rtt_gidx.2568911))))
 (let (($x17757 (not (= ?x21348 5))))
 (let ((?x21762 (g_granule_state (select (granule_data (share ?x64213)) ?x19865))))
 (let (($x20784 (= ?x21762 6)))
 (let (($x21621 (= ?x21762 4)))
 (or $x21621 $x20784 $x17757 $x176 $x21421))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x21439) $x20881))))
(assert
 (forall ((offset.2569618 Int) (empty_pte.2569618 abs_PTE_t) )(let ((?x2001 (div offset.2569618 4096)))
 (let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 ...
 (let ((?x21420 (globals ?x21337)))
 (let ((?x21567 (g_granules ?x21420)))
 (let (($x20925 (forall ((rtt_gidx.2569614 Int) (ipa_gidx.2569614 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21337 (share ?x64213)))
 (let ((?x21420 (globals ?x21337)))
 (let ((?x2022 (test_PTE_Z.0_call empty_pte.2569618)))
 (let ((?x2023 (mod offset.2569618 4096)))
 (let ((?x20779 (store (g_norm (select (granule_data ?x21337) (div offset.2569618 4096))) ?x2023 ?x2022)))
 (let ((?x21538 (mkr_granule_data (gd_g_idx (select (granule_data ?x21337) (div offset.2569618 4096))) (g_granule_state (select (granule_data ?x21337) (div offset.2569618 4096))) ?x20779 (g_rd (select (granule_data ?x21337) (div offset.2569618 4096))) (g_rec (select (granule_data ?x21337) (div offset.2569618 4096))))))
 (let ((?x2017 (div offset.2569618 4096)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x21128 (store ?x21664 ?x2017 ?x21538)))
 (let ((?x747088 (gpt ?x21337)))
 (let ((?x21264 (priv ?x64213)))
 (let ((?x21379 (repl ?x64213)))
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x21942 (rtt_walk_abs.0_call (mkRData ?x4307 ?x21388 ?x21379 ?x21264 (mkShared ?x747088 ?x21128 ?x21420) ?x21503 $x21313) rtt_gidx.2569614 ipa_gidx.2569614)))
 (let ((?x20999 (g_granule_state (select ?x21128 ?x21942))))
 (let (($x17757 (not (= (e_state_s_granule (select (g_granules ?x21420) rtt_gidx.2569614)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2569614))))
 (or $x176 $x17757 (= ?x20999 6) (= ?x21942 (- 1)) (= ?x20999 4)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x20918 (forall ((rtt_gidx.2569501 Int) (ipa_gidx.2569501 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x19865 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2569501 ipa_gidx.2569501)))
 (let ((?x21337 (share ?x64213)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x21762 (g_granule_state (select ?x21664 ?x19865))))
 (let (($x21621 (= ?x21762 4)))
 (let (($x21421 (= ?x19865 (- 1))))
 (let (($x20784 (= ?x21762 6)))
 (let (($x17757 (not (= (e_state_s_granule (select (g_granules (globals ?x21337)) rtt_gidx.2569501)) 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2569501))))
 (or $x176 $x17757 $x20784 $x21421 $x21621)))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x20778 (not $x20918)))
 (let (($x2000 (not (= (meta_granule_offset (meta_PA empty_pte.2569618)) (- 1)))))
 (or $x2000 $x20778 $x20925 (not (= (e_state_s_granule (select ?x21567 ?x2001)) 5))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.2570177 Int) (state.2570177 Int) )(let (($x4290 (forall ((rtt_gidx.2570175 Int) (ipa_gidx.2570175 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21337 (share ?x64213)))
 (let ((?x21420 (globals ?x21337)))
 (let ((?x21745 (g_realm_attest_private_key ?x21420)))
 (let ((?x19573 (g_get_realm_identity_identity ?x21420)))
 (let ((?x21768 (g_rmm_platform_token ?x21420)))
 (let ((?x21255 (g_platform_token_buf ?x21420)))
 (let ((?x21328 (g_rmm_attest_public_key_hash_len ?x21420)))
 (let ((?x21631 (g_rmm_attest_public_key_hash ?x21420)))
 (let ((?x21160 (g_rmm_attest_public_key_len ?x21420)))
 (let ((?x21945 (g_rmm_attest_public_key ?x21420)))
 (let ((?x21431 (g_rmm_attest_signing_key ?x21420)))
 (let ((?x21298 (mks_granule (e_lock (select (g_granules ?x21420) offset.2570177)) state.2570177 (e_ref (select (g_granules ?x21420) offset.2570177)))))
 (let ((?x21567 (g_granules ?x21420)))
 (let ((?x21727 (store ?x21567 offset.2570177 ?x21298)))
 (let ((?x21071 (g_mbedtls_mem_buf ?x21420)))
 (let ((?x4304 (g_tt_l1_upper ?x21420)))
 (let ((?x20766 (g_tt_l2_mem1_3 ?x21420)))
 (let ((?x20235 (g_tt_l2_mem1_2 ?x21420)))
 (let ((?x12057 (g_tt_l2_mem1_1 ?x21420)))
 (let ((?x21586 (g_tt_l2_mem1_0 ?x21420)))
 (let ((?x21952 (g_tt_l2_mem0_1 ?x21420)))
 (let ((?x20189 (g_tt_l2_mem0_0 ?x21420)))
 (let ((?x21947 (g_tt_l3_buffer ?x21420)))
 (let ((?x21958 (g_rmm_trap_list ?x21420)))
 (let ((?x21953 (g_status_handler ?x21420)))
 (let ((?x21512 (g_default_gicstate ?x21420)))
 (let ((?x21711 (g_pri_res0_mask ?x21420)))
 (let ((?x21121 (g_max_vintid ?x21420)))
 (let ((?x21297 (g_nr_aprs ?x21420)))
 (let ((?x21909 (g_nr_lrs ?x21420)))
 (let ((?x21280 (g_vmids ?x21420)))
 (let ((?x21342 (g_vmid_lock ?x21420)))
 (let ((?x4260 (g_vmid_count ?x21420)))
 (let ((?x21626 (g_debug_exits ?x21420)))
 (let ((?x21806 (g_heap ?x21420)))
 (let ((?x21629 (mkGLOBALS ?x21806 ?x21626 ?x4260 ?x21342 ?x21280 ?x21909 ?x21297 ?x21121 ?x21711 ?x21512 ?x21953 ?x21958 ?x21947 ?x20189 ?x21952 ?x21586 ?x12057 ?x20235 ?x20766 ?x4304 ?x21071 ?x21727 ?x21431 ?x21945 ?x21160 ?x21631 ?x21328 ?x21255 ?x21768 ?x19573 ?x21745)))
 (let ((?x21152 (mkr_granule_data (gd_g_idx (select (granule_data ?x21337) offset.2570177)) (g_granule_state (select (granule_data ?x21337) offset.2570177)) zero_granule_data (g_rd (select (granule_data ?x21337) offset.2570177)) (g_rec (select (granule_data ?x21337) offset.2570177)))))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x21044 (store ?x21664 offset.2570177 ?x21152)))
 (let ((?x747088 (gpt ?x21337)))
 (let ((?x21264 (priv ?x64213)))
 (let ((?x21379 (repl ?x64213)))
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x21941 (rtt_walk_abs.0_call (mkRData ?x4307 ?x21388 ?x21379 ?x21264 (mkShared ?x747088 ?x21044 ?x21629) ?x21503 $x21313) rtt_gidx.2570175 ipa_gidx.2570175)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2570175))))
 (or $x176 (= (g_granule_state (select ?x21044 ?x21941)) 4) (not (= (e_state_s_granule (select ?x21727 rtt_gidx.2570175)) 5)) (= (g_granule_state (select ?x21044 ?x21941)) 6) (= ?x21941 (- 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x19646 (forall ((rtt_gidx.2570076 Int) (ipa_gidx.2570076 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x19865 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2570076 ipa_gidx.2570076)))
 (let (($x21421 (= ?x19865 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2570076))))
 (let ((?x21762 (g_granule_state (select (granule_data (share ?x64213)) ?x19865))))
 (let (($x20784 (= ?x21762 6)))
 (let ((?x21348 (e_state_s_granule (select (g_granules (globals (share ?x64213))) rtt_gidx.2570076))))
 (let (($x17757 (not (= ?x21348 5))))
 (let (($x21621 (= ?x21762 4)))
 (or $x21621 $x17757 $x20784 $x176 $x21421))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21776 (not $x19646)))
 (or $x21776 $x4290)))))
 )
(assert
 (forall ((parent_gidx.2571121 Int) (pte_z.2571121 Int) (x.2571121 Int) (y.2571121 Int) (z.2571121 Int) )(let (($x21923 (forall ((rtt_gidx.2571119 Int) (ipa_gidx.2571119 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21945 (g_rmm_attest_public_key ?x21420)))
 (let ((?x21431 (g_rmm_attest_signing_key ?x21420)))
 (let ((?x1845 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.2571121))) 4096)))
 (let ((?x21567 (g_granules ?x21420)))
 (let ((?x21826 (select ?x21567 ?x1845)))
 (let ((?x21750 (store ?x21567 ?x1845 (mks_granule (e_lock ?x21826) 4 (e_ref ?x21826)))))
 (let ((?x21071 (g_mbedtls_mem_buf ?x21420)))
 (let ((?x4304 (g_tt_l1_upper ?x21420)))
 (let ((?x20766 (g_tt_l2_mem1_3 ?x21420)))
 (let ((?x20235 (g_tt_l2_mem1_2 ?x21420)))
 ...
 (let ((?x21626 (g_debug_exits ?x21420)))
 (let ((?x21806 (g_heap ?x21420)))
 (let ((?x20932 (mkGLOBALS ?x21806 ?x21626 ?x4260 ?x21342 ?x21280 ?x21909 ?x21297 ?x21121 ?x21711 ?x21512 ?x21953 ?x21958 ?x21947 ?x20189 ?x21952 ?x21586 ?x12057 ?x20235 ?x20766 ?x4304 ?x21071 ?x21750 ?x21431 ?x21945 ?x21160 ?x21631 ?x21328 ?x21255 ?x21768 ?x19573 ?x21745)))
 (let ((?x1891 (test_PTE_Z.0_call (mkabs_PTE_t (meta_PA (test_Z_PTE.0_call pte_z.2571121)) x.2571121 y.2571121 z.2571121))))
 (let ((?x1892 (mod parent_gidx.2571121 4096)))
 (let ((?x21327 (store (g_norm (select (granule_data ?x21337) (div parent_gidx.2571121 4096))) ?x1892 ?x1891)))
 (let ((?x21809 (mkr_granule_data (gd_g_idx (select (granule_data ?x21337) (div parent_gidx.2571121 4096))) (g_granule_state (select (granule_data ?x21337) (div parent_gidx.2571121 4096))) ?x21327 (g_rd (select (granule_data ?x21337) (div parent_gidx.2571121 4096))) (g_rec (select (granule_data ?x21337) (div parent_gidx.2571121 4096))))))
 (let ((?x1886 (div parent_gidx.2571121 4096)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x21893 (store ?x21664 ?x1886 ?x21809)))
 (let ((?x747088 (gpt ?x21337)))
 (let ((?x21264 (priv ?x64213)))
 (let ((?x21379 (repl ?x64213)))
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x21665 (rtt_walk_abs.0_call (mkRData ?x4307 ?x21388 ?x21379 ?x21264 (mkShared ?x747088 ?x21893 ?x20932) ?x21503 $x21313) rtt_gidx.2571119 ipa_gidx.2571119)))
 (let ((?x21383 (g_granule_state (select ?x21893 ?x21665))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2571119))))
 (or (= ?x21665 (- 1)) (= ?x21383 6) (not (= (e_state_s_granule (select ?x21750 rtt_gidx.2571119)) 5)) $x176 (= ?x21383 4)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21999 (forall ((rtt_gidx.2570923 Int) (ipa_gidx.2570923 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21420 (globals ?x21337)))
 (let ((?x21567 (g_granules ?x21420)))
 (let ((?x21348 (e_state_s_granule (select ?x21567 rtt_gidx.2570923))))
 (let (($x17757 (not (= ?x21348 5))))
 (let ((?x19865 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2570923 ipa_gidx.2570923)))
 (let (($x21421 (= ?x19865 (- 1))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2570923))))
 (let ((?x21762 (g_granule_state (select (granule_data ?x21337) ?x19865))))
 (let (($x20784 (= ?x21762 6)))
 (let (($x21621 (= ?x21762 4)))
 (or $x21621 $x20784 $x176 $x21421 $x17757)))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21261 (not $x21999)))
 (or $x21261 $x21923)))))
 )
(assert
 (forall ((offset.2571528 Int) )(let (($x20673 (forall ((rtt_gidx.2571526 Int) (ipa_gidx.2571526 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21945 (g_rmm_attest_public_key ?x21420)))
 (let ((?x21431 (g_rmm_attest_signing_key ?x21420)))
 (let ((?x21452 (mks_granule (e_lock (select (g_granules ?x21420) offset.2571528)) 4 (e_ref (select (g_granules ?x21420) offset.2571528)))))
 (let ((?x21567 (g_granules ?x21420)))
 (let ((?x21764 (store ?x21567 offset.2571528 ?x21452)))
 (let ((?x21071 (g_mbedtls_mem_buf ?x21420)))
 (let ((?x4304 (g_tt_l1_upper ?x21420)))
 (let ((?x20766 (g_tt_l2_mem1_3 ?x21420)))
 (let ((?x20235 (g_tt_l2_mem1_2 ?x21420)))
 ...
 (let ((?x21626 (g_debug_exits ?x21420)))
 (let ((?x21806 (g_heap ?x21420)))
 (let ((?x21927 (mkGLOBALS ?x21806 ?x21626 ?x4260 ?x21342 ?x21280 ?x21909 ?x21297 ?x21121 ?x21711 ?x21512 ?x21953 ?x21958 ?x21947 ?x20189 ?x21952 ?x21586 ?x12057 ?x20235 ?x20766 ?x4304 ?x21071 ?x21764 ?x21431 ?x21945 ?x21160 ?x21631 ?x21328 ?x21255 ?x21768 ?x19573 ?x21745)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x747088 (gpt ?x21337)))
 (let ((?x21264 (priv ?x64213)))
 (let ((?x21379 (repl ?x64213)))
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x21180 (rtt_walk_abs.0_call (mkRData ?x4307 ?x21388 ?x21379 ?x21264 (mkShared ?x747088 ?x21664 ?x21927) ?x21503 $x21313) rtt_gidx.2571526 ipa_gidx.2571526)))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2571526))))
 (or (= (g_granule_state (select ?x21664 ?x21180)) 4) (= (g_granule_state (select ?x21664 ?x21180)) 6) (not (= (e_state_s_granule (select ?x21764 rtt_gidx.2571526)) 5)) $x176 (= ?x21180 (- 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21981 (forall ((rtt_gidx.2571461 Int) (ipa_gidx.2571461 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21420 (globals ?x21337)))
 (let ((?x21567 (g_granules ?x21420)))
 (let ((?x21348 (e_state_s_granule (select ?x21567 rtt_gidx.2571461))))
 (let (($x17757 (not (= ?x21348 5))))
 (let (($x176 (not (rtt_is_root.0_call rtt_gidx.2571461))))
 (let ((?x19865 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2571461 ipa_gidx.2571461)))
 (let (($x21421 (= ?x19865 (- 1))))
 (let ((?x21762 (g_granule_state (select (granule_data ?x21337) ?x19865))))
 (let (($x20784 (= ?x21762 6)))
 (let (($x21621 (= ?x21762 4)))
 (or $x21621 $x20784 $x21421 $x176 $x17757)))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x21996 (not $x21981)))
 (or $x21996 $x20673)))))
 )
(assert
 (forall ((rtt_gidx.2571630 Int) (ipa_gidx.2571630 Int) (i.2571630 Int) (d.2571630 r_granule_data) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x21388 (oracle ?x64213)))
 (let ((?x4307 (log ?x64213)))
 (let ((?x22037 (mkRData ?x4307 ?x21388 ?x21379 ?x21264 (mkShared ?x747088 (store (granule_data ?x21337) i.2571630 d.2571630) ?x21420) ?x21503 $x21313)))
 (let ((?x22397 (+ (rtt_walk_abs.0_call ?x64213 rtt_gidx.2571630 ipa_gidx.2571630) (* (- 1) (rtt_walk_abs.0_call ?x22037 rtt_gidx.2571630 ipa_gidx.2571630)))))
 (let (($x17757 (not (= (e_state_s_granule (select (g_granules ?x21420) i.2571630)) 5))))
 (let (($x21623 (and $x17757 (not (= (e_state_s_granule (select (g_granules ?x21420) i.2571630)) 4)))))
 (=> $x21623 (= ?x22397 0))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x22719 (forall ((rtt_gidx.2575407 Int) (ipa_gidx.2575407 Int) (data_gidx.2575407 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x20819 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2575407 ipa_gidx.2575407)))
 (let ((?x21337 (share ?x64213)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x20539 (g_granule_state (select ?x21664 ?x20819))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2575407)))
 (let (($x21582 (=> $x153 (or (= ?x20539 4) (= ?x20539 6)))))
 (let (($x21196 (= (e_state_s_granule (select (g_granules (globals ?x21337)) rtt_gidx.2575407)) 5)))
 (=> (and $x21196 (and (distinct ?x20819 (- 1)) true) $x153) (or (= ?x20539 4) (= ?x20539 6)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x22719)))
(check-sat)

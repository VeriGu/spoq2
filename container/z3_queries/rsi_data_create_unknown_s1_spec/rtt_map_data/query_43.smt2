...
(assert
 (let (($x22126 (forall ((rtt_gidx.2571709 Int) (ipa_gidx.2571709 Int) (data_gidx.2571709 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x18559 (spinlock_acquire_spec.0_call ?x123561 ?x20259)))
 (let ((?x64213 (value_RData ?x18559)))
 (let ((?x20819 (rtt_walk_abs.0_call ?x64213 rtt_gidx.2571709 ipa_gidx.2571709)))
 (let ((?x21337 (share ?x64213)))
 (let ((?x21664 (granule_data ?x21337)))
 (let ((?x20539 (g_granule_state (select ?x21664 ?x20819))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2571709)))
 (let (($x21582 (=> $x153 (or (= ?x20539 4) (= ?x20539 6)))))
 (let (($x21196 (= (e_state_s_granule (select (g_granules (globals ?x21337)) rtt_gidx.2571709)) 5)))
 (=> (and $x21196 (and (distinct ?x20819 (- 1)) true) $x153) (or (= ?x20539 4) (= ?x20539 6)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x22126)))
(check-sat)

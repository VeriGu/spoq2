...
(assert
 (let (($x19136 (forall ((rtt_gidx.2562151 Int) (ipa_gidx.2562151 Int) (data_gidx.2562151 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x13077 (spinlock_acquire_spec.0_call ?x12290 ?x3160)))
 (let ((?x3355 (value_RData ?x13077)))
 (let ((?x13201 (rtt_walk_abs.0_call ?x3355 rtt_gidx.2562151 ipa_gidx.2562151)))
 (let ((?x13000 (share ?x3355)))
 (let ((?x12289 (granule_data ?x13000)))
 (let ((?x13034 (g_granule_state (select ?x12289 ?x13201))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2562151)))
 (let (($x13146 (=> $x153 (or (= ?x13034 4) (= ?x13034 6)))))
 (let (($x12861 (= (e_state_s_granule (select (g_granules (globals ?x13000)) rtt_gidx.2562151)) 5)))
 (=> (and $x12861 (and (distinct ?x13201 (- 1)) true) $x153) (or (= ?x13034 4) (= ?x13034 6)))))))))))))))))))))))))))))
 ))
 (not $x19136)))
(check-sat)

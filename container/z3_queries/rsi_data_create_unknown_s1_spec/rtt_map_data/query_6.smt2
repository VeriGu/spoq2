...
(assert
 (let (($x7030 (forall ((rtt_gidx.2520959 Int) (ipa_gidx.2520959 Int) (data_gidx.2520959 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x6558 (g_rmm_attest_public_key ?x6271)))
 (let ((?x6561 (g_rmm_attest_signing_key ?x6271)))
 (let ((?x30082 (mks_granule (e_lock (select (g_granules ?x6271) (div ?x2325 4096))) 4 (e_ref (select (g_granules ?x6271) (div ?x2325 4096))))))
 (let ((?x3159 (div ?x2325 4096)))
 (let ((?x6273 (g_granules ?x6271)))
 (let ((?x6999 (store ?x6273 ?x3159 ?x30082)))
 (let ((?x6594 (g_mbedtls_mem_buf ?x6271)))
 (let ((?x6455 (g_tt_l1_upper ?x6271)))
 (let ((?x6550 (g_tt_l2_mem1_3 ?x6271)))
 (let ((?x6529 (g_tt_l2_mem1_2 ?x6271)))
 ...
 (let ((?x6541 (g_debug_exits ?x6271)))
 (let ((?x6542 (g_heap ?x6271)))
 (let ((?x6995 (mkGLOBALS ?x6542 ?x6541 ?x6552 ?x6544 ?x6540 ?x6537 ?x6514 ?x6510 ?x6507 ?x6539 ?x6535 ?x6532 ?x6531 ?x6367 ?x6536 ?x6526 ?x6533 ?x6529 ?x6550 ?x6455 ?x6594 ?x6999 ?x6561 ?x6558 ?x6557 ?x6559 ?x6560 ?x6556 ?x6442 ?x6553 ?x6548)))
 ...
 (let ((?x6281 (oracle ?x6079)))
 (let ((?x6294 (log ?x6079)))
 (let ((?x7063 (mkRData ?x6294 ?x6281 ?x6147 ?x6149 (mkShared ?x29241 ?x7001 ?x6995) ?x6133 $x6140)))
 (let ((?x7192 (g_granule_state (select ?x7001 (rtt_walk_abs.0_call ?x7063 rtt_gidx.2520959 ipa_gidx.2520959)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2520959)))
 (let ((?x6977 (mkRData ?x6294 ?x6281 ?x6147 ?x6149 (mkShared ?x29241 ?x6364 ?x6995) ?x6133 $x6140)))
 (let (($x38009 (halt ?x6977)))
 (let ((?x38030 (stack ?x6977)))
 (let ((?x38015 (priv ?x6977)))
 (let ((?x37865 (repl ?x6977)))
 (let ((?x38053 (oracle ?x6977)))
 (let ((?x38040 (log ?x6977)))
 (let ((?x6813 (mkRData ?x38040 ?x38053 ?x37865 ?x38015 (mkShared (gpt (share ?x6977)) ?x7001 (globals (share ?x6977))) ?x38030 $x38009)))
 (let (($x7015 (=> (and (and (distinct (rtt_walk_abs.0_call ?x6813 rtt_gidx.2520959 ipa_gidx.2520959) (- 1)) true) $x153) (or (= ?x7192 4) (= ?x7192 6)))))
 (let (($x53352 (= (e_state_s_granule (select ?x6999 rtt_gidx.2520959)) 5)))
 (=> (and $x53352 (and (distinct (rtt_walk_abs.0_call ?x6813 rtt_gidx.2520959 ipa_gidx.2520959) (- 1)) true) $x153) (or (= ?x7192 4) (= ?x7192 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x7030)))
(check-sat)

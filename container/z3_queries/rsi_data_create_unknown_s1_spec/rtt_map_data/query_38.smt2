...
(assert
 (let (($x58418 (forall ((rtt_gidx.2561953 Int) (ipa_gidx.2561953 Int) (data_gidx.2561953 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x19164 (mks_granule ?x19232 4 ?x19145)))
 ...
 (let ((?x57578 (rtt_walk_abs.0_call ?x57944 rtt_gidx.2561953 ipa_gidx.2561953)))
 (let ((?x49415 (g_granule_state (select ?x14171 ?x57578))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2561953)))
 (let (($x57946 (=> (and (and (distinct ?x57578 (- 1)) true) $x153) (or (= ?x49415 4) (= ?x49415 6)))))
 (=> (and (= (e_state_s_granule (select ?x57263 rtt_gidx.2561953)) 5) (and (distinct ?x57578 (- 1)) true) $x153) (or (= ?x49415 4) (= ?x49415 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x58418)))
(check-sat)

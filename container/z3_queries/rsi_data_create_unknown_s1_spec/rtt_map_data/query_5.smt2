...
(assert
 (let (($x30215 (forall ((rtt_gidx.2520806 Int) (ipa_gidx.2520806 Int) (data_gidx.2520806 Int) )(let ((?x2342 (test_Z_PTE.0_call v_0.0)))
 (let ((?x2324 (meta_PA ?x2342)))
 (let ((?x2325 (meta_granule_offset ?x2324)))
 (let ((?x2326 (mkPtr "granules" ?x2325)))
 (let ((?x2327 (spinlock_acquire_spec.0_call ?x2326 st.0)))
 ...
 (let ((?x6364 (granule_data ?x6274)))
 (let ((?x6998 (select ?x6364 ?x6990)))
 (let ((?x6579 (mkabs_PTE_t ?x2324 0 0 1)))
 (let ((?x6987 (test_PTE_Z.0_call ?x6579)))
 (let ((?x6991 (mod ?x36157 4096)))
 (let ((?x6989 (g_norm ?x6998)))
 (let ((?x6986 (store ?x6989 ?x6991 ?x6987)))
 (let ((?x6975 (mkr_granule_data (gd_g_idx ?x6998) (g_granule_state ?x6998) ?x6986 (g_rd ?x6998) (g_rec ?x6998))))
 (let ((?x29251 (store ?x6364 ?x6990 ?x6975)))
 (let ((?x29241 (gpt ?x6274)))
 (let ((?x6149 (priv ?x6079)))
 (let ((?x6147 (repl ?x6079)))
 (let ((?x6281 (oracle ?x6079)))
 (let ((?x6294 (log ?x6079)))
 (let ((?x38062 (mkRData ?x6294 ?x6281 ?x6147 ?x6149 (mkShared ?x29241 ?x29251 ?x6995) ?x6133 $x6140)))
 (let ((?x38035 (g_granule_state (select ?x29251 (rtt_walk_abs.0_call ?x38062 rtt_gidx.2520806 ipa_gidx.2520806)))))
 (let (($x153 (rtt_is_root.0_call rtt_gidx.2520806)))
 (let ((?x6977 (mkRData ?x6294 ?x6281 ?x6147 ?x6149 (mkShared ?x29241 ?x6364 ?x6995) ?x6133 $x6140)))
 (let ((?x38011 (mkRData (log ?x6977) (oracle ?x6977) (repl ?x6977) (priv ?x6977) (mkShared (gpt (share ?x6977)) ?x29251 (globals (share ?x6977))) (stack ?x6977) (halt ?x6977))))
 (let (($x45687 (=> (and (and (distinct (rtt_walk_abs.0_call ?x38011 rtt_gidx.2520806 ipa_gidx.2520806) (- 1)) true) $x153) (or (= ?x38035 4) (= ?x38035 6)))))
 (=> (and (= (e_state_s_granule (select ?x6999 rtt_gidx.2520806)) 5) (and (distinct (rtt_walk_abs.0_call ?x38011 rtt_gidx.2520806 ipa_gidx.2520806) (- 1)) true) $x153) (or (= ?x38035 4) (= ?x38035 6)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x30215)))
(check-sat)

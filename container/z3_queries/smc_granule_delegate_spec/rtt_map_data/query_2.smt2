...
(assert
 ...
 (let ((?x1759 (oracle ?x1608)))
 (let ((?x1481 (log ?x1608)))
 (let ((?x1834 (mkRData ?x1481 ?x1759 ?x1613 ?x1647 (mkShared ?x1597 (store (granule_data ?x1509) i.1614829 d.1614829) ?x1864) ?x1802 $x1780)))
 (let ((?x1711 (rtt_walk_abs.0_call ?x1834 rtt_gidx.1614829 ipa_gidx.1614829)))
...
(assert
 (let (($x1619 (forall ((rtt_gidx.1615005 Int) (ipa_gidx.1615005 Int) (data_gidx.1615005 Int) )(let ((?x652 (query_oracle.0_call st.0)))
 (let ((?x23834 (value_RData ?x652)))
 (let ((?x1582 (+ 18446744004990074880 v_0.1613755)))
 (let ((?x1375 (get_tte_spec.0_call ?x1582 ?x23834)))
 (let ((?x1599 (value_Tuple_Ptr_RData ?x1375)))
 ...
 (let ((?x1509 (share ?x1608)))
 (let ((?x1820 (granule_data ?x1509)))
 (let ((?x1625 (g_granule_state (select ?x1820 (rtt_walk_abs.0_call ?x1608 rtt_gidx.1615005 ipa_gidx.1615005)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1615005)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x1509)) rtt_gidx.1615005)) 5) $x142) (or (= ?x1625 4) (= ?x1625 6))))))))))))))
 ))
 (not $x1619)))
(check-sat)

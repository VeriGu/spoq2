...
(assert
 ...
 (not $x1468)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x3469 (forall ((rtt_gidx.1617177 Int) (ipa_gidx.1617177 Int) (data_gidx.1617177 Int) )(let ((?x652 (query_oracle.0_call st.0)))
 (let ((?x23834 (value_RData ?x652)))
 (let ((?x645 (share ?x23834)))
 (let ((?x9100 (granule_data ?x645)))
 (let ((?x1336 (g_granule_state (select ?x9100 (rtt_walk_abs.0_call ?x23834 rtt_gidx.1617177 ipa_gidx.1617177)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1617177)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x645)) rtt_gidx.1617177)) 5) $x142) (or (= ?x1336 4) (= ?x1336 6))))))))))
 ))
 (not $x3469)))
(check-sat)

...
(assert
 ...
 (let ((?x19 (g_heap ?x15)))
 (let ((?x1195 (mkGLOBALS ?x19 ?x20 ?x21 ?x22 ?x23 ?x24 ?x25 ?x26 ?x27 ?x28 ?x29 ?x30 ?x31 ?x32 ?x33 ?x34 ?x35 ?x36 ?x37 ?x38 ?x39 (store (g_granules ?x15) i.49969 d.49969) ?x40 ?x41 ?x42 ?x43 ?x44 ?x45 ?x46 ?x47 ?x48)))
 (let ((?x51 (granule_data ?x13)))
 (let ((?x50 (gpt ?x13)))
 (let ((?x56 (priv st.0)))
 (let ((?x55 (repl st.0)))
 ...
 (let ((?x160 (e_state_s_granule (select (g_granules ?x15) i.49969))))
 (let (($x161 (= ?x160 5)))
 (let (($x162 (not $x161)))
...
(assert
 ...
 (or (not $x1242) $x1244))))
(assert
 (forall ((v_0.61307 Int) )(let ((?x13 (share st.0)))
 (let ((?x50 (gpt ?x13)))
 (select ?x50 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.61307))) 4096)))))
 )
(assert
...
(assert
 (let (($x1288 (forall ((rtt_gidx.1613651 Int) (ipa_gidx.1613651 Int) (data_gidx.1613651 Int) )(let ((?x13 (share st.0)))
 (let ((?x51 (granule_data ?x13)))
 (let ((?x138 (g_granule_state (select ?x51 (rtt_walk_abs.0_call st.0 rtt_gidx.1613651 ipa_gidx.1613651)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1613651)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x13)) rtt_gidx.1613651)) 5) $x142) (or (= ?x138 4) (= ?x138 6))))))))
 ))
 (not $x1288)))
(check-sat)

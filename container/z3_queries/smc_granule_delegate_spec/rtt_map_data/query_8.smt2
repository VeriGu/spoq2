...
(assert
 ...
 (let ((?x585 (g_granules ?x748)))
 (let ((?x1524 (select ?x585 ?x1499)))
 (let ((?x1575 (e_ref ?x1524)))
 (let ((?x1558 (e_state_s_granule ?x1524)))
 (let ((?x37893 (Some_Z CPU_ID.0)))
 (let ((?x62611 (mks_spinlock_t ?x37893)))
 (let ((?x1465 (mks_granule ?x62611 ?x1558 ?x1575)))
 ...
 (not $x1467)))))))))))))))))))))
(assert
 (let (($x3319 (forall ((rtt_gidx.1617283 Int) (ipa_gidx.1617283 Int) (data_gidx.1617283 Int) )(let ((?x652 (query_oracle.0_call st.0)))
 (let ((?x23834 (value_RData ?x652)))
 (let (($x50465 (halt ?x23834)))
 (let ((?x50463 (stack ?x23834)))
 (let ((?x645 (share ?x23834)))
 ...
 (let ((?x1575 (e_ref ?x1524)))
 (let ((?x1558 (e_state_s_granule ?x1524)))
 (let ((?x85873 (mks_spinlock_t None_Z)))
 (let ((?x3106 (mks_granule ?x85873 ?x1558 ?x1575)))
 (let ((?x3296 (store ?x585 ?x1499 ?x3106)))
 (let ((?x47033 (g_mbedtls_mem_buf ?x748)))
 (let ((?x47068 (g_tt_l1_upper ?x748)))
 (let ((?x47064 (g_tt_l2_mem1_3 ?x748)))
 (let ((?x54881 (g_tt_l2_mem1_2 ?x748)))
 ...
 (let ((?x54851 (g_debug_exits ?x748)))
 (let ((?x39469 (g_heap ?x748)))
 (let ((?x2850 (mkGLOBALS ?x39469 ?x54851 ?x31644 ?x39463 ?x31637 ?x70416 ?x54876 ?x49721 ?x78147 ?x616 ?x85872 ?x62604 ?x62600 ?x62601 ?x54891 ?x54848 ?x54890 ?x54881 ?x47064 ?x47068 ?x47033 ?x3296 ?x50270 ?x50265 ?x49715 ?x31654 ?x54906 ?x31657 ?x31627 ?x47099 ?x85853)))
 (let ((?x9100 (granule_data ?x645)))
 (let ((?x85855 (gpt ?x645)))
 (let ((?x54912 (priv ?x23834)))
 (let ((?x54910 (repl ?x23834)))
 (let ((?x70420 (oracle ?x23834)))
 (let ((?x54686 (log ?x23834)))
 (let ((?x31451 (mkRData ?x54686 ?x70420 ?x54910 ?x54912 (mkShared ?x85855 ?x9100 ?x2850) ?x50463 $x50465)))
 (let ((?x3486 (g_granule_state (select ?x9100 (rtt_walk_abs.0_call ?x31451 rtt_gidx.1617283 ipa_gidx.1617283)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1617283)))
 (=> (and (= (e_state_s_granule (select ?x3296 rtt_gidx.1617283)) 5) $x142) (or (= ?x3486 4) (= ?x3486 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3319)))
(check-sat)

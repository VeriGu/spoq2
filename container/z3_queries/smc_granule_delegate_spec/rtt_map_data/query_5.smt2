...
(assert
 ...
 (let ((?x2116 (oracle ?x1762)))
 (let ((?x2573 (log ?x1762)))
 (let ((?x31002 (mkRData ?x2573 ?x2116 ?x2386 ?x2192 (mkShared ?x2061 (store (granule_data ?x2206) i.1616253 d.1616253) ?x2104) ?x2379 $x2105)))
 (let ((?x2484 (rtt_walk_abs.0_call ?x31002 rtt_gidx.1616253 ipa_gidx.1616253)))
...
(assert
 (let (($x2628 (forall ((rtt_gidx.1616429 Int) (ipa_gidx.1616429 Int) (data_gidx.1616429 Int) )(let ((?x652 (query_oracle.0_call st.0)))
 (let ((?x23834 (value_RData ?x652)))
 (let ((?x1782 (+ 18446743457381744640 v_0.1613755)))
 (let ((?x56643 (get_tte_spec.0_call ?x1782 ?x23834)))
 (let ((?x2251 (value_Tuple_Ptr_RData ?x56643)))
 ...
 (let ((?x2206 (share ?x1762)))
 (let ((?x2108 (granule_data ?x2206)))
 (let ((?x2119 (g_granule_state (select ?x2108 (rtt_walk_abs.0_call ?x1762 rtt_gidx.1616429 ipa_gidx.1616429)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.1616429)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x2206)) rtt_gidx.1616429)) 5) $x142) (or (= ?x2119 4) (= ?x2119 6))))))))))))))
 ))
 (not $x2628)))
(check-sat)

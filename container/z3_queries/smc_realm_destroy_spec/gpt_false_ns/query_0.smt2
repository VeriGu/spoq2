...
(assert
 (forall ((gidx.72744 Int) )(let ((?x532 (share st.0)))
 (let ((?x538 (globals ?x532)))
 (let ((?x540 (g_granules ?x538)))
 (let ((?x549 (select ?x540 gidx.72744)))
 (let ((?x550 (e_state_s_granule ?x549)))
 (let (($x551 (= ?x550 6)))
 (let (($x552 (= ?x550 0)))
 (=> (not (select (gpt ?x532) gidx.72744)) (or $x552 $x551))))))))))
 )
(assert
 (let (($x569 (forall ((gidx.168129 Int) )(let ((?x532 (share st.0)))
 (let ((?x538 (globals ?x532)))
 (let ((?x540 (g_granules ?x538)))
 (let ((?x549 (select ?x540 gidx.168129)))
 (let ((?x550 (e_state_s_granule ?x549)))
 (let (($x551 (= ?x550 6)))
 (let (($x552 (= ?x550 0)))
 (=> (not (select (gpt ?x532) gidx.168129)) (or $x552 $x551))))))))))
 ))
 (not $x569)))
(check-sat)

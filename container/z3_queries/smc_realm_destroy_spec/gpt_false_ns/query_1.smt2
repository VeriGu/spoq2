...
(assert
 (let ((?x599 (test_PA.0_call v_0.0)))
 (let ((?x601 (meta_granule_offset ?x599)))
 (let ((?x602 (div ?x601 4096)))
 (let ((?x558 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x558)))
 (let ((?x8310 (share ?x560)))
 (let ((?x574 (gpt ?x8310)))
 (select ?x574 ?x602)))))))))
(assert
 (let ((?x532 (share st.0)))
 (let ((?x538 (globals ?x532)))
 (let ((?x540 (g_granules ?x538)))
 (let ((?x558 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x558)))
 (let ((?x8310 (share ?x560)))
 (let ((?x576 (globals ?x8310)))
 (let ((?x581 (g_granules ?x576)))
 (= ?x581 ?x540))))))))))
(assert
 (let ((?x599 (test_PA.0_call v_0.0)))
 (let ((?x601 (meta_granule_offset ?x599)))
 ...
 (let ((?x576 (globals ?x8310)))
 (let ((?x581 (g_granules ?x576)))
 (let ((?x606 (select ?x581 ?x602)))
 (let ((?x614 (e_lock ?x606)))
 (let ((?x621 (e_val ?x614)))
 (= ?x621 None_Z)))))))))))))
(assert
 (let ((?x599 (test_PA.0_call v_0.0)))
 ...
 (let ((?x581 (g_granules ?x576)))
 (let ((?x606 (select ?x581 ?x602)))
 (let ((?x628 (e_state_s_granule ?x606)))
 (= ?x628 2))))))))))))
(assert
 (let ((?x558 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x558)))
 (let ((?x599 (test_PA.0_call v_0.0)))
 (let ((?x601 (meta_granule_offset ?x599)))
 (let ((?x631 (mkPtr "granules" ?x601)))
 (let ((?x635 (g_refcount_para.0_call ?x631 ?x560)))
 (= ?x635 0))))))))
(assert
 (let ((?x599 (test_PA.0_call v_0.0)))
 (let ((?x601 (meta_granule_offset ?x599)))
 (let ((?x16048 (mod ?x601 4096)))
 (let (($x639 (= ?x16048 0)))
 (let (($x638 (>= ?x601 0)))
 (and $x638 $x639)))))))
(assert
 ...
 (let ((?x601 (meta_granule_offset ?x599)))
 (let ((?x651 (+ 24 ?x601)))
 (let ((?x690 (mod ?x651 4096)))
 (let ((?x650 (div ?x651 4096)))
 (let ((?x8310 (share ?x560)))
 (let ((?x9175 (granule_data ?x8310)))
 (let ((?x652 (select ?x9175 ?x650)))
 (let ((?x653 (g_norm ?x652)))
 (let ((?x693 (select ?x653 ?x690)))
 (let ((?x643 (+ 32 ?x601)))
 (let ((?x646 (mod ?x643 4096)))
 (let ((?x642 (div ?x643 4096)))
 (let ((?x648 (select ?x9175 ?x642)))
 (let ((?x645 (g_norm ?x648)))
 (let ((?x647 (select ?x645 ?x646)))
 (let ((?x695 (total_root_rtt_refcount_para.0_call ?x647 ?x693 ?x560)))
 (= ?x695 0)))))))))))))))))))))
(assert
 (forall ((gidx.168184 Int) )(let ((?x558 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x558)))
 (let ((?x8310 (share ?x560)))
 (let ((?x576 (globals ?x8310)))
 (let ((?x581 (g_granules ?x576)))
 (let ((?x591 (e_state_s_granule (select ?x581 gidx.168184))))
 (let ((?x574 (gpt ?x8310)))
 (let (($x595 (select ?x574 gidx.168184)))
 (let (($x596 (not $x595)))
 (=> $x596 (or (= ?x591 0) (= ?x591 6)))))))))))))
 )
(assert
 (let (($x778 (forall ((gidx.168305 Int) )(let ((?x599 (test_PA.0_call v_0.0)))
 (let ((?x601 (meta_granule_offset ?x599)))
 (let ((?x602 (div ?x601 4096)))
 (let ((?x558 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x558)))
 ...
 (let ((?x606 (select ?x581 ?x602)))
 (let ((?x614 (e_lock ?x606)))
 (let ((?x700 (mks_granule ?x614 1 (e_ref ?x606))))
 (let ((?x701 (store ?x581 ?x602 ?x700)))
 (let ((?x773 (e_state_s_granule (select ?x701 gidx.168305))))
 (let ((?x574 (gpt ?x8310)))
 (let (($x595 (select ?x574 gidx.168305)))
 (let (($x596 (not $x595)))
 (=> $x596 (or (= ?x773 0) (= ?x773 6))))))))))))))))))))
 ))
 (not $x778)))
(check-sat)

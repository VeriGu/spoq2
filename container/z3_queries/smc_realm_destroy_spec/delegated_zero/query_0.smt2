...
(assert
 (forall ((gidx.72770 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.72770)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.72770)) 1)))
 (=> $x62 $x59))))
 )
(assert
 (let (($x1583 (forall ((gidx.77866 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x53 (granule_data ?x17)))
 (let ((?x93 (select ?x53 gidx.77866)))
 (let (($x95 (= (g_norm ?x93) zero_granule_data)))
 (let (($x98 (= (e_state_s_granule (select (g_granules (globals ?x17)) gidx.77866)) 1)))
 (or (not $x98) $x95)))))))))))
 ))
 (let (($x1535 (forall ((gidx.77855 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.77855)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.77855)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x1535) $x1583))))
(assert
 (let (($x51410 (forall ((gidx.2336715 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.2336715)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.2336715)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x51410)))
(check-sat)

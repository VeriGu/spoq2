...
(assert
 ...
 (not $x1805))))))))))))))))))))))
(assert
 (forall ((gidx.2336752 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1234 (select ?x9074 gidx.2336752)))
 (let (($x1361 (= (g_norm ?x1234) zero_granule_data)))
 (let (($x1287 (= (e_state_s_granule (select (g_granules (globals ?x220)) gidx.2336752)) 1)))
 (=> $x1287 $x1361)))))))))
 )
(assert
 (let (($x51454 (forall ((gidx.2336888 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x85720 (log ?x617)))
 (let ((?x1739 (|(oracle (value_RData (query_oracle.0_call st.0)))_call| ?x85720)))
 (let ((?x46965 (|(repl (value_RData (query_oracle.0_call st.0)))_call| ?x1739 ?x220)))
 (let ((?x1321 (value_Shared ?x46965)))
 (let ((?x1458 (granule_data ?x1321)))
 (let ((?x1723 (select ?x1458 gidx.2336888)))
 (let (($x1418 (= (g_norm ?x1723) zero_granule_data)))
 (let (($x47008 (= (e_state_s_granule (select (g_granules (globals ?x1321)) gidx.2336888)) 1)))
 (or (not $x47008) $x1418)))))))))))))
 ))
 (let (($x130110 (forall ((gidx.2336877 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1234 (select ?x9074 gidx.2336877)))
 (let (($x1361 (= (g_norm ?x1234) zero_granule_data)))
 (let (($x1287 (= (e_state_s_granule (select (g_granules (globals ?x220)) gidx.2336877)) 1)))
 (or (not $x1287) $x1361)))))))))
 ))
 (or (not $x130110) $x51454))))
(assert
 (let (($x79652 (forall ((gidx.2337245 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1234 (select ?x9074 gidx.2337245)))
 (let (($x1361 (= (g_norm ?x1234) zero_granule_data)))
 (let (($x1287 (= (e_state_s_granule (select (g_granules (globals ?x220)) gidx.2337245)) 1)))
 (=> $x1287 $x1361)))))))))
 ))
 (not $x79652)))
(check-sat)

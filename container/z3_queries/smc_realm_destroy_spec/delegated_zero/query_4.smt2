...
(assert
 (let (($x122318 (forall ((gidx.2337283 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1234 (select ?x9074 gidx.2337283)))
 (let (($x1361 (= (g_norm ?x1234) zero_granule_data)))
 (let (($x1287 (= (e_state_s_granule (select (g_granules (globals ?x220)) gidx.2337283)) 1)))
 (=> $x1287 $x1361)))))))))
 ))
 (not $x122318)))
(check-sat)

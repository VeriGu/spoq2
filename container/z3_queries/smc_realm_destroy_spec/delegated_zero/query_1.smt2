...
(assert
 (let (($x59690 (forall ((gidx.2336928 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1234 (select ?x9074 gidx.2336928)))
 (let (($x1361 (= (g_norm ?x1234) zero_granule_data)))
 (let (($x1287 (= (e_state_s_granule (select (g_granules (globals ?x220)) gidx.2336928)) 1)))
 (=> $x1287 $x1361)))))))))
 ))
 (not $x59690)))
(check-sat)

...
(declare-fun free_sl_rtts_spec.0_call (Ptr Int Bool RData) Option_RData)
(declare-fun test_Z_Ptr.0_call (Int) Ptr)
(declare-fun |(let ((a!1 (granule_data (share (value_RData (query_oracle.0_call st.0)))))
      (a!2 (div (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!3 (mod (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!5 (div (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!6 (mod (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096)))
(let ((a!4 (test_Z_Ptr.0_call (select (g_norm (select a!1 a!2)) a!3))))
(let ((a!7 (free_sl_rtts_spec.0_call
             a!4
             (select (g_norm (select a!1 a!5)) a!6)
             true
...
(assert
 ...
 (let ((?x220 (share ?x617)))
 (let ((?x223 (globals ?x220)))
 (let ((?x619 (g_granules ?x223)))
 (= ?x619 ?x43))))))))))
(assert
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x46590 (div ?x157405 4096)))
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x220 (share ?x617)))
 (let ((?x223 (globals ?x220)))
 (let ((?x619 (g_granules ?x223)))
 (let ((?x46962 (select ?x619 ?x46590)))
 (let ((?x46659 (e_lock ?x46962)))
 (let ((?x59723 (e_val ?x46659)))
 (= ?x59723 None_Z)))))))))))))
(assert
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 ...
 (let ((?x619 (g_granules ?x223)))
 (let ((?x46962 (select ?x619 ?x46590)))
 (let ((?x1493 (e_state_s_granule ?x46962)))
 (= ?x1493 2))))))))))))
(assert
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x18226 (mkPtr "granules" ?x157405)))
 (let ((?x51354 (g_refcount_para.0_call ?x18226 ?x617)))
 (= ?x51354 0))))))))
(assert
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x25265 (mod ?x157405 4096)))
 (let (($x1538 (= ?x25265 0)))
 (let (($x20849 (>= ?x157405 0)))
 (and $x20849 $x1538)))))))
(assert
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x1765 (+ 24 ?x157405)))
 (let ((?x1682 (mod ?x1765 4096)))
 (let ((?x1562 (div ?x1765 4096)))
 (let ((?x220 (share ?x617)))
 (let ((?x9074 (granule_data ?x220)))
 (let ((?x1542 (select ?x9074 ?x1562)))
 (let ((?x1829 (g_norm ?x1542)))
 (let ((?x1195 (select ?x1829 ?x1682)))
 (let ((?x1611 (+ 32 ?x157405)))
 (let ((?x1536 (mod ?x1611 4096)))
 (let ((?x1537 (div ?x1611 4096)))
 (let ((?x1645 (select ?x9074 ?x1537)))
 (let ((?x1523 (g_norm ?x1645)))
 (let ((?x1498 (select ?x1523 ?x1536)))
 (let ((?x1206 (total_root_rtt_refcount_para.0_call ?x1498 ?x1195 ?x617)))
 (= ?x1206 0)))))))))))))))))))))
(assert
 (forall ((gidx.2336965 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x1765 (+ 24 ?x157405)))
 ...
 (let ((?x1523 (g_norm ?x1645)))
 (let ((?x1498 (select ?x1523 ?x1536)))
 (let ((?x1302 (test_Z_Ptr.0_call ?x1498)))
 (let ((?x1187 (free_sl_rtts_spec.0_call ?x1302 ?x1195 true ?x617)))
 (let ((?x1606 (value_RData ?x1187)))
 (let ((?x1802 (share ?x1606)))
 (let ((?x1748 (granule_data ?x1802)))
 (let ((?x1466 (select ?x1748 gidx.2336965)))
 (let (($x1387 (= (g_norm ?x1466) zero_granule_data)))
 (let (($x1264 (= (e_state_s_granule (select (g_granules (globals ?x1802)) gidx.2336965)) 1)))
 (=> $x1264 $x1387))))))))))))))))))))))))))))
 )
(assert
 (let (($x1326 (forall ((gidx.2337101 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x1765 (+ 24 ?x157405)))
 ...
 (let ((?x1802 (share ?x1606)))
 (let ((?x1868 (log ?x1606)))
 (let ((?x1274 (|(let ((a!1 (granule_data (share (value_RData (query_oracle.0_call st.0)))))
      (a!2 (div (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!3 (mod (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!5 (div (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!6 (mod (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096)))
...
(let ((a!7 (free_sl_rtts_spec.0_call
             ...
             true
             (value_RData (query_oracle.0_call st.0)))))
  (oracle (value_RData a!7)))))_call| ?x1868)))
 (let ((?x1521 (|(let ((a!1 (granule_data (share (value_RData (query_oracle.0_call st.0)))))
      (a!2 (div (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!3 (mod (+ 32 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!5 (div (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096))
      (a!6 (mod (+ 24 (meta_granule_offset (test_PA.0_call v_0.0))) 4096)))
...
(let ((a!7 (free_sl_rtts_spec.0_call
             ...
             true
             (value_RData (query_oracle.0_call st.0)))))
  (repl (value_RData a!7)))))_call| ?x1274 ?x1802)))
 (let ((?x67753 (value_Shared ?x1521)))
 (let ((?x1180 (granule_data ?x67753)))
 (let ((?x1453 (select ?x1180 gidx.2337101)))
 (let (($x8867 (= (g_norm ?x1453) zero_granule_data)))
 (let (($x87466 (= (e_state_s_granule (select (g_granules (globals ?x67753)) gidx.2337101)) 1)))
 (or (not $x87466) $x8867))))))))))))))))))))))))))))))))
 ))
 (let (($x67584 (forall ((gidx.2337090 Int) )(let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 (let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x1765 (+ 24 ?x157405)))
 ...
 (let ((?x1802 (share ?x1606)))
 (let ((?x1748 (granule_data ?x1802)))
 (let ((?x1466 (select ?x1748 gidx.2337090)))
 (let (($x1387 (= (g_norm ?x1466) zero_granule_data)))
 (let (($x1264 (= (e_state_s_granule (select (g_granules (globals ?x1802)) gidx.2337090)) 1)))
 (or (not $x1264) $x1387))))))))))))))))))))))))))))
 ))
 (or (not $x67584) $x1326))))
(assert
 (let (($x1450 (forall ((gidx.2337207 Int) )(let ((?x13545 (test_PA.0_call v_0.0)))
 (let ((?x157405 (meta_granule_offset ?x13545)))
 (let ((?x46590 (div ?x157405 4096)))
 (let ((?x487 (query_oracle.0_call st.0)))
 (let ((?x617 (value_RData ?x487)))
 ...
 (let ((?x1802 (share ?x1606)))
 (let ((?x1748 (granule_data ?x1802)))
 (let ((?x1612 (select ?x1748 ?x46590)))
 (let ((?x1638 (g_rec ?x1612)))
 (let ((?x1752 (g_rd ?x1612)))
 (let ((?x1575 (g_granule_state ?x1612)))
 (let ((?x1603 (gd_g_idx ?x1612)))
 (let ((?x1712 (mkr_granule_data ?x1603 ?x1575 zero_granule_data ?x1752 ?x1638)))
 (let ((?x1840 (store ?x1748 ?x46590 ?x1712)))
 (let ((?x1770 (globals ?x1802)))
 (let ((?x1873 (g_granules ?x1770)))
 (let ((?x1758 (select ?x1873 ?x46590)))
 (let ((?x1728 (e_ref ?x1758)))
 (let ((?x1710 (e_lock ?x1758)))
 (let ((?x1596 (mks_granule ?x1710 1 ?x1728)))
 (let ((?x1530 (store ?x1873 ?x46590 ?x1596)))
 (=> (= (e_state_s_granule (select ?x1530 gidx.2337207)) 1) (= (g_norm (select ?x1840 gidx.2337207)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1450)))
(check-sat)

...
(assert
 (let (($x1656 (forall ((rtt_gidx.203545 Int) (ipa_gidx.203545 Int) (data_gidx.203545 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1200 (g_granule_state (select ?x1239 (rtt_walk_abs.0_call ?x1147 rtt_gidx.203545 ipa_gidx.203545)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.203545)))
 (let (($x1210 (= (e_state_s_granule (select (g_granules (globals ?x1206)) rtt_gidx.203545)) 5)))
 (=> (and $x1210 $x102) (or (= ?x1200 4) (= ?x1200 6)))))))))))
 ))
 (not $x1656)))
(check-sat)

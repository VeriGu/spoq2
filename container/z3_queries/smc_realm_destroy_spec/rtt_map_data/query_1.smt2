...
(declare-fun v_0.202319 () Int)
(declare-fun g_refcount_para.0_call (Ptr RData) Int)
(declare-fun total_root_rtt_refcount_para.0_call (Int Int RData) Int)
...
(assert
 ...
 (let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1209 (g_granules ?x1254)))
 (= ?x1209 ?x13))))))))))
(assert
 (let ((?x1569 (test_PA.0_call v_0.202319)))
 (let ((?x1571 (meta_granule_offset ?x1569)))
 (let ((?x1572 (div ?x1571 4096)))
 (let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1209 (g_granules ?x1254)))
 (let ((?x1573 (select ?x1209 ?x1572)))
 (let ((?x1577 (e_lock ?x1573)))
 (let ((?x1579 (e_val ?x1577)))
 (= ?x1579 None_Z)))))))))))))
(assert
 (let ((?x1569 (test_PA.0_call v_0.202319)))
 (let ((?x1571 (meta_granule_offset ?x1569)))
 ...
 (let ((?x1209 (g_granules ?x1254)))
 (let ((?x1573 (select ?x1209 ?x1572)))
 (let ((?x1582 (e_state_s_granule ?x1573)))
 (= ?x1582 2))))))))))))
(assert
 (let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1569 (test_PA.0_call v_0.202319)))
 (let ((?x1571 (meta_granule_offset ?x1569)))
 (let ((?x1585 (mkPtr "granules" ?x1571)))
 (let ((?x1589 (g_refcount_para.0_call ?x1585 ?x1147)))
 (= ?x1589 0))))))))
(assert
 (let ((?x1569 (test_PA.0_call v_0.202319)))
 (let ((?x1571 (meta_granule_offset ?x1569)))
 (let ((?x1593 (mod ?x1571 4096)))
 (let (($x1594 (= ?x1593 0)))
 (let (($x1592 (>= ?x1571 0)))
 (and $x1592 $x1594)))))))
(assert
 ...
 (let ((?x1571 (meta_granule_offset ?x1569)))
 (let ((?x1606 (+ 24 ?x1571)))
 (let ((?x1611 (mod ?x1606 4096)))
 (let ((?x1602 (div ?x1606 4096)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1609 (select ?x1239 ?x1602)))
 (let ((?x1610 (g_norm ?x1609)))
 (let ((?x1612 (select ?x1610 ?x1611)))
 (let ((?x1598 (+ 32 ?x1571)))
 (let ((?x1600 (mod ?x1598 4096)))
 (let ((?x1597 (div ?x1598 4096)))
 (let ((?x1603 (select ?x1239 ?x1597)))
 (let ((?x1604 (g_norm ?x1603)))
 (let ((?x1601 (select ?x1604 ?x1600)))
 (let ((?x1614 (total_root_rtt_refcount_para.0_call ?x1601 ?x1612 ?x1147)))
 (= ?x1614 0)))))))))))))))))))))
(assert
 (forall ((rtt_gidx.202284 Int) (ipa_gidx.202284 Int) (data_gidx.202284 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1200 (g_granule_state (select ?x1239 (rtt_walk_abs.0_call ?x1147 rtt_gidx.202284 ipa_gidx.202284)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.202284)))
 (let (($x1210 (= (e_state_s_granule (select (g_granules (globals ?x1206)) rtt_gidx.202284)) 5)))
 (=> (and $x1210 $x102) (or (= ?x1200 4) (= ?x1200 6)))))))))))
 )
(assert
 (forall ((v_0.202319 Int) )(let ((?x1141 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.202319))) 4096)))
 (let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1272 (gpt ?x1206)))
...
(assert
 (let (($x1333 (forall ((rtt_gidx.202611 Int) (ipa_gidx.202611 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1220 (log ?x1147)))
 (let ((?x1222 (|(oracle (value_RData (query_oracle.0_call st.0)))_call| ?x1220)))
 (let ((?x1224 (|(repl (value_RData (query_oracle.0_call st.0)))_call| ?x1222 ?x1206)))
 (let ((?x1243 (value_Shared ?x1224)))
 (let ((?x1285 (globals ?x1243)))
 (let ((?x1286 (g_granules ?x1285)))
 (let (($x1331 (not (= (e_state_s_granule (select ?x1286 rtt_gidx.202611)) 5))))
 (let (($x1296 (halt ?x1147)))
 (let ((?x1295 (stack ?x1147)))
 (let ((?x1294 (priv ?x1147)))
 (let ((?x1223 (repl ?x1147)))
 (let ((?x1221 (oracle ?x1147)))
 (let ((?x1292 (List_Event_concat ?x1222 ?x1220)))
 (let ((?x1306 (mkRData ?x1292 ?x1221 ?x1223 ?x1294 ?x1243 ?x1295 $x1296)))
 (let ((?x1375 (rtt_walk_abs.0_call ?x1306 rtt_gidx.202611 ipa_gidx.202611)))
 (let ((?x1289 (granule_data ?x1243)))
 (let ((?x1377 (g_granule_state (select ?x1289 ?x1375))))
 (let (($x1378 (= ?x1377 4)))
 (let (($x1326 (= ?x1377 6)))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.202611))))
 (or $x113 $x1326 $x1378 $x1331)))))))))))))))))))))))))
 ))
 (let (($x1374 (forall ((rtt_gidx.202575 Int) (ipa_gidx.202575 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1209 (g_granules ?x1254)))
 (let ((?x1370 (e_state_s_granule (select ?x1209 rtt_gidx.202575))))
 (let (($x1372 (not (= ?x1370 5))))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.202575))))
 (let ((?x1366 (g_granule_state (select (granule_data ?x1206) (rtt_walk_abs.0_call ?x1147 rtt_gidx.202575 ipa_gidx.202575)))))
 (let (($x1368 (= ?x1366 4)))
 (let (($x1367 (= ?x1366 6)))
 (or $x1367 $x1368 $x113 $x1372)))))))))))))
 ))
 (or (not $x1374) $x1333))))
(assert
 (forall ((rtt_gidx.202716 Int) (ipa_gidx.202716 Int) (i.202716 Int) (d.202716 r_granule_data) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let (($x1296 (halt ?x1147)))
 (let ((?x1295 (stack ?x1147)))
 (let ((?x1206 (share ?x1147)))
 ...
 (let ((?x1221 (oracle ?x1147)))
 (let ((?x1220 (log ?x1147)))
 (let ((?x1350 (mkRData ?x1220 ?x1221 ?x1223 ?x1294 (mkShared ?x1272 (store (granule_data ?x1206) i.202716 d.202716) ?x1254) ?x1295 $x1296)))
 (let ((?x1351 (rtt_walk_abs.0_call ?x1350 rtt_gidx.202716 ipa_gidx.202716)))
 (let ((?x1353 (rtt_walk_abs.0_call ?x1147 rtt_gidx.202716 ipa_gidx.202716)))
 (let (($x1372 (not (= (e_state_s_granule (select (g_granules ?x1254) i.202716)) 5))))
 (let (($x1358 (and $x1372 (not (= (e_state_s_granule (select (g_granules ?x1254) i.202716)) 4)))))
 (=> $x1358 (= (+ ?x1353 (* (- 1) ?x1351)) 0)))))))))))))))))))
 )
(assert
 (forall ((rtt_gidx.202823 Int) (ipa_gidx.202823 Int) (i.202823 Int) (d.202823 s_granule) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let (($x1296 (halt ?x1147)))
 (let ((?x1295 (stack ?x1147)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1428 (g_realm_attest_private_key ?x1254)))
 (let ((?x1427 (g_get_realm_identity_identity ?x1254)))
 (let ((?x1426 (g_rmm_platform_token ?x1254)))
 (let ((?x1425 (g_platform_token_buf ?x1254)))
 (let ((?x1424 (g_rmm_attest_public_key_hash_len ?x1254)))
 (let ((?x1423 (g_rmm_attest_public_key_hash ?x1254)))
 (let ((?x1422 (g_rmm_attest_public_key_len ?x1254)))
 (let ((?x1421 (g_rmm_attest_public_key ?x1254)))
 (let ((?x1420 (g_rmm_attest_signing_key ?x1254)))
 (let ((?x1419 (g_mbedtls_mem_buf ?x1254)))
 (let ((?x1417 (g_tt_l1_upper ?x1254)))
 (let ((?x1415 (g_tt_l2_mem1_3 ?x1254)))
 (let ((?x1414 (g_tt_l2_mem1_2 ?x1254)))
 (let ((?x1413 (g_tt_l2_mem1_1 ?x1254)))
 (let ((?x1412 (g_tt_l2_mem1_0 ?x1254)))
 (let ((?x1411 (g_tt_l2_mem0_1 ?x1254)))
 (let ((?x1409 (g_tt_l2_mem0_0 ?x1254)))
 (let ((?x1408 (g_tt_l3_buffer ?x1254)))
 (let ((?x1407 (g_rmm_trap_list ?x1254)))
 (let ((?x1406 (g_status_handler ?x1254)))
 (let ((?x1405 (g_default_gicstate ?x1254)))
 (let ((?x1404 (g_pri_res0_mask ?x1254)))
 (let ((?x1403 (g_max_vintid ?x1254)))
 (let ((?x1402 (g_nr_aprs ?x1254)))
 (let ((?x1401 (g_nr_lrs ?x1254)))
 (let ((?x1400 (g_vmids ?x1254)))
 (let ((?x1399 (g_vmid_lock ?x1254)))
 (let ((?x1391 (g_vmid_count ?x1254)))
 (let ((?x1389 (g_debug_exits ?x1254)))
 (let ((?x1395 (g_heap ?x1254)))
 (let ((?x1416 (mkGLOBALS ?x1395 ?x1389 ?x1391 ?x1399 ?x1400 ?x1401 ?x1402 ?x1403 ?x1404 ?x1405 ?x1406 ?x1407 ?x1408 ?x1409 ?x1411 ?x1412 ?x1413 ?x1414 ?x1415 ?x1417 ?x1419 (store (g_granules ?x1254) i.202823 d.202823) ?x1420 ?x1421 ?x1422 ?x1423 ?x1424 ?x1425 ?x1426 ?x1427 ?x1428)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1272 (gpt ?x1206)))
 (let ((?x1294 (priv ?x1147)))
 (let ((?x1223 (repl ?x1147)))
 (let ((?x1221 (oracle ?x1147)))
 (let ((?x1220 (log ?x1147)))
 (let ((?x1438 (rtt_walk_abs.0_call (mkRData ?x1220 ?x1221 ?x1223 ?x1294 (mkShared ?x1272 ?x1239 ?x1416) ?x1295 $x1296) rtt_gidx.202823 ipa_gidx.202823)))
 (let ((?x1353 (rtt_walk_abs.0_call ?x1147 rtt_gidx.202823 ipa_gidx.202823)))
 (let (($x1372 (not (= (e_state_s_granule (select (g_granules ?x1254) i.202823)) 5))))
 (let (($x1358 (and $x1372 (not (= (e_state_s_granule (select (g_granules ?x1254) i.202823)) 4)))))
 (=> $x1358 (= (+ ?x1353 (* (- 1) ?x1438)) 0))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((offset.203370 Int) (empty_pte.203370 abs_PTE_t) )(let (($x956 (not (= (meta_granule_offset (meta_PA empty_pte.203370)) (- 1)))))
 (let ((?x957 (div offset.203370 4096)))
 (let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1209 (g_granules ?x1254)))
 (let (($x1549 (forall ((rtt_gidx.203366 Int) (ipa_gidx.203366 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let (($x1296 (halt ?x1147)))
 (let ((?x1295 (stack ?x1147)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x968 (test_PTE_Z.0_call empty_pte.203370)))
 (let ((?x969 (mod offset.203370 4096)))
 (let ((?x1536 (store (g_norm (select (granule_data ?x1206) (div offset.203370 4096))) ?x969 ?x968)))
 (let ((?x1539 (mkr_granule_data (gd_g_idx (select (granule_data ?x1206) (div offset.203370 4096))) (g_granule_state (select (granule_data ?x1206) (div offset.203370 4096))) ?x1536 (g_rd (select (granule_data ?x1206) (div offset.203370 4096))) (g_rec (select (granule_data ?x1206) (div offset.203370 4096))))))
 (let ((?x964 (div offset.203370 4096)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1540 (store ?x1239 ?x964 ?x1539)))
 (let ((?x1272 (gpt ?x1206)))
 (let ((?x1294 (priv ?x1147)))
 (let ((?x1223 (repl ?x1147)))
 (let ((?x1221 (oracle ?x1147)))
 (let ((?x1220 (log ?x1147)))
 (let ((?x1543 (rtt_walk_abs.0_call (mkRData ?x1220 ?x1221 ?x1223 ?x1294 (mkShared ?x1272 ?x1540 ?x1254) ?x1295 $x1296) rtt_gidx.203366 ipa_gidx.203366)))
 (let ((?x1545 (g_granule_state (select ?x1540 ?x1543))))
 (let (($x1546 (= ?x1545 4)))
 (let (($x1547 (= ?x1545 6)))
 (let (($x1372 (not (= (e_state_s_granule (select (g_granules ?x1254) rtt_gidx.203366)) 5))))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.203366))))
 (or $x113 $x1372 $x1547 $x1546))))))))))))))))))))))))))
 ))
 (let (($x1512 (forall ((rtt_gidx.203275 Int) (ipa_gidx.203275 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let ((?x1206 (share ?x1147)))
 (let ((?x1254 (globals ?x1206)))
 (let ((?x1209 (g_granules ?x1254)))
 (let ((?x1370 (e_state_s_granule (select ?x1209 rtt_gidx.203275))))
 (let (($x1372 (not (= ?x1370 5))))
 (let ((?x1366 (g_granule_state (select (granule_data ?x1206) (rtt_walk_abs.0_call ?x1147 rtt_gidx.203275 ipa_gidx.203275)))))
 (let (($x1368 (= ?x1366 4)))
 (let (($x1367 (= ?x1366 6)))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.203275))))
 (or $x113 $x1367 $x1368 $x1372)))))))))))))
 ))
 (let (($x1522 (not $x1512)))
 (or $x1522 $x1549 (not (= (e_state_s_granule (select ?x1209 ?x957)) 5)) $x956))))))))))))
 )
(assert
 (let (($x1652 (forall ((rtt_gidx.203475 Int) (ipa_gidx.203475 Int) (data_gidx.203475 Int) )(let ((?x1145 (query_oracle.0_call st.0)))
 (let ((?x1147 (value_RData ?x1145)))
 (let (($x1296 (halt ?x1147)))
 (let ((?x1295 (stack ?x1147)))
 (let ((?x1206 (share ?x1147)))
 ...
 (let ((?x1573 (select ?x1209 ?x1572)))
 (let ((?x1577 (e_lock ?x1573)))
 (let ((?x1622 (mks_granule ?x1577 1 (e_ref ?x1573))))
 (let ((?x1623 (store ?x1209 ?x1572 ?x1622)))
 (let ((?x1419 (g_mbedtls_mem_buf ?x1254)))
 (let ((?x1417 (g_tt_l1_upper ?x1254)))
 (let ((?x1415 (g_tt_l2_mem1_3 ?x1254)))
 (let ((?x1414 (g_tt_l2_mem1_2 ?x1254)))
 ...
 (let ((?x1389 (g_debug_exits ?x1254)))
 (let ((?x1395 (g_heap ?x1254)))
 (let ((?x1624 (mkGLOBALS ?x1395 ?x1389 ?x1391 ?x1399 ?x1400 ?x1401 ?x1402 ?x1403 ?x1404 ?x1405 ?x1406 ?x1407 ?x1408 ?x1409 ?x1411 ?x1412 ?x1413 ?x1414 ?x1415 ?x1417 ?x1419 ?x1623 ?x1420 ?x1421 ?x1422 ?x1423 ?x1424 ?x1425 ?x1426 ?x1427 ?x1428)))
 (let ((?x1239 (granule_data ?x1206)))
 (let ((?x1272 (gpt ?x1206)))
 (let ((?x1294 (priv ?x1147)))
 (let ((?x1223 (repl ?x1147)))
 (let ((?x1221 (oracle ?x1147)))
 (let ((?x1220 (log ?x1147)))
 (let ((?x1636 (mkRData ?x1220 ?x1221 ?x1223 ?x1294 (mkShared ?x1272 ?x1239 ?x1624) ?x1295 $x1296)))
 (let ((?x1645 (g_granule_state (select ?x1239 (rtt_walk_abs.0_call ?x1636 rtt_gidx.203475 ipa_gidx.203475)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.203475)))
 (=> (and (= (e_state_s_granule (select ?x1623 rtt_gidx.203475)) 5) $x102) (or (= ?x1645 4) (= ?x1645 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1652)))
(check-sat)

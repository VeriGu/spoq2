...
(assert
 (forall ((rtt_gidx.73115 Int) (ipa_gidx.73115 Int) (data_gidx.73115 Int) )(let ((?x9 (share st.0)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x98 (g_granule_state (select ?x36 (rtt_walk_abs.0_call st.0 rtt_gidx.73115 ipa_gidx.73115)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.73115)))
 (let (($x106 (= (e_state_s_granule (select (g_granules (globals ?x9)) rtt_gidx.73115)) 5)))
 (=> (and $x106 $x102) (or (= ?x98 4) (= ?x98 6)))))))))
 )
(assert
 (forall ((offset.94895 Int) (empty_pte.94895 abs_PTE_t) )(let (($x956 (not (= (meta_granule_offset (meta_PA empty_pte.94895)) (- 1)))))
 (let ((?x959 (e_state_s_granule (select (g_granules (globals (share st.0))) (div offset.94895 4096)))))
 (let (($x961 (not (= ?x959 5))))
 (let (($x984 (forall ((rtt_gidx.94891 Int) (ipa_gidx.94891 Int) )(let (($x70 (halt st.0)))
 (let ((?x69 (stack st.0)))
 (let ((?x9 (share st.0)))
 (let ((?x11 (globals ?x9)))
 (let ((?x971 (store (g_norm (select (granule_data ?x9) (div offset.94895 4096))) (mod offset.94895 4096) (test_PTE_Z.0_call empty_pte.94895))))
 (let ((?x974 (mkr_granule_data (gd_g_idx (select (granule_data ?x9) (div offset.94895 4096))) (g_granule_state (select (granule_data ?x9) (div offset.94895 4096))) ?x971 (g_rd (select (granule_data ?x9) (div offset.94895 4096))) (g_rec (select (granule_data ?x9) (div offset.94895 4096))))))
 (let ((?x964 (div offset.94895 4096)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x975 (store ?x36 ?x964 ?x974)))
 (let ((?x63 (gpt ?x9)))
 (let ((?x68 (priv st.0)))
 (let ((?x67 (repl st.0)))
 (let ((?x66 (oracle st.0)))
 (let ((?x65 (log st.0)))
 (let ((?x978 (rtt_walk_abs.0_call (mkRData ?x65 ?x66 ?x67 ?x68 (mkShared ?x63 ?x975 ?x11) ?x69 $x70) rtt_gidx.94891 ipa_gidx.94891)))
 (let ((?x980 (g_granule_state (select ?x975 ?x978))))
 (let (($x981 (= ?x980 4)))
 (let (($x982 (= ?x980 6)))
 (let ((?x120 (e_state_s_granule (select (g_granules ?x11) rtt_gidx.94891))))
 (let (($x121 (= ?x120 5)))
 (let (($x122 (not $x121)))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.94891))))
 (or $x113 $x122 $x982 $x981))))))))))))))))))))))))
 ))
 (let (($x936 (forall ((rtt_gidx.94800 Int) (ipa_gidx.94800 Int) )(let ((?x120 (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.94800))))
 (let (($x121 (= ?x120 5)))
 (let (($x122 (not $x121)))
 (let ((?x114 (rtt_walk_abs.0_call st.0 rtt_gidx.94800 ipa_gidx.94800)))
 (let ((?x9 (share st.0)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x116 (g_granule_state (select ?x36 ?x114))))
 (let (($x118 (= ?x116 4)))
 (let (($x117 (= ?x116 6)))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.94800))))
 (or $x113 $x117 $x118 $x122))))))))))))
 ))
 (let (($x937 (not $x936)))
 (or $x937 $x984 $x961 $x956))))))))
 )
(assert
 (forall ((rtt_gidx.95937 Int) (ipa_gidx.95937 Int) (i.95937 Int) (d.95937 s_granule) )(let (($x70 (halt st.0)))
 (let ((?x69 (stack st.0)))
 (let ((?x9 (share st.0)))
 (let ((?x11 (globals ?x9)))
 (let ((?x608 (g_realm_attest_private_key ?x11)))
 (let ((?x607 (g_get_realm_identity_identity ?x11)))
 (let ((?x606 (g_rmm_platform_token ?x11)))
 (let ((?x605 (g_platform_token_buf ?x11)))
 (let ((?x604 (g_rmm_attest_public_key_hash_len ?x11)))
 (let ((?x603 (g_rmm_attest_public_key_hash ?x11)))
 (let ((?x602 (g_rmm_attest_public_key_len ?x11)))
 (let ((?x601 (g_rmm_attest_public_key ?x11)))
 (let ((?x600 (g_rmm_attest_signing_key ?x11)))
 (let ((?x599 (g_mbedtls_mem_buf ?x11)))
 (let ((?x598 (g_tt_l1_upper ?x11)))
 (let ((?x597 (g_tt_l2_mem1_3 ?x11)))
 (let ((?x596 (g_tt_l2_mem1_2 ?x11)))
 (let ((?x595 (g_tt_l2_mem1_1 ?x11)))
 (let ((?x594 (g_tt_l2_mem1_0 ?x11)))
 (let ((?x593 (g_tt_l2_mem0_1 ?x11)))
 (let ((?x592 (g_tt_l2_mem0_0 ?x11)))
 (let ((?x591 (g_tt_l3_buffer ?x11)))
 (let ((?x590 (g_rmm_trap_list ?x11)))
 (let ((?x589 (g_status_handler ?x11)))
 (let ((?x588 (g_default_gicstate ?x11)))
 (let ((?x587 (g_pri_res0_mask ?x11)))
 (let ((?x586 (g_max_vintid ?x11)))
 (let ((?x585 (g_nr_aprs ?x11)))
 (let ((?x584 (g_nr_lrs ?x11)))
 (let ((?x583 (g_vmids ?x11)))
 (let ((?x582 (g_vmid_lock ?x11)))
 (let ((?x581 (g_vmid_count ?x11)))
 (let ((?x580 (g_debug_exits ?x11)))
 (let ((?x579 (g_heap ?x11)))
 (let ((?x1047 (mkGLOBALS ?x579 ?x580 ?x581 ?x582 ?x583 ?x584 ?x585 ?x586 ?x587 ?x588 ?x589 ?x590 ?x591 ?x592 ?x593 ?x594 ?x595 ?x596 ?x597 ?x598 ?x599 (store (g_granules ?x11) i.95937 d.95937) ?x600 ?x601 ?x602 ?x603 ?x604 ?x605 ?x606 ?x607 ?x608)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x63 (gpt ?x9)))
 (let ((?x68 (priv st.0)))
 (let ((?x67 (repl st.0)))
 (let ((?x66 (oracle st.0)))
 (let ((?x65 (log st.0)))
 (let ((?x1050 (rtt_walk_abs.0_call (mkRData ?x65 ?x66 ?x67 ?x68 (mkShared ?x63 ?x36 ?x1047) ?x69 $x70) rtt_gidx.95937 ipa_gidx.95937)))
 (let ((?x1052 (rtt_walk_abs.0_call st.0 rtt_gidx.95937 ipa_gidx.95937)))
 (let ((?x120 (e_state_s_granule (select (g_granules ?x11) i.95937))))
 (let (($x121 (= ?x120 5)))
 (let (($x122 (not $x121)))
 (let (($x1057 (and $x122 (not (= ?x120 4)))))
 (=> $x1057 (= (+ ?x1052 (* (- 1) ?x1050)) 0))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1106 (forall ((rtt_gidx.106864 Int) (ipa_gidx.106864 Int) )(let ((?x9 (share st.0)))
 (let ((?x65 (log st.0)))
 (let ((?x238 (|(oracle st.0)_call| ?x65)))
 (let ((?x240 (|(repl st.0)_call| ?x238 ?x9)))
 (let ((?x242 (value_Shared ?x240)))
 (let ((?x306 (globals ?x242)))
 (let ((?x307 (g_granules ?x306)))
 (let (($x347 (not (= (e_state_s_granule (select ?x307 rtt_gidx.106864)) 5))))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.106864))))
 (let (($x70 (halt st.0)))
 (let ((?x69 (stack st.0)))
 (let ((?x68 (priv st.0)))
 (let ((?x67 (repl st.0)))
 (let ((?x66 (oracle st.0)))
 (let ((?x244 (List_Event_concat ?x238 ?x65)))
 (let ((?x279 (mkRData ?x244 ?x66 ?x67 ?x68 ?x242 ?x69 $x70)))
 (let ((?x339 (rtt_walk_abs.0_call ?x279 rtt_gidx.106864 ipa_gidx.106864)))
 (let ((?x272 (granule_data ?x242)))
 (let ((?x341 (g_granule_state (select ?x272 ?x339))))
 (let (($x343 (= ?x341 4)))
 (let (($x342 (= ?x341 6)))
 (or $x342 $x343 $x113 $x347)))))))))))))))))))))))
 ))
 (let (($x1104 (forall ((rtt_gidx.106828 Int) (ipa_gidx.106828 Int) )(let ((?x120 (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.106828))))
 (let (($x121 (= ?x120 5)))
 (let (($x122 (not $x121)))
 (let (($x113 (not (rtt_is_root.0_call rtt_gidx.106828))))
 (let ((?x114 (rtt_walk_abs.0_call st.0 rtt_gidx.106828 ipa_gidx.106828)))
 (let ((?x9 (share st.0)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x116 (g_granule_state (select ?x36 ?x114))))
 (let (($x118 (= ?x116 4)))
 (let (($x117 (= ?x116 6)))
 (or $x117 $x118 $x113 $x122))))))))))))
 ))
 (or (not $x1104) $x1106))))
(assert
 (forall ((rtt_gidx.96845 Int) (ipa_gidx.96845 Int) (i.96845 Int) (d.96845 r_granule_data) )(let (($x70 (halt st.0)))
 (let ((?x69 (stack st.0)))
 (let ((?x9 (share st.0)))
 (let ((?x11 (globals ?x9)))
 (let ((?x63 (gpt ?x9)))
 ...
 (let ((?x66 (oracle st.0)))
 (let ((?x65 (log st.0)))
 (let ((?x1126 (mkRData ?x65 ?x66 ?x67 ?x68 (mkShared ?x63 (store (granule_data ?x9) i.96845 d.96845) ?x11) ?x69 $x70)))
 (let ((?x1127 (rtt_walk_abs.0_call ?x1126 rtt_gidx.96845 ipa_gidx.96845)))
 (let ((?x1052 (rtt_walk_abs.0_call st.0 rtt_gidx.96845 ipa_gidx.96845)))
 (let (($x1130 (= (+ ?x1052 (* (- 1) ?x1127)) 0)))
 (let ((?x120 (e_state_s_granule (select (g_granules ?x11) i.96845))))
 (let (($x121 (= ?x120 5)))
 (let (($x122 (not $x121)))
 (let (($x1057 (and $x122 (not (= ?x120 4)))))
 (=> $x1057 $x1130)))))))))))))))))))
...
(assert
 (forall ((v_0.107275 Int) )(let ((?x9 (share st.0)))
 (let ((?x63 (gpt ?x9)))
 (select ?x63 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.107275))) 4096)))))
 )
(assert
 (let (($x1195 (forall ((rtt_gidx.202215 Int) (ipa_gidx.202215 Int) (data_gidx.202215 Int) )(let ((?x9 (share st.0)))
 (let ((?x36 (granule_data ?x9)))
 (let ((?x98 (g_granule_state (select ?x36 (rtt_walk_abs.0_call st.0 rtt_gidx.202215 ipa_gidx.202215)))))
 (let (($x102 (rtt_is_root.0_call rtt_gidx.202215)))
 (let (($x106 (= (e_state_s_granule (select (g_granules (globals ?x9)) rtt_gidx.202215)) 5)))
 (=> (and $x106 $x102) (or (= ?x98 4) (= ?x98 6)))))))))
 ))
 (not $x1195)))
(check-sat)

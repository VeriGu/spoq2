...
(declare-fun |(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.107793) (to_int (^ 2 524300))))))
...
(assert
 ...
 (and $x875 $x922)))))))))))
(assert
 (>= v_0.107793 551903297536))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x909 (+ (- 551903297536) v_0.107793)))
 (let ((?x876 (div ?x909 ?x941)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x930 (select ?x43 ?x876)))
 (let ((?x945 (e_lock ?x930)))
 (let ((?x898 (e_val ?x945)))
 (= ?x898 None_Z))))))))))))
(assert
 true)
(assert
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x930 (select ?x43 ?x876)))
 (let ((?x999 (e_state_s_granule ?x930)))
 (= ?x999 5)))))))))))
(assert
 (forall ((gidx.436880 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x909 (+ (- 551903297536) v_0.107793)))
 (let ((?x876 (div ?x909 ?x941)))
 (let ((?x1043 (* 16 ?x876)))
 (let ((?x1052 (mkPtr "granules" ?x1043)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x950 (rtt_walk_lock_unlock_spec.0_call ?x1022 ?x1052 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x1067 (value_RData ?x950)))
 (let ((?x10756 (share ?x1067)))
 (let ((?x948 (granule_data ?x10756)))
 (let (($x1075 (= (g_norm (select ?x948 gidx.436880)) zero_granule_data)))
 (let (($x1040 (= (e_state_s_granule (select (g_granules (globals ?x10756)) gidx.436880)) 1)))
 (=> $x1040 $x1075)))))))))))))))
 )
(assert
 (forall ((v_0.436915 Int) )(let ((?x889 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.436915))) 4096)))
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x909 (+ (- 551903297536) v_0.107793)))
 (let ((?x876 (div ?x909 ?x941)))
 ...
 (let ((?x1067 (value_RData ?x950)))
 (let ((?x10756 (share ?x1067)))
 (let ((?x1079 (gpt ?x10756)))
 (select ?x1079 ?x889))))))))))))))
 )
(assert
 (let (($x1135 (forall ((gidx.437051 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x909 (+ (- 551903297536) v_0.107793)))
 (let ((?x876 (div ?x909 ?x941)))
 (let ((?x1043 (* 16 ?x876)))
 ...
 (let ((?x10756 (share ?x1067)))
 (let ((?x993 (log ?x1067)))
 (let ((?x995 (|(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.107793) (to_int (^ 2 524300))))))
  (oracle (value_RData (rtt_walk_lock_unlock_spec.0_call
                         (mkPtr "stack_s_rtt_walk" 0)
                         (mkPtr "granules" a!1)
                         0
                         ...
                         v_2.0
                         st.0))))_call| ?x993)))
 (let ((?x1074 (|(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.107793) (to_int (^ 2 524300))))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       (mkPtr "stack_s_rtt_walk" 0)
                       (mkPtr "granules" a!1)
                       0
                       ...
                       v_1.0
                       v_2.0
                       st.0))))_call| ?x995 ?x10756)))
 (let ((?x1091 (value_Shared ?x1074)))
 (let ((?x1078 (granule_data ?x1091)))
 (let (($x1104 (= (g_norm (select ?x1078 gidx.437051)) zero_granule_data)))
 (let (($x1097 (= (e_state_s_granule (select (g_granules (globals ?x1091)) gidx.437051)) 1)))
 (or (not $x1097) $x1104)))))))))))))))))))
 ))
 (let (($x1072 (forall ((gidx.437040 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x909 (+ (- 551903297536) v_0.107793)))
 (let ((?x876 (div ?x909 ?x941)))
 (let ((?x1043 (* 16 ?x876)))
 ...
 (let ((?x10756 (share ?x1067)))
 (let ((?x948 (granule_data ?x10756)))
 (let (($x1075 (= (g_norm (select ?x948 gidx.437040)) zero_granule_data)))
 (let (($x1040 (= (e_state_s_granule (select (g_granules (globals ?x10756)) gidx.437040)) 1)))
 (or (not $x1040) $x1075)))))))))))))))
 ))
 (or (not $x1072) $x1135))))
(assert
...
(assert
 ...
 (not $x1294))))))))
(assert
 (let (($x1174 (forall ((gidx.437092 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.437092)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.437092)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x1174)))
(check-sat)

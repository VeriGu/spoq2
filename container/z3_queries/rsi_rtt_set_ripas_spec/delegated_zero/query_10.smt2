...
(declare-fun |(let ((a!1 (* 16
              (div (+ (- 551903297536) (land v_0.107793 (- 2)))
                   (to_int (^ 2 524300))))))
...
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x2265 (+ (- 551903297536) ?x1545)))
 (let ((?x11430 (div ?x2265 ?x941)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1558 (select ?x43 ?x11430)))
 (let ((?x1562 (e_lock ?x1558)))
 (let ((?x1588 (e_val ?x1562)))
 (= ?x1588 None_Z)))))))))))))
(assert
 true)
(assert
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1558 (select ?x43 ?x11430)))
 (let ((?x1559 (e_state_s_granule ?x1558)))
 (= ?x1559 3))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 ...
 (let ((?x11430 (div ?x2265 ?x941)))
 (let ((?x1539 (* 16 ?x11430)))
 (let ((?x1568 (mkPtr "granules" ?x1539)))
 (let ((?x1646 (|\|granule_addr_spec'.0\|_call| ?x1568)))
 (let ((?x1576 (value_Z ?x1646)))
 (let ((?x1589 (|\|buffer_map_spec'.0\|_call| 3 ?x1576 false)))
 (let ((?x1569 (value_Ptr ?x1589)))
 (let ((?x1647 (poffset ?x1569)))
 (let (($x1575 (>= ?x1647 0)))
 (let ((?x1566 (mod ?x1647 4096)))
 (let (($x1567 (= ?x1566 0)))
 (let ((?x1573 (pbase ?x1569)))
 (let (($x1572 (= ?x1573 "granule_data")))
 (and $x1572 $x1567 $x1575)))))))))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 ...
 (let ((?x1569 (value_Ptr ?x1589)))
 (let ((?x1647 (poffset ?x1569)))
 (let ((?x11529 (div ?x1647 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (granule_data ?x12)))
 (let ((?x1606 (select ?x19 ?x11529)))
 (let ((?x1607 (g_granule_state ?x1606)))
 (= ?x1607 3)))))))))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 ...
 (let ((?x19 (granule_data ?x12)))
 (let ((?x1606 (select ?x19 ?x11529)))
 (let ((?x1663 (g_rec ?x1606)))
 (let ((?x1624 (e_s1_ctx ?x1663)))
 (let ((?x1630 (e_g_ttbr1 ?x1624)))
 (let (($x1609 (not (<= 18446744007137558528 ?x1630))))
 (let (($x1608 (>= ?x1630 130000000)))
 (and $x1608 $x1609)))))))))))))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 ...
 (let ((?x1624 (e_s1_ctx ?x1663)))
 (let ((?x1630 (e_g_ttbr1 ?x1624)))
 (let ((?x1584 (+ (- 130000000) ?x1630)))
 (let ((?x12877 (div ?x1584 16)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1605 (select ?x43 ?x12877)))
 (let ((?x1644 (e_lock ?x1605)))
 (let ((?x1585 (e_val ?x1644)))
 (= ?x1585 None_Z))))))))))))))))))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1605 (select ?x43 ?x12877)))
 (let ((?x1204 (e_state_s_granule ?x1605)))
 (let ((?x1558 (select ?x43 ?x11430)))
 (let ((?x1597 (e_ref ?x1558)))
 (let ((?x1559 (e_state_s_granule ?x1558)))
 (let ((?x1613 (Some_Z CPU_ID.0)))
 (let ((?x1664 (mks_spinlock_t ?x1613)))
 (let ((?x10820 (mks_granule ?x1664 ?x1559 ?x1597)))
 (let ((?x1635 (store ?x43 ?x11430 ?x10820)))
 (let ((?x1583 (select ?x1635 ?x12877)))
 (let ((?x1619 (e_state_s_granule ?x1583)))
 (let ((?x1652 (+ ?x1619 (* (- 1) ?x1204))))
 (= ?x1652 0)))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
...
(assert
 ...
 (not $x10776))))))))))))))))))))))))))))
(assert
 (forall ((gidx.437814 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x2265 (+ (- 551903297536) ?x1545)))
 (let ((?x11430 (div ?x2265 ?x941)))
 ...
 (let ((?x1630 (e_g_ttbr1 ?x1624)))
 (let ((?x1584 (+ (- 130000000) ?x1630)))
 (let ((?x2679 (mkPtr "granules" ?x1584)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1598 (rtt_walk_lock_unlock_spec.0_call ?x1022 ?x2679 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x2684 (value_RData ?x1598)))
 (let ((?x14001 (share ?x2684)))
 (let ((?x1618 (granule_data ?x14001)))
 (let (($x1725 (= (g_norm (select ?x1618 gidx.437814)) zero_granule_data)))
 (let (($x1657 (= (e_state_s_granule (select (g_granules (globals ?x14001)) gidx.437814)) 1)))
 (=> $x1657 $x1725))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.437849 Int) )(let ((?x889 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.437849))) 4096)))
 (let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x2265 (+ (- 551903297536) ?x1545)))
 ...
 (let ((?x2684 (value_RData ?x1598)))
 (let ((?x14001 (share ?x2684)))
 (let ((?x1679 (gpt ?x14001)))
 (select ?x1679 ?x889)))))))))))))))))))))))))))))
 )
(assert
 (let (($x12139 (forall ((gidx.437985 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x2265 (+ (- 551903297536) ?x1545)))
 (let ((?x11430 (div ?x2265 ?x941)))
...
(let ((a!4 (+ (- 130000000) (e_g_ttbr1 (e_s1_ctx (g_rec a!3))))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       ...
                       v_1.0
                       v_2.0
                       st.0)))))))_call| ?x10713 ?x14001)))
 (let ((?x1709 (value_Shared ?x1727)))
 (let ((?x1712 (granule_data ?x1709)))
 (let (($x1698 (= (g_norm (select ?x1712 gidx.437985)) zero_granule_data)))
 (let (($x1718 (= (e_state_s_granule (select (g_granules (globals ?x1709)) gidx.437985)) 1)))
 (or (not $x1718) $x1698))))))))))))))))))))))))))))))))))
 ))
 (let (($x1478 (forall ((gidx.437974 Int) )(let ((?x877 (^ 2 524300)))
 (let ((?x941 (to_int ?x877)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x2265 (+ (- 551903297536) ?x1545)))
 (let ((?x11430 (div ?x2265 ?x941)))
 ...
 (let ((?x14001 (share ?x2684)))
 (let ((?x1618 (granule_data ?x14001)))
 (let (($x1725 (= (g_norm (select ?x1618 gidx.437974)) zero_granule_data)))
 (let (($x1657 (= (e_state_s_granule (select (g_granules (globals ?x14001)) gidx.437974)) 1)))
 (or (not $x1657) $x1725))))))))))))))))))))))))))))))
 ))
 (or (not $x1478) $x12139))))
(assert
...
(assert
 ...
 (not $x1294))))))))
(assert
 (let (($x1540 (forall ((gidx.438026 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.438026)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.438026)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x1540)))
(check-sat)

...
(assert
 ...
 (= ?x2001 5)))))))))))))))))))))))))
(assert
 (let (($x2005 (forall ((gidx.438101 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.438101)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.438101)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x2005)))
(check-sat)

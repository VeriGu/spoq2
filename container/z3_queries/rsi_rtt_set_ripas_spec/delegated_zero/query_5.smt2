...
(declare-fun |(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.107793) 4096)))))
...
(assert
 ...
 (= ?x920 0)))
(assert
 (let ((?x918 (land v_0.107793 4095)))
 (let (($x922 (= ?x918 0)))
 (let (($x905 (not (<= 556198264832 v_0.107793))))
 (let (($x919 (>= v_0.107793 551903297536)))
 (let (($x886 (and $x919 $x905)))
 (let (($x873 (not (<= 4294967296 v_0.107793))))
 (let (($x887 (>= v_0.107793 2147483648)))
 (let (($x888 (and $x887 $x873)))
 (let (($x875 (or $x888 $x886)))
 (and $x875 $x922)))))))))))
(assert
 (let (($x919 (>= v_0.107793 551903297536)))
 (not $x919)))
(assert
 (let ((?x973 (+ (- 2147483648) v_0.107793)))
 (let ((?x1311 (div ?x973 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x11095 (select ?x43 ?x1311)))
 (let ((?x997 (e_lock ?x11095)))
 (let ((?x927 (e_val ?x997)))
 (= ?x927 None_Z))))))))))
(assert
 true)
(assert
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x11095 (select ?x43 ?x1311)))
 (let ((?x1309 (e_state_s_granule ?x11095)))
 (= ?x1309 5)))))))))
(assert
 (forall ((gidx.437204 Int) )(let ((?x973 (+ (- 2147483648) v_0.107793)))
 (let ((?x1311 (div ?x973 4096)))
 (let ((?x1299 (* 16 ?x1311)))
 (let ((?x1269 (mkPtr "granules" ?x1299)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1156 (rtt_walk_lock_unlock_spec.0_call ?x1022 ?x1269 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x1307 (value_RData ?x1156)))
 (let ((?x11029 (share ?x1307)))
 (let ((?x1231 (granule_data ?x11029)))
 (let (($x1324 (= (g_norm (select ?x1231 gidx.437204)) zero_granule_data)))
 (let (($x1328 (= (e_state_s_granule (select (g_granules (globals ?x11029)) gidx.437204)) 1)))
 (=> $x1328 $x1324)))))))))))))
 )
(assert
 (forall ((v_0.437239 Int) )(let ((?x889 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.437239))) 4096)))
 (let ((?x973 (+ (- 2147483648) v_0.107793)))
 (let ((?x1311 (div ?x973 4096)))
 (let ((?x1299 (* 16 ?x1311)))
 (let ((?x1269 (mkPtr "granules" ?x1299)))
 ...
 (let ((?x1307 (value_RData ?x1156)))
 (let ((?x11029 (share ?x1307)))
 (let ((?x1341 (gpt ?x11029)))
 (select ?x1341 ?x889))))))))))))
 )
(assert
 (let (($x1394 (forall ((gidx.437375 Int) )(let ((?x973 (+ (- 2147483648) v_0.107793)))
 (let ((?x1311 (div ?x973 4096)))
 (let ((?x1299 (* 16 ?x1311)))
 (let ((?x1269 (mkPtr "granules" ?x1299)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 ...
 (let ((?x11029 (share ?x1307)))
 (let ((?x1351 (log ?x1307)))
 (let ((?x1353 (|(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.107793) 4096)))))
  (oracle (value_RData (rtt_walk_lock_unlock_spec.0_call
                         (mkPtr "stack_s_rtt_walk" 0)
                         a!1
                         0
                         ...
                         v_2.0
                         st.0))))_call| ?x1351)))
 (let ((?x1355 (|(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.107793) 4096)))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       (mkPtr "stack_s_rtt_walk" 0)
                       a!1
                       0
                       ...
                       v_1.0
                       v_2.0
                       st.0))))_call| ?x1353 ?x11029)))
 (let ((?x893 (value_Shared ?x1355)))
 (let ((?x1375 (granule_data ?x893)))
 (let (($x1383 (= (g_norm (select ?x1375 gidx.437375)) zero_granule_data)))
 (let (($x1386 (= (e_state_s_granule (select (g_granules (globals ?x893)) gidx.437375)) 1)))
 (or (not $x1386) $x1383)))))))))))))))))
 ))
 (let (($x1391 (forall ((gidx.437364 Int) )(let ((?x973 (+ (- 2147483648) v_0.107793)))
 (let ((?x1311 (div ?x973 4096)))
 (let ((?x1299 (* 16 ?x1311)))
 (let ((?x1269 (mkPtr "granules" ?x1299)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 ...
 (let ((?x11029 (share ?x1307)))
 (let ((?x1231 (granule_data ?x11029)))
 (let (($x1324 (= (g_norm (select ?x1231 gidx.437364)) zero_granule_data)))
 (let (($x1328 (= (e_state_s_granule (select (g_granules (globals ?x11029)) gidx.437364)) 1)))
 (or (not $x1328) $x1324)))))))))))))
 ))
 (or (not $x1391) $x1394))))
(assert
...
(assert
 ...
 (not $x1294))))))))
(assert
 (let (($x10460 (forall ((gidx.437416 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.437416)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.437416)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x10460)))
(check-sat)

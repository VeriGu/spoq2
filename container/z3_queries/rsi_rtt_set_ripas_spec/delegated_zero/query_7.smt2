...
(assert
 ...
 (= ?x1204 5)))))))))))))))))))))))))))
(assert
 (let (($x1622 (forall ((gidx.437491 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.437491)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.437491)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x1622)))
(check-sat)

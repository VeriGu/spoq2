...
(assert
 ...
 (not $x1194)))))))))))))
(assert
 (let (($x1940 (forall ((gidx.438064 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.438064)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.438064)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x1940)))
(check-sat)

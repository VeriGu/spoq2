...
(assert
 ...
 (not $x10776))))))))))))))))))))))))))))
(assert
 (let (($x1793 (forall ((gidx.437777 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.437777)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.437777)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x1793)))
(check-sat)

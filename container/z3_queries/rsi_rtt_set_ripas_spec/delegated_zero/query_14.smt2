...
(assert
 ...
 (not $x2030))))))))))))))))))))))))))
(assert
 (let (($x2224 (forall ((gidx.438387 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.438387)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.438387)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x2224)))
(check-sat)

...
(declare-fun |(let ((a!1 (* 16 (div (+ (- 2147483648) (land v_0.107793 (- 2))) 4096))))
...
(assert
 (let (($x915 (forall ((gidx.107382 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 ...
 (let (($x912 (forall ((gidx.107371 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.107371)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.107371)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x912) $x915))))
(assert
 (forall ((v_0.107793 Int) )(let ((?x889 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.107793))) 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x91 (gpt ?x12)))
 (select ?x91 ?x889)))))
 )
(assert
 ...
 (not $x864))))
(assert
 (let ((?x920 (land v_0.107793 1)))
 (let (($x1126 (= ?x920 0)))
 (not $x1126))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1546 (land ?x1545 4095)))
 (let (($x1537 (= ?x1546 0)))
 (let (($x1479 (not (<= 556198264832 ?x1545))))
 (let (($x933 (>= ?x1545 551903297536)))
 (let (($x1544 (and $x933 $x1479)))
 (let (($x1487 (not (<= 4294967296 ?x1545))))
 (let (($x1508 (>= ?x1545 2147483648)))
 (let (($x10556 (and $x1508 $x1487)))
 (let (($x1552 (or $x10556 $x1544)))
 (and $x1552 $x1537))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let (($x933 (>= ?x1545 551903297536)))
...
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x10072 (select ?x43 ?x1874)))
 (let ((?x1560 (e_lock ?x10072)))
 (let ((?x1591 (e_val ?x1560)))
 (= ?x1591 None_Z)))))))))))
(assert
 true)
(assert
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x10072 (select ?x43 ?x1874)))
 (let ((?x11172 (e_state_s_granule ?x10072)))
 (= ?x11172 3))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x1997 (* 16 ?x1874)))
 (let ((?x1938 (mkPtr "granules" ?x1997)))
 (let ((?x1861 (|\|granule_addr_spec'.0\|_call| ?x1938)))
 (let ((?x1509 (value_Z ?x1861)))
 (let ((?x1981 (|\|buffer_map_spec'.0\|_call| 3 ?x1509 false)))
 (let ((?x1972 (value_Ptr ?x1981)))
 (let ((?x2003 (poffset ?x1972)))
 (let (($x1683 (>= ?x2003 0)))
 (let ((?x1960 (mod ?x2003 4096)))
 (let (($x1990 (= ?x1960 0)))
 (let ((?x1956 (pbase ?x1972)))
 (let (($x1935 (= ?x1956 "granule_data")))
 (and $x1935 $x1990 $x1683)))))))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 ...
 (let ((?x1972 (value_Ptr ?x1981)))
 (let ((?x2003 (poffset ?x1972)))
 (let ((?x11999 (div ?x2003 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (granule_data ?x12)))
 (let ((?x1968 (select ?x19 ?x11999)))
 (let ((?x1856 (g_granule_state ?x1968)))
 (= ?x1856 3)))))))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 ...
 (let ((?x19 (granule_data ?x12)))
 (let ((?x1968 (select ?x19 ?x11999)))
 (let ((?x11756 (g_rec ?x1968)))
 (let ((?x1832 (e_s1_ctx ?x11756)))
 (let ((?x1795 (e_g_ttbr1 ?x1832)))
 (let (($x1926 (not (<= 18446744007137558528 ?x1795))))
 (let (($x1742 (>= ?x1795 130000000)))
 (and $x1742 $x1926)))))))))))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 ...
 (let ((?x1832 (e_s1_ctx ?x11756)))
 (let ((?x1795 (e_g_ttbr1 ?x1832)))
 (let ((?x1866 (+ (- 130000000) ?x1795)))
 (let ((?x13340 (div ?x1866 16)))
 (let ((?x41 (globals ?x12)))
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1995 (select ?x43 ?x13340)))
 (let ((?x1975 (e_lock ?x1995)))
 (let ((?x11071 (e_val ?x1975)))
 (= ?x11071 None_Z))))))))))))))))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 ...
 (let ((?x43 (g_granules ?x41)))
 (let ((?x1995 (select ?x43 ?x13340)))
 (let ((?x2001 (e_state_s_granule ?x1995)))
 (let ((?x10072 (select ?x43 ?x1874)))
 (let ((?x20017 (e_ref ?x10072)))
 (let ((?x11172 (e_state_s_granule ?x10072)))
 (let ((?x1613 (Some_Z CPU_ID.0)))
 (let ((?x1664 (mks_spinlock_t ?x1613)))
 (let ((?x12377 (mks_granule ?x1664 ?x11172 ?x20017)))
 (let ((?x1964 (store ?x43 ?x1874 ?x12377)))
 (let ((?x1976 (select ?x1964 ?x13340)))
 (let ((?x2000 (e_state_s_granule ?x1976)))
 (let ((?x1908 (+ ?x2000 (* (- 1) ?x2001))))
 (= ?x1908 0)))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
...
(assert
 ...
 (not $x2030))))))))))))))))))))))))))
(assert
 (forall ((gidx.438424 Int) )(let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x1997 (* 16 ?x1874)))
 (let ((?x1938 (mkPtr "granules" ?x1997)))
 ...
 (let ((?x1795 (e_g_ttbr1 ?x1832)))
 (let ((?x1866 (+ (- 130000000) ?x1795)))
 (let ((?x2031 (mkPtr "granules" ?x1866)))
 (let ((?x1022 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x2024 (rtt_walk_lock_unlock_spec.0_call ?x1022 ?x2031 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x11051 (value_RData ?x2024)))
 (let ((?x14464 (share ?x11051)))
 (let ((?x2034 (granule_data ?x14464)))
 (let (($x1850 (= (g_norm (select ?x2034 gidx.438424)) zero_granule_data)))
 (let (($x1580 (= (e_state_s_granule (select (g_granules (globals ?x14464)) gidx.438424)) 1)))
 (=> $x1580 $x1850))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.438459 Int) )(let ((?x889 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.438459))) 4096)))
 (let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x1997 (* 16 ?x1874)))
 ...
 (let ((?x11051 (value_RData ?x2024)))
 (let ((?x14464 (share ?x11051)))
 (let ((?x2046 (gpt ?x14464)))
 (select ?x2046 ?x889)))))))))))))))))))))))))))
 )
(assert
 (let (($x2185 (forall ((gidx.438595 Int) )(let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x1997 (* 16 ?x1874)))
 (let ((?x1938 (mkPtr "granules" ?x1997)))
 ...
 (let ((?x11051 (value_RData ?x2024)))
 (let ((?x14464 (share ?x11051)))
 (let ((?x10138 (log ?x11051)))
 (let ((?x11280 (|(let ((a!1 (* 16 (div (+ (- 2147483648) (land v_0.107793 (- 2))) 4096))))
(let ((a!2 (\|\\\|buffer_map_spec'.0\\\|_call\|
             3
             (value_Z (\|\\\|granule_addr_spec'.0\\\|_call\| (mkPtr "granules" a!1)))
             false)))
...
(let ((a!4 (+ (- 130000000) (e_g_ttbr1 (e_s1_ctx (g_rec a!3))))))
  (oracle (value_RData (rtt_walk_lock_unlock_spec.0_call
                         ...
                         v_2.0
                         st.0)))))))_call| ?x10138)))
 (let ((?x2036 (|(let ((a!1 (* 16 (div (+ (- 2147483648) (land v_0.107793 (- 2))) 4096))))
(let ((a!2 (\|\\\|buffer_map_spec'.0\\\|_call\|
             3
             (value_Z (\|\\\|granule_addr_spec'.0\\\|_call\| (mkPtr "granules" a!1)))
             false)))
...
(let ((a!4 (+ (- 130000000) (e_g_ttbr1 (e_s1_ctx (g_rec a!3))))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       ...
                       v_1.0
                       v_2.0
                       st.0)))))))_call| ?x11280 ?x14464)))
 (let ((?x2039 (value_Shared ?x2036)))
 (let ((?x2113 (granule_data ?x2039)))
 (let (($x2143 (= (g_norm (select ?x2113 gidx.438595)) zero_granule_data)))
 (let (($x2084 (= (e_state_s_granule (select (g_granules (globals ?x2039)) gidx.438595)) 1)))
 (or (not $x2084) $x2143))))))))))))))))))))))))))))))))
 ))
 (let (($x2072 (forall ((gidx.438584 Int) )(let ((?x1545 (land v_0.107793 (- 2))))
 (let ((?x1548 (+ (- 2147483648) ?x1545)))
 (let ((?x1874 (div ?x1548 4096)))
 (let ((?x1997 (* 16 ?x1874)))
 (let ((?x1938 (mkPtr "granules" ?x1997)))
 ...
 (let ((?x14464 (share ?x11051)))
 (let ((?x2034 (granule_data ?x14464)))
 (let (($x1850 (= (g_norm (select ?x2034 gidx.438584)) zero_granule_data)))
 (let (($x1580 (= (e_state_s_granule (select (g_granules (globals ?x14464)) gidx.438584)) 1)))
 (or (not $x1580) $x1850))))))))))))))))))))))))))))
 ))
 (or (not $x2072) $x2185))))
(assert
...
(assert
 (let ((?x27 (stack st.0)))
 (let ((?x1159 (stack_s_rtt_walk ?x27)))
 (let ((?x1161 (e_g_llt ?x1159)))
 (>= ?x1161 130000000)))))
(assert
...
(assert
 ...
 (let ((?x27 (stack st.0)))
 (let ((?x1159 (stack_s_rtt_walk ?x27)))
 (let ((?x1293 (e_last_level ?x1159)))
 (let ((?x1292 (+ ?x1293 ?x674)))
 (let (($x1294 (= ?x1292 0)))
 (not $x1294))))))))
(assert
 (let (($x2316 (forall ((gidx.438636 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.438636)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.438636)) 1)))
 (=> $x62 $x59))))
 ))
 (not $x2316)))
(check-sat)

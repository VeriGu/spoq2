...
(declare-fun |(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.110041) 4096)))))
...
(assert
 ...
 (= ?x898 0)))
(assert
 (let ((?x921 (land v_0.110041 4095)))
 (let (($x1002 (= ?x921 0)))
 (let (($x1043 (not (<= 556198264832 v_0.110041))))
 (let (($x815 (>= v_0.110041 551903297536)))
 (let (($x885 (and $x815 $x1043)))
 (let (($x938 (not (<= 4294967296 v_0.110041))))
 (let (($x937 (>= v_0.110041 2147483648)))
 (let (($x858 (and $x937 $x938)))
 (let (($x911 (or $x858 $x885)))
 (and $x911 $x1002)))))))))))
(assert
 (let (($x815 (>= v_0.110041 551903297536)))
 (not $x815)))
(assert
 (let ((?x896 (+ (- 2147483648) v_0.110041)))
 (let ((?x1321 (div ?x896 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x9176 (select ?x21 ?x1321)))
 (let ((?x989 (e_lock ?x9176)))
 (let ((?x933 (e_val ?x989)))
 (= ?x933 None_Z))))))))))
(assert
 true)
(assert
 ...
 (let ((?x21 (g_granules ?x19)))
 (let ((?x9176 (select ?x21 ?x1321)))
 (let ((?x1324 (e_state_s_granule ?x9176)))
 (= ?x1324 5)))))))))
(assert
 (forall ((gidx.439630 Int) )(let ((?x896 (+ (- 2147483648) v_0.110041)))
 (let ((?x1321 (div ?x896 4096)))
 (let ((?x1299 (* 16 ?x1321)))
 (let ((?x1319 (mkPtr "granules" ?x1299)))
 (let ((?x988 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1323 (rtt_walk_lock_unlock_spec.0_call ?x988 ?x1319 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x1318 (value_RData ?x1323)))
 (let ((?x9248 (share ?x1318)))
 (let ((?x1340 (globals ?x9248)))
 (let ((?x1342 (g_granules ?x1340)))
 (let ((?x1338 (e_state_s_granule (select ?x1342 gidx.439630))))
 (let (($x1343 (= ?x1338 6)))
 (let (($x1327 (= ?x1338 0)))
 (=> (not (select (gpt ?x9248) gidx.439630)) (or $x1327 $x1343))))))))))))))))
 )
(assert
 (forall ((v_0.439665 Int) )(let ((?x855 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.439665))) 4096)))
 (let ((?x896 (+ (- 2147483648) v_0.110041)))
 (let ((?x1321 (div ?x896 4096)))
 (let ((?x1299 (* 16 ?x1321)))
 (let ((?x1319 (mkPtr "granules" ?x1299)))
...
(assert
 (let (($x1406 (forall ((gidx.439853 Int) )(let ((?x896 (+ (- 2147483648) v_0.110041)))
 (let ((?x1321 (div ?x896 4096)))
 (let ((?x1299 (* 16 ?x1321)))
 (let ((?x1319 (mkPtr "granules" ?x1299)))
 (let ((?x988 (mkPtr "stack_s_rtt_walk" 0)))
 ...
 (let ((?x9248 (share ?x1318)))
 (let ((?x1361 (log ?x1318)))
 (let ((?x1362 (|(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.110041) 4096)))))
  (oracle (value_RData (rtt_walk_lock_unlock_spec.0_call
                         (mkPtr "stack_s_rtt_walk" 0)
                         a!1
                         0
                         ...
                         v_2.0
                         st.0))))_call| ?x1361)))
 (let ((?x1364 (|(let ((a!1 (mkPtr "granules" (* 16 (div (+ (- 2147483648) v_0.110041) 4096)))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       (mkPtr "stack_s_rtt_walk" 0)
                       a!1
                       0
                       ...
                       v_1.0
                       v_2.0
                       st.0))))_call| ?x1362 ?x9248)))
 (let ((?x1365 (value_Shared ?x1364)))
 (let ((?x1383 (gpt ?x1365)))
 (let (($x1399 (select ?x1383 gidx.439853)))
 (let ((?x1395 (e_state_s_granule (select (g_granules (globals ?x1365)) gidx.439853))))
 (let (($x1397 (= ?x1395 0)))
 (let (($x1396 (= ?x1395 6)))
 (or $x1396 $x1397 $x1399)))))))))))))))))))
 ))
 (let (($x1404 (forall ((gidx.439836 Int) )(let ((?x896 (+ (- 2147483648) v_0.110041)))
 (let ((?x1321 (div ?x896 4096)))
 (let ((?x1299 (* 16 ?x1321)))
 (let ((?x1319 (mkPtr "granules" ?x1299)))
 (let ((?x988 (mkPtr "stack_s_rtt_walk" 0)))
 ...
 (let ((?x9248 (share ?x1318)))
 (let ((?x1297 (gpt ?x9248)))
 (let (($x1351 (select ?x1297 gidx.439836)))
 (let ((?x1338 (e_state_s_granule (select (g_granules (globals ?x9248)) gidx.439836))))
 (let (($x1343 (= ?x1338 6)))
 (let (($x1327 (= ?x1338 0)))
 (or $x1327 $x1343 $x1351)))))))))))))))
 ))
 (or (not $x1404) $x1406))))
(assert
 true)
...
(assert
 ...
 (not $x1251))))))))
(assert
 (let (($x1436 (forall ((gidx.439912 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.439912)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.439912)) (or $x62 $x61))))))))))
 ))
 (not $x1436)))
(check-sat)

...
(assert
 ...
 (or (not $x3725) $x880))))
(assert
 (forall ((v_0.110041 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (select ?x48 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.110041))) 4096)))))
 )
(assert
 (let (($x888 (<= v_3.0 1)))
 (let (($x894 (not $x888)))
...
(assert
 ...
 (= ?x939 5)))))))))))
(assert
 (let (($x1041 (forall ((gidx.439127 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.439127)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.439127)) (or $x62 $x61))))))))))
 ))
 (not $x1041)))
(check-sat)

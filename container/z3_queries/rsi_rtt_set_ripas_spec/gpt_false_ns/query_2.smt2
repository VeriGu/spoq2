...
(declare-fun |(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.110041) (to_int (^ 2 524300))))))
...
(assert
 ...
 (and $x911 $x1002)))))))))))
(assert
 (>= v_0.110041 551903297536))
(assert
 (let ((?x913 (^ 2 524300)))
 (let ((?x942 (to_int ?x913)))
 (let ((?x876 (+ (- 551903297536) v_0.110041)))
 (let ((?x1040 (div ?x876 ?x942)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x930 (select ?x21 ?x1040)))
 (let ((?x949 (e_lock ?x930)))
 (let ((?x1035 (e_val ?x949)))
 (= ?x1035 None_Z))))))))))))
(assert
 true)
(assert
 ...
 (let ((?x21 (g_granules ?x19)))
 (let ((?x930 (select ?x21 ?x1040)))
 (let ((?x939 (e_state_s_granule ?x930)))
 (= ?x939 5)))))))))))
(assert
 (forall ((gidx.439182 Int) )(let ((?x913 (^ 2 524300)))
 (let ((?x942 (to_int ?x913)))
 (let ((?x876 (+ (- 551903297536) v_0.110041)))
 (let ((?x1040 (div ?x876 ?x942)))
 (let ((?x926 (* 16 ?x1040)))
 (let ((?x943 (mkPtr "granules" ?x926)))
 (let ((?x988 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x1034 (rtt_walk_lock_unlock_spec.0_call ?x988 ?x943 0 64 v_1.0 v_2.0 st.0)))
 (let ((?x1057 (value_RData ?x1034)))
 (let ((?x8835 (share ?x1057)))
 (let ((?x1090 (globals ?x8835)))
 (let ((?x1071 (g_granules ?x1090)))
 (let ((?x1017 (e_state_s_granule (select ?x1071 gidx.439182))))
 (let (($x1065 (= ?x1017 6)))
 (let (($x991 (= ?x1017 0)))
 (=> (not (select (gpt ?x8835) gidx.439182)) (or $x991 $x1065))))))))))))))))))
 )
(assert
 (forall ((v_0.439217 Int) )(let ((?x855 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.439217))) 4096)))
 (let ((?x913 (^ 2 524300)))
 (let ((?x942 (to_int ?x913)))
 (let ((?x876 (+ (- 551903297536) v_0.110041)))
 (let ((?x1040 (div ?x876 ?x942)))
...
(assert
 (let (($x1104 (forall ((gidx.439405 Int) )(let ((?x913 (^ 2 524300)))
 (let ((?x942 (to_int ?x913)))
 (let ((?x876 (+ (- 551903297536) v_0.110041)))
 (let ((?x1040 (div ?x876 ?x942)))
 (let ((?x926 (* 16 ?x1040)))
 ...
 (let ((?x8835 (share ?x1057)))
 (let ((?x1085 (log ?x1057)))
 (let ((?x1082 (|(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.110041) (to_int (^ 2 524300))))))
  (oracle (value_RData (rtt_walk_lock_unlock_spec.0_call
                         (mkPtr "stack_s_rtt_walk" 0)
                         (mkPtr "granules" a!1)
                         0
                         ...
                         v_2.0
                         st.0))))_call| ?x1085)))
 (let ((?x1099 (|(let ((a!1 (* 16 (div (+ (- 551903297536) v_0.110041) (to_int (^ 2 524300))))))
  (repl (value_RData (rtt_walk_lock_unlock_spec.0_call
                       (mkPtr "stack_s_rtt_walk" 0)
                       (mkPtr "granules" a!1)
                       0
                       ...
                       v_1.0
                       v_2.0
                       st.0))))_call| ?x1082 ?x8835)))
 (let ((?x1100 (value_Shared ?x1099)))
 (let ((?x1120 (gpt ?x1100)))
 (let (($x1124 (select ?x1120 gidx.439405)))
 (let ((?x1131 (e_state_s_granule (select (g_granules (globals ?x1100)) gidx.439405))))
 (let (($x1115 (= ?x1131 6)))
 (let (($x1061 (= ?x1131 0)))
 (or $x1061 $x1115 $x1124)))))))))))))))))))))
 ))
 (let (($x1121 (forall ((gidx.439388 Int) )(let ((?x913 (^ 2 524300)))
 (let ((?x942 (to_int ?x913)))
 (let ((?x876 (+ (- 551903297536) v_0.110041)))
 (let ((?x1040 (div ?x876 ?x942)))
 (let ((?x926 (* 16 ?x1040)))
 ...
 (let ((?x1090 (globals ?x8835)))
 (let ((?x1071 (g_granules ?x1090)))
 (let ((?x1017 (e_state_s_granule (select ?x1071 gidx.439388))))
 (let (($x1065 (= ?x1017 6)))
 (let ((?x1055 (gpt ?x8835)))
 (let (($x1006 (select ?x1055 gidx.439388)))
 (let (($x991 (= ?x1017 0)))
 (or $x991 $x1006 $x1065)))))))))))))))))))
 ))
 (or (not $x1121) $x1104))))
...
(assert
 ...
 (not $x1251))))))))
(assert
 (let (($x1261 (forall ((gidx.439464 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.439464)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.439464)) (or $x62 $x61))))))))))
 ))
 (not $x1261)))
(check-sat)

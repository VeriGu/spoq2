...
(assert
 ...
 (and $x22350 $x7312))))))))))))))))))))))
(assert
 (let (($x15002 (forall ((rtt_gidx.38677217 Int) (ipa_gidx.38677217 Int) (data_gidx.38677217 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x38847 (test_PA.0_call v_0.38675966)))
 (let ((?x19921 (meta_granule_offset ?x38847)))
 (let ((?x15463 (mkPtr "granules" ?x19921)))
 ...
 (let ((?x38585 (share ?x37317)))
 (let ((?x20969 (granule_data ?x38585)))
 (let ((?x45309 (g_granule_state (select ?x20969 (rtt_walk_abs.0_call ?x37317 rtt_gidx.38677217 ipa_gidx.38677217)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38677217)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x38585)) rtt_gidx.38677217)) 5) $x142) (or (= ?x45309 4) (= ?x45309 6)))))))))))))))))
 ))
 (not $x15002)))
(check-sat)

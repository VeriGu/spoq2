...
(assert
 ...
 (let ((?x52442 (meta_desc_type ?x54055)))
 (let (($x32552 (= ?x52442 0)))
 (and $x32552 $x27189 $x31078)))))))))))))))))))))))))
(assert
 (let (($x27888 (forall ((rtt_gidx.38677637 Int) (ipa_gidx.38677637 Int) (data_gidx.38677637 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x38847 (test_PA.0_call v_0.38675966)))
 (let ((?x19921 (meta_granule_offset ?x38847)))
 (let ((?x15463 (mkPtr "granules" ?x19921)))
 ...
 (let ((?x38585 (share ?x37317)))
 (let ((?x20969 (granule_data ?x38585)))
 (let ((?x45309 (g_granule_state (select ?x20969 (rtt_walk_abs.0_call ?x37317 rtt_gidx.38677637 ipa_gidx.38677637)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38677637)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x38585)) rtt_gidx.38677637)) 5) $x142) (or (= ?x45309 4) (= ?x45309 6)))))))))))))))))
 ))
 (not $x27888)))
(check-sat)

...
(assert
 ...
 (not $x38762)))))))))))))
(assert
 (let (($x21698 (forall ((rtt_gidx.38677847 Int) (ipa_gidx.38677847 Int) (data_gidx.38677847 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x39981 (share ?x39775)))
 (let ((?x9035 (granule_data ?x39981)))
 (let ((?x39361 (g_granule_state (select ?x9035 (rtt_walk_abs.0_call ?x39775 rtt_gidx.38677847 ipa_gidx.38677847)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38677847)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x39981)) rtt_gidx.38677847)) 5) $x142) (or (= ?x39361 4) (= ?x39361 6))))))))))
 ))
 (not $x21698)))
(check-sat)

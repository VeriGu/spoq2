...
(assert
 ...
 (let ((?x25995 (oracle ?x70854)))
 (let ((?x25997 (log ?x70854)))
 (let ((?x7318 (mkRData ?x25997 ?x25995 ?x26775 ?x26787 (mkShared ?x35568 (store (granule_data ?x31444) i.38679094 d.38679094) ?x26791) ?x26088 $x26681)))
 (let ((?x5609 (rtt_walk_abs.0_call ?x7318 rtt_gidx.38679094 ipa_gidx.38679094)))
...
(assert
 ...
 (= ?x6907 5)))))))))))))))))
(assert
 (let (($x34795 (forall ((rtt_gidx.38679270 Int) (ipa_gidx.38679270 Int) (data_gidx.38679270 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x31424 (query_oracle.0_call ?x39775)))
 (let ((?x70854 (value_RData ?x31424)))
 (let ((?x31444 (share ?x70854)))
 (let ((?x18766 (granule_data ?x31444)))
 (let ((?x17188 (g_granule_state (select ?x18766 (rtt_walk_abs.0_call ?x70854 rtt_gidx.38679270 ipa_gidx.38679270)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38679270)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x31444)) rtt_gidx.38679270)) 5) $x142) (or (= ?x17188 4) (= ?x17188 6))))))))))))
 ))
 (not $x34795)))
(check-sat)

...
(assert
 ...
 (not $x27214))))))))))))))))))
(assert
 (let (($x1810 (forall ((rtt_gidx.38683868 Int) (ipa_gidx.38683868 Int) (data_gidx.38683868 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x31424 (query_oracle.0_call ?x39775)))
 (let ((?x70854 (value_RData ?x31424)))
 (let ((?x31444 (share ?x70854)))
 (let ((?x18766 (granule_data ?x31444)))
 (let ((?x17188 (g_granule_state (select ?x18766 (rtt_walk_abs.0_call ?x70854 rtt_gidx.38683868 ipa_gidx.38683868)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38683868)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x31444)) rtt_gidx.38683868)) 5) $x142) (or (= ?x17188 4) (= ?x17188 6))))))))))))
 ))
 (not $x1810)))
(check-sat)

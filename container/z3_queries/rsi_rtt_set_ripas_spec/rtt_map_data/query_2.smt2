...
(assert
 ...
 (and $x31235 $x19862)))))))
(assert
 (let (($x37858 (forall ((rtt_gidx.38676539 Int) (ipa_gidx.38676539 Int) (data_gidx.38676539 Int) )(let ((?x2781 (query_oracle.0_call st.0)))
 (let ((?x39775 (value_RData ?x2781)))
 (let ((?x39981 (share ?x39775)))
 (let ((?x9035 (granule_data ?x39981)))
 (let ((?x39361 (g_granule_state (select ?x9035 (rtt_walk_abs.0_call ?x39775 rtt_gidx.38676539 ipa_gidx.38676539)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.38676539)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x39981)) rtt_gidx.38676539)) 5) $x142) (or (= ?x39361 4) (= ?x39361 6))))))))))
 ))
 (not $x37858)))
(check-sat)

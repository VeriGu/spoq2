...
(let ((a!2 (value_Tuple_Z_RData
  ...
  (repl (value_RData (query_oracle.0_call (elem_1 a!2))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (oracle (value_RData (query_oracle.0_call (elem_1 a!2))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (and $x1592 $x1684))))))))))))))))))))
(assert
 (forall ((gidx.752346 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x1433 (value_RData ?x1435)))
 (let ((?x41312 (share ?x1433)))
 (let ((?x1494 (granule_data ?x41312)))
 (let (($x1543 (= (g_norm (select ?x1494 gidx.752346)) zero_granule_data)))
 (let (($x1527 (= (e_state_s_granule (select (g_granules (globals ?x41312)) gidx.752346)) 1)))
 (=> $x1527 $x1543))))))))))))))))))
 )
(assert
 (let (($x1578 (forall ((gidx.752482 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x41312 (share ?x1433)))
 (let ((?x1509 (log ?x1433)))
 (let ((?x1542 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (oracle (value_RData (query_oracle.0_call (elem_1 a!2))))))_call| ?x1509)))
 (let ((?x1480 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (repl (value_RData (query_oracle.0_call (elem_1 a!2))))))_call| ?x1542 ?x41312)))
 (let ((?x1479 (value_Shared ?x1480)))
 (let ((?x1484 (granule_data ?x1479)))
 (let (($x1746 (= (g_norm (select ?x1484 gidx.752482)) zero_granule_data)))
 (let (($x1531 (= (e_state_s_granule (select (g_granules (globals ?x1479)) gidx.752482)) 1)))
 (or (not $x1531) $x1746))))))))))))))))))))))
 ))
 (let (($x1556 (forall ((gidx.752471 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x41312 (share ?x1433)))
 (let ((?x1494 (granule_data ?x41312)))
 (let (($x1543 (= (g_norm (select ?x1494 gidx.752471)) zero_granule_data)))
 (let (($x1527 (= (e_state_s_granule (select (g_granules (globals ?x41312)) gidx.752471)) 1)))
 (or (not $x1527) $x1543))))))))))))))))))
 ))
 (or (not $x1556) $x1578))))
(assert
 (forall ((rtt_gidx.752587 Int) (ipa_gidx.752587 Int) (i.752587 Int) (d.752587 r_granule_data) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x1435 (query_oracle.0_call ?x1252)))
 (let ((?x1433 (value_RData ?x1435)))
 (let (($x1595 (halt ?x1433)))
 (let ((?x1575 (stack ?x1433)))
 (let ((?x41312 (share ?x1433)))
 (let ((?x1501 (globals ?x41312)))
 (let ((?x1593 (gpt ?x41312)))
 (let ((?x1503 (priv ?x1433)))
 (let ((?x1522 (repl ?x1433)))
 (let ((?x1482 (oracle ?x1433)))
 (let ((?x1509 (log ?x1433)))
 (let ((?x1565 (mkRData ?x1509 ?x1482 ?x1522 ?x1503 (mkShared ?x1593 (store (granule_data ?x41312) i.752587 d.752587) ?x1501) ?x1575 $x1595)))
 (let ((?x1588 (+ (rtt_walk_abs.0_call ?x1433 rtt_gidx.752587 ipa_gidx.752587) (* (- 1) (rtt_walk_abs.0_call ?x1565 rtt_gidx.752587 ipa_gidx.752587)))))
 (let (($x1637 (and (not (= (e_state_s_granule (select (g_granules ?x1501) i.752587)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1501) i.752587)) 4)))))
 (=> $x1637 (= ?x1588 0)))))))))))))))))))))))))))
 )
(assert
 (let (($x1571 (forall ((gidx.752624 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x41312 (share ?x1433)))
 (let ((?x1494 (granule_data ?x41312)))
 (let (($x1543 (= (g_norm (select ?x1494 gidx.752624)) zero_granule_data)))
 (let (($x1527 (= (e_state_s_granule (select (g_granules (globals ?x41312)) gidx.752624)) 1)))
 (=> $x1527 $x1543))))))))))))))))))
 ))
 (not $x1571)))
(check-sat)

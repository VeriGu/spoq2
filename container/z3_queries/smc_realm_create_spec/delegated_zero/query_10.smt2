...
(assert
 (let (($x2371 (forall ((gidx.753865 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x41312 (share ?x1433)))
 (let ((?x1494 (granule_data ?x41312)))
 (let (($x1543 (= (g_norm (select ?x1494 gidx.753865)) zero_granule_data)))
 (let (($x1527 (= (e_state_s_granule (select (g_granules (globals ?x41312)) gidx.753865)) 1)))
 (=> $x1527 $x1543))))))))))))))))))
 ))
 (not $x2371)))
(check-sat)

...
(let ((a!2 (value_Tuple_Z_RData
  ...
  (repl (elem_1 a!2))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (oracle (elem_1 a!2))))_call| (List_Event) List_Event)
...
(assert
 ...
 (= ?x1255 0))))))))))))
(assert
 (forall ((gidx.752031 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x1319 (granule_data ?x25744)))
 (let (($x1326 (= (g_norm (select ?x1319 gidx.752031)) zero_granule_data)))
 (let (($x1329 (= (e_state_s_granule (select (g_granules (globals ?x25744)) gidx.752031)) 1)))
 (=> $x1329 $x1326))))))))))))))))
 )
(assert
 (let (($x1387 (forall ((gidx.752167 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x25744 (share ?x1252)))
 (let ((?x1323 (log ?x1252)))
 (let ((?x1379 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (oracle (elem_1 a!2))))_call| ?x1323)))
 (let ((?x1293 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (repl (elem_1 a!2))))_call| ?x1379 ?x25744)))
 (let ((?x1294 (value_Shared ?x1293)))
 (let ((?x1295 (granule_data ?x1294)))
 (let (($x1376 (= (g_norm (select ?x1295 gidx.752167)) zero_granule_data)))
 (let (($x1408 (= (e_state_s_granule (select (g_granules (globals ?x1294)) gidx.752167)) 1)))
 (or (not $x1408) $x1376))))))))))))))))))))
 ))
 (let (($x1390 (forall ((gidx.752156 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x25744 (share ?x1252)))
 (let ((?x1319 (granule_data ?x25744)))
 (let (($x1326 (= (g_norm (select ?x1319 gidx.752156)) zero_granule_data)))
 (let (($x1329 (= (e_state_s_granule (select (g_granules (globals ?x25744)) gidx.752156)) 1)))
 (or (not $x1329) $x1326))))))))))))))))
 ))
 (or (not $x1390) $x1387))))
(assert
 (forall ((rtt_gidx.752272 Int) (ipa_gidx.752272 Int) (i.752272 Int) (d.752272 r_granule_data) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x1254 (value_Tuple_Z_RData ?x1239)))
 (let ((?x1252 (elem_1 ?x1254)))
 (let (($x1422 (halt ?x1252)))
 (let ((?x1423 (stack ?x1252)))
 (let ((?x25744 (share ?x1252)))
 (let ((?x1312 (globals ?x25744)))
 (let ((?x1427 (gpt ?x25744)))
 (let ((?x1412 (priv ?x1252)))
 (let ((?x1380 (repl ?x1252)))
 (let ((?x1292 (oracle ?x1252)))
 (let ((?x1323 (log ?x1252)))
 (let ((?x1413 (mkRData ?x1323 ?x1292 ?x1380 ?x1412 (mkShared ?x1427 (store (granule_data ?x25744) i.752272 d.752272) ?x1312) ?x1423 $x1422)))
 (let ((?x1449 (+ (rtt_walk_abs.0_call ?x1252 rtt_gidx.752272 ipa_gidx.752272) (* (- 1) (rtt_walk_abs.0_call ?x1413 rtt_gidx.752272 ipa_gidx.752272)))))
 (let (($x1441 (and (not (= (e_state_s_granule (select (g_granules ?x1312) i.752272)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1312) i.752272)) 4)))))
 (=> $x1441 (= ?x1449 0)))))))))))))))))))))))))
 )
(assert
 (let (($x1464 (forall ((gidx.752309 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x25744 (share ?x1252)))
 (let ((?x1319 (granule_data ?x25744)))
 (let (($x1326 (= (g_norm (select ?x1319 gidx.752309)) zero_granule_data)))
 (let (($x1329 (= (e_state_s_granule (select (g_granules (globals ?x25744)) gidx.752309)) 1)))
 (=> $x1329 $x1326))))))))))))))))
 ))
 (not $x1464)))
(check-sat)

...
(assert
 (let (($x1263 (forall ((gidx.751994 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x9829 (share ?x1087)))
 (let ((?x1107 (granule_data ?x9829)))
 (let (($x1181 (= (g_norm (select ?x1107 gidx.751994)) zero_granule_data)))
 (let (($x1179 (= (e_state_s_granule (select (g_granules (globals ?x9829)) gidx.751994)) 1)))
 (=> $x1179 $x1181)))))))))))))
 ))
 (not $x1263)))
(check-sat)

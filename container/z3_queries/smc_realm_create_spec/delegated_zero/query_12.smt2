...
(declare-fun |(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             ...
             64
             st.0)))
  (repl (elem_1 (value_Tuple_bool_RData a!1))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
  (oracle (elem_1 (value_Tuple_bool_RData a!1))))_call| (List_Event) List_Event)
...
(assert
 ...
 (let (($x1106 (elem_0 ?x1098)))
 (not $x1106)))))))))
(assert
 (forall ((gidx.751716 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x9829 (share ?x1087)))
 (let ((?x1107 (granule_data ?x9829)))
 (let (($x1181 (= (g_norm (select ?x1107 gidx.751716)) zero_granule_data)))
 (let (($x1179 (= (e_state_s_granule (select (g_granules (globals ?x9829)) gidx.751716)) 1)))
 (=> $x1179 $x1181)))))))))))))
 )
(assert
 (let (($x1189 (forall ((gidx.751852 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x9829 (share ?x1087)))
 (let ((?x760 (log ?x1087)))
 (let ((?x1719 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
  (oracle (elem_1 (value_Tuple_bool_RData a!1))))_call| ?x760)))
 (let ((?x1137 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
  (repl (elem_1 (value_Tuple_bool_RData a!1))))_call| ?x1719 ?x9829)))
 (let ((?x1186 (value_Shared ?x1137)))
 (let ((?x1188 (granule_data ?x1186)))
 (let (($x1249 (= (g_norm (select ?x1188 gidx.751852)) zero_granule_data)))
 (let (($x1153 (= (e_state_s_granule (select (g_granules (globals ?x1186)) gidx.751852)) 1)))
 (or (not $x1153) $x1249)))))))))))))))))
 ))
 (let (($x1213 (forall ((gidx.751841 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x9829 (share ?x1087)))
 (let ((?x1107 (granule_data ?x9829)))
 (let (($x1181 (= (g_norm (select ?x1107 gidx.751841)) zero_granule_data)))
 (let (($x1179 (= (e_state_s_granule (select (g_granules (globals ?x9829)) gidx.751841)) 1)))
 (or (not $x1179) $x1181)))))))))))))
 ))
 (or (not $x1213) $x1189))))
(assert
 (forall ((rtt_gidx.751957 Int) (ipa_gidx.751957 Int) (i.751957 Int) (d.751957 r_granule_data) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 (let ((?x1098 (value_Tuple_bool_RData ?x1096)))
 (let ((?x1087 (elem_1 ?x1098)))
 (let (($x1216 (halt ?x1087)))
 (let ((?x1231 (stack ?x1087)))
 (let ((?x9829 (share ?x1087)))
 (let ((?x1178 (globals ?x9829)))
 (let ((?x1201 (gpt ?x9829)))
 (let ((?x1224 (priv ?x1087)))
 (let ((?x1743 (repl ?x1087)))
 (let ((?x1741 (oracle ?x1087)))
 (let ((?x760 (log ?x1087)))
 (let ((?x1227 (mkRData ?x760 ?x1741 ?x1743 ?x1224 (mkShared ?x1201 (store (granule_data ?x9829) i.751957 d.751957) ?x1178) ?x1231 $x1216)))
 (let ((?x1251 (+ (rtt_walk_abs.0_call ?x1087 rtt_gidx.751957 ipa_gidx.751957) (* (- 1) (rtt_walk_abs.0_call ?x1227 rtt_gidx.751957 ipa_gidx.751957)))))
 (let (($x1234 (and (not (= (e_state_s_granule (select (g_granules ?x1178) i.751957)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1178) i.751957)) 4)))))
 (=> $x1234 (= ?x1251 0))))))))))))))))))))))
 )
(assert
 (let (($x2380 (forall ((gidx.753941 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x9829 (share ?x1087)))
 (let ((?x1107 (granule_data ?x9829)))
 (let (($x1181 (= (g_norm (select ?x1107 gidx.753941)) zero_granule_data)))
 (let (($x1179 (= (e_state_s_granule (select (g_granules (globals ?x9829)) gidx.753941)) 1)))
 (=> $x1179 $x1181)))))))))))))
 ))
 (not $x2380)))
(check-sat)

...
(assert
 ...
 (>= ?x1128 0))))
(assert
 (forall ((gidx.60136 Int) )(let (($x73 (= (g_norm (select (granule_data (share st.0)) gidx.60136)) zero_granule_data)))
 (let (($x76 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.60136)) 1)))
 (=> $x76 $x73))))
 )
(assert
 (let (($x1111 (forall ((gidx.66190 Int) )(let ((?x13 (share st.0)))
 (let ((?x20 (log st.0)))
 (let ((?x35 (|(oracle st.0)_call| ?x20)))
 (let ((?x37 (|(repl st.0)_call| ?x35 ?x13)))
 (let ((?x39 (value_Shared ?x37)))
 (let ((?x66 (granule_data ?x39)))
 (let ((?x107 (select ?x66 gidx.66190)))
 (let (($x109 (= (g_norm ?x107) zero_granule_data)))
 (let (($x112 (= (e_state_s_granule (select (g_granules (globals ?x39)) gidx.66190)) 1)))
 (or (not $x112) $x109)))))))))))
 ))
 (let (($x1081 (forall ((gidx.66179 Int) )(let (($x73 (= (g_norm (select (granule_data (share st.0)) gidx.66179)) zero_granule_data)))
 (let (($x76 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.66179)) 1)))
 (or (not $x76) $x73))))
 ))
 (or (not $x1081) $x1111))))
(assert
 (forall ((rtt_gidx.61476 Int) (ipa_gidx.61476 Int) (i.61476 Int) (d.61476 r_granule_data) )(let (($x25 (halt st.0)))
 (let ((?x24 (stack st.0)))
 (let ((?x13 (share st.0)))
 (let ((?x18 (globals ?x13)))
 (let ((?x17 (gpt ?x13)))
 ...
 (let ((?x21 (oracle st.0)))
 (let ((?x20 (log st.0)))
 (let ((?x1146 (mkRData ?x20 ?x21 ?x22 ?x23 (mkShared ?x17 (store (granule_data ?x13) i.61476 d.61476) ?x18) ?x24 $x25)))
 (let ((?x1125 (rtt_walk_abs.0_call ?x1146 rtt_gidx.61476 ipa_gidx.61476)))
 (let (($x1077 (= (+ (rtt_walk_abs.0_call st.0 rtt_gidx.61476 ipa_gidx.61476) (* (- 1) ?x1125)) 0)))
 (let (($x1134 (and (not (= (e_state_s_granule (select (g_granules ?x18) i.61476)) 5)) (not (= (e_state_s_granule (select (g_granules ?x18) i.61476)) 4)))))
 (=> $x1134 $x1077)))))))))))))))
 )
(assert
 (let (($x1172 (forall ((gidx.751679 Int) )(let (($x73 (= (g_norm (select (granule_data (share st.0)) gidx.751679)) zero_granule_data)))
 (let (($x76 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.751679)) 1)))
 (=> $x76 $x73))))
 ))
 (not $x1172)))
(check-sat)

...
(assert
 (let (($x2378 (forall ((gidx.753903 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x25744 (share ?x1252)))
 (let ((?x1319 (granule_data ?x25744)))
 (let (($x1326 (= (g_norm (select ?x1319 gidx.753903)) zero_granule_data)))
 (let (($x1329 (= (e_state_s_granule (select (g_granules (globals ?x25744)) gidx.753903)) 1)))
 (=> $x1329 $x1326))))))))))))))))
 ))
 (not $x2378)))
(check-sat)

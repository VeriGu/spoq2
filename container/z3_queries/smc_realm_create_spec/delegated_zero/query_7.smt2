...
(let ((a!39 (query_oracle.0_call
  ...
  (repl (value_RData (query_oracle.0_call (value_RData a!39)))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!39 (query_oracle.0_call
              (mkRData (log (value_RData a!4))
                       ...
                       (stack (value_RData a!4))
                       (halt (value_RData a!4))))))
  (oracle (value_RData (query_oracle.0_call (value_RData a!39)))))))))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (let ((?x1913 (stack ?x1810)))
 (let ((?x70192 (stack_s_realm_params ?x1913)))
 (let ((?x2116 (e_rtt_addr ?x70192)))
 (let ((?x2169 (test_PA.0_call ?x2116)))
 (let ((?x2088 (meta_granule_offset ?x2169)))
 (let ((?x2092 (div ?x2088 4096)))
 (let ((?x2039 (query_oracle.0_call ?x1810)))
 (let ((?x2125 (value_RData ?x2039)))
 (let ((?x69259 (share ?x2125)))
 (let ((?x2067 (globals ?x69259)))
 (let ((?x2053 (g_granules ?x2067)))
 (let ((?x2156 (select ?x2053 ?x2092)))
 (let ((?x2158 (e_state_s_granule ?x2156)))
 (= ?x2158 1)))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x56172 (test_PA.0_call v_0.0)))
 (let ((?x1922 (meta_granule_offset ?x56172)))
 ...
 (let ((?x1852 (g_granules ?x1853)))
 (let ((?x1946 (select ?x1852 ?x1909)))
 (let ((?x1992 (e_ref ?x1946)))
 (let ((?x1956 (e_state_s_granule ?x1946)))
 (let ((?x68417 (mks_spinlock_t None_Z)))
 (let ((?x2166 (mks_granule ?x68417 ?x1956 ?x1992)))
 (let ((?x2178 (store ?x1852 ?x1909 ?x2166)))
 (let ((?x2039 (query_oracle.0_call ?x1810)))
 (let ((?x2125 (value_RData ?x2039)))
 (let ((?x69259 (share ?x2125)))
 (let ((?x2067 (globals ?x69259)))
...
(assert
 ...
 (let ((?x2053 (g_granules ?x2067)))
 (let ((?x2156 (select ?x2053 ?x2092)))
 (let ((?x70191 (e_lock ?x2156)))
 (let ((?x2163 (e_val ?x70191)))
 (= ?x2163 None_Z))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
...
(assert
 ...
 (let ((?x2125 (value_RData ?x2039)))
 (let ((?x69259 (share ?x2125)))
 (let ((?x2081 (gpt ?x69259)))
 (select ?x2081 ?x2092))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.753369 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x2125 (value_RData ?x2039)))
 (let ((?x69259 (share ?x2125)))
 (let ((?x2152 (granule_data ?x69259)))
 (let (($x2074 (= (g_norm (select ?x2152 gidx.753369)) zero_granule_data)))
 (let (($x2075 (= (e_state_s_granule (select (g_granules (globals ?x69259)) gidx.753369)) 1)))
 (=> $x2075 $x2074))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2123 (forall ((gidx.753505 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x69259 (share ?x2125)))
 (let ((?x2084 (log ?x2125)))
 (let ((?x2151 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!39 (query_oracle.0_call
              (mkRData (log (value_RData a!4))
                       ...
                       (stack (value_RData a!4))
                       (halt (value_RData a!4))))))
  (oracle (value_RData (query_oracle.0_call (value_RData a!39)))))))))))))_call| ?x2084)))
 (let ((?x2011 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!39 (query_oracle.0_call
              (mkRData (log (value_RData a!4))
                       ...
                       (stack (value_RData a!4))
                       (halt (value_RData a!4))))))
  (repl (value_RData (query_oracle.0_call (value_RData a!39)))))))))))))_call| ?x2151 ?x69259)))
 (let ((?x2046 (value_Shared ?x2011)))
 (let ((?x2122 (granule_data ?x2046)))
 (let (($x2089 (= (g_norm (select ?x2122 gidx.753505)) zero_granule_data)))
 (let (($x2104 (= (e_state_s_granule (select (g_granules (globals ?x2046)) gidx.753505)) 1)))
 (or (not $x2104) $x2089))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2065 (forall ((gidx.753494 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x69259 (share ?x2125)))
 (let ((?x2152 (granule_data ?x69259)))
 (let (($x2074 (= (g_norm (select ?x2152 gidx.753494)) zero_granule_data)))
 (let (($x2075 (= (e_state_s_granule (select (g_granules (globals ?x69259)) gidx.753494)) 1)))
 (or (not $x2075) $x2074))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2065) $x2123))))
(assert
 (forall ((rtt_gidx.753610 Int) (ipa_gidx.753610 Int) (i.753610 Int) (d.753610 r_granule_data) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x2039 (query_oracle.0_call ?x1810)))
 (let ((?x2125 (value_RData ?x2039)))
 (let (($x2164 (halt ?x2125)))
 (let ((?x2142 (stack ?x2125)))
 (let ((?x69259 (share ?x2125)))
 (let ((?x2067 (globals ?x69259)))
 (let ((?x2081 (gpt ?x69259)))
 (let ((?x2130 (priv ?x2125)))
 (let ((?x2027 (repl ?x2125)))
 (let ((?x2112 (oracle ?x2125)))
 (let ((?x2084 (log ?x2125)))
 (let ((?x2136 (mkRData ?x2084 ?x2112 ?x2027 ?x2130 (mkShared ?x2081 (store (granule_data ?x69259) i.753610 d.753610) ?x2067) ?x2142 $x2164)))
 (let ((?x2137 (+ (rtt_walk_abs.0_call ?x2125 rtt_gidx.753610 ipa_gidx.753610) (* (- 1) (rtt_walk_abs.0_call ?x2136 rtt_gidx.753610 ipa_gidx.753610)))))
 (let (($x2188 (and (not (= (e_state_s_granule (select (g_granules ?x2067) i.753610)) 5)) (not (= (e_state_s_granule (select (g_granules ?x2067) i.753610)) 4)))))
 (=> $x2188 (= ?x2137 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2252 (forall ((gidx.753700 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x69259 (share ?x2125)))
 (let ((?x2152 (granule_data ?x69259)))
 (let (($x2074 (= (g_norm (select ?x2152 gidx.753700)) zero_granule_data)))
 (let ((?x1913 (stack ?x1810)))
 (let ((?x70192 (stack_s_realm_params ?x1913)))
 (let ((?x2116 (e_rtt_addr ?x70192)))
 (let ((?x2169 (test_PA.0_call ?x2116)))
 ...
 (let ((?x2053 (g_granules ?x2067)))
 (let ((?x2156 (select ?x2053 ?x2092)))
 (let ((?x2463 (e_ref ?x2156)))
 (let ((?x1949 (Some_Z CPU_ID.0)))
 (let ((?x1991 (mks_spinlock_t ?x1949)))
 (let ((?x2264 (store ?x2053 ?x2092 (mks_granule ?x1991 1 ?x2463))))
 (=> (= (e_state_s_granule (select ?x2264 gidx.753700)) 1) $x2074))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2252)))
(check-sat)

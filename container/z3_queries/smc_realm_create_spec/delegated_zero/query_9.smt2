...
(assert
 (let (($x2365 (forall ((gidx.753827 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x57081 (share ?x1810)))
 (let ((?x1881 (granule_data ?x57081)))
 (let (($x1893 (= (g_norm (select ?x1881 gidx.753827)) zero_granule_data)))
 (let (($x1892 (= (e_state_s_granule (select (g_granules (globals ?x57081)) gidx.753827)) 1)))
 (=> $x1892 $x1893))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2365)))
(check-sat)

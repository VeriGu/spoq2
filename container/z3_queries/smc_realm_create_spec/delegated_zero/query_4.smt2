...
(assert
 ...
 (select ?x1744 ?x1621)))))))))))))))))))))))))
(assert
 (forall ((gidx.752661 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let (($x1650 (= (g_norm (select ?x1662 gidx.752661)) zero_granule_data)))
 (let (($x4506 (= (e_state_s_granule (select (g_granules (globals ?x50142)) gidx.752661)) 1)))
 (=> $x4506 $x1650))))))))))))))))))))))))))
 )
(assert
 (let (($x4520 (forall ((gidx.752797 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x50142 (share ?x1610)))
 (let ((?x1645 (log ?x1610)))
 (let ((?x1720 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!4 (s2tt_init_unassigned_spec.0_call
             ...
             1
             (value_RData (query_oracle.0_call (elem_1 a!2))))))
  (oracle (value_RData a!4))))))_call| ?x1645)))
 (let ((?x1702 (|(let ((a!1 (memcpy_ns_read_spec_state_oracle.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!4 (s2tt_init_unassigned_spec.0_call
             ...
             1
             (value_RData (query_oracle.0_call (elem_1 a!2))))))
  (repl (value_RData a!4))))))_call| ?x1720 ?x50142)))
 (let ((?x1701 (value_Shared ?x1702)))
 (let ((?x806 (granule_data ?x1701)))
 (let (($x1143 (= (g_norm (select ?x806 gidx.752797)) zero_granule_data)))
 (let (($x1552 (= (e_state_s_granule (select (g_granules (globals ?x1701)) gidx.752797)) 1)))
 (or (not $x1552) $x1143))))))))))))))))))))))))))))))
 ))
 (let (($x4504 (forall ((gidx.752786 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x50142 (share ?x1610)))
 (let ((?x1662 (granule_data ?x50142)))
 (let (($x1650 (= (g_norm (select ?x1662 gidx.752786)) zero_granule_data)))
 (let (($x4506 (= (e_state_s_granule (select (g_granules (globals ?x50142)) gidx.752786)) 1)))
 (or (not $x4506) $x1650))))))))))))))))))))))))))
 ))
 (or (not $x4504) $x4520))))
(assert
 (forall ((rtt_gidx.752902 Int) (ipa_gidx.752902 Int) (i.752902 Int) (d.752902 r_granule_data) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x1645 (log ?x1610)))
 (let ((?x1781 (mkRData ?x1645 ?x4510 ?x1700 ?x1673 (mkShared ?x1744 (store (granule_data ?x50142) i.752902 d.752902) ?x1605) ?x1733 $x1734)))
 (let ((?x4511 (+ (rtt_walk_abs.0_call ?x1610 rtt_gidx.752902 ipa_gidx.752902) (* (- 1) (rtt_walk_abs.0_call ?x1781 rtt_gidx.752902 ipa_gidx.752902)))))
 (let (($x1765 (and (not (= (e_state_s_granule (select (g_granules ?x1605) i.752902)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1605) i.752902)) 4)))))
 (=> $x1765 (= ?x4511 0)))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1829 (forall ((gidx.752939 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x50142 (share ?x1610)))
 (let ((?x1662 (granule_data ?x50142)))
 (let (($x1650 (= (g_norm (select ?x1662 gidx.752939)) zero_granule_data)))
 (let ((?x1801 (mks_granule (e_lock (select (g_granules (globals ?x50142)) (div ?x1570 4096))) 5 (e_ref (select (g_granules (globals ?x50142)) (div ?x1570 4096))))))
 (let ((?x1621 (div ?x1570 4096)))
 (let ((?x1605 (globals ?x50142)))
 (let ((?x1606 (g_granules ?x1605)))
 (let ((?x1783 (store ?x1606 ?x1621 ?x1801)))
 (=> (= (e_state_s_granule (select ?x1783 gidx.752939)) 1) $x1650))))))))))))))))))))))))))))))
 ))
 (not $x1829)))
(check-sat)

...
(assert
 ...
 (let ((?x68147 (select ?x1881 ?x1909)))
 (let ((?x1975 (g_granule_state ?x68147)))
 (= ?x1975 2)))))))))))))))))))))))))))))))))))))))))))))))
(assert
...
(assert
 (let (($x2038 (forall ((gidx.753295 Int) )(let ((?x1165 (test_PA.0_call v_1.0)))
 (let ((?x1128 (meta_granule_offset ?x1165)))
 (let ((?x759 (mkPtr "granule_data" ?x1128)))
 (let ((?x1145 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1096 (memcpy_ns_read_spec_state_oracle.0_call ?x1145 ?x759 64 st.0)))
 ...
 (let ((?x57081 (share ?x1810)))
 (let ((?x1881 (granule_data ?x57081)))
 (let (($x1893 (= (g_norm (select ?x1881 gidx.753295)) zero_granule_data)))
 (let ((?x56172 (test_PA.0_call v_0.0)))
 (let ((?x1922 (meta_granule_offset ?x56172)))
 (let ((?x1909 (div ?x1922 4096)))
 (let ((?x1853 (globals ?x57081)))
 ...
 (let ((?x1981 (store ?x1852 ?x1909 (mks_granule ?x1991 2 ?x1992))))
 (=> (= (e_state_s_granule (select ?x1981 gidx.753295)) 1) $x1893)))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2038)))
(check-sat)

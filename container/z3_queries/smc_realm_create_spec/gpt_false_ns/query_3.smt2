...
(assert
 ...
 (and $x1577 $x1559))))))))))))))))))))
(assert
 (forall ((gidx.755055 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1479 (globals ?x40384)))
 (let ((?x1494 (g_granules ?x1479)))
 (let ((?x1486 (e_state_s_granule (select ?x1494 gidx.755055))))
 (let (($x1485 (= ?x1486 6)))
 (let (($x1495 (= ?x1486 0)))
 (=> (not (select (gpt ?x40384) gidx.755055)) (or $x1495 $x1485)))))))))))))))))))))))))))
 )
(assert
 (let (($x1466 (forall ((gidx.755243 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x40384 (share ?x1431)))
 (let ((?x1488 (log ?x1431)))
 (let ((?x1478 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!4 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!3)))
             (elem_1 a!2))))
  (oracle (value_RData a!4))))))_call| ?x1488)))
 (let ((?x1476 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!4 (spinlock_acquire_spec.0_call
             (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!3)))
             (elem_1 a!2))))
  (repl (value_RData a!4))))))_call| ?x1478 ?x40384)))
 (let ((?x1473 (value_Shared ?x1476)))
 (let ((?x1511 (gpt ?x1473)))
 (let (($x1572 (select ?x1511 gidx.755243)))
 (let ((?x1555 (e_state_s_granule (select (g_granules (globals ?x1473)) gidx.755243))))
 (let (($x1554 (= ?x1555 6)))
 (let (($x1553 (= ?x1555 0)))
 (or $x1553 $x1554 $x1572))))))))))))))))))))))))))))))
 ))
 (let (($x1558 (forall ((gidx.755226 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1479 (globals ?x40384)))
 (let ((?x1494 (g_granules ?x1479)))
 (let ((?x1486 (e_state_s_granule (select ?x1494 gidx.755226))))
 (let (($x1495 (= ?x1486 0)))
 (let (($x1485 (= ?x1486 6)))
 (let ((?x1463 (gpt ?x40384)))
 (let (($x1481 (select ?x1463 gidx.755226)))
 (or $x1481 $x1485 $x1495))))))))))))))))))))))))))))
 ))
 (or (not $x1558) $x1466))))
(assert
 (forall ((rtt_gidx.755348 Int) (ipa_gidx.755348 Int) (i.755348 Int) (d.755348 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1433 (spinlock_acquire_spec.0_call ?x1434 ?x1213)))
 (let ((?x1431 (value_RData ?x1433)))
 (let (($x1614 (halt ?x1431)))
 (let ((?x1613 (stack ?x1431)))
 (let ((?x40384 (share ?x1431)))
 (let ((?x1479 (globals ?x40384)))
 (let ((?x1463 (gpt ?x40384)))
 (let ((?x1551 (priv ?x1431)))
 (let ((?x1477 (repl ?x1431)))
 (let ((?x1496 (oracle ?x1431)))
 (let ((?x1488 (log ?x1431)))
 (let ((?x1545 (mkRData ?x1488 ?x1496 ?x1477 ?x1551 (mkShared ?x1463 (store (granule_data ?x40384) i.755348 d.755348) ?x1479) ?x1613 $x1614)))
 (let ((?x1550 (+ (rtt_walk_abs.0_call ?x1431 rtt_gidx.755348 ipa_gidx.755348) (* (- 1) (rtt_walk_abs.0_call ?x1545 rtt_gidx.755348 ipa_gidx.755348)))))
 (let (($x1579 (and (not (= (e_state_s_granule (select (g_granules ?x1479) i.755348)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1479) i.755348)) 4)))))
 (=> $x1579 (= ?x1550 0)))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1822 (forall ((gidx.755403 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1479 (globals ?x40384)))
 (let ((?x1494 (g_granules ?x1479)))
 (let ((?x1486 (e_state_s_granule (select ?x1494 gidx.755403))))
 (let (($x1485 (= ?x1486 6)))
 (let (($x1495 (= ?x1486 0)))
 (=> (not (select (gpt ?x40384) gidx.755403)) (or $x1495 $x1485)))))))))))))))))))))))))))
 ))
 (not $x1822)))
(check-sat)

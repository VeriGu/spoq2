...
(assert
 (forall ((gidx.60074 Int) )(let ((?x13 (share st.0)))
 (let ((?x18 (globals ?x13)))
 (let ((?x42 (g_granules ?x18)))
 (let ((?x75 (select ?x42 gidx.60074)))
 (let ((?x76 (e_state_s_granule ?x75)))
 (let (($x77 (= ?x76 6)))
 (let (($x78 (= ?x76 0)))
 (=> (not (select (gpt ?x13) gidx.60074)) (or $x78 $x77))))))))))
 )
(assert
 (forall ((rtt_gidx.61414 Int) (ipa_gidx.61414 Int) (i.61414 Int) (d.61414 r_granule_data) )(let (($x25 (halt st.0)))
 (let ((?x24 (stack st.0)))
 (let ((?x13 (share st.0)))
 (let ((?x18 (globals ?x13)))
 (let ((?x17 (gpt ?x13)))
 ...
 (let ((?x21 (oracle st.0)))
 (let ((?x20 (log st.0)))
 (let ((?x4151 (mkRData ?x20 ?x21 ?x22 ?x23 (mkShared ?x17 (store (granule_data ?x13) i.61414 d.61414) ?x18) ?x24 $x25)))
 (let ((?x1103 (rtt_walk_abs.0_call ?x4151 rtt_gidx.61414 ipa_gidx.61414)))
 (let (($x1006 (= (+ (rtt_walk_abs.0_call st.0 rtt_gidx.61414 ipa_gidx.61414) (* (- 1) ?x1103)) 0)))
 (let (($x1013 (and (not (= (e_state_s_granule (select (g_granules ?x18) i.61414)) 5)) (not (= (e_state_s_granule (select (g_granules ?x18) i.61414)) 4)))))
 (=> $x1013 $x1006)))))))))))))))
 )
(assert
 (let (($x1092 (forall ((gidx.68364 Int) )(let ((?x13 (share st.0)))
 (let ((?x20 (log st.0)))
 (let ((?x35 (|(oracle st.0)_call| ?x20)))
 (let ((?x37 (|(repl st.0)_call| ?x35 ?x13)))
 (let ((?x39 (value_Shared ?x37)))
 (let ((?x103 (gpt ?x39)))
 (let (($x118 (select ?x103 gidx.68364)))
 (let ((?x68 (globals ?x39)))
 (let ((?x69 (g_granules ?x68)))
 (let ((?x113 (select ?x69 gidx.68364)))
 (let ((?x114 (e_state_s_granule ?x113)))
 (let (($x116 (= ?x114 0)))
 (let (($x115 (= ?x114 6)))
 (or $x115 $x116 $x118)))))))))))))))
 ))
 (let (($x1101 (forall ((gidx.68347 Int) )(let ((?x13 (share st.0)))
 (let ((?x17 (gpt ?x13)))
 (let (($x80 (select ?x17 gidx.68347)))
 (let ((?x18 (globals ?x13)))
 (let ((?x42 (g_granules ?x18)))
 (let ((?x75 (select ?x42 gidx.68347)))
 (let ((?x76 (e_state_s_granule ?x75)))
 (let (($x78 (= ?x76 0)))
 (let (($x77 (= ?x76 6)))
 (or $x77 $x78 $x80)))))))))))
 ...
 (or (not $x1101) $x1092))))
(assert
 (let (($x1140 (forall ((gidx.754194 Int) )(let ((?x13 (share st.0)))
 (let ((?x18 (globals ?x13)))
 (let ((?x42 (g_granules ?x18)))
 (let ((?x75 (select ?x42 gidx.754194)))
 (let ((?x76 (e_state_s_granule ?x75)))
 (let (($x77 (= ?x76 6)))
 (let (($x78 (= ?x76 0)))
 (=> (not (select (gpt ?x13) gidx.754194)) (or $x78 $x77))))))))))
 ))
 (not $x1140)))
(check-sat)

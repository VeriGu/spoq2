...
(let ((a!42 (spinlock_release_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_0.0)))
              (value_RData a!41))))
(let ((a!43 (e_rtt_addr (stack_s_realm_params (stack (value_RData a!42))))))
(let ((a!44 (spinlock_acquire_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!43)))
              (value_RData a!42))))
(let ((a!45 (spinlock_release_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!43)))
              (value_RData a!44))))
(let ((a!46 (g_heap (globals (share (value_RData a!45)))))
      (a!47 (g_debug_exits (globals (share (value_RData a!45)))))
      (a!48 (g_vmid_count (globals (share (value_RData a!45)))))
      (a!49 (g_vmid_lock (globals (share (value_RData a!45)))))
      (a!50 (g_vmids (globals (share (value_RData a!45)))))
      (a!51 (g_nr_lrs (globals (share (value_RData a!45)))))
      (a!52 (g_nr_aprs (globals (share (value_RData a!45)))))
      (a!53 (g_max_vintid (globals (share (value_RData a!45)))))
      (a!54 (g_pri_res0_mask (globals (share (value_RData a!45)))))
      (a!55 (g_default_gicstate (globals (share (value_RData a!45)))))
      (a!56 (g_status_handler (globals (share (value_RData a!45)))))
      (a!57 (g_rmm_trap_list (globals (share (value_RData a!45)))))
      (a!58 (g_tt_l3_buffer (globals (share (value_RData a!45)))))
      (a!59 (g_tt_l2_mem0_0 (globals (share (value_RData a!45)))))
      (a!60 (g_tt_l2_mem0_1 (globals (share (value_RData a!45)))))
      (a!61 (g_tt_l2_mem1_0 (globals (share (value_RData a!45)))))
      (a!62 (g_tt_l2_mem1_1 (globals (share (value_RData a!45)))))
      (a!63 (g_tt_l2_mem1_2 (globals (share (value_RData a!45)))))
      (a!64 (g_tt_l2_mem1_3 (globals (share (value_RData a!45)))))
      (a!65 (g_tt_l1_upper (globals (share (value_RData a!45)))))
      (a!66 (g_mbedtls_mem_buf (globals (share (value_RData a!45)))))
      (a!67 (g_granules (globals (share (value_RData a!45)))))
      (a!70 (g_rmm_attest_signing_key (globals (share (value_RData a!45)))))
      (a!71 (g_rmm_attest_public_key (globals (share (value_RData a!45)))))
      (a!72 (g_rmm_attest_public_key_len (globals (share (value_RData a!45)))))
      (a!73 (g_rmm_attest_public_key_hash (globals (share (value_RData a!45)))))
      (a!74 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!45)))))
      (a!75 (g_platform_token_buf (globals (share (value_RData a!45)))))
      (a!76 (g_rmm_platform_token (globals (share (value_RData a!45)))))
      (a!77 (g_get_realm_identity_identity (globals (share (value_RData a!45)))))
      (a!78 (g_realm_attest_private_key (globals (share (value_RData a!45))))))
(let ((a!68 (select a!67 (div (meta_granule_offset (test_PA.0_call a!43)) 4096))))
(let ((a!69 (store a!67
                   (div (meta_granule_offset (test_PA.0_call a!43)) 4096)
                   (mks_granule (e_lock a!68) 1 (e_ref a!68)))))
(let ((a!79 (mkShared (gpt (share (value_RData a!45)))
                      (granule_data (share (value_RData a!45)))
                      (mkGLOBALS a!46
                                 a!47
                                 a!48
                                 a!49
                                 ...
                                 a!77
                                 a!78))))
(let ((a!80 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!43)))
              (mkRData (log (value_RData a!45))
                       (oracle (value_RData a!45))
                       (repl (value_RData a!45))
                       (priv (value_RData a!45))
                       a!79
                       (stack (value_RData a!45))
                       (halt (value_RData a!45))))))
  (repl (value_RData a!80))))))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!80 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!45))
                       ...
                       (stack (value_RData a!45))
                       (halt (value_RData a!45))))))
  (oracle (value_RData a!80))))))))))))))))))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (let ((?x2267 (stack ?x2343)))
 (let ((?x2420 (stack_s_realm_params ?x2267)))
 (let ((?x2520 (e_rtt_addr ?x2420)))
 (let ((?x2512 (test_PA.0_call ?x2520)))
 (let ((?x2508 (meta_granule_offset ?x2512)))
 (let ((?x2565 (div ?x2508 4096)))
 (let ((?x2516 (mkPtr "granules" ?x2508)))
 (let ((?x2515 (spinlock_acquire_spec.0_call ?x2516 ?x2343)))
 (let ((?x2450 (value_RData ?x2515)))
 (let ((?x84155 (share ?x2450)))
 (let ((?x2563 (globals ?x84155)))
 (let ((?x2509 (g_granules ?x2563)))
 (let ((?x2585 (select ?x2509 ?x2565)))
 (let ((?x2603 (e_state_s_granule ?x2585)))
 (let (($x2586 (= ?x2603 5)))
 (not $x2586)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1077 (test_PA.0_call v_1.0)))
 ...
 (let ((?x2515 (spinlock_acquire_spec.0_call ?x2516 ?x2343)))
 (let ((?x2450 (value_RData ?x2515)))
 (let ((?x104072 (spinlock_release_spec.0_call ?x2516 ?x2450)))
 (let ((?x2876 (value_RData ?x104072)))
 (let ((?x92224 (share ?x2876)))
 (let ((?x2823 (gpt ?x92224)))
 (select ?x2823 ?x2565)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 ...
 (let ((?x2508 (meta_granule_offset ?x2512)))
 (let (($x2592 (>= ?x2508 0)))
 (let ((?x2600 (mod ?x2508 4096)))
 (let (($x2610 (= ?x2600 0)))
 (and $x2610 $x2592))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.758794 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x104072 (spinlock_release_spec.0_call ?x2516 ?x2450)))
 (let ((?x2876 (value_RData ?x104072)))
 (let (($x2990 (halt ?x2876)))
 (let ((?x2925 (stack ?x2876)))
 (let ((?x49605 (mks_granule (e_lock (select (g_granules (globals (share ?x2876))) (div ?x2508 4096))) 1 (e_ref (select (g_granules (globals (share ?x2876))) (div ?x2508 4096))))))
 (let ((?x2565 (div ?x2508 4096)))
 (let ((?x92224 (share ?x2876)))
 (let ((?x2851 (globals ?x92224)))
 (let ((?x2841 (g_granules ?x2851)))
 (let ((?x41908 (store ?x2841 ?x2565 ?x49605)))
 (let ((?x2999 (mkGLOBALS (g_heap ?x2851) (g_debug_exits ?x2851) (g_vmid_count ?x2851) (g_vmid_lock ?x2851) (g_vmids ?x2851) (g_nr_lrs ?x2851) (g_nr_aprs ?x2851) (g_max_vintid ?x2851) (g_pri_res0_mask ?x2851) (g_default_gicstate ?x2851) (g_status_handler ?x2851) (g_rmm_trap_list ?x2851) (g_tt_l3_buffer ?x2851) (g_tt_l2_mem0_0 ?x2851) (g_tt_l2_mem0_1 ?x2851) (g_tt_l2_mem1_0 ?x2851) (g_tt_l2_mem1_1 ?x2851) (g_tt_l2_mem1_2 ?x2851) (g_tt_l2_mem1_3 ?x2851) (g_tt_l1_upper ?x2851) (g_mbedtls_mem_buf ?x2851) ?x41908 (g_rmm_attest_signing_key ?x2851) (g_rmm_attest_public_key ?x2851) (g_rmm_attest_public_key_len ?x2851) (g_rmm_attest_public_key_hash ?x2851) (g_rmm_attest_public_key_hash_len ?x2851) (g_platform_token_buf ?x2851) (g_rmm_platform_token ?x2851) (g_get_realm_identity_identity ?x2851) (g_realm_attest_private_key ?x2851))))
 (let ((?x2973 (granule_data ?x92224)))
 (let ((?x2823 (gpt ?x92224)))
 (let ((?x2965 (priv ?x2876)))
 (let ((?x2947 (repl ?x2876)))
 (let ((?x2940 (oracle ?x2876)))
 (let ((?x2858 (log ?x2876)))
 (let ((?x3055 (mkRData ?x2858 ?x2940 ?x2947 ?x2965 (mkShared ?x2823 ?x2973 ?x2999) ?x2925 $x2990)))
 (let ((?x3058 (granule_unlock_spec.0_call ?x2516 ?x3055)))
 (let ((?x3074 (value_RData ?x3058)))
 (let ((?x100098 (share ?x3074)))
 (let ((?x3105 (globals ?x100098)))
 (let ((?x3028 (g_granules ?x3105)))
 (let ((?x3157 (e_state_s_granule (select ?x3028 gidx.758794))))
 (let (($x3158 (= ?x3157 6)))
 (let (($x3169 (= ?x3157 0)))
 (=> (not (select (gpt ?x100098) gidx.758794)) (or $x3169 $x3158)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x3155 (forall ((gidx.758982 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x100098 (share ?x3074)))
 (let ((?x3119 (log ?x3074)))
 (let ((?x3032 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!80 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!45))
                       ...
                       (stack (value_RData a!45))
                       (halt (value_RData a!45))))))
  (oracle (value_RData a!80))))))))))))))))))))))_call| ?x3119)))
 (let ((?x3079 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!80 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!45))
                       ...
                       (stack (value_RData a!45))
                       (halt (value_RData a!45))))))
  (repl (value_RData a!80))))))))))))))))))))))_call| ?x3032 ?x100098)))
 (let ((?x3154 (value_Shared ?x3079)))
 (let ((?x3117 (globals ?x3154)))
 (let ((?x3098 (g_granules ?x3117)))
 (let ((?x3077 (e_state_s_granule (select ?x3098 gidx.758982))))
 (let (($x3092 (= ?x3077 6)))
 (let ((?x2699 (gpt ?x3154)))
 (let (($x3084 (select ?x2699 gidx.758982)))
 (let (($x2932 (= ?x3077 0)))
 (or $x2932 $x3084 $x3092))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x3014 (forall ((gidx.758965 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x3105 (globals ?x100098)))
 (let ((?x3028 (g_granules ?x3105)))
 (let ((?x3157 (e_state_s_granule (select ?x3028 gidx.758965))))
 (let (($x3169 (= ?x3157 0)))
 (let (($x3158 (= ?x3157 6)))
 (let ((?x3068 (gpt ?x100098)))
 (let (($x3114 (select ?x3068 gidx.758965)))
 (or $x3114 $x3158 $x3169))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x3014) $x3155))))
(assert
 (forall ((rtt_gidx.759087 Int) (ipa_gidx.759087 Int) (i.759087 Int) (d.759087 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x3058 (granule_unlock_spec.0_call ?x2516 ?x3055)))
 (let ((?x3074 (value_RData ?x3058)))
 (let (($x3162 (halt ?x3074)))
 (let ((?x3174 (stack ?x3074)))
 (let ((?x100098 (share ?x3074)))
 (let ((?x3105 (globals ?x100098)))
 (let ((?x3068 (gpt ?x100098)))
 (let ((?x3181 (priv ?x3074)))
 (let ((?x3078 (repl ?x3074)))
 (let ((?x2100 (oracle ?x3074)))
 (let ((?x3119 (log ?x3074)))
 (let ((?x3194 (mkRData ?x3119 ?x2100 ?x3078 ?x3181 (mkShared ?x3068 (store (granule_data ?x100098) i.759087 d.759087) ?x3105) ?x3174 $x3162)))
 (let ((?x3192 (+ (rtt_walk_abs.0_call ?x3074 rtt_gidx.759087 ipa_gidx.759087) (* (- 1) (rtt_walk_abs.0_call ?x3194 rtt_gidx.759087 ipa_gidx.759087)))))
 (let (($x3148 (and (not (= (e_state_s_granule (select (g_granules ?x3105) i.759087)) 5)) (not (= (e_state_s_granule (select (g_granules ?x3105) i.759087)) 4)))))
 (=> $x3148 (= ?x3192 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x3218 (forall ((gidx.759143 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x3105 (globals ?x100098)))
 (let ((?x3028 (g_granules ?x3105)))
 (let ((?x3157 (e_state_s_granule (select ?x3028 gidx.759143))))
 (let (($x3158 (= ?x3157 6)))
 (let (($x3169 (= ?x3157 0)))
 (=> (not (select (gpt ?x100098) gidx.759143)) (or $x3169 $x3158)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x3218)))
(check-sat)

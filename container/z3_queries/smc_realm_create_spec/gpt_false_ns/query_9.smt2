...
(assert
 (let (($x2494 (forall ((gidx.757474 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2251 (globals ?x76274)))
 (let ((?x2254 (g_granules ?x2251)))
 (let ((?x2415 (e_state_s_granule (select ?x2254 gidx.757474))))
 (let (($x2322 (= ?x2415 6)))
 (let (($x2387 (= ?x2415 0)))
 (=> (not (select (gpt ?x76274) gidx.757474)) (or $x2387 $x2322)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2494)))
(check-sat)

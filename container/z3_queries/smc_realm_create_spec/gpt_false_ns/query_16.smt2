...
(assert
 (let (($x3130 (forall ((gidx.759254 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1479 (globals ?x40384)))
 (let ((?x1494 (g_granules ?x1479)))
 (let ((?x1486 (e_state_s_granule (select ?x1494 gidx.759254))))
 (let (($x1485 (= ?x1486 6)))
 (let (($x1495 (= ?x1486 0)))
 (=> (not (select (gpt ?x40384) gidx.759254)) (or $x1495 $x1485)))))))))))))))))))))))))))
 ))
 (not $x3130)))
(check-sat)

...
(assert
 ...
 (let (($x1031 (elem_0 ?x1011)))
 (not $x1031)))))))))
(assert
 (forall ((gidx.754249 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x8854 (share ?x1337)))
 (let ((?x1096 (globals ?x8854)))
 (let ((?x1137 (g_granules ?x1096)))
 (let ((?x1142 (e_state_s_granule (select ?x1137 gidx.754249))))
 (let (($x1099 (= ?x1142 6)))
 (let (($x1033 (= ?x1142 0)))
 (=> (not (select (gpt ?x8854) gidx.754249)) (or $x1033 $x1099))))))))))))))))
 )
(assert
 (let (($x1166 (forall ((gidx.754437 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x8854 (share ?x1337)))
 (let ((?x1155 (log ?x1337)))
 (let ((?x1159 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
  (oracle (elem_1 (value_Tuple_bool_RData a!1))))_call| ?x1155)))
 (let ((?x1161 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
  (repl (elem_1 (value_Tuple_bool_RData a!1))))_call| ?x1159 ?x8854)))
 (let ((?x1154 (value_Shared ?x1161)))
 (let ((?x1153 (globals ?x1154)))
 (let ((?x1151 (g_granules ?x1153)))
 (let ((?x1239 (e_state_s_granule (select ?x1151 gidx.754437))))
 (let (($x1237 (= ?x1239 6)))
 (let ((?x1180 (gpt ?x1154)))
 (let (($x1230 (select ?x1180 gidx.754437)))
 (let (($x1196 (= ?x1239 0)))
 (or $x1196 $x1230 $x1237)))))))))))))))))))))
 ))
 (let (($x1164 (forall ((gidx.754420 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x8854 (share ?x1337)))
 (let ((?x1136 (gpt ?x8854)))
 (let (($x1173 (select ?x1136 gidx.754420)))
 (let ((?x1142 (e_state_s_granule (select (g_granules (globals ?x8854)) gidx.754420))))
 (let (($x1099 (= ?x1142 6)))
 (let (($x1033 (= ?x1142 0)))
 (or $x1033 $x1099 $x1173)))))))))))))))
 ))
 (or (not $x1164) $x1166))))
(assert
 (forall ((rtt_gidx.754542 Int) (ipa_gidx.754542 Int) (i.754542 Int) (d.754542 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 (let ((?x1011 (value_Tuple_bool_RData ?x1132)))
 (let ((?x1337 (elem_1 ?x1011)))
 (let (($x1183 (halt ?x1337)))
 (let ((?x1182 (stack ?x1337)))
 (let ((?x8854 (share ?x1337)))
 (let ((?x1096 (globals ?x8854)))
 (let ((?x1136 (gpt ?x8854)))
 (let ((?x1209 (priv ?x1337)))
 (let ((?x1160 (repl ?x1337)))
 (let ((?x1158 (oracle ?x1337)))
 (let ((?x1155 (log ?x1337)))
 (let ((?x18410 (mkRData ?x1155 ?x1158 ?x1160 ?x1209 (mkShared ?x1136 (store (granule_data ?x8854) i.754542 d.754542) ?x1096) ?x1182 $x1183)))
 (let ((?x1204 (+ (rtt_walk_abs.0_call ?x1337 rtt_gidx.754542 ipa_gidx.754542) (* (- 1) (rtt_walk_abs.0_call ?x18410 rtt_gidx.754542 ipa_gidx.754542)))))
 (let (($x18403 (and (not (= (e_state_s_granule (select (g_granules ?x1096) i.754542)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1096) i.754542)) 4)))))
 (=> $x18403 (= ?x1204 0))))))))))))))))))))))
 )
(assert
 (let (($x3409 (forall ((gidx.759770 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1096 (globals ?x8854)))
 (let ((?x1137 (g_granules ?x1096)))
 (let ((?x1142 (e_state_s_granule (select ?x1137 gidx.759770))))
 (let (($x1099 (= ?x1142 6)))
 (let (($x1033 (= ?x1142 0)))
 (=> (not (select (gpt ?x8854) gidx.759770)) (or $x1033 $x1099))))))))))))))))
 ))
 (not $x3409)))
(check-sat)

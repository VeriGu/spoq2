...
(assert
 (let (($x1223 (forall ((gidx.754597 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1096 (globals ?x8854)))
 (let ((?x1137 (g_granules ?x1096)))
 (let ((?x1142 (e_state_s_granule (select ?x1137 gidx.754597))))
 (let (($x1099 (= ?x1142 6)))
 (let (($x1033 (= ?x1142 0)))
 (=> (not (select (gpt ?x8854) gidx.754597)) (or $x1033 $x1099))))))))))))))))
 ))
 (not $x1223)))
(check-sat)

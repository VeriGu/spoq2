...
(assert
 ...
 (= ?x1212 0))))))))))))
(assert
 (forall ((gidx.754652 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x24804 (share ?x1213)))
 (let ((?x1283 (globals ?x24804)))
 (let ((?x1288 (g_granules ?x1283)))
 (let ((?x1295 (e_state_s_granule (select ?x1288 gidx.754652))))
 (let (($x1284 (= ?x1295 6)))
 (let (($x1287 (= ?x1295 0)))
 (=> (not (select (gpt ?x24804) gidx.754652)) (or $x1287 $x1284)))))))))))))))))))
 )
(assert
 (let (($x1277 (forall ((gidx.754840 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x24804 (share ?x1213)))
 (let ((?x1293 (log ?x1213)))
 (let ((?x1264 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (oracle (elem_1 a!2))))_call| ?x1293)))
 (let ((?x1266 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
(let ((a!2 (value_Tuple_Z_RData
             (validate_realm_params_spec.0_call
               (mkPtr "stack_s_realm_params" 0)
               (elem_1 (value_Tuple_bool_RData a!1))))))
  (repl (elem_1 a!2))))_call| ?x1264 ?x24804)))
 (let ((?x1267 (value_Shared ?x1266)))
 (let ((?x1321 (globals ?x1267)))
 (let ((?x1253 (g_granules ?x1321)))
 (let ((?x1362 (e_state_s_granule (select ?x1253 gidx.754840))))
 (let (($x1361 (= ?x1362 6)))
 (let (($x1360 (= ?x1362 0)))
 (let ((?x1303 (gpt ?x1267)))
 (let (($x1358 (select ?x1303 gidx.754840)))
 (or $x1358 $x1360 $x1361))))))))))))))))))))))))
 ))
 (let (($x1276 (forall ((gidx.754823 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1213 (elem_1 ?x1220)))
 (let ((?x24804 (share ?x1213)))
 (let ((?x1280 (gpt ?x24804)))
 (let (($x1299 (select ?x1280 gidx.754823)))
 (let ((?x1295 (e_state_s_granule (select (g_granules (globals ?x24804)) gidx.754823))))
 (let (($x1287 (= ?x1295 0)))
 (let (($x1284 (= ?x1295 6)))
 (or $x1284 $x1287 $x1299))))))))))))))))))
 ))
 (or (not $x1276) $x1277))))
(assert
 (forall ((rtt_gidx.754945 Int) (ipa_gidx.754945 Int) (i.754945 Int) (d.754945 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1220 (value_Tuple_Z_RData ?x18413)))
 (let ((?x1213 (elem_1 ?x1220)))
 (let (($x1373 (halt ?x1213)))
 (let ((?x1374 (stack ?x1213)))
 (let ((?x24804 (share ?x1213)))
 (let ((?x1283 (globals ?x24804)))
 (let ((?x1280 (gpt ?x24804)))
 (let ((?x1382 (priv ?x1213)))
 (let ((?x1265 (repl ?x1213)))
 (let ((?x1286 (oracle ?x1213)))
 (let ((?x1293 (log ?x1213)))
 (let ((?x1417 (mkRData ?x1293 ?x1286 ?x1265 ?x1382 (mkShared ?x1280 (store (granule_data ?x24804) i.754945 d.754945) ?x1283) ?x1374 $x1373)))
 (let ((?x1412 (+ (rtt_walk_abs.0_call ?x1213 rtt_gidx.754945 ipa_gidx.754945) (* (- 1) (rtt_walk_abs.0_call ?x1417 rtt_gidx.754945 ipa_gidx.754945)))))
 (let (($x1393 (and (not (= (e_state_s_granule (select (g_granules ?x1283) i.754945)) 5)) (not (= (e_state_s_granule (select (g_granules ?x1283) i.754945)) 4)))))
 (=> $x1393 (= ?x1412 0)))))))))))))))))))))))))
 )
(assert
 (let (($x1441 (forall ((gidx.755000 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1283 (globals ?x24804)))
 (let ((?x1288 (g_granules ?x1283)))
 (let ((?x1295 (e_state_s_granule (select ?x1288 gidx.755000))))
 (let (($x1284 (= ?x1295 6)))
 (let (($x1287 (= ?x1295 0)))
 (=> (not (select (gpt ?x24804) gidx.755000)) (or $x1287 $x1284)))))))))))))))))))
 ))
 (not $x1441)))
(check-sat)

...
(let ((a!44 (spinlock_acquire_spec.0_call
              ...
              (value_RData a!42))))
(let ((a!45 (g_heap (globals (share (value_RData a!44)))))
      (a!46 (g_debug_exits (globals (share (value_RData a!44)))))
      (a!47 (g_vmid_count (globals (share (value_RData a!44)))))
      (a!48 (g_vmid_lock (globals (share (value_RData a!44)))))
      (a!49 (g_vmids (globals (share (value_RData a!44)))))
      (a!50 (g_nr_lrs (globals (share (value_RData a!44)))))
      (a!51 (g_nr_aprs (globals (share (value_RData a!44)))))
      (a!52 (g_max_vintid (globals (share (value_RData a!44)))))
      (a!53 (g_pri_res0_mask (globals (share (value_RData a!44)))))
      (a!54 (g_default_gicstate (globals (share (value_RData a!44)))))
      (a!55 (g_status_handler (globals (share (value_RData a!44)))))
      (a!56 (g_rmm_trap_list (globals (share (value_RData a!44)))))
      (a!57 (g_tt_l3_buffer (globals (share (value_RData a!44)))))
      (a!58 (g_tt_l2_mem0_0 (globals (share (value_RData a!44)))))
      (a!59 (g_tt_l2_mem0_1 (globals (share (value_RData a!44)))))
      (a!60 (g_tt_l2_mem1_0 (globals (share (value_RData a!44)))))
      (a!61 (g_tt_l2_mem1_1 (globals (share (value_RData a!44)))))
      (a!62 (g_tt_l2_mem1_2 (globals (share (value_RData a!44)))))
      (a!63 (g_tt_l2_mem1_3 (globals (share (value_RData a!44)))))
      (a!64 (g_tt_l1_upper (globals (share (value_RData a!44)))))
      (a!65 (g_mbedtls_mem_buf (globals (share (value_RData a!44)))))
      (a!66 (g_granules (globals (share (value_RData a!44)))))
      (a!69 (g_rmm_attest_signing_key (globals (share (value_RData a!44)))))
      (a!70 (g_rmm_attest_public_key (globals (share (value_RData a!44)))))
      (a!71 (g_rmm_attest_public_key_len (globals (share (value_RData a!44)))))
      (a!72 (g_rmm_attest_public_key_hash (globals (share (value_RData a!44)))))
      (a!73 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!44)))))
      (a!74 (g_platform_token_buf (globals (share (value_RData a!44)))))
      (a!75 (g_rmm_platform_token (globals (share (value_RData a!44)))))
      (a!76 (g_get_realm_identity_identity (globals (share (value_RData a!44)))))
      (a!77 (g_realm_attest_private_key (globals (share (value_RData a!44))))))
(let ((a!67 (select a!66 (div (meta_granule_offset (test_PA.0_call a!43)) 4096))))
(let ((a!68 (store a!66
                   (div (meta_granule_offset (test_PA.0_call a!43)) 4096)
                   (mks_granule (e_lock a!67) 1 (e_ref a!67)))))
(let ((a!78 (mkShared (gpt (share (value_RData a!44)))
                      (granule_data (share (value_RData a!44)))
                      (mkGLOBALS a!45
                                 a!46
                                 a!47
                                 a!48
                                 ...
                                 a!76
                                 a!77))))
(let ((a!79 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call a!43)))
              (mkRData (log (value_RData a!44))
                       (oracle (value_RData a!44))
                       (repl (value_RData a!44))
                       (priv (value_RData a!44))
                       a!78
                       (stack (value_RData a!44))
                       (halt (value_RData a!44))))))
  (repl (value_RData a!79)))))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!79 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!44))
                       ...
                       (stack (value_RData a!44))
                       (halt (value_RData a!44))))))
  (oracle (value_RData a!79)))))))))))))))))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (let ((?x2450 (value_RData ?x2515)))
 (let ((?x84155 (share ?x2450)))
 (let ((?x2577 (gpt ?x84155)))
 (select ?x2577 ?x2565)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.757932 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2515 (spinlock_acquire_spec.0_call ?x2516 ?x2343)))
 (let ((?x2450 (value_RData ?x2515)))
 (let (($x2628 (halt ?x2450)))
 (let ((?x2593 (stack ?x2450)))
 (let ((?x56314 (mks_granule (e_lock (select (g_granules (globals (share ?x2450))) (div ?x2508 4096))) 1 (e_ref (select (g_granules (globals (share ?x2450))) (div ?x2508 4096))))))
 (let ((?x2565 (div ?x2508 4096)))
 (let ((?x84155 (share ?x2450)))
 (let ((?x2563 (globals ?x84155)))
 (let ((?x2509 (g_granules ?x2563)))
 (let ((?x2665 (store ?x2509 ?x2565 ?x56314)))
 (let ((?x2691 (mkGLOBALS (g_heap ?x2563) (g_debug_exits ?x2563) (g_vmid_count ?x2563) (g_vmid_lock ?x2563) (g_vmids ?x2563) (g_nr_lrs ?x2563) (g_nr_aprs ?x2563) (g_max_vintid ?x2563) (g_pri_res0_mask ?x2563) (g_default_gicstate ?x2563) (g_status_handler ?x2563) (g_rmm_trap_list ?x2563) (g_tt_l3_buffer ?x2563) (g_tt_l2_mem0_0 ?x2563) (g_tt_l2_mem0_1 ?x2563) (g_tt_l2_mem1_0 ?x2563) (g_tt_l2_mem1_1 ?x2563) (g_tt_l2_mem1_2 ?x2563) (g_tt_l2_mem1_3 ?x2563) (g_tt_l1_upper ?x2563) (g_mbedtls_mem_buf ?x2563) ?x2665 (g_rmm_attest_signing_key ?x2563) (g_rmm_attest_public_key ?x2563) (g_rmm_attest_public_key_len ?x2563) (g_rmm_attest_public_key_hash ?x2563) (g_rmm_attest_public_key_hash_len ?x2563) (g_platform_token_buf ?x2563) (g_rmm_platform_token ?x2563) (g_get_realm_identity_identity ?x2563) (g_realm_attest_private_key ?x2563))))
 (let ((?x2562 (granule_data ?x84155)))
 (let ((?x2577 (gpt ?x84155)))
 (let ((?x357 (priv ?x2450)))
 (let ((?x2482 (repl ?x2450)))
 (let ((?x2510 (oracle ?x2450)))
 (let ((?x2491 (log ?x2450)))
 (let ((?x2653 (mkRData ?x2491 ?x2510 ?x2482 ?x357 (mkShared ?x2577 ?x2562 ?x2691) ?x2593 $x2628)))
 (let ((?x2649 (granule_unlock_spec.0_call ?x2516 ?x2653)))
 (let ((?x2755 (value_RData ?x2649)))
 (let ((?x92045 (share ?x2755)))
 (let ((?x2754 (globals ?x92045)))
 (let ((?x2710 (g_granules ?x2754)))
 (let ((?x2751 (e_state_s_granule (select ?x2710 gidx.757932))))
 (let (($x2741 (= ?x2751 6)))
 (let (($x2772 (= ?x2751 0)))
 (=> (not (select (gpt ?x92045) gidx.757932)) (or $x2772 $x2741)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2724 (forall ((gidx.758120 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x92045 (share ?x2755)))
 (let ((?x2768 (log ?x2755)))
 (let ((?x2712 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!79 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!44))
                       ...
                       (stack (value_RData a!44))
                       (halt (value_RData a!44))))))
  (oracle (value_RData a!79)))))))))))))))))))))_call| ?x2768)))
 (let ((?x2707 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!79 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!44))
                       ...
                       (stack (value_RData a!44))
                       (halt (value_RData a!44))))))
  (repl (value_RData a!79)))))))))))))))))))))_call| ?x2712 ?x92045)))
 (let ((?x2743 (value_Shared ?x2707)))
 (let ((?x2734 (globals ?x2743)))
 (let ((?x2750 (g_granules ?x2734)))
 (let ((?x2666 (e_state_s_granule (select ?x2750 gidx.758120))))
 (let (($x2692 (= ?x2666 6)))
 (let (($x2688 (= ?x2666 0)))
 (let ((?x2722 (gpt ?x2743)))
 (let (($x2636 (select ?x2722 gidx.758120)))
 (or $x2636 $x2688 $x2692))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2684 (forall ((gidx.758103 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2755 (value_RData ?x2649)))
 (let ((?x92045 (share ?x2755)))
 (let ((?x2721 (gpt ?x92045)))
 (let (($x2789 (select ?x2721 gidx.758103)))
 (let ((?x2751 (e_state_s_granule (select (g_granules (globals ?x92045)) gidx.758103))))
 (let (($x2772 (= ?x2751 0)))
 (let (($x2741 (= ?x2751 6)))
 (or $x2741 $x2772 $x2789))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2684) $x2724))))
(assert
 (forall ((rtt_gidx.758225 Int) (ipa_gidx.758225 Int) (i.758225 Int) (d.758225 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2649 (granule_unlock_spec.0_call ?x2516 ?x2653)))
 (let ((?x2755 (value_RData ?x2649)))
 (let (($x2732 (halt ?x2755)))
 (let ((?x2728 (stack ?x2755)))
 (let ((?x92045 (share ?x2755)))
 (let ((?x2754 (globals ?x92045)))
 (let ((?x2721 (gpt ?x92045)))
 (let ((?x2727 (priv ?x2755)))
 (let ((?x2708 (repl ?x2755)))
 (let ((?x2719 (oracle ?x2755)))
 (let ((?x2768 (log ?x2755)))
 (let ((?x2846 (mkRData ?x2768 ?x2719 ?x2708 ?x2727 (mkShared ?x2721 (store (granule_data ?x92045) i.758225 d.758225) ?x2754) ?x2728 $x2732)))
 (let ((?x2810 (+ (rtt_walk_abs.0_call ?x2755 rtt_gidx.758225 ipa_gidx.758225) (* (- 1) (rtt_walk_abs.0_call ?x2846 rtt_gidx.758225 ipa_gidx.758225)))))
 (let (($x2814 (and (not (= (e_state_s_granule (select (g_granules ?x2754) i.758225)) 5)) (not (= (e_state_s_granule (select (g_granules ?x2754) i.758225)) 4)))))
 (=> $x2814 (= ?x2810 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2853 (forall ((gidx.758281 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2754 (globals ?x92045)))
 (let ((?x2710 (g_granules ?x2754)))
 (let ((?x2751 (e_state_s_granule (select ?x2710 gidx.758281))))
 (let (($x2741 (= ?x2751 6)))
 (let (($x2772 (= ?x2751 0)))
 (=> (not (select (gpt ?x92045) gidx.758281)) (or $x2772 $x2741)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2853)))
(check-sat)

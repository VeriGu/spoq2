...
(let ((a!41 (spinlock_acquire_spec.0_call
              ...
              (value_RData a!40))))
(let ((a!42 (g_heap (globals (share (value_RData a!41)))))
      (a!43 (g_debug_exits (globals (share (value_RData a!41)))))
      (a!44 (g_vmid_count (globals (share (value_RData a!41)))))
      (a!45 (g_vmid_lock (globals (share (value_RData a!41)))))
      (a!46 (g_vmids (globals (share (value_RData a!41)))))
      (a!47 (g_nr_lrs (globals (share (value_RData a!41)))))
      (a!48 (g_nr_aprs (globals (share (value_RData a!41)))))
      (a!49 (g_max_vintid (globals (share (value_RData a!41)))))
      (a!50 (g_pri_res0_mask (globals (share (value_RData a!41)))))
      (a!51 (g_default_gicstate (globals (share (value_RData a!41)))))
      (a!52 (g_status_handler (globals (share (value_RData a!41)))))
      (a!53 (g_rmm_trap_list (globals (share (value_RData a!41)))))
      (a!54 (g_tt_l3_buffer (globals (share (value_RData a!41)))))
      (a!55 (g_tt_l2_mem0_0 (globals (share (value_RData a!41)))))
      (a!56 (g_tt_l2_mem0_1 (globals (share (value_RData a!41)))))
      (a!57 (g_tt_l2_mem1_0 (globals (share (value_RData a!41)))))
      (a!58 (g_tt_l2_mem1_1 (globals (share (value_RData a!41)))))
      (a!59 (g_tt_l2_mem1_2 (globals (share (value_RData a!41)))))
      (a!60 (g_tt_l2_mem1_3 (globals (share (value_RData a!41)))))
      (a!61 (g_tt_l1_upper (globals (share (value_RData a!41)))))
      (a!62 (g_mbedtls_mem_buf (globals (share (value_RData a!41)))))
      (a!63 (g_granules (globals (share (value_RData a!41)))))
      (a!66 (g_rmm_attest_signing_key (globals (share (value_RData a!41)))))
      (a!67 (g_rmm_attest_public_key (globals (share (value_RData a!41)))))
      (a!68 (g_rmm_attest_public_key_len (globals (share (value_RData a!41)))))
      (a!69 (g_rmm_attest_public_key_hash (globals (share (value_RData a!41)))))
      (a!70 (g_rmm_attest_public_key_hash_len
              (globals (share (value_RData a!41)))))
      (a!71 (g_platform_token_buf (globals (share (value_RData a!41)))))
      (a!72 (g_rmm_platform_token (globals (share (value_RData a!41)))))
      (a!73 (g_get_realm_identity_identity (globals (share (value_RData a!41)))))
      (a!74 (g_realm_attest_private_key (globals (share (value_RData a!41))))))
(let ((a!64 (select a!63
                    (div (meta_granule_offset (test_PA.0_call v_0.0)) 4096))))
(let ((a!65 (store a!63
                   (div (meta_granule_offset (test_PA.0_call v_0.0)) 4096)
                   (mks_granule (e_lock a!64) 2 (e_ref a!64)))))
(let ((a!75 (mkShared (gpt (share (value_RData a!41)))
                      (granule_data (share (value_RData a!41)))
                      (mkGLOBALS a!42
                                 a!43
                                 a!44
                                 a!45
                                 ...
                                 a!73
                                 a!74))))
(let ((a!76 (granule_unlock_spec.0_call
              (mkPtr "granules" (meta_granule_offset (test_PA.0_call v_0.0)))
              (mkRData (log (value_RData a!41))
                       (oracle (value_RData a!41))
                       (repl (value_RData a!41))
                       (priv (value_RData a!41))
                       a!75
                       (stack (value_RData a!41))
                       (halt (value_RData a!41))))))
  (repl (value_RData a!76))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
...
(let ((a!76 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!41))
                       ...
                       (stack (value_RData a!41))
                       (halt (value_RData a!41))))))
  (oracle (value_RData a!76))))))))))))))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (let ((?x1895 (value_RData ?x6594)))
 (let ((?x68171 (share ?x1895)))
 (let ((?x2013 (granule_data ?x68171)))
 (let ((?x75983 (select ?x2013 ?x2015)))
 (let ((?x2097 (g_granule_state ?x75983)))
 (= ?x2097 2)))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.756667 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x6594 (spinlock_acquire_spec.0_call ?x6604 ?x1766)))
 (let ((?x1895 (value_RData ?x6594)))
 (let (($x2059 (halt ?x1895)))
 (let ((?x2052 (stack ?x1895)))
 (let ((?x2084 (mks_granule (e_lock (select (g_granules (globals (share ?x1895))) (div ?x1899 4096))) 2 (e_ref (select (g_granules (globals (share ?x1895))) (div ?x1899 4096))))))
 (let ((?x2015 (div ?x1899 4096)))
 (let ((?x68171 (share ?x1895)))
 (let ((?x2031 (globals ?x68171)))
 (let ((?x2019 (g_granules ?x2031)))
 (let ((?x48291 (store ?x2019 ?x2015 ?x2084)))
 (let ((?x2104 (mkGLOBALS (g_heap ?x2031) (g_debug_exits ?x2031) (g_vmid_count ?x2031) (g_vmid_lock ?x2031) (g_vmids ?x2031) (g_nr_lrs ?x2031) (g_nr_aprs ?x2031) (g_max_vintid ?x2031) (g_pri_res0_mask ?x2031) (g_default_gicstate ?x2031) (g_status_handler ?x2031) (g_rmm_trap_list ?x2031) (g_tt_l3_buffer ?x2031) (g_tt_l2_mem0_0 ?x2031) (g_tt_l2_mem0_1 ?x2031) (g_tt_l2_mem1_0 ?x2031) (g_tt_l2_mem1_1 ?x2031) (g_tt_l2_mem1_2 ?x2031) (g_tt_l2_mem1_3 ?x2031) (g_tt_l1_upper ?x2031) (g_mbedtls_mem_buf ?x2031) ?x48291 (g_rmm_attest_signing_key ?x2031) (g_rmm_attest_public_key ?x2031) (g_rmm_attest_public_key_len ?x2031) (g_rmm_attest_public_key_hash ?x2031) (g_rmm_attest_public_key_hash_len ?x2031) (g_platform_token_buf ?x2031) (g_rmm_platform_token ?x2031) (g_get_realm_identity_identity ?x2031) (g_realm_attest_private_key ?x2031))))
 (let ((?x2013 (granule_data ?x68171)))
 (let ((?x2023 (gpt ?x68171)))
 (let ((?x2010 (priv ?x1895)))
 (let ((?x1990 (repl ?x1895)))
 (let ((?x1996 (oracle ?x1895)))
 (let ((?x1971 (log ?x1895)))
 (let ((?x2123 (mkRData ?x1971 ?x1996 ?x1990 ?x2010 (mkShared ?x2023 ?x2013 ?x2104) ?x2052 $x2059)))
 (let ((?x2120 (granule_unlock_spec.0_call ?x6604 ?x2123)))
 (let ((?x2127 (value_RData ?x2120)))
 (let ((?x1989 (share ?x2127)))
 (let ((?x2206 (globals ?x1989)))
 (let ((?x2170 (g_granules ?x2206)))
 (let ((?x2208 (e_state_s_granule (select ?x2170 gidx.756667))))
 (let (($x2187 (= ?x2208 6)))
 (let (($x2184 (= ?x2208 0)))
 (=> (not (select (gpt ?x1989) gidx.756667)) (or $x2184 $x2187)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2246 (forall ((gidx.756855 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1989 (share ?x2127)))
 (let ((?x2167 (log ?x2127)))
 (let ((?x2176 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!76 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!41))
                       ...
                       (stack (value_RData a!41))
                       (halt (value_RData a!41))))))
  (oracle (value_RData a!76))))))))))))))))))_call| ?x2167)))
 (let ((?x1984 (|(let ((a!1 (memcpy_ns_read_spec.0_call
             (mkPtr "stack_s_realm_params" 0)
             (mkPtr "granule_data" (meta_granule_offset (test_PA.0_call v_1.0)))
             64
             st.0)))
...
(let ((a!76 (granule_unlock_spec.0_call
              ...
              (mkRData (log (value_RData a!41))
                       ...
                       (stack (value_RData a!41))
                       (halt (value_RData a!41))))))
  (repl (value_RData a!76))))))))))))))))))_call| ?x2176 ?x1989)))
 (let ((?x2169 (value_Shared ?x1984)))
 (let ((?x2225 (gpt ?x2169)))
 (let (($x2175 (select ?x2225 gidx.756855)))
 (let ((?x2155 (e_state_s_granule (select (g_granules (globals ?x2169)) gidx.756855))))
 (let (($x2159 (= ?x2155 6)))
 (let (($x2138 (= ?x2155 0)))
 (or $x2138 $x2159 $x2175))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2528 (forall ((gidx.756838 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1989 (share ?x2127)))
 (let ((?x2203 (gpt ?x1989)))
 (let (($x2219 (select ?x2203 gidx.756838)))
 (let ((?x2208 (e_state_s_granule (select (g_granules (globals ?x1989)) gidx.756838))))
 (let (($x2187 (= ?x2208 6)))
 (let (($x2184 (= ?x2208 0)))
 (or $x2184 $x2187 $x2219))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2528) $x2246))))
(assert
 (forall ((rtt_gidx.756960 Int) (ipa_gidx.756960 Int) (i.756960 Int) (d.756960 r_granule_data) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2120 (granule_unlock_spec.0_call ?x6604 ?x2123)))
 (let ((?x2127 (value_RData ?x2120)))
 (let (($x2193 (halt ?x2127)))
 (let ((?x2205 (stack ?x2127)))
 (let ((?x1989 (share ?x2127)))
 (let ((?x2206 (globals ?x1989)))
 (let ((?x2203 (gpt ?x1989)))
 (let ((?x2191 (priv ?x2127)))
 (let ((?x2172 (repl ?x2127)))
 (let ((?x2173 (oracle ?x2127)))
 (let ((?x2167 (log ?x2127)))
 (let ((?x2270 (mkRData ?x2167 ?x2173 ?x2172 ?x2191 (mkShared ?x2203 (store (granule_data ?x1989) i.756960 d.756960) ?x2206) ?x2205 $x2193)))
 (let ((?x2259 (+ (rtt_walk_abs.0_call ?x2127 rtt_gidx.756960 ipa_gidx.756960) (* (- 1) (rtt_walk_abs.0_call ?x2270 rtt_gidx.756960 ipa_gidx.756960)))))
 (let (($x2266 (and (not (= (e_state_s_granule (select (g_granules ?x2206) i.756960)) 5)) (not (= (e_state_s_granule (select (g_granules ?x2206) i.756960)) 4)))))
 (=> $x2266 (= ?x2259 0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2252 (forall ((gidx.757016 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x2206 (globals ?x1989)))
 (let ((?x2170 (g_granules ?x2206)))
 (let ((?x2208 (e_state_s_granule (select ?x2170 gidx.757016))))
 (let (($x2187 (= ?x2208 6)))
 (let (($x2184 (= ?x2208 0)))
 (=> (not (select (gpt ?x1989) gidx.757016)) (or $x2184 $x2187)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2252)))
(check-sat)

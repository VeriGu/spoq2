...
(assert
 (let (($x3465 (forall ((gidx.759714 Int) )(let ((?x1077 (test_PA.0_call v_1.0)))
 (let ((?x1104 (meta_granule_offset ?x1077)))
 (let ((?x1133 (mkPtr "granule_data" ?x1104)))
 (let ((?x993 (mkPtr "stack_s_realm_params" 0)))
 (let ((?x1132 (memcpy_ns_read_spec.0_call ?x993 ?x1133 64 st.0)))
 ...
 (let ((?x1283 (globals ?x24804)))
 (let ((?x1288 (g_granules ?x1283)))
 (let ((?x1295 (e_state_s_granule (select ?x1288 gidx.759714))))
 (let (($x1284 (= ?x1295 6)))
 (let (($x1287 (= ?x1295 0)))
 (=> (not (select (gpt ?x24804) gidx.759714)) (or $x1287 $x1284)))))))))))))))))))
 ))
 (not $x3465)))
(check-sat)

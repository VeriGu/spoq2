...
(assert
 (forall ((gidx.102337 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.102337)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.102337)) (or $x62 $x61))))))))))
 )
(assert
 (let (($x633 (forall ((gidx.109627 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x87 (gpt ?x17)))
 (let (($x102 (select ?x87 gidx.109627)))
 (let ((?x52 (globals ?x17)))
 (let ((?x53 (g_granules ?x52)))
 (let ((?x96 (select ?x53 gidx.109627)))
 (let ((?x98 (e_state_s_granule ?x96)))
 (let (($x100 (= ?x98 0)))
 (let (($x99 (= ?x98 6)))
 (or $x99 $x100 $x102)))))))))))))))
 ))
 (let (($x627 (forall ((gidx.109610 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (let (($x64 (select ?x48 gidx.109610)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.109610)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x62 (= ?x60 0)))
 (let (($x61 (= ?x60 6)))
 (or $x61 $x62 $x64)))))))))))
 ...
 (or (not $x627) $x633))))
(assert
 (forall ((v_0.110038 Int) )(let ((?x12 (share st.0)))
 (let ((?x48 (gpt ?x12)))
 (select ?x48 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.110038))) 4096)))))
 )
(assert
 (let ((?x278 (poffset v_1.0)))
 (let (($x279 (= ?x278 0)))
 (let ((?x267 (pbase v_1.0)))
 (let (($x276 (= ?x267 "stack_s_smc_result")))
 (and $x276 $x279))))))
(assert
 (= v_0.0 0))
(assert
 (let (($x458 (forall ((gidx.326328 Int) )(let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
 (let ((?x21 (g_granules ?x19)))
 (let ((?x59 (select ?x21 gidx.326328)))
 (let ((?x60 (e_state_s_granule ?x59)))
 (let (($x61 (= ?x60 6)))
 (let (($x62 (= ?x60 0)))
 (=> (not (select (gpt ?x12) gidx.326328)) (or $x62 $x61))))))))))
 ))
 (not $x458)))
(check-sat)

...
(declare-fun rtt_walk_abs.0_call (RData Int Int) Option_Z)
...
(declare-fun v_1.0 () Ptr)
(declare-fun v_0.0 () Int)
(assert
 (forall ((rtt_gidx.102351 Int) (ipa_gidx.102351 Int) (data_gidx.102351 Int) )(let ((?x81 (g_granule_state (select (granule_data (share st.0)) data_gidx.102351))))
 (let (($x82 (= ?x81 6)))
 (let (($x83 (= ?x81 4)))
 (let (($x85 (rtt_is_root.0_call rtt_gidx.102351)))
 (let (($x89 (= (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.102351)) 5)))
 (let ((?x91 (Some_Z data_gidx.102351)))
 (let ((?x92 (rtt_walk_abs.0_call st.0 rtt_gidx.102351 ipa_gidx.102351)))
 (let (($x93 (= ?x92 ?x91)))
 (=> (and $x93 $x89 $x85) (or $x83 $x82)))))))))))
 )
(assert
 (let (($x548 (forall ((rtt_gidx.110972 Int) (ipa_gidx.110972 Int) (data_gidx.110972 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x127 (globals ?x17)))
 (let ((?x128 (g_granules ?x127)))
 (let (($x155 (= (e_state_s_granule (select ?x128 rtt_gidx.110972)) 5)))
 (let (($x161 (not $x155)))
 (let ((?x148 (g_granule_state (select (granule_data ?x17) data_gidx.110972))))
 (let (($x150 (= ?x148 4)))
 (let (($x149 (= ?x148 6)))
 (let ((?x91 (Some_Z data_gidx.110972)))
 (let (($x34 (halt st.0)))
 (let ((?x33 (stack st.0)))
 (let ((?x18 (priv st.0)))
 (let ((?x14 (repl st.0)))
 (let ((?x9 (oracle st.0)))
 (let ((?x16 (List_Event_concat ?x10 ?x7)))
 (let ((?x99 (mkRData ?x16 ?x9 ?x14 ?x18 ?x17 ?x33 $x34)))
 (let ((?x157 (rtt_walk_abs.0_call ?x99 rtt_gidx.110972 ipa_gidx.110972)))
 (let (($x158 (= ?x157 ?x91)))
 (let (($x144 (not $x158)))
 (let (($x85 (rtt_is_root.0_call rtt_gidx.110972)))
 (let (($x74 (not $x85)))
 (or $x74 $x144 $x149 $x150 $x161)))))))))))))))))))))))))))
 ))
 (let (($x531 (forall ((rtt_gidx.110942 Int) (ipa_gidx.110942 Int) (data_gidx.110942 Int) )(let (($x89 (= (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.110942)) 5)))
 (let (($x96 (not $x89)))
 (let ((?x81 (g_granule_state (select (granule_data (share st.0)) data_gidx.110942))))
 (let (($x83 (= ?x81 4)))
 (let (($x82 (= ?x81 6)))
 (let ((?x91 (Some_Z data_gidx.110942)))
 (let ((?x92 (rtt_walk_abs.0_call st.0 rtt_gidx.110942 ipa_gidx.110942)))
 (let (($x93 (= ?x92 ?x91)))
 (let (($x76 (not $x93)))
 (let (($x85 (rtt_is_root.0_call rtt_gidx.110942)))
 (let (($x74 (not $x85)))
 (or $x74 $x76 $x82 $x83 $x96)))))))))))))
 ))
 (or (not $x531) $x548))))
(assert
 (forall ((v_0.111383 Int) )(let ((?x12 (share st.0)))
 (let ((?x140 (gpt ?x12)))
 (select ?x140 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.111383))) 4096)))))
 )
(assert
 (let ((?x330 (poffset v_1.0)))
 (let (($x331 (= ?x330 0)))
 (let ((?x320 (pbase v_1.0)))
 (let (($x328 (= ?x320 "stack_s_smc_result")))
 (and $x328 $x331))))))
(assert
 (= v_0.0 0))
(assert
 (let (($x672 (forall ((rtt_gidx.331907 Int) (ipa_gidx.331907 Int) (data_gidx.331907 Int) )(let ((?x81 (g_granule_state (select (granule_data (share st.0)) data_gidx.331907))))
 (let (($x82 (= ?x81 6)))
 (let (($x83 (= ?x81 4)))
 (let (($x85 (rtt_is_root.0_call rtt_gidx.331907)))
 (let (($x89 (= (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.331907)) 5)))
 (let ((?x91 (Some_Z data_gidx.331907)))
 (let ((?x92 (rtt_walk_abs.0_call st.0 rtt_gidx.331907 ipa_gidx.331907)))
 (let (($x93 (= ?x92 ?x91)))
 (=> (and $x93 $x89 $x85) (or $x83 $x82)))))))))))
 ))
 (not $x672)))

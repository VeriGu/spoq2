...
(assert
 (let (($x8751 (forall ((gidx.2467800 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x8329 (globals ?x727)))
 (let ((?x682 (g_granules ?x8329)))
 (let ((?x1067 (e_state_s_granule (select ?x682 gidx.2467800))))
 (=> (not (select (gpt ?x727) gidx.2467800)) (or (= ?x1067 0) (= ?x1067 6))))))))))))
 ))
 (not $x8751)))
(check-sat)

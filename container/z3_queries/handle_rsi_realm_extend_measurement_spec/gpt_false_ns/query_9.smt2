...
(assert
 ...
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x9137 (granule_data ?x8305)))
 (let ((?x19498 (select ?x9137 ?x8128)))
 (let ((?x176 (g_norm ?x19498)))
 (let ((?x192 (select ?x176 ?x479)))
 (let (($x1002 (not (<= 1 ?x192))))
 (not $x1002))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x402 (+ 40 ?x28)))
 ...
 (let ((?x8305 (share ?x8061)))
 (let ((?x9137 (granule_data ?x8305)))
 (let ((?x439 (select ?x9137 ?x368)))
 (let ((?x248 (g_norm ?x439)))
 (let ((?x493 (select ?x248 ?x549)))
 (let (($x8311 (<= ?x493 64)))
 (not $x8311))))))))))))))
(assert
 ...
 (let (($x8440 (= ?x8353 6)))
 (let (($x8434 (= ?x8353 0)))
 (=> (not (select (gpt ?x362) gidx.37866)) (or $x8434 $x8440))))))))))
 )
(assert
...
(assert
 (let (($x762 (forall ((gidx.2467499 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x986 (e_state_s_granule (select ?x380 gidx.2467499))))
 (=> (not (select (gpt ?x8305) gidx.2467499)) (or (= ?x986 0) (= ?x986 6))))))))))
 ))
 (not $x762)))
(check-sat)

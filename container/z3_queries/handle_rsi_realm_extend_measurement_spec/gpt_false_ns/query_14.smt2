...
(assert
 ...
 (let ((?x488 (div ?x28 4096)))
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x29622 (select ?x403 ?x488)))
 (let ((?x509 (e_state_s_granule ?x29622)))
 (= ?x509 3)))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8052 (mod ?x28 4096)))
 (let (($x528 (= ?x8052 0)))
 (let (($x33 (>= ?x28 0)))
 (let ((?x24 (pbase v_0.0)))
 (let (($x29624 (= ?x24 "granule_data")))
 (and $x29624 $x33 $x528))))))))
(assert
 (let ((?x8051 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8094 (pbase ?x8051)))
 (let (($x31294 (= ?x8094 "granules")))
 (not $x31294)))))
(assert
 (let ((?x8051 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8094 (pbase ?x8051)))
...
(assert
 ...
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (= ?x380 ?x403))))))))))
(assert
 (let ((?x8051 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8279 (poffset ?x8051)))
 (= ?x8279 0))))
(assert
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x400 (g_vmid_lock ?x363)))
 (let ((?x191 (e_val ?x400)))
 (= ?x191 None_Z))))))
(assert
 (let ((?x8051 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8279 (poffset ?x8051)))
 (let ((?x283 (div ?x8279 4096)))
 (let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x507 (select ?x380 ?x283)))
 (let ((?x122 (e_state_s_granule ?x507)))
 (let (($x1003 (= ?x122 2)))
 (not $x1003)))))))))))))
(assert
 (let ((?x8063 (query_oracle.0_call st.0)))
 ...
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x8329 (globals ?x727)))
 (let ((?x682 (g_granules ?x8329)))
 (= ?x682 ?x380))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8147 (+ 32 ?x28)))
 (let ((?x479 (mod ?x8147 4096)))
 (let ((?x8128 (div ?x8147 4096)))
 (let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x18912 (granule_data ?x727)))
 (let ((?x737 (select ?x18912 ?x8128)))
 (let ((?x8331 (g_norm ?x737)))
 (let ((?x10389 (select ?x8331 ?x479)))
 (let (($x428 (not (<= 1 ?x10389))))
 (not $x428))))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x402 (+ 40 ?x28)))
 (let ((?x549 (mod ?x402 4096)))
 (let ((?x368 (div ?x402 4096)))
 (let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x18912 (granule_data ?x727)))
 (let ((?x752 (select ?x18912 ?x368)))
 (let ((?x468 (g_norm ?x752)))
 (let ((?x753 (select ?x468 ?x549)))
 (let (($x8350 (<= ?x753 64)))
 (let (($x721 (not $x8350)))
 (not $x721)))))))))))))))))
(assert
 (forall ((gidx.37866 Int) )(let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x8421 (select ?x403 gidx.37866)))
 (let ((?x8353 (e_state_s_granule ?x8421)))
 (let (($x8440 (= ?x8353 6)))
 (let (($x8434 (= ?x8353 0)))
 (let (($x783 (or $x8434 $x8440)))
 (=> (not (select (gpt ?x362) gidx.37866)) $x783))))))))))
 )
(assert
 (forall ((v.38518 Int) )(let ((?x792 (make_return_code_para.0_call v.38518)))
 (let ((?x394 (pack_struct_return_code_para.0_call ?x792)))
 (and (distinct ?x394 0) true))))
 )
(assert
 (forall ((v.38394 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38394)) (* (- 1) v.38394)) 0))
 )
(assert
 (forall ((gidx.2467364 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x986 (e_state_s_granule (select ?x380 gidx.2467364))))
 (=> (not (select (gpt ?x8305) gidx.2467364)) (or (= ?x986 0) (= ?x986 6))))))))))
 )
(assert
 (forall ((v.2467374 Int) )(let ((?x792 (make_return_code_para.0_call v.2467374)))
 (let ((?x394 (pack_struct_return_code_para.0_call ?x792)))
 (and (distinct ?x394 0) true))))
 )
(assert
 (forall ((v.2467387 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2467387)) (* (- 1) v.2467387)) 0))
 )
(assert
 (forall ((gidx.2467665 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x8329 (globals ?x727)))
 (let ((?x682 (g_granules ?x8329)))
 (let ((?x1067 (e_state_s_granule (select ?x682 gidx.2467665))))
 (=> (not (select (gpt ?x727) gidx.2467665)) (or (= ?x1067 0) (= ?x1067 6))))))))))))
 )
(assert
 (forall ((v.2467675 Int) )(let ((?x792 (make_return_code_para.0_call v.2467675)))
 (let ((?x394 (pack_struct_return_code_para.0_call ?x792)))
 (and (distinct ?x394 0) true))))
 )
(assert
 (forall ((v.2467688 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2467688)) (* (- 1) v.2467688)) 0))
 )
(assert
 (let (($x8980 (forall ((gidx.2467856 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x707 (query_oracle.0_call ?x8061)))
 (let ((?x8323 (value_RData ?x707)))
 (let ((?x727 (share ?x8323)))
 (let ((?x8329 (globals ?x727)))
 (let ((?x682 (g_granules ?x8329)))
 (let ((?x1067 (e_state_s_granule (select ?x682 gidx.2467856))))
 (=> (not (select (gpt ?x727) gidx.2467856)) (or (= ?x1067 0) (= ?x1067 6))))))))))))
 ))
 (not $x8980)))
(check-sat)

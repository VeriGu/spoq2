...
(assert
 ...
 (let ((?x8068 (e_lock ?x507)))
 (let ((?x238 (e_val ?x8068)))
 (= ?x238 None_Z)))))))))))))
(assert
 (let ((?x8051 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8279 (poffset ?x8051)))
...
(assert
 (forall ((gidx.2466895 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x986 (e_state_s_granule (select ?x380 gidx.2466895))))
 (=> (not (select (gpt ?x8305) gidx.2466895)) (or (= ?x986 0) (= ?x986 6))))))))))
 )
(assert
 (forall ((v.2466905 Int) )(let ((?x792 (make_return_code_para.0_call v.2466905)))
 (let ((?x394 (pack_struct_return_code_para.0_call ?x792)))
 (and (distinct ?x394 0) true))))
 )
(assert
 (forall ((v.2466918 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2466918)) (* (- 1) v.2466918)) 0))
 )
(assert
 (let (($x1025 (forall ((gidx.2467086 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x986 (e_state_s_granule (select ?x380 gidx.2467086))))
 (=> (not (select (gpt ?x8305) gidx.2467086)) (or (= ?x986 0) (= ?x986 6))))))))))
 ))
 (not $x1025)))
(check-sat)

...
(assert
 (let (($x1030 (forall ((gidx.2467142 Int) )(let ((?x8063 (query_oracle.0_call st.0)))
 (let ((?x8061 (value_RData ?x8063)))
 (let ((?x8305 (share ?x8061)))
 (let ((?x205 (globals ?x8305)))
 (let ((?x380 (g_granules ?x205)))
 (let ((?x986 (e_state_s_granule (select ?x380 gidx.2467142))))
 (=> (not (select (gpt ?x8305) gidx.2467142)) (or (= ?x986 0) (= ?x986 6))))))))))
 ))
 (not $x1030)))
(check-sat)

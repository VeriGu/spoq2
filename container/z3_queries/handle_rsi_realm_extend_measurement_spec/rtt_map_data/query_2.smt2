...
(assert
 (let (($x816 (forall ((rtt_gidx.2467147 Int) (ipa_gidx.2467147 Int) (data_gidx.2467147 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x1009 (rtt_walk_abs.0_call ?x8067 rtt_gidx.2467147 ipa_gidx.2467147)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x1011 (g_granule_state (select ?x9184 ?x1009))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2467147)))
 (let (($x538 (=> (and (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x8308)) rtt_gidx.2467147)) 5) (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6))))))))))))
 ))
 (not $x816)))
(check-sat)

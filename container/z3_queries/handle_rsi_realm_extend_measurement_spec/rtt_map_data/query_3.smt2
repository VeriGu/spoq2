...
(assert
 ...
 (let ((?x8076 (e_lock ?x520)))
 (let ((?x397 (e_val ?x8076)))
 (= ?x397 None_Z)))))))))))))
(assert
 (let ((?x8057 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8276 (poffset ?x8057)))
...
(assert
 (forall ((rtt_gidx.2466964 Int) (ipa_gidx.2466964 Int) (data_gidx.2466964 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x1009 (rtt_walk_abs.0_call ?x8067 rtt_gidx.2466964 ipa_gidx.2466964)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x1011 (g_granule_state (select ?x9184 ?x1009))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2466964)))
 (let (($x538 (=> (and (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x8308)) rtt_gidx.2466964)) 5) (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6))))))))))))
 )
(assert
 (forall ((v.2466974 Int) )(let ((?x796 (make_return_code_para.0_call v.2466974)))
 (let ((?x797 (pack_struct_return_code_para.0_call ?x796)))
 (and (distinct ?x797 0) true))))
 )
(assert
 (forall ((v.2466987 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2466987)) (* (- 1) v.2466987)) 0))
 )
(assert
 (let (($x11523 (forall ((rtt_gidx.2467227 Int) (ipa_gidx.2467227 Int) (data_gidx.2467227 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x1009 (rtt_walk_abs.0_call ?x8067 rtt_gidx.2467227 ipa_gidx.2467227)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x1011 (g_granule_state (select ?x9184 ?x1009))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2467227)))
 (let (($x538 (=> (and (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x8308)) rtt_gidx.2467227)) 5) (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6))))))))))))
 ))
 (not $x11523)))
(check-sat)

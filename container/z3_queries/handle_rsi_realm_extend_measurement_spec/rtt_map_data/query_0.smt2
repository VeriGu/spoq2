...
(assert
 ...
 (let (($x790 (=> (and (and (distinct ?x783 (- 1)) true) (rtt_is_root.0_call rtt_gidx.37887)) (or (= ?x785 4) (= ?x785 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x362)) rtt_gidx.37887)) 5) (and (distinct ?x783 (- 1)) true) (rtt_is_root.0_call rtt_gidx.37887)) (or (= ?x785 4) (= ?x785 6)))))))))
 )
(assert
...
(assert
 (let (($x686 (forall ((rtt_gidx.2466885 Int) (ipa_gidx.2466885 Int) (data_gidx.2466885 Int) )(let ((?x783 (rtt_walk_abs.0_call st.0 rtt_gidx.2466885 ipa_gidx.2466885)))
 (let ((?x362 (share st.0)))
 (let ((?x8471 (granule_data ?x362)))
 (let ((?x785 (g_granule_state (select ?x8471 ?x783))))
 (let (($x790 (=> (and (and (distinct ?x783 (- 1)) true) (rtt_is_root.0_call rtt_gidx.2466885)) (or (= ?x785 4) (= ?x785 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x362)) rtt_gidx.2466885)) 5) (and (distinct ?x783 (- 1)) true) (rtt_is_root.0_call rtt_gidx.2466885)) (or (= ?x785 4) (= ?x785 6)))))))))
 ))
 (not $x686)))
(check-sat)

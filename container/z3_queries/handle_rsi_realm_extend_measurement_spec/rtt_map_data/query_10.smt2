...
(assert
 ...
 (let ((?x25071 (select ?x9184 ?x8135)))
 (let ((?x203 (g_norm ?x25071)))
 (let ((?x257 (select ?x203 ?x514)))
 (let (($x8513 (not (<= 1 ?x257))))
 (not $x8513))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x29605 (+ 40 ?x28)))
 ...
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x429 (select ?x9184 ?x499)))
 (let ((?x223 (g_norm ?x429)))
 (let ((?x352 (select ?x223 ?x554)))
 (let (($x8275 (<= ?x352 64)))
 (let (($x1047 (not $x8275)))
 (not $x1047)))))))))))))))
(assert
...
(assert
 (let (($x8740 (forall ((rtt_gidx.2467888 Int) (ipa_gidx.2467888 Int) (data_gidx.2467888 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x1009 (rtt_walk_abs.0_call ?x8067 rtt_gidx.2467888 ipa_gidx.2467888)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x1011 (g_granule_state (select ?x9184 ?x1009))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2467888)))
 (let (($x538 (=> (and (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x8308)) rtt_gidx.2467888)) 5) (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6))))))))))))
 ))
 (not $x8740)))
(check-sat)

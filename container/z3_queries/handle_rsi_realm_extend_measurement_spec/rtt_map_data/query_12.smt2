...
(assert
 (let (($x1196 (forall ((rtt_gidx.2468149 Int) (ipa_gidx.2468149 Int) (data_gidx.2468149 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x1116 (rtt_walk_abs.0_call ?x8320 rtt_gidx.2468149 ipa_gidx.2468149)))
 (let ((?x725 (share ?x8320)))
 (let ((?x16269 (granule_data ?x725)))
 (let ((?x1160 (g_granule_state (select ?x16269 ?x1116))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2468149)))
 (let (($x8938 (=> (and (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x725)) rtt_gidx.2468149)) 5) (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6))))))))))))))
 ))
 (not $x1196)))
(check-sat)

...
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x29626 (div ?x28 4096)))
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x398 (select ?x403 ?x29626)))
 (let ((?x31293 (e_state_s_granule ?x398)))
 (= ?x31293 3)))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8060 (mod ?x28 4096)))
 (let (($x205 (= ?x8060 0)))
 (let (($x33 (>= ?x28 0)))
 (let ((?x24 (pbase v_0.0)))
 (let (($x63596 (= ?x24 "granule_data")))
 (and $x63596 $x33 $x205))))))))
(assert
 (let ((?x8057 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8090 (pbase ?x8057)))
 (let (($x343 (= ?x8090 "granules")))
 (not $x343)))))
(assert
 (let ((?x8057 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8090 (pbase ?x8057)))
...
(assert
 ...
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x507 (globals ?x8308)))
 (let ((?x264 (g_granules ?x507)))
 (= ?x264 ?x403))))))))))
(assert
 (let ((?x8057 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8276 (poffset ?x8057)))
 (= ?x8276 0))))
(assert
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x503 (g_vmid_lock ?x363)))
 (let ((?x83 (e_val ?x503)))
 (= ?x83 None_Z))))))
(assert
 (let ((?x8057 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8276 (poffset ?x8057)))
 (let ((?x29615 (div ?x8276 4096)))
 (let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x507 (globals ?x8308)))
 (let ((?x264 (g_granules ?x507)))
 (let ((?x520 (select ?x264 ?x29615)))
 (let ((?x467 (e_state_s_granule ?x520)))
 (let (($x825 (= ?x467 2)))
 (not $x825)))))))))))))
(assert
 (let ((?x8071 (query_oracle.0_call st.0)))
 ...
 (let ((?x507 (globals ?x8308)))
 (let ((?x264 (g_granules ?x507)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x725 (share ?x8320)))
 (let ((?x8329 (globals ?x725)))
 (let ((?x675 (g_granules ?x8329)))
 (= ?x675 ?x264))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8159 (+ 32 ?x28)))
 (let ((?x514 (mod ?x8159 4096)))
 (let ((?x8135 (div ?x8159 4096)))
 (let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x725 (share ?x8320)))
 (let ((?x16269 (granule_data ?x725)))
 (let ((?x17957 (select ?x16269 ?x8135)))
 (let ((?x728 (g_norm ?x17957)))
 (let ((?x8327 (select ?x728 ?x514)))
 (let (($x1165 (not (<= 1 ?x8327))))
 (not $x1165))))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x29605 (+ 40 ?x28)))
 (let ((?x554 (mod ?x29605 4096)))
 (let ((?x499 (div ?x29605 4096)))
 (let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x725 (share ?x8320)))
 (let ((?x16269 (granule_data ?x725)))
 (let ((?x741 (select ?x16269 ?x499)))
 (let ((?x742 (g_norm ?x741)))
 (let ((?x743 (select ?x742 ?x554)))
 (let (($x8424 (<= ?x743 64)))
 (let (($x1145 (not $x8424)))
 (not $x1145)))))))))))))))))
(assert
 (forall ((rtt_gidx.37887 Int) (ipa_gidx.37887 Int) (data_gidx.37887 Int) )(let ((?x783 (rtt_walk_abs.0_call st.0 rtt_gidx.37887 ipa_gidx.37887)))
 (let ((?x362 (share st.0)))
 (let ((?x8471 (granule_data ?x362)))
 (let ((?x785 (g_granule_state (select ?x8471 ?x783))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.37887)))
 (let (($x790 (=> (and (and (distinct ?x783 (- 1)) true) $x345) (or (= ?x785 4) (= ?x785 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x362)) rtt_gidx.37887)) 5) (and (distinct ?x783 (- 1)) true) $x345) (or (= ?x785 4) (= ?x785 6))))))))))
 )
(assert
 (forall ((v.38539 Int) )(let ((?x796 (make_return_code_para.0_call v.38539)))
 (let ((?x797 (pack_struct_return_code_para.0_call ?x796)))
 (and (distinct ?x797 0) true))))
 )
(assert
 (forall ((v.38415 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38415)) (* (- 1) v.38415)) 0))
 )
(assert
 (forall ((rtt_gidx.2467625 Int) (ipa_gidx.2467625 Int) (data_gidx.2467625 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x1009 (rtt_walk_abs.0_call ?x8067 rtt_gidx.2467625 ipa_gidx.2467625)))
 (let ((?x8308 (share ?x8067)))
 (let ((?x9184 (granule_data ?x8308)))
 (let ((?x1011 (g_granule_state (select ?x9184 ?x1009))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2467625)))
 (let (($x538 (=> (and (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x8308)) rtt_gidx.2467625)) 5) (and (distinct ?x1009 (- 1)) true) $x345) (or (= ?x1011 4) (= ?x1011 6))))))))))))
 )
(assert
 (forall ((v.2467635 Int) )(let ((?x796 (make_return_code_para.0_call v.2467635)))
 (let ((?x797 (pack_struct_return_code_para.0_call ?x796)))
 (and (distinct ?x797 0) true))))
 )
(assert
 (forall ((v.2467648 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2467648)) (* (- 1) v.2467648)) 0))
 )
(assert
 (forall ((rtt_gidx.2468046 Int) (ipa_gidx.2468046 Int) (data_gidx.2468046 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x1116 (rtt_walk_abs.0_call ?x8320 rtt_gidx.2468046 ipa_gidx.2468046)))
 (let ((?x725 (share ?x8320)))
 (let ((?x16269 (granule_data ?x725)))
 (let ((?x1160 (g_granule_state (select ?x16269 ?x1116))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2468046)))
 (let (($x8938 (=> (and (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x725)) rtt_gidx.2468046)) 5) (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6))))))))))))))
 )
(assert
 (forall ((v.2468056 Int) )(let ((?x796 (make_return_code_para.0_call v.2468056)))
 (let ((?x797 (pack_struct_return_code_para.0_call ?x796)))
 (and (distinct ?x797 0) true))))
 )
(assert
 (forall ((v.2468069 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2468069)) (* (- 1) v.2468069)) 0))
 )
(assert
 (let (($x9028 (forall ((rtt_gidx.2468309 Int) (ipa_gidx.2468309 Int) (data_gidx.2468309 Int) )(let ((?x8071 (query_oracle.0_call st.0)))
 (let ((?x8067 (value_RData ?x8071)))
 (let ((?x700 (query_oracle.0_call ?x8067)))
 (let ((?x8320 (value_RData ?x700)))
 (let ((?x1116 (rtt_walk_abs.0_call ?x8320 rtt_gidx.2468309 ipa_gidx.2468309)))
 (let ((?x725 (share ?x8320)))
 (let ((?x16269 (granule_data ?x725)))
 (let ((?x1160 (g_granule_state (select ?x16269 ?x1116))))
 (let (($x345 (rtt_is_root.0_call rtt_gidx.2468309)))
 (let (($x8938 (=> (and (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6)))))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x725)) rtt_gidx.2468309)) 5) (and (distinct ?x1116 (- 1)) true) $x345) (or (= ?x1160 4) (= ?x1160 6))))))))))))))
 ))
 (not $x9028)))
(check-sat)

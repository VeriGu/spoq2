...
(assert
 (let (($x1048 (forall ((gidx.2467444 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x16024 (granule_data ?x692)))
 (let ((?x1006 (select ?x16024 gidx.2467444)))
 (let (($x1017 (= (g_norm ?x1006) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x692)) gidx.2467444)) 1) $x1017))))))))))
 ))
 (not $x1048)))
(check-sat)

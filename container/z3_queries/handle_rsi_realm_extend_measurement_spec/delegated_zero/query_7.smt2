...
(assert
 (let (($x941 (forall ((gidx.2467135 Int) )(let (($x8372 (= (g_norm (select (granule_data (share st.0)) gidx.2467135)) zero_granule_data)))
 (let (($x8326 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.2467135)) 1)))
 (=> $x8326 $x8372))))
 ))
 (not $x941)))
(check-sat)

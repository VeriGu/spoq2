...
(assert
 ...
 (let ((?x8020 (e_lock ?x343)))
 (let ((?x397 (e_val ?x8020)))
 (= ?x397 None_Z)))))))))))))
(assert
 (let ((?x8019 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8258 (poffset ?x8019)))
...
(assert
 (forall ((gidx.2466847 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x54431 (select ?x9165 gidx.2466847)))
 (let (($x8441 (= (g_norm ?x54431) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8279)) gidx.2466847)) 1) $x8441))))))))
 )
(assert
 (forall ((v.2466857 Int) )(let ((?x746 (make_return_code_para.0_call v.2466857)))
 (let ((?x747 (pack_struct_return_code_para.0_call ?x746)))
 (and (distinct ?x747 0) true))))
 )
(assert
 (forall ((v.2466870 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2466870)) (* (- 1) v.2466870)) 0))
 )
(assert
 (let (($x8620 (forall ((gidx.2467098 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x54431 (select ?x9165 gidx.2467098)))
 (let (($x8441 (= (g_norm ?x54431) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8279)) gidx.2467098)) 1) $x8441))))))))
 ))
 (not $x8620)))
(check-sat)

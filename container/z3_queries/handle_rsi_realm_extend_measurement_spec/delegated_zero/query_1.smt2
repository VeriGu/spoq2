...
(assert
 (let (($x979 (forall ((gidx.2466908 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x54431 (select ?x9165 gidx.2466908)))
 (let (($x8441 (= (g_norm ?x54431) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8279)) gidx.2466908)) 1) $x8441))))))))
 ))
 (not $x979)))
(check-sat)

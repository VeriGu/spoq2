...
(assert
 ...
 (let ((?x20703 (select ?x9165 ?x8090)))
 (let ((?x203 (g_norm ?x20703)))
 (let ((?x257 (select ?x203 ?x216)))
 (let (($x974 (not (<= 1 ?x257))))
 (not $x974))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 ...
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x476 (select ?x9165 ?x73708)))
 (let ((?x369 (g_norm ?x476)))
 (let ((?x352 (select ?x369 ?x73732)))
 (let (($x8291 (<= ?x352 64)))
 (not $x8291))))))))))))))
(assert
...
(assert
 (let (($x1010 (forall ((gidx.2467271 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x54431 (select ?x9165 gidx.2467271)))
 (let (($x8441 (= (g_norm ?x54431) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8279)) gidx.2467271)) 1) $x8441))))))))
 ))
 (not $x1010)))
(check-sat)

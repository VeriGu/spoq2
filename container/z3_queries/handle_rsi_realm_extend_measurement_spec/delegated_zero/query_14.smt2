...
(assert
 ...
 (let ((?x489 (div ?x28 4096)))
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x73692 (select ?x403 ?x489)))
 (let ((?x510 (e_state_s_granule ?x73692)))
 (= ?x510 3)))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8013 (mod ?x28 4096)))
 (let (($x73702 (= ?x8013 0)))
 (let (($x33 (>= ?x28 0)))
 (let ((?x24 (pbase v_0.0)))
 (let (($x73694 (= ?x24 "granule_data")))
 (and $x73694 $x33 $x73702))))))))
(assert
 (let ((?x8019 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8054 (pbase ?x8019)))
 (let (($x205 (= ?x8054 "granules")))
 (not $x205)))))
(assert
 (let ((?x8019 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8054 (pbase ?x8019)))
...
(assert
 ...
 (let ((?x363 (globals ?x362)))
 (let ((?x403 (g_granules ?x363)))
 (let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x73501 (globals ?x8279)))
 (let ((?x508 (g_granules ?x73501)))
 (= ?x508 ?x403))))))))))
(assert
 (let ((?x8019 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8258 (poffset ?x8019)))
 (= ?x8258 0))))
(assert
 (let ((?x362 (share st.0)))
 (let ((?x363 (globals ?x362)))
 (let ((?x504 (g_vmid_lock ?x363)))
 (let ((?x83 (e_val ?x504)))
 (= ?x83 None_Z))))))
(assert
 (let ((?x8019 (rec_to_rd_para.0_call v_0.0 st.0)))
 (let ((?x8258 (poffset ?x8019)))
 (let ((?x73513 (div ?x8258 4096)))
 (let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x73501 (globals ?x8279)))
 (let ((?x508 (g_granules ?x73501)))
 (let ((?x343 (select ?x508 ?x73513)))
 (let ((?x54458 (e_state_s_granule ?x343)))
 (let (($x767 (= ?x54458 2)))
 (not $x767)))))))))))))
(assert
 (let ((?x8025 (query_oracle.0_call st.0)))
 ...
 (let ((?x73501 (globals ?x8279)))
 (let ((?x508 (g_granules ?x73501)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x8346 (globals ?x692)))
 (let ((?x602 (g_granules ?x8346)))
 (= ?x602 ?x508))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x8116 (+ 32 ?x28)))
 (let ((?x216 (mod ?x8116 4096)))
 (let ((?x8090 (div ?x8116 4096)))
 (let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x16024 (granule_data ?x692)))
 (let ((?x21803 (select ?x16024 ?x8090)))
 (let ((?x695 (g_norm ?x21803)))
 (let ((?x8343 (select ?x695 ?x216)))
 (let (($x230 (not (<= 1 ?x8343))))
 (not $x230))))))))))))))))
(assert
 (let ((?x28 (poffset v_0.0)))
 (let ((?x73710 (+ 40 ?x28)))
 (let ((?x73732 (mod ?x73710 4096)))
 (let ((?x73708 (div ?x73710 4096)))
 (let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x16024 (granule_data ?x692)))
 (let ((?x709 (select ?x16024 ?x73708)))
 (let ((?x710 (g_norm ?x709)))
 (let ((?x711 (select ?x710 ?x73732)))
 (let (($x15978 (<= ?x711 64)))
 (let (($x8675 (not $x15978)))
 (not $x8675)))))))))))))))))
(assert
 (forall ((gidx.37854 Int) )(let (($x8372 (= (g_norm (select (granule_data (share st.0)) gidx.37854)) zero_granule_data)))
 (let (($x8326 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.37854)) 1)))
 (=> $x8326 $x8372))))
 )
(assert
 (forall ((v.38506 Int) )(let ((?x746 (make_return_code_para.0_call v.38506)))
 (let ((?x747 (pack_struct_return_code_para.0_call ?x746)))
 (and (distinct ?x747 0) true))))
 )
(assert
 (forall ((v.38382 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.38382)) (* (- 1) v.38382)) 0))
 )
(assert
 (forall ((gidx.2467172 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x8279 (share ?x8029)))
 (let ((?x9165 (granule_data ?x8279)))
 (let ((?x54431 (select ?x9165 gidx.2467172)))
 (let (($x8441 (= (g_norm ?x54431) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x8279)) gidx.2467172)) 1) $x8441))))))))
 )
(assert
 (forall ((v.2467182 Int) )(let ((?x746 (make_return_code_para.0_call v.2467182)))
 (let ((?x747 (pack_struct_return_code_para.0_call ?x746)))
 (and (distinct ?x747 0) true))))
 )
(assert
 (forall ((v.2467195 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2467195)) (* (- 1) v.2467195)) 0))
 )
(assert
 (forall ((gidx.2467383 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x16024 (granule_data ?x692)))
 (let ((?x1006 (select ?x16024 gidx.2467383)))
 (let (($x1017 (= (g_norm ?x1006) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x692)) gidx.2467383)) 1) $x1017))))))))))
 )
(assert
 (forall ((v.2467393 Int) )(let ((?x746 (make_return_code_para.0_call v.2467393)))
 (let ((?x747 (pack_struct_return_code_para.0_call ?x746)))
 (and (distinct ?x747 0) true))))
 )
(assert
 (forall ((v.2467406 Int) )(= (+ (test_PTE_Z.0_call (test_Z_PTE.0_call v.2467406)) (* (- 1) v.2467406)) 0))
 )
(assert
 (let (($x1046 (forall ((gidx.2467520 Int) )(let ((?x8025 (query_oracle.0_call st.0)))
 (let ((?x8029 (value_RData ?x8025)))
 (let ((?x667 (query_oracle.0_call ?x8029)))
 (let ((?x8337 (value_RData ?x667)))
 (let ((?x692 (share ?x8337)))
 (let ((?x16024 (granule_data ?x692)))
 (let ((?x1006 (select ?x16024 gidx.2467520)))
 (let (($x1017 (= (g_norm ?x1006) zero_granule_data)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x692)) gidx.2467520)) 1) $x1017))))))))))
 ))
 (not $x1046)))
(check-sat)

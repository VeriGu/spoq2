...
(declare-fun n.0 () Int)
(declare-fun c.0 () Int)
(declare-fun v_s.0 () Ptr)
(assert
 (forall ((gidx.66617 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.66617)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.66617)) 1)))
 (=> $x62 $x59))))
 )
(assert
 (let (($x783 (forall ((gidx.71671 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 (let ((?x10 (|(oracle st.0)_call| ?x7)))
 (let ((?x15 (|(repl st.0)_call| ?x10 ?x12)))
 (let ((?x17 (value_Shared ?x15)))
 (let ((?x53 (granule_data ?x17)))
 (let ((?x93 (select ?x53 gidx.71671)))
 (let (($x95 (= (g_norm ?x93) zero_granule_data)))
 (let (($x98 (= (e_state_s_granule (select (g_granules (globals ?x17)) gidx.71671)) 1)))
 (or (not $x98) $x95)))))))))))
 ))
 (let (($x795 (forall ((gidx.71660 Int) )(let (($x59 (= (g_norm (select (granule_data (share st.0)) gidx.71660)) zero_granule_data)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals (share st.0))) gidx.71660)) 1)))
 (or (not $x62) $x59))))
 ))
 (or (not $x795) $x783))))
(assert
 (let (($x1513 (= n.0 4096)))
 (let (($x1510 (= c.0 0)))
 (let ((?x10257 (pbase v_s.0)))
 (let (($x1536 (= ?x10257 "granule_data")))
 (and $x1536 $x1510 $x1513))))))
(assert
 (let (($x1574 (forall ((gidx.289036 Int) )(let ((?x1539 (poffset v_s.0)))
 (let ((?x1519 (div ?x1539 4096)))
 (let ((?x12 (share st.0)))
 (let ((?x19 (granule_data ?x12)))
 (let ((?x1545 (select ?x19 ?x1519)))
 (let ((?x1577 (g_rec ?x1545)))
 (let ((?x1578 (g_rd ?x1545)))
 (let ((?x1561 (g_granule_state ?x1545)))
 (let ((?x1543 (gd_g_idx ?x1545)))
 (let ((?x1533 (mkr_granule_data ?x1543 ?x1561 zero_granule_data ?x1578 ?x1577)))
 (let ((?x1534 (store ?x19 ?x1519 ?x1533)))
 (let (($x62 (= (e_state_s_granule (select (g_granules (globals ?x12)) gidx.289036)) 1)))
 (=> $x62 (= (g_norm (select ?x1534 gidx.289036)) zero_granule_data)))))))))))))))
 ))
 (not $x1574)))
(check-sat)

...
(assert
 ...
 (let (($x1201 (= ?x1200 0)))
 (let (($x1210 (and $x1201 $x1204 $x1208)))
 (not $x1210))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2397809 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x1086 (elem_0 ?x1040)))
 (let ((?x1190 (e_2 ?x1086)))
 (let ((?x89654 (granule_unlock_spec.0_call ?x1190 ?x1117)))
 (let ((?x26609 (value_RData ?x89654)))
 (let ((?x93479 (share ?x26609)))
 (let ((?x1770 (granule_data ?x93479)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x93479)) gidx.2397809)) 1) (= (g_norm (select ?x1770 gidx.2397809)) zero_granule_data))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2397883 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x89654 (granule_unlock_spec.0_call ?x1190 ?x1117)))
 (let ((?x26609 (value_RData ?x89654)))
 (let ((?x383 (granule_unlock_spec.0_call ?x958 ?x26609)))
 (let ((?x1780 (value_RData ?x383)))
 (let ((?x26656 (share ?x1780)))
 (let ((?x26670 (granule_data ?x26656)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x26656)) gidx.2397883)) 1) (= (g_norm (select ?x26670 gidx.2397883)) zero_granule_data))))))))))))))))))))))))))
 )
(assert
 (let (($x1744 (forall ((gidx.2397921 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x26656 (share ?x1780)))
 (let ((?x26670 (granule_data ?x26656)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x26656)) gidx.2397921)) 1) (= (g_norm (select ?x26670 gidx.2397921)) zero_granule_data))))))))))))))))))))))))))
 ))
 (not $x1744)))
(check-sat)

...
(assert
 ...
 (not $x1145))))))))))))))))))))
(assert
 (forall ((gidx.2398181 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x961 (spinlock_acquire_spec.0_call ?x1020 ?x1067)))
 (let ((?x1073 (value_RData ?x961)))
 (let ((?x82184 (spinlock_release_spec.0_call ?x1020 ?x1073)))
 (let ((?x34771 (value_RData ?x82184)))
 (let ((?x26778 (share ?x34771)))
 (let ((?x34514 (granule_data ?x26778)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x26778)) gidx.2398181)) 1) (= (g_norm (select ?x34514 gidx.2398181)) zero_granule_data))))))))))))))))))
 )
(assert
 (let (($x26831 (forall ((gidx.2398219 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x26778 (share ?x34771)))
 (let ((?x34514 (granule_data ?x26778)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x26778)) gidx.2398219)) 1) (= (g_norm (select ?x34514 gidx.2398219)) zero_granule_data))))))))))))))))))
 ))
 (not $x26831)))
(check-sat)

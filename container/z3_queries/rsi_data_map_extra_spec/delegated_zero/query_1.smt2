...
(assert
 ...
 (let ((?x1022 (elem_1 ?x35446)))
 (let ((?x1017 (share ?x1022)))
 (let ((?x30994 (globals ?x1017)))
 (let ((?x48264 (g_vmid_lock ?x30994)))
 (let ((?x48495 (e_val ?x48264)))
 (= ?x48495 None_Z))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x29734 (query_oracle.0_call st.0)))
 (let ((?x626 (value_RData ?x29734)))
 ...
 (= ?x39992 2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.6635866 Int) )(let ((?x29734 (query_oracle.0_call st.0)))
 (let ((?x626 (value_RData ?x29734)))
 (let (($x86329 (halt ?x626)))
 (let ((?x24406 (stack ?x626)))
 (let ((?x34941 (share ?x626)))
 ...
 (=> (= (e_state_s_granule (select (g_granules (globals ?x73531)) gidx.6635866)) 1) (= (g_norm (select ?x75623 gidx.6635866)) zero_granule_data))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x29734 (query_oracle.0_call st.0)))
 (let ((?x626 (value_RData ?x29734)))
...
(assert
 ...
 (= ?x61655 8))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x26632 (forall ((gidx.6636365 Int) )(let ((?x29734 (query_oracle.0_call st.0)))
 (let ((?x626 (value_RData ?x29734)))
 (let (($x86329 (halt ?x626)))
 (let ((?x24406 (stack ?x626)))
 (let ((?x34941 (share ?x626)))
 ...
 (=> (= (e_state_s_granule (select ?x32162 gidx.6636365)) 1) (= (g_norm (select ?x40019 gidx.6636365)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x26632)))
(check-sat)

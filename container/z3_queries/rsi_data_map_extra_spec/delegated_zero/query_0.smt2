...
(assert
 ...
 (not $x994)))))))))))))))
(assert
 (forall ((gidx.2398293 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 (let ((?x1067 (value_RData ?x1029)))
 (let ((?x68239 (spinlock_release_spec.0_call ?x958 ?x1067)))
 (let ((?x26833 (value_RData ?x68239)))
 (let ((?x10811 (share ?x26833)))
 (let ((?x1816 (granule_data ?x10811)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x10811)) gidx.2398293)) 1) (= (g_norm (select ?x1816 gidx.2398293)) zero_granule_data)))))))))))))
 )
(assert
 (let (($x1834 (forall ((gidx.2398331 Int) )(let ((?x2194 (test_Z_PTE.0_call v_2.0)))
 (let ((?x1580 (meta_PA ?x2194)))
 (let ((?x8877 (meta_granule_offset ?x1580)))
 (let ((?x958 (mkPtr "granules" ?x8877)))
 (let ((?x1029 (spinlock_acquire_spec.0_call ?x958 st.0)))
 ...
 (let ((?x10811 (share ?x26833)))
 (let ((?x1816 (granule_data ?x10811)))
 (=> (= (e_state_s_granule (select (g_granules (globals ?x10811)) gidx.2398331)) 1) (= (g_norm (select ?x1816 gidx.2398331)) zero_granule_data)))))))))))))
 ))
 (not $x1834)))
(check-sat)

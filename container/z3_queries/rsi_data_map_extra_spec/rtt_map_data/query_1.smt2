...
(assert
 ...
 (and $x19946 $x14483))))))))
(assert
 (let (($x31382 (forall ((rtt_gidx.28889056 Int) (ipa_gidx.28889056 Int) (data_gidx.28889056 Int) )(let ((?x39978 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x39978)))
 (let ((?x39191 (share ?x560)))
 (let ((?x86432 (granule_data ?x39191)))
 (let ((?x40092 (g_granule_state (select ?x86432 (rtt_walk_abs.0_call ?x560 rtt_gidx.28889056 ipa_gidx.28889056)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.28889056)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x39191)) rtt_gidx.28889056)) 5) $x142) (or (= ?x40092 4) (= ?x40092 6))))))))))
 ))
 (not $x31382)))
(check-sat)

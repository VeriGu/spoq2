...
(assert
 ...
 (and $x39708 $x40146)))))))
(assert
 (let (($x30437 (forall ((rtt_gidx.28889733 Int) (ipa_gidx.28889733 Int) (data_gidx.28889733 Int) )(let ((?x39978 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x39978)))
 (let ((?x24767 (query_oracle.0_call ?x560)))
 (let ((?x20065 (value_RData ?x24767)))
 (let ((?x63078 (share ?x20065)))
 (let ((?x20501 (granule_data ?x63078)))
 (let ((?x40270 (g_granule_state (select ?x20501 (rtt_walk_abs.0_call ?x20065 rtt_gidx.28889733 ipa_gidx.28889733)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.28889733)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x63078)) rtt_gidx.28889733)) 5) $x142) (or (= ?x40270 4) (= ?x40270 6))))))))))))
 ))
 (not $x30437)))
(check-sat)

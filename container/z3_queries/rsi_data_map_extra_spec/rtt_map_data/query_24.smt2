...
(assert
 ...
 (let (($x38916 (= ?x112309 4)))
 (not $x38916))))))))))))))
(assert
 (let (($x1768 (forall ((rtt_gidx.28896737 Int) (ipa_gidx.28896737 Int) (data_gidx.28896737 Int) )(let ((?x39978 (query_oracle.0_call st.0)))
 (let ((?x560 (value_RData ?x39978)))
 (let ((?x39191 (share ?x560)))
 (let ((?x86432 (granule_data ?x39191)))
 (let ((?x40092 (g_granule_state (select ?x86432 (rtt_walk_abs.0_call ?x560 rtt_gidx.28896737 ipa_gidx.28896737)))))
 (let (($x142 (rtt_is_root.0_call rtt_gidx.28896737)))
 (=> (and (= (e_state_s_granule (select (g_granules (globals ?x39191)) rtt_gidx.28896737)) 5) $x142) (or (= ?x40092 4) (= ?x40092 6))))))))))
 ))
 (not $x1768)))
(check-sat)

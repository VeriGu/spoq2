...
(assert
 ...
 (= ?x1465 2))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2401638 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1548 (memcpy_ns_read_spec.0_call ?x1532 ?x1533 4096 ?x1452)))
 (let ((?x1554 (value_Tuple_bool_RData ?x1548)))
 (let ((?x1551 (elem_1 ?x1554)))
 (let ((?x17310 (share ?x1551)))
 (let ((?x25158 (globals ?x17310)))
 (let ((?x25163 (g_granules ?x25158)))
 (let ((?x1493 (e_state_s_granule (select ?x25163 gidx.2401638))))
 (=> (not (select (gpt ?x17310) gidx.2401638)) (or (= ?x1493 0) (= ?x1493 6)))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 ...
 (elem_0 ?x1554))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2401748 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1554 (value_Tuple_bool_RData ?x1548)))
 (let ((?x1551 (elem_1 ?x1554)))
 (let ((?x25168 (granule_unlock_spec.0_call ?x1446 ?x1551)))
 (let ((?x75750 (value_RData ?x25168)))
 (let ((?x112768 (share ?x75750)))
 (let ((?x1564 (globals ?x112768)))
 (let ((?x1566 (g_granules ?x1564)))
 (let ((?x25228 (e_state_s_granule (select ?x1566 gidx.2401748))))
 (let (($x87844 (not (select (gpt ?x112768) gidx.2401748))))
 (=> $x87844 (or (= ?x25228 0) (= ?x25228 6))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
...
(assert
 ...
 (= ?x25220 8)))))))))))))))))))))
(assert
 (forall ((gidx.2401858 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1564 (globals ?x112768)))
 (let ((?x1566 (g_granules ?x1564)))
 (let ((?x1628 (select ?x1566 ?x1627)))
 (let ((?x1589 (e_ref ?x1628)))
 (let ((?x1592 (e_u_anon_3_0 ?x1589)))
 (let ((?x1582 (+ 1 ?x1592)))
 (let ((?x1581 (mku_anon_3 ?x1582)))
 (let ((?x1609 (mks_granule (e_lock ?x1628) (e_state_s_granule ?x1628) ?x1581)))
 (let ((?x1608 (store ?x1566 ?x1627 ?x1609)))
 (let ((?x1610 (select ?x1608 ?x1225)))
 (let ((?x76451 (e_ref ?x1610)))
 (let ((?x54553 (e_u_anon_3_0 ?x76451)))
 (let ((?x1601 (g_mapped_addr_set_para.0_call ?x54553 v_1.0)))
 (let ((?x54556 (+ 1 ?x1601)))
 (let ((?x1602 (mku_anon_3 ?x54556)))
 (let ((?x1611 (mks_granule (e_lock ?x1610) (e_state_s_granule ?x1610) ?x1602)))
 (let ((?x1607 (store ?x1608 ?x1225 ?x1611)))
 (let ((?x82043 (mkGLOBALS (g_heap ?x1564) (g_debug_exits ?x1564) (g_vmid_count ?x1564) (g_vmid_lock ?x1564) (g_vmids ?x1564) (g_nr_lrs ?x1564) (g_nr_aprs ?x1564) (g_max_vintid ?x1564) (g_pri_res0_mask ?x1564) (g_default_gicstate ?x1564) (g_status_handler ?x1564) (g_rmm_trap_list ?x1564) (g_tt_l3_buffer ?x1564) (g_tt_l2_mem0_0 ?x1564) (g_tt_l2_mem0_1 ?x1564) (g_tt_l2_mem1_0 ?x1564) (g_tt_l2_mem1_1 ?x1564) (g_tt_l2_mem1_2 ?x1564) (g_tt_l2_mem1_3 ?x1564) (g_tt_l1_upper ?x1564) (g_mbedtls_mem_buf ?x1564) ?x1607 (g_rmm_attest_signing_key ?x1564) (g_rmm_attest_public_key ?x1564) (g_rmm_attest_public_key_len ?x1564) (g_rmm_attest_public_key_hash ?x1564) (g_rmm_attest_public_key_hash_len ?x1564) (g_platform_token_buf ?x1564) (g_rmm_platform_token ?x1564) (g_get_realm_identity_identity ?x1564) (g_realm_attest_private_key ?x1564))))
 (let ((?x1559 (gpt ?x112768)))
 (let ((?x25282 (mkRData (log ?x75750) (oracle ?x75750) (repl ?x75750) (priv ?x75750) (mkShared ?x1559 (granule_data ?x112768) ?x82043) (stack ?x75750) (halt ?x75750))))
 (let ((?x25274 (granule_unlock_spec.0_call ?x1424 ?x25282)))
 (let ((?x25277 (value_RData ?x25274)))
 (let ((?x3806 (share ?x25277)))
 (let ((?x25232 (globals ?x3806)))
 (let ((?x9624 (g_granules ?x25232)))
 (let ((?x1690 (e_state_s_granule (select ?x9624 gidx.2401858))))
 (=> (not (select (gpt ?x3806) gidx.2401858)) (or (= ?x1690 0) (= ?x1690 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2401968 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x25274 (granule_unlock_spec.0_call ?x1424 ?x25282)))
 (let ((?x25277 (value_RData ?x25274)))
 (let ((?x1596 (granule_unlock_spec.0_call ?x1211 ?x25277)))
 (let ((?x1687 (value_RData ?x1596)))
 (let ((?x25399 (share ?x1687)))
 (let ((?x1677 (globals ?x25399)))
 (let ((?x1678 (g_granules ?x1677)))
 (let ((?x25407 (e_state_s_granule (select ?x1678 gidx.2401968))))
 (=> (not (select (gpt ?x25399) gidx.2401968)) (or (= ?x25407 0) (= ?x25407 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1779 (forall ((gidx.2402024 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1677 (globals ?x25399)))
 (let ((?x1678 (g_granules ?x1677)))
 (let ((?x25407 (e_state_s_granule (select ?x1678 gidx.2402024))))
 (=> (not (select (gpt ?x25399) gidx.2402024)) (or (= ?x25407 0) (= ?x25407 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1779)))
(check-sat)

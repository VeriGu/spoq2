...
(assert
 ...
 (let (($x1435 (= ?x1434 0)))
 (let (($x1444 (and $x1435 $x1438 $x1442)))
 (not $x1444))))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2403732 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1387 (elem_0 ?x1368)))
 (let ((?x1424 (e_2 ?x1387)))
 (let ((?x179814 (granule_unlock_spec.0_call ?x1424 ?x1273)))
 (let ((?x1895 (value_RData ?x179814)))
 (let ((?x87298 (share ?x1895)))
 (let ((?x87338 (globals ?x87298)))
 (let ((?x10184 (g_granules ?x87338)))
 (let ((?x25577 (e_state_s_granule (select ?x10184 gidx.2403732))))
 (=> (not (select (gpt ?x87298) gidx.2403732)) (or (= ?x25577 0) (= ?x25577 6)))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2403842 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x179814 (granule_unlock_spec.0_call ?x1424 ?x1273)))
 (let ((?x1895 (value_RData ?x179814)))
 (let ((?x49100 (granule_unlock_spec.0_call ?x1211 ?x1895)))
 (let ((?x103892 (value_RData ?x49100)))
 (let ((?x55983 (share ?x103892)))
 (let ((?x54768 (globals ?x55983)))
 (let ((?x25920 (g_granules ?x54768)))
 (let ((?x2146 (e_state_s_granule (select ?x25920 gidx.2403842))))
 (=> (not (select (gpt ?x55983) gidx.2403842)) (or (= ?x2146 0) (= ?x2146 6)))))))))))))))))))))))))))))
 )
(assert
 (let (($x17970 (forall ((gidx.2403898 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x54768 (globals ?x55983)))
 (let ((?x25920 (g_granules ?x54768)))
 (let ((?x2146 (e_state_s_granule (select ?x25920 gidx.2403898))))
 (=> (not (select (gpt ?x55983) gidx.2403898)) (or (= ?x2146 0) (= ?x2146 6)))))))))))))))))))))))))))))
 ))
 (not $x17970)))
(check-sat)

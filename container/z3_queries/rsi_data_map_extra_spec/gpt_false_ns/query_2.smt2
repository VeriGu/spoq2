...
(assert
 ...
 (elem_0 ?x56375))))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2402850 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x56375 (value_Tuple_bool_RData ?x9921)))
 (let ((?x1645 (elem_1 ?x56375)))
 (let ((?x1887 (granule_unlock_spec.0_call ?x1446 ?x1645)))
 (let ((?x54651 (value_RData ?x1887)))
 (let ((?x25540 (share ?x54651)))
 (let ((?x25563 (globals ?x25540)))
 (let ((?x25566 (g_granules ?x25563)))
 (let ((?x56250 (e_state_s_granule (select ?x25566 gidx.2402850))))
 (let (($x25630 (not (select (gpt ?x25540) gidx.2402850))))
 (=> $x25630 (or (= ?x56250 0) (= ?x56250 6))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
...
(assert
 ...
 (let ((?x1425 (poffset ?x1424)))
 (let ((?x50782 (+ 8 ?x1425)))
 (let ((?x25220 (mod ?x50782 4096)))
 (= ?x25220 8)))))))))))))))))))))
(assert
 (forall ((gidx.2402960 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1425 (poffset ?x1424)))
 (let ((?x50782 (+ 8 ?x1425)))
 (let ((?x1627 (div ?x50782 4096)))
 (let ((?x25540 (share ?x54651)))
 (let ((?x25563 (globals ?x25540)))
 (let ((?x25566 (g_granules ?x25563)))
 (let ((?x50656 (select ?x25566 ?x1627)))
 (let ((?x25609 (e_ref ?x50656)))
 (let ((?x25637 (e_u_anon_3_0 ?x25609)))
 (let ((?x87559 (+ 1 ?x25637)))
 (let ((?x92821 (mku_anon_3 ?x87559)))
 (let ((?x17739 (mks_granule (e_lock ?x50656) (e_state_s_granule ?x50656) ?x92821)))
 (let ((?x68625 (store ?x25566 ?x1627 ?x17739)))
 (let ((?x87629 (select ?x68625 ?x1225)))
 (let ((?x58971 (e_ref ?x87629)))
 (let ((?x1871 (e_u_anon_3_0 ?x58971)))
 (let ((?x83571 (g_mapped_addr_set_para.0_call ?x1871 v_1.0)))
 (let ((?x73572 (+ 1 ?x83571)))
 (let ((?x104164 (mku_anon_3 ?x73572)))
 (let ((?x63815 (mks_granule (e_lock ?x87629) (e_state_s_granule ?x87629) ?x104164)))
 (let ((?x25612 (store ?x68625 ?x1225 ?x63815)))
 (let ((?x1714 (mkGLOBALS (g_heap ?x25563) (g_debug_exits ?x25563) (g_vmid_count ?x25563) (g_vmid_lock ?x25563) (g_vmids ?x25563) (g_nr_lrs ?x25563) (g_nr_aprs ?x25563) (g_max_vintid ?x25563) (g_pri_res0_mask ?x25563) (g_default_gicstate ?x25563) (g_status_handler ?x25563) (g_rmm_trap_list ?x25563) (g_tt_l3_buffer ?x25563) (g_tt_l2_mem0_0 ?x25563) (g_tt_l2_mem0_1 ?x25563) (g_tt_l2_mem1_0 ?x25563) (g_tt_l2_mem1_1 ?x25563) (g_tt_l2_mem1_2 ?x25563) (g_tt_l2_mem1_3 ?x25563) (g_tt_l1_upper ?x25563) (g_mbedtls_mem_buf ?x25563) ?x25612 (g_rmm_attest_signing_key ?x25563) (g_rmm_attest_public_key ?x25563) (g_rmm_attest_public_key_len ?x25563) (g_rmm_attest_public_key_hash ?x25563) (g_rmm_attest_public_key_hash_len ?x25563) (g_platform_token_buf ?x25563) (g_rmm_platform_token ?x25563) (g_get_realm_identity_identity ?x25563) (g_realm_attest_private_key ?x25563))))
 (let ((?x25567 (gpt ?x25540)))
 (let ((?x87514 (mkRData (log ?x54651) (oracle ?x54651) (repl ?x54651) (priv ?x54651) (mkShared ?x25567 (granule_data ?x25540) ?x1714) (stack ?x54651) (halt ?x54651))))
 (let ((?x50638 (granule_unlock_spec.0_call ?x1424 ?x87514)))
 (let ((?x87515 (value_RData ?x50638)))
 (let ((?x1944 (share ?x87515)))
 (let ((?x87542 (globals ?x1944)))
 (let ((?x25521 (g_granules ?x87542)))
 (let ((?x1916 (e_state_s_granule (select ?x25521 gidx.2402960))))
 (=> (not (select (gpt ?x1944) gidx.2402960)) (or (= ?x1916 0) (= ?x1916 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2403070 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x50638 (granule_unlock_spec.0_call ?x1424 ?x87514)))
 (let ((?x87515 (value_RData ?x50638)))
 (let ((?x9884 (granule_unlock_spec.0_call ?x1211 ?x87515)))
 (let ((?x1908 (value_RData ?x9884)))
 (let ((?x25797 (share ?x1908)))
 (let ((?x1939 (globals ?x25797)))
 (let ((?x1930 (g_granules ?x1939)))
 (let ((?x1977 (e_state_s_granule (select ?x1930 gidx.2403070))))
 (=> (not (select (gpt ?x25797) gidx.2403070)) (or (= ?x1977 0) (= ?x1977 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1893 (forall ((gidx.2403126 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1939 (globals ?x25797)))
 (let ((?x1930 (g_granules ?x1939)))
 (let ((?x1977 (e_state_s_granule (select ?x1930 gidx.2403126))))
 (=> (not (select (gpt ?x25797) gidx.2403126)) (or (= ?x1977 0) (= ?x1977 6))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1893)))
(check-sat)

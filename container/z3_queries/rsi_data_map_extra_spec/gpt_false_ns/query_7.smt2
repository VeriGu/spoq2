...
(assert
 ...
 (not $x1286)))))))))))))))
(assert
 (forall ((gidx.2404450 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 (let ((?x2451 (value_RData ?x1241)))
 (let ((?x50597 (spinlock_release_spec.0_call ?x1211 ?x2451)))
 (let ((?x54821 (value_RData ?x50597)))
 (let ((?x2147 (share ?x54821)))
 (let ((?x1809 (globals ?x2147)))
 (let ((?x2131 (g_granules ?x1809)))
 (let ((?x50514 (e_state_s_granule (select ?x2131 gidx.2404450))))
 (=> (not (select (gpt ?x2147) gidx.2404450)) (or (= ?x50514 0) (= ?x50514 6))))))))))))))))
 )
(assert
 (let (($x2209 (forall ((gidx.2404506 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1809 (globals ?x2147)))
 (let ((?x2131 (g_granules ?x1809)))
 (let ((?x50514 (e_state_s_granule (select ?x2131 gidx.2404506))))
 (=> (not (select (gpt ?x2147) gidx.2404506)) (or (= ?x50514 0) (= ?x50514 6))))))))))))))))
 ))
 (not $x2209)))
(check-sat)

...
(assert
 ...
 (not $x1375))))))))))))))))))))
(assert
 (forall ((gidx.2404284 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1287 (spinlock_acquire_spec.0_call ?x1252 ?x2451)))
 (let ((?x1321 (value_RData ?x1287)))
 (let ((?x93043 (spinlock_release_spec.0_call ?x1252 ?x1321)))
 (let ((?x10244 (value_RData ?x93043)))
 (let ((?x10185 (share ?x10244)))
 (let ((?x26056 (globals ?x10185)))
 (let ((?x26018 (g_granules ?x26056)))
 (let ((?x50568 (e_state_s_granule (select ?x26018 gidx.2404284))))
 (=> (not (select (gpt ?x10185) gidx.2404284)) (or (= ?x50568 0) (= ?x50568 6)))))))))))))))))))))
 )
(assert
 (let (($x54820 (forall ((gidx.2404340 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x26056 (globals ?x10185)))
 (let ((?x26018 (g_granules ?x26056)))
 (let ((?x50568 (e_state_s_granule (select ?x26018 gidx.2404340))))
 (=> (not (select (gpt ?x10185) gidx.2404340)) (or (= ?x50568 0) (= ?x50568 6)))))))))))))))))))))
 ))
 (not $x54820)))
(check-sat)

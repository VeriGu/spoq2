...
(assert
 ...
 (let ((?x1548 (memcpy_ns_read_spec.0_call ?x1532 ?x1533 4096 ?x1452)))
 (let ((?x1554 (value_Tuple_bool_RData ?x1548)))
 (let (($x1555 (elem_0 ?x1554)))
 (not $x1555)))))))))))))))))))))))))))))
(assert
 (forall ((gidx.2402134 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1554 (value_Tuple_bool_RData ?x1548)))
 (let ((?x1551 (elem_1 ?x1554)))
 (let ((?x109335 (memset_spec.0_call ?x1532 0 4096 ?x1551)))
 (let ((?x1803 (value_Tuple_Ptr_RData ?x109335)))
 (let ((?x25465 (elem_1 ?x1803)))
 (let ((?x76441 (share ?x25465)))
 (let ((?x1696 (globals ?x76441)))
 (let ((?x1764 (g_granules ?x1696)))
 (let ((?x1795 (e_state_s_granule (select ?x1764 gidx.2402134))))
 (=> (not (select (gpt ?x76441) gidx.2402134)) (or (= ?x1795 0) (= ?x1795 6))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2402244 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1803 (value_Tuple_Ptr_RData ?x109335)))
 (let ((?x25465 (elem_1 ?x1803)))
 (let ((?x1792 (granule_unlock_spec.0_call ?x1446 ?x25465)))
 (let ((?x1670 (value_RData ?x1792)))
 (let ((?x25494 (share ?x1670)))
 (let ((?x1829 (globals ?x25494)))
 (let ((?x50700 (g_granules ?x1829)))
 (let ((?x50693 (e_state_s_granule (select ?x50700 gidx.2402244))))
 (=> (not (select (gpt ?x25494) gidx.2402244)) (or (= ?x50693 0) (= ?x50693 6))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2402354 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x1387 (elem_0 ?x1368)))
 (let ((?x1424 (e_2 ?x1387)))
 (let ((?x25527 (granule_unlock_spec.0_call ?x1424 ?x1670)))
 (let ((?x25523 (value_RData ?x25527)))
 (let ((?x50694 (share ?x25523)))
 (let ((?x97819 (globals ?x50694)))
 (let ((?x1817 (g_granules ?x97819)))
 (let ((?x25548 (e_state_s_granule (select ?x1817 gidx.2402354))))
 (=> (not (select (gpt ?x50694) gidx.2402354)) (or (= ?x25548 0) (= ?x25548 6))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((gidx.2402464 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x25527 (granule_unlock_spec.0_call ?x1424 ?x1670)))
 (let ((?x25523 (value_RData ?x25527)))
 (let ((?x1839 (granule_unlock_spec.0_call ?x1211 ?x25523)))
 (let ((?x1683 (value_RData ?x1839)))
 (let ((?x25557 (share ?x1683)))
 (let ((?x90741 (globals ?x25557)))
 (let ((?x25464 (g_granules ?x90741)))
 (let ((?x70097 (e_state_s_granule (select ?x25464 gidx.2402464))))
 (=> (not (select (gpt ?x25557) gidx.2402464)) (or (= ?x70097 0) (= ?x70097 6))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1712 (forall ((gidx.2402520 Int) )(let ((?x1164 (test_Z_PTE.0_call v_2.0)))
 (let ((?x2617 (meta_PA ?x1164)))
 (let ((?x2644 (meta_granule_offset ?x2617)))
 (let ((?x1211 (mkPtr "granules" ?x2644)))
 (let ((?x1241 (spinlock_acquire_spec.0_call ?x1211 st.0)))
 ...
 (let ((?x90741 (globals ?x25557)))
 (let ((?x25464 (g_granules ?x90741)))
 (let ((?x70097 (e_state_s_granule (select ?x25464 gidx.2402520))))
 (=> (not (select (gpt ?x25557) gidx.2402520)) (or (= ?x70097 0) (= ?x70097 6))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x1712)))
(check-sat)

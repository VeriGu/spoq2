...
(assert
 (let (($x230 (forall ((rtt_gidx.110972 Int) (ipa_gidx.110972 Int) (data_gidx.110972 Int) )(let ((?x12 (share st.0)))
 (let ((?x7 (log st.0)))
 ...
 (let (($x228 (forall ((rtt_gidx.110942 Int) (ipa_gidx.110942 Int) (data_gidx.110942 Int) )(let (($x89 (= (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.110942)) 5)))
 (let (($x96 (not $x89)))
...
(assert
 (let (($x255 (forall ((rtt_gidx.111685 Int) (ipa_gidx.111685 Int) (data_gidx.111685 Int) )(let ((?x81 (g_granule_state (select (granule_data (share st.0)) data_gidx.111685))))
 (let (($x82 (= ?x81 6)))
 (let (($x83 (= ?x81 4)))
 (let (($x85 (rtt_is_root.0_call rtt_gidx.111685)))
 (let (($x89 (= (e_state_s_granule (select (g_granules (globals (share st.0))) rtt_gidx.111685)) 5)))
 (let ((?x91 (Some_Z data_gidx.111685)))
 (let ((?x92 (rtt_walk_abs.0_call st.0 rtt_gidx.111685 ipa_gidx.111685)))
 (let (($x93 (= ?x92 ?x91)))
 (=> (and $x93 $x89 $x85) (or $x83 $x82)))))))))))
 ))
 (not $x255)))

...
(assert
 (let (($x2123 (forall ((gidx.367519 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x727149 (share ?x28715)))
 (let ((?x2098 (granule_data ?x727149)))
 (let (($x18950 (= (g_norm (select ?x2098 gidx.367519)) zero_granule_data)))
 (let (($x36609 (= (e_state_s_granule (select (g_granules (globals ?x727149)) gidx.367519)) 1)))
 (=> $x36609 $x18950))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2123)))
(check-sat)

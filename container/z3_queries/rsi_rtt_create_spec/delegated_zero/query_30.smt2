...
(let ((a!27 (granule_unlock_spec.0_call
 ...
 (or (not $x4921) $x4629))))
(assert
 (let (($x13215 (forall ((gidx.372249 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x221885 (share ?x4262)))
 (let ((?x4910 (granule_data ?x221885)))
 (let (($x4795 (= (g_norm (select ?x4910 gidx.372249)) zero_granule_data)))
 (let (($x3277 (= (e_state_s_granule (select (g_granules (globals ?x221885)) gidx.372249)) 1)))
 (=> $x3277 $x4795)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x13215)))
(check-sat)

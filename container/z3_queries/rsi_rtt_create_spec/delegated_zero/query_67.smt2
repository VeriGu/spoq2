...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (rec_to_ttbr1_para.0_call
             (mkPtr "granule_data"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1))))
...
(let ((a!7 (+ (poffset (e_2 (elem_0 a!6))) (* 8 (e_3 (elem_0 a!6)))))
      (a!11 (g_heap (globals (share (elem_1 a!6)))))
      (a!12 (g_debug_exits (globals (share (elem_1 a!6)))))
      (a!13 (g_vmid_count (globals (share (elem_1 a!6)))))
      (a!14 (g_vmid_lock (globals (share (elem_1 a!6)))))
      (a!15 (g_vmids (globals (share (elem_1 a!6)))))
      (a!16 (g_nr_lrs (globals (share (elem_1 a!6)))))
      (a!17 (g_nr_aprs (globals (share (elem_1 a!6)))))
      (a!18 (g_max_vintid (globals (share (elem_1 a!6)))))
      (a!19 (g_pri_res0_mask (globals (share (elem_1 a!6)))))
      (a!20 (g_default_gicstate (globals (share (elem_1 a!6)))))
      (a!21 (g_status_handler (globals (share (elem_1 a!6)))))
      (a!22 (g_rmm_trap_list (globals (share (elem_1 a!6)))))
      (a!23 (g_tt_l3_buffer (globals (share (elem_1 a!6)))))
      (a!24 (g_tt_l2_mem0_0 (globals (share (elem_1 a!6)))))
      (a!25 (g_tt_l2_mem0_1 (globals (share (elem_1 a!6)))))
      (a!26 (g_tt_l2_mem1_0 (globals (share (elem_1 a!6)))))
      (a!27 (g_tt_l2_mem1_1 (globals (share (elem_1 a!6)))))
      (a!28 (g_tt_l2_mem1_2 (globals (share (elem_1 a!6)))))
      (a!29 (g_tt_l2_mem1_3 (globals (share (elem_1 a!6)))))
      (a!30 (g_tt_l1_upper (globals (share (elem_1 a!6)))))
      (a!31 (g_mbedtls_mem_buf (globals (share (elem_1 a!6)))))
      (a!32 (g_granules (globals (share (elem_1 a!6)))))
      (a!35 (g_rmm_attest_signing_key (globals (share (elem_1 a!6)))))
      (a!36 (g_rmm_attest_public_key (globals (share (elem_1 a!6)))))
      (a!37 (g_rmm_attest_public_key_len (globals (share (elem_1 a!6)))))
      (a!38 (g_rmm_attest_public_key_hash (globals (share (elem_1 a!6)))))
      (a!39 (g_rmm_attest_public_key_hash_len (globals (share (elem_1 a!6)))))
      (a!40 (g_platform_token_buf (globals (share (elem_1 a!6)))))
      (a!41 (g_rmm_platform_token (globals (share (elem_1 a!6)))))
      (a!42 (g_get_realm_identity_identity (globals (share (elem_1 a!6)))))
      (a!43 (g_realm_attest_private_key (globals (share (elem_1 a!6))))))
(let ((a!8 (select (granule_data (share (elem_1 a!6))) (div a!7 4096)))
      (a!34 (store a!32
                   a!33
                   (mks_granule (e_lock (select a!32 a!33))
                                5
                                (e_ref (select a!32 a!33))))))
(let ((a!9 (store (g_norm a!8)
                  (mod a!7 4096)
                  (test_PTE_Z.0_call
                    (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0)))))
(let ((a!10 (store (granule_data (share (elem_1 a!6)))
                   (div a!7 4096)
                   (mkr_granule_data (gd_g_idx a!8)
                                     ...
                                     (g_rd a!8)
                                     (g_rec a!8)))))
(let ((a!44 (mkShared (gpt (share (elem_1 a!6)))
                      a!10
                      (mkGLOBALS a!11
                                 a!12
                                 a!13
                                 ...
                                 a!42
                                 a!43))))
(let ((a!45 (granule_unlock_spec.0_call
              (e_2 (elem_0 a!6))
              (mkRData (log (elem_1 a!6))
                       (oracle (elem_1 a!6))
                       (repl (elem_1 a!6))
                       (priv (elem_1 a!6))
                       a!44
                       (stack (elem_1 a!6))
                       (halt (elem_1 a!6))))))
  (repl (value_RData a!45))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!45 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!6))
                       ...
                       (stack (elem_1 a!6))
                       (halt (elem_1 a!6))))))
  (oracle (value_RData a!45))))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!46 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!45))))
(let ((a!47 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!46))))
  (repl (value_RData a!47))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!47 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!46))))
  (oracle (value_RData a!47))))))))))))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.380678 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x7744 (value_Tuple_abs_ret_rtt_RData ?x9194)))
 (let ((?x9408 (elem_1 ?x7744)))
 (let (($x11135 (halt ?x9408)))
 (let ((?x11479 (stack ?x9408)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x57473 (share ?x9408)))
 (let ((?x8393 (globals ?x57473)))
 (let ((?x9471 (g_granules ?x8393)))
 (let ((?x9488 (select ?x9471 ?x28222)))
 (let ((?x10893 (mks_granule (e_lock ?x9488) 5 (e_ref ?x9488))))
 (let ((?x10734 (store ?x9471 ?x28222 ?x10893)))
 (let ((?x11381 (mkGLOBALS (g_heap ?x8393) (g_debug_exits ?x8393) (g_vmid_count ?x8393) (g_vmid_lock ?x8393) (g_vmids ?x8393) (g_nr_lrs ?x8393) (g_nr_aprs ?x8393) (g_max_vintid ?x8393) (g_pri_res0_mask ?x8393) (g_default_gicstate ?x8393) (g_status_handler ?x8393) (g_rmm_trap_list ?x8393) (g_tt_l3_buffer ?x8393) (g_tt_l2_mem0_0 ?x8393) (g_tt_l2_mem0_1 ?x8393) (g_tt_l2_mem1_0 ?x8393) (g_tt_l2_mem1_1 ?x8393) (g_tt_l2_mem1_2 ?x8393) (g_tt_l2_mem1_3 ?x8393) (g_tt_l1_upper ?x8393) (g_mbedtls_mem_buf ?x8393) ?x10734 (g_rmm_attest_signing_key ?x8393) (g_rmm_attest_public_key ?x8393) (g_rmm_attest_public_key_len ?x8393) (g_rmm_attest_public_key_hash ?x8393) (g_rmm_attest_public_key_hash_len ?x8393) (g_platform_token_buf ?x8393) (g_rmm_platform_token ?x8393) (g_get_realm_identity_identity ?x8393) (g_realm_attest_private_key ?x8393))))
 (let ((?x9055 (elem_0 ?x7744)))
 (let ((?x9521 (e_3 ?x9055)))
 (let ((?x9517 (* 8 ?x9521)))
 (let ((?x8863 (e_2 ?x9055)))
 ...
 (let ((?x9511 (div ?x9484 4096)))
 (let ((?x9196 (granule_data ?x57473)))
 (let ((?x9954 (select ?x9196 ?x9511)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x9490 (mod ?x9484 4096)))
 (let ((?x10941 (g_norm ?x9954)))
 (let ((?x11088 (store ?x10941 ?x9490 ?x35861)))
 (let ((?x8366 (mkr_granule_data (gd_g_idx ?x9954) (g_granule_state ?x9954) ?x11088 (g_rd ?x9954) (g_rec ?x9954))))
 (let ((?x72060 (store ?x9196 ?x9511 ?x8366)))
 (let ((?x9487 (gpt ?x57473)))
 (let ((?x10629 (priv ?x9408)))
 (let ((?x9537 (repl ?x9408)))
 (let ((?x9520 (oracle ?x9408)))
 (let ((?x9276 (log ?x9408)))
 (let ((?x11499 (granule_unlock_spec.0_call ?x8863 (mkRData ?x9276 ?x9520 ?x9537 ?x10629 (mkShared ?x9487 ?x72060 ?x11381) ?x11479 $x11135))))
 (let ((?x9466 (value_RData ?x11499)))
 (let ((?x765450 (share ?x9466)))
 (let ((?x9256 (granule_data ?x765450)))
 (let (($x9996 (= (g_norm (select ?x9256 gidx.380678)) zero_granule_data)))
 (let (($x10398 (= (e_state_s_granule (select (g_granules (globals ?x765450)) gidx.380678)) 1)))
 (=> $x10398 $x9996)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.380713 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.380713))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x9466 (value_RData ?x11499)))
 (let ((?x765450 (share ?x9466)))
 (let ((?x10444 (gpt ?x765450)))
 (select ?x10444 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x70969 (forall ((gidx.380849 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x9466 (value_RData ?x11499)))
 (let ((?x765450 (share ?x9466)))
 (let ((?x10461 (log ?x9466)))
 (let ((?x10153 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!45 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!6))
                       ...
                       (stack (elem_1 a!6))
                       (halt (elem_1 a!6))))))
  (oracle (value_RData a!45))))))))))))))_call| ?x10461)))
 (let ((?x10345 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!45 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!6))
                       ...
                       (stack (elem_1 a!6))
                       (halt (elem_1 a!6))))))
  (repl (value_RData a!45))))))))))))))_call| ?x10153 ?x765450)))
 (let ((?x10123 (value_Shared ?x10345)))
 (let ((?x54940 (granule_data ?x10123)))
 (let (($x11120 (= (g_norm (select ?x54940 gidx.380849)) zero_granule_data)))
 (let (($x10049 (= (e_state_s_granule (select (g_granules (globals ?x10123)) gidx.380849)) 1)))
 (or (not $x10049) $x11120)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x10422 (forall ((gidx.380838 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x765450 (share ?x9466)))
 (let ((?x9256 (granule_data ?x765450)))
 (let (($x9996 (= (g_norm (select ?x9256 gidx.380838)) zero_granule_data)))
 (let (($x10398 (= (e_state_s_granule (select (g_granules (globals ?x765450)) gidx.380838)) 1)))
 (or (not $x10398) $x9996)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x10422) $x70969))))
(assert
 (forall ((gidx.380926 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x11499 (granule_unlock_spec.0_call ?x8863 (mkRData ?x9276 ?x9520 ?x9537 ?x10629 (mkShared ?x9487 ?x72060 ?x11381) ?x11479 $x11135))))
 (let ((?x9466 (value_RData ?x11499)))
 (let ((?x10746 (granule_unlock_spec.0_call ?x992 ?x9466)))
 (let ((?x11257 (value_RData ?x10746)))
 (let ((?x91303 (share ?x11257)))
 (let ((?x56432 (granule_data ?x91303)))
 (let (($x19549 (= (g_norm (select ?x56432 gidx.380926)) zero_granule_data)))
 (let (($x11345 (= (e_state_s_granule (select (g_granules (globals ?x91303)) gidx.380926)) 1)))
 (=> $x11345 $x19549)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.380961 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.380961))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x11257 (value_RData ?x10746)))
 (let ((?x91303 (share ?x11257)))
 (let ((?x11224 (gpt ?x91303)))
 (select ?x11224 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x9728 (forall ((gidx.381097 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x11257 (value_RData ?x10746)))
 (let ((?x91303 (share ?x11257)))
 (let ((?x10770 (log ?x11257)))
 (let ((?x56645 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!46 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!45))))
  (oracle (value_RData a!46)))))))))))))))_call| ?x10770)))
 (let ((?x10606 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!46 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!45))))
  (repl (value_RData a!46)))))))))))))))_call| ?x56645 ?x91303)))
 (let ((?x9774 (value_Shared ?x10606)))
 (let ((?x10987 (granule_data ?x9774)))
 (let (($x10796 (= (g_norm (select ?x10987 gidx.381097)) zero_granule_data)))
 (let (($x11077 (= (e_state_s_granule (select (g_granules (globals ?x9774)) gidx.381097)) 1)))
 (or (not $x11077) $x10796)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x10414 (forall ((gidx.381086 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x91303 (share ?x11257)))
 (let ((?x56432 (granule_data ?x91303)))
 (let (($x19549 (= (g_norm (select ?x56432 gidx.381086)) zero_granule_data)))
 (let (($x11345 (= (e_state_s_granule (select (g_granules (globals ?x91303)) gidx.381086)) 1)))
 (or (not $x11345) $x19549)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x10414) $x9728))))
(assert
 (forall ((gidx.381174 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x10746 (granule_unlock_spec.0_call ?x992 ?x9466)))
 (let ((?x11257 (value_RData ?x10746)))
 (let ((?x6783 (granule_unlock_spec.0_call ?x1576 ?x11257)))
 (let ((?x56636 (value_RData ?x6783)))
 (let ((?x100870 (share ?x56636)))
 (let ((?x11039 (granule_data ?x100870)))
 (let (($x10982 (= (g_norm (select ?x11039 gidx.381174)) zero_granule_data)))
 (let (($x11023 (= (e_state_s_granule (select (g_granules (globals ?x100870)) gidx.381174)) 1)))
 (=> $x11023 $x10982)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.381209 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.381209))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x56636 (value_RData ?x6783)))
 (let ((?x100870 (share ?x56636)))
 (let ((?x11064 (gpt ?x100870)))
 (select ?x11064 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x10372 (forall ((gidx.381345 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x56636 (value_RData ?x6783)))
 (let ((?x100870 (share ?x56636)))
 (let ((?x10657 (log ?x56636)))
 (let ((?x10865 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!47 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!46))))
  (oracle (value_RData a!47))))))))))))))))_call| ?x10657)))
 (let ((?x7170 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!33 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!47 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!46))))
  (repl (value_RData a!47))))))))))))))))_call| ?x10865 ?x100870)))
 (let ((?x64183 (value_Shared ?x7170)))
 (let ((?x11002 (granule_data ?x64183)))
 (let (($x11059 (= (g_norm (select ?x11002 gidx.381345)) zero_granule_data)))
 (let (($x60647 (= (e_state_s_granule (select (g_granules (globals ?x64183)) gidx.381345)) 1)))
 (or (not $x60647) $x11059)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x28850 (forall ((gidx.381334 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x100870 (share ?x56636)))
 (let ((?x11039 (granule_data ?x100870)))
 (let (($x10982 (= (g_norm (select ?x11039 gidx.381334)) zero_granule_data)))
 (let (($x11023 (= (e_state_s_granule (select (g_granules (globals ?x100870)) gidx.381334)) 1)))
 (or (not $x11023) $x10982)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x28850) $x10372))))
(assert
 (let (($x11536 (forall ((gidx.381386 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x100870 (share ?x56636)))
 (let ((?x11039 (granule_data ?x100870)))
 (let (($x10982 (= (g_norm (select ?x11039 gidx.381386)) zero_granule_data)))
 (let (($x11023 (= (e_state_s_granule (select (g_granules (globals ?x100870)) gidx.381386)) 1)))
 (=> $x11023 $x10982)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x11536)))
(check-sat)

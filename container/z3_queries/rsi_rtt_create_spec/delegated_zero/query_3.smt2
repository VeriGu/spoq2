...
(assert
 ...
 (and $x1454 $x1347))))))))))))))))))))))))))))
(assert
 (let (($x1562 (forall ((gidx.366451 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x29612 (share ?x1186)))
 (let ((?x1288 (granule_data ?x29612)))
 (let (($x1296 (= (g_norm (select ?x1288 gidx.366451)) zero_granule_data)))
 (let (($x1352 (= (e_state_s_granule (select (g_granules (globals ?x29612)) gidx.366451)) 1)))
 (=> $x1352 $x1296))))))))))))))))))))
 ))
 (not $x1562)))
(check-sat)

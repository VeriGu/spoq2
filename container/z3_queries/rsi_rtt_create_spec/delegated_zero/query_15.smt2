...
(assert
 ...
 (not $x1150)))))))))))))))))))
(assert
 (let (($x3015 (forall ((gidx.368873 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x19888 (share ?x1050)))
 (let ((?x1122 (granule_data ?x19888)))
 (let (($x1055 (= (g_norm (select ?x1122 gidx.368873)) zero_granule_data)))
 (let (($x1152 (= (e_state_s_granule (select (g_granules (globals ?x19888)) gidx.368873)) 1)))
 (=> $x1152 $x1055))))))))))))))))
 ))
 (not $x3015)))
(check-sat)

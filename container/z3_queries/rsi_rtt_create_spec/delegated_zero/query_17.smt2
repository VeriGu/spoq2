...
(assert
 ...
 (not $x964))))))))))))))
(assert
 (let (($x37673 (forall ((gidx.369159 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 (let ((?x9777 (share ?x1634)))
 (let ((?x897 (granule_data ?x9777)))
 (let (($x918 (= (g_norm (select ?x897 gidx.369159)) zero_granule_data)))
 (let (($x913 (= (e_state_s_granule (select (g_granules (globals ?x9777)) gidx.369159)) 1)))
 (=> $x913 $x918)))))))))))
 ))
 (not $x37673)))
(check-sat)

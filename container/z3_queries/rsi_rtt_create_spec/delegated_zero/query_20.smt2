...
(assert
 true)
(assert
 (let (($x3379 (forall ((gidx.369693 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 (let ((?x9777 (share ?x1634)))
 (let ((?x897 (granule_data ?x9777)))
 (let (($x918 (= (g_norm (select ?x897 gidx.369693)) zero_granule_data)))
 (let (($x913 (= (e_state_s_granule (select (g_granules (globals ?x9777)) gidx.369693)) 1)))
 (=> $x913 $x918)))))))))))
 ))
 (not $x3379)))
(check-sat)

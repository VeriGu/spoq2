...
(assert
 (let (($x63580 (forall ((gidx.380107 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x612791 (share ?x8873)))
 (let ((?x10270 (granule_data ?x612791)))
 (let (($x10475 (= (g_norm (select ?x10270 gidx.380107)) zero_granule_data)))
 (let (($x9581 (= (e_state_s_granule (select (g_granules (globals ?x612791)) gidx.380107)) 1)))
 (=> $x9581 $x10475)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x63580)))
(check-sat)

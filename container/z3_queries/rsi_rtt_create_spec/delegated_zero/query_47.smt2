...
(let ((a!6 (value_RData (granule_unlock_spec.0_call
 ...
 (or (not $x8983) $x8742))))
(assert
 (let (($x53073 (forall ((gidx.376731 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x65299 (share ?x4630)))
 (let ((?x26056 (granule_data ?x65299)))
 (let (($x53158 (= (g_norm (select ?x26056 gidx.376731)) zero_granule_data)))
 (let (($x8693 (= (e_state_s_granule (select (g_granules (globals ?x65299)) gidx.376731)) 1)))
 (=> $x8693 $x53158)))))))))))))))))))))))))))))))
 ))
 (not $x53073)))
(check-sat)

...
(let ((a!5 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             a!4)))
(let ((a!6 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!5))))
  (repl (value_RData a!6))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
...
(let ((a!6 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!5))))
  (oracle (value_RData a!6))))))))_call| (List_Event) List_Event)
...
(assert
 ...
 (not $x8978))))))))))))))))))))))))))))
(assert
 (forall ((gidx.385408 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x8107 (spinlock_acquire_spec.0_call ?x992 ?x3456)))
 (let ((?x8404 (value_RData ?x8107)))
 (let ((?x106627 (spinlock_release_spec.0_call ?x992 ?x8404)))
 (let ((?x44207 (value_RData ?x106627)))
 (let ((?x62421 (share ?x44207)))
 (let ((?x14789 (granule_data ?x62421)))
 (let (($x14537 (= (g_norm (select ?x14789 gidx.385408)) zero_granule_data)))
 (let (($x15414 (= (e_state_s_granule (select (g_granules (globals ?x62421)) gidx.385408)) 1)))
 (=> $x15414 $x14537)))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.385443 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.385443))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x44207 (value_RData ?x106627)))
 (let ((?x62421 (share ?x44207)))
 (let ((?x14820 (gpt ?x62421)))
 (select ?x14820 ?x1632))))))))))))))))))))))))))
 )
(assert
 (let (($x14154 (forall ((gidx.385579 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x44207 (value_RData ?x106627)))
 (let ((?x62421 (share ?x44207)))
 (let ((?x51012 (log ?x44207)))
 (let ((?x68575 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (rec_to_ttbr1_para.0_call
...
(let ((a!6 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!5))))
  (oracle (value_RData a!6))))))))_call| ?x51012)))
 (let ((?x13364 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (rec_to_ttbr1_para.0_call
...
(let ((a!6 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!5))))
  (repl (value_RData a!6))))))))_call| ?x68575 ?x62421)))
 (let ((?x14535 (value_Shared ?x13364)))
 (let ((?x9454 (granule_data ?x14535)))
 (let (($x60547 (= (g_norm (select ?x9454 gidx.385579)) zero_granule_data)))
 (let (($x14371 (= (e_state_s_granule (select (g_granules (globals ?x14535)) gidx.385579)) 1)))
 (or (not $x14371) $x60547)))))))))))))))))))))))))))))))
 ))
 (let (($x14435 (forall ((gidx.385568 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x62421 (share ?x44207)))
 (let ((?x14789 (granule_data ?x62421)))
 (let (($x14537 (= (g_norm (select ?x14789 gidx.385568)) zero_granule_data)))
 (let (($x15414 (= (e_state_s_granule (select (g_granules (globals ?x62421)) gidx.385568)) 1)))
 (or (not $x15414) $x14537)))))))))))))))))))))))))))
 ))
 (or (not $x14435) $x14154))))
(assert
 (forall ((gidx.385656 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x106627 (spinlock_release_spec.0_call ?x992 ?x8404)))
 (let ((?x44207 (value_RData ?x106627)))
 (let ((?x14398 (granule_unlock_spec.0_call ?x1576 ?x44207)))
 (let ((?x12873 (value_RData ?x14398)))
 (let ((?x71805 (share ?x12873)))
 (let ((?x68647 (granule_data ?x71805)))
 (let (($x15109 (= (g_norm (select ?x68647 gidx.385656)) zero_granule_data)))
 (let (($x14993 (= (e_state_s_granule (select (g_granules (globals ?x71805)) gidx.385656)) 1)))
 (=> $x14993 $x15109)))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.385691 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.385691))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x12873 (value_RData ?x14398)))
 (let ((?x71805 (share ?x12873)))
 (let ((?x13691 (gpt ?x71805)))
 (select ?x13691 ?x1632))))))))))))))))))))))))))))
 )
(assert
 (let (($x14361 (forall ((gidx.385827 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x12873 (value_RData ?x14398)))
 (let ((?x71805 (share ?x12873)))
 (let ((?x60365 (log ?x12873)))
 (let ((?x14048 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (rec_to_ttbr1_para.0_call
...
(let ((a!7 (granule_unlock_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!6))))
  (oracle (value_RData a!7)))))))))_call| ?x60365)))
 (let ((?x14831 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (rec_to_ttbr1_para.0_call
...
(let ((a!7 (granule_unlock_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!6))))
  (repl (value_RData a!7)))))))))_call| ?x14048 ?x71805)))
 (let ((?x33162 (value_Shared ?x14831)))
 (let ((?x60918 (granule_data ?x33162)))
 (let (($x61069 (= (g_norm (select ?x60918 gidx.385827)) zero_granule_data)))
 (let (($x12761 (= (e_state_s_granule (select (g_granules (globals ?x33162)) gidx.385827)) 1)))
 (or (not $x12761) $x61069)))))))))))))))))))))))))))))))))
 ))
 (let (($x13804 (forall ((gidx.385816 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x71805 (share ?x12873)))
 (let ((?x68647 (granule_data ?x71805)))
 (let (($x15109 (= (g_norm (select ?x68647 gidx.385816)) zero_granule_data)))
 (let (($x14993 (= (e_state_s_granule (select (g_granules (globals ?x71805)) gidx.385816)) 1)))
 (or (not $x14993) $x15109)))))))))))))))))))))))))))))
 ))
 (or (not $x13804) $x14361))))
(assert
 (let (($x115099 (forall ((gidx.385868 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x71805 (share ?x12873)))
 (let ((?x68647 (granule_data ?x71805)))
 (let (($x15109 (= (g_norm (select ?x68647 gidx.385868)) zero_granule_data)))
 (let (($x14993 (= (e_state_s_granule (select (g_granules (globals ?x71805)) gidx.385868)) 1)))
 (=> $x14993 $x15109)))))))))))))))))))))))))))))
 ))
 (not $x115099)))
(check-sat)

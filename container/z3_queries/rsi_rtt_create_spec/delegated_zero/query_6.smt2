...
(assert
 (forall ((gidx.366984 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x35868 (granule_unlock_spec.0_call ?x1204 (mkRData ?x28036 ?x1658 ?x1590 ?x28092 (mkShared ?x1391 ?x1604 ?x35865) ?x28093 $x28082))))
 (let ((?x4537 (value_RData ?x35868)))
 (let ((?x1771 (granule_unlock_spec.0_call ?x992 ?x4537)))
 (let ((?x1767 (value_RData ?x1771)))
 (let ((?x74037 (share ?x1767)))
 (let ((?x2071 (granule_data ?x74037)))
 (let (($x2107 (= (g_norm (select ?x2071 gidx.366984)) zero_granule_data)))
 (let (($x2004 (= (e_state_s_granule (select (g_granules (globals ?x74037)) gidx.366984)) 1)))
 (=> $x2004 $x2107)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.367019 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.367019))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x1767 (value_RData ?x1771)))
 (let ((?x74037 (share ?x1767)))
 (let ((?x1962 (gpt ?x74037)))
 (select ?x1962 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x1798 (forall ((gidx.367155 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1767 (value_RData ?x1771)))
 (let ((?x74037 (share ?x1767)))
 (let ((?x35979 (log ?x1767)))
 (let ((?x4529 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!37 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!51 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!50))))
  (oracle (value_RData a!51))))))))))))))))_call| ?x35979)))
 (let ((?x1984 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!37 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!51 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!50))))
  (repl (value_RData a!51))))))))))))))))_call| ?x4529 ?x74037)))
 (let ((?x1860 (value_Shared ?x1984)))
 (let ((?x1951 (granule_data ?x1860)))
 (let (($x2018 (= (g_norm (select ?x1951 gidx.367155)) zero_granule_data)))
 (let (($x1892 (= (e_state_s_granule (select (g_granules (globals ?x1860)) gidx.367155)) 1)))
 (or (not $x1892) $x2018)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x28186 (forall ((gidx.367144 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x74037 (share ?x1767)))
 (let ((?x2071 (granule_data ?x74037)))
 (let (($x2107 (= (g_norm (select ?x2071 gidx.367144)) zero_granule_data)))
 (let (($x2004 (= (e_state_s_granule (select (g_granules (globals ?x74037)) gidx.367144)) 1)))
 (or (not $x2004) $x2107)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x28186) $x1798))))
(assert
 (let (($x36199 (forall ((gidx.367196 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x74037 (share ?x1767)))
 (let ((?x2071 (granule_data ?x74037)))
 (let (($x2107 (= (g_norm (select ?x2071 gidx.367196)) zero_granule_data)))
 (let (($x2004 (= (e_state_s_granule (select (g_granules (globals ?x74037)) gidx.367196)) 1)))
 (=> $x2004 $x2107)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x36199)))
(check-sat)

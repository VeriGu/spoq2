...
(assert
 ...
 (= ?x2150 5))))))))))))))))))))
(assert
 (let (($x3328 (forall ((gidx.369941 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x22258 (share ?x3425)))
 (let ((?x3413 (granule_data ?x22258)))
 (let (($x3321 (= (g_norm (select ?x3413 gidx.369941)) zero_granule_data)))
 (let (($x14724 (= (e_state_s_granule (select (g_granules (globals ?x22258)) gidx.369941)) 1)))
 (=> $x14724 $x3321))))))))))))))))))
 ))
 (not $x3328)))
(check-sat)

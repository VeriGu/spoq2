...
(assert
 ...
 (= ?x3625 1)))))))))))))))))))))))))
(assert
 (let (($x3671 (forall ((gidx.370189 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x31821 (share ?x3570)))
 (let ((?x3616 (granule_data ?x31821)))
 (let (($x3131 (= (g_norm (select ?x3616 gidx.370189)) zero_granule_data)))
 (let (($x3559 (= (e_state_s_granule (select (g_granules (globals ?x31821)) gidx.370189)) 1)))
 (=> $x3559 $x3131)))))))))))))))))))))))
 ))
 (not $x3671)))
(check-sat)

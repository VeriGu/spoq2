...
(let ((a!28 (granule_unlock_spec.0_call
 ...
 (or (not $x9725) $x9352))))
(assert
 (let (($x10521 (forall ((gidx.380355 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x237492 (share ?x18838)))
 (let ((?x10684 (granule_data ?x237492)))
 (let (($x10268 (= (g_norm (select ?x10684 gidx.380355)) zero_granule_data)))
 (let (($x8654 (= (e_state_s_granule (select (g_granules (globals ?x237492)) gidx.380355)) 1)))
 (=> $x8654 $x10268)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10521)))
(check-sat)

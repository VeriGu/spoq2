...
(assert
 ...
 (not $x964))))))))))))))
(assert
 (forall ((gidx.369196 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let (($x37659 (= (g_norm (select ?x2931 gidx.369196)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.369196)) 1)))
 (=> $x2971 $x37659)))))))))))))
 )
(assert
 (forall ((v_0.369231 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.369231))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
...
(assert
 (let (($x3046 (forall ((gidx.369367 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
...
(let ((a!2 (spinlock_release_spec.0_call
 ...
 (let (($x12153 (= (g_norm (select ?x3083 gidx.369367)) zero_granule_data)))
 (let (($x3056 (= (e_state_s_granule (select (g_granules (globals ?x2956)) gidx.369367)) 1)))
 (or (not $x3056) $x12153)))))))))))))))))
 ))
 (let (($x2904 (forall ((gidx.369356 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x21765 (share ?x1136)))
 (let ((?x2931 (granule_data ?x21765)))
 (let (($x37659 (= (g_norm (select ?x2931 gidx.369356)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.369356)) 1)))
 (or (not $x2971) $x37659)))))))))))))
 ))
 (or (not $x2904) $x3046))))
(assert
...
(assert
 true)
(assert
 (let (($x3095 (forall ((gidx.369408 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x21765 (share ?x1136)))
 (let ((?x2931 (granule_data ?x21765)))
 (let (($x37659 (= (g_norm (select ?x2931 gidx.369408)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.369408)) 1)))
 (=> $x2971 $x37659)))))))))))))
 ))
 (not $x3095)))
(check-sat)

...
(assert
 ...
 (not $x1150)))))))))))))))))))
(assert
 (forall ((gidx.368910 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1048 (spinlock_acquire_spec.0_call ?x992 ?x1634)))
 (let ((?x1050 (value_RData ?x1048)))
 (let ((?x66474 (spinlock_release_spec.0_call ?x992 ?x1050)))
 (let ((?x47398 (value_RData ?x66474)))
 (let ((?x30665 (share ?x47398)))
 (let ((?x3116 (granule_data ?x30665)))
 (let (($x2746 (= (g_norm (select ?x3116 gidx.368910)) zero_granule_data)))
 (let (($x2868 (= (e_state_s_granule (select (g_granules (globals ?x30665)) gidx.368910)) 1)))
 (=> $x2868 $x2746))))))))))))))))))
 )
(assert
 (forall ((v_0.368945 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.368945))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x47398 (value_RData ?x66474)))
 (let ((?x30665 (share ?x47398)))
 (let ((?x2650 (gpt ?x30665)))
 (select ?x2650 ?x1632)))))))))))))))))
 )
(assert
 (let (($x29704 (forall ((gidx.369081 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x47398 (value_RData ?x66474)))
 (let ((?x30665 (share ?x47398)))
 (let ((?x29583 (log ?x47398)))
 (let ((?x2953 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (spinlock_acquire_spec.0_call
...
(let ((a!3 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!2))))
  (oracle (value_RData a!3)))))_call| ?x29583)))
 (let ((?x2830 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (spinlock_acquire_spec.0_call
...
(let ((a!3 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!2))))
  (repl (value_RData a!3)))))_call| ?x2953 ?x30665)))
 (let ((?x2756 (value_Shared ?x2830)))
 (let ((?x29435 (granule_data ?x2756)))
 (let (($x2697 (= (g_norm (select ?x29435 gidx.369081)) zero_granule_data)))
 (let (($x2916 (= (e_state_s_granule (select (g_granules (globals ?x2756)) gidx.369081)) 1)))
 (or (not $x2916) $x2697))))))))))))))))))))))
 ))
 (let (($x37201 (forall ((gidx.369070 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x30665 (share ?x47398)))
 (let ((?x3116 (granule_data ?x30665)))
 (let (($x2746 (= (g_norm (select ?x3116 gidx.369070)) zero_granule_data)))
 (let (($x2868 (= (e_state_s_granule (select (g_granules (globals ?x30665)) gidx.369070)) 1)))
 (or (not $x2868) $x2746))))))))))))))))))
 ))
 (or (not $x37201) $x29704))))
(assert
 (let (($x3125 (forall ((gidx.369122 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x30665 (share ?x47398)))
 (let ((?x3116 (granule_data ?x30665)))
 (let (($x2746 (= (g_norm (select ?x3116 gidx.369122)) zero_granule_data)))
 (let (($x2868 (= (e_state_s_granule (select (g_granules (globals ?x30665)) gidx.369122)) 1)))
 (=> $x2868 $x2746))))))))))))))))))
 ))
 (not $x3125)))
(check-sat)

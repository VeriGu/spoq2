...
(assert
 (let (($x37457 (forall ((gidx.368587 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x361586 (share ?x2227)))
 (let ((?x2783 (granule_data ?x361586)))
 (let (($x29186 (= (g_norm (select ?x2783 gidx.368587)) zero_granule_data)))
 (let (($x29506 (= (e_state_s_granule (select (g_granules (globals ?x361586)) gidx.368587)) 1)))
 (=> $x29506 $x29186))))))))))))))))))))))))
 ))
 (not $x37457)))
(check-sat)

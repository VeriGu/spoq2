...
(let ((a!45 (granule_unlock_spec.0_call
 ...
 (or (not $x5379) $x48039))))
(assert
 (let (($x5080 (forall ((gidx.373031 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x77222 (share ?x5326)))
 (let ((?x4952 (granule_data ?x77222)))
 (let (($x4831 (= (g_norm (select ?x4952 gidx.373031)) zero_granule_data)))
 (let (($x4819 (= (e_state_s_granule (select (g_granules (globals ?x77222)) gidx.373031)) 1)))
 (=> $x4819 $x4831)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5080)))
(check-sat)

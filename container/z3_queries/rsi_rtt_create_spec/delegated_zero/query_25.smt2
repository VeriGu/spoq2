...
(assert
 (let (($x39781 (forall ((gidx.370933 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x69597 (share ?x3777)))
 (let ((?x4048 (granule_data ?x69597)))
 (let (($x4205 (= (g_norm (select ?x4048 gidx.370933)) zero_granule_data)))
 (let (($x3498 (= (e_state_s_granule (select (g_granules (globals ?x69597)) gidx.370933)) 1)))
 (=> $x3498 $x4205))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39781)))
(check-sat)

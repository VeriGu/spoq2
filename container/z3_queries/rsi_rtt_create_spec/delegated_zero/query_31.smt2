...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
                    (retval___1.363635 Int)
                    (st_10.363635 RData))
             (! (let ((a!1 (exists ((st_11.363624 RData))
                ...
                (let ((a!5 (value_Tuple_abs_ret_rtt_RData
                  ...
                  (= (Some_RData st_11.363624)
                     (granule_unlock_spec.0_call
                       ...
                       (elem_1 a!5))))))))
                :weight 0)))
      (a!21 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (rec_to_ttbr1_para.0_call
             (mkPtr "granule_data"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1)))
...
(let ((a!9 (value_RData (granule_unlock_spec.0_call
                          (e_2 (elem_0 a!5))
                          (elem_1 a!5))))
      (a!14 (+ (poffset (e_2 (elem_0 a!5))) (* 8 (e_3 (elem_0 a!5))))))
...
(let ((a!15 (gd_g_idx (select (granule_data (share a!13)) (div a!14 4096))))
      (a!16 (g_granule_state (select (granule_data (share a!13))
                                     (div a!14 4096))))
      (a!17 (g_norm (select (granule_data (share a!13)) (div a!14 4096))))
      (a!19 (g_rd (select (granule_data (share a!13)) (div a!14 4096))))
      (a!20 (g_rec (select (granule_data (share a!13)) (div a!14 4096))))
      (a!22 (select (g_granules (globals (share a!13))) a!21)))
(let ((a!18 (store a!17
                   (mod a!14 4096)
                   (test_PTE_Z.0_call
                     (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0))))
      (a!23 (store (g_granules (globals (share a!13)))
                   a!21
                   (mks_granule (e_lock a!22) 5 (e_ref a!22)))))
(let ((a!24 (mkGLOBALS (g_heap (globals (share a!13)))
                       (g_debug_exits (globals (share a!13)))
                       (g_vmid_count (globals (share a!13)))
                       (g_vmid_lock (globals (share a!13)))
                       (g_vmids (globals (share a!13)))
                       (g_nr_lrs (globals (share a!13)))
                       (g_nr_aprs (globals (share a!13)))
                       (g_max_vintid (globals (share a!13)))
                       (g_pri_res0_mask (globals (share a!13)))
                       (g_default_gicstate (globals (share a!13)))
                       (g_status_handler (globals (share a!13)))
                       (g_rmm_trap_list (globals (share a!13)))
                       (g_tt_l3_buffer (globals (share a!13)))
                       (g_tt_l2_mem0_0 (globals (share a!13)))
                       (g_tt_l2_mem0_1 (globals (share a!13)))
                       (g_tt_l2_mem1_0 (globals (share a!13)))
                       (g_tt_l2_mem1_1 (globals (share a!13)))
                       (g_tt_l2_mem1_2 (globals (share a!13)))
                       (g_tt_l2_mem1_3 (globals (share a!13)))
                       (g_tt_l1_upper (globals (share a!13)))
                       (g_mbedtls_mem_buf (globals (share a!13)))
                       a!23
                       (g_rmm_attest_signing_key (globals (share a!13)))
                       (g_rmm_attest_public_key (globals (share a!13)))
                       (g_rmm_attest_public_key_len (globals (share a!13)))
                       (g_rmm_attest_public_key_hash (globals (share a!13)))
                       (g_rmm_attest_public_key_hash_len (globals (share a!13)))
                       (g_platform_token_buf (globals (share a!13)))
                       (g_rmm_platform_token (globals (share a!13)))
                       (g_get_realm_identity_identity (globals (share a!13)))
                       (g_realm_attest_private_key (globals (share a!13))))))
(let ((a!25 (mkShared (gpt (share a!13))
                      (store (granule_data (share a!13))
                             (div a!14 4096)
                             (mkr_granule_data a!15 a!16 a!18 a!19 a!20))
                      a!24)))
(let ((a!26 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!5))
                           (mkRData (log a!13)
                                    (oracle a!13)
                                    (repl a!13)
                                    ...
                                    (stack a!13)
                                    (halt a!13))))))
  (repl a!26))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!26 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!13)
                                    ...
                                    (stack a!13)
                                    (halt a!13))))))
  (oracle a!26))))))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!26 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!13)
                                    ...
                                    (stack a!13)
                                    (halt a!13))))))
(let ((a!27 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!26)))
  (repl (value_RData a!27))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!27 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!26)))
  (oracle (value_RData a!27))))))))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(assert
 ...
 (let (($x4726 (exists ((st_12.363620 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x4630 (value_RData ?x4675)))
 (let ((?x4362 (granule_unlock_spec.0_call ?x992 ?x4630)))
 (let ((?x736 (Some_RData st_12.363620)))
 (= ?x736 ?x4362)))))))))))))))))))))))))))))
 ))
 (let (($x1077 (exists ((st_11.363624 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x3644 (e_2 ?x3391)))
 (let ((?x4675 (granule_unlock_spec.0_call ?x3644 ?x3479)))
 (let ((?x736 (Some_RData st_11.363624)))
 (= ?x736 ?x4675)))))))))))))))))))))))))))
 ))
 (let ((?x3746 (ite (and $x1077 $x4726) ?x4643 None_Tuple_bool_Z_RData)))
 (let ((?x4711 (value_Tuple_bool_Z_RData ?x3746)))
 (let ((?x4340 (elem_2 ?x4711)))
 (let ((?x4216 (elem_1 ?x4711)))
 (let (($x2631 (elem_0 ?x4711)))
 (let ((?x4061 (mkTuple_bool_Z_RData $x2631 ?x4216 ?x4340)))
 (let ((?x4361 (Some_Tuple_bool_Z_RData ?x4061)))
 (let (($x4518 (exists ((return___1.363635 Bool) (retval___1.363635 Int) (st_10.363635 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x3746 (ite (and $x1077 $x4726) ?x4643 None_Tuple_bool_Z_RData)))
 (let ((?x1901 (mkTuple_bool_Z_RData return___1.363635 retval___1.363635 st_10.363635)))
 (let ((?x1896 (Some_Tuple_bool_Z_RData ?x1901)))
 (= ?x1896 ?x3746))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x4471 (value_Tuple_bool_Z_RData (ite $x4518 ?x4361 None_Tuple_bool_Z_RData))))
 (let (($x4723 (elem_0 ?x4471)))
 (not $x4723)))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1062 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x991 (meta_granule_offset ?x1062)))
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.371790 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x4471 (value_Tuple_bool_Z_RData (ite $x4518 ?x4361 None_Tuple_bool_Z_RData))))
 (let ((?x3591 (elem_2 ?x4471)))
 (let (($x4423 (halt ?x3591)))
 (let ((?x4679 (stack ?x3591)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x3614 (share ?x3591)))
 (let ((?x13256 (globals ?x3614)))
 (let ((?x3377 (g_granules ?x13256)))
 (let ((?x3907 (select ?x3377 ?x28222)))
 (let ((?x3903 (mks_granule (e_lock ?x3907) 5 (e_ref ?x3907))))
 (let ((?x3834 (store ?x3377 ?x28222 ?x3903)))
 (let ((?x3898 (mkGLOBALS (g_heap ?x13256) (g_debug_exits ?x13256) (g_vmid_count ?x13256) (g_vmid_lock ?x13256) (g_vmids ?x13256) (g_nr_lrs ?x13256) (g_nr_aprs ?x13256) (g_max_vintid ?x13256) (g_pri_res0_mask ?x13256) (g_default_gicstate ?x13256) (g_status_handler ?x13256) (g_rmm_trap_list ?x13256) (g_tt_l3_buffer ?x13256) (g_tt_l2_mem0_0 ?x13256) (g_tt_l2_mem0_1 ?x13256) (g_tt_l2_mem1_0 ?x13256) (g_tt_l2_mem1_1 ?x13256) (g_tt_l2_mem1_2 ?x13256) (g_tt_l2_mem1_3 ?x13256) (g_tt_l1_upper ?x13256) (g_mbedtls_mem_buf ?x13256) ?x3834 (g_rmm_attest_signing_key ?x13256) (g_rmm_attest_public_key ?x13256) (g_rmm_attest_public_key_len ?x13256) (g_rmm_attest_public_key_hash ?x13256) (g_rmm_attest_public_key_hash_len ?x13256) (g_platform_token_buf ?x13256) (g_rmm_platform_token ?x13256) (g_get_realm_identity_identity ?x13256) (g_realm_attest_private_key ?x13256))))
 (let ((?x3669 (e_3 ?x3391)))
 (let ((?x3667 (* 8 ?x3669)))
 (let ((?x3662 (poffset ?x3644)))
 (let ((?x3590 (+ ?x3662 ?x3667)))
 (let ((?x3316 (div ?x3590 4096)))
 (let ((?x48086 (granule_data ?x3614)))
 (let ((?x4776 (select ?x48086 ?x3316)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x4176 (mod ?x3590 4096)))
 (let ((?x4743 (g_norm ?x4776)))
 (let ((?x4755 (store ?x4743 ?x4176 ?x35861)))
 (let ((?x3844 (mkr_granule_data (gd_g_idx ?x4776) (g_granule_state ?x4776) ?x4755 (g_rd ?x4776) (g_rec ?x4776))))
 (let ((?x4753 (store ?x48086 ?x3316 ?x3844)))
 (let ((?x4703 (gpt ?x3614)))
 (let ((?x4706 (priv ?x3591)))
 (let ((?x3190 (repl ?x3591)))
 (let ((?x4091 (oracle ?x3591)))
 (let ((?x4759 (log ?x3591)))
 (let ((?x47794 (granule_unlock_spec.0_call ?x3644 (mkRData ?x4759 ?x4091 ?x3190 ?x4706 (mkShared ?x4703 ?x4753 ?x3898) ?x4679 $x4423))))
 (let ((?x47657 (value_RData ?x47794)))
 (let ((?x822323 (share ?x47657)))
 (let ((?x4661 (granule_data ?x822323)))
 (let (($x47637 (= (g_norm (select ?x4661 gidx.371790)) zero_granule_data)))
 (let (($x4022 (= (e_state_s_granule (select (g_granules (globals ?x822323)) gidx.371790)) 1)))
 (=> $x4022 $x47637)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.371825 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.371825))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x47657 (value_RData ?x47794)))
 (let ((?x822323 (share ?x47657)))
 (let ((?x4791 (gpt ?x822323)))
 (select ?x4791 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x56761 (forall ((gidx.371961 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x47657 (value_RData ?x47794)))
 (let ((?x822323 (share ?x47657)))
 (let ((?x3692 (log ?x47657)))
 (let ((?x4089 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!26 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!13)
                                    ...
                                    (stack a!13)
                                    (halt a!13))))))
  (oracle a!26))))))))))))))))_call| ?x3692)))
 (let ((?x4431 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!26 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!13)
                                    ...
                                    (stack a!13)
                                    (halt a!13))))))
  (repl a!26))))))))))))))))_call| ?x4089 ?x822323)))
 (let ((?x39589 (value_Shared ?x4431)))
 (let ((?x4655 (granule_data ?x39589)))
 (let (($x48408 (= (g_norm (select ?x4655 gidx.371961)) zero_granule_data)))
 (let (($x48592 (= (e_state_s_granule (select (g_granules (globals ?x39589)) gidx.371961)) 1)))
 (or (not $x48592) $x48408)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x40534 (forall ((gidx.371950 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x822323 (share ?x47657)))
 (let ((?x4661 (granule_data ?x822323)))
 (let (($x47637 (= (g_norm (select ?x4661 gidx.371950)) zero_granule_data)))
 (let (($x4022 (= (e_state_s_granule (select (g_granules (globals ?x822323)) gidx.371950)) 1)))
 (or (not $x4022) $x47637)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x40534) $x56761))))
(assert
 (forall ((gidx.372038 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x47794 (granule_unlock_spec.0_call ?x3644 (mkRData ?x4759 ?x4091 ?x3190 ?x4706 (mkShared ?x4703 ?x4753 ?x3898) ?x4679 $x4423))))
 (let ((?x47657 (value_RData ?x47794)))
 (let ((?x37552 (granule_unlock_spec.0_call ?x992 ?x47657)))
 (let ((?x4262 (value_RData ?x37552)))
 (let ((?x221885 (share ?x4262)))
 (let ((?x4910 (granule_data ?x221885)))
 (let (($x4795 (= (g_norm (select ?x4910 gidx.372038)) zero_granule_data)))
 (let (($x3277 (= (e_state_s_granule (select (g_granules (globals ?x221885)) gidx.372038)) 1)))
 (=> $x3277 $x4795)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.372073 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.372073))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x4262 (value_RData ?x37552)))
 (let ((?x221885 (share ?x4262)))
 (let ((?x4948 (gpt ?x221885)))
 (select ?x4948 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x4629 (forall ((gidx.372209 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x221885 (share ?x4262)))
 (let ((?x4517 (log ?x4262)))
 (let ((?x4540 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!27 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!26)))
  (oracle (value_RData a!27))))))))))))))))))_call| ?x4517)))
 (let ((?x4955 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!27 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!26)))
  (repl (value_RData a!27))))))))))))))))))_call| ?x4540 ?x221885)))
 (let ((?x4770 (value_Shared ?x4955)))
 (let ((?x4575 (granule_data ?x4770)))
 (let (($x48193 (= (g_norm (select ?x4575 gidx.372209)) zero_granule_data)))
 (let (($x3829 (= (e_state_s_granule (select (g_granules (globals ?x4770)) gidx.372209)) 1)))
 (or (not $x3829) $x48193)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x4921 (forall ((gidx.372198 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x221885 (share ?x4262)))
 (let ((?x4910 (granule_data ?x221885)))
 (let (($x4795 (= (g_norm (select ?x4910 gidx.372198)) zero_granule_data)))
 (let (($x3277 (= (e_state_s_granule (select (g_granules (globals ?x221885)) gidx.372198)) 1)))
 (or (not $x3277) $x4795)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x4921) $x4629))))
(assert
 (forall ((gidx.372286 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x37552 (granule_unlock_spec.0_call ?x992 ?x47657)))
 (let ((?x4262 (value_RData ?x37552)))
 (let ((?x4665 (granule_unlock_spec.0_call ?x1576 ?x4262)))
 (let ((?x5014 (value_RData ?x4665)))
 (let ((?x231623 (share ?x5014)))
 (let ((?x4938 (granule_data ?x231623)))
 (let (($x5041 (= (g_norm (select ?x4938 gidx.372286)) zero_granule_data)))
 (let (($x5328 (= (e_state_s_granule (select (g_granules (globals ?x231623)) gidx.372286)) 1)))
 (=> $x5328 $x5041)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.372321 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.372321))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x5014 (value_RData ?x4665)))
 (let ((?x231623 (share ?x5014)))
 (let ((?x1447 (gpt ?x231623)))
 (select ?x1447 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x5000 (forall ((gidx.372457 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x231623 (share ?x5014)))
 (let ((?x5050 (log ?x5014)))
 (let ((?x5059 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!27))))
  (oracle (value_RData a!28)))))))))))))))))))_call| ?x5050)))
 (let ((?x5179 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!6 (exists ((return___1.363635 Bool)
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!27))))
  (repl (value_RData a!28)))))))))))))))))))_call| ?x5059 ?x231623)))
 (let ((?x5102 (value_Shared ?x5179)))
 (let ((?x5094 (granule_data ?x5102)))
 (let (($x4446 (= (g_norm (select ?x5094 gidx.372457)) zero_granule_data)))
 (let (($x4276 (= (e_state_s_granule (select (g_granules (globals ?x5102)) gidx.372457)) 1)))
 (or (not $x4276) $x4446)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x35745 (forall ((gidx.372446 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x231623 (share ?x5014)))
 (let ((?x4938 (granule_data ?x231623)))
 (let (($x5041 (= (g_norm (select ?x4938 gidx.372446)) zero_granule_data)))
 (let (($x5328 (= (e_state_s_granule (select (g_granules (globals ?x231623)) gidx.372446)) 1)))
 (or (not $x5328) $x5041)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x35745) $x5000))))
(assert
 (let (($x142829 (forall ((gidx.372498 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x231623 (share ?x5014)))
 (let ((?x4938 (granule_data ?x231623)))
 (let (($x5041 (= (g_norm (select ?x4938 gidx.372498)) zero_granule_data)))
 (let (($x5328 (= (e_state_s_granule (select (g_granules (globals ?x231623)) gidx.372498)) 1)))
 (=> $x5328 $x5041)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x142829)))
(check-sat)

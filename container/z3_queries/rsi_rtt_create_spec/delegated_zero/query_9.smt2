...
(assert
 ...
 (= ?x57321 0)))))
(assert
 (let (($x2583 (forall ((gidx.367805 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (=> (= (e_state_s_granule (select ?x2034 gidx.367805)) 1) (= (g_norm (select ?x2100 gidx.367805)) zero_granule_data)))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2583)))
(check-sat)

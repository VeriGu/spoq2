...
(assert
 (let (($x55816 (forall ((gidx.380889 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x765450 (share ?x9466)))
 (let ((?x9256 (granule_data ?x765450)))
 (let (($x9996 (= (g_norm (select ?x9256 gidx.380889)) zero_granule_data)))
 (let (($x10398 (= (e_state_s_granule (select (g_granules (globals ?x765450)) gidx.380889)) 1)))
 (=> $x10398 $x9996)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x55816)))
(check-sat)

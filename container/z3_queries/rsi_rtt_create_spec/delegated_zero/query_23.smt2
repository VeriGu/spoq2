...
(assert
 ...
 (and $x3656 $x3449)))))))))))))))))))))))))))))))))))
(assert
 (let (($x3984 (forall ((gidx.370437 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x41999 (share ?x3479)))
 (let ((?x3353 (granule_data ?x41999)))
 (let (($x3789 (= (g_norm (select ?x3353 gidx.370437)) zero_granule_data)))
 (let (($x3290 (= (e_state_s_granule (select (g_granules (globals ?x41999)) gidx.370437)) 1)))
 (=> $x3290 $x3789)))))))))))))))))))))))))))
 ))
 (not $x3984)))
(check-sat)

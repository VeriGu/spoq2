...
(let ((a!7 (granule_unlock_spec.0_call
 ...
 (or (not $x8392) $x9069))))
(assert
 (let (($x45091 (forall ((gidx.376979 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x73893 (share ?x4658)))
 (let ((?x6713 (granule_data ?x73893)))
 (let (($x8203 (= (g_norm (select ?x6713 gidx.376979)) zero_granule_data)))
 (let (($x7573 (= (e_state_s_granule (select (g_granules (globals ?x73893)) gidx.376979)) 1)))
 (=> $x7573 $x8203)))))))))))))))))))))))))))))))))
 ))
 (not $x45091)))
(check-sat)

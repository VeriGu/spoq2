...
(let ((a!52 (granule_unlock_spec.0_call
 ...
 (or (not $x55430) $x9945))))
(assert
 (let (($x9149 (forall ((gidx.379287 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x100984 (share ?x9239)))
 (let ((?x10015 (granule_data ?x100984)))
 (let (($x10022 (= (g_norm (select ?x10015 gidx.379287)) zero_granule_data)))
 (let (($x27414 (= (e_state_s_granule (select (g_granules (globals ?x100984)) gidx.379287)) 1)))
 (=> $x27414 $x10022))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9149)))
(check-sat)

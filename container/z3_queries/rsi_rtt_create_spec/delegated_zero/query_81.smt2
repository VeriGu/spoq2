...
(assert
 (let (($x14847 (forall ((gidx.385619 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x62421 (share ?x44207)))
 (let ((?x14789 (granule_data ?x62421)))
 (let (($x14537 (= (g_norm (select ?x14789 gidx.385619)) zero_granule_data)))
 (let (($x15414 (= (e_state_s_granule (select (g_granules (globals ?x62421)) gidx.385619)) 1)))
 (=> $x15414 $x14537)))))))))))))))))))))))))))
 ))
 (not $x14847)))
(check-sat)

...
(assert
 (let (($x115101 (forall ((gidx.385085 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x89151 (share ?x10240)))
 (let ((?x11687 (granule_data ?x89151)))
 (let (($x14909 (= (g_norm (select ?x11687 gidx.385085)) zero_granule_data)))
 (let (($x14431 (= (e_state_s_granule (select (g_granules (globals ?x89151)) gidx.385085)) 1)))
 (=> $x14431 $x14909)))))))))))))))))))))))))))))))))))
 ))
 (not $x115101)))
(check-sat)

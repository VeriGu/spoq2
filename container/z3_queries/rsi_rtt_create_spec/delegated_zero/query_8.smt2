...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!4 (exists ((return___1.363002 Bool)
                    (retval___1.363002 Int)
                    (st_10.363002 RData))
             (! (let ((a!1 (and (exists ((st_11.362991 RData))
                                  (! (let ((a!1 (spinlock_acquire_spec.0_call
                                     ...
                                     (let ((a!4 (granule_unlock_spec.0_call
                                                  (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData
                                                                 a!3)))
                                                  (elem_1 (value_Tuple_abs_ret_rtt_RData
                                                            a!3)))))
                                       (= (Some_RData st_11.362991) a!4)))))
                                     :weight 0))
                                (exists ((st_12.362987 RData))
                                  (! (let ((a!1 (spinlock_acquire_spec.0_call
                                                  (mkPtr "granules"
                                                         (meta_granule_offset
                                                           (test_PA.0_call v_1_Zptr.0)))
                                     ...
                                     (let ((a!5 (granule_unlock_spec.0_call
                                                  (mkPtr "granules"
                                                         (meta_granule_offset
                                                           (test_PA.0_call v_0_Zptr.0)))
                                                  (value_RData a!4))))
                                       (= (Some_RData st_12.362987) a!5))))))
                                     :weight 0))))
                      (a!2 (spinlock_acquire_spec.0_call
                             (mkPtr "granules"
                                    (meta_granule_offset
                                      (test_PA.0_call v_1_Zptr.0)))
                             st.0)))
                ...
                (let ((a!6 (granule_unlock_spec.0_call
                             (mkPtr "granules"
                                    (meta_granule_offset
                                      (test_PA.0_call v_0_Zptr.0)))
                             (value_RData a!5))))
                (let ((a!7 (Some_Tuple_bool_Z_RData
                  ...
                  (= (Some_Tuple_bool_Z_RData
                       (mkTuple_bool_Z_RData
                         ...
                         retval___1.363002
                         st_10.363002))
                     (ite a!1 a!7 None_Tuple_bool_Z_RData))))))))
                :weight 0)))
      (a!5 (and (exists ((st_11.362991 RData))
                  (! (let ((a!1 (spinlock_acquire_spec.0_call
                                  (mkPtr "granules"
                                         (meta_granule_offset
                                           (test_PA.0_call v_1_Zptr.0)))
                ...
                (exists ((st_12.362987 RData))
                  (! (let ((a!1 (spinlock_acquire_spec.0_call
                     ...
                     (let ((a!5 (granule_unlock_spec.0_call
                       ...
                       (= (Some_RData st_12.362987) a!5))))))
                     :weight 0))))
      (a!19 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!1))))
...
(let ((a!6 (granule_unlock_spec.0_call
             ...
             (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))
      (a!11 (poffset (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))))
      (a!12 (* 8 (e_3 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3))))))
(let ((a!7 (granule_unlock_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!6))))
(let ((a!8 (Some_Tuple_bool_Z_RData
             (mkTuple_bool_Z_RData
               true
               (pack_struct_return_code_para.0_call
                 (make_return_code_para.0_call 9))
               (value_RData a!7)))))
(let ((a!9 (mkTuple_bool_Z_RData
             (elem_0 (value_Tuple_bool_Z_RData
                       (ite a!5 a!8 None_Tuple_bool_Z_RData)))
             (elem_1 (value_Tuple_bool_Z_RData
                       (ite a!5 a!8 None_Tuple_bool_Z_RData)))
             (elem_2 (value_Tuple_bool_Z_RData
                       (ite a!5 a!8 None_Tuple_bool_Z_RData))))))
(let ((a!10 (elem_2 (value_Tuple_bool_Z_RData
                      (ite a!4
                           (Some_Tuple_bool_Z_RData a!9)
                           None_Tuple_bool_Z_RData)))))
(let ((a!13 (gd_g_idx (select (granule_data (share a!10))
                              (div (+ a!11 a!12) 4096))))
      (a!14 (g_granule_state (select (granule_data (share a!10))
                                     (div (+ a!11 a!12) 4096))))
      (a!15 (g_norm (select (granule_data (share a!10))
                            (div (+ a!11 a!12) 4096))))
      (a!17 (g_rd (select (granule_data (share a!10)) (div (+ a!11 a!12) 4096))))
      (a!18 (g_rec (select (granule_data (share a!10)) (div (+ a!11 a!12) 4096))))
      (a!20 (select (g_granules (globals (share a!10))) a!19)))
(let ((a!16 (store a!15
                   (mod (+ a!11 a!12) 4096)
                   (test_PTE_Z.0_call
                     (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0))))
      (a!21 (store (g_granules (globals (share a!10)))
                   a!19
                   (mks_granule (e_lock a!20) 5 (e_ref a!20)))))
(let ((a!22 (mkGLOBALS (g_heap (globals (share a!10)))
                       (g_debug_exits (globals (share a!10)))
                       (g_vmid_count (globals (share a!10)))
                       (g_vmid_lock (globals (share a!10)))
                       (g_vmids (globals (share a!10)))
                       (g_nr_lrs (globals (share a!10)))
                       (g_nr_aprs (globals (share a!10)))
                       (g_max_vintid (globals (share a!10)))
                       (g_pri_res0_mask (globals (share a!10)))
                       (g_default_gicstate (globals (share a!10)))
                       (g_status_handler (globals (share a!10)))
                       (g_rmm_trap_list (globals (share a!10)))
                       (g_tt_l3_buffer (globals (share a!10)))
                       (g_tt_l2_mem0_0 (globals (share a!10)))
                       (g_tt_l2_mem0_1 (globals (share a!10)))
                       (g_tt_l2_mem1_0 (globals (share a!10)))
                       (g_tt_l2_mem1_1 (globals (share a!10)))
                       (g_tt_l2_mem1_2 (globals (share a!10)))
                       (g_tt_l2_mem1_3 (globals (share a!10)))
                       (g_tt_l1_upper (globals (share a!10)))
                       (g_mbedtls_mem_buf (globals (share a!10)))
                       a!21
                       (g_rmm_attest_signing_key (globals (share a!10)))
                       (g_rmm_attest_public_key (globals (share a!10)))
                       (g_rmm_attest_public_key_len (globals (share a!10)))
                       (g_rmm_attest_public_key_hash (globals (share a!10)))
                       (g_rmm_attest_public_key_hash_len (globals (share a!10)))
                       (g_platform_token_buf (globals (share a!10)))
                       (g_rmm_platform_token (globals (share a!10)))
                       (g_get_realm_identity_identity (globals (share a!10)))
                       (g_realm_attest_private_key (globals (share a!10))))))
(let ((a!23 (mkShared (gpt (share a!10))
                      (store (granule_data (share a!10))
                             (div (+ a!11 a!12) 4096)
                             (mkr_granule_data a!13 a!14 a!16 a!17 a!18))
                      a!22)))
...
(let ((a!24 (granule_unlock_spec.0_call
              ...
              (mkRData (log a!10)
                       ...
                       (stack a!10)
                       (halt a!10)))))
(let ((a!25 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!24))))
  (repl (value_RData a!25))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!25 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!24))))
  (oracle (value_RData a!25))))))))))))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (let ((?x2134 (mkTuple_bool_Z_RData true ?x1904 ?x2174)))
 (let ((?x1624 (Some_Tuple_bool_Z_RData ?x2134)))
 (let (($x2246 (exists ((st_12.362987 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x2227 (value_RData ?x2222)))
 (let ((?x2242 (granule_unlock_spec.0_call ?x992 ?x2227)))
 (let ((?x736 (Some_RData st_12.362987)))
 (= ?x736 ?x2242))))))))))))))))))))))
 ))
 (let (($x2056 (exists ((st_11.362991 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1204 (e_2 ?x1189)))
 (let ((?x2222 (granule_unlock_spec.0_call ?x1204 ?x1186)))
 (let ((?x736 (Some_RData st_11.362991)))
 (= ?x736 ?x2222))))))))))))))))))))
 ))
 (let ((?x36206 (ite (and $x2056 $x2246) ?x1624 None_Tuple_bool_Z_RData)))
 (let ((?x2190 (value_Tuple_bool_Z_RData ?x36206)))
 (let ((?x36204 (elem_2 ?x2190)))
 (let ((?x2201 (elem_1 ?x2190)))
 (let (($x2173 (elem_0 ?x2190)))
 (let ((?x2255 (mkTuple_bool_Z_RData $x2173 ?x2201 ?x36204)))
 (let ((?x1905 (Some_Tuple_bool_Z_RData ?x2255)))
 (let (($x2218 (exists ((return___1.363002 Bool) (retval___1.363002 Int) (st_10.363002 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x36206 (ite (and $x2056 $x2246) ?x1624 None_Tuple_bool_Z_RData)))
 (let ((?x1901 (mkTuple_bool_Z_RData return___1.363002 retval___1.363002 st_10.363002)))
 (let ((?x1896 (Some_Tuple_bool_Z_RData ?x1901)))
 (= ?x1896 ?x36206)))))))))))))))))))))))))))))))
 ))
 (let ((?x1853 (value_Tuple_bool_Z_RData (ite $x2218 ?x1905 None_Tuple_bool_Z_RData))))
 (let (($x2206 (elem_0 ?x1853)))
 (not $x2206))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1062 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x991 (meta_granule_offset ?x1062)))
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.367308 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1853 (value_Tuple_bool_Z_RData (ite $x2218 ?x1905 None_Tuple_bool_Z_RData))))
 (let ((?x36389 (elem_2 ?x1853)))
 (let (($x28679 (halt ?x36389)))
 (let ((?x11146 (stack ?x36389)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x36401 (share ?x36389)))
 (let ((?x36402 (globals ?x36401)))
 (let ((?x2059 (g_granules ?x36402)))
 (let ((?x2138 (select ?x2059 ?x28222)))
 (let ((?x36002 (mks_granule (e_lock ?x2138) 5 (e_ref ?x2138))))
 (let ((?x36404 (store ?x2059 ?x28222 ?x36002)))
 (let ((?x5078 (mkGLOBALS (g_heap ?x36402) (g_debug_exits ?x36402) (g_vmid_count ?x36402) (g_vmid_lock ?x36402) (g_vmids ?x36402) (g_nr_lrs ?x36402) (g_nr_aprs ?x36402) (g_max_vintid ?x36402) (g_pri_res0_mask ?x36402) (g_default_gicstate ?x36402) (g_status_handler ?x36402) (g_rmm_trap_list ?x36402) (g_tt_l3_buffer ?x36402) (g_tt_l2_mem0_0 ?x36402) (g_tt_l2_mem0_1 ?x36402) (g_tt_l2_mem1_0 ?x36402) (g_tt_l2_mem1_1 ?x36402) (g_tt_l2_mem1_2 ?x36402) (g_tt_l2_mem1_3 ?x36402) (g_tt_l1_upper ?x36402) (g_mbedtls_mem_buf ?x36402) ?x36404 (g_rmm_attest_signing_key ?x36402) (g_rmm_attest_public_key ?x36402) (g_rmm_attest_public_key_len ?x36402) (g_rmm_attest_public_key_hash ?x36402) (g_rmm_attest_public_key_hash_len ?x36402) (g_platform_token_buf ?x36402) (g_rmm_platform_token ?x36402) (g_get_realm_identity_identity ?x36402) (g_realm_attest_private_key ?x36402))))
 (let ((?x1209 (e_3 ?x1189)))
 (let ((?x1242 (* 8 ?x1209)))
 (let ((?x1206 (poffset ?x1204)))
 (let ((?x1318 (+ ?x1206 ?x1242)))
 (let ((?x1341 (div ?x1318 4096)))
 (let ((?x3263 (granule_data ?x36401)))
 (let ((?x28719 (select ?x3263 ?x1341)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x1746 (mod ?x1318 4096)))
 (let ((?x28682 (g_norm ?x28719)))
 (let ((?x28696 (store ?x28682 ?x1746 ?x35861)))
 (let ((?x1866 (mkr_granule_data (gd_g_idx ?x28719) (g_granule_state ?x28719) ?x28696 (g_rd ?x28719) (g_rec ?x28719))))
 (let ((?x2265 (store ?x3263 ?x1341 ?x1866)))
 (let ((?x1848 (gpt ?x36401)))
 (let ((?x19813 (priv ?x36389)))
 (let ((?x28681 (repl ?x36389)))
 (let ((?x1952 (oracle ?x36389)))
 (let ((?x28404 (log ?x36389)))
 (let ((?x1937 (granule_unlock_spec.0_call ?x1204 (mkRData ?x28404 ?x1952 ?x28681 ?x19813 (mkShared ?x1848 ?x2265 ?x5078) ?x11146 $x28679))))
 (let ((?x28715 (value_RData ?x1937)))
 (let ((?x727149 (share ?x28715)))
 (let ((?x2098 (granule_data ?x727149)))
 (let (($x18950 (= (g_norm (select ?x2098 gidx.367308)) zero_granule_data)))
 (let (($x36609 (= (e_state_s_granule (select (g_granules (globals ?x727149)) gidx.367308)) 1)))
 (=> $x36609 $x18950))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.367343 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.367343))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x28715 (value_RData ?x1937)))
 (let ((?x727149 (share ?x28715)))
 (let ((?x36627 (gpt ?x727149)))
 (select ?x36627 ?x1632)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x28900 (forall ((gidx.367479 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x28715 (value_RData ?x1937)))
 (let ((?x727149 (share ?x28715)))
 (let ((?x1865 (log ?x28715)))
 (let ((?x2143 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!4 (exists ((return___1.363002 Bool)
...
(let ((a!24 (granule_unlock_spec.0_call
              ...
              (mkRData (log a!10)
                       ...
                       (stack a!10)
                       (halt a!10)))))
  (oracle (value_RData a!24)))))))))))))))_call| ?x1865)))
 (let ((?x2314 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!4 (exists ((return___1.363002 Bool)
...
(let ((a!24 (granule_unlock_spec.0_call
              ...
              (mkRData (log a!10)
                       ...
                       (stack a!10)
                       (halt a!10)))))
  (repl (value_RData a!24)))))))))))))))_call| ?x2143 ?x727149)))
 (let ((?x36545 (value_Shared ?x2314)))
 (let ((?x2259 (granule_data ?x36545)))
 (let (($x45610 (= (g_norm (select ?x2259 gidx.367479)) zero_granule_data)))
 (let (($x36744 (= (e_state_s_granule (select (g_granules (globals ?x36545)) gidx.367479)) 1)))
 (or (not $x36744) $x45610))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x28887 (forall ((gidx.367468 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x727149 (share ?x28715)))
 (let ((?x2098 (granule_data ?x727149)))
 (let (($x18950 (= (g_norm (select ?x2098 gidx.367468)) zero_granule_data)))
 (let (($x36609 (= (e_state_s_granule (select (g_granules (globals ?x727149)) gidx.367468)) 1)))
 (or (not $x36609) $x18950))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x28887) $x28900))))
(assert
 (forall ((gidx.367556 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1937 (granule_unlock_spec.0_call ?x1204 (mkRData ?x28404 ?x1952 ?x28681 ?x19813 (mkShared ?x1848 ?x2265 ?x5078) ?x11146 $x28679))))
 (let ((?x28715 (value_RData ?x1937)))
 (let ((?x36612 (granule_unlock_spec.0_call ?x992 ?x28715)))
 (let ((?x2116 (value_RData ?x36612)))
 (let ((?x210986 (share ?x2116)))
 (let ((?x2473 (granule_data ?x210986)))
 (let (($x2369 (= (g_norm (select ?x2473 gidx.367556)) zero_granule_data)))
 (let (($x2701 (= (e_state_s_granule (select (g_granules (globals ?x210986)) gidx.367556)) 1)))
 (=> $x2701 $x2369))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.367591 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.367591))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x2116 (value_RData ?x36612)))
 (let ((?x210986 (share ?x2116)))
 (let ((?x2495 (gpt ?x210986)))
 (select ?x2495 ?x1632)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x2308 (forall ((gidx.367727 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x2116 (value_RData ?x36612)))
 (let ((?x210986 (share ?x2116)))
 (let ((?x36076 (log ?x2116)))
 (let ((?x1428 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!4 (exists ((return___1.363002 Bool)
...
(let ((a!25 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!24))))
  (oracle (value_RData a!25))))))))))))))))_call| ?x36076)))
 (let ((?x2695 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!4 (exists ((return___1.363002 Bool)
...
(let ((a!25 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!24))))
  (repl (value_RData a!25))))))))))))))))_call| ?x1428 ?x210986)))
 (let ((?x2391 (value_Shared ?x2695)))
 (let ((?x2381 (granule_data ?x2391)))
 (let (($x2358 (= (g_norm (select ?x2381 gidx.367727)) zero_granule_data)))
 (let (($x2326 (= (e_state_s_granule (select (g_granules (globals ?x2391)) gidx.367727)) 1)))
 (or (not $x2326) $x2358))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2385 (forall ((gidx.367716 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x210986 (share ?x2116)))
 (let ((?x2473 (granule_data ?x210986)))
 (let (($x2369 (= (g_norm (select ?x2473 gidx.367716)) zero_granule_data)))
 (let (($x2701 (= (e_state_s_granule (select (g_granules (globals ?x210986)) gidx.367716)) 1)))
 (or (not $x2701) $x2369))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2385) $x2308))))
(assert
 (let (($x2488 (forall ((gidx.367768 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x210986 (share ?x2116)))
 (let ((?x2473 (granule_data ?x210986)))
 (let (($x2369 (= (g_norm (select ?x2473 gidx.367768)) zero_granule_data)))
 (let (($x2701 (= (e_state_s_granule (select (g_granules (globals ?x210986)) gidx.367768)) 1)))
 (=> $x2701 $x2369))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2488)))
(check-sat)

...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1))))
...
(assert
 ...
 (not $x3388))))))))))))))
(assert
 (forall ((gidx.385942 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 (let ((?x39636 (spinlock_release_spec.0_call ?x1576 ?x1634)))
 (let ((?x1136 (value_RData ?x39636)))
 (let ((?x21765 (share ?x1136)))
 (let ((?x2931 (granule_data ?x21765)))
 (let (($x37659 (= (g_norm (select ?x2931 gidx.385942)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.385942)) 1)))
 (=> $x2971 $x37659)))))))))))))
 )
(assert
 (forall ((v_0.385977 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.385977))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x1136 (value_RData ?x39636)))
 (let ((?x21765 (share ?x1136)))
 (let ((?x3091 (gpt ?x21765)))
 (select ?x3091 ?x1632))))))))))))
 )
(assert
 (let (($x14315 (forall ((gidx.386113 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1136 (value_RData ?x39636)))
 (let ((?x21765 (share ?x1136)))
 (let ((?x37660 (log ?x1136)))
 (let ((?x3129 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1))))
  (oracle (value_RData a!2))))_call| ?x37660)))
 (let ((?x29651 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0)))
(let ((a!2 (spinlock_release_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1))))
  (repl (value_RData a!2))))_call| ?x3129 ?x21765)))
 (let ((?x2956 (value_Shared ?x29651)))
 (let ((?x3083 (granule_data ?x2956)))
 (let (($x12153 (= (g_norm (select ?x3083 gidx.386113)) zero_granule_data)))
 (let (($x3056 (= (e_state_s_granule (select (g_granules (globals ?x2956)) gidx.386113)) 1)))
 (or (not $x3056) $x12153)))))))))))))))))
 ))
 (let (($x15037 (forall ((gidx.386102 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x21765 (share ?x1136)))
 (let ((?x2931 (granule_data ?x21765)))
 (let (($x37659 (= (g_norm (select ?x2931 gidx.386102)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.386102)) 1)))
 (or (not $x2971) $x37659)))))))))))))
 ))
 (or (not $x15037) $x14315))))
(assert
 true)
(assert
 true)
(assert
 (let (($x14319 (forall ((gidx.386154 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x21765 (share ?x1136)))
 (let ((?x2931 (granule_data ?x21765)))
 (let (($x37659 (= (g_norm (select ?x2931 gidx.386154)) zero_granule_data)))
 (let (($x2971 (= (e_state_s_granule (select (g_granules (globals ?x21765)) gidx.386154)) 1)))
 (=> $x2971 $x37659)))))))))))))
 ))
 (not $x14319)))
(check-sat)

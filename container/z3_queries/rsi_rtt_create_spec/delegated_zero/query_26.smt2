...
(let ((a!51 (granule_unlock_spec.0_call
 ...
 (or (not $x3959) $x5047))))
(assert
 (let (($x39973 (forall ((gidx.371181 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x86109 (share ?x4034)))
 (let ((?x4384 (granule_data ?x86109)))
 (let (($x4382 (= (g_norm (select ?x4384 gidx.371181)) zero_granule_data)))
 (let (($x4329 (= (e_state_s_granule (select (g_granules (globals ?x86109)) gidx.371181)) 1)))
 (=> $x4329 $x4382))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x39973)))
(check-sat)

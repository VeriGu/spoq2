...
(assert
 (let (($x48387 (forall ((gidx.372001 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x822323 (share ?x47657)))
 (let ((?x4661 (granule_data ?x822323)))
 (let (($x47637 (= (g_norm (select ?x4661 gidx.372001)) zero_granule_data)))
 (let (($x4022 (= (e_state_s_granule (select (g_granules (globals ?x822323)) gidx.372001)) 1)))
 (=> $x4022 $x47637)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x48387)))
(check-sat)

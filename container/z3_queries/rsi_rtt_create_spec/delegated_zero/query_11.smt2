...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!15 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
             (value_RData a!1))))
(let ((a!3 (rtt_walk_lock_unlock_spec_abs.0_call
             ...
             v_3.0
             (value_RData a!2))))
(let ((a!4 (gpt (share (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))))
      (a!5 (granule_data (share (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))))
      (a!6 (poffset (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))))
      (a!7 (* 8 (e_3 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))))
      (a!14 (globals (share (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
(let ((a!8 (gd_g_idx (select a!5 (div (+ a!6 a!7) 4096))))
      (a!9 (g_granule_state (select a!5 (div (+ a!6 a!7) 4096))))
      (a!10 (g_norm (select a!5 (div (+ a!6 a!7) 4096))))
      (a!12 (g_rd (select a!5 (div (+ a!6 a!7) 4096))))
      (a!13 (g_rec (select a!5 (div (+ a!6 a!7) 4096))))
      (a!16 (mks_granule (e_lock (select (g_granules a!14) a!15))
                         5
                         (e_ref (select (g_granules a!14) a!15)))))
(let ((a!11 (store a!10
                   (mod (+ a!6 a!7) 4096)
                   (test_PTE_Z.0_call
                     (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0)))))
(let ((a!17 (mkShared a!4
                      (store a!5
                             (div (+ a!6 a!7) 4096)
                             (mkr_granule_data a!8 a!9 a!11 a!12 a!13))
                      (mkGLOBALS (g_heap a!14)
                                 (g_debug_exits a!14)
                                 (g_vmid_count a!14)
                                 (g_vmid_lock a!14)
                                 (g_vmids a!14)
                                 ...
                                 (g_nr_aprs a!14)
                                 (g_max_vintid a!14)
                                 (g_pri_res0_mask a!14)
                                 (g_default_gicstate a!14)
                                 (g_status_handler a!14)
                                 (g_rmm_trap_list a!14)
                                 (g_tt_l3_buffer a!14)
                                 (g_tt_l2_mem0_0 a!14)
                                 (g_tt_l2_mem0_1 a!14)
                                 (g_tt_l2_mem1_0 a!14)
                                 ...
                                 (g_tt_l2_mem1_3 a!14)
                                 (g_tt_l1_upper a!14)
                                 (g_mbedtls_mem_buf a!14)
                                 (store (g_granules a!14) a!15 a!16)
                                 (g_rmm_attest_signing_key a!14)
                                 (g_rmm_attest_public_key a!14)
                                 (g_rmm_attest_public_key_len a!14)
                                 (g_rmm_attest_public_key_hash a!14)
                                 (g_rmm_attest_public_key_hash_len a!14)
                                 (g_platform_token_buf a!14)
                                 (g_rmm_platform_token a!14)
                                 (g_get_realm_identity_identity a!14)
                                 (g_realm_attest_private_key a!14)))))
(let ((a!18 (mkRData (log (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))
                     (oracle (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))
                     (repl (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))
                     (priv (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))
                     a!17
                     (stack (elem_1 (value_Tuple_abs_ret_rtt_RData a!3)))
                     (halt (elem_1 (value_Tuple_abs_ret_rtt_RData a!3))))))
(let ((a!19 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              a!18)))
  (repl (value_RData a!19)))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!19 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              a!18)))
  (oracle (value_RData a!19)))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!20 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!19))))
  (repl (value_RData a!20))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!20 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!19))))
  (oracle (value_RData a!20))))))))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.367842 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x1188 (value_Tuple_abs_ret_rtt_RData ?x1184)))
 (let ((?x1186 (elem_1 ?x1188)))
 (let (($x5075 (halt ?x1186)))
 (let ((?x1528 (stack ?x1186)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x29612 (share ?x1186)))
 (let ((?x1273 (globals ?x29612)))
 (let ((?x1274 (g_granules ?x1273)))
 (let ((?x2109 (select ?x1274 ?x28222)))
 (let ((?x2446 (mks_granule (e_lock ?x2109) 5 (e_ref ?x2109))))
 (let ((?x2034 (store ?x1274 ?x28222 ?x2446)))
 (let ((?x1259 (mkGLOBALS (g_heap ?x1273) (g_debug_exits ?x1273) (g_vmid_count ?x1273) (g_vmid_lock ?x1273) (g_vmids ?x1273) (g_nr_lrs ?x1273) (g_nr_aprs ?x1273) (g_max_vintid ?x1273) (g_pri_res0_mask ?x1273) (g_default_gicstate ?x1273) (g_status_handler ?x1273) (g_rmm_trap_list ?x1273) (g_tt_l3_buffer ?x1273) (g_tt_l2_mem0_0 ?x1273) (g_tt_l2_mem0_1 ?x1273) (g_tt_l2_mem1_0 ?x1273) (g_tt_l2_mem1_1 ?x1273) (g_tt_l2_mem1_2 ?x1273) (g_tt_l2_mem1_3 ?x1273) (g_tt_l1_upper ?x1273) (g_mbedtls_mem_buf ?x1273) ?x2034 (g_rmm_attest_signing_key ?x1273) (g_rmm_attest_public_key ?x1273) (g_rmm_attest_public_key_len ?x1273) (g_rmm_attest_public_key_hash ?x1273) (g_rmm_attest_public_key_hash_len ?x1273) (g_platform_token_buf ?x1273) (g_rmm_platform_token ?x1273) (g_get_realm_identity_identity ?x1273) (g_realm_attest_private_key ?x1273))))
 (let ((?x1189 (elem_0 ?x1188)))
 (let ((?x1209 (e_3 ?x1189)))
 (let ((?x1242 (* 8 ?x1209)))
 (let ((?x1204 (e_2 ?x1189)))
 ...
 (let ((?x1341 (div ?x1318 4096)))
 (let ((?x1288 (granule_data ?x29612)))
 (let ((?x2110 (select ?x1288 ?x1341)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x1746 (mod ?x1318 4096)))
 (let ((?x2336 (g_norm ?x2110)))
 (let ((?x2524 (store ?x2336 ?x1746 ?x35861)))
 (let ((?x2232 (mkr_granule_data (gd_g_idx ?x2110) (g_granule_state ?x2110) ?x2524 (g_rd ?x2110) (g_rec ?x2110))))
 (let ((?x2100 (store ?x1288 ?x1341 ?x2232)))
 (let ((?x1328 (gpt ?x29612)))
 (let ((?x1393 (priv ?x1186)))
 (let ((?x1201 (repl ?x1186)))
 (let ((?x1267 (oracle ?x1186)))
 (let ((?x1200 (log ?x1186)))
 (let ((?x36988 (granule_unlock_spec.0_call ?x1204 (mkRData ?x1200 ?x1267 ?x1201 ?x1393 (mkShared ?x1328 ?x2100 ?x1259) ?x1528 $x5075))))
 (let ((?x36936 (value_RData ?x36988)))
 (let ((?x535446 (share ?x36936)))
 (let ((?x1285 (granule_data ?x535446)))
 (let (($x2809 (= (g_norm (select ?x1285 gidx.367842)) zero_granule_data)))
 (let (($x2743 (= (e_state_s_granule (select (g_granules (globals ?x535446)) gidx.367842)) 1)))
 (=> $x2743 $x2809))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.367877 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.367877))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x36936 (value_RData ?x36988)))
 (let ((?x535446 (share ?x36936)))
 (let ((?x2337 (gpt ?x535446)))
 (select ?x2337 ?x1632)))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x36571 (forall ((gidx.368013 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x36936 (value_RData ?x36988)))
 (let ((?x535446 (share ?x36936)))
 (let ((?x2374 (log ?x36936)))
 (let ((?x2459 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!15 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!19 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              a!18)))
  (oracle (value_RData a!19)))))))))))_call| ?x2374)))
 (let ((?x2739 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!15 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!19 (granule_unlock_spec.0_call
              (e_2 (elem_0 (value_Tuple_abs_ret_rtt_RData a!3)))
              a!18)))
  (repl (value_RData a!19)))))))))))_call| ?x2459 ?x535446)))
 (let ((?x37203 (value_Shared ?x2739)))
 (let ((?x2818 (granule_data ?x37203)))
 (let (($x2273 (= (g_norm (select ?x2818 gidx.368013)) zero_granule_data)))
 (let (($x2732 (= (e_state_s_granule (select (g_granules (globals ?x37203)) gidx.368013)) 1)))
 (or (not $x2732) $x2273))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2348 (forall ((gidx.368002 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x535446 (share ?x36936)))
 (let ((?x1285 (granule_data ?x535446)))
 (let (($x2809 (= (g_norm (select ?x1285 gidx.368002)) zero_granule_data)))
 (let (($x2743 (= (e_state_s_granule (select (g_granules (globals ?x535446)) gidx.368002)) 1)))
 (or (not $x2743) $x2809))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2348) $x36571))))
(assert
 (forall ((gidx.368090 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x36988 (granule_unlock_spec.0_call ?x1204 (mkRData ?x1200 ?x1267 ?x1201 ?x1393 (mkShared ?x1328 ?x2100 ?x1259) ?x1528 $x5075))))
 (let ((?x36936 (value_RData ?x36988)))
 (let ((?x2441 (granule_unlock_spec.0_call ?x992 ?x36936)))
 (let ((?x2497 (value_RData ?x2441)))
 (let ((?x65066 (share ?x2497)))
 (let ((?x2866 (granule_data ?x65066)))
 (let (($x2823 (= (g_norm (select ?x2866 gidx.368090)) zero_granule_data)))
 (let (($x2599 (= (e_state_s_granule (select (g_granules (globals ?x65066)) gidx.368090)) 1)))
 (=> $x2599 $x2823))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.368125 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.368125))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x2497 (value_RData ?x2441)))
 (let ((?x65066 (share ?x2497)))
 (let ((?x2303 (gpt ?x65066)))
 (select ?x2303 ?x1632)))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x37195 (forall ((gidx.368261 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x65066 (share ?x2497)))
 (let ((?x2900 (log ?x2497)))
 (let ((?x2862 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!15 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!20 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!19))))
  (oracle (value_RData a!20))))))))))))_call| ?x2900)))
 (let ((?x2864 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!15 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!20 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!19))))
  (repl (value_RData a!20))))))))))))_call| ?x2862 ?x65066)))
 (let ((?x29136 (value_Shared ?x2864)))
 (let ((?x2428 (granule_data ?x29136)))
 (let (($x2762 (= (g_norm (select ?x2428 gidx.368261)) zero_granule_data)))
 (let (($x2366 (= (e_state_s_granule (select (g_granules (globals ?x29136)) gidx.368261)) 1)))
 (or (not $x2366) $x2762))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x2736 (forall ((gidx.368250 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x65066 (share ?x2497)))
 (let ((?x2866 (granule_data ?x65066)))
 (let (($x2823 (= (g_norm (select ?x2866 gidx.368250)) zero_granule_data)))
 (let (($x2599 (= (e_state_s_granule (select (g_granules (globals ?x65066)) gidx.368250)) 1)))
 (or (not $x2599) $x2823))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x2736) $x37195))))
(assert
 (let (($x2778 (forall ((gidx.368302 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x65066 (share ?x2497)))
 (let ((?x2866 (granule_data ?x65066)))
 (let (($x2823 (= (g_norm (select ?x2866 gidx.368302)) zero_granule_data)))
 (let (($x2599 (= (e_state_s_granule (select (g_granules (globals ?x65066)) gidx.368302)) 1)))
 (=> $x2599 $x2823))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2778)))
(check-sat)

...
(let ((a!19 (granule_unlock_spec.0_call
 ...
 (or (not $x2348) $x36571))))
(assert
 (let (($x2198 (forall ((gidx.368053 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x535446 (share ?x36936)))
 (let ((?x1285 (granule_data ?x535446)))
 (let (($x2809 (= (g_norm (select ?x1285 gidx.368053)) zero_granule_data)))
 (let (($x2743 (= (e_state_s_granule (select (g_granules (globals ?x535446)) gidx.368053)) 1)))
 (=> $x2743 $x2809))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x2198)))
(check-sat)

...
(let ((a!46 (granule_unlock_spec.0_call
 ...
 (or (not $x10414) $x9728))))
(assert
 (let (($x10840 (forall ((gidx.381137 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x91303 (share ?x11257)))
 (let ((?x56432 (granule_data ?x91303)))
 (let (($x19549 (= (g_norm (select ?x56432 gidx.381137)) zero_granule_data)))
 (let (($x11345 (= (e_state_s_granule (select (g_granules (globals ?x91303)) gidx.381137)) 1)))
 (=> $x11345 $x19549)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x10840)))
(check-sat)

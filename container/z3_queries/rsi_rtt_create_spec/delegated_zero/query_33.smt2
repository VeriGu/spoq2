...
(assert
 (let (($x5249 (forall ((gidx.372783 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x653989 (share ?x4987)))
 (let ((?x5267 (granule_data ?x653989)))
 (let (($x5273 (= (g_norm (select ?x5267 gidx.372783)) zero_granule_data)))
 (let (($x3520 (= (e_state_s_granule (select (g_granules (globals ?x653989)) gidx.372783)) 1)))
 (=> $x3520 $x5273)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x5249)))
(check-sat)

...
(assert
 ...
 (not $x8978))))))))))))))))))))))))))))
(assert
 (let (($x14352 (forall ((gidx.385371 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x47037 (share ?x8404)))
 (let ((?x53538 (granule_data ?x47037)))
 (let (($x8589 (= (g_norm (select ?x53538 gidx.385371)) zero_granule_data)))
 (let (($x9072 (= (e_state_s_granule (select (g_granules (globals ?x47037)) gidx.385371)) 1)))
 (=> $x9072 $x8589)))))))))))))))))))))))))
 ))
 (not $x14352)))
(check-sat)

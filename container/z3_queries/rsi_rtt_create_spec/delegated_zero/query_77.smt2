...
(assert
 (let (($x14339 (forall ((gidx.384837 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x80259 (share ?x8837)))
 (let ((?x115107 (granule_data ?x80259)))
 (let (($x14672 (= (g_norm (select ?x115107 gidx.384837)) zero_granule_data)))
 (let (($x15077 (= (e_state_s_granule (select (g_granules (globals ?x80259)) gidx.384837)) 1)))
 (=> $x15077 $x14672)))))))))))))))))))))))))))))))))
 ))
 (not $x14339)))
(check-sat)

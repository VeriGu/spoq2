...
(assert
 ...
 (and $x9747 $x45345)))))))))))))))))))))))))))))))))))))
(assert
 (let (($x9015 (forall ((gidx.378543 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x57473 (share ?x9408)))
 (let ((?x9196 (granule_data ?x57473)))
 (let (($x9526 (= (g_norm (select ?x9196 gidx.378543)) zero_granule_data)))
 (let (($x9079 (= (e_state_s_granule (select (g_granules (globals ?x57473)) gidx.378543)) 1)))
 (=> $x9079 $x9526)))))))))))))))))))))))))))))
 ))
 (not $x9015)))
(check-sat)

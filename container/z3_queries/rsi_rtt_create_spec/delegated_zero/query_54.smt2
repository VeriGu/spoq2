...
(let ((a!4 (value_RData (spinlock_release_spec.0_call
 ...
 (or (not $x9241) $x8389))))
(assert
 (let (($x44818 (forall ((gidx.378047 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x37906 (share ?x3456)))
 (let ((?x9127 (granule_data ?x37906)))
 (let (($x8130 (= (g_norm (select ?x9127 gidx.378047)) zero_granule_data)))
 (let (($x8637 (= (e_state_s_granule (select (g_granules (globals ?x37906)) gidx.378047)) 1)))
 (=> $x8637 $x8130))))))))))))))))))))
 ))
 (not $x44818)))
(check-sat)

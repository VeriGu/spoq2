...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (rec_to_ttbr1_para.0_call
             (mkPtr "granule_data"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1))))
...
(let ((a!6 (+ (poffset (e_2 (elem_0 a!5))) (* 8 (e_3 (elem_0 a!5)))))
      (a!10 (g_heap (globals (share (elem_1 a!5)))))
      (a!11 (g_debug_exits (globals (share (elem_1 a!5)))))
      (a!12 (g_vmid_count (globals (share (elem_1 a!5)))))
      (a!13 (g_vmid_lock (globals (share (elem_1 a!5)))))
      (a!14 (g_vmids (globals (share (elem_1 a!5)))))
      (a!15 (g_nr_lrs (globals (share (elem_1 a!5)))))
      (a!16 (g_nr_aprs (globals (share (elem_1 a!5)))))
      (a!17 (g_max_vintid (globals (share (elem_1 a!5)))))
      (a!18 (g_pri_res0_mask (globals (share (elem_1 a!5)))))
      (a!19 (g_default_gicstate (globals (share (elem_1 a!5)))))
      (a!20 (g_status_handler (globals (share (elem_1 a!5)))))
      (a!21 (g_rmm_trap_list (globals (share (elem_1 a!5)))))
      (a!22 (g_tt_l3_buffer (globals (share (elem_1 a!5)))))
      (a!23 (g_tt_l2_mem0_0 (globals (share (elem_1 a!5)))))
      (a!24 (g_tt_l2_mem0_1 (globals (share (elem_1 a!5)))))
      (a!25 (g_tt_l2_mem1_0 (globals (share (elem_1 a!5)))))
      (a!26 (g_tt_l2_mem1_1 (globals (share (elem_1 a!5)))))
      (a!27 (g_tt_l2_mem1_2 (globals (share (elem_1 a!5)))))
      (a!28 (g_tt_l2_mem1_3 (globals (share (elem_1 a!5)))))
      (a!29 (g_tt_l1_upper (globals (share (elem_1 a!5)))))
      (a!30 (g_mbedtls_mem_buf (globals (share (elem_1 a!5)))))
      (a!31 (g_granules (globals (share (elem_1 a!5)))))
      (a!34 (g_rmm_attest_signing_key (globals (share (elem_1 a!5)))))
      (a!35 (g_rmm_attest_public_key (globals (share (elem_1 a!5)))))
      (a!36 (g_rmm_attest_public_key_len (globals (share (elem_1 a!5)))))
      (a!37 (g_rmm_attest_public_key_hash (globals (share (elem_1 a!5)))))
      (a!38 (g_rmm_attest_public_key_hash_len (globals (share (elem_1 a!5)))))
      (a!39 (g_platform_token_buf (globals (share (elem_1 a!5)))))
      (a!40 (g_rmm_platform_token (globals (share (elem_1 a!5)))))
      (a!41 (g_get_realm_identity_identity (globals (share (elem_1 a!5)))))
      (a!42 (g_realm_attest_private_key (globals (share (elem_1 a!5))))))
(let ((a!7 (select (granule_data (share (elem_1 a!5))) (div a!6 4096)))
      (a!33 (store a!31
                   a!32
                   (mks_granule (e_lock (select a!31 a!32))
                                5
                                (e_ref (select a!31 a!32))))))
(let ((a!8 (store (g_norm a!7)
                  (mod a!6 4096)
                  (test_PTE_Z.0_call
                    (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0)))))
(let ((a!9 (store (granule_data (share (elem_1 a!5)))
                  (div a!6 4096)
                  (mkr_granule_data (gd_g_idx a!7)
                                    (g_granule_state a!7)
                                    a!8
                                    (g_rd a!7)
                                    (g_rec a!7)))))
(let ((a!43 (mkShared (gpt (share (elem_1 a!5)))
                      a!9
                      (mkGLOBALS a!10
                                 a!11
                                 a!12
                                 ...
                                 a!41
                                 a!42))))
(let ((a!44 (granule_unlock_spec.0_call
              (e_2 (elem_0 a!5))
              (mkRData (log (elem_1 a!5))
                       (oracle (elem_1 a!5))
                       (repl (elem_1 a!5))
                       (priv (elem_1 a!5))
                       a!43
                       (stack (elem_1 a!5))
                       (halt (elem_1 a!5))))))
  (repl (value_RData a!44)))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!44 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!5))
                       ...
                       (stack (elem_1 a!5))
                       (halt (elem_1 a!5))))))
  (oracle (value_RData a!44)))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(assert
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.372572 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x3585 (value_Tuple_abs_ret_rtt_RData ?x3560)))
 (let ((?x3479 (elem_1 ?x3585)))
 (let (($x4251 (halt ?x3479)))
 (let ((?x5217 (stack ?x3479)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x41999 (share ?x3479)))
 (let ((?x3612 (globals ?x41999)))
 (let ((?x3225 (g_granules ?x3612)))
 (let ((?x5349 (select ?x3225 ?x28222)))
 (let ((?x5309 (mks_granule (e_lock ?x5349) 5 (e_ref ?x5349))))
 (let ((?x4445 (store ?x3225 ?x28222 ?x5309)))
 (let ((?x4719 (mkGLOBALS (g_heap ?x3612) (g_debug_exits ?x3612) (g_vmid_count ?x3612) (g_vmid_lock ?x3612) (g_vmids ?x3612) (g_nr_lrs ?x3612) (g_nr_aprs ?x3612) (g_max_vintid ?x3612) (g_pri_res0_mask ?x3612) (g_default_gicstate ?x3612) (g_status_handler ?x3612) (g_rmm_trap_list ?x3612) (g_tt_l3_buffer ?x3612) (g_tt_l2_mem0_0 ?x3612) (g_tt_l2_mem0_1 ?x3612) (g_tt_l2_mem1_0 ?x3612) (g_tt_l2_mem1_1 ?x3612) (g_tt_l2_mem1_2 ?x3612) (g_tt_l2_mem1_3 ?x3612) (g_tt_l1_upper ?x3612) (g_mbedtls_mem_buf ?x3612) ?x4445 (g_rmm_attest_signing_key ?x3612) (g_rmm_attest_public_key ?x3612) (g_rmm_attest_public_key_len ?x3612) (g_rmm_attest_public_key_hash ?x3612) (g_rmm_attest_public_key_hash_len ?x3612) (g_platform_token_buf ?x3612) (g_rmm_platform_token ?x3612) (g_get_realm_identity_identity ?x3612) (g_realm_attest_private_key ?x3612))))
 (let ((?x3391 (elem_0 ?x3585)))
 (let ((?x3669 (e_3 ?x3391)))
 (let ((?x3667 (* 8 ?x3669)))
 (let ((?x3644 (e_2 ?x3391)))
 ...
 (let ((?x3316 (div ?x3590 4096)))
 (let ((?x3353 (granule_data ?x41999)))
 (let ((?x5685 (select ?x3353 ?x3316)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x4176 (mod ?x3590 4096)))
 (let ((?x5290 (g_norm ?x5685)))
 (let ((?x5683 (store ?x5290 ?x4176 ?x35861)))
 (let ((?x4926 (mkr_granule_data (gd_g_idx ?x5685) (g_granule_state ?x5685) ?x5683 (g_rd ?x5685) (g_rec ?x5685))))
 (let ((?x5422 (store ?x3353 ?x3316 ?x4926)))
 (let ((?x3771 (gpt ?x41999)))
 (let ((?x5197 (priv ?x3479)))
 (let ((?x3399 (repl ?x3479)))
 (let ((?x3470 (oracle ?x3479)))
 (let ((?x3715 (log ?x3479)))
 (let ((?x3851 (granule_unlock_spec.0_call ?x3644 (mkRData ?x3715 ?x3470 ?x3399 ?x5197 (mkShared ?x3771 ?x5422 ?x4719) ?x5217 $x4251))))
 (let ((?x4987 (value_RData ?x3851)))
 (let ((?x653989 (share ?x4987)))
 (let ((?x5267 (granule_data ?x653989)))
 (let (($x5273 (= (g_norm (select ?x5267 gidx.372572)) zero_granule_data)))
 (let (($x3520 (= (e_state_s_granule (select (g_granules (globals ?x653989)) gidx.372572)) 1)))
 (=> $x3520 $x5273)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.372607 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.372607))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x4987 (value_RData ?x3851)))
 (let ((?x653989 (share ?x4987)))
 (let ((?x5126 (gpt ?x653989)))
 (select ?x5126 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x21869 (forall ((gidx.372743 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x653989 (share ?x4987)))
 (let ((?x5172 (log ?x4987)))
 (let ((?x5615 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!44 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!5))
                       ...
                       (stack (elem_1 a!5))
                       (halt (elem_1 a!5))))))
  (oracle (value_RData a!44)))))))))))))_call| ?x5172)))
 (let ((?x5189 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!44 (granule_unlock_spec.0_call
              ...
              (mkRData (log (elem_1 a!5))
                       ...
                       (stack (elem_1 a!5))
                       (halt (elem_1 a!5))))))
  (repl (value_RData a!44)))))))))))))_call| ?x5615 ?x653989)))
 (let ((?x5185 (value_Shared ?x5189)))
 (let ((?x4519 (granule_data ?x5185)))
 (let (($x4844 (= (g_norm (select ?x4519 gidx.372743)) zero_granule_data)))
 (let (($x1557 (= (e_state_s_granule (select (g_granules (globals ?x5185)) gidx.372743)) 1)))
 (or (not $x1557) $x4844)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x40866 (forall ((gidx.372732 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x653989 (share ?x4987)))
 (let ((?x5267 (granule_data ?x653989)))
 (let (($x5273 (= (g_norm (select ?x5267 gidx.372732)) zero_granule_data)))
 (let (($x3520 (= (e_state_s_granule (select (g_granules (globals ?x653989)) gidx.372732)) 1)))
 (or (not $x3520) $x5273)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x40866) $x21869))))
(assert
 (forall ((gidx.372820 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x3851 (granule_unlock_spec.0_call ?x3644 (mkRData ?x3715 ?x3470 ?x3399 ?x5197 (mkShared ?x3771 ?x5422 ?x4719) ?x5217 $x4251))))
 (let ((?x4987 (value_RData ?x3851)))
 (let ((?x5342 (granule_unlock_spec.0_call ?x992 ?x4987)))
 (let ((?x5326 (value_RData ?x5342)))
 (let ((?x77222 (share ?x5326)))
 (let ((?x4952 (granule_data ?x77222)))
 (let (($x4831 (= (g_norm (select ?x4952 gidx.372820)) zero_granule_data)))
 (let (($x4819 (= (e_state_s_granule (select (g_granules (globals ?x77222)) gidx.372820)) 1)))
 (=> $x4819 $x4831)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.372855 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.372855))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x5326 (value_RData ?x5342)))
 (let ((?x77222 (share ?x5326)))
 (let ((?x5479 (gpt ?x77222)))
 (select ?x5479 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x48039 (forall ((gidx.372991 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x77222 (share ?x5326)))
 (let ((?x4608 (log ?x5326)))
 (let ((?x5322 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!45 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!44))))
  (oracle (value_RData a!45))))))))))))))_call| ?x4608)))
 (let ((?x5165 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!45 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              (value_RData a!44))))
  (repl (value_RData a!45))))))))))))))_call| ?x5322 ?x77222)))
 (let ((?x5334 (value_Shared ?x5165)))
 (let ((?x5395 (granule_data ?x5334)))
 (let (($x5620 (= (g_norm (select ?x5395 gidx.372991)) zero_granule_data)))
 (let (($x5275 (= (e_state_s_granule (select (g_granules (globals ?x5334)) gidx.372991)) 1)))
 (or (not $x5275) $x5620)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x5379 (forall ((gidx.372980 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x77222 (share ?x5326)))
 (let ((?x4952 (granule_data ?x77222)))
 (let (($x4831 (= (g_norm (select ?x4952 gidx.372980)) zero_granule_data)))
 (let (($x4819 (= (e_state_s_granule (select (g_granules (globals ?x77222)) gidx.372980)) 1)))
 (or (not $x4819) $x4831)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x5379) $x48039))))
(assert
 (forall ((gidx.373068 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x5342 (granule_unlock_spec.0_call ?x992 ?x4987)))
 (let ((?x5326 (value_RData ?x5342)))
 (let ((?x5130 (granule_unlock_spec.0_call ?x1576 ?x5326)))
 (let ((?x12041 (value_RData ?x5130)))
 (let ((?x86070 (share ?x12041)))
 (let ((?x4832 (granule_data ?x86070)))
 (let (($x4688 (= (g_norm (select ?x4832 gidx.373068)) zero_granule_data)))
 (let (($x4901 (= (e_state_s_granule (select (g_granules (globals ?x86070)) gidx.373068)) 1)))
 (=> $x4901 $x4688)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.373103 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.373103))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x12041 (value_RData ?x5130)))
 (let ((?x86070 (share ?x12041)))
 (let ((?x5455 (gpt ?x86070)))
 (select ?x5455 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x48980 (forall ((gidx.373239 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x12041 (value_RData ?x5130)))
 (let ((?x86070 (share ?x12041)))
 (let ((?x5306 (log ?x12041)))
 (let ((?x5399 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!46 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!45))))
  (oracle (value_RData a!46)))))))))))))))_call| ?x5306)))
 (let ((?x5456 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!32 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
...
(let ((a!46 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!45))))
  (repl (value_RData a!46)))))))))))))))_call| ?x5399 ?x86070)))
 (let ((?x41321 (value_Shared ?x5456)))
 (let ((?x5259 (granule_data ?x41321)))
 (let (($x5336 (= (g_norm (select ?x5259 gidx.373239)) zero_granule_data)))
 (let (($x49128 (= (e_state_s_granule (select (g_granules (globals ?x41321)) gidx.373239)) 1)))
 (or (not $x49128) $x5336)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x41269 (forall ((gidx.373228 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x86070 (share ?x12041)))
 (let ((?x4832 (granule_data ?x86070)))
 (let (($x4688 (= (g_norm (select ?x4832 gidx.373228)) zero_granule_data)))
 (let (($x4901 (= (e_state_s_granule (select (g_granules (globals ?x86070)) gidx.373228)) 1)))
 (or (not $x4901) $x4688)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x41269) $x48980))))
(assert
 (let (($x4488 (forall ((gidx.373280 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x86070 (share ?x12041)))
 (let ((?x4832 (granule_data ?x86070)))
 (let (($x4688 (= (g_norm (select ?x4832 gidx.373280)) zero_granule_data)))
 (let (($x4901 (= (e_state_s_granule (select (g_granules (globals ?x86070)) gidx.373280)) 1)))
 (=> $x4901 $x4688)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x4488)))
(check-sat)

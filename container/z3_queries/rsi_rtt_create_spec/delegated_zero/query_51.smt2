...
(let ((a!5 (spinlock_release_spec.0_call
 ...
 (or (not $x8155) $x8984))))
(assert
 (let (($x9204 (forall ((gidx.377513 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x47516 (share ?x59466)))
 (let ((?x8469 (granule_data ?x47516)))
 (let (($x8953 (= (g_norm (select ?x8469 gidx.377513)) zero_granule_data)))
 (let (($x45297 (= (e_state_s_granule (select (g_granules (globals ?x47516)) gidx.377513)) 1)))
 (=> $x45297 $x8953)))))))))))))))))))))))))
 ))
 (not $x9204)))
(check-sat)

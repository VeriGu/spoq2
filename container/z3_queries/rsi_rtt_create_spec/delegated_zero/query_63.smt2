...
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
                    (retval___1.364800 Int)
                    (st_10.364800 RData))
             (! (let ((a!1 (exists ((st_11.364789 RData))
                                  ...
                                  (! (let ((a!1 (spinlock_acquire_spec.0_call
                                     ...
                                     (let ((a!6 (value_Tuple_abs_ret_rtt_RData
                                                  (rtt_walk_lock_unlock_spec_abs.0_call
                                                    ...
                                                    v_3.0
                                                    (value_RData a!5)))))
                                     (let ((a!7 (value_RData (granule_unlock_spec.0_call
                                                               (e_2 (elem_0 a!6))
                                                               (elem_1 a!6)))))
                                     (let ((a!8 (granule_unlock_spec.0_call
                                                  (mkPtr "granules"
                                                         (meta_granule_offset
                                                           (test_PA.0_call v_0_Zptr.0)))
                                                  a!7)))
                                       (= (Some_RData st_12.364785) a!8)))))))))
                                     :weight 0))))
                ...
                (let ((a!11 (Some_Tuple_bool_Z_RData
                  ...
                  (= (Some_Tuple_bool_Z_RData
                       (mkTuple_bool_Z_RData
                         ...
                         retval___1.364800
                         st_10.364800))
                     (ite a!2 a!11 None_Tuple_bool_Z_RData)))))))))))
                :weight 0)))
      (a!8 (exists ((st_11.364789 RData))
             (! (let ((a!1 (spinlock_acquire_spec.0_call
                             (mkPtr "granules"
                                    (meta_granule_offset
                                      (test_PA.0_call v_1_Zptr.0)))
                ...
                (let ((a!6 (value_Tuple_abs_ret_rtt_RData
                  ...
                  (= (Some_RData st_11.364789)
                     (granule_unlock_spec.0_call
                       ...
                       (elem_1 a!6)))))))))
                :weight 0)))
      (a!22 (div (+ 4 (meta_granule_offset (test_PA.0_call v_0_Zptr.0))) 4096)))
(let ((a!2 (rec_to_ttbr1_para.0_call
             (mkPtr "granule_data"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             (value_RData a!1)))
...
(let ((a!10 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (elem_1 a!6))))
      (a!15 (+ (poffset (e_2 (elem_0 a!6))) (* 8 (e_3 (elem_0 a!6))))))
...
(let ((a!13 (mkTuple_bool_Z_RData
              ...
              (elem_2 (value_Tuple_bool_Z_RData
                        (ite a!9 a!12 None_Tuple_bool_Z_RData))))))
(let ((a!14 (elem_2 (value_Tuple_bool_Z_RData
                      (ite a!7
                           (Some_Tuple_bool_Z_RData a!13)
                           None_Tuple_bool_Z_RData)))))
(let ((a!16 (gd_g_idx (select (granule_data (share a!14)) (div a!15 4096))))
      (a!17 (g_granule_state (select (granule_data (share a!14))
                                     (div a!15 4096))))
      (a!18 (g_norm (select (granule_data (share a!14)) (div a!15 4096))))
      (a!20 (g_rd (select (granule_data (share a!14)) (div a!15 4096))))
      (a!21 (g_rec (select (granule_data (share a!14)) (div a!15 4096))))
      (a!23 (select (g_granules (globals (share a!14))) a!22)))
(let ((a!19 (store a!18
                   (mod a!15 4096)
                   (test_PTE_Z.0_call
                     (mkabs_PTE_t (test_PA.0_call v_0_Zptr.0) 3 0 0))))
      (a!24 (store (g_granules (globals (share a!14)))
                   a!22
                   (mks_granule (e_lock a!23) 5 (e_ref a!23)))))
(let ((a!25 (mkGLOBALS (g_heap (globals (share a!14)))
                       (g_debug_exits (globals (share a!14)))
                       (g_vmid_count (globals (share a!14)))
                       (g_vmid_lock (globals (share a!14)))
                       (g_vmids (globals (share a!14)))
                       (g_nr_lrs (globals (share a!14)))
                       (g_nr_aprs (globals (share a!14)))
                       (g_max_vintid (globals (share a!14)))
                       (g_pri_res0_mask (globals (share a!14)))
                       (g_default_gicstate (globals (share a!14)))
                       (g_status_handler (globals (share a!14)))
                       (g_rmm_trap_list (globals (share a!14)))
                       (g_tt_l3_buffer (globals (share a!14)))
                       (g_tt_l2_mem0_0 (globals (share a!14)))
                       (g_tt_l2_mem0_1 (globals (share a!14)))
                       (g_tt_l2_mem1_0 (globals (share a!14)))
                       (g_tt_l2_mem1_1 (globals (share a!14)))
                       (g_tt_l2_mem1_2 (globals (share a!14)))
                       (g_tt_l2_mem1_3 (globals (share a!14)))
                       (g_tt_l1_upper (globals (share a!14)))
                       (g_mbedtls_mem_buf (globals (share a!14)))
                       a!24
                       (g_rmm_attest_signing_key (globals (share a!14)))
                       (g_rmm_attest_public_key (globals (share a!14)))
                       (g_rmm_attest_public_key_len (globals (share a!14)))
                       (g_rmm_attest_public_key_hash (globals (share a!14)))
                       (g_rmm_attest_public_key_hash_len (globals (share a!14)))
                       (g_platform_token_buf (globals (share a!14)))
                       (g_rmm_platform_token (globals (share a!14)))
                       (g_get_realm_identity_identity (globals (share a!14)))
                       (g_realm_attest_private_key (globals (share a!14))))))
(let ((a!26 (mkShared (gpt (share a!14))
                      (store (granule_data (share a!14))
                             (div a!15 4096)
                             (mkr_granule_data a!16 a!17 a!19 a!20 a!21))
                      a!25)))
(let ((a!27 (value_RData (granule_unlock_spec.0_call
                           (e_2 (elem_0 a!6))
                           (mkRData (log a!14)
                                    (oracle a!14)
                                    (repl a!14)
                                    ...
                                    (stack a!14)
                                    (halt a!14))))))
  (repl a!27)))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!27 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!14)
                                    ...
                                    (stack a!14)
                                    (halt a!14))))))
  (oracle a!27)))))))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!27 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!14)
                                    ...
                                    (stack a!14)
                                    (halt a!14))))))
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!27)))
  (repl (value_RData a!28)))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!27)))
  (oracle (value_RData a!28)))))))))))))))))))_call| (List_Event) List_Event)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!27)))
(let ((a!29 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!28))))
  (repl (value_RData a!29))))))))))))))))))))_call| (List_Event Shared) Option_Shared)
(declare-fun |(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
...
(let ((a!29 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!28))))
  (oracle (value_RData a!29))))))))))))))))))))_call| (List_Event) List_Event)
(assert
...
(assert
 ...
 (let ((?x9055 (elem_0 ?x7744)))
 (let ((?x8863 (e_2 ?x9055)))
 (let ((?x9556 (granule_unlock_spec.0_call ?x8863 ?x9408)))
 (let ((?x8837 (value_RData ?x9556)))
 (let ((?x9828 (granule_unlock_spec.0_call ?x992 ?x8837)))
 (let ((?x10240 (value_RData ?x9828)))
 (let ((?x5079 (make_return_code_para.0_call 9)))
 (let ((?x1904 (pack_struct_return_code_para.0_call ?x5079)))
 (let ((?x10350 (mkTuple_bool_Z_RData true ?x1904 ?x10240)))
 (let ((?x10138 (Some_Tuple_bool_Z_RData ?x10350)))
 (let (($x14670 (exists ((st_12.364785 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x8837 (value_RData ?x9556)))
 (let ((?x9828 (granule_unlock_spec.0_call ?x992 ?x8837)))
 (let ((?x736 (Some_RData st_12.364785)))
 (= ?x736 ?x9828)))))))))))))))))))))))))))))))
 ))
 (let (($x14619 (exists ((st_11.364789 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x8863 (e_2 ?x9055)))
 (let ((?x9556 (granule_unlock_spec.0_call ?x8863 ?x9408)))
 (let ((?x736 (Some_RData st_11.364789)))
 (= ?x736 ?x9556)))))))))))))))))))))))))))))
 ))
 (let ((?x10219 (ite (and $x14619 $x14670) ?x10138 None_Tuple_bool_Z_RData)))
 (let ((?x10316 (value_Tuple_bool_Z_RData ?x10219)))
 (let ((?x10318 (elem_2 ?x10316)))
 (let ((?x10098 (elem_1 ?x10316)))
 (let (($x9987 (elem_0 ?x10316)))
 (let ((?x10135 (mkTuple_bool_Z_RData $x9987 ?x10098 ?x10318)))
 (let ((?x8153 (Some_Tuple_bool_Z_RData ?x10135)))
 (let (($x9605 (exists ((return___1.364800 Bool) (retval___1.364800 Int) (st_10.364800 RData) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x10219 (ite (and $x14619 $x14670) ?x10138 None_Tuple_bool_Z_RData)))
 (let ((?x1901 (mkTuple_bool_Z_RData return___1.364800 retval___1.364800 st_10.364800)))
 (let ((?x1896 (Some_Tuple_bool_Z_RData ?x1901)))
 (= ?x1896 ?x10219))))))))))))))))))))))))))))))))))))))))
 ))
 (let ((?x10173 (value_Tuple_bool_Z_RData (ite $x9605 ?x8153 None_Tuple_bool_Z_RData))))
 (let (($x9986 (elem_0 ?x10173)))
 (not $x9986)))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x1062 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x991 (meta_granule_offset ?x1062)))
 ...
 (= ?x57321 0)))))
(assert
 (forall ((gidx.379896 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x10173 (value_Tuple_bool_Z_RData (ite $x9605 ?x8153 None_Tuple_bool_Z_RData))))
 (let ((?x9373 (elem_2 ?x10173)))
 (let (($x9467 (halt ?x9373)))
 (let ((?x14622 (stack ?x9373)))
 (let ((?x28219 (+ 4 ?x991)))
 (let ((?x28222 (div ?x28219 4096)))
 (let ((?x9869 (share ?x9373)))
 (let ((?x4970 (globals ?x9869)))
 (let ((?x9732 (g_granules ?x4970)))
 (let ((?x63102 (select ?x9732 ?x28222)))
 (let ((?x10323 (mks_granule (e_lock ?x63102) 5 (e_ref ?x63102))))
 (let ((?x61902 (store ?x9732 ?x28222 ?x10323)))
 (let ((?x9836 (mkGLOBALS (g_heap ?x4970) (g_debug_exits ?x4970) (g_vmid_count ?x4970) (g_vmid_lock ?x4970) (g_vmids ?x4970) (g_nr_lrs ?x4970) (g_nr_aprs ?x4970) (g_max_vintid ?x4970) (g_pri_res0_mask ?x4970) (g_default_gicstate ?x4970) (g_status_handler ?x4970) (g_rmm_trap_list ?x4970) (g_tt_l3_buffer ?x4970) (g_tt_l2_mem0_0 ?x4970) (g_tt_l2_mem0_1 ?x4970) (g_tt_l2_mem1_0 ?x4970) (g_tt_l2_mem1_1 ?x4970) (g_tt_l2_mem1_2 ?x4970) (g_tt_l2_mem1_3 ?x4970) (g_tt_l1_upper ?x4970) (g_mbedtls_mem_buf ?x4970) ?x61902 (g_rmm_attest_signing_key ?x4970) (g_rmm_attest_public_key ?x4970) (g_rmm_attest_public_key_len ?x4970) (g_rmm_attest_public_key_hash ?x4970) (g_rmm_attest_public_key_hash_len ?x4970) (g_platform_token_buf ?x4970) (g_rmm_platform_token ?x4970) (g_get_realm_identity_identity ?x4970) (g_realm_attest_private_key ?x4970))))
 (let ((?x9521 (e_3 ?x9055)))
 (let ((?x9517 (* 8 ?x9521)))
 (let ((?x8991 (poffset ?x8863)))
 (let ((?x9484 (+ ?x8991 ?x9517)))
 (let ((?x9511 (div ?x9484 4096)))
 (let ((?x10336 (granule_data ?x9869)))
 (let ((?x10190 (select ?x10336 ?x9511)))
 (let ((?x1747 (mkabs_PTE_t ?x1062 3 0 0)))
 (let ((?x35861 (test_PTE_Z.0_call ?x1747)))
 (let ((?x9490 (mod ?x9484 4096)))
 (let ((?x10562 (g_norm ?x10190)))
 (let ((?x10447 (store ?x10562 ?x9490 ?x35861)))
 (let ((?x51307 (mkr_granule_data (gd_g_idx ?x10190) (g_granule_state ?x10190) ?x10447 (g_rd ?x10190) (g_rec ?x10190))))
 (let ((?x9640 (store ?x10336 ?x9511 ?x51307)))
 (let ((?x10067 (gpt ?x9869)))
 (let ((?x9503 (priv ?x9373)))
 (let ((?x14617 (repl ?x9373)))
 (let ((?x10557 (oracle ?x9373)))
 (let ((?x10090 (log ?x9373)))
 (let ((?x9502 (granule_unlock_spec.0_call ?x8863 (mkRData ?x10090 ?x10557 ?x14617 ?x9503 (mkShared ?x10067 ?x9640 ?x9836) ?x14622 $x9467))))
 (let ((?x8873 (value_RData ?x9502)))
 (let ((?x612791 (share ?x8873)))
 (let ((?x10270 (granule_data ?x612791)))
 (let (($x10475 (= (g_norm (select ?x10270 gidx.379896)) zero_granule_data)))
 (let (($x9581 (= (e_state_s_granule (select (g_granules (globals ?x612791)) gidx.379896)) 1)))
 (=> $x9581 $x10475)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.379931 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.379931))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x8873 (value_RData ?x9502)))
 (let ((?x612791 (share ?x8873)))
 (let ((?x61584 (gpt ?x612791)))
 (select ?x61584 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x63319 (forall ((gidx.380067 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x8873 (value_RData ?x9502)))
 (let ((?x612791 (share ?x8873)))
 (let ((?x10320 (log ?x8873)))
 (let ((?x8722 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!27 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!14)
                                    ...
                                    (stack a!14)
                                    (halt a!14))))))
  (oracle a!27)))))))))))))))))_call| ?x10320)))
 (let ((?x9746 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!27 (value_RData (granule_unlock_spec.0_call
                           ...
                           (mkRData (log a!14)
                                    ...
                                    (stack a!14)
                                    (halt a!14))))))
  (repl a!27)))))))))))))))))_call| ?x8722 ?x612791)))
 (let ((?x10050 (value_Shared ?x9746)))
 (let ((?x9663 (granule_data ?x10050)))
 (let (($x1642 (= (g_norm (select ?x9663 gidx.380067)) zero_granule_data)))
 (let (($x8922 (= (e_state_s_granule (select (g_granules (globals ?x10050)) gidx.380067)) 1)))
 (or (not $x8922) $x1642)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x62909 (forall ((gidx.380056 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x612791 (share ?x8873)))
 (let ((?x10270 (granule_data ?x612791)))
 (let (($x10475 (= (g_norm (select ?x10270 gidx.380056)) zero_granule_data)))
 (let (($x9581 (= (e_state_s_granule (select (g_granules (globals ?x612791)) gidx.380056)) 1)))
 (or (not $x9581) $x10475)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x62909) $x63319))))
(assert
 (forall ((gidx.380144 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x9502 (granule_unlock_spec.0_call ?x8863 (mkRData ?x10090 ?x10557 ?x14617 ?x9503 (mkShared ?x10067 ?x9640 ?x9836) ?x14622 $x9467))))
 (let ((?x8873 (value_RData ?x9502)))
 (let ((?x9432 (granule_unlock_spec.0_call ?x992 ?x8873)))
 (let ((?x18838 (value_RData ?x9432)))
 (let ((?x237492 (share ?x18838)))
 (let ((?x10684 (granule_data ?x237492)))
 (let (($x10268 (= (g_norm (select ?x10684 gidx.380144)) zero_granule_data)))
 (let (($x8654 (= (e_state_s_granule (select (g_granules (globals ?x237492)) gidx.380144)) 1)))
 (=> $x8654 $x10268)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.380179 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.380179))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x18838 (value_RData ?x9432)))
 (let ((?x237492 (share ?x18838)))
 (let ((?x10161 (gpt ?x237492)))
 (select ?x10161 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x9352 (forall ((gidx.380315 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x18838 (value_RData ?x9432)))
 (let ((?x237492 (share ?x18838)))
 (let ((?x62868 (log ?x18838)))
 (let ((?x9702 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!27)))
  (oracle (value_RData a!28)))))))))))))))))))_call| ?x62868)))
 (let ((?x11121 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!28 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_0_Zptr.0)))
              a!27)))
  (repl (value_RData a!28)))))))))))))))))))_call| ?x9702 ?x237492)))
 (let ((?x9017 (value_Shared ?x11121)))
 (let ((?x10808 (granule_data ?x9017)))
 (let (($x63242 (= (g_norm (select ?x10808 gidx.380315)) zero_granule_data)))
 (let (($x54637 (= (e_state_s_granule (select (g_granules (globals ?x9017)) gidx.380315)) 1)))
 (or (not $x54637) $x63242)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x9725 (forall ((gidx.380304 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x237492 (share ?x18838)))
 (let ((?x10684 (granule_data ?x237492)))
 (let (($x10268 (= (g_norm (select ?x10684 gidx.380304)) zero_granule_data)))
 (let (($x8654 (= (e_state_s_granule (select (g_granules (globals ?x237492)) gidx.380304)) 1)))
 (or (not $x8654) $x10268)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x9725) $x9352))))
(assert
 (forall ((gidx.380392 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x9432 (granule_unlock_spec.0_call ?x992 ?x8873)))
 (let ((?x18838 (value_RData ?x9432)))
 (let ((?x10332 (granule_unlock_spec.0_call ?x1576 ?x18838)))
 (let ((?x10875 (value_RData ?x10332)))
 (let ((?x246180 (share ?x10875)))
 (let ((?x14660 (granule_data ?x246180)))
 (let (($x9934 (= (g_norm (select ?x14660 gidx.380392)) zero_granule_data)))
 (let (($x11196 (= (e_state_s_granule (select (g_granules (globals ?x246180)) gidx.380392)) 1)))
 (=> $x11196 $x9934)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (forall ((v_0.380427 Int) )(let ((?x1632 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call v_0.380427))) 4096)))
 (let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 ...
 (let ((?x10875 (value_RData ?x10332)))
 (let ((?x246180 (share ?x10875)))
 (let ((?x9335 (gpt ?x246180)))
 (select ?x9335 ?x1632))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 )
(assert
 (let (($x10870 (forall ((gidx.380563 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x10875 (value_RData ?x10332)))
 (let ((?x246180 (share ?x10875)))
 (let ((?x10809 (log ?x10875)))
 (let ((?x63400 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!29 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!28))))
  (oracle (value_RData a!29))))))))))))))))))))_call| ?x10809)))
 (let ((?x10354 (|(let ((a!1 (spinlock_acquire_spec.0_call
             (mkPtr "granules"
                    (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
             st.0))
      (a!7 (exists ((return___1.364800 Bool)
...
(let ((a!29 (granule_unlock_spec.0_call
              (mkPtr "granules"
                     (meta_granule_offset (test_PA.0_call v_1_Zptr.0)))
              (value_RData a!28))))
  (repl (value_RData a!29))))))))))))))))))))_call| ?x63400 ?x246180)))
 (let ((?x10654 (value_Shared ?x10354)))
 (let ((?x10804 (granule_data ?x10654)))
 (let (($x11180 (= (g_norm (select ?x10804 gidx.380563)) zero_granule_data)))
 (let (($x10781 (= (e_state_s_granule (select (g_granules (globals ?x10654)) gidx.380563)) 1)))
 (or (not $x10781) $x11180)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x10126 (forall ((gidx.380552 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x246180 (share ?x10875)))
 (let ((?x14660 (granule_data ?x246180)))
 (let (($x9934 (= (g_norm (select ?x14660 gidx.380552)) zero_granule_data)))
 (let (($x11196 (= (e_state_s_granule (select (g_granules (globals ?x246180)) gidx.380552)) 1)))
 (or (not $x11196) $x9934)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (or (not $x10126) $x10870))))
(assert
 (let (($x9430 (forall ((gidx.380604 Int) )(let ((?x1597 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x1577 (meta_granule_offset ?x1597)))
 (let ((?x1576 (mkPtr "granules" ?x1577)))
 (let ((?x1594 (spinlock_acquire_spec.0_call ?x1576 st.0)))
 (let ((?x1634 (value_RData ?x1594)))
 ...
 (let ((?x246180 (share ?x10875)))
 (let ((?x14660 (granule_data ?x246180)))
 (let (($x9934 (= (g_norm (select ?x14660 gidx.380604)) zero_granule_data)))
 (let (($x11196 (= (e_state_s_granule (select (g_granules (globals ?x246180)) gidx.380604)) 1)))
 (=> $x11196 $x9934)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (not $x9430)))
(check-sat)

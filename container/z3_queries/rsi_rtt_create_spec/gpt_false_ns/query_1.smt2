...
(assert
 (forall ((gidx.102007665 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x39691 (share ?x403)))
 (let ((?x39700 (globals ?x39691)))
 (let ((?x29794 (g_granules ?x39700)))
 (let ((?x2352 (e_state_s_granule (select ?x29794 gidx.102007665))))
 (=> (not (select (gpt ?x39691) gidx.102007665)) (or (= ?x2352 0) (= ?x2352 6))))))))))
 )
(assert
 (let ((?x12 (share st.0)))
 (let ((?x19 (globals ?x12)))
...
(assert
 ...
 (let ((?x8267 (e_lock ?x58981)))
 (let ((?x30684 (e_val ?x8267)))
 (= ?x30684 None_Z)))))))))))))
(assert
 (let ((?x22860 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x57793 (meta_granule_offset ?x22860)))
 (let ((?x8407 (div ?x57793 4096)))
 (let ((?x62037 (div ?x57793 16)))
 (let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x39691 (share ?x403)))
 ...
 (let ((?x1009 (select ?x42382 ?x8407)))
 (let ((?x40935 (e_state_s_granule ?x1009)))
 (= ?x40935 5))))))))))))))))))))
(assert
 (let ((?x22860 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x57793 (meta_granule_offset ?x22860)))
 (let (($x56747 (>= ?x57793 0)))
 (let ((?x56715 (mod ?x57793 4096)))
 (let (($x32203 (= ?x56715 0)))
 (and $x32203 $x56747)))))))
(assert
 (let (($x1639 (forall ((gidx.102007720 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x39691 (share ?x403)))
 (let ((?x39700 (globals ?x39691)))
 (let ((?x29794 (g_granules ?x39700)))
 (let ((?x2352 (e_state_s_granule (select ?x29794 gidx.102007720))))
 (=> (not (select (gpt ?x39691) gidx.102007720)) (or (= ?x2352 0) (= ?x2352 6))))))))))
 ))
 (not $x1639)))
(check-sat)

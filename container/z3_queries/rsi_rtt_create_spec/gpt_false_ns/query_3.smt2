...
(assert
 (forall ((gidx.102007885 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 ...
 (let ((?x80659 (mkPtr "granules" ?x57793)))
 (let ((?x9314 (mkPtr "stack_s_rtt_walk" 0)))
 (let ((?x40881 (rtt_walk_lock_unlock_spec_abs.0_call ?x9314 ?x80659 0 64 v_2.0 v_3.0 ?x16160)))
 (let ((?x1356 (value_Tuple_abs_ret_rtt_RData ?x40881)))
 (let ((?x45006 (elem_1 ?x1356)))
 (let ((?x24112 (share ?x45006)))
 (let ((?x1646 (globals ?x24112)))
 (let ((?x2278 (g_granules ?x1646)))
 (let ((?x1287 (e_state_s_granule (select ?x2278 gidx.102007885))))
 (=> (not (select (gpt ?x24112) gidx.102007885)) (or (= ?x1287 0) (= ?x1287 6)))))))))))))))))))
 )
(assert
 ...
 (let ((?x40881 (rtt_walk_lock_unlock_spec_abs.0_call ?x9314 ?x80659 0 64 v_2.0 v_3.0 ?x16160)))
 (let ((?x1356 (value_Tuple_abs_ret_rtt_RData ?x40881)))
 (let ((?x41381 (elem_0 ?x1356)))
 (let ((?x1629 (e_3 ?x41381)))
 (let ((?x45473 (* 8 ?x1629)))
 (let ((?x1743 (e_2 ?x41381)))
 (let ((?x1772 (poffset ?x1743)))
 (let ((?x2106 (+ ?x1772 ?x45473)))
 (let ((?x1663 (div ?x2106 4096)))
 (let ((?x45006 (elem_1 ?x1356)))
 (let ((?x24112 (share ?x45006)))
 (let ((?x1646 (globals ?x24112)))
 (let ((?x2278 (g_granules ?x1646)))
 (let ((?x1948 (select ?x2278 ?x1663)))
 (let ((?x45441 (e_state_s_granule ?x1948)))
 (= ?x45441 5)))))))))))))))))))))))))
(assert
 (let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
...
(assert
 ...
 (let ((?x1772 (poffset ?x1743)))
 (let ((?x2106 (+ ?x1772 ?x45473)))
 (let ((?x58045 (mkPtr "granule_data" ?x2106)))
 (let ((?x1507 (abs_tte_read.0_call ?x58045 ?x45006)))
 (let ((?x45506 (meta_ripas ?x1507)))
 (let (($x58894 (= ?x45506 0)))
 (let ((?x58659 (meta_desc_type ?x1507)))
 (let (($x40677 (= ?x58659 0)))
 (and $x40677 $x58894)))))))))))))))))))))))))
(assert
 (let (($x1771 (forall ((gidx.102007940 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 (let ((?x16160 (value_RData ?x30525)))
 (let ((?x22860 (test_PA.0_call v_1_Zptr.0)))
 ...
 (let ((?x1646 (globals ?x24112)))
 (let ((?x2278 (g_granules ?x1646)))
 (let ((?x1287 (e_state_s_granule (select ?x2278 gidx.102007940))))
 (=> (not (select (gpt ?x24112) gidx.102007940)) (or (= ?x1287 0) (= ?x1287 6)))))))))))))))))))
 ))
 (not $x1771)))
(check-sat)

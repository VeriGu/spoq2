...
(assert
 (forall ((gidx.102007775 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 (let ((?x16160 (value_RData ?x30525)))
 (let ((?x70864 (share ?x16160)))
 (let ((?x17318 (globals ?x70864)))
 (let ((?x55237 (g_granules ?x17318)))
 (let ((?x2109 (select ?x55237 gidx.102007775)))
 (let ((?x1957 (e_state_s_granule ?x2109)))
 (let (($x2602 (= ?x1957 6)))
 (let (($x1752 (= ?x1957 0)))
 (=> (not (select (gpt ?x70864) gidx.102007775)) (or $x1752 $x2602))))))))))))))
 )
(assert
 (let ((?x22860 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x57793 (meta_granule_offset ?x22860)))
 (let ((?x62037 (div ?x57793 16)))
 (let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x39691 (share ?x403)))
 (let ((?x39700 (globals ?x39691)))
 (let ((?x29794 (g_granules ?x39700)))
 (let ((?x58981 (select ?x29794 ?x62037)))
 (let ((?x61381 (e_ref ?x58981)))
 (let ((?x16146 (e_state_s_granule ?x58981)))
 (let ((?x28886 (Some_Z CPU_ID.0)))
 (let ((?x31408 (mks_spinlock_t ?x28886)))
 (let ((?x70672 (mks_granule ?x31408 ?x16146 ?x61381)))
 (let ((?x42382 (store ?x29794 ?x62037 ?x70672)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 (let ((?x16160 (value_RData ?x30525)))
 (let ((?x70864 (share ?x16160)))
 (let ((?x17318 (globals ?x70864)))
 ...
 (= ?x55237 ?x42382))))))))))))))))))))))
(assert
 (let ((?x20492 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x813 (meta_granule_offset ?x20492)))
 (let ((?x21674 (div ?x813 16)))
 (let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 (let ((?x16160 (value_RData ?x30525)))
 ...
 (let ((?x17318 (globals ?x70864)))
 (let ((?x55237 (g_granules ?x17318)))
 (let ((?x56381 (select ?x55237 ?x21674)))
 (let ((?x1832 (e_lock ?x56381)))
 (let ((?x598 (e_val ?x1832)))
 (= ?x598 None_Z)))))))))))))))
(assert
 (let ((?x20492 (test_PA.0_call v_0_Zptr.0)))
 (let ((?x813 (meta_granule_offset ?x20492)))
 (let ((?x10112 (div ?x813 4096)))
 (let ((?x21674 (div ?x813 16)))
 (let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 ...
 (let ((?x55237 (g_granules ?x17318)))
 (let ((?x56381 (select ?x55237 ?x21674)))
 (let ((?x2070 (e_ref ?x56381)))
 (let ((?x59178 (e_state_s_granule ?x56381)))
 (let ((?x28886 (Some_Z CPU_ID.0)))
 (let ((?x31408 (mks_spinlock_t ?x28886)))
 (let ((?x1903 (mks_granule ?x31408 ?x59178 ?x2070)))
 (let ((?x1819 (store ?x55237 ?x21674 ?x1903)))
 (let ((?x59290 (select ?x1819 ?x10112)))
 (let ((?x2206 (e_state_s_granule ?x59290)))
 (= ?x2206 1))))))))))))))))))))))
(assert
 (let (($x2514 (forall ((gidx.102007830 Int) )(let ((?x376 (query_oracle.0_call st.0)))
 (let ((?x403 (value_RData ?x376)))
 (let ((?x30525 (query_oracle.0_call ?x403)))
 (let ((?x16160 (value_RData ?x30525)))
 (let ((?x70864 (share ?x16160)))
 (let ((?x17318 (globals ?x70864)))
 (let ((?x55237 (g_granules ?x17318)))
 (let ((?x2109 (select ?x55237 gidx.102007830)))
 (let ((?x1957 (e_state_s_granule ?x2109)))
 (let (($x2602 (= ?x1957 6)))
 (let (($x1752 (= ?x1957 0)))
 (=> (not (select (gpt ?x70864) gidx.102007830)) (or $x1752 $x2602))))))))))))))
 ))
 (not $x2514)))
(check-sat)

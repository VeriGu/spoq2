...
(assert
 (let (($x3322 (forall ((rtt_gidx.1354545 Int) (ipa_gidx.1354545 Int) (data_gidx.1354545 Int) )(let ((?x2136 (test_PA.0_call v_1_Zptr.0)))
 (let ((?x9898 (meta_granule_offset ?x2136)))
 (let ((?x2228 (mkPtr "granules" ?x9898)))
 (let ((?x2235 (spinlock_acquire_spec.0_call ?x2228 st.0)))
 (let ((?x3269 (value_RData ?x2235)))
 (let ((?x2537 (rtt_walk_abs.0_call ?x3269 rtt_gidx.1354545 ipa_gidx.1354545)))
 (let ((?x1516 (share ?x3269)))
 (let ((?x2560 (granule_data ?x1516)))
 (let ((?x2527 (g_granule_state (select ?x2560 ?x2537))))
 (let (($x158 (rtt_is_root.0_call rtt_gidx.1354545)))
 (let (($x2541 (=> $x158 (or (= ?x2527 4) (= ?x2527 6)))))
 (let (($x2542 (= (e_state_s_granule (select (g_granules (globals ?x1516)) rtt_gidx.1354545)) 5)))
 (=> (and $x2542 (and (distinct ?x2537 (- 1)) true) $x158) (or (= ?x2527 4) (= ?x2527 6))))))))))))))))
 ))
 (not $x3322)))
(check-sat)

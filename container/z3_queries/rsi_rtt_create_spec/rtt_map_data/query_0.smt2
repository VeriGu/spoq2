...
(assert
 ...
 (let ((?x102011 (mkr_granule_data ?x102010 ?x102009 (store ?x1625 ?x1665 (test_PTE_Z.0_call (mkabs_PTE_t pa.126404 x.126404 y.126404 z.126404))) ?x117391 ?x24983)))
 (let ((?x17246 (store ?x27 ?x1672 ?x102011)))
 (let ((?x89 (gpt ?x25)))
 (let ((?x94 (priv st.0)))
 (let ((?x93 (repl st.0)))
 (let ((?x92 (oracle st.0)))
...
(assert
 ...
 (let ((?x40 (globals ?x25)))
 (let ((?x44 (g_granules ?x40)))
 (let ((?x1799 (select ?x44 (div (meta_granule_offset (meta_PA (test_Z_PTE.0_call pte_z.95988))) 4096))))
 (let ((?x1800 (e_state_s_granule ?x1799)))
...
(assert
 ...
 (let ((?x1625 (g_norm ?x24976)))
 (let ((?x2001 (store ?x1625 ?x1665 (test_PTE_Z.0_call (mkabs_PTE_t (test_PA.0_call pa.69801) x.69801 y.69801 z.69801)))))
 (let ((?x102009 (g_granule_state ?x24976)))
 (let ((?x102010 (gd_g_idx ?x24976)))
 (let ((?x2003 (store ?x27 ?x1672 (mkr_granule_data ?x102010 ?x102009 ?x2001 ?x117391 ?x24983))))
 (let ((?x89 (gpt ?x25)))
 (let ((?x94 (priv st.0)))
 (let ((?x93 (repl st.0)))
 (let ((?x92 (oracle st.0)))
...
(assert
 (let (($x2182 (forall ((rtt_gidx.1351995 Int) (ipa_gidx.1351995 Int) (data_gidx.1351995 Int) )(let ((?x152 (rtt_walk_abs.0_call st.0 rtt_gidx.1351995 ipa_gidx.1351995)))
 (let ((?x25 (share st.0)))
 (let ((?x27 (granule_data ?x25)))
 (let ((?x154 (g_granule_state (select ?x27 ?x152))))
 (let (($x158 (rtt_is_root.0_call rtt_gidx.1351995)))
 (let (($x159 (=> $x158 (or (= ?x154 4) (= ?x154 6)))))
 (let (($x165 (= (e_state_s_granule (select (g_granules (globals ?x25)) rtt_gidx.1351995)) 5)))
 (=> (and $x165 (and (distinct ?x152 (- 1)) true) $x158) (or (= ?x154 4) (= ?x154 6)))))))))))
 ))
 (not $x2182)))
(check-sat)

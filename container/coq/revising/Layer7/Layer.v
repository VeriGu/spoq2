  ...
  Definition Layer7_layer :=
    {|
      ...
      PrimCall :=
          ...
          :: ("psci_affinity_info", prim psci_affinity_info_spec)
          :: ("psci_cpu_off", prim psci_cpu_off_spec)
          :: ("psci_cpu_on", prim psci_cpu_on_spec)
          :: ("psci_cpu_suspend", prim psci_cpu_suspend_spec)
          :: ("psci_features", prim psci_features_spec)
          :: ("psci_system_off", prim psci_system_off_spec)
          :: ("psci_system_reset", prim psci_system_reset_spec)
          :: ("psci_version", prim psci_version_spec)
          ...
          :: ("s1addr_level_mask", prim s1addr_level_mask_spec)

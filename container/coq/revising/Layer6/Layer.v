  ...
  Definition Layer6_layer :=
    {|
      ...
      PrimCall :=
          ...
          :: ("get_realm_identity", prim get_realm_identity_spec)
          ...
          :: ("rd_map_read_rec_count", prim rd_map_read_rec_count_spec)

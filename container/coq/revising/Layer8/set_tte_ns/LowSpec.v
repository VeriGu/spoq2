...
Section Layer8_set_tte_ns_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition set_tte_ns_spec_low (v_0: Z) (st: RData) : (option RData) :=
...
End Layer8_set_tte_ns_LowSpec.

#[global] Hint Unfold set_tte_ns_spec_low: spec.

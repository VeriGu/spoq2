...
Require Import Layer8.clear_tte_ns.LowSpec.
Require Import Zwf.
...
Section Layer8_clear_tte_ns_CodeProof.
  ...
  Local Opaque iasm_9_spec.
    Lemma f_clear_tte_ns_correct:
      forall v_0 st st'
             (Hspec: clear_tte_ns_spec_low v_0 st = Some st'),
        exec_func Layer7_layer code "clear_tte_ns"
                  [VInt v_0]
                  st st' None.
    Proof.
...
End Layer8_clear_tte_ns_CodeProof.

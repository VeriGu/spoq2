...
Section Layer8_get_dabt_write_value_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition get_dabt_write_value_spec_low (v_0: Ptr) (v_1: Z) (st: RData) : (option (Z * RData)) :=
...
End Layer8_get_dabt_write_value_LowSpec.

#[global] Hint Unfold get_dabt_write_value_spec_low: spec.

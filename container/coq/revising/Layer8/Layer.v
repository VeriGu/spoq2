  ...
  Definition Layer8_layer :=
    {|
      ...
      PrimCall :=
          ...
          :: ("clear_tte_ns", prim clear_tte_ns_spec)
          :: ("data_create_internal", prim data_create_internal_spec)
          :: ("data_create_s1_el1", prim data_create_s1_el1_spec)
          :: ("emulate_stage2_data_abort", prim emulate_stage2_data_abort_spec)
          :: ("emulate_sysreg_access_ns", prim emulate_sysreg_access_ns_spec)
          ...
          :: ("fixup_aarch32_data_abort", prim fixup_aarch32_data_abort_spec)
          :: ("g_refcount", prim g_refcount_spec)
          :: ("get_dabt_write_value", prim get_dabt_write_value_spec)
          ...
          :: ("handle_rsi_realm_extend_measurement", prim handle_rsi_realm_extend_measurement_spec)
          ...
          :: ("min", prim min_spec)
          :: ("next_granule", prim next_granule_spec)
          ...
          :: ("psci_rsi", prim psci_rsi_spec)
          :: ("range_intersects_par", prim range_intersects_par_spec)
          :: ("ranges_intersect", prim ranges_intersect_spec)
          :: ("rc_update_ttbr0_el12", prim rc_update_ttbr0_el12_spec)
          ...
          :: ("rsi_memory_dispose", prim rsi_memory_dispose_spec)
          ...
          :: ("set_pas_ns", prim set_pas_ns_spec)
          :: ("set_pas_realm", prim set_pas_realm_spec)
          ...
          :: ("virt_to_phys", prim virt_to_phys_spec)

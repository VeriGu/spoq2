  ...
  Definition Layer12_layer :=
    {|
      ...
      PrimCall :=
          ...
          :: ("complete_hvc_exit", prim complete_hvc_exit_spec)
          :: ("complete_mmio_emulation", prim complete_mmio_emulation_spec)
          :: ("complete_sysreg_emulation", prim complete_sysreg_emulation_spec)
          :: ("copy_gic_state_from_ns", prim copy_gic_state_from_ns_spec)
          :: ("copy_gic_state_to_ns", prim copy_gic_state_to_ns_spec)
          ...
          :: ("get_cntfrq", prim get_cntfrq_spec)
          ...
          :: ("process_disposed_info", prim process_disposed_info_spec)
          ...
          :: ("s2tt_init_assigned", prim s2tt_init_assigned_spec)
          ...
          :: ("vmpidr_is_valid", prim vmpidr_is_valid_spec)
          :: nil
    |}.

...
Section Layer12_s2tt_init_valid_ns_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Fixpoint s2tt_init_valid_ns_loop839_low (_N_: nat) (__return__: bool) (v_0: Ptr) (v_2: Z) (v_5: Z) (v__010: Z) (v_indvars_iv: Z) (st: RData) : (option (bool * Ptr * Z * Z * Z * Z * RData)) :=
    match (_N_) with
    | O => (Some (__return__, v_0, v_2, v_5, v__010, v_indvars_iv, st))
    | (S _N__0) =>
      match ((s2tt_init_valid_ns_loop839_low _N__0 __return__ v_0 v_2 v_5 v__010 v_indvars_iv st)) with
  ...
  Definition s2tt_init_valid_ns_spec_low (v_0: Ptr) (v_1: Z) (v_2: Z) (st: RData) : (option RData) :=
    when v_5, st_0 == ((s2tte_map_size_spec v_2 st));
    rely (((s2tt_init_valid_ns_loop839_rank v_0 v_2 v_5 v_1 0) >= (0)));
    match ((s2tt_init_valid_ns_loop839_low (z_to_nat (s2tt_init_valid_ns_loop839_rank v_0 v_2 v_5 v_1 0)) false v_0 v_2 v_5 v_1 0 st_0)) with
    | (Some (__return__, v_7, v_3, v_6, v__11, v_indvars_iv_0, st_1)) => (Some st_1)
    | None => None
    end.

End Layer12_s2tt_init_valid_ns_LowSpec.

#[global] Hint Unfold s2tt_init_valid_ns_loop839_low: spec.

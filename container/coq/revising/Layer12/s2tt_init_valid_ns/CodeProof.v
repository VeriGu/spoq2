...
Section Layer12_s2tt_init_valid_ns_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque iasm_10_spec.
  Local Opaque ptr_offset.
  Hint Unfold s2tt_init_valid_ns_loop839_low:spec.
  Hint Unfold s2tt_init_valid_ns_loop839_rank:spec.
  ...
  Local Opaque store_RData.
    Lemma f_s2tt_init_valid_ns_correct:
      forall v_0 v_1 v_2 st st'
             (Hspec: s2tt_init_valid_ns_spec_low v_0 v_1 v_2 st = Some st'),
        exec_func Layer11_layer code "s2tt_init_valid_ns"
                  [VPtr v_0; VInt v_1; VInt v_2]
                  st st' None.
Admitted.

End Layer12_s2tt_init_valid_ns_CodeProof.

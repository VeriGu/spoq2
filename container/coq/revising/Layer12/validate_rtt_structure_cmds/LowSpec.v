...
Section Layer12_validate_rtt_structure_cmds_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition validate_rtt_structure_cmds_spec_low (v_0: Z) (v_1: Z) (v_2: Ptr) (st: RData) : (option (Z * RData)) :=
...
End Layer12_validate_rtt_structure_cmds_LowSpec.

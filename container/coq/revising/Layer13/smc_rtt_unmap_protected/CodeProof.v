...
Require Import Layer13.smc_rtt_unmap_protected.LowSpec.
...
Section Layer13_smc_rtt_unmap_protected_CodeProof.
  ...
  Local Opaque validate_rtt_map_cmds_spec.
    Lemma f_smc_rtt_unmap_protected_correct:
      forall v_0 v_1 v_2 st st' res
             (Hspec: smc_rtt_unmap_protected_spec_low v_0 v_1 v_2 st = Some (res, st')),
        exec_func Layer12_layer code "smc_rtt_unmap_protected"
...
End Layer13_smc_rtt_unmap_protected_CodeProof.

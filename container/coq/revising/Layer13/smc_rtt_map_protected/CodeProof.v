...
Section Layer13_smc_rtt_map_protected_CodeProof.
  ...
  Local Opaque validate_rtt_map_cmds_spec.
    Lemma f_smc_rtt_map_protected_correct:
      forall v_0 v_1 v_2 st st' res
             (Hspec: smc_rtt_map_protected_spec_low v_0 v_1 v_2 st = Some (res, st')),
        exec_func Layer12_layer code "smc_rtt_map_protected"
                  [VInt v_0; VInt v_1; VInt v_2]
                  st st' (Some (VInt res)).
Admitted.

End Layer13_smc_rtt_map_protected_CodeProof.

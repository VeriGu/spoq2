...
Section Layer13_smc_rtt_create_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque __granule_get_spec.
  Local Opaque __granule_refcount_inc_spec.
  ...
  Local Opaque s2tt_init_assigned_spec.
  Local Opaque s2tt_init_destroyed_spec.
  Local Opaque s2tt_init_unassigned_spec.
  Local Opaque s2tt_init_valid_ns_spec.
  Local Opaque s2tt_init_valid_spec.
  Local Opaque s2tte_create_table_spec.
  ...
  Local Opaque validate_rtt_structure_cmds_spec.
    Lemma f_smc_rtt_create_correct:
      forall v_0 v_1 v_2 v_3 st st' res
             (Hspec: smc_rtt_create_spec_low v_0 v_1 v_2 v_3 st = Some (res, st')),
        exec_func Layer12_layer code "smc_rtt_create"
                  [VInt v_0; VInt v_1; VInt v_2; VInt v_3]
                  st st' (Some (VInt res)).
Admitted.

End Layer13_smc_rtt_create_CodeProof.

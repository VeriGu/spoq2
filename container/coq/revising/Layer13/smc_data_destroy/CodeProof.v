...
Section Layer13_smc_data_destroy_CodeProof.
  ...
  Local Opaque validate_map_addr_spec.
    Lemma f_smc_data_destroy_correct:
      forall v_0 v_1 st st' res
             (Hspec: smc_data_destroy_spec_low v_0 v_1 st = Some (res, st')),
        exec_func Layer12_layer code "smc_data_destroy"
                  [VInt v_0; VInt v_1]
                  st st' (Some (VInt res)).
Admitted.

End Layer13_smc_data_destroy_CodeProof.

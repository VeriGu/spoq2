...
Section Layer9_rsi_data_read_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Fixpoint rsi_data_read_loop175_low (_N_: nat) (__return__: bool) (__break__: bool) (v_0: Ptr) (v_1: Z) (v_2: Z) (v_3: Z) (v_4: Z) (v_6: Ptr) (v__027: Z) (st: RData) : (option (bool * bool * Ptr * Z * Z * Z * Z * Ptr * Z * RData)) :=
    match (_N_) with
    | O => (Some (__return__, __break__, v_0, v_1, v_2, v_3, v_4, v_6, v__027, st))
    | (S _N__0) =>
      match ((rsi_data_read_loop175_low _N__0 __return__ __break__ v_0 v_1 v_2 v_3 v_4 v_6 v__027 st)) with
  ...
  Definition rsi_data_read_loop175_rank (v_0: Ptr) (v_1: Z) (v_2: Z) (v_3: Z) (v_4: Z) (v_6: Ptr) (v__027: Z) : Z :=
    0.

  Definition rsi_data_read_spec_low (v_0: Ptr) (v_1: Z) (v_2: Z) (v_3: Z) (v_4: Z) (st: RData) : (option RData) :=
    ...
    then (
      ...
      match (
        (rsi_data_read_loop175_low
          (z_to_nat (rsi_data_read_loop175_rank v_0 v_1 v_2 v_3 v_4 (mkPtr "stack_type_3" 0) 0))
          false
          false
          v_0
          v_1
...
End Layer9_rsi_data_read_LowSpec.

#[global] Hint Unfold rsi_data_read_loop175_low: spec.
#[global] Hint Unfold rsi_data_read_loop175_rank: spec.
#[global] Hint Unfold rsi_data_read_spec_low: spec.

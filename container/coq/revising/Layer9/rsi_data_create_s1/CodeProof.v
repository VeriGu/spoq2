...
Require Import Layer9.rsi_data_create_s1.LowSpec.
Require Import Zwf.
...
Section Layer9_rsi_data_create_s1_CodeProof.
  ...
  Local Opaque s1tte_pa_spec.
    Lemma f_rsi_data_create_s1_correct:
      forall v_0 v_1 v_2 v_3 st st' res
             (Hspec: rsi_data_create_s1_spec_low v_0 v_1 v_2 v_3 st = Some (res, st')),
        exec_func Layer8_layer code "rsi_data_create_s1"
...
End Layer9_rsi_data_create_s1_CodeProof.

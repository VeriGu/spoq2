...
Section Layer9_rsi_data_write_CodeProof.
  ...
  Local Opaque ns_buffer_read_byte_spec.
  Local Opaque pack_return_code_spec.
  Local Opaque ptr_offset.
  Local Opaque rc_update_ttbr0_el12_spec.
  Hint Unfold rsi_data_write_loop104_low:spec.
  Hint Unfold rsi_data_write_loop104_rank:spec.
  Local Opaque store_RData.
  Local Opaque virt_to_phys_spec.
    Lemma f_rsi_data_write_correct:
      forall v_0 v_1 v_2 v_3 v_4 st st'
             (Hspec: rsi_data_write_spec_low v_0 v_1 v_2 v_3 v_4 st = Some st'),
        exec_func Layer8_layer code "rsi_data_write"
                  [VPtr v_0; VInt v_1; VInt v_2; VInt v_3; VInt v_4]
                  st st' None.
Admitted.

End Layer9_rsi_data_write_CodeProof.

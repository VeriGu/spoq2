...
Section Layer4___find_next_level_idx_LowSpec.
  ...
  Definition __find_next_level_idx_spec_low (v_0: Ptr) (v_1: Z) (st: RData) : (option (Ptr * RData)) :=
    when v_3, st_0 == ((__table_get_entry_spec_abs v_0 v_1 st));
    when v_4, st_1 == ((entry_is_table_spec_abs v_3 st_0));
    if v_4
    then (
      when v_7, st_2 == ((table_entry_to_phys_spec_abs v_3 st_1));
      when v_8, st_3 == ((addr_to_granule_spec_abs v_7 st_2));
      (Some (v_8, st_3)))

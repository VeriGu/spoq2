              ...
              then (
                ...
                then (
                  ...
                  then (
                    ...
                    then (
                      when st_11 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
                      (Some st_11))
                    else (
                      when st_10 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
                      (Some st_10)))
                  else (
                    when st_9 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
                    (Some st_9)))
                else (
                  when st_8 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
                  (Some st_8)))
              else (
                when st_7 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
                (Some st_7)))
            else (
              when st_6 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
              (Some st_6)))
          else (
            when st_5 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
            (Some st_5)))
        else (
          when st_4 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
          (Some st_4)))
      else (
        when st_3 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) 0 st_1));
        (Some st_3)))
    else (
      when st_3 == ((store_RData 8 (mkPtr (v_0.(pbase)) ((v_0.(poffset)) + (32))) (- 1) st_1));
      (Some st_3)).

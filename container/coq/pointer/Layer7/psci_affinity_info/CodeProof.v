...
Require Import Layer7.psci_affinity_info.LowSpec.
Require Import Zwf.
...
Section Layer7_psci_affinity_info_CodeProof.
  ...
  Local Opaque vmpidr_to_rec_idx_spec.
    Lemma f_psci_affinity_info_correct:
      forall v_0 v_1 v_2 v_3 st st'
             (Hspec: psci_affinity_info_spec_low v_0 v_1 v_2 v_3 st = Some st'),
        exec_func Layer6_layer code "psci_affinity_info"
...
End Layer7_psci_affinity_info_CodeProof.

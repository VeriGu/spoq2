...
Section Layer9_rsi_data_map_extra_LowSpec.
  ...
  Definition rsi_data_map_extra_spec_low (v_0: Z) (v_1: Z) (v_2: Z) (st: RData) : (option (Z * RData)) :=
    ...
    let v_2_pte := (test_Z_PTE v_2) in
    when v_4, st_0 == ((s1tte_pa_spec_abs v_2_pte st));
    when v_5, st_1 == ((find_lock_granule_spec_abs v_4 4 st_0));
    ...
    then (
      ...
      when v_11, st_2 == ((find_lock_granule_spec_abs v_0_pa 5 st_1));
      ...
      then (
        ...
        when v_16, st_3 == ((data_create_internal_spec_abs v_2_pte v_11 v_1 (mkPtr "null" 0) (mkPtr "null" 0) 0 st_2));

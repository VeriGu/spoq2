...
namespace autov {
  void gen_low_proof_func(Project * p, int i, string fname, string path) {
    ...
    //Require Import
    std::set<string> deps = {"CommonDeps", "Code", "DataTypes", "GlobalDefs", "Zwf", layer+"."+fname+"."+"LowSpec", base_layer+".Layer"};
    ...
    out << "Local Opaque Z.add Z.mul Z.div Z.sub Z.land Z.lor Z.lxor Z.shiftl Z.shiftr Z.quot Z.rem Z.testbit Z.setbit Z.clearbit xorb List.nth.\n";
    out << "\n";
  ...
  void gen_low_proof_proc(Project * p, int i, string fname, string path) {
    ...
    //Require Import
    std::set<string> deps = {"CommonDeps", "Code", "DataTypes", "GlobalDefs", layer+"."+fname+"."+"LowSpec", base_layer+".Layer"};
    if(std::get<0>(loc) != "GlobalDefs") {
      deps.insert("GlobalDefs");
    }
    ...
    out << "Local Open Scope string_scope.\n";
    out << "Local Open Scope Z_scope.\n";
    out << "Local Opaque Z.add Z.mul Z.div Z.sub Z.land Z.lor Z.lxor Z.shiftl Z.shiftr Z.quot Z.rem Z.testbit Z.setbit Z.clearbit.\n";
    out << "\n";

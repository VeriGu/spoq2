...
void gen_layer(Project* proj, int i, string path) {
  ...
  std::set<string> ps;
  std::set_union(layer->prims.begin(), layer->prims.end(), layer->passthrough.begin(), layer->passthrough.end(), std::inserter(ps, ps.end()));
  ...
  if (layer->ops.find("load") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_load (size: Z) (p: Ptr) (st: "+string(*layer->abs_data)+") : option (Z * "+string(*layer->abs_data) + ") := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("store") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_store (size: Z) (p: Ptr) (val: Z) (st: "+string(*layer->abs_data)+") : option "+string(*layer->abs_data) + " := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("new_frame") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_newframe (fname: string) (st: "+string(*layer->abs_data)+") : option ("+string(*layer->abs_data) + ") := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("alloc") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_alloca (fname: string) (size: Z) (align: Z) (st: "+string(*layer->abs_data)+") : option (Ptr * "+string(*layer->abs_data) + ") := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("get_reg") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_get_reg (reg: regset) (st: "+string(*layer->abs_data)+") : option Z := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("set_reg") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_set_reg (reg: regset) (val: Z) (st: "+string(*layer->abs_data)+") : option "+string(*layer->abs_data) + " := None.\n";
        out << "\n";
  ...
  if (layer->ops.find("set_flag") != layer->ops.end()) {
        ...
        out << "  Definition "+layer->name+"_set_flag (f: flag) (val: bool) (st: "+string(*layer->abs_data)+") : option "+string(*layer->abs_data) + " := None.\n";
        out << "\n";

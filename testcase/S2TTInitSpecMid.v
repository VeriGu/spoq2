Fixpoint s2tt_init_valid_ns_loop738_mid (_N_: nat) (__return__: bool) (v_call: Z) (v_indvars_iv: Z) (v_level: Z) (v_pa_addr_05: Z) (v_s2tt: Ptr) (st: RData) : (option (bool * Z * Z * Z * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_call, v_indvars_iv, v_level, v_pa_addr_05, v_s2tt, st))
  | (S _N__0) =>
    match ((s2tt_init_valid_ns_loop738_mid _N__0 __return__ v_call v_indvars_iv v_level v_pa_addr_05 v_s2tt st)) with
...
Definition s2tt_init_valid_ns_spec_mid (v_s2tt: Ptr) (v_pa: Z) (v_level: Z) (st: RData) : (option RData) :=
  rely (((v_s2tt.(pbase)) = ("slot_delegated")));
  (anno (((- 9) = ((- 9))));
  (anno (((512 - (0)) = (512)));
  (anno (((39 + (((- 9) * (v_level)))) = ((3 * ((13 + (((- 3) * (v_level)))))))));
  (anno (((3 * ((13 + (((- 3) * (v_level)))))) = ((39 + (((- 9) * (v_level)))))));
  match ((s2tt_init_valid_ns_loop738_mid (z_to_nat 512) false (1 << ((39 + (((- 9) * (v_level)))))) 0 v_level v_pa v_s2tt st)) with
  | (Some (__return__, v_call_0, v_indvars_iv_0, v_level_0, v_pa_addr_6, v_s2tt_0, st_1)) => (Some st_1)
  | None => None
  end)))).

Fixpoint s2tt_init_valid_loop719_mid (_N_: nat) (__return__: bool) (v_call: Z) (v_indvars_iv: Z) (v_level: Z) (v_pa_addr_05: Z) (v_s2tt: Ptr) (st: RData) : (option (bool * Z * Z * Z * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_call, v_indvars_iv, v_level, v_pa_addr_05, v_s2tt, st))
  | (S _N__0) =>
    match ((s2tt_init_valid_loop719_mid _N__0 __return__ v_call v_indvars_iv v_level v_pa_addr_05 v_s2tt st)) with
    | (Some (__return___0, v_call_0, v_indvars_iv_0, v_level_0, v_pa_addr_6, v_s2tt_0, st_0)) =>
      rely (((v_s2tt_0.(pbase)) = ("slot_delegated")));
      when cid == (((((st_0.(share)).(granules)) @ (((st_0.(share)).(slots)) @ SLOT_DELEGATED)).(e_lock)));
      if ((v_indvars_iv_0 + (1)) <>? (512))
...
Definition s2tt_init_valid_spec_mid (v_s2tt: Ptr) (v_pa: Z) (v_level: Z) (st: RData) : (option RData) :=
  rely (((v_s2tt.(pbase)) = ("slot_delegated")));
  (anno (((- 9) = ((- 9))));
  (anno (((512 - (0)) = (512)));
  (anno (((39 + (((- 9) * (v_level)))) = ((3 * ((13 + (((- 3) * (v_level)))))))));
  (anno (((3 * ((13 + (((- 3) * (v_level)))))) = ((39 + (((- 9) * (v_level)))))));
  match ((s2tt_init_valid_loop719_mid (z_to_nat 512) false (1 << ((39 + (((- 9) * (v_level)))))) 0 v_level v_pa v_s2tt st)) with
  | (Some (__return__, v_call_0, v_indvars_iv_0, v_level_0, v_pa_addr_6, v_s2tt_0, st_1)) => (Some st_1)
  | None => None
  end)))).

Fixpoint s2tt_init_assigned_empty_loop700_mid (_N_: nat) (__return__: bool) (v_call: Z) (v_indvars_iv: Z) (v_level: Z) (v_pa_addr_05: Z) (v_s2tt: Ptr) (st: RData) : (option (bool * Z * Z * Z * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_call, v_indvars_iv, v_level, v_pa_addr_05, v_s2tt, st))
  | (S _N__0) =>
    match ((s2tt_init_assigned_empty_loop700_mid _N__0 __return__ v_call v_indvars_iv v_level v_pa_addr_05 v_s2tt st)) with
    | (Some (__return___0, v_call_0, v_indvars_iv_0, v_level_0, v_pa_addr_6, v_s2tt_0, st_0)) =>
      rely (((v_s2tt_0.(pbase)) = ("slot_delegated")));
      when cid == (((((st_0.(share)).(granules)) @ (((st_0.(share)).(slots)) @ SLOT_DELEGATED)).(e_lock)));
      if ((v_indvars_iv_0 + (1)) <>? (512))
...
Definition s2tt_init_assigned_empty_spec_mid (v_s2tt: Ptr) (v_pa: Z) (v_level: Z) (st: RData) : (option RData) :=
  rely (((v_s2tt.(pbase)) = ("slot_delegated")));
  (anno (((- 9) = ((- 9))));
  (anno (((512 - (0)) = (512)));
  (anno (((39 + (((- 9) * (v_level)))) = ((3 * ((13 + (((- 3) * (v_level)))))))));
  (anno (((3 * ((13 + (((- 3) * (v_level)))))) = ((39 + (((- 9) * (v_level)))))));
  match ((s2tt_init_assigned_empty_loop700_mid (z_to_nat 512) false (1 << ((39 + (((- 9) * (v_level)))))) 0 v_level v_pa v_s2tt st)) with
  | (Some (__return__, v_call_0, v_indvars_iv_0, v_level_0, v_pa_addr_6, v_s2tt_0, st_1)) => (Some st_1)
  | None => None
  end)))).

Fixpoint s2tt_init_destroyed_loop0_mid (_N_: nat) (__return__: bool) (v_index: Z) (v_s2tt: Ptr) (st: RData) : (option (bool * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_index, v_s2tt, st))
  | (S _N__0) =>
    match ((s2tt_init_destroyed_loop0_mid _N__0 __return__ v_index v_s2tt st)) with
...
Definition s2tt_init_destroyed_spec_mid (v_s2tt: Ptr) (st: RData) : (option RData) :=
  rely (((v_s2tt.(pbase)) = ("slot_delegated")));
  (anno (((512 - (0)) = (512)));
  match ((s2tt_init_destroyed_loop0_mid (z_to_nat 512) false 0 v_s2tt st)) with
  | (Some (__return__, v_index_0, v_s2tt_0, st_0)) => (Some st_0)
  | None => None
  end).

Fixpoint s2tt_init_unassigned_loop0_mid (_N_: nat) (__return__: bool) (v_call: Z) (v_index: Z) (v_s2tt: Ptr) (st: RData) : (option (bool * Z * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_call, v_index, v_s2tt, st))
  | (S _N__0) =>
    match ((s2tt_init_unassigned_loop0_mid _N__0 __return__ v_call v_index v_s2tt st)) with
...
Definition s2tt_init_unassigned_spec_mid (v_s2tt: Ptr) (v_ripas: Z) (st: RData) : (option RData) :=
  rely (((v_s2tt.(pbase)) = ("slot_delegated")));
  (anno (((512 - (0)) = (512)));
  match ((s2tt_init_unassigned_loop0_mid (z_to_nat 512) false (s2tte_create_ripas_spec' v_ripas st) 0 v_s2tt st)) with
  | (Some (__return__, v_call_0, v_index_0, v_s2tt_0, st_1)) => (Some st_1)
  | None => None
  end).

Definition realm_ipa_get_ripas_spec_mid (v_rec: Ptr) (v_ipa: Z) (v_ripas_ptr: Ptr) (v_rtt_level: Ptr) (st: RData) : (option (Z * RData)) :=
...
Definition realm_ipa_to_pa_spec_mid (v_rd: Ptr) (v_ipa: Z) (v_s2_walk: Ptr) (st: RData) : (option (Z * RData)) :=

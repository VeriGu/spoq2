Definition get_rd_state_locked_spec_mid (v_rd: Ptr) (st: RData) : (option (Z * RData)) :=
...
Definition get_rd_state_unlocked_spec_mid (v_rd: Ptr) (st: RData) : (option (Z * RData)) :=
  rely ((((v_rd.(pbase)) = ("slot_rd")) /\ (((v_rd.(poffset)) = (0)))));
  (anno (((456 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
  match (((((st.(share)).(granules)) @ (((st.(share)).(slots)) @ SLOT_RD)).(e_lock))) with
...
Definition set_rd_state_spec_mid (v_rd: Ptr) (v_state: Z) (st: RData) : (option RData) :=
  rely ((((v_rd.(pbase)) = ("slot_rd")) /\ (((v_rd.(poffset)) = (0)))));
  (anno (((456 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
  rely (
...
Definition get_rd_rec_count_locked_spec_mid (v_rd: Ptr) (st: RData) : (option (Z * RData)) :=
  rely ((((v_rd.(pbase)) = ("slot_rd")) /\ (((v_rd.(poffset)) = (0)))));
  (anno (((456 * (0)) = (0)));
  (anno (((8 + (0)) = (8)));
  (anno (((0 + (8)) = (8)));
...
Definition get_rd_rec_count_unlocked_spec_mid (v_rd: Ptr) (st: RData) : (option (Z * RData)) :=
  rely ((((v_rd.(pbase)) = ("slot_rd")) /\ (((v_rd.(poffset)) = (0)))));
  (anno (((456 * (0)) = (0)));
  (anno (((8 + (0)) = (8)));
  (anno (((0 + (8)) = (8)));
...
Definition set_rd_rec_count_spec_mid (v_rd: Ptr) (v_val: Z) (st: RData) : (option RData) :=
  rely ((((v_rd.(pbase)) = ("slot_rd")) /\ (((v_rd.(poffset)) = (0)))));
  (anno (((456 * (0)) = (0)));
  (anno (((8 + (0)) = (8)));
  (anno (((0 + (8)) = (8)));

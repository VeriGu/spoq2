Definition validate_map_addr_spec' (v_map_addr: Z) (v_level: Z) (v_rd: Ptr) (st: RData) : (option bool) :=
  rely ((((((((st.(share)).(granules)) @ (((st.(share)).(slots)) @ SLOT_RD)).(e_lock)) = ((Some CPU_ID))) /\ (((v_rd.(poffset)) = (0)))) /\ (((v_rd.(pbase)) = ("slot_rd")))));

Definition do_host_call_spec_mid (v_rec: Ptr) (v_rec_exit: Ptr) (v_rec_entry: Ptr) (v_rsi_walk_result: Ptr) (st: RData) : (option (Z * RData)) :=
  ...
  then (
    ...
    then (
      (anno (((- 1) = ((- 1))));
      (Some (1, ((st_5.[share].[slots] :< (((st_5.(share)).(slots)) # SLOT_RD == (- 1))).[stack].[do_host_call_stack] :< ((st.(stack)).(do_host_call_stack)))))))
    else (
      (anno (((16 * (0)) = (0)));
      (anno (((0 + (0)) = (0)));
      ...
      then (
        ...
        (anno (((0 + (8)) = (8)));
        (anno (((- 1) = ((- 1))));
        (anno ((((v_rsi_walk_result.(poffset)) + (0)) = ((v_rsi_walk_result.(poffset)))));
        (Some (
          0  ,
    ...
    (anno (((32 * (0)) = (0)));
    (anno (((0 + (0)) = (0)));
    rely (((((((st_5.(stack)).(do_host_call_stack)) @ 0) & (4095)) =? (0)) = (true)));
    rely (((((((st_5.(stack)).(do_host_call_stack)) @ 0) / (GRANULE_SIZE)) >? (1048575)) = (false)));
    rely ((((0 - (((((st_5.(stack)).(do_host_call_stack)) @ 0) / (GRANULE_SIZE)))) <= (0)) /\ ((((((st_5.(stack)).(do_host_call_stack)) @ 0) / (GRANULE_SIZE)) < (1048576)))));
    (anno (((24 - (22)) = (2)));
    (anno ((((16 * (((((st_5.(stack)).(do_host_call_stack)) @ 0) / (GRANULE_SIZE)))) >> (4)) = (((((st_5.(stack)).(do_host_call_stack)) @ 0) / (GRANULE_SIZE)))));
    when st_9 == (
...
Definition region_in_rec_par_spec_mid (v_rec: Ptr) (v_base: Z) (v_end: Z) (st: RData) : (option (bool * RData)) :=
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  rely (
    match (((((st.(share)).(granules)) @ (((st.(share)).(slots)) @ SLOT_REC)).(e_lock))) with
    | (Some cid) =>

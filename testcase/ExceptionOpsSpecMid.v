Definition ipa_is_empty_spec_mid (v_ipa: Z) (v_rec: Ptr) (st: RData) : (option (bool * RData)) :=
  ...
  then (
    ...
    | None =>
      ...
      then (
        ...
        (anno (((8 + (0)) = (8)));
        (anno (((0 + (8)) = (8)));
        (anno ((((8 * ((((st_8.(stack)).(ipa_is_empty_stack)) @ 8))) + (0)) = ((8 * ((((st_8.(stack)).(ipa_is_empty_stack)) @ 8))))));
        (anno (((0 + ((8 * ((((st_8.(stack)).(ipa_is_empty_stack)) @ 8))))) = ((8 * ((((st_8.(stack)).(ipa_is_empty_stack)) @ 8))))));
        when ret == (
            (__tte_read_spec'
...
Definition access_in_rec_par_spec_mid (v_rec: Ptr) (v_addr: Z) (st: RData) : (option (bool * RData)) :=
  rely (
...
Definition fixup_aarch32_data_abort_spec_mid (v_rec: Ptr) (v_esr: Ptr) (st: RData) : (option (bool * RData)) :=
...
Definition get_dabt_write_value_spec_mid (v_rec: Ptr) (v_esr: Z) (st: RData) : (option (Z * RData)) :=
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  if (((v_esr >> (16)) & (31)) =? (31))
  then (Some (0, st))
  else (
    rely ((((0 - (((v_esr >> (16)) & (31)))) <= (0)) /\ ((((v_esr >> (16)) & (31)) < (31)))));
    (anno (((3272 * (0)) = (0)));
    rely (
      match (((((st.(share)).(granules)) @ (((st.(share)).(slots)) @ SLOT_REC)).(e_lock))) with
    ...
    (anno ((((8 * (((v_esr >> (16)) & (31)))) + (0)) = ((8 * (((v_esr >> (16)) & (31)))))));
    (anno (((0 + ((24 + ((8 * (((v_esr >> (16)) & (31)))))))) = ((24 + ((8 * (((v_esr >> (16)) & (31)))))))));
    (anno ((((v_rec.(poffset)) + ((24 + ((8 * (((v_esr >> (16)) & (31)))))))) = ((24 + ((8 * (((v_esr >> (16)) & (31)))))))));
    (anno ((((24 + ((8 * (((v_esr >> (16)) & (31)))))) - (24)) = ((8 * (((v_esr >> (16)) & (31)))))));
    (anno ((((8 * (((v_esr >> (16)) & (31)))) / (8)) = (((v_esr >> (16)) & (31)))));
    (Some (((access_mask_spec' v_esr st) & (((((((st.(share)).(granule_data)) @ (((st.(share)).(slots)) @ SLOT_REC)).(g_rec)).(e_regs)) @ ((v_esr >> (16)) & (31))))), st))))))))).

Definition handle_sync_external_abort_spec_mid (v_rec: Ptr) (v_rec_exit: Ptr) (v_esr: Z) (st: RData) : (option (bool * RData)) :=
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
...
Definition emulate_sysreg_access_ns_spec_mid (v_rec: Ptr) (v_rec_exit: Ptr) (v_esr: Z) (st: RData) : (option RData) :=
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  rely ((((v_rec_exit.(pbase)) = ("smc_rec_enter_stack")) /\ (((v_rec_exit.(poffset)) = (0)))));
  if ((v_esr & (1)) =? (0))
  then (
...
Definition handle_rsi_ipa_state_get_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
...
Definition psci_rsi_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (v_function_id: Z) (v_arg0: Z) (v_arg1: Z) (v_arg2: Z) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  if (
  ...
  then (
    ...
    then (
      ...
      then (
        ...
        then (Some (st_1.[stack].[handle_realm_rsi_stack] :< (((st_1.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == 0)))
          ...
          (anno (((- 1) = ((- 1))));
          (Some (st_1.[stack].[handle_realm_rsi_stack] :< (((st_1.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == (- 1))))))))
    else (
      rely ((("handle_realm_rsi_stack" = ("handle_realm_rsi_stack")) /\ ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))))));
      when st_1 == ((llvm_memset_p0i8_i64_spec_state_oracle (mkPtr "handle_realm_rsi_stack" (v_agg_result.(poffset))) 0 72 false st));
    ...
    then (
      ...
      then (
        ...
        (anno (((- 2) = ((- 2))));
        (Some (st_1.[stack].[handle_realm_rsi_stack] :< (((st_1.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == (- 2)))))))
    else (
      rely ((("handle_realm_rsi_stack" = ("handle_realm_rsi_stack")) /\ ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))))));
      when st_1 == ((llvm_memset_p0i8_i64_spec_state_oracle (mkPtr "handle_realm_rsi_stack" (v_agg_result.(poffset))) 0 72 false st));
      if (v_arg1 =? (0))

Definition find_lock_granules_loop197_low (_N_: nat) (__break__: bool) (v_granules: Ptr) (v_i_241: Z) (st: RData) : (option (bool * Ptr * Z * RData)) :=
  match (_N_) with
...
Definition find_lock_granules_loop0_low (_N_: nat) (__return__: bool) (__retval__: bool) (__break__: bool) (v_granules: Ptr) (v_i_143: Z) (st: RData) : (option (bool * bool * bool * Ptr * Z * RData)) :=
  match (_N_) with

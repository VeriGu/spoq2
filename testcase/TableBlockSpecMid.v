Fixpoint __table_maps_block_loop840_mid (_N_: nat) (v_call: Z) (v_call3: Z) (v_i_015: Z) (v_level: Z) (v_retval_0: bool) (v_table: Ptr) (v_s2tte_is_x: Ptr) (st: RData) : (option (Z * Z * Z * Z * bool * Ptr * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (v_call, v_call3, v_i_015, v_level, v_retval_0, v_table, v_s2tte_is_x, st))
  | (S _N__0) =>
    match ((__table_maps_block_loop840_mid _N__0 v_call v_call3 v_i_015 v_level v_retval_0 v_table v_s2tte_is_x st)) with
    | (Some (v_call_0, v_call3_0, v_i_16, v_level_0, v_retval_1, v_table_0, v_s2tte_is_x_0, st_0)) =>
      ...
      then (
        ...
        then (
          (anno (((- 1) = ((- 1))));
          (anno (((39 + ((38654705655 * (v_level_0)))) = ((3 * ((13 + ((12884901885 * (v_level_0)))))))));
          (anno (((3 * ((13 + ((12884901885 * (v_level_0)))))) = ((39 + ((38654705655 * (v_level_0)))))));
...
Definition __table_maps_block_spec_mid (v_table: Ptr) (v_level: Z) (v_s2tte_is_x: Ptr) (st: RData) : (option (bool * RData)) :=
  ...
  then (
    ...
    then (
      (anno (((- 1) = ((- 1))));
      (anno (((39 + ((38654705655 * ((v_level + ((- 1))))))) = ((3 * ((13 + ((12884901885 * ((v_level + ((- 1))))))))))));
      (anno (((13 + ((12884901885 * ((v_level + ((- 1))))))) = (((- 12884901872) + ((12884901885 * (v_level)))))));
      (anno ((((- 38654705616) + ((38654705655 * (v_level)))) = ((3 * (((- 12884901872) + ((12884901885 * (v_level)))))))));
      (anno (((39 + ((38654705655 * (v_level)))) = ((3 * ((13 + ((12884901885 * (v_level)))))))));
      (anno (((3 * (((- 12884901872) + ((12884901885 * (v_level)))))) = (((- 38654705616) + ((38654705655 * (v_level)))))));
      ...
      then (
        ...
        (anno (((3 * ((13 + ((12884901885 * (v_level)))))) = ((39 + ((38654705655 * (v_level)))))));
        match (
          (__table_maps_block_loop840_mid
            (z_to_nat 511) 
            (1 << ((39 + (((- 9) * (v_level)))))) 
            ((ret & (281474976710655)) & (((- 1) << (((39 + ((38654705655 * (v_level)))) & (4294967295)))))) 
            1 
...
Fixpoint __table_is_uniform_block_loop777_mid (_N_: nat) (v_cmp_not: bool) (v_indvars_iv: Z) (v_retval_0: bool) (v_ripas_0: Z) (v_ripas_ptr: Ptr) (v_table: Ptr) (v_s2tte_is_x: Ptr) (st: RData) : (option (bool * Z * bool * Z * Ptr * Ptr * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (v_cmp_not, v_indvars_iv, v_retval_0, v_ripas_0, v_ripas_ptr, v_table, v_s2tte_is_x, st))
  | (S _N__0) =>
    match ((__table_is_uniform_block_loop777_mid _N__0 v_cmp_not v_indvars_iv v_retval_0 v_ripas_0 v_ripas_ptr v_table v_s2tte_is_x st)) with
    | (Some (v_cmp_not_0, v_indvars_iv_0, v_retval_1, v_ripas_1, v_ripas_ptr_0, v_table_0, v_s2tte_is_x_0, st_0)) =>
      ...
      (anno ((((8 * (v_indvars_iv_0)) + (0)) = ((8 * (v_indvars_iv_0)))));
...
Definition __table_is_uniform_block_spec_mid (v_table: Ptr) (v_s2tte_is_x: Ptr) (v_ripas_ptr: Ptr) (st: RData) : (option (bool * RData)) :=
  rely (((v_table.(pbase)) = ("slot_rtt2")));
  ...
  then (
    ...
    then (
      (anno ((((v_ripas_ptr.(poffset)) - (0)) = ((v_ripas_ptr.(poffset)))));
      if (((v_ripas_ptr.(pbase)) =s ("null")) && (((v_ripas_ptr.(poffset)) =? (0))))
      then (
        (anno (((511 - (0)) = (511)));
        (anno (((512 - (1)) = (511)));
        (anno ((((v_ripas_ptr.(poffset)) - (0)) = ((v_ripas_ptr.(poffset)))));
        match ((__table_is_uniform_block_loop777_mid (z_to_nat 511) ((v_ripas_ptr.(pbase)) =s ("null")) 1 false 0 v_ripas_ptr v_table v_s2tte_is_x st)) with
        ...
        (anno ((((v_ripas_ptr.(poffset)) - (0)) = ((v_ripas_ptr.(poffset)))));
        match (
          (__table_is_uniform_block_loop777_mid
            (z_to_nat 511) 

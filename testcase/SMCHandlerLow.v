...
(*                   when st_34 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_33)); *)
(*                   when v_14, st_35 == ((load_RData 8 (ptr_offset v_wi 8) st_34)); *)
(*                   when st_36 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) 8 st_35)); *)
(*                   when st_37 == ((granule_memzero_mapped_spec v_call34 st_36)); *)
(*                   when st_38 == ((granule_set_state_spec v_call33 1 st_37)); *)
(*                   when st_39 == ((buffer_unmap_spec v_call34 st_38)); *)
(*                   when st_40 == ((granule_unlock_spec v_call33 st_39)); *)
...
(*                   if v_call90 *)
(*                   then ( *)
(*                     when st_35 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_34)); *)
(*                     when v_14, st_36 == ((load_RData 8 (ptr_offset v_wi 8) st_35)); *)
(*                     when st_37 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) 8 st_36)); *)
(*                     when st_38 == ((granule_memzero_mapped_spec v_call34 st_37)); *)
(*                     when st_39 == ((granule_set_state_spec v_call33 1 st_38)); *)
(*                     when st_40 == ((buffer_unmap_spec v_call34 st_39)); *)
(*                     when st_41 == ((granule_unlock_spec v_call33 st_40)); *)
(*                     when st_42 == ((buffer_unmap_spec v_call15 st_41)); *)
(*                     when v_15_tmp, st_43 == ((load_RData 8 (ptr_offset v_wi 0) st_42)); *)
(*                     when st_44 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_43)); *)
(*                     when st_45 == ((free_stack "smc_rtt_fold" st_0 st_44)); *)
(*                     (Some (0, st_45))) *)
(*                   else ( *)
(*                     when st_35 == ((invalidate_block_spec v_s2_ctx v_map_addr st_34)); *)
(*                     when v_14, st_36 == ((load_RData 8 (ptr_offset v_wi 8) st_35)); *)
(*                     when st_37 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) 8 st_36)); *)
(*                     when st_38 == ((granule_memzero_mapped_spec v_call34 st_37)); *)
(*                     when st_39 == ((granule_set_state_spec v_call33 1 st_38)); *)
...
(*                     when v_15_tmp, st_43 == ((load_RData 8 (ptr_offset v_wi 0) st_42)); *)
(*                     when st_44 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_43)); *)
(*                     when st_46 == ((free_stack "smc_rtt_fold" st_0 st_44)); *)
(*                     (Some (0, st_46))))) *)
(*               else ( *)
(*                 when v_call42, st_28 == ((table_is_unassigned_block_spec v_call34 v_ripas st_27)); *)
(*                 if v_call42 *)
...
(*                   if v_call87 *)
(*                   then ( *)
(*                     when st_37 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_36)); *)
(*                     when v_14, st_38 == ((load_RData 8 (ptr_offset v_wi 8) st_37)); *)
(*                     when st_39 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call44 st_38)); *)
(*                     when st_40 == ((granule_memzero_mapped_spec v_call34 st_39)); *)
(*                     when st_41 == ((granule_set_state_spec v_call33 1 st_40)); *)
(*                     when st_42 == ((buffer_unmap_spec v_call34 st_41)); *)
(*                     when st_43 == ((granule_unlock_spec v_call33 st_42)); *)
(*                     when st_44 == ((buffer_unmap_spec v_call15 st_43)); *)
(*                     when v_15_tmp, st_45 == ((load_RData 8 (ptr_offset v_wi 0) st_44)); *)
(*                     when st_46 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_45)); *)
(*                     when st_47 == ((free_stack "smc_rtt_fold" st_0 st_46)); *)
(*                     (Some (0, st_47))) *)
(*                   else ( *)
(*                     when v_call90, st_37 == ((s2tte_is_valid_ns_spec v_call44 (v_ulevel + ((- 1))) st_36)); *)
(*                     if v_call90 *)
(*                     then ( *)
(*                       when st_38 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_37)); *)
(*                       when v_14, st_39 == ((load_RData 8 (ptr_offset v_wi 8) st_38)); *)
(*                       when st_40 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call44 st_39)); *)
(*                       when st_41 == ((granule_memzero_mapped_spec v_call34 st_40)); *)
(*                       when st_42 == ((granule_set_state_spec v_call33 1 st_41)); *)
(*                       when st_43 == ((buffer_unmap_spec v_call34 st_42)); *)
(*                       when st_44 == ((granule_unlock_spec v_call33 st_43)); *)
(*                       when st_45 == ((buffer_unmap_spec v_call15 st_44)); *)
(*                       when v_15_tmp, st_46 == ((load_RData 8 (ptr_offset v_wi 0) st_45)); *)
(*                       when st_47 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_46)); *)
(*                       when st_48 == ((free_stack "smc_rtt_fold" st_0 st_47)); *)
(*                       (Some (0, st_48))) *)
(*                     else ( *)
(*                       when st_38 == ((invalidate_block_spec v_s2_ctx v_map_addr st_37)); *)
(*                       when v_14, st_39 == ((load_RData 8 (ptr_offset v_wi 8) st_38)); *)
(*                       when st_40 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call44 st_39)); *)
(*                       when st_41 == ((granule_memzero_mapped_spec v_call34 st_40)); *)
(*                       when st_42 == ((granule_set_state_spec v_call33 1 st_41)); *)
...
(*                       when v_15_tmp, st_46 == ((load_RData 8 (ptr_offset v_wi 0) st_45)); *)
(*                       when st_47 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_46)); *)
(*                       when st_49 == ((free_stack "smc_rtt_fold" st_0 st_47)); *)
(*                       (Some (0, st_49))))) *)
(*                 else ( *)
(*                   when st_29 == ((buffer_unmap_spec v_call34 st_28)); *)
(*                   when st_30 == ((granule_unlock_spec v_call33 st_29)); *)
...
(*                     if v_call87 *)
(*                     then ( *)
(*                       when st_36 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_35)); *)
(*                       when v_14, st_37 == ((load_RData 8 (ptr_offset v_wi 8) st_36)); *)
(*                       when st_38 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call64 st_37)); *)
(*                       when st_39 == ((granule_memzero_mapped_spec v_call34 st_38)); *)
(*                       when st_40 == ((granule_set_state_spec v_call33 1 st_39)); *)
(*                       when st_41 == ((buffer_unmap_spec v_call34 st_40)); *)
(*                       when st_42 == ((granule_unlock_spec v_call33 st_41)); *)
(*                       when st_43 == ((buffer_unmap_spec v_call15 st_42)); *)
(*                       when v_15_tmp, st_44 == ((load_RData 8 (ptr_offset v_wi 0) st_43)); *)
(*                       when st_45 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_44)); *)
(*                       when st_46 == ((free_stack "smc_rtt_fold" st_0 st_45)); *)
(*                       (Some (0, st_46))) *)
(*                     else ( *)
(*                       when v_call90, st_36 == ((s2tte_is_valid_ns_spec v_call64 (v_ulevel + ((- 1))) st_35)); *)
(*                       if v_call90 *)
...
(*                         when st_37 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_36)); *)
(*                         when v_14, st_38 == ((load_RData 8 (ptr_offset v_wi 8) st_37)); *)
(*                         when st_39 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call64 st_38)); *)
(*                         when st_40 == ((granule_memzero_mapped_spec v_call34 st_39)); *)
(*                         when st_41 == ((granule_set_state_spec v_call33 1 st_40)); *)
(*                         when st_42 == ((buffer_unmap_spec v_call34 st_41)); *)
(*                         when st_43 == ((granule_unlock_spec v_call33 st_42)); *)
(*                         when st_44 == ((buffer_unmap_spec v_call15 st_43)); *)
(*                         when v_15_tmp, st_45 == ((load_RData 8 (ptr_offset v_wi ((24 * (0)) + ((0 + (0))))) st_44)); *)
(*                         when st_46 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_45)); *)
(*                         when st_47 == ((free_stack "smc_rtt_fold" st_0 st_46)); *)
(*                         (Some (0, st_47))) *)
(*                       else ( *)
(*                         when st_37 == ((invalidate_block_spec v_s2_ctx v_map_addr st_36)); *)
(*                         when v_14, st_38 == ((load_RData 8 (ptr_offset v_wi 8) st_37)); *)
(*                         when st_39 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call64 st_38)); *)
(*                         when st_40 == ((granule_memzero_mapped_spec v_call34 st_39)); *)
(*                         when st_41 == ((granule_set_state_spec v_call33 1 st_40)); *)
...
(*                         when v_15_tmp, st_45 == ((load_RData 8 (ptr_offset v_wi 0) st_44)); *)
(*                         when st_46 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_45)); *)
(*                         when st_48 == ((free_stack "smc_rtt_fold" st_0 st_46)); *)
(*                         (Some (0, st_48))))) *)
(*                   else ( *)
(*                     when v_call66, st_30 == ((table_maps_valid_block_spec v_call34 v_ulevel st_29)); *)
(*                     if v_call66 *)
...
(*                         when st_37 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_36)); *)
(*                         when v_14, st_38 == ((load_RData 8 (ptr_offset v_wi 8) st_37)); *)
(*                         when st_39 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call69 st_38)); *)
(*                         when st_40 == ((granule_memzero_mapped_spec v_call34 st_39)); *)
(*                         when st_41 == ((granule_set_state_spec v_call33 1 st_40)); *)
(*                         when st_42 == ((buffer_unmap_spec v_call34 st_41)); *)
(*                         when st_43 == ((granule_unlock_spec v_call33 st_42)); *)
...
(*                           when st_38 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_37)); *)
(*                           when v_14, st_39 == ((load_RData 8 (ptr_offset v_wi 8) st_38)); *)
(*                           when st_40 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call69 st_39)); *)
(*                           when st_41 == ((granule_memzero_mapped_spec v_call34 st_40)); *)
(*                           when st_42 == ((granule_set_state_spec v_call33 1 st_41)); *)
(*                           when st_43 == ((buffer_unmap_spec v_call34 st_42)); *)
(*                           when st_44 == ((granule_unlock_spec v_call33 st_43)); *)
(*                           when st_45 == ((buffer_unmap_spec v_call15 st_44)); *)
(*                           when v_15_tmp, st_46 == ((load_RData 8 (ptr_offset v_wi ((24 * (0)) + ((0 + (0))))) st_45)); *)
(*                           when st_47 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_46)); *)
(*                           when st_48 == ((free_stack "smc_rtt_fold" st_0 st_47)); *)
(*                           (Some (0, st_48))) *)
(*                         else ( *)
...
(*                           when st_38 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_37)); *)
(*                           when v_14, st_39 == ((load_RData 8 (ptr_offset v_wi 8) st_38)); *)
(*                           when st_40 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call74 st_39)); *)
(*                           when st_41 == ((granule_memzero_mapped_spec v_call34 st_40)); *)
(*                           when st_42 == ((granule_set_state_spec v_call33 1 st_41)); *)
(*                           when st_43 == ((buffer_unmap_spec v_call34 st_42)); *)
(*                           when st_44 == ((granule_unlock_spec v_call33 st_43)); *)
...
(*                           if v_call90 *)
(*                           then ( *)
(*                             when st_39 == ((invalidate_pages_in_block_spec v_s2_ctx v_map_addr st_38)); *)
(*                             when v_14, st_40 == ((load_RData 8 (ptr_offset v_wi 8) st_39)); *)
(*                             when st_41 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call74 st_40)); *)
(*                             when st_42 == ((granule_memzero_mapped_spec v_call34 st_41)); *)
(*                             when st_43 == ((granule_set_state_spec v_call33 1 st_42)); *)
(*                             when st_44 == ((buffer_unmap_spec v_call34 st_43)); *)
(*                             when st_45 == ((granule_unlock_spec v_call33 st_44)); *)
(*                             when st_46 == ((buffer_unmap_spec v_call15 st_45)); *)
(*                             when v_15_tmp, st_47 == ((load_RData 8 (ptr_offset v_wi 0) st_46)); *)
(*                             when st_48 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_47)); *)
(*                             when st_49 == ((free_stack "smc_rtt_fold" st_0 st_48)); *)
(*                             (Some (0, st_49))) *)
(*                           else ( *)
(*                             when st_39 == ((invalidate_block_spec v_s2_ctx v_map_addr st_38)); *)
(*                             when v_14, st_40 == ((load_RData 8 (ptr_offset v_wi 8) st_39)); *)
(*                             when st_41 == ((__tte_write_spec (ptr_offset v_call15 (8 * (v_14))) v_call74 st_40)); *)
(*                             when st_42 == ((granule_memzero_mapped_spec v_call34 st_41)); *)
(*                             when st_43 == ((granule_set_state_spec v_call33 1 st_42)); *)
...
(*                             when v_15_tmp, st_47 == ((load_RData 8 (ptr_offset v_wi 0) st_46)); *)
(*                             when st_48 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_47)); *)
(*                             when st_50 == ((free_stack "smc_rtt_fold" st_0 st_48)); *)
(*                             (Some (0, st_50))))) *)
(*                       else ( *)
(*                         when v_call77, st_32 == ((pack_return_code_spec 4 v_ulevel st_31)); *)
(*                         when st_33 == ((buffer_unmap_spec v_call34 st_32)); *)
(*                         when st_34 == ((granule_unlock_spec v_call33 st_33)); *)
(*                         when st_35 == ((buffer_unmap_spec v_call15 st_34)); *)
(*                         when v_15_tmp, st_36 == ((load_RData 8 (ptr_offset v_wi 0) st_35)); *)
(*                         when st_37 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_36)); *)
(*                         when st_39 == ((free_stack "smc_rtt_fold" st_0 st_37)); *)
(*                         (Some (v_call77, st_39))))))) *)
(*               else ( *)
(*                 when st_27 == ((buffer_unmap_spec v_call34 st_26)); *)
(*                 when st_28 == ((granule_unlock_spec v_call33 st_27)); *)
(*                 when st_29 == ((buffer_unmap_spec v_call15 st_28)); *)
(*                 when v_15_tmp, st_30 == ((load_RData 8 (ptr_offset v_wi ((24 * (0)) + ((0 + (0))))) st_29)); *)
(*                 when st_31 == ((granule_unlock_spec (int_to_ptr v_15_tmp) st_30)); *)
(*                 when st_33 == ((free_stack "smc_rtt_fold" st_0 st_31)); *)
(*                 (Some (5, st_33))))) *)
(*           else ( *)

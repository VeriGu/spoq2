...
Section Bottom_Spec.
  ...
  Definition iasm_2_spec (v_ptr: Ptr) (v_val: Z) (st: RData) : (option RData) :=
    (Some st).

  Definition iasm_18_spec (st: RData) : (option (Z * RData)) :=
    (Some (0, st)).

  Definition iasm_0_spec (v_ptr: Ptr) (st: RData) : (option (Z * RData)) :=
    (Some (0, st)).

  Definition iasm_335_spec (st: RData) : (option RData) :=
    (Some st).

  Definition xlat_arch_tlbi_va_sync_spec (st: RData) : (option RData) :=
    (Some st).

  Definition xlat_arch_tlbi_va_spec (ptr: Ptr) (st: RData) : (option RData) :=
    (Some st).
...
#[global] Hint Unfold iasm_2_spec: spec.
#[global] Hint Unfold iasm_18_spec: spec.
#[global] Hint Unfold iasm_0_spec: spec.
#[global] Hint Unfold iasm_335_spec: spec.
#[global] Hint Unfold xlat_arch_tlbi_va_sync_spec: spec.
#[global] Hint Unfold xlat_arch_tlbi_va_spec: spec.

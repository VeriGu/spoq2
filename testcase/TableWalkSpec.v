...
Fixpoint rtt_walk_lock_unlock_loop370 (_N_: nat) (__return__: bool) (v_g_tbls: Ptr) (v_indvars_iv: Z) (v_level: Z) (v_map_addr: Z) (v_wi: Ptr) (st: RData) : (option (bool * Ptr * Z * Z * Z * Ptr * RData)) :=
  match (_N_) with
  | O => (Some (__return__, v_g_tbls, v_indvars_iv, v_level, v_map_addr, v_wi, st))
  | (S _N_) =>
    match ((rtt_walk_lock_unlock_loop370 _N_ __return__ v_g_tbls v_indvars_iv v_level v_map_addr v_wi st)) with

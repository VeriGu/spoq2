Definition table_is_destroyed_block_spec_mid (v_table: Ptr) (st: RData) : (option (bool * RData)) :=
...
Definition table_is_unassigned_block_spec_mid (v_table: Ptr) (v_ripas: Ptr) (st: RData) : (option (bool * RData)) :=
...
Definition table_maps_assigned_block_spec_mid (v_table: Ptr) (v_level: Z) (st: RData) : (option (bool * RData)) :=
  rely (
...
Definition table_maps_valid_block_spec_mid (v_table: Ptr) (v_level: Z) (st: RData) : (option (bool * RData)) :=
  rely (
    (((v_table.(pbase)) = ("slot_rtt2")) /\
...
Definition table_maps_valid_ns_block_spec_mid (v_table: Ptr) (v_level: Z) (st: RData) : (option (bool * RData)) :=
  rely (
    (((v_table.(pbase)) = ("slot_rtt2")) /\

Definition psci_features_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (v_psci_func_id: Z) (st: RData) : (option RData) :=
  ...
  then (
    ...
    (anno (((32 + (0)) = (32)));
    (anno (((0 + (32)) = (32)));
    (Some (st_0.[stack].[handle_realm_rsi_stack] :< (((st_0.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == 0))))))))))
  else (
    (anno (((- 1) = ((- 1))));
    (anno (((72 * (0)) = (0)));
    (anno (((8 * (0)) = (0)));
    ...
    (anno (((32 + (0)) = (32)));
    (anno (((0 + (32)) = (32)));
    (Some (st_0.[stack].[handle_realm_rsi_stack] :< (((st_0.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == (- 1)))))))))))))).

Definition psci_system_reset_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
...
Definition psci_system_off_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
...
Definition psci_affinity_info_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (v_target_affinity: Z) (v_lowest_affinity_level: Z) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
  ...
  then (
    ...
    (anno (((32 + (0)) = (32)));
    (anno (((0 + (32)) = (32)));
    (Some (st_0.[stack].[handle_realm_rsi_stack] :< (((st_0.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == (- 2)))))))))))))).

Definition psci_cpu_on_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (v_target_cpu: Z) (v_entry_point_address: Z) (v_context_id: Z) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
  ...
  then (
    ...
    (anno (((32 + (0)) = (32)));
    (anno (((0 + (32)) = (32)));
    (Some (st_0.[stack].[handle_realm_rsi_stack] :< (((st_0.(stack)).(handle_realm_rsi_stack)) # ((v_agg_result.(poffset)) + (32)) == (- 9)))))))))))))).

Definition psci_cpu_off_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
...
Definition psci_cpu_suspend_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (v_entry_point_address: Z) (v_context_id: Z) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));
...
Definition psci_version_spec_mid (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
  rely (((v_agg_result.(pbase)) = ("handle_realm_rsi_stack")));
  rely ((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))));
  (anno (((72 * (0)) = (0)));
  (anno (((0 + (0)) = (0)));

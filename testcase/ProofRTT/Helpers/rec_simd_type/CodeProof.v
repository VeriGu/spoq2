...
Require Import Helpers.rec_simd_type.LowSpec.
...
Section Helpers_rec_simd_type_CodeProof.
  ...
  Local Opacque rec_refcount_one.
    Lemma f_rec_simd_type_correct:
      forall v_rec st st' res
        ...
        exec_func MakeReturnCode_layer code "rec_simd_type"
                  [VPtr v_rec]
                  st st' (Some (VInt res)).
    Proof.
...
End Helpers_rec_simd_type_CodeProof.

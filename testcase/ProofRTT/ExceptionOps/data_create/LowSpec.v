...
Section ExceptionOps_data_create_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition data_create_1_low (v_data_addr: Z) (v_wi: Ptr) (v_call14: Ptr) (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (st_0: RData) (st_20: RData) : (option (Z * RData)) :=
  ...
  Definition data_create_2_low (v_data_addr: Z) (v_wi: Ptr) (v_call14: Ptr) (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (st_0: RData) (st_20: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("data_create_stack")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_g_rd.(pbase)) = ("data_create_stack")));
  ...
  Definition data_create_3_low (v_call14: Ptr) (v_wi: Ptr) (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (st_0: RData) (st_19: RData) : (option (Z * RData)) :=
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_wi.(pbase)) = ("data_create_stack")));
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_g_rd.(pbase)) = ("data_create_stack")));
  ...
  Definition data_create_4_low (v_4: Z) (v_wi: Ptr) (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (st_0: RData) (st_14: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("data_create_stack")));
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_g_rd.(pbase)) = ("data_create_stack")));
    rely (((v_g_data.(pbase)) = ("data_create_stack")));
  ...
  Definition data_create_5_low (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (v_call3: Z) (st_0: RData) (st_7: RData) : (option (Z * RData)) :=
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_g_rd.(pbase)) = ("data_create_stack")));
    rely (((v_g_data.(pbase)) = ("data_create_stack")));
  ...
  Definition data_create_6_low (v_call24: Ptr) (v_call14: Ptr) (v_wi: Ptr) (v_call1_0: Ptr) (v_g_rd: Ptr) (v_g_data: Ptr) (st_0: RData) (st_23: RData) : (option (Z * RData)) :=
...
End ExceptionOps_data_create_LowSpec.

#[global] Hint Unfold data_create_1_low: spec.
#[global] Hint Unfold data_create_2_low: spec.
#[global] Hint Unfold data_create_3_low: spec.
#[global] Hint Unfold data_create_4_low: spec.
#[global] Hint Unfold data_create_5_low: spec.
#[global] Hint Unfold data_create_6_low: spec.

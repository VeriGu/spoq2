...
Section SMCHandler_smc_rtt_create_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition smc_rtt_create_6_low (v_wi: Ptr) (v_call14: Ptr) (v_call15: Z) (v_call16: Ptr) (v_ulevel: Z) (v_g_tbl: Ptr) (v_rtt_addr: Z) (st_0: RData) (st_26: RData) : (option (Z * RData)) :=
  ...
  Definition smc_rtt_create_5_low (v_wi: Ptr) (v_call14: Ptr) (v_call15: Z) (v_call16: Ptr) (v_ulevel: Z) (v_g_tbl: Ptr) (v_rtt_addr: Z) (st_0: RData) (st_27: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
  ...
  Definition smc_rtt_create_4_low (v_wi: Ptr) (v_call14: Ptr) (v_call15: Z) (v_call16: Ptr) (v_ulevel: Z) (v_g_tbl: Ptr) (v_rtt_addr: Z) (st_0: RData) (st_28: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
  ...
  Definition smc_rtt_create_3_low (v_wi: Ptr) (v_map_addr: Z) (v_call14: Ptr) (v_call15: Z) (v_call16: Ptr) (v_s2_ctx: Ptr) (v_g_tbl: Ptr) (v_rtt_addr: Z) (v_ulevel: Z) (st_0: RData) (st_29: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
  ...
  Definition smc_rtt_create_2_low (v_map_addr: Z) (v_wi: Ptr) (v_call14: Ptr) (v_call15: Z) (v_call16: Ptr) (v_ulevel: Z) (v_g_tbl: Ptr) (v_s2_ctx: Ptr) (v_rtt_addr: Z) (st_0: RData) (st_30: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
  ...
  Definition smc_rtt_create_1_low (v_ulevel: Z) (v_call14: Ptr) (v_call16: Ptr) (v_wi: Ptr) (v_g_tbl: Ptr) (st_0: RData) (st_31: RData) : (option (Z * RData)) :=
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
  ...
  Definition smc_rtt_create_0_low (v_g_tbl: Ptr) (v_rtt_addr: Z) (v_ulevel: Z) (v_wi: Ptr) (v_call14: Ptr) (v_call16: Ptr) (st_0: RData) (st_31: RData) : (option (Z * RData)) :=
    rely (((v_g_tbl.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_wi.(pbase)) = ("smc_rtt_create_stack")));
    rely (((v_call16.(pbase)) = ("slot_delegated")));
    rely (((v_call14.(pbase)) = ("slot_rtt")));
...
End SMCHandler_smc_rtt_create_LowSpec.

#[global] Hint Unfold smc_rtt_create_6_low: spec.
#[global] Hint Unfold smc_rtt_create_5_low: spec.

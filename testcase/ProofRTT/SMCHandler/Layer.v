  ...
  Definition SMCHandler_layer :=
    {|
      ...
      PrimCall :=
          ...
          :: ("smc_rtt_map_unprotected", prim smc_rtt_map_unprotected_spec)
          :: ("smc_rtt_set_ripas", prim smc_rtt_set_ripas_spec)
          :: ("smc_rtt_unmap_unprotected", prim smc_rtt_unmap_unprotected_spec)

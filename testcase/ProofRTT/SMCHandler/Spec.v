                  ...
                  then None
                    ...
                    then None
                      ...
                      then (
                        (Some (
                          0  ,
                          (((lens 371 st_1).[share].[granule_data] :<
                            (((st_1.(share)).(granule_data)) #
                              (((st_1.(share)).(slots)) @ SLOT_RTT) ==
                              ((((st_1.(share)).(granule_data)) @ (((st_1.(share)).(slots)) @ SLOT_RTT)).[g_norm] :<
                                (((((st_1.(share)).(granule_data)) @ (((st_1.(share)).(slots)) @ SLOT_RTT)).(g_norm)) #
                    ...
                    then None
                      ...
                      then None
                        ...
                        then (
                          (Some (
                            0  ,
                            (((lens 384 st_1).[share].[granule_data] :<
                              (((st_1.(share)).(granule_data)) #
                                (((st_1.(share)).(slots)) @ SLOT_RTT) ==
                                ((((st_1.(share)).(granule_data)) @ (((st_1.(share)).(slots)) @ SLOT_RTT)).[g_norm] :<
                                  (((((st_1.(share)).(granule_data)) @ (((st_1.(share)).(slots)) @ SLOT_RTT)).(g_norm)) #
...
Definition smc_rtt_create_1 (v_ulevel: Z) (v_call14: Ptr) (v_call16: Ptr) (v_wi: Ptr) (v_g_tbl: Ptr) (st_0: RData) (st_31: RData) : (option (Z * RData)) :=
  ...
  (Some (
    ((((((v_ulevel + ((- 1))) << (32)) + (4)) >> (24)) & (4294967040)) |' (((((v_ulevel + ((- 1))) << (32)) + (4)) & (4294967295))))  ,
    ((lens 387 st_31).[share].[slots] :< ((((st_31.(share)).(slots)) # SLOT_DELEGATED == (- 1)) # SLOT_RTT == (- 1)))
  )).
...
Definition smc_rtt_create_0 (v_g_tbl: Ptr) (v_rtt_addr: Z) (v_ulevel: Z) (v_wi: Ptr) (v_call14: Ptr) (v_call16: Ptr) (st_0: RData) (st_31: RData) : (option (Z * RData)) :=
  ...
  (Some (
    0  ,
    (((lens 393 st_31).[share].[granule_data] :<
    ...
    then (
      ...
      when st_18 == (
          (rtt_walk_lock_unlock_spec
            ...
            (v_ulevel + ((- 1)))
            (mkPtr "stack_wi" 0)
            (((lens 398 st_5).[share].[slots] :< ((((st_5.(share)).(slots)) # SLOT_RD == ((((st_5.(stack)).(stack_g1)) - (GRANULES_BASE)) >> (4))) # SLOT_RD == (- 1))).[stack].[stack_s2_ctx] :<
      ...
      then (
        rely (((((((st_18.(stack)).(stack_wi)).(e_g_llt)) - (STACK_VIRT)) < (0)) /\ ((((((st_18.(stack)).(stack_wi)).(e_g_llt)) - (GRANULES_BASE)) >= (0)))));
      ...
      (Some (1, ((lens 402 st_5).[share].[slots] :< ((((st_5.(share)).(slots)) # SLOT_RD == ((((st_5.(stack)).(stack_g1)) - (GRANULES_BASE)) >> (4))) # SLOT_RD == (- 1)))))))
  else (Some (1, st_5)).
...
Definition update_ripas_spec (v_s2tte: Ptr) (v_level: Z) (v_ripas: Z) (st: RData) : (option (bool * RData)) :=
  ...
  then (Some (false, st))
    ...
    if ((((st.(stack)).(stack_s2tte)) & (36028797018963968)) =? (0))
    then (
      if ((v_level =? (3)) && (((((st.(stack)).(stack_s2tte)) & (3)) =? (3))))
      then (
        if (v_ripas =? (0))
        ...
        if ((v_level =? (2)) && (((((st.(stack)).(stack_s2tte)) & (3)) =? (1))))
        then (
          if (v_ripas =? (0))
          then (
            (Some (
...
#[global] Hint Unfold smc_rtt_set_ripas_6: spec.
#[global] Hint Unfold smc_rtt_set_ripas_7: spec.
#[global] Hint Unfold smc_rtt_set_ripas_8: spec.
#[global] Hint Unfold smc_rtt_create_spec: spec.
#[global] Hint Unfold smc_rtt_set_ripas_spec: spec.
Opaque smc_rtt_set_ripas_1.
Opaque smc_rtt_set_ripas_2.
Opaque smc_rtt_set_ripas_3.
Opaque smc_rtt_set_ripas_4.
Opaque smc_rtt_set_ripas_5.
...
Opaque smc_rtt_destroy_2.
Opaque smc_rtt_destroy_1.
Opaque smc_rtt_destroy_3.

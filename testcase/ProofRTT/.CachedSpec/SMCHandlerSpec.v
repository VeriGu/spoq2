          ...
          then (
            ...
            then (
              ...
              then (
                ...
                rely (
                  (((((((lens 8498 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 8164 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
                    (((((((lens 8498 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 8164 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
                when st_18 == (
                    (rtt_walk_lock_unlock_spec
                      (mkPtr
                        "granules"
                ...
                then (
                  ...
                  when cid_0 == (((((st_18.(share)).(granules)) @ (((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 8244 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) / (ST_GRANULE_SIZE))).(e_lock)));
                  rely (
                    (((((((lens 8611 st_18).(stack)).(smc_rtt_create_stack)) @ (((lens 8204 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
                      (((((((lens 8611 st_18).(stack)).(smc_rtt_create_stack)) @ (((lens 8204 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
                  (Some (
                    ((((((((st_18.(stack)).(smc_rtt_create_stack)) @ ((((lens 8244 st).(func_sp)).(smc_rtt_create_sp)) + (16))) << (32)) + (4)) >> (24)) & (4294967040)) |'
                      (((((((st_18.(stack)).(smc_rtt_create_stack)) @ ((((lens 8244 st).(func_sp)).(smc_rtt_create_sp)) + (16))) << (32)) + (4)) & (4294967295))))  ,
                    (lens 8663 st_18)

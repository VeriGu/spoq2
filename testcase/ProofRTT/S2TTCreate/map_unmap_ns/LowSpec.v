...
Section S2TTCreate_map_unmap_ns_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition map_unmap_ns_3_low (v_wi: Ptr) (st_16: RData) : (option (bool * Ptr * RData)) :=
  ...
  Definition map_unmap_ns_2_low (v_s2_ctx: Ptr) (v_call1_0: Ptr) (v_2_tmp: Z) (v_call: Ptr) (v_call6_1: Z) (v_call7_1: Z) (v_map_addr: Z) (v_level: Z) (v_wi: Ptr) (st_9: RData) : (option (Z * RData)) :=
  ...
  Definition map_unmap_ns_4_low (v_host_s2tte: Z) (v_level: Z) (v_wi: Ptr) (v_call18: Ptr) (st_0: RData) (st_21: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("map_unmap_ns_stack")));
  ...
  Definition map_unmap_ns_5_low (v_level: Z) (v_call18: Ptr) (v_wi: Ptr) (st_0: RData) (st_21: RData) : (option (Z * RData)) :=
    rely (((v_call18.(pbase)) = ("slot_rtt")));
    rely (((v_wi.(pbase)) = ("map_unmap_ns_stack")));
  ...
  Definition map_unmap_ns_6_low (v_4: Z) (v_wi: Ptr) (st_0: RData) (st_16: RData) : (option (Z * RData)) :=
    rely (((v_wi.(pbase)) = ("map_unmap_ns_stack")));
  ...
  Definition map_unmap_ns_1_low (v_call1_0: Ptr) (v_map_addr: Z) (v_call: Ptr) (v_s2_ctx: Ptr) (v_2_tmp: Z) (v_level: Z) (v_host_s2tte: Z) (v_call6_1: Z) (v_call7_1: Z) (v_wi: Ptr) (st_0: RData) (st_8: RData) : (option (Z * RData)) :=
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_call.(pbase)) = ("granules")));
    rely (((v_s2_ctx.(pbase)) = ("map_unmap_ns_stack")));
    rely (((v_2_tmp < (STACK_VIRT)) /\ ((v_2_tmp >= (GRANULES_BASE)))));
  ...
  Definition map_unmap_ns_7_low (v_call1_0: Ptr) (v_map_addr: Z) (v_call: Ptr) (v_s2_ctx: Ptr) (v_2_tmp: Z) (v_level: Z) (v_host_s2tte: Z) (v_call6_1: Z) (v_call7_1: Z) (v_wi: Ptr) (st_0: RData) (st_8: RData) : (option (Z * RData)) :=
    rely (((v_call1_0.(pbase)) = ("slot_rd")));
    rely (((v_call.(pbase)) = ("granules")));
    rely (((v_s2_ctx.(pbase)) = ("map_unmap_ns_stack")));
    rely (((v_2_tmp < (STACK_VIRT)) /\ ((v_2_tmp >= (GRANULES_BASE)))));
...
End S2TTCreate_map_unmap_ns_LowSpec.

#[global] Hint Unfold map_unmap_ns_3_low: spec.
#[global] Hint Unfold map_unmap_ns_2_low: spec.
#[global] Hint Unfold map_unmap_ns_4_low: spec.
#[global] Hint Unfold map_unmap_ns_5_low: spec.
#[global] Hint Unfold map_unmap_ns_6_low: spec.
#[global] Hint Unfold map_unmap_ns_1_low: spec.
#[global] Hint Unfold map_unmap_ns_7_low: spec.

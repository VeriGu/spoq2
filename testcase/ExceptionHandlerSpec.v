Definition handle_simd_exception_spec (v_exp_type: Z) (v_rec: Ptr) (st: RData) : (option (bool * RData)) :=
  if (v_exp_type =? (2))
  then (
...
Definition handle_instruction_abort_spec (v_rec: Ptr) (v_rec_exit: Ptr) (v_esr: Z) (st: RData) : (option (bool * RData)) :=
...
Definition handle_data_abort_spec (v_rec: Ptr) (v_rec_exit: Ptr) (v_esr: Z) (st: RData) : (option (bool * RData)) :=
  rely (((((v_rec.(pbase)) = ("slot_rec")) /\ (((v_rec.(poffset)) = (0)))) /\ ((((v_rec_exit.(pbase)) = ("smc_rec_enter_stack")) /\ (((v_rec_exit.(poffset)) = (0)))))));
...
Definition handle_rsi_realm_config_spec (v_agg_result: Ptr) (v_rec: Ptr) (st: RData) : (option RData) :=
...
Definition handle_sysreg_access_trap_spec (v_rec: Ptr) (v_rec_exit: Ptr) (v_esr: Z) (st: RData) : (option (bool * RData)) :=
  let v_0 := v_esr in
  let v_1 := (v_0 >> (5)) in

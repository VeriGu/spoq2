Definition PROJ_NAME: string := "RMMProof.ProofGenBufferMap".
Definition PROJ_BASE: string := "./ProofGenBufferMap".
Hint CacheSpec.
...
Section Bottom.
  ...
  Definition iasm_2_spec (v_ptr: Ptr) (v_val: Z) (st:RData) : option RData := Some st.
  Definition iasm_18_spec (st: RData) : option (Z * RData) := Some (0, st).
  Definition iasm_0_spec (v_ptr: Ptr) (st: RData) : option (Z * RData) := Some (0, st).
  Definition iasm_335_spec (st: RData) : option RData := Some st.
  Definition xlat_arch_tlbi_va_sync_spec (st:RData) : option RData := (Some st).
  Definition xlat_arch_tlbi_va_spec (ptr: Ptr) (st:RData) : option RData := (Some st).
End Bottom.
...
Section Helper.
  ...
  Definition LAYER_PRIMS: list string :=
   "read_id_aa64mmfr0_el1" :: nil.

  Hint NoTrans read_id_aa64mmfr0_el1_spec.
End Helper.
...
Section SCA.
  ...
  "xlat_arch_get_pas" :: nil.

  Hint NoTrans __sca_write64_spec.
  Hint NoTrans __sca_read64_spec.
  Hint NoTrans __arch_feat_get_pa_width_spec.
  Hint NoTrans __xlat_arch_get_pas_spec.
End SCA.
...
Definition LAYER_DATA := RData.
  ...
  Hint NoTrans xlat_desc_spec.
  Hint NoTrans xlat_arch_get_max_supported_pa_spec.
  Hint NoTrans xlat_get_tte_ptr_spec.
  Hint NoTrans xlat_write_tte_spec.
  Hint NoTrans xlat_read_tte_spec.
End XLat_Helper.
...
Section MapHelper.
  ...
  Definition LAYER_PRIMS: list string :=
    ...
    "xlat_unmap_memory_page" :: nil.

  Hint NoTrans xlat_map_memory_page_with_attrs_spec.
  Hint NoTrans xlat_unmap_memory_page_spec.
End MapHelper.
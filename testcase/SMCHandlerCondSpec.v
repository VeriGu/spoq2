Definition smc_rtt_create_spec (v_rtt_addr: Z) (v_rd_addr: Z) (v_map_addr: Z) (v_ulevel: Z) (st: RData) : (option (Z * RData)) :=
  match ((find_lock_granules_loop0 (z_to_nat 2) false false false (mkPtr "find_lock_two_granules_stack" 0) 0 (lens 9445 st))) with
  | (Some (__return__, __retval__, __break__, v_granules_0, v_i_144, st_3)) =>
    rely (((v_granules_0.(pbase)) = ("find_lock_two_granules_stack")));
    if __return__
    then (
      rely ((__retval__ = (true)));
      rely (
        (((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
          (((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
      rely ((((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) mod (ST_GRANULE_SIZE)) = (0)));
      rely ((((0 - (CPU_ID)) <= (0)) /\ ((CPU_ID < (16)))));
      when cid == ((((((lens 2449 st_3).(share)).(granules)) @ ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(e_lock)));
      rely (
        (((v_ulevel >? (3)) ||
          ((((((((((st_3.(share)).(granule_data)) @ ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(g_rd)).(e_rd_s2_ctx)).(e_rls2ctx_s2_starting_level)) +
            (1)) -
            (v_ulevel)) >?
            (0)))) =
          (false)));
      ...
      rely (
        ((((1 <<
          (((((((st_3.(share)).(granule_data)) @ ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(g_rd)).(e_rd_s2_ctx)).(e_rls2ctx_ipa_bits)))) -
          (v_map_addr)) >?
          (0)) =
          (true)));
      rely (
        (((((v_map_addr & (281474976710655)) & (((- 1) << (((((((v_ulevel * (18446744069414584320)) + (12884901888)) >> (32)) * (9)) + (12)) & (4294967295)))))) -
          ...
          (true)));
      rely (
        (((((((((st_3.(share)).(granule_data)) @ ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(g_rd)).(e_rd_s2_ctx)).(e_rls2ctx_g_rtt)) -
          (STACK_VIRT)) <
          (0)) /\
          (((((((((st_3.(share)).(granule_data)) @ ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(g_rd)).(e_rd_s2_ctx)).(e_rls2ctx_g_rtt)) -
            (GRANULES_BASE)) >=
      ...
      when sh == (
          (((lens 2449 st_3).(repl))
            ...
            (((lens 2449 st_3).(share)).[slots] :<
              ((((st_3.(share)).(slots)) #
                SLOT_RD ==
                ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))) #
                SLOT_RD ==
                (- 1)))));
      rely (
        (((((((lens 9450 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
          (((((((lens 9450 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
      when st_18 == (
          (rtt_walk_lock_unlock_spec
            ...
            v_map_addr
            (v_ulevel + ((- 1)))
            (mkPtr "smc_rtt_create_stack" (((lens 9361 st).(func_sp)).(smc_rtt_create_sp)))
            ((lens 9452 st_3).[share].[slots] :<
              ((((st_3.(share)).(slots)) #
                SLOT_RD ==
                ((((((lens 2449 st_3).(stack)).(smc_rtt_create_stack)) @ (((lens 9281 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))) #
                SLOT_RD ==
                (- 1)))));
      rely ((((((st_18.(stack)).(smc_rtt_create_stack)) @ ((((lens 9361 st).(func_sp)).(smc_rtt_create_sp)) + (16))) - ((v_ulevel + ((- 1))))) = (0)));
      rely (
        ((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
          ((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
      rely (((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) mod (ST_GRANULE_SIZE)) = (0)));
      when cid_0 == (((((st_18.(share)).(granules)) @ (((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(e_lock)));
      rely (
        ((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9321 st).(func_sp)).(smc_rtt_create_sp))) - (STACK_VIRT)) < (0)) /\
          ((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9321 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >= (0)))));
      rely (((((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9321 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) mod (ST_GRANULE_SIZE)) = (0)));
      rely (
        ((((((((st_18.(share)).(granule_data)) @ (((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))).(g_norm)) @ (8 * ((((st_18.(stack)).(smc_rtt_create_stack)) @ ((((lens 9361 st).(func_sp)).(smc_rtt_create_sp)) + (8)))))) &
          (3)) =?
          (0)) =
          (true)));
      rely (
      ...
      (smc_rtt_create_6
        ...
        v_ulevel
        (mkPtr "smc_rtt_create_stack" (((lens 9321 st).(func_sp)).(smc_rtt_create_sp)))
        v_rtt_addr
        (lens 9281 st)
        (st_18.[share].[slots] :<
          ((((st_18.(share)).(slots)) #
            SLOT_RTT ==
            (((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9361 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))) #
            SLOT_DELEGATED ==
            (((((st_18.(stack)).(smc_rtt_create_stack)) @ (((lens 9321 st).(func_sp)).(smc_rtt_create_sp))) - (GRANULES_BASE)) >> (4))))))
    else (
      rely (((v_i_144 >? (0)) = (true)));

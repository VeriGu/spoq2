...
Definition builtin_update_Ptr_pbase (p: Ptr) (b: string) :=
  mkPtr b (poffset p).
Notation "_a '.[pbase]' ':<' _b" := (builtin_update_Ptr_pbase _a _b) (at level 1).

Definition builtin_update_Ptr_poffset (p: Ptr) (o: Z) :=
  mkPtr (pbase p) o.
Notation "_a '.[poffset]' ':<' _b" := (builtin_update_Ptr_poffset _a _b) (at level 1).
...
| UNKNOWN_INSTRUCTION
| IAlloca (fname: string) (t: typ) (assign: string) (align: Z)
